...
namespace BangBangForkDefine {
  ...
  void
  BangBangFork::p_guess_eval( P_p_type P__ ) const {
  ...
  void
  BangBangFork::xlambda_guess_eval(
    integer        i_segment,
    Q_const_p_type Q__,
    P_const_p_type P__,
    X_p_type       X__,
    ...
    { // open block to avoid temporary clash
      ...
      real_type t2   = 1 - t1;
      X__[ iX_x1 ] = ModelPars[iM_x1_f] * t1 + ModelPars[iM_x1_i] * t2;
      X__[ iX_x2 ] = ModelPars[iM_x2_f] * t1 + ModelPars[iM_x2_i] * t2;
      X__[ iX_x3 ] = ModelPars[iM_x3_f] * t1 + ModelPars[iM_x3_i] * t2;
    }
    { // open block to avoid temporary clash
  ...
  bool
  BangBangFork::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  BangBangFork::xlambda_check_node(
    integer         ipos,
  ...
  BangBangFork::penalties_check(
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    bool ok = true;
    ok = ok && Tbarrier.check_range(-P__[iP_T]);
    return ok;
  }
  ...
  integer BangBangFork::u_guess_numEqns() const { return 2; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  BangBangFork::u_guess_eval(
    NodeQXL const & NODE__,
    P_const_p_type  P__,
    ...
    UGUESS__[ iU_u  ] = uControl.solve(-MU__[2], -1, 1);
    UGUESS__[ iU_u2 ] = -1.0 / ModelPars[iM_WC] * MU__[1] * ModelPars[iM_WU2] / 2;
    if ( m_debug )
  ...
  bool
  BangBangFork::u_check_if_admissible(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__
