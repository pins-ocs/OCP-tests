...
#ifndef BANGBANGFORK_DOT_HH
#define BANGBANGFORK_DOT_HH
...
// User Header (end)
  ...
  #ifndef BANGBANGFORK_API_DLL
    #ifdef BANGBANGFORK_EXPORT
      #define BANGBANGFORK_API_DLL __declspec(dllexport)
    #elif defined(BANGBANGFORK_IMPORT)
      #define BANGBANGFORK_API_DLL __declspec(dllimport)
    #else
      #define BANGBANGFORK_API_DLL
    #endif
  #endif
...
namespace BangBangForkDefine {
  ...
  class BangBangFork : public Mechatronix::Discretized_Indirect_OCP {
    ...
    // Constraints LT  - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    Mechatronix::PenaltyBarrier1DLessThan Tbarrier;
    ...
    BangBangFork( BangBangFork const & );
    BangBangFork const & operator = ( BangBangFork const & );
...
namespace BangBangForkLoad {
  using BangBangForkDefine::BangBangFork;
