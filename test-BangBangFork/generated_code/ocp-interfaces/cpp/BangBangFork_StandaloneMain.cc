...
main() {
  ...
  try {
    ...
    BangBangFork     model("BangBangFork",n_threads,&console);
    ...
    gc_data["DumpFile"] = "BangBangFork_dump";
    ...
    data_BoundaryConditions["final_x1"] = SET;
    data_BoundaryConditions["final_x2"] = SET;
    data_BoundaryConditions["final_x3"] = SET;
    ...
    // Model Parameters
    data_Parameters["WC"] = WC;
    data_Parameters["WU2"] = 1;
    data_Parameters["kappa"] = 0;

    // Guess Parameters
    data_Parameters["T_guess"] = 10;

    // Boundary Conditions
    data_Parameters["x1_f"] = 0;
    data_Parameters["x1_i"] = 0;
    data_Parameters["x2_f"] = 0;
    data_Parameters["x2_i"] = -1.3;
    data_Parameters["x3_f"] = 0;
    data_Parameters["x3_i"] = -1.3;
    ...
    // Continuation Parameters
    data_Parameters["WC0"] = WC0;
    data_Parameters["WC1"] = 100000;
    data_Parameters["u_epsi0"] = u_epsi0;
    data_Parameters["u_epsi1"] = 1e-05;
    data_Parameters["u_tol0"] = u_tol0;
    data_Parameters["u_tol1"] = 1e-05;
    ...
    GenericContainer & data_Tbarrier = data_Constraints["Tbarrier"];
    data_Tbarrier["subType"]   = "BARRIER_LOG0";
    data_Tbarrier["epsilon"]   = 0;
    data_Tbarrier["tolerance"] = 0.01;
    data_Tbarrier["active"]    = true;
    // Constraint1D: none defined
    // Constraint2D: none defined

    // User defined classes initialization
    // User defined classes: M E S H
BangBangFork_data.Mesh["s0"] = 0;
BangBangFork_data.Mesh["segments"][0]["n"] = 100;
BangBangFork_data.Mesh["segments"][0]["length"] = 1;
    ...
    std::ofstream file;
    if ( ok ) {
      file.open( "data/BangBangFork_OCP_result.txt" );
    } else {
      cout << gc_solution("solver_message").get_string() << '\n';
      // dump solution to file
      file.open( "data/BangBangFork_OCP_result_NOT_CONVERGED.txt" );
    }
    file.precision(18);
