...
%ocp.setup(BangBangFork_data);
ocp.setup('../../data/BangBangFork_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%BangBangFork_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = BangBangFork_Mex('get_raw_solution',obj);
%J     = BangBangFork_Mex('eval_JF',obj,Z,MU,U);
%f     = BangBangFork_Mex('eval_F',obj,Z,MU,U);
