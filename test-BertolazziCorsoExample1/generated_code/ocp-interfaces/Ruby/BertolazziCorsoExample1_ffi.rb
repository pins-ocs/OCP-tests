#-----------------------------------------------------------------------#
#  file: BertolazziCorsoExample1_run.rb                                 #
#                                                                       #
...
module GenericContainer
  @libGenericContainer = MECHATRONIX_LIB_PATH+"/libBertolazziCorsoExample1.#{DYLIB_EXT}"
end

module Splines
  @libSplines = MECHATRONIX_LIB_PATH+"/libBertolazziCorsoExample1.#{DYLIB_EXT}"
end
...
module BertolazziCorsoExample1
  ...
  LIB_PATH = MECHATRONIX_LIB_PATH+"/libBertolazziCorsoExample1.#{DYLIB_EXT}"
  ...
  attach_function :OCP_setup,
                  :BertolazziCorsoExample1_ocp_setup,
                  [ :string, :buffer_in ], :bool

  attach_function :OCP_guess,
                  :BertolazziCorsoExample1_ocp_guess,
                  [ :string, :buffer_in ], :bool

  attach_function :OCP_solve,
                  :BertolazziCorsoExample1_ocp_solve,
                  [ :string, :buffer_in, :buffer_out ], :bool

  attach_function :OCP_write_ocp_solution,
                  :BertolazziCorsoExample1_write_ocp_solution,
                  [ :string, :string ], :void
  ...
  class OCPSolver
    ...
    def solve( convert = true )
      ...
      ok = BertolazziCorsoExample1.OCP_setup( @id, GenericContainer.GC_mem_ptr(@id) )
      raise RuntimeError, "Failed to do setup: #{out[:Error]}\n" unless ok

      ok = BertolazziCorsoExample1.OCP_guess( @id, GenericContainer.GC_mem_ptr(@id) )
      raise RuntimeError, "Failed to do guess: #{out[:Error]}\n" unless ok

      ok  = BertolazziCorsoExample1.OCP_solve( @id,
    ...
    def write_ocp_solution( fname )
      BertolazziCorsoExample1.OCP_write_ocp_solution( @id, fname )
    end
...
# EOF: BertolazziCorsoExample1_ffi.rb
