...
%ocp.setup(BertolazziCorsoExample1_data);
%ocp.setup('../../data/BertolazziCorsoExample1_Data.lua');
ocp.setup('../../data/BertolazziCorsoExample1_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%BertolazziCorsoExample1_Mex('set_tracked',obj,tracked);
...
%[Z,U] = BertolazziCorsoExample1_Mex('get_raw_solution',obj);
%J     = BertolazziCorsoExample1_Mex('eval_JF',obj,Z,U);
%f     = BertolazziCorsoExample1_Mex('eval_F',obj,Z,U);
