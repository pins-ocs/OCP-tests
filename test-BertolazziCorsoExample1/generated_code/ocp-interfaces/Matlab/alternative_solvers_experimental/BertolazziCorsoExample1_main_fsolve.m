...
ocp.setup( [DATA_PATH 'BertolazziCorsoExample1_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = BertolazziCorsoExample1_Mex('get_raw_solution',obj);
%J        = BertolazziCorsoExample1_Mex('eval_JF',obj,Z,MU,U);
%f        = BertolazziCorsoExample1_Mex('eval_F',obj,Z,MU,U);
