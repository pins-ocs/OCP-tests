...
namespace BertolazziCorsoExample1Define {
  ...
  void
  BertolazziCorsoExample1::DgDxlxlp_sparse(
    NodeType2 const &    LEFT__,
    NodeType2 const &    RIGHT__,
    U_const_pointer_type UM__,
    P_const_pointer_type P__,
  ...
  BertolazziCorsoExample1::u_eval_analytic(
    ...
    integer i_segment = LEFT__.i_segment;
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    U__[ iU_F ] = -LM__[1] / ModelPars[iM_mass] / 2;
    if ( m_debug )
  ...
  void
  BertolazziCorsoExample1::DuDxlxlp_full_analytic(
    NodeType2 const &          LEFT__,
    NodeType2 const &          RIGHT__,
    P_const_pointer_type       P__,
    U_const_pointer_type       UM__,
    ...
    real_type tmp_0_3 = -0.2500000000e0 / ModelPars[iM_mass];
  ...
  real_type
  BertolazziCorsoExample1::m_eval(
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    real_type t1   = P__[iP_T];
    real_type t6   = pow(-X__[iX_v] * t1 + V__[0], 2);
  ...
  BertolazziCorsoExample1::DmDu_eval(
    ...
    real_type t6   = 1.0 / ModelPars[iM_mass];
    result__[ 0   ] = -2 * t6 * t2 * (-t6 * U__[iU_F] * t2 + V__[1]);
    if ( m_debug )
  ...
  BertolazziCorsoExample1::DmDuu_sparse(
    ...
    real_const_ptr X__ = NODE__.x;
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    real_type t2   = P__[iP_T] * P__[iP_T];
    real_type t4   = ModelPars[iM_mass] * ModelPars[iM_mass];
    result__[ 0   ] = 2 / t4 * t2;
    if ( m_debug )
