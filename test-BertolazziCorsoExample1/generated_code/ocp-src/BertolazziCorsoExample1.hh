/*-----------------------------------------------------------------------*\
 |  file: BertolazziCorsoExample1.hh                                     |
 |                                                                       |
...
#ifndef BERTOLAZZICORSOEXAMPLE1_DOT_HH
#define BERTOLAZZICORSOEXAMPLE1_DOT_HH
...
// User Header (end)
  ...
  #ifndef BERTOLAZZICORSOEXAMPLE1_API_DLL
    #ifdef BERTOLAZZICORSOEXAMPLE1_EXPORT
      #define BERTOLAZZICORSOEXAMPLE1_API_DLL __declspec(dllexport)
    #elif defined(BERTOLAZZICORSOEXAMPLE1_IMPORT)
      #define BERTOLAZZICORSOEXAMPLE1_API_DLL __declspec(dllimport)
    #else
      #define BERTOLAZZICORSOEXAMPLE1_API_DLL
    #endif
  #endif
...
namespace BertolazziCorsoExample1Define {
  ...
  class BertolazziCorsoExample1 : public Mechatronix::Discretized_Indirect_OCP {
    ...
    BertolazziCorsoExample1( BertolazziCorsoExample1 const & );
    BertolazziCorsoExample1 const & operator = ( BertolazziCorsoExample1 const & );
  ...
  public:
    ...
    explicit
    BertolazziCorsoExample1(
      string const   & name,
      integer          n_threads,
      Console const  * console
    );

    ~BertolazziCorsoExample1() override;
    ...
    { return "BertolazziCorsoExample1"; }
...
namespace BertolazziCorsoExample1Load {
  using BertolazziCorsoExample1Define::BertolazziCorsoExample1;

}

#endif

// EOF: BertolazziCorsoExample1.hh
