/*-----------------------------------------------------------------------*\
 |  file: BertolazziCorsoExample1_dll_pins.hh                            |
 |                                                                       |
...
namespace BertolazziCorsoExample1Define {
  ...
  using namespace BertolazziCorsoExample1Load;
  ...
  class BertolazziCorsoExample1_Problem {

    BertolazziCorsoExample1 model;
    ...
    BertolazziCorsoExample1_Problem( BertolazziCorsoExample1_Problem const & );
    BertolazziCorsoExample1_Problem const & operator = ( BertolazziCorsoExample1_Problem const & );
  ...
  public:
    ...
    BertolazziCorsoExample1_Problem( ThreadPool * TP, Console const * console )
    : model("BertolazziCorsoExample1",TP,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "BertolazziCorsoExample1::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: BertolazziCorsoExample1_dll_pins.hh
