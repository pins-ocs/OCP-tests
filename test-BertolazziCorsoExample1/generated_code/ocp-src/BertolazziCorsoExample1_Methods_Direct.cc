...
namespace BertolazziCorsoExample1Define {
  ...
  integer BertolazziCorsoExample1::fd_ode_numEqns() const { return 2; }

  void
  BertolazziCorsoExample1::fd_ode_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BertolazziCorsoExample1::Dfd_odeDxxup_numRows() const { return 2; }
  integer BertolazziCorsoExample1::Dfd_odeDxxup_numCols() const { return 6; }
  integer BertolazziCorsoExample1::Dfd_odeDxxup_nnz()     const { return 9; }

  void
  BertolazziCorsoExample1::Dfd_odeDxxup_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  BertolazziCorsoExample1::Dfd_odeDxxup_sparse(
    NodeType const &     LEFT__,
    NodeType const &     RIGHT__,
    P_const_pointer_type P__,
    U_const_pointer_type UM__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BertolazziCorsoExample1::D2fd_odeD2xxup_numRows() const { return 6; }
  integer BertolazziCorsoExample1::D2fd_odeD2xxup_numCols() const { return 6; }
  integer BertolazziCorsoExample1::D2fd_odeD2xxup_nnz()     const { return 6; }

  void
  BertolazziCorsoExample1::D2fd_odeD2xxup_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  BertolazziCorsoExample1::D2fd_odeD2xxup_sparse(
    NodeType const &     LEFT__,
    NodeType const &     RIGHT__,
    P_const_pointer_type P__,
    U_const_pointer_type UM__,
    ...
    result__[ 2   ] = -LM__[1] / ModelPars[iM_mass];
    result__[ 3   ] = result__[1];
...
// EOF: BertolazziCorsoExample1_Methods_Guess.cc
