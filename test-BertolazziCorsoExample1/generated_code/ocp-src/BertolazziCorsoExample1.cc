/*-----------------------------------------------------------------------*\
 |  file: BertolazziCorsoExample1.cc                                     |
 |                                                                       |
...
namespace BertolazziCorsoExample1Define {
  ...
  */
  BertolazziCorsoExample1::BertolazziCorsoExample1(
    string const   & name,
  ...
  */
  void
  BertolazziCorsoExample1::update_continuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
  ...
  */
  void
  BertolazziCorsoExample1::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "BertolazziCorsoExample1::setup_parameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in BertolazziCorsoExample1::setup not all parameters are set!\n"
    );
  }

  void
  BertolazziCorsoExample1::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  BertolazziCorsoExample1::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  BertolazziCorsoExample1::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  BertolazziCorsoExample1::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  BertolazziCorsoExample1::setup_controls( GenericContainer const & gc_data ) {
  ...
  */
  void
  BertolazziCorsoExample1::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "BertolazziCorsoExample1::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in BertolazziCorsoExample1::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  BertolazziCorsoExample1::info_model( integer level ) const {
  ...
  */
  void
  BertolazziCorsoExample1::setup( GenericContainer const & gc ) {

    m_debug = false;
    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("BertolazziCorsoExample1::setup, Debug");
  ...
  */
  void
  BertolazziCorsoExample1::get_names( GenericContainer & out ) const {
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  void
  BertolazziCorsoExample1::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
...
// EOF: BertolazziCorsoExample1.cc
