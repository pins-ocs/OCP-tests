...
namespace BertolazziCorsoExample1Define {
  ...
  void
  BertolazziCorsoExample1::p_guess_eval( P_pointer_type P__ ) const {
    P__[ iP_T ] = 1;
    if ( m_debug )
  ...
  void
  BertolazziCorsoExample1::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  BertolazziCorsoExample1::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  BertolazziCorsoExample1::xlambda_check_node(
    integer              ipos,
  ...
  bool
  BertolazziCorsoExample1::xlambda_check_cell(
    integer              icell,
  ...
  integer BertolazziCorsoExample1::u_guess_numEqns() const { return 1; }

  void
  BertolazziCorsoExample1::u_guess_eval(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    ...
    UGUESS__[ iU_F ] = -L__[iL_lambda2__xo] / ModelPars[iM_mass] / 2;
    if ( m_debug )
  ...
  bool
  BertolazziCorsoExample1::u_check_if_admissible(
    NodeType2 const    & NODE__,
