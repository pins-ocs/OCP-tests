...
namespace BertolazziCorsoExample1Define {
  ...
  void
  BertolazziCorsoExample1::p_guess_eval( P_p_type P__ ) const {
    P__[ iP_T ] = 1;
    if ( m_debug )
  ...
  bool
  BertolazziCorsoExample1::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  BertolazziCorsoExample1::penalties_check_node(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
  ...
  BertolazziCorsoExample1::u_guess_eval(
    ...
    UGUESS__[ iU_F ] = -MU__[1] / ModelPars[iM_mass] / 2;
    if ( m_debug )
