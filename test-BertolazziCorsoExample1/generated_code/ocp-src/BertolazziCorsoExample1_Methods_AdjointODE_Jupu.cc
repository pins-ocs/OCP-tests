...
namespace BertolazziCorsoExample1Define {
  ...
  integer BertolazziCorsoExample1::JPxpu_numEqns() const { return 4; }

  void
  BertolazziCorsoExample1::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer BertolazziCorsoExample1::JUxpu_numEqns() const { return 4; }

  void
  BertolazziCorsoExample1::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer BertolazziCorsoExample1::LTxpu_numEqns() const { return 4; }

  void
  BertolazziCorsoExample1::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
