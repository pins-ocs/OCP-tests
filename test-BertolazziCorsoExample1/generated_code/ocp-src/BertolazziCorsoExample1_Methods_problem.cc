...
namespace BertolazziCorsoExample1Define {
  ...
  BertolazziCorsoExample1::D2lagrangeD2xpu_sparse(
    ...
    real_const_ptr X__ = NODE__.x;
    MeshStd::SegmentClass const & segment = m_pMesh->get_segment_by_index(i_segment);
    result__[ 0   ] = 2 * U__[iU_F];
    result__[ 1   ] = result__[0];
    result__[ 2   ] = 2 * P__[iP_T];
    if ( m_debug )
  ...
  integer BertolazziCorsoExample1::DsegmentLinkDxxp_numRows() const { return 0; }
  integer BertolazziCorsoExample1::DsegmentLinkDxxp_numCols() const { return 0; }
  integer BertolazziCorsoExample1::DsegmentLinkDxxp_nnz() const { return 0; }

  void
  BertolazziCorsoExample1::DsegmentLinkDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  BertolazziCorsoExample1::DsegmentLinkDxxp_sparse(
    NodeQX const & L,
    NodeQX const & R,
    P_const_p_type p,
