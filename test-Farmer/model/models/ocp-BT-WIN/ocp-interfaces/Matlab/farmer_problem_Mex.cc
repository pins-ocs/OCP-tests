...
#define MODEL_NAME  "farmer_problem"
#define MODEL_CLASS farmer_problem
...
public:
  ...
  ProblemStorage( std::string const & cname, integer infoLevel )
  ...
  \*/
  void
  mex_setup( int nlhs, mxArray       *plhs[],
             int nrhs, mxArray const *prhs[] ) {
  ...
  void
  mex_get_guess( int nlhs, mxArray       *plhs[],
                 int nrhs, mxArray const *prhs[] ) {
  ...
  void
  mex_get_solution_as_guess( int nlhs, mxArray       *plhs[],
                             int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_solve( int nlhs, mxArray       *plhs[],
             int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_dims( int nlhs, mxArray       *plhs[],
            int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_names( int nlhs, mxArray       *plhs[],
             int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_updateContinuation( int nlhs, mxArray       *plhs[],
                          int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_get_raw_solution( int nlhs, mxArray       *plhs[],
                        int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_set_raw_solution( int nlhs, mxArray       *plhs[],
                        int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_check_raw_solution( int nlhs, mxArray       *plhs[],
                          int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_check_jacobian( int nlhs, mxArray       *plhs[],
                      int nrhs, mxArray const *prhs[] ) {
    ...
    this->checkJacobian(x,epsi,cout);
    #undef CMD
  }
  ...
  \*/
  void
  mex_get_solution( int nlhs, mxArray       *plhs[],
                    int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_get_ocp_data( int nlhs, mxArray       *plhs[],
                    int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_eval_F( int nlhs, mxArray       *plhs[],
              int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_eval_JF( int nlhs, mxArray       *plhs[],
               int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_eval_JF_pattern( int nlhs, mxArray       *plhs[],
                       int nrhs, mxArray const *prhs[] ) {
  ...
  \*/
  void
  mex_pack( int nlhs, mxArray       *plhs[],
            int nrhs, mxArray const *prhs[] ) {
    ...
    ASSERT( nrX == mwSize(this->dim_X()) && ncX == nn,
            CMD << "size(x) = " << nrX << " x " << ncX <<
            " expected to be " << this->dim_X() << " x " << nn );
    ASSERT( nrL == mwSize(this->dim_X()) && ncL == nn,
            CMD << "size(lambda) = " << nrL << " x " << ncL <<
            " expected to be " << this->dim_X() << " x " << nn );
    ASSERT( nP == mwSize(this->dim_Pars()),
            CMD << "length(pars) = " << nP <<
            " expected to be " << this->dim_Pars() );
    ASSERT( nO == mwSize(this->dim_Omega()),
            CMD << "length(omega) = " << nO <<
            " expected to be " << this->dim_Omega() );
    ASSERT( nrU == mwSize(this->dim_U()) && ncU == nn-1,
            CMD << "size(u) = " << nrU << " x " << ncU <<
            " expected to be " << this->dim_U() << " x " << nn-1 );
  ...
  \*/
  void
  mex_unpack( int nlhs, mxArray       *plhs[],
              int nrhs, mxArray const *prhs[] ) {
    ...
    ASSERT( nZ == mwSize(this->numEquations()),
            CMD << "length(Z) = " << nZ <<
            " expected to be " << this->numEquations() );
  ...
  \*/
  void
  mex_changeInfoLevel( int nlhs, mxArray       *plhs[],
                       int nrhs, mxArray const *prhs[] ) {
...
static
ProblemStorage *
DATA_NEW( mxArray * & mx_id, std::string const & name, integer infoLevel ) {
  ...
  try {
    ...
    case CMD_NEW:
      ...
      */
      ...
      ptr = DATA_NEW( arg_out_0, mxArrayToString(arg_in_1), 4 );
      #undef CMD
      break;
    case CMD_HELP:
      /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
