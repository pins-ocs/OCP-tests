/*-----------------------------------------------------------------------*\
 |  file: farmer_problem_dll_pins.hh                                     |
 |                                                                       |
...
using Mechatronix::MeshStd;
  ...
  class farmer_problem_Problem {

    farmer_problem model;
    ...
    farmer_problem_Problem( farmer_problem_Problem const & );
    farmer_problem_Problem const & operator = ( farmer_problem_Problem const & );
  ...
  public:
    ...
    farmer_problem_Problem( ostream_type * pCout, integer infoLevel )
    : model("farmer_problem",pCout,infoLevel)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "farmer_problem::solver, fatal: unknown error";
      }
      return ok;
    }
    ...
    FARMER_PROBLEM_API_DLL
    void
    changeInfoLevel( integer infoLevel )
...
// EOF: farmer_problem_dll_pins.hh
