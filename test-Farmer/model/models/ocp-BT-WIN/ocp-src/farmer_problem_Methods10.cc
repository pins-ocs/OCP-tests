...
namespace farmer_problemDefine {
  ...
  integer
  farmer_problem::u_guess_numEqns() const
  { return 4; }

  void
  farmer_problem::u_guess_eval(
    integer              i_segment,
    ...
    CHECK_NAN(U__.pointer(),"u_guess_eval",4);
    #endif
  }
  ...
  void
  farmer_problem::u_check_if_admissible(
    integer              i_segment,
    Q_const_pointer_type Q__,
    X_const_pointer_type X__,
    L_const_pointer_type L__,
    ...
    try {
      ...
      MECHATRONIX_DO_ERROR("farmer_problem::u_check_if_admissible: " << exc.what());
    }
  }
  ...
  integer
  farmer_problem::post_numEqns() const
  { return 2; }

  void
  farmer_problem::post_eval(
    integer              i_segment,
    Q_const_pointer_type Q__,
    X_const_pointer_type X__,
    L_const_pointer_type L__,
    ...
    result__[ 0   ] = 1.0 / ModelPars[10] * X__[0] + 1.0 / ModelPars[11] * X__[1] + 1.0 / ModelPars[12] * X__[2] + 1.0 / ModelPars[13] * X__[4];
    real_type t17  = ModelPars[3];
  ...
  integer
  farmer_problem::integrated_post_numEqns() const
  { return 0; }

  void
  farmer_problem::integrated_post_eval(
    integer              i_segment,
    Q_const_pointer_type Q__,
    X_const_pointer_type X__,
    L_const_pointer_type L__,
