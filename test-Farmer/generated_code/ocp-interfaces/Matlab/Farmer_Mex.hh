...
public:
  ...
  void do_Ptot( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_Ptot_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_Ptot_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
