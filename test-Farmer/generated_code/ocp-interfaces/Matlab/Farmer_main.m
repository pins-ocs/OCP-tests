...
%ocp.setup(Farmer_data);
ocp.setup('../../data/Farmer_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Farmer_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = Farmer_Mex('get_raw_solution',obj);
%J     = Farmer_Mex('eval_JF',obj,Z,MU,U);
%f     = Farmer_Mex('eval_F',obj,Z,MU,U);
