...
namespace FarmerDefine {
  ...
  integer Farmer::boundaryConditions_numEqns() const { return 5; }

  void
  Farmer::boundaryConditions_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Farmer::DbcDxxp_numRows() const { return 5; }
  integer Farmer::DbcDxxp_numCols() const { return 10; }
  integer Farmer::DbcDxxp_nnz()     const { return 5; }

  void
  Farmer::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Farmer::D2bcD2xxp_numRows() const { return 10; }
  integer Farmer::D2bcD2xxp_numCols() const { return 10; }
  integer Farmer::D2bcD2xxp_nnz()     const { return 0; }

  void
  Farmer::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  Farmer::D2bcD2xxp_sparse(
    NodeType const         & LEFT__,
    NodeType const         & RIGHT__,
    P_const_pointer_type     P__,
  ...
  integer Farmer::adjointBC_numEqns() const { return 10; }

  void
  Farmer::adjointBC_eval(
    NodeType const              & LEFT__,
    NodeType const              & RIGHT__,
    P_const_pointer_type          P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Farmer::DadjointBCDxxp_numRows() const { return 10; }
  integer Farmer::DadjointBCDxxp_numCols() const { return 10; }
  integer Farmer::DadjointBCDxxp_nnz()     const { return 0; }

  void
  Farmer::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
