...
namespace FarmerDefine {
  ...
  integer Farmer::bc_numEqns() const { return 5; }
  ...
  integer Farmer::fd_BC_numEqns() const { return 10; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Farmer::Dfd_BCDxlxlp_numRows() const { return 10; }
  integer Farmer::Dfd_BCDxlxlp_numCols() const { return 20; }
  integer Farmer::Dfd_BCDxlxlp_nnz()     const { return 10; }

  void
  Farmer::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
