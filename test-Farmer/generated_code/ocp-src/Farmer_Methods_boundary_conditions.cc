...
namespace FarmerDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Farmer::DboundaryConditionsDxxp_numRows() const { return 5; }
  integer Farmer::DboundaryConditionsDxxp_numCols() const { return 10; }
  integer Farmer::DboundaryConditionsDxxp_nnz()     const { return 5; }

  void
  Farmer::DboundaryConditionsDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
