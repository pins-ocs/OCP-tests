...
namespace FarmerDefine {
  ...
  public:
    ...
    FARMER_API_DLL
    Farmer_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("Farmer",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "Farmer::solver, fatal: unknown error";
      }
      return ok;
    }
