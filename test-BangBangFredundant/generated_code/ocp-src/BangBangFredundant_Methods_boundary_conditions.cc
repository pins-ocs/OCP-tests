...
namespace BangBangFredundantDefine {
  ...
  integer BangBangFredundant::fd_BC_numEqns() const { return 12; }

  void
  BangBangFredundant::fd_BC_eval(
    ...
    real_type t8   = Flim_D(XL__[iX_F1] + XL__[iX_F2]);
    ...
    real_type t17  = Flim_D(XR__[iX_F1] + XR__[iX_F2]);
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFredundant::Dfd_BCDxlxlp_numRows() const { return 12; }
  integer BangBangFredundant::Dfd_BCDxlxlp_numCols() const { return 24; }
  integer BangBangFredundant::Dfd_BCDxlxlp_nnz()     const { return 20; }

  void
  BangBangFredundant::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
    ...
    iIndex[10] = 6   ; jIndex[10] = 18  ;
    iIndex[11] = 7   ; jIndex[11] = 19  ;
    iIndex[12] = 8   ; jIndex[12] = 14  ;
    iIndex[13] = 8   ; jIndex[13] = 15  ;
    iIndex[14] = 8   ; jIndex[14] = 20  ;
    iIndex[15] = 9   ; jIndex[15] = 14  ;
    iIndex[16] = 9   ; jIndex[16] = 15  ;
    iIndex[17] = 9   ; jIndex[17] = 21  ;
    iIndex[18] = 10  ; jIndex[18] = 22  ;
    iIndex[19] = 11  ; jIndex[19] = 23  ;
  }


  void
  BangBangFredundant::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
    ...
    result__[ 0   ] = 1;
    result__[ 1   ] = 1;
    result__[ 2   ] = Flim_DD(XL__[iX_F1] + XL__[iX_F2]);
    ...
    result__[ 10  ] = -1;
    result__[ 11  ] = -1;
    result__[ 12  ] = Flim_DD(XR__[iX_F1] + XR__[iX_F2]);
    ...
    result__[ 19  ] = -1;
    if ( m_debug )
      Mechatronix::check_in_segment2( result__, "Dfd_BCDxlxlp_sparse", 20, i_segment_left, i_segment_right );
  }
