...
namespace BangBangFredundantDefine {
  ...
  BangBangFredundant::u_eval_analytic(
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    real_type t5   = ModelPars[iM_maxAF];
    U__[ iU_aF1 ] = aF1Control.solve(-LL__[iL_lambda5__xo] / 2 - LR__[iL_lambda5__xo] / 2, -t5, t5);
    U__[ iU_aF2 ] = aF2Control.solve(-LL__[iL_lambda6__xo] / 2 - LR__[iL_lambda6__xo] / 2, -t5, t5);
    if ( m_debug )
  ...
  BangBangFredundant::DuDxlxlp_full_analytic(
    ...
    real_type tmp_1_9 = 0;
    real_type t5   = ModelPars[iM_maxAF];
    real_type t6   = aF1Control.solve_rhs(-LL__[iL_lambda5__xo] / 2 - LR__[iL_lambda5__xo] / 2, -t5, t5);
    real_type tmp_0_10 = -t6 / 2;
    real_type tmp_1_10 = 0;
    real_type tmp_0_11 = 0;
    real_type t12  = aF2Control.solve_rhs(-LL__[iL_lambda6__xo] / 2 - LR__[iL_lambda6__xo] / 2, -t5, t5);
    real_type tmp_1_11 = -t12 / 2;
