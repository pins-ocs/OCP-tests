...
main() {
  ...
  try {
    BangBangFredundant * m_model = new BangBangFredundant("BangBangFredundant",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/BangBangFredundant_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/BangBangFredundant_Data.lua";
    #endif
