...
%ocp.setup('../../data/BangBangFredundant_Data.lua');
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%BangBangFredundant_Mex('set_tracked',obj,tracked);
...
%[Z,U] = BangBangFredundant_Mex('get_raw_solution',obj);
%J     = BangBangFredundant_Mex('eval_JF',obj,Z,U);
%f     = BangBangFredundant_Mex('eval_F',obj,Z,U);
