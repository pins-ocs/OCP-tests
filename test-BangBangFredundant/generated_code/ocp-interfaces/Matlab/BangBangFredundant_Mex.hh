...
public:
  ...
  void do_Flim( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_Flim_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_Flim_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
