...
%ocp.setup(BangBangFredundant_data);
ocp.setup( [DATA_PATH 'BangBangFredundant_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = BangBangFredundant_Mex('get_raw_solution',obj);
%J        = BangBangFredundant_Mex('eval_JF',obj,Z,MU,U);
%f        = BangBangFredundant_Mex('eval_F',obj,Z,MU,U);
