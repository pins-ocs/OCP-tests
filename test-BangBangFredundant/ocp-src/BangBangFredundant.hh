...
#ifndef BANGBANGFREDUNDANT_DOT_HH
#define BANGBANGFREDUNDANT_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef BANGBANGFREDUNDANT_API_DLL
    #ifdef BANGBANGFREDUNDANT_EXPORT
      #define BANGBANGFREDUNDANT_API_DLL __declspec(dllexport)
    #elif defined(BANGBANGFREDUNDANT_IMPORT)
      #define BANGBANGFREDUNDANT_API_DLL __declspec(dllimport)
    #else
      #define BANGBANGFREDUNDANT_API_DLL
    #endif
  #endif
...
namespace BangBangFredundantDefine {
  ...
  class BangBangFredundant : public Mechatronix::Discretized_Indirect_OCP {
    ...
    BangBangFredundant( BangBangFredundant const & );
    BangBangFredundant const & operator = ( BangBangFredundant const & );
  ...
  public:
    ...
    BANGBANGFREDUNDANT_API_DLL virtual
    ~BangBangFredundant() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    BANGBANGFREDUNDANT_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "BangBangFredundant"; }
...
namespace BangBangFredundantLoad {
  using BangBangFredundantDefine::BangBangFredundant;

}

#endif

// EOF: BangBangFredundant.hh
