...
% create object
infolevel  = 4;
ocp = BangBangFredundant( 'BangBangFredundant', infolevel );
...
%%clear mex
%x = BangBangFredundant_Mex('get_raw_solution',obj);
%J = BangBangFredundant_Mex('eval_JF',obj,x);
%f = BangBangFredundant_Mex('eval_F',obj,x);
