%-----------------------------------------------------------------------%
%  file: PathConstrained_fsolve_main.m                                  %
%                                                                       %
...
% create object
infolevel  = 4;
ocp = PathConstrained( 'PathConstrained' );
...
%%clear mex
%[Z,U] = PathConstrained_Mex('get_raw_solution',obj);
%J     = PathConstrained_Mex('eval_JF',obj,Z,U);
%f     = PathConstrained_Mex('eval_F',obj,Z,U);
