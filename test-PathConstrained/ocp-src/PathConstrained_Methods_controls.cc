...
namespace PathConstrainedDefine {
  ...
  PathConstrained::g_eval(
    ...
    result__[ 0   ] = 0.10e-1 * t1 + L__[1] + t4;
    if ( m_debug )
  ...
  PathConstrained::DgDu_sparse(
    ...
    real_type const * L__ = NODE__.lambda;
    MeshStd::SegmentClass const & segment = pMesh->getSegmentByIndex(i_segment);
    real_type t2   = ALIAS_uControl_D_1_1(U__[0], -20, 20);
  ...
  void
  PathConstrained::u_eval_analytic(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    U_pointer_type       U__
  ) const {
  ...
  \*/
  void
  PathConstrained::DuDxlp_full_analytic(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
  ...
  bool
  PathConstrained::DuDxlp_full_numeric(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    MatrixWrapper<real_type> & DuDxlp
