/*-----------------------------------------------------------------------*\
 |  file: PathConstrained_dll_pins.hh                                    |
 |                                                                       |
...
namespace PathConstrainedDefine {
  ...
  public:
    ...
    PathConstrained_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("PathConstrained",pTP,pConsole)
    , mesh( "mesh" )
    {
...
// EOF: PathConstrained_dll_pins.hh
