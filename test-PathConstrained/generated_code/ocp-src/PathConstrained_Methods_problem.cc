...
namespace PathConstrainedDefine {
  ...
  PathConstrained::H_eval(
    ...
    real_type t16  = t8 * t8;
    real_type t19  = X__[iX_x1] * X__[iX_x1];
    real_type result__ = t7 + t9 + t10 + t5 * (L__[iL_lambda1__xo] - 1.0 * t12) + 0.5e-2 * t16 + t19 + t8 * t12;
    return result__;
  }
#else
  real_type
  ...
  integer
  PathConstrained::DmayerDx_numEqns() const
  { return 4; }

  void
  PathConstrained::DmayerDx_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  PathConstrained::DmayerDp_numEqns() const
  { return 0; }

  void
  PathConstrained::DmayerDp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  PathConstrained::DJDx_numEqns() const
  { return 2; }

  void
  PathConstrained::DJDx_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  PathConstrained::DJDp_numEqns() const
  { return 0; }

  void
  PathConstrained::DJDp_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  PathConstrained::DJDu_numEqns() const
  { return 1; }

  void
  PathConstrained::DJDu_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_ptr             result__
...
// EOF: PathConstrained_Methods_problem.cc
