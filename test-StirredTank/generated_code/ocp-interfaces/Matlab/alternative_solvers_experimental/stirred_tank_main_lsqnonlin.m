...
%ocp.setup(stirred_tank_data);
ocp.setup( [DATA_PATH 'stirred_tank_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = stirred_tank_Mex('get_raw_solution',obj);
%J        = stirred_tank_Mex('eval_JF',obj,Z,MU,U);
%f        = stirred_tank_Mex('eval_F',obj,Z,MU,U);
