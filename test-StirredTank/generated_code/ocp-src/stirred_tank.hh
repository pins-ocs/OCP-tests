...
#ifndef STIRRED_TANK_DOT_HH
#define STIRRED_TANK_DOT_HH
...
// User Header (end)
  ...
  #ifndef STIRRED_TANK_API_DLL
    #ifdef STIRRED_TANK_EXPORT
      #define STIRRED_TANK_API_DLL __declspec(dllexport)
    #elif defined(STIRRED_TANK_IMPORT)
      #define STIRRED_TANK_API_DLL __declspec(dllimport)
    #else
      #define STIRRED_TANK_API_DLL
    #endif
  #endif
...
namespace stirred_tankDefine {
  ...
  class stirred_tank : public Mechatronix::Discretized_Indirect_OCP {
    ...
    Mechatronix::PenaltyBarrierU u4Control;
    ...
    stirred_tank( stirred_tank const & );
    stirred_tank const & operator = ( stirred_tank const & );
...
namespace stirred_tankLoad {
  using stirred_tankDefine::stirred_tank;
