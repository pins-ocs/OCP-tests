...
namespace BrakeDefine {
  ...
  class Brake_Problem {
    ...
    Brake_Problem( Brake_Problem const & );
    Brake_Problem const & operator = ( Brake_Problem const & );
  ...
  public:
    ...
    BRAKE_API_DLL
    Brake_Problem( integer n_threads, Console const * console )
    : model("Brake",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "Brake::solver, fatal: unknown error";
      }
      return ok;
    }
