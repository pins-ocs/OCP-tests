...
DO_COMMAND_REMAP_TO_CLASS_METHOD(guess_x);
DO_COMMAND_REMAP_TO_CLASS_METHOD(guess_x_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(guess_v);
DO_COMMAND_REMAP_TO_CLASS_METHOD(guess_v_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(guess_lambda1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(guess_lambda1_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(guess_lambda2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(guess_lambda2_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(guess_u);
DO_COMMAND_REMAP_TO_CLASS_METHOD(guess_u_D);
...
static std::unordered_map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"guess_x",do_guess_x},
  {"guess_x_D",do_guess_x_D},
  {"guess_v",do_guess_v},
  {"guess_v_D",do_guess_v_D},
  {"guess_lambda1",do_guess_lambda1},
  {"guess_lambda1_D",do_guess_lambda1_D},
  {"guess_lambda2",do_guess_lambda2},
  {"guess_lambda2_D",do_guess_lambda2_D},
  {"guess_u",do_guess_u},
  {"guess_u_D",do_guess_u_D},
  {"new",do_new},
  {"delete",do_delete},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "Brake_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "Brake_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
