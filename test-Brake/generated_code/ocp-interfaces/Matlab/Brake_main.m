...
%ocp.setup(Brake_data);
ocp.setup('../../data/Brake_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Brake_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = Brake_Mex('get_raw_solution',obj);
%J     = Brake_Mex('eval_JF',obj,Z,MU,U);
%f     = Brake_Mex('eval_F',obj,Z,MU,U);
