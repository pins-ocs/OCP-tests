...
%ocp.setup('../../data/Brake_Data.lua');
ocp.setup('../../data/Brake_Data.rb');
...
%%clear mex
%x = Brake_Mex('get_raw_solution',obj);
%J = Brake_Mex('eval_JF',obj,x);
%f = Brake_Mex('eval_F',obj,x);
