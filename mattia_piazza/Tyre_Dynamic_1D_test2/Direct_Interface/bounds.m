...
function [x_lb,x_ub,u_lb,u_ub] = bounds(self, varargin) 
	...
	Fz__ub     = oneN * self.pins_data.parameters.Fz__ub() ;
	Fz__lb     = oneN * self.pins_data.parameters.Fz__lb() ;
	...
	x_ub = reshape([ v__ub; omega__ub; lambda__ub; p__ub; b__ub; Fz__ub;  ], 1, self.N*self.nx );
	x_lb = reshape([ v__lb; omega__lb; lambda__lb; p__lb; b__lb; Fz__lb;  ], 1, self.N*self.nx );
