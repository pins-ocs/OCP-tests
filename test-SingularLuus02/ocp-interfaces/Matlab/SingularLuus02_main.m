...
% create object
ocp = SingularLuus02( 'SingularLuus02' );
...
%ocp.setup(SingularLuus02_data);
%ocp.setup('../../data/SingularLuus02_Data.lua');
ocp.setup('../../data/SingularLuus02_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%SingularLuus02_Mex('set_tracked',obj,tracked);
...
%[Z,U] = SingularLuus02_Mex('get_raw_solution',obj);
%J     = SingularLuus02_Mex('eval_JF',obj,Z,U);
%f     = SingularLuus02_Mex('eval_F',obj,Z,U);
