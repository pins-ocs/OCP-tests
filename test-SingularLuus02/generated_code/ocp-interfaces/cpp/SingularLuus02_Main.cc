...
main() {
  ...
  try {
    SingularLuus02 * m_model = new SingularLuus02("SingularLuus02",&TP,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/SingularLuus02_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/SingularLuus02_Data.lua";
    #endif
    ...
    if ( ok ) {
      ...
      file.open( "data/SingularLuus02_OCP_result_NOT_CONVERGED.ßtxt" );
    }
    file.precision(18);
