...
namespace SingularLuus02Define {
  ...
  SingularLuus02::H_eval(
    ...
    real_type result__ = L__[iL_lambda1__xo] * X__[iX_y] + L__[iL_lambda2__xo] * U__[iU_u] + t8;
    if ( m_debug ) {
  ...
  real_type
  SingularLuus02::control_penalties_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__
  ) const {
  ...
  real_type
  SingularLuus02::lagrange_target(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__
  ) const {
  ...
  integer
  SingularLuus02::DmayerDxxp_numEqns() const
  { return 4; }

  void
  SingularLuus02::DmayerDxxp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularLuus02::DlagrangeDxup_numEqns() const
  { return 3; }

  void
  SingularLuus02::DlagrangeDxup_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularLuus02::DJDx_numEqns() const
  { return 2; }

  void
  SingularLuus02::DJDx_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularLuus02::DJDp_numEqns() const
  { return 0; }

  void
  SingularLuus02::DJDp_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularLuus02::DJDu_numEqns() const
  { return 1; }

  void
  SingularLuus02::DJDu_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularLuus02::q_numEqns() const
  { return 1; }

  void
  SingularLuus02::q_eval(
    integer        i_segment,
    real_type      s,
  ...
  integer
  SingularLuus02::post_numEqns() const
  { return 0; }

  void
  SingularLuus02::post_eval(
    NodeType2 const    & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularLuus02::integrated_post_numEqns() const
  { return 1; }

  void
  SingularLuus02::integrated_post_eval(
    NodeType2 const    & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
...
// EOF: SingularLuus02_Methods_problem.cc
