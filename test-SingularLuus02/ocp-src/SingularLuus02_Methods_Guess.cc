...
namespace SingularLuus02Define {
  ...
  void
  SingularLuus02::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  SingularLuus02::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  SingularLuus02::p_check( P_const_pointer_type P__ ) const {
    bool ok = true;
  ...
  bool
  SingularLuus02::xlambda_check_node(
    integer              ipos,
  ...
  bool
  SingularLuus02::xlambda_check_cell(
    integer              icell,
    NodeType2 const    & NODE__,
    P_const_pointer_type P__
  ) const {
