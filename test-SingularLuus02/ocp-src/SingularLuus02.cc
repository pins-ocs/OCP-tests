...
namespace SingularLuus02Define {
  ...
  */
  void
  SingularLuus02::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  SingularLuus02::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "SingularLuus02::setupParameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in SingularLuus02::setup not all parameters are set!\n"
    );
  }

  void
  SingularLuus02::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  SingularLuus02::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  SingularLuus02::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  SingularLuus02::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  SingularLuus02::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "SingularLuus02::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  SingularLuus02::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "SingularLuus02::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in SingularLuus02::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  SingularLuus02::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  SingularLuus02::setup( GenericContainer const & gc ) {

    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("SingularLuus02::setup, Debug");
  ...
  */
  void
  SingularLuus02::get_names( GenericContainer & out ) const {
  ...
  */
  void
  SingularLuus02::diagnostic( GenericContainer const & gc ) {
  ...
  void
  SingularLuus02::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
