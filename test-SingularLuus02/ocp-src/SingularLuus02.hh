...
#ifndef SINGULARLUUS02_DOT_HH
#define SINGULARLUUS02_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef SINGULARLUUS02_API_DLL
    #ifdef SINGULARLUUS02_EXPORT
      #define SINGULARLUUS02_API_DLL __declspec(dllexport)
    #elif defined(SINGULARLUUS02_IMPORT)
      #define SINGULARLUUS02_API_DLL __declspec(dllimport)
    #else
      #define SINGULARLUUS02_API_DLL
    #endif
  #endif
...
namespace SingularLuus02Define {
  ...
  class SingularLuus02 : public Mechatronix::Discretized_Indirect_OCP {
    ...
    SingularLuus02( SingularLuus02 const & );
    SingularLuus02 const & operator = ( SingularLuus02 const & );
  ...
  public:
    ...
    SINGULARLUUS02_API_DLL virtual
    ~SingularLuus02() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    SINGULARLUUS02_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "SingularLuus02"; }
...
namespace SingularLuus02Load {
  using SingularLuus02Define::SingularLuus02;

}

#endif

// EOF: SingularLuus02.hh
