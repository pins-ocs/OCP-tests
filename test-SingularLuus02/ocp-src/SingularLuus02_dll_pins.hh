...
namespace SingularLuus02Define {
  ...
  using namespace SingularLuus02Load;
  ...
  class SingularLuus02_Problem {

    SingularLuus02 model;
    ...
    SingularLuus02_Problem( SingularLuus02_Problem const & );
    SingularLuus02_Problem const & operator = ( SingularLuus02_Problem const & );
  ...
  public:
    ...
    SingularLuus02_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("SingularLuus02",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "SingularLuus02::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: SingularLuus02_dll_pins.hh
