...
namespace vanDerPolDefine {
  ...
  vanDerPol::H_eval(
    ...
    real_type result__ = t8 * (t2 + t4 + ModelPars[iM_epsilon]) + t4 + t3 * (-t2 * t10 + t10 + L__[iL_lambda1__xo]) + t10 * (t7 - t1) + t2;
    return result__;
  }
#else
  real_type
  ...
  integer
  vanDerPol::DmayerDx_numEqns() const
  { return 4; }

  void
  vanDerPol::DmayerDx_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  vanDerPol::DmayerDp_numEqns() const
  { return 0; }

  void
  vanDerPol::DmayerDp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
