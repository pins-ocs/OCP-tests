...
namespace vanDerPolDefine {
  ...
  */
  ...
  vanDerPol::update_continuation(
    ...
    UTILS_ASSERT(
      0 <= old_s && old_s < s && s <= 1,
      "vanDerPol::update_continuation( phase number={}, old_s={}, s={} ) "
      "must be 0 <= old_s < s <= 1\n",
      phase, old_s, s
    );
    switch ( phase ) {
  ...
  */
  void
  vanDerPol::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "vanDerPol::setup_parameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  vanDerPol::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  vanDerPol::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  vanDerPol::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  vanDerPol::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  vanDerPol::setup_controls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "vanDerPol::setup_classes: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  vanDerPol::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "vanDerPol::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in vanDerPol::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  vanDerPol::info_model( integer level ) const {
