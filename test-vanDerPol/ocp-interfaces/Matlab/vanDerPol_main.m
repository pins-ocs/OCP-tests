...
%ocp.setup('../../data/vanDerPol_Data.lua');
ocp.setup('../../data/vanDerPol_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%vanDerPol_Mex('set_tracked',obj,tracked);
...
%x = vanDerPol_Mex('get_raw_solution',obj);
%J = vanDerPol_Mex('eval_JF',obj,x);
%f = vanDerPol_Mex('eval_F',obj,x);
