...
namespace vanDerPolDefine {
  ...
  class vanDerPol_Problem {
    ...
    vanDerPol_Problem( vanDerPol_Problem const & );
    vanDerPol_Problem const & operator = ( vanDerPol_Problem const & );
  ...
  public:
    ...
    VANDERPOL_API_DLL
    vanDerPol_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("vanDerPol",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "vanDerPol::solver, fatal: unknown error";
      }
      return ok;
    }
