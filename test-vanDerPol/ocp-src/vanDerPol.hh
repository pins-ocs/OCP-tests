...
#ifndef VANDERPOL_DOT_HH
#define VANDERPOL_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef VANDERPOL_API_DLL
    #ifdef VANDERPOL_EXPORT
      #define VANDERPOL_API_DLL __declspec(dllexport)
    #elif defined(VANDERPOL_IMPORT)
      #define VANDERPOL_API_DLL __declspec(dllimport)
    #else
      #define VANDERPOL_API_DLL
    #endif
  #endif
...
namespace vanDerPolDefine {
  ...
  class vanDerPol : public Mechatronix::Discretized_Indirect_OCP {
    ...
    vanDerPol( vanDerPol const & );
    vanDerPol const & operator = ( vanDerPol const & );
  ...
  public:
    ...
    VANDERPOL_API_DLL virtual
    ~vanDerPol() MECHATRONIX_OVERRIDE;
...
namespace vanDerPolLoad {
  using vanDerPolDefine::vanDerPol;
