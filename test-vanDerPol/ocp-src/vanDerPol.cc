...
namespace vanDerPolDefine {
  ...
  */
  void
  vanDerPol::updateContinuation( integer phase, real_type s ) {
    UTILS_ASSERT(
      s >= 0 && s <= 1,
      "vanDerPol::updateContinuation( phase number = {}, s = {}) "
  ...
  */
  void
  vanDerPol::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "vanDerPol::setupParameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in vanDerPol::setup not all parameters are set!\n"
    );
  }

  void
  vanDerPol::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  vanDerPol::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  vanDerPol::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  vanDerPol::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  vanDerPol::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "vanDerPol::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  vanDerPol::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "vanDerPol::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in vanDerPol::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  vanDerPol::setup( GenericContainer const & gc ) {

    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("vanDerPol::setup, Debug");
  ...
  */
  void
  vanDerPol::get_names( GenericContainer & out ) const {
  ...
  */
  void
  vanDerPol::diagnostic( GenericContainer const & gc ) {
  ...
  void
  vanDerPol::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
