...
namespace PuglieseDefine {
  ...
  */
  void
  Pugliese::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "Pugliese::setup_parameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in Pugliese::setup not all parameters are set!\n"
    );
  }

  void
  Pugliese::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  Pugliese::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  Pugliese::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  Pugliese::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  Pugliese::setup_controls( GenericContainer const & gc_data ) {
  ...
  */
  void
  Pugliese::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "Pugliese::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in Pugliese::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  Pugliese::info_model( integer level ) const {
  ...
  */
  void
  Pugliese::setup( GenericContainer const & gc ) {

    m_debug = false;
    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("Pugliese::setup, Debug");
  ...
  */
  void
  Pugliese::get_names( GenericContainer & out ) const {
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  void
  Pugliese::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
