...
namespace PuglieseDefine {
  ...
  class Pugliese_Problem {
    ...
    Pugliese_Problem( Pugliese_Problem const & );
    Pugliese_Problem const & operator = ( Pugliese_Problem const & );
  ...
  public:
    ...
    PUGLIESE_API_DLL
    Pugliese_Problem( integer n_threads, Console const * console )
    : model("Pugliese",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "Pugliese::solver, fatal: unknown error";
      }
      return ok;
    }
