...
#ifndef PUGLIESE_DOT_HH
#define PUGLIESE_DOT_HH
...
// User Header (end)
  ...
  #ifndef PUGLIESE_API_DLL
    #ifdef PUGLIESE_EXPORT
      #define PUGLIESE_API_DLL __declspec(dllexport)
    #elif defined(PUGLIESE_IMPORT)
      #define PUGLIESE_API_DLL __declspec(dllimport)
    #else
      #define PUGLIESE_API_DLL
    #endif
  #endif
...
namespace PuglieseDefine {
  ...
  class Pugliese : public Mechatronix::Discretized_Indirect_OCP {
    ...
    Pugliese( Pugliese const & );
    Pugliese const & operator = ( Pugliese const & );
  ...
  public:
    ...
    PUGLIESE_API_DLL real_type T_lim       ( real_type xo__T ) const;
    PUGLIESE_API_DLL real_type T_lim_D     ( real_type xo__T ) const;
    PUGLIESE_API_DLL real_type T_lim_DD    ( real_type xo__T ) const;
    PUGLIESE_API_DLL real_type D_lim       ( real_type xo__DD ) const;
    PUGLIESE_API_DLL real_type D_lim_D     ( real_type xo__DD ) const;
    PUGLIESE_API_DLL real_type D_lim_DD    ( real_type xo__DD ) const;
    PUGLIESE_API_DLL real_type IL_lim      ( real_type xo__IL ) const;
    PUGLIESE_API_DLL real_type IL_lim_D    ( real_type xo__IL ) const;
    PUGLIESE_API_DLL real_type IL_lim_DD   ( real_type xo__IL ) const;
    PUGLIESE_API_DLL real_type IL          ( real_type xo__T, real_type xo__C ) const;
    PUGLIESE_API_DLL real_type IL_D_1      ( real_type xo__T, real_type xo__C ) const;
    PUGLIESE_API_DLL real_type IL_D_1_1    ( real_type xo__T, real_type xo__C ) const;
    PUGLIESE_API_DLL real_type IL_D_1_2    ( real_type xo__T, real_type xo__C ) const;
    PUGLIESE_API_DLL real_type IL_D_2      ( real_type xo__T, real_type xo__C ) const;
    PUGLIESE_API_DLL real_type IL_D_2_2    ( real_type xo__T, real_type xo__C ) const;
...
namespace PuglieseLoad {
  using PuglieseDefine::Pugliese;
