...
namespace PuglieseDefine {
  ...
  integer Pugliese::boundaryConditions_numEqns() const { return 5; }

  void
  Pugliese::boundaryConditions_eval(
  ...
  integer Pugliese::adjointBC_numEqns() const { return 10; }

  void
  Pugliese::adjointBC_eval(
    NodeType const              & LEFT__,
    NodeType const              & RIGHT__,
    P_const_pointer_type          P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Pugliese::DadjointBCDxxp_numRows() const { return 10; }
  integer Pugliese::DadjointBCDxxp_numCols() const { return 10; }
  integer Pugliese::DadjointBCDxxp_nnz()     const { return 0; }

  void
  Pugliese::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  Pugliese::DadjointBCDxxp_sparse(
    NodeType const              & LEFT__,
    NodeType const              & RIGHT__,
    P_const_pointer_type          P__,
    OMEGA_full_const_pointer_type OMEGA__,
