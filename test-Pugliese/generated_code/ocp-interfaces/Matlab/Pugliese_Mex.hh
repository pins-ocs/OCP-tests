...
public:
  ...
  void do_T_lim( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_T_lim_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_T_lim_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_D_lim( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_D_lim_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_D_lim_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_IL_lim( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_IL_lim_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_IL_lim_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_IL( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_IL_D_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_IL_D_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_IL_D_1_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_IL_D_1_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_IL_D_2_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
