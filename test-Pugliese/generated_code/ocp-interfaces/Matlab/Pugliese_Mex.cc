...
DO_COMMAND_REMAP_TO_CLASS_METHOD(T_lim);
DO_COMMAND_REMAP_TO_CLASS_METHOD(T_lim_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(D_lim);
DO_COMMAND_REMAP_TO_CLASS_METHOD(D_lim_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(IL_lim);
DO_COMMAND_REMAP_TO_CLASS_METHOD(IL_lim_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(IL);
DO_COMMAND_REMAP_TO_CLASS_METHOD(IL_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(IL_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(IL_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(IL_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(IL_D_2_2);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "Pugliese_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "Pugliese_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
