...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"T_lim",&ProblemStorage::do_T_lim},
  {"T_lim_D",&ProblemStorage::do_T_lim_D},
  {"D_lim",&ProblemStorage::do_D_lim},
  {"D_lim_D",&ProblemStorage::do_D_lim_D},
  {"IL_lim",&ProblemStorage::do_IL_lim},
  {"IL_lim_D",&ProblemStorage::do_IL_lim_D},
  {"IL",&ProblemStorage::do_IL},
  {"IL_D_1",&ProblemStorage::do_IL_D_1},
  {"IL_D_2",&ProblemStorage::do_IL_D_2},
  {"IL_D_1_1",&ProblemStorage::do_IL_D_1_1},
  {"IL_D_1_2",&ProblemStorage::do_IL_D_1_2},
  {"IL_D_2_2",&ProblemStorage::do_IL_D_2_2}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "Pugliese_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
