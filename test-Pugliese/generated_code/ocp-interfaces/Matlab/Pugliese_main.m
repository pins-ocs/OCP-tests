...
%ocp.setup(Pugliese_data);
ocp.setup('../../data/Pugliese_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Pugliese_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = Pugliese_Mex('get_raw_solution',obj);
%J     = Pugliese_Mex('eval_JF',obj,Z,MU,U);
%f     = Pugliese_Mex('eval_F',obj,Z,MU,U);
