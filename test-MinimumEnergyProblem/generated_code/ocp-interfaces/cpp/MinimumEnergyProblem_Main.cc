...
main() {
  ...
  try {
    MinimumEnergyProblem * m_model = new MinimumEnergyProblem("MinimumEnergyProblem",&TP,&console);
    ...
    if ( ok ) {
      ...
      file.open( "data/MinimumEnergyProblem_OCP_result_NOT_CONVERGED.ßtxt" );
    }
    file.precision(18);
