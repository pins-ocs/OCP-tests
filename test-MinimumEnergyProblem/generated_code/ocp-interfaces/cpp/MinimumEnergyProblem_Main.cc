...
main() {
  ...
  try {
    MinimumEnergyProblem * m_model = new MinimumEnergyProblem("MinimumEnergyProblem",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/MinimumEnergyProblem_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/MinimumEnergyProblem_Data.lua";
    #endif
