...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"interpLog",&ProblemStorage::do_interpLog},
  {"interpLog_D_1",&ProblemStorage::do_interpLog_D_1},
  {"interpLog_D_2",&ProblemStorage::do_interpLog_D_2},
  {"interpLog_D_3",&ProblemStorage::do_interpLog_D_3},
  {"interpLog_D_1_1",&ProblemStorage::do_interpLog_D_1_1},
  {"interpLog_D_1_2",&ProblemStorage::do_interpLog_D_1_2},
  {"interpLog_D_1_3",&ProblemStorage::do_interpLog_D_1_3},
  {"interpLog_D_2_2",&ProblemStorage::do_interpLog_D_2_2},
  {"interpLog_D_2_3",&ProblemStorage::do_interpLog_D_2_3},
  {"interpLog_D_3_3",&ProblemStorage::do_interpLog_D_3_3}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "MinimumEnergyProblem_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
