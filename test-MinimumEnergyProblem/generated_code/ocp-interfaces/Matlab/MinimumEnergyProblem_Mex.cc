...
DO_COMMAND_REMAP_TO_CLASS_METHOD(interpLog);
DO_COMMAND_REMAP_TO_CLASS_METHOD(interpLog_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(interpLog_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(interpLog_D_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(interpLog_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(interpLog_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(interpLog_D_1_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(interpLog_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(interpLog_D_2_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(interpLog_D_3_3);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "MinimumEnergyProblem_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "MinimumEnergyProblem_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
