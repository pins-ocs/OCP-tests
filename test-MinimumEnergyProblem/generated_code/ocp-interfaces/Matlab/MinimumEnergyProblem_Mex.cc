...
public:
...

  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "MinimumEnergyProblem_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "MinimumEnergyProblem_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
...

  {
    ...
    try {
      ...
      string msg = fmt::format( "MinimumEnergyProblem_Mex('eval_F',...) error: {}", exc.what() );
      mexWarnMsgTxt( msg.c_str() );
      ok = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "MinimumEnergyProblem_Mex('eval_F',...) unkown error\n" );
      ok = false;
    }
...

  {
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "MinimumEnergyProblem_Mex('eval_JF',...) error: {}", exc.what() ).c_str() );
      ok_value = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "MinimumEnergyProblem_Mex('eval_JF',...) unkown error\n" );
      ok_value = false;
    }
    int ok = mexCallMATLAB( 1, &arg_out_0, 5, args, "sparse" );
    UTILS_MEX_ASSERT0( ok == 0, CMD "failed the call sparse(...)" );
...
do_interpLog(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_interpLog( nlhs, plhs, nrhs, prhs );
}
...
do_interpLog_D_1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_interpLog_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_interpLog_D_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_interpLog_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_interpLog_D_3(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_interpLog_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_interpLog_D_1_1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_interpLog_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_interpLog_D_1_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_interpLog_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_interpLog_D_1_3(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_interpLog_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_interpLog_D_2_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_interpLog_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_interpLog_D_2_3(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_interpLog_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_interpLog_D_3_3(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_interpLog_D_3_3( nlhs, plhs, nrhs, prhs );
}
