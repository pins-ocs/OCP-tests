...
% create object
infolevel = 4;
ocp = MinimumEnergyProblem( 'MinimumEnergyProblem' );
...
ocp.setup( [DATA_PATH 'MinimumEnergyProblem_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = MinimumEnergyProblem_Mex('get_raw_solution',obj);
%J        = MinimumEnergyProblem_Mex('eval_JF',obj,Z,MU,U);
%f        = MinimumEnergyProblem_Mex('eval_F',obj,Z,MU,U);
