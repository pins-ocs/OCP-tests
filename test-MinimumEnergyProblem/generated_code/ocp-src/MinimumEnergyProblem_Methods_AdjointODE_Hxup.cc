...
namespace MinimumEnergyProblemDefine {
  ...
  integer MinimumEnergyProblem::Hxp_numEqns() const { return 2; }

  void
  MinimumEnergyProblem::Hxp_eval(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer MinimumEnergyProblem::DHxpDxpuv_numRows() const { return 2; }
  integer MinimumEnergyProblem::DHxpDxpuv_numCols() const { return 5; }
  integer MinimumEnergyProblem::DHxpDxpuv_nnz()     const { return 1; }

  void
  MinimumEnergyProblem::DHxpDxpuv_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
  }


  void
  MinimumEnergyProblem::DHxpDxpuv_sparse(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__,
