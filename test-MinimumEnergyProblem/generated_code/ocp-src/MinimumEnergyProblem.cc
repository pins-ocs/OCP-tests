...
namespace MinimumEnergyProblemDefine {
  ...
  */
  void
  MinimumEnergyProblem::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "MinimumEnergyProblem::setup_parameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  MinimumEnergyProblem::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  MinimumEnergyProblem::setup_classes( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Constraints"),
      "MinimumEnergyProblem::setup_classes: Missing key `Parameters` in data\n"
    );
    GenericContainer const & gc = gc_data("Constraints");
    // Initialize Constraints 1D
    UTILS_ASSERT0(
      gc.exists("x1Limitation"),
      "in MinimumEnergyProblem::setup_classes(gc) missing key: ``x1Limitation''\n"
    );
  ...
  */
  void
  MinimumEnergyProblem::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  MinimumEnergyProblem::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  MinimumEnergyProblem::setup_controls( GenericContainer const & gc_data ) {
  ...
  */
  void
  MinimumEnergyProblem::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "MinimumEnergyProblem::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in MinimumEnergyProblem::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  MinimumEnergyProblem::info_model( integer level ) const {
  ...
  */
  void
  MinimumEnergyProblem::get_names( GenericContainer & out ) const {
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  void
  MinimumEnergyProblem::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
