/*-----------------------------------------------------------------------*\
 |  file: MinimumEnergyProblem_dll_pins.hh                               |
 |                                                                       |
...
namespace MinimumEnergyProblemDefine {
  ...
  class MinimumEnergyProblem_Problem {

    MinimumEnergyProblem model;
    ...
    MinimumEnergyProblem_Problem( MinimumEnergyProblem_Problem const & );
    MinimumEnergyProblem_Problem const & operator = ( MinimumEnergyProblem_Problem const & );
  ...
  public:
    ...
    MinimumEnergyProblem_Problem( integer n_threads, Console const * console )
    : model("MinimumEnergyProblem",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "MinimumEnergyProblem::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: MinimumEnergyProblem_dll_pins.hh
