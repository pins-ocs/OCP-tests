...
namespace MinimumEnergyProblemDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer MinimumEnergyProblem::DHxpDxpu_numRows() const { return 2; }
  integer MinimumEnergyProblem::DHxpDxpu_numCols() const { return 3; }
  integer MinimumEnergyProblem::DHxpDxpu_nnz()     const { return 1; }

  void
  MinimumEnergyProblem::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
  }


  void
  MinimumEnergyProblem::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
