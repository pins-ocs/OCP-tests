...
namespace MinimumEnergyProblemDefine {
  ...
  integer
  MinimumEnergyProblem::DboundaryConditionsDxxp_numRows() const
  { return 4; }

  integer
  MinimumEnergyProblem::DboundaryConditionsDxxp_numCols() const
  { return 4; }

  integer
  MinimumEnergyProblem::DboundaryConditionsDxxp_nnz() const
  { return 4; }

  void
  MinimumEnergyProblem::DboundaryConditionsDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  integer
  MinimumEnergyProblem::DadjointBCDxxp_numRows() const
  { return 4; }

  integer
  MinimumEnergyProblem::DadjointBCDxxp_numCols() const
  { return 4; }

  integer
  MinimumEnergyProblem::DadjointBCDxxp_nnz() const
  { return 0; }

  void
  MinimumEnergyProblem::DadjointBCDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  }
