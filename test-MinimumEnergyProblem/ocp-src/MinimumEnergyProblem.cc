...
namespace MinimumEnergyProblemDefine {
  ...
  */
  ...
  void
  MinimumEnergyProblem::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  MinimumEnergyProblem::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  MinimumEnergyProblem::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  MinimumEnergyProblem::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  MinimumEnergyProblem::diagnostic( GenericContainer const & gc ) {
