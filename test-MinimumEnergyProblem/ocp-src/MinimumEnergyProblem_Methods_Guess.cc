/*-----------------------------------------------------------------------*\
 |  file: MinimumEnergyProblem_Guess.cc                                  |
 |                                                                       |
...
namespace MinimumEnergyProblemDefine {
  ...
  void
  MinimumEnergyProblem::p_guess_eval( P_pointer_type P__ ) const {
  }
  ...
  bool
  MinimumEnergyProblem::p_check( P_const_pointer_type P__ ) const {
    bool ok = true;
  ...
  bool
  MinimumEnergyProblem::xlambda_check_cell(
    integer              icell,
    NodeType2 const    & NODE__,
    P_const_pointer_type P__
  ) const {
...
// EOF: MinimumEnergyProblem_Guess.cc
