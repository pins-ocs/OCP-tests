...
namespace MinimumEnergyProblemDefine {
  ...
  integer
  MinimumEnergyProblem::g_numEqns() const
  { return 1; }
  ...
  integer
  MinimumEnergyProblem::DgDxlp_numRows() const
  { return 1; }

  integer
  MinimumEnergyProblem::DgDxlp_numCols() const
  { return 4; }

  integer
  MinimumEnergyProblem::DgDxlp_nnz() const
  { return 1; }

  void
  MinimumEnergyProblem::DgDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  MinimumEnergyProblem::DgDxlp_sparse(
    NodeType2 const    & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  MinimumEnergyProblem::DgDu_numRows() const
  { return 1; }

  integer
  MinimumEnergyProblem::DgDu_numCols() const
  { return 1; }

  integer
  MinimumEnergyProblem::DgDu_nnz() const
  { return 1; }

  void
  MinimumEnergyProblem::DgDu_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  \*/
  integer
  MinimumEnergyProblem::u_numEqns() const
  { return 1; }
  ...
  \*/
  void
  MinimumEnergyProblem::DuDxlp_full_analytic(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
  ...
  bool
  MinimumEnergyProblem::DuDxlp_full_numeric(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    MatrixWrapper<real_type> & DuDxlp
