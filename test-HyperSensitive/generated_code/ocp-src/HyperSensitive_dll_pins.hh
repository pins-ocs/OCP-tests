/*-----------------------------------------------------------------------*\
 |  file: HyperSensitive_dll_pins.hh                                     |
 |                                                                       |
...
namespace HyperSensitiveDefine {
  ...
  class HyperSensitive_Problem {

    HyperSensitive model;
    ...
    HyperSensitive_Problem( HyperSensitive_Problem const & );
    HyperSensitive_Problem const & operator = ( HyperSensitive_Problem const & );
  ...
  public:
    ...
    HyperSensitive_Problem( integer n_threads, Console const * console )
    : model("HyperSensitive",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "HyperSensitive::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: HyperSensitive_dll_pins.hh
