...
namespace HyperSensitiveDefine {
  ...
  void
  HyperSensitive::DgDxlxlp_sparse(
    NodeType2 const &    LEFT__,
    NodeType2 const &    RIGHT__,
    U_const_pointer_type UM__,
    P_const_pointer_type P__,
  ...
  void
  HyperSensitive::DuDxlxlp_full_analytic(
    NodeType2 const &          LEFT__,
    NodeType2 const &          RIGHT__,
    P_const_pointer_type       P__,
    U_const_pointer_type       UM__,
    ...
    real_type tmp_0_1 = -0.250000000000000000e0;
    real_type tmp_0_2 = 0.0e0;
    real_type tmp_0_3 = -0.250000000000000000e0;
  ...
  HyperSensitive::m_eval(
    ...
    real_type t2   = t1 * t1;
    real_type result__ = pow(t2 * t1 - U__[iU_u] + V__[0], 2);
    if ( m_debug ) {
