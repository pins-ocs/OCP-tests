...
namespace HyperSensitiveDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer HyperSensitive::D2LTargsD2xup_numRows() const { return 2; }
  integer HyperSensitive::D2LTargsD2xup_numCols() const { return 2; }
  integer HyperSensitive::D2LTargsD2xup_nnz()     const { return 0; }

  void
  HyperSensitive::D2LTargsD2xup_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  HyperSensitive::D2LTargsD2xup_sparse(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
