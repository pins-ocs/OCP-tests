...
namespace HyperSensitiveDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer HyperSensitive::DHxpDxpu_numRows() const { return 1; }
  integer HyperSensitive::DHxpDxpu_numCols() const { return 2; }
  integer HyperSensitive::DHxpDxpu_nnz()     const { return 1; }

  void
  HyperSensitive::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
  }


  void
  HyperSensitive::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
