...
namespace HyperSensitiveDefine {
  ...
  integer HyperSensitive::DlagrangeDxpu_numEqns() const { return 2; }

  void
  HyperSensitive::DlagrangeDxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer HyperSensitive::D2lagrangeD2xpu_numRows() const { return 2; }
  integer HyperSensitive::D2lagrangeD2xpu_numCols() const { return 2; }
  integer HyperSensitive::D2lagrangeD2xpu_nnz()     const { return 2; }

  void
  HyperSensitive::D2lagrangeD2xpu_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  HyperSensitive::D2lagrangeD2xpu_sparse(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer HyperSensitive::DsegmentLinkDxxp_numRows() const { return 0; }
  integer HyperSensitive::DsegmentLinkDxxp_numCols() const { return 0; }
  integer HyperSensitive::DsegmentLinkDxxp_nnz() const { return 0; }

  void
  HyperSensitive::DsegmentLinkDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  HyperSensitive::DsegmentLinkDxxp_sparse(
    NodeQX const & L,
    NodeQX const & R,
    P_const_p_type p,
