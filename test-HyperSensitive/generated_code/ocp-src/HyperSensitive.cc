...
namespace HyperSensitiveDefine {
  ...
  */
  void
  HyperSensitive::update_continuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
  ...
  */
  void
  HyperSensitive::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "HyperSensitive::setup_parameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  HyperSensitive::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  HyperSensitive::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  HyperSensitive::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  HyperSensitive::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  HyperSensitive::setup_controls( GenericContainer const & gc_data ) {
  ...
  */
  void
  HyperSensitive::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "HyperSensitive::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in HyperSensitive::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  HyperSensitive::info_model( integer level ) const {
