...
namespace HyperSensitiveDefine {
  ...
  integer HyperSensitive::boundaryConditions_numEqns() const { return 2; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer HyperSensitive::DboundaryConditionsDxxp_numRows() const { return 2; }
  integer HyperSensitive::DboundaryConditionsDxxp_numCols() const { return 2; }
  integer HyperSensitive::DboundaryConditionsDxxp_nnz()     const { return 2; }

  void
  HyperSensitive::DboundaryConditionsDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  integer HyperSensitive::adjointBC_numEqns() const { return 2; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer HyperSensitive::DadjointBCDxxp_numRows() const { return 2; }
  integer HyperSensitive::DadjointBCDxxp_numCols() const { return 2; }
  integer HyperSensitive::DadjointBCDxxp_nnz()     const { return 0; }

  void
  HyperSensitive::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
