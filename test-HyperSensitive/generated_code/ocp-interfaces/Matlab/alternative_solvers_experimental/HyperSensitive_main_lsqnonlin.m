...
ocp.setup( [DATA_PATH 'HyperSensitive_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = HyperSensitive_Mex('get_raw_solution',obj);
%J        = HyperSensitive_Mex('eval_JF',obj,Z,MU,U);
%f        = HyperSensitive_Mex('eval_F',obj,Z,MU,U);
