...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%HyperSensitive_Mex('set_tracked',obj,tracked);
...
%[Z,U] = HyperSensitive_Mex('get_raw_solution',obj);
%J     = HyperSensitive_Mex('eval_JF',obj,Z,U);
%f     = HyperSensitive_Mex('eval_F',obj,Z,U);
