%-----------------------------------------------------------------------%
%  file: HyperSensitive_fsolve_main.m                                   %
%                                                                       %
...
% create object
infolevel  = 4;
ocp = HyperSensitive( 'HyperSensitive', infolevel );
...
%ocp.setup(HyperSensitive_data);
%ocp.setup('../../data/HyperSensitive_Data.lua');
ocp.setup('../../data/HyperSensitive_Data.rb');
...
%%clear mex
%x = HyperSensitive_Mex('get_raw_solution',obj);
%J = HyperSensitive_Mex('eval_JF',obj,x);
%f = HyperSensitive_Mex('eval_F',obj,x);
