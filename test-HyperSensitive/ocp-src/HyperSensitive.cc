...
namespace HyperSensitiveDefine {
  ...
  */
  void
  HyperSensitive::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  HyperSensitive::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "HyperSensitive::setupParameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in HyperSensitive::setup not all parameters are set!\n"
    );
  }

  void
  HyperSensitive::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  HyperSensitive::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  HyperSensitive::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  HyperSensitive::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  HyperSensitive::setupControls( GenericContainer const & gc_data ) {
  ...
  */
  void
  HyperSensitive::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "HyperSensitive::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in HyperSensitive::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  HyperSensitive::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  HyperSensitive::setup( GenericContainer const & gc ) {

    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("HyperSensitive::setup, Debug");
  ...
  */
  void
  HyperSensitive::get_names( GenericContainer & out ) const {
  ...
  */
  void
  HyperSensitive::diagnostic( GenericContainer const & gc ) {
  ...
  void
  HyperSensitive::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
