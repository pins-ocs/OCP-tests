...
"RobotArm_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "RobotArm"
#define MODEL_CLASS RobotArm
...
public:
  ...
  do_I_phi(
    ...
    #define CMD MODEL_NAME "_Mex('I_phi', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->I_phi(arg0) );
    #undef CMD
  }
  ...
  do_I_phi_D(
    ...
    #define CMD MODEL_NAME "_Mex('I_phi_D', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->I_phi_D(arg0) );
    #undef CMD
  }
  void
  do_I_phi_DD(
    ...
    #define CMD MODEL_NAME "_Mex('I_phi_DD', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->I_phi_DD(arg0) );
    #undef CMD
  }
  ...
  do_I_theta(
    ...
    #define CMD MODEL_NAME "_Mex('I_theta', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->I_theta(arg0,arg1) );
    #undef CMD
  }
  ...
  do_I_theta_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('I_theta_D_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->I_theta_D_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_I_theta_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('I_theta_D_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->I_theta_D_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_I_theta_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('I_theta_D_1_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->I_theta_D_1_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_I_theta_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('I_theta_D_1_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->I_theta_D_1_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_I_theta_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('I_theta_D_2_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->I_theta_D_2_2(arg0,arg1) );
    #undef CMD
  }
...
do_I_phi(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('I_phi',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_I_phi( nlhs, plhs, nrhs, prhs );
}
...
do_I_phi_D(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('I_phi_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_I_phi_D( nlhs, plhs, nrhs, prhs );
}
...
do_I_phi_DD(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('I_phi_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_I_phi_DD( nlhs, plhs, nrhs, prhs );
}
...
do_I_theta(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('I_theta',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_I_theta( nlhs, plhs, nrhs, prhs );
}
...
do_I_theta_D_1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('I_theta_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_I_theta_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_I_theta_D_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('I_theta_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_I_theta_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_I_theta_D_1_1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('I_theta_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_I_theta_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_I_theta_D_1_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('I_theta_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_I_theta_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_I_theta_D_2_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('I_theta_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_I_theta_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"I_phi",do_I_phi},
  {"I_phi_D",do_I_phi_D},
  {"I_phi_DD",do_I_phi_DD},
  {"I_theta",do_I_theta},
  {"I_theta_D_1",do_I_theta_D_1},
  {"I_theta_D_2",do_I_theta_D_2},
  {"I_theta_D_1_1",do_I_theta_D_1_1},
  {"I_theta_D_1_2",do_I_theta_D_1_2},
  {"I_theta_D_2_2",do_I_theta_D_2_2},
  {"new",do_new},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "RobotArm_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "RobotArm_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
