...
namespace RobotArmDefine {
  ...
  RobotArm::H_eval(
    ...
    real_type result__ = t2 * MU__[0] * U__[iU_u_rho] + t2 * MU__[1] * U__[iU_u_theta] + t2 * MU__[2] * U__[iU_u_phi] + t2 * MU__[3] * X__[iX_rho1] + t2 * MU__[4] * X__[iX_theta1] + t2 * MU__[5] * X__[iX_phi1];
    if ( m_debug ) {
