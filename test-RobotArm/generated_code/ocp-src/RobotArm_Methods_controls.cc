...
namespace RobotArmDefine {
  ...
  RobotArm::g_eval(
    ...
    result__[ 0   ] = (t3 + L__[iL_lambda1__xo]) * t1;
    real_type t7   = ALIAS_u_thetaControl_D_1(U__[iU_u_theta], -1, 1);
    result__[ 1   ] = (t7 + L__[iL_lambda2__xo]) * t1;
    real_type t11  = ALIAS_u_phiControl_D_1(U__[iU_u_phi], -1, 1);
    result__[ 2   ] = (t11 + L__[iL_lambda3__xo]) * t1;
    if ( m_debug )
  ...
  RobotArm::u_eval_analytic(
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    U__[ iU_u_rho   ] = u_rhoControl.solve(-LL__[iL_lambda1__xo] / 2 - LR__[iL_lambda1__xo] / 2, -1, 1);
    U__[ iU_u_theta ] = u_thetaControl.solve(-LL__[iL_lambda2__xo] / 2 - LR__[iL_lambda2__xo] / 2, -1, 1);
    U__[ iU_u_phi   ] = u_phiControl.solve(-LL__[iL_lambda3__xo] / 2 - LR__[iL_lambda3__xo] / 2, -1, 1);
    if ( m_debug )
  ...
  void
  RobotArm::DuDxlxlp_full_analytic(
    NodeType2 const &          LEFT__,
    NodeType2 const &          RIGHT__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    ...
    real_type tmp_1_5 = 0;
    real_type tmp_2_5 = 0;
    real_type t5   = u_rhoControl.solve_rhs(-LL__[iL_lambda1__xo] / 2 - LR__[iL_lambda1__xo] / 2, -1, 1);
    real_type tmp_0_6 = -t5 / 2;
    real_type tmp_1_6 = 0;
    real_type tmp_2_6 = 0;
    real_type tmp_0_7 = 0;
    real_type t11  = u_thetaControl.solve_rhs(-LL__[iL_lambda2__xo] / 2 - LR__[iL_lambda2__xo] / 2, -1, 1);
    real_type tmp_1_7 = -t11 / 2;
    real_type tmp_2_7 = 0;
    real_type tmp_0_8 = 0;
    real_type tmp_1_8 = 0;
    real_type t17  = u_phiControl.solve_rhs(-LL__[iL_lambda3__xo] / 2 - LR__[iL_lambda3__xo] / 2, -1, 1);
    real_type tmp_2_8 = -t17 / 2;
    real_type tmp_0_9 = 0;
    real_type tmp_1_9 = 0;
    real_type tmp_2_9 = 0;
  ...
  RobotArm::m_eval(
    ...
    real_type t16  = pow(-t2 * t1 + V__[3] * ModelPars[iM_L], 2);
  ...
  RobotArm::DmDu_eval(
    ...
    real_type t1   = P__[iP_T];
    real_type t2   = U__[iU_u_rho];
    real_type t9   = ALIAS_u_rhoControl_D_1(t2, -1, 1);
    result__[ 0   ] = (2 * t2 * t1 - 2 * V__[3] * ModelPars[iM_L] + t9) * t1;
    real_type t11  = U__[iU_u_theta];
    real_type t14  = X__[iX_rho];
    real_type t16  = I_theta(t14, X__[iX_phi]);
    real_type t20  = ALIAS_u_thetaControl_D_1(t11, -1, 1);
    result__[ 1   ] = (2 * t11 * t1 - 2 * V__[4] * t16 + t20) * t1;
    real_type t22  = I_phi(t14);
    real_type t26  = U__[iU_u_phi];
    real_type t29  = ALIAS_u_phiControl_D_1(t26, -1, 1);
    result__[ 2   ] = (2 * t26 * t1 - 2 * V__[5] * t22 + t29) * t1;
    if ( m_debug )
  ...
  RobotArm::DmDuu_sparse(
    ...
    real_type t4   = 2 * t1;
    result__[ 0   ] = (t3 + t4) * t1;
    real_type t7   = ALIAS_u_thetaControl_D_1_1(U__[iU_u_theta], -1, 1);
    result__[ 1   ] = (t7 + t4) * t1;
    real_type t10  = ALIAS_u_phiControl_D_1_1(U__[iU_u_phi], -1, 1);
    result__[ 2   ] = (t10 + t4) * t1;
    if ( m_debug )
