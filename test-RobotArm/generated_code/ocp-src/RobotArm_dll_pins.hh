...
namespace RobotArmDefine {
  ...
  class RobotArm_Problem {
    ...
    RobotArm_Problem const & operator = ( RobotArm_Problem const & );
  ...
  public:
    ...
    ROBOTARM_API_DLL
    RobotArm_Problem( integer n_threads, Console const * console )
    : model("RobotArm",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "RobotArm::solver, fatal: unknown error";
      }
      return ok;
    }
