...
namespace RobotArmDefine {
  ...
  */
  void
  RobotArm::info_model( integer level ) const {
    ...
    m_console->message( u_rhoControl.info(),level);
    m_console->message( u_thetaControl.info(),level);
    m_console->message( u_phiControl.info(),level);
