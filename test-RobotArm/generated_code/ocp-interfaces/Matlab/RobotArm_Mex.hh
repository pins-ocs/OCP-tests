...
public:
  ...
  void do_I_phi( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_I_phi_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_I_phi_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_I_theta( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_I_theta_D_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_I_theta_D_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_I_theta_D_1_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_I_theta_D_1_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_I_theta_D_2_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
