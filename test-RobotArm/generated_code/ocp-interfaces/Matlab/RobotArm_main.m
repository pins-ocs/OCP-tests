...
%ocp.setup('../../data/RobotArm_Data.lua');
ocp.setup('../../data/RobotArm_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%RobotArm_Mex('set_tracked',obj,tracked);
...
%[Z,U] = RobotArm_Mex('get_raw_solution',obj);
%J     = RobotArm_Mex('eval_JF',obj,Z,U);
%f     = RobotArm_Mex('eval_F',obj,Z,U);
