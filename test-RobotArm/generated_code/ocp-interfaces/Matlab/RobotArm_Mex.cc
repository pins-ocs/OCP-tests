...
DO_COMMAND_REMAP_TO_CLASS_METHOD(I_phi);
DO_COMMAND_REMAP_TO_CLASS_METHOD(I_phi_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(I_theta);
DO_COMMAND_REMAP_TO_CLASS_METHOD(I_theta_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(I_theta_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(I_theta_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(I_theta_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(I_theta_D_2_2);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "RobotArm_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "RobotArm_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
