...
public:
...

  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "RobotArm_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "RobotArm_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
...

  {
    ...
    try {
      ...
      string msg = fmt::format( "RobotArm_Mex('eval_F',...) error: {}", exc.what() );
      mexWarnMsgTxt( msg.c_str() );
      ok = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "RobotArm_Mex('eval_F',...) unkown error\n" );
      ok = false;
    }
...

  {
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "RobotArm_Mex('eval_JF',...) error: {}", exc.what() ).c_str() );
      ok_value = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "RobotArm_Mex('eval_JF',...) unkown error\n" );
      ok_value = false;
    }
    int ok = mexCallMATLAB( 1, &arg_out_0, 5, args, "sparse" );
    UTILS_MEX_ASSERT0( ok == 0, CMD "failed the call sparse(...)" );
...
do_I_phi(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_I_phi( nlhs, plhs, nrhs, prhs );
}
...
do_I_phi_D(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_I_phi_D( nlhs, plhs, nrhs, prhs );
}
...
do_I_phi_DD(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_I_phi_DD( nlhs, plhs, nrhs, prhs );
}
...
do_I_theta(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_I_theta( nlhs, plhs, nrhs, prhs );
}
...
do_I_theta_D_1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_I_theta_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_I_theta_D_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_I_theta_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_I_theta_D_1_1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_I_theta_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_I_theta_D_1_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_I_theta_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_I_theta_D_2_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_I_theta_D_2_2( nlhs, plhs, nrhs, prhs );
}
