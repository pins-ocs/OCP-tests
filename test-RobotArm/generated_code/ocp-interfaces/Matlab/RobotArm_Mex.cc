...
public:
  ...
  do_eval_F(
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "RobotArm_Mex('eval_F',...) error: {}", exc.what() ).c_str() );
      ok = false;
    } catch ( ... ) {
  ...
  do_I_phi(
    ...
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
    real_type const * arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__rho" );
  ...
  do_I_theta(
    ...
    real_type const * arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__rho" );
    mwSize N1, M1;
    real_type const * arg1 = getMatrixPointer( arg_in_3, N1, M1, CMD " xo__phi" );
