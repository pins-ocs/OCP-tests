...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"I_phi",&ProblemStorage::do_I_phi},
  {"I_phi_D",&ProblemStorage::do_I_phi_D},
  {"I_theta",&ProblemStorage::do_I_theta},
  {"I_theta_D_1",&ProblemStorage::do_I_theta_D_1},
  {"I_theta_D_2",&ProblemStorage::do_I_theta_D_2},
  {"I_theta_D_1_1",&ProblemStorage::do_I_theta_D_1_1},
  {"I_theta_D_1_2",&ProblemStorage::do_I_theta_D_1_2},
  {"I_theta_D_2_2",&ProblemStorage::do_I_theta_D_2_2}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "RobotArm_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
