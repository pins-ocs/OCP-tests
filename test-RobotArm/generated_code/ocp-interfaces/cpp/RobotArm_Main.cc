...
main() {
  ...
  try {
    RobotArm * m_model = new RobotArm("RobotArm",&TP,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/RobotArm_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/RobotArm_Data.lua";
    #endif
    ...
    if ( ok ) {
      ...
      file.open( "data/RobotArm_OCP_result_NOT_CONVERGED.ßtxt" );
    }
    file.precision(18);
