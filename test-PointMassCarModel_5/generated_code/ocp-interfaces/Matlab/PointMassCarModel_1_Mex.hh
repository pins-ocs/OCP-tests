...
public:
  ...
  void do_inv_zeta__dot( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_3( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_4( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_1_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_1_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_1_3( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_1_4( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_2_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_2_3( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_2_4( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_3_3( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_3_4( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_inv_zeta__dot_D_4_4( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
