...
public:
  ...
  do_eval_F(
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "PointMassCarModel_1_Mex('eval_F',...) error: {}", exc.what() ).c_str() );
      ok = false;
    } catch ( ... ) {
...
do_inv_zeta__dot(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_4(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_4( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_1_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_1_4(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_1_4( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_2_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_2_4(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_2_4( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_3_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_3_3( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_3_4(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_3_4( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_4_4(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_4_4( nlhs, plhs, nrhs, prhs );
}
