...
namespace PointMassCarModel_1Define {
  ...
  PointMassCarModel_1::u_guess_eval(
    ...
    UGUESS__[ iU_v__fx    ] = v__OmegaControl.solve(-L__[iL_lambda5__xo] * ModelPars[iM_v__fx__max], -1, 1);
    UGUESS__[ iU_v__Omega ] = v__OmegaControl.solve(-L__[iL_lambda4__xo] * ModelPars[iM_v__Omega__max], -1, 1);
    if ( m_debug )
