...
namespace CNOCDefine {
  ...
  integer CNOC::fd_BC_numEqns() const { return 14; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer CNOC::Dfd_BCDxlxlp_numRows() const { return 14; }
  integer CNOC::Dfd_BCDxlxlp_numCols() const { return 28; }
  integer CNOC::Dfd_BCDxlxlp_nnz()     const { return 14; }

  void
  CNOC::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
