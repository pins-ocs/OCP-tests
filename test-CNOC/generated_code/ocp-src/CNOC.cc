...
namespace CNOCDefine {
  ...
  */
  ...
  void
  CNOC::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  CNOC::info_model( integer level ) const {
    ...
    m_console->message( jsControl.info(),level);
    m_console->message( jnControl.info(),level);

    // ==================================================================
    m_console->PINS_COLOR_TITLE( fmt::format( "+{:.^71}+\n", "Constraints type LT" ), level);
    m_console->message( timePositive.info(),level);
    m_console->message( vLimit.info(),level);
    m_console->message( PathFollowingTolerance_min.info(),level);
    m_console->message( PathFollowingTolerance_max.info(),level);
    m_console->message( as_limit_min.info(),level);
    m_console->message( as_limit_max.info(),level);
    m_console->message( an_limit_min.info(),level);
    m_console->message( an_limit_max.info(),level);
    m_console->message( ax_limit_min.info(),level);
    m_console->message( ax_limit_max.info(),level);
    m_console->message( ay_limit_min.info(),level);
    m_console->message( ay_limit_max.info(),level);
    ...
    m_console->message( pToolPath2D->info(),level);
