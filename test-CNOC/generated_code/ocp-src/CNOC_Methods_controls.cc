...
namespace CNOCDefine {
  ...
  CNOC::g_fun_eval(
    ...
    real_type t95  = 1.0 / (-t31 * t92 + 1);
    real_type t103 = t95 * t92;
    real_type t126 = t60 * t1 + t73 * t1 + t76 * t1 + t85 * t1 + t88 * t1 + t1 * t95 * t2 * MU__[0] + t1 * t4 * MU__[1] - t1 * (-t103 * t2 * t4 - t41) * MU__[2] - t1 * (t3 * t92 * t95 - t51) * MU__[3] - t1 * (-t103 * t2 * t51 - t16) * MU__[4] - t1 * (t103 * t2 * t41 - t21) * MU__[5];
