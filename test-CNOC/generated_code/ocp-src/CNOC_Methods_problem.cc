...
namespace CNOCDefine {
  ...
  CNOC::H_eval(
    ...
    real_type result__ = 1.0 / t13 * t10 * t1 + t1 * t23 * t2 * MU__[0] + t1 * t4 * MU__[1] - t1 * (-t32 * t4 * t2 - t30) * MU__[2] - t1 * (t23 * t20 * t3 - t38) * MU__[3] - t1 * (-t32 * t38 * t2 - U__[iU_js]) * MU__[4] - t1 * (t32 * t30 * t2 - U__[iU_jn]) * MU__[5];
    if ( m_debug ) {
