...
namespace CNOCDefine {
  ...
  CNOC::DJDx_eval(
    ...
    real_type t2   = ALIAS_theta_D(t1);
    real_type t3   = ModelPars[iM_ay_max];
    real_type t4   = X__[iX_as];
    real_type t5   = ALIAS_theta(t1);
    real_type t6   = sin(t5);
    real_type t8   = X__[iX_an];
    real_type t9   = cos(t5);
    real_type t11  = t6 * t4 + t9 * t8;
    real_type t15  = t9 * t4 - t6 * t8;
    ...
    real_type t29  = X__[iX_coV];
    result__[ 0   ] = -t21 * t17 * t29 * (t19 * t11 * t3 - t15 * t16 * t23) * t2;
    ...
    real_type t63  = t19 * t29;
    real_type t66  = t23 * t29;
    result__[ 4   ] = t17 * t9 * t63 + t21 * t6 * t66 + t58 * t60 * t29;
    real_type t70  = 1.0 / ModelPars[iM_an_max];
    real_type t71  = t70 * t8;
    real_type t72  = ALIAS_an_limit_D(t71);
    result__[ 5   ] = -t17 * t6 * t63 + t21 * t9 * t66 + t70 * t72 * t29;
    real_type t79  = ALIAS_timePositive_D(t29);
