...
%ocp.setup(CNOC_data);
ocp.setup('../../data/CNOC_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%CNOC_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = CNOC_Mex('get_raw_solution',obj);
%J     = CNOC_Mex('eval_JF',obj,Z,MU,U);
%f     = CNOC_Mex('eval_F',obj,Z,MU,U);
