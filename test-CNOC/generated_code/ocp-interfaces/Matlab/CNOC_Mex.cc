...
DO_COMMAND_REMAP_TO_CLASS_METHOD(PathFollowingTolerance);
DO_COMMAND_REMAP_TO_CLASS_METHOD(PathFollowingTolerance_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(as_limit);
DO_COMMAND_REMAP_TO_CLASS_METHOD(as_limit_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(an_limit);
DO_COMMAND_REMAP_TO_CLASS_METHOD(an_limit_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(ax_limit);
DO_COMMAND_REMAP_TO_CLASS_METHOD(ax_limit_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(ay_limit);
DO_COMMAND_REMAP_TO_CLASS_METHOD(ay_limit_D);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "CNOC_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "CNOC_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
