...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"PathFollowingTolerance",&ProblemStorage::do_PathFollowingTolerance},
  {"PathFollowingTolerance_D",&ProblemStorage::do_PathFollowingTolerance_D},
  {"as_limit",&ProblemStorage::do_as_limit},
  {"as_limit_D",&ProblemStorage::do_as_limit_D},
  {"an_limit",&ProblemStorage::do_an_limit},
  {"an_limit_D",&ProblemStorage::do_an_limit_D},
  {"ax_limit",&ProblemStorage::do_ax_limit},
  {"ax_limit_D",&ProblemStorage::do_ax_limit_D},
  {"ay_limit",&ProblemStorage::do_ay_limit},
  {"ay_limit_D",&ProblemStorage::do_ay_limit_D}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "CNOC_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
