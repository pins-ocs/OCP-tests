...
"CNOC_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "CNOC"
#define MODEL_CLASS CNOC
...
public:
  ...
  )
  {
    ...
    GenericContainer & gc_mesh = gc_data["ToolPath2D"];
    GenericContainer & ptrs    = gc_data["Pointers"];
    ToolPath2D * pToolPath2D = ptrs("pToolPath2D").get_pointer<ToolPath2D*>();
  ...
  )
  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "CNOC_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "CNOC_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
  ...
  )
  {
    ...
    try {
      ...
      string msg = fmt::format( "CNOC_Mex('eval_F',...) error: {}", exc.what() );
      mexWarnMsgTxt( msg.c_str() );
      ok = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "CNOC_Mex('eval_F',...) unkown error\n" );
      ok = false;
    }
  ...
  )
  {
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "CNOC_Mex('eval_JF',...) error: {}", exc.what() ).c_str() );
      ok_value = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "CNOC_Mex('eval_JF',...) unkown error\n" );
      ok_value = false;
    }
    int ok = mexCallMATLAB( 1, &arg_out_0, 5, args, "sparse" );
    UTILS_MEX_ASSERT0( ok == 0, CMD "failed the call sparse(...)" );
...
do_PathFollowingTolerance(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('PathFollowingTolerance',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_PathFollowingTolerance( nlhs, plhs, nrhs, prhs );
}
...
do_PathFollowingTolerance_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('PathFollowingTolerance_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_PathFollowingTolerance_D( nlhs, plhs, nrhs, prhs );
}
...
do_PathFollowingTolerance_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('PathFollowingTolerance_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_PathFollowingTolerance_DD( nlhs, plhs, nrhs, prhs );
}
...
do_as_limit(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('as_limit',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_as_limit( nlhs, plhs, nrhs, prhs );
}
...
do_as_limit_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('as_limit_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_as_limit_D( nlhs, plhs, nrhs, prhs );
}
...
do_as_limit_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('as_limit_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_as_limit_DD( nlhs, plhs, nrhs, prhs );
}
...
do_an_limit(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('an_limit',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_an_limit( nlhs, plhs, nrhs, prhs );
}
...
do_an_limit_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('an_limit_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_an_limit_D( nlhs, plhs, nrhs, prhs );
}
...
do_an_limit_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('an_limit_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_an_limit_DD( nlhs, plhs, nrhs, prhs );
}
...
do_ax_limit(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('ax_limit',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_ax_limit( nlhs, plhs, nrhs, prhs );
}
...
do_ax_limit_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('ax_limit_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_ax_limit_D( nlhs, plhs, nrhs, prhs );
}
...
do_ax_limit_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('ax_limit_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_ax_limit_DD( nlhs, plhs, nrhs, prhs );
}
...
do_ay_limit(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('ay_limit',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_ay_limit( nlhs, plhs, nrhs, prhs );
}
...
do_ay_limit_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('ay_limit_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_ay_limit_D( nlhs, plhs, nrhs, prhs );
}
...
do_ay_limit_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('ay_limit_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_ay_limit_DD( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"PathFollowingTolerance",do_PathFollowingTolerance},
  {"PathFollowingTolerance_D",do_PathFollowingTolerance_D},
  {"PathFollowingTolerance_DD",do_PathFollowingTolerance_DD},
  {"as_limit",do_as_limit},
  {"as_limit_D",do_as_limit_D},
  {"as_limit_DD",do_as_limit_DD},
  {"an_limit",do_an_limit},
  {"an_limit_D",do_an_limit_D},
  {"an_limit_DD",do_an_limit_DD},
  {"ax_limit",do_ax_limit},
  {"ax_limit_D",do_ax_limit_D},
  {"ax_limit_DD",do_ax_limit_DD},
  {"ay_limit",do_ay_limit},
  {"ay_limit_D",do_ay_limit_D},
  {"ay_limit_DD",do_ay_limit_DD},
  {"new",do_new},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "CNOC_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "CNOC_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
