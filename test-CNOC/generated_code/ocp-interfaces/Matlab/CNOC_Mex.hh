...
public:
  ...
  void do_PathFollowingTolerance( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_PathFollowingTolerance_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_PathFollowingTolerance_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_as_limit( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_as_limit_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_as_limit_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_an_limit( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_an_limit_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_an_limit_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_ax_limit( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_ax_limit_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_ax_limit_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_ay_limit( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_ay_limit_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_ay_limit_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
