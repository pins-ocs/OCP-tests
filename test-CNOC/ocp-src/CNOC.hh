...
#include <MechatronixManufacturing/MechatronixManufacturing.hh>
  ...
  #ifndef CNOC_API_DLL
    #ifdef CNOC_EXPORT
      #define CNOC_API_DLL __declspec(dllexport)
    #elif defined(CNOC_IMPORT)
      #define CNOC_API_DLL __declspec(dllimport)
    #else
      #define CNOC_API_DLL
    #endif
  #endif
...
namespace CNOCDefine {
  ...
  class CNOC : public Mechatronix::Discretized_Indirect_OCP {
    ...
    CNOC( CNOC const & );
    CNOC const & operator = ( CNOC const & );
  ...
  public:
    ...
    CNOC_API_DLL virtual
    ~CNOC() MECHATRONIX_OVERRIDE;
