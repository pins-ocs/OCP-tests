...
classdef MinimumFuelOrbitRaising < handle
  ...
  methods
    ...
    function u = eval_u( self, varargin )
      ...
      u = MinimumFuelOrbitRaising_Mex( 'u', self.objectHandle, varargin{:} );
    end
    % ---------------------------------------------------------------------
