%-----------------------------------------------------------------------%
%  file: MinimumFuelOrbitRaising_main.m                                 %
%                                                                       %
...
% create object
ocp = MinimumFuelOrbitRaising( 'MinimumFuelOrbitRaising' );
...
%ocp.setup(MinimumFuelOrbitRaising_data);
%ocp.setup('../../data/MinimumFuelOrbitRaising_Data.lua');
ocp.setup('../../data/MinimumFuelOrbitRaising_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%MinimumFuelOrbitRaising_Mex('set_tracked',obj,tracked);
...
%[Z,U] = MinimumFuelOrbitRaising_Mex('get_raw_solution',obj);
%J     = MinimumFuelOrbitRaising_Mex('eval_JF',obj,Z,U);
%f     = MinimumFuelOrbitRaising_Mex('eval_F',obj,Z,U);
