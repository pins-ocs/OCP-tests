...
namespace MinimumFuelOrbitRaisingDefine {
  ...
  integer
  MinimumFuelOrbitRaising::DmayerDxxp_numEqns() const
  { return 6; }

  void
  MinimumFuelOrbitRaising::DmayerDxxp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  MinimumFuelOrbitRaising::DlagrangeDxup_numEqns() const
  { return 4; }

  void
  MinimumFuelOrbitRaising::DlagrangeDxup_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
