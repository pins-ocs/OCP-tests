/*-----------------------------------------------------------------------*\
 |  file: MinimumFuelOrbitRaising_dll_pins.hh                            |
 |                                                                       |
...
namespace MinimumFuelOrbitRaisingDefine {
  ...
  using namespace MinimumFuelOrbitRaisingLoad;
  ...
  class MinimumFuelOrbitRaising_Problem {

    MinimumFuelOrbitRaising model;
    ...
    MinimumFuelOrbitRaising_Problem( MinimumFuelOrbitRaising_Problem const & );
    MinimumFuelOrbitRaising_Problem const & operator = ( MinimumFuelOrbitRaising_Problem const & );
  ...
  public:
    ...
    MinimumFuelOrbitRaising_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("MinimumFuelOrbitRaising",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    MINIMUMFUELORBITRAISING_API_DLL
    ~MinimumFuelOrbitRaising_Problem()
    {}
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "MinimumFuelOrbitRaising::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: MinimumFuelOrbitRaising_dll_pins.hh
