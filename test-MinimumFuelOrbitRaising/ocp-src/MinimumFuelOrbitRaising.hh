/*-----------------------------------------------------------------------*\
 |  file: MinimumFuelOrbitRaising.hh                                     |
 |                                                                       |
...
#ifndef MINIMUMFUELORBITRAISING_DOT_HH
#define MINIMUMFUELORBITRAISING_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef MINIMUMFUELORBITRAISING_API_DLL
    #ifdef MINIMUMFUELORBITRAISING_EXPORT
      #define MINIMUMFUELORBITRAISING_API_DLL __declspec(dllexport)
    #elif defined(MINIMUMFUELORBITRAISING_IMPORT)
      #define MINIMUMFUELORBITRAISING_API_DLL __declspec(dllimport)
    #else
      #define MINIMUMFUELORBITRAISING_API_DLL
    #endif
  #endif
...
namespace MinimumFuelOrbitRaisingDefine {
  ...
  class MinimumFuelOrbitRaising : public Mechatronix::Discretized_Indirect_OCP {
    ...
    MinimumFuelOrbitRaising( MinimumFuelOrbitRaising const & );
    MinimumFuelOrbitRaising const & operator = ( MinimumFuelOrbitRaising const & );
  ...
  public:
    ...
    MINIMUMFUELORBITRAISING_API_DLL virtual
    ~MinimumFuelOrbitRaising() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    MINIMUMFUELORBITRAISING_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "MinimumFuelOrbitRaising"; }
...
namespace MinimumFuelOrbitRaisingLoad {
  using MinimumFuelOrbitRaisingDefine::MinimumFuelOrbitRaising;

}

#endif

// EOF: MinimumFuelOrbitRaising.hh
