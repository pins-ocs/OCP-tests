/*-----------------------------------------------------------------------*\
 |  file: MinimumFuelOrbitRaising_dll_ruby.hh                            |
 |                                                                       |
...
namespace MinimumFuelOrbitRaisingDefine {
  ...
  */
  ...
  MINIMUMFUELORBITRAISING_API_DLL
  bool
  MinimumFuelOrbitRaising_ocp_guess( char const id[], GenericContainer & gc_guess );
...
// EOF: MinimumFuelOrbitRaising_dll_ruby.hh
