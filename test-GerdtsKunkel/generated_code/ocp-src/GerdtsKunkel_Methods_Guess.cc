...
namespace GerdtsKunkelDefine {
  ...
  void
  GerdtsKunkel::p_guess_eval( P_pointer_type P__ ) const {
  }
  ...
  bool
  GerdtsKunkel::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  GerdtsKunkel::xlambda_check_cell(
    integer              icell,
  ...
  GerdtsKunkel::u_guess_eval(
    ...
    UGUESS__[ iU_u ] = -L__[iL_lambda2__xo] / L__[iL_lambda3__xo];
    if ( m_debug )
