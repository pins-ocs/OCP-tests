...
namespace GerdtsKunkelDefine {
  ...
  void
  GerdtsKunkel::p_guess_eval( P_p_type P__ ) const {
  }

  void
  GerdtsKunkel::xlambda_guess_eval(
    integer        i_segment,
    Q_const_p_type Q__,
    P_const_p_type P__,
    X_p_type       X__,
  ...
  bool
  GerdtsKunkel::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  GerdtsKunkel::xlambda_check_node(
    integer         ipos,
  ...
  bool
  GerdtsKunkel::penalties_check_node(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
  ...
  bool
  GerdtsKunkel::u_check_if_admissible(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__
