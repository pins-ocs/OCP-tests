...
namespace GerdtsKunkelDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer GerdtsKunkel::Dfd_odeDxxpu_numRows() const { return 3; }
  integer GerdtsKunkel::Dfd_odeDxxpu_numCols() const { return 7; }
  integer GerdtsKunkel::Dfd_odeDxxpu_nnz()     const { return 10; }

  void
  GerdtsKunkel::Dfd_odeDxxpu_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  GerdtsKunkel::Dfd_odeDxxpu_sparse(
    NodeType const &     LEFT__,
    NodeType const &     RIGHT__,
    P_const_pointer_type P__,
    U_const_pointer_type UM__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer GerdtsKunkel::D2fd_odeD2xxpu_numRows() const { return 7; }
  integer GerdtsKunkel::D2fd_odeD2xxpu_numCols() const { return 7; }
  integer GerdtsKunkel::D2fd_odeD2xxpu_nnz()     const { return 1; }

  void
  GerdtsKunkel::D2fd_odeD2xxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 6   ; jIndex[0 ] = 6   ;
  }


  void
  GerdtsKunkel::D2fd_odeD2xxpu_sparse(
    NodeType const &     LEFT__,
    NodeType const &     RIGHT__,
    P_const_pointer_type P__,
    U_const_pointer_type UM__,
