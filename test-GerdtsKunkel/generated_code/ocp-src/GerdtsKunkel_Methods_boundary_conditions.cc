...
namespace GerdtsKunkelDefine {
  ...
  integer GerdtsKunkel::bc_numEqns() const { return 5; }

  void
  GerdtsKunkel::bc_eval(
    NodeQX const & LEFT__,
  ...
  integer GerdtsKunkel::fd_BC_numEqns() const { return 6; }

  void
  GerdtsKunkel::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer GerdtsKunkel::Dfd_BCDxlxlp_numRows() const { return 6; }
  integer GerdtsKunkel::Dfd_BCDxlxlp_numCols() const { return 12; }
  integer GerdtsKunkel::Dfd_BCDxlxlp_nnz()     const { return 6; }

  void
  GerdtsKunkel::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  GerdtsKunkel::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
