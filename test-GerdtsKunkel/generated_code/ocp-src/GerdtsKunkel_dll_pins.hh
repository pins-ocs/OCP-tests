...
namespace GerdtsKunkelDefine {
  ...
  class GerdtsKunkel_Problem {
    ...
    GerdtsKunkel_Problem( GerdtsKunkel_Problem const & );
    GerdtsKunkel_Problem const & operator = ( GerdtsKunkel_Problem const & );
  ...
  public:
    ...
    GerdtsKunkel_Problem( integer n_threads, Console const * console )
    : model("GerdtsKunkel",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "GerdtsKunkel::solver, fatal: unknown error";
      }
      return ok;
    }
