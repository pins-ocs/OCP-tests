...
namespace GerdtsKunkelDefine {
  ...
  bool
  GerdtsKunkel::penalties_check_cell(
  ...
  GerdtsKunkel::H_eval(
    ...
    real_type t8   = t5 * t5;
    real_type result__ = L__[iL_lambda1__xo] * X__[iX_x2] + t5 * L__[iL_lambda2__xo] + t8 * L__[iL_lambda3__xo] / 2;
    if ( m_debug ) {
  ...
  void
  GerdtsKunkel::DsegmentLinkDxp_sparse(
    NodeType const     & L,
    NodeType const     & R,
    P_const_pointer_type p,
