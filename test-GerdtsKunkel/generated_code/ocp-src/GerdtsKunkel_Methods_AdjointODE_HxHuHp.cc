...
namespace GerdtsKunkelDefine {
  ...
  integer GerdtsKunkel::Hxp_numEqns() const { return 3; }

  void
  GerdtsKunkel::Hxp_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer GerdtsKunkel::DHxpDxpu_numRows() const { return 3; }
  integer GerdtsKunkel::DHxpDxpu_numCols() const { return 4; }
  integer GerdtsKunkel::DHxpDxpu_nnz()     const { return 0; }

  void
  GerdtsKunkel::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  GerdtsKunkel::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
