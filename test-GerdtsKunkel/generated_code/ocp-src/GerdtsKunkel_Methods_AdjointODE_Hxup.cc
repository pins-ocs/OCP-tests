...
namespace GerdtsKunkelDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer GerdtsKunkel::DHxpDxpuv_numRows() const { return 3; }
  integer GerdtsKunkel::DHxpDxpuv_numCols() const { return 7; }
  integer GerdtsKunkel::DHxpDxpuv_nnz()     const { return 1; }

  void
  GerdtsKunkel::DHxpDxpuv_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
  }


  void
  GerdtsKunkel::DHxpDxpuv_sparse(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__,
