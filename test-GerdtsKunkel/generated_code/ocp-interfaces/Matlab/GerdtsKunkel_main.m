...
ocp.setup('../../data/GerdtsKunkel_Data');  % automatically try extension .rb and .lua
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%GerdtsKunkel_Mex('set_tracked',obj,tracked);
...
%[Z,U] = GerdtsKunkel_Mex('get_raw_solution',obj);
%J     = GerdtsKunkel_Mex('eval_JF',obj,Z,U);
%f     = GerdtsKunkel_Mex('eval_F',obj,Z,U);
