...
namespace GerdtsKunkelDefine {
  ...
  */
  void
  GerdtsKunkel::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  GerdtsKunkel::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "GerdtsKunkel::setupParameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  GerdtsKunkel::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  GerdtsKunkel::setupClasses( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Constraints"),
      "GerdtsKunkel::setupClasses: Missing key `Parameters` in data\n"
    );
    GenericContainer const & gc = gc_data("Constraints");
    // Initialize Constraints 1D
    UTILS_ASSERT0(
      gc.exists("x1Limitation"),
      "in GerdtsKunkel::setupClasses(gc) missing key: ``x1Limitation''\n"
    );
  ...
  */
  void
  GerdtsKunkel::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  GerdtsKunkel::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  GerdtsKunkel::setupControls( GenericContainer const & gc_data ) {
  ...
  */
  void
  GerdtsKunkel::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "GerdtsKunkel::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in GerdtsKunkel::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  GerdtsKunkel::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  GerdtsKunkel::diagnostic( GenericContainer const & gc ) {
