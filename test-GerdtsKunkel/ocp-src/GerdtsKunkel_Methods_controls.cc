...
namespace GerdtsKunkelDefine {
  ...
  integer
  GerdtsKunkel::DgDxlp_numRows() const
  { return 1; }

  integer
  GerdtsKunkel::DgDxlp_numCols() const
  { return 6; }

  integer
  GerdtsKunkel::DgDxlp_nnz() const
  { return 2; }

  void
  GerdtsKunkel::DgDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  \*/
  void
  GerdtsKunkel::DuDxlp_full_analytic(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
  ...
  bool
  GerdtsKunkel::DuDxlp_full_numeric(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    MatrixWrapper<real_type> & DuDxlp
