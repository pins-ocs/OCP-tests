...
namespace ICLOCS_PathConstrainedDefine {
  ...
  void
  ICLOCS_PathConstrained::continuation_step_0( real_type s ) {
    real_type t2   = 1 - s;
  ...
  real_type
  ICLOCS_PathConstrained::penalties_eval(
  ...
  real_type
  ICLOCS_PathConstrained::control_penalties_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__
  ) const {
  ...
  real_type
  ICLOCS_PathConstrained::lagrange_target(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__
  ) const {
  ...
  real_type
  ICLOCS_PathConstrained::mayer_target(
  ...
  integer
  ICLOCS_PathConstrained::DmayerDxxp_numEqns() const
  { return 4; }

  void
  ICLOCS_PathConstrained::DmayerDxxp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  ICLOCS_PathConstrained::DlagrangeDxup_numEqns() const
  { return 3; }
  ...
  integer
  ICLOCS_PathConstrained::DJDx_numEqns() const
  { return 2; }

  void
  ICLOCS_PathConstrained::DJDx_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
    ...
    result__[ 0   ] = 0;
    real_type t3   = pow(Q__[iQ_zeta] - 0.5e0, 2);
    real_type t7   = ALIAS_x2bound_D(8 * t3 - 0.5e0 - X__[iX_x2]);
    result__[ 1   ] = -t7;
    if ( m_debug )
  ...
  integer
  ICLOCS_PathConstrained::DJDp_numEqns() const
  { return 0; }

  void
  ICLOCS_PathConstrained::DJDp_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  ICLOCS_PathConstrained::DJDu_numEqns() const
  { return 1; }

  void
  ICLOCS_PathConstrained::DJDu_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  ICLOCS_PathConstrained::q_numEqns() const
  { return 1; }

  void
  ICLOCS_PathConstrained::q_eval(
    integer        i_segment,
    real_type      s,
  ...
  integer
  ICLOCS_PathConstrained::segmentLink_numEqns() const
  { return 0; }

  void
  ICLOCS_PathConstrained::segmentLink_eval(
    NodeType const     & L,
    NodeType const     & R,
  ...
  integer
  ICLOCS_PathConstrained::DsegmentLinkDxp_numRows() const
  { return 0; }

  integer
  ICLOCS_PathConstrained::DsegmentLinkDxp_numCols() const
  { return 0; }

  integer
  ICLOCS_PathConstrained::DsegmentLinkDxp_nnz() const
  { return 0; }

  void
  ICLOCS_PathConstrained::DsegmentLinkDxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  ICLOCS_PathConstrained::DsegmentLinkDxp_sparse(
    NodeType const     & L,
    NodeType const     & R,
    P_const_pointer_type p,
  ...
  integer
  ICLOCS_PathConstrained::jump_numEqns() const
  { return 4; }

  void
  ICLOCS_PathConstrained::jump_eval(
  ...
  integer
  ICLOCS_PathConstrained::DjumpDxlxlp_numRows() const
  { return 4; }

  integer
  ICLOCS_PathConstrained::DjumpDxlxlp_numCols() const
  { return 8; }

  integer
  ICLOCS_PathConstrained::DjumpDxlxlp_nnz() const
  { return 8; }

  void
  ICLOCS_PathConstrained::DjumpDxlxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  ICLOCS_PathConstrained::DjumpDxlxlp_sparse(
    NodeType2 const    & LEFT__,
    NodeType2 const    & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  ICLOCS_PathConstrained::post_numEqns() const
  { return 0; }
  ...
  integer
  ICLOCS_PathConstrained::integrated_post_numEqns() const
  { return 0; }

  void
  ICLOCS_PathConstrained::integrated_post_eval(
    NodeType2 const    & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
...
// EOF: ICLOCS_PathConstrained_Methods_problem.cc
