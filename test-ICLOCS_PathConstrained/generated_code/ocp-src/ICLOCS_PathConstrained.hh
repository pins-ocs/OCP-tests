/*-----------------------------------------------------------------------*\
 |  file: ICLOCS_PathConstrained.hh                                      |
 |                                                                       |
...
#ifndef ICLOCS_PATHCONSTRAINED_DOT_HH
#define ICLOCS_PATHCONSTRAINED_DOT_HH
...
// User Header (end)
  ...
  #ifndef ICLOCS_PATHCONSTRAINED_API_DLL
    #ifdef ICLOCS_PATHCONSTRAINED_EXPORT
      #define ICLOCS_PATHCONSTRAINED_API_DLL __declspec(dllexport)
    #elif defined(ICLOCS_PATHCONSTRAINED_IMPORT)
      #define ICLOCS_PATHCONSTRAINED_API_DLL __declspec(dllimport)
    #else
      #define ICLOCS_PATHCONSTRAINED_API_DLL
    #endif
  #endif
...
namespace ICLOCS_PathConstrainedDefine {
  ...
  class ICLOCS_PathConstrained : public Mechatronix::Discretized_Indirect_OCP {
    ...
    // Constraints 1D  - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    Mechatronix::PenaltyBarrier1DGreaterThan x2bound;
    ...
    ICLOCS_PathConstrained( ICLOCS_PathConstrained const & );
    ICLOCS_PathConstrained const & operator = ( ICLOCS_PathConstrained const & );
  ...
  public:
    ...
    explicit
    ICLOCS_PathConstrained(
      string  const & name,
      ThreadPool    * TP,
      Console const * console
    );

    ~ICLOCS_PathConstrained() override;
...
namespace ICLOCS_PathConstrainedLoad {
  using ICLOCS_PathConstrainedDefine::ICLOCS_PathConstrained;

}

#endif

// EOF: ICLOCS_PathConstrained.hh
