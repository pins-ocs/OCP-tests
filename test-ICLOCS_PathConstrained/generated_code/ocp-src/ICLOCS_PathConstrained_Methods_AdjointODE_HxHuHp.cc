...
namespace ICLOCS_PathConstrainedDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer ICLOCS_PathConstrained::DHxpDxpu_numRows() const { return 2; }
  integer ICLOCS_PathConstrained::DHxpDxpu_numCols() const { return 3; }
  integer ICLOCS_PathConstrained::DHxpDxpu_nnz()     const { return 2; }

  void
  ICLOCS_PathConstrained::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  ICLOCS_PathConstrained::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
