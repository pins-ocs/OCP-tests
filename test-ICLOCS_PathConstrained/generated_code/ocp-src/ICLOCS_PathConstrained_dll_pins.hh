...
namespace ICLOCS_PathConstrainedDefine {
  ...
  class ICLOCS_PathConstrained_Problem {

    ICLOCS_PathConstrained model;
    ...
    ICLOCS_PathConstrained_Problem const & operator = ( ICLOCS_PathConstrained_Problem const & );
  ...
  public:
    ...
    ICLOCS_PathConstrained_Problem( integer n_threads, Console const * console )
    : model("ICLOCS_PathConstrained",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    ICLOCS_PATHCONSTRAINED_API_DLL
    ~ICLOCS_PathConstrained_Problem()
    {}
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "ICLOCS_PathConstrained::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: ICLOCS_PathConstrained_dll_pins.hh
