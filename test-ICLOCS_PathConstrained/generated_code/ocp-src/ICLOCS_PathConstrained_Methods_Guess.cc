...
namespace ICLOCS_PathConstrainedDefine {
  ...
  void
  ICLOCS_PathConstrained::p_guess_eval( P_pointer_type P__ ) const {
  }
  ...
  bool
  ICLOCS_PathConstrained::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  ICLOCS_PathConstrained::xlambda_check_cell(
    integer              icell,
