...
main() {
  ...
  try {
    ICLOCS_PathConstrained * m_model = new ICLOCS_PathConstrained("ICLOCS_PathConstrained",&console,&TP);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    string fname = "./data/ICLOCS_PathConstrained_Data"; // no .lua or .rb extension
