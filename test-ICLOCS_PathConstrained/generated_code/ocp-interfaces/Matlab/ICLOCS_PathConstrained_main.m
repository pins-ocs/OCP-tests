%-----------------------------------------------------------------------%
%  file: ICLOCS_PathConstrained_main.m                                  %
%                                                                       %
...
% create object
ocp = ICLOCS_PathConstrained( 'ICLOCS_PathConstrained' );
...
%ocp.setup(ICLOCS_PathConstrained_data);
%ocp.setup('../../data/ICLOCS_PathConstrained_Data.lua');
ocp.setup('../../data/ICLOCS_PathConstrained_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ICLOCS_PathConstrained_Mex('set_tracked',obj,tracked);
...
%[Z,U] = ICLOCS_PathConstrained_Mex('get_raw_solution',obj);
%J     = ICLOCS_PathConstrained_Mex('eval_JF',obj,Z,U);
%f     = ICLOCS_PathConstrained_Mex('eval_F',obj,Z,U);
