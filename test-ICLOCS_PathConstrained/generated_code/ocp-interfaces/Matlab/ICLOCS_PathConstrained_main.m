...
ocp.setup('../../data/ICLOCS_PathConstrained_Data');  % automatically try extension .rb and .lua
...
%[Z,MU,U] = ICLOCS_PathConstrained_Mex('get_raw_solution',obj);
%J     = ICLOCS_PathConstrained_Mex('eval_JF',obj,Z,MU,U);
%f     = ICLOCS_PathConstrained_Mex('eval_F',obj,Z,MU,U);
