...
%ocp.setup('../../data/ICLOCS_SingularArc_Data.lua');
ocp.setup('../../data/ICLOCS_SingularArc_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = ICLOCS_SingularArc_Mex('get_raw_solution',obj);
%J     = ICLOCS_SingularArc_Mex('eval_JF',obj,Z,U);
%f     = ICLOCS_SingularArc_Mex('eval_F',obj,Z,U);
