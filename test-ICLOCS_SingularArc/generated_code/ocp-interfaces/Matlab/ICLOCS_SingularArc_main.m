%-----------------------------------------------------------------------%
%  file: ICLOCS_SingularArc_main.m                                      %
%                                                                       %
...
% create object
ocp = ICLOCS_SingularArc( 'ICLOCS_SingularArc' );
...
%ocp.setup(ICLOCS_SingularArc_data);
ocp.setup('../../data/ICLOCS_SingularArc_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ICLOCS_SingularArc_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = ICLOCS_SingularArc_Mex('get_raw_solution',obj);
%J     = ICLOCS_SingularArc_Mex('eval_JF',obj,Z,MU,U);
%f     = ICLOCS_SingularArc_Mex('eval_F',obj,Z,MU,U);
