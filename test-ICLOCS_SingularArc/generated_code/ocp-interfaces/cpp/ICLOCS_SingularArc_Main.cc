...
main() {
  ...
  try {
    ICLOCS_SingularArc * m_model = new ICLOCS_SingularArc("ICLOCS_SingularArc",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/ICLOCS_SingularArc_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/ICLOCS_SingularArc_Data.lua";
    #endif
