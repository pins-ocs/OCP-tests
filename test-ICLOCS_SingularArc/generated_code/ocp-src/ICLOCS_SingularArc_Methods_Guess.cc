...
namespace ICLOCS_SingularArcDefine {
  ...
  void
  ICLOCS_SingularArc::p_guess_eval( P_pointer_type P__ ) const {
  ...
  bool
  ICLOCS_SingularArc::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  ICLOCS_SingularArc::xlambda_check_cell(
    integer              icell,
  ...
  ICLOCS_SingularArc::u_guess_eval(
    ...
    UGUESS__[ iU_u ] = uControl.solve(-L__[iL_lambda1__xo] * P__[iP_T], -2, 2);
    if ( m_debug )
