...
namespace ICLOCS_SingularArcDefine {
  ...
  integer ICLOCS_SingularArc::JPxpu_numEqns() const { return 5; }

  void
  ICLOCS_SingularArc::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer ICLOCS_SingularArc::JUxpu_numEqns() const { return 5; }

  void
  ICLOCS_SingularArc::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
    ...
    result__[ 2   ] = 0;
    result__[ 3   ] = 0;
    result__[ 4   ] = ALIAS_uControl_D_1(U__[iU_u], -2, 2);
    if ( m_debug )
  ...
  integer ICLOCS_SingularArc::LTxpu_numEqns() const { return 5; }

  void
  ICLOCS_SingularArc::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
