...
namespace ICLOCS_SingularArcDefine {
  ...
  integer
  ICLOCS_SingularArc::boundaryConditions_numEqns() const
  { return 5; }
  ...
  integer
  ICLOCS_SingularArc::DboundaryConditionsDxxp_numRows() const
  { return 5; }

  integer
  ICLOCS_SingularArc::DboundaryConditionsDxxp_numCols() const
  { return 7; }

  integer
  ICLOCS_SingularArc::DboundaryConditionsDxxp_nnz() const
  { return 5; }

  void
  ICLOCS_SingularArc::DboundaryConditionsDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  integer
  ICLOCS_SingularArc::adjointBC_numEqns() const
  { return 7; }
  ...
  integer
  ICLOCS_SingularArc::DadjointBCDxxp_numRows() const
  { return 7; }

  integer
  ICLOCS_SingularArc::DadjointBCDxxp_numCols() const
  { return 7; }

  integer
  ICLOCS_SingularArc::DadjointBCDxxp_nnz() const
  { return 0; }

  void
  ICLOCS_SingularArc::DadjointBCDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  }
