/*-----------------------------------------------------------------------*\
 |  file: ICLOCS_SingularArc_dll_pins.hh                                 |
 |                                                                       |
...
namespace ICLOCS_SingularArcDefine {
  ...
  using namespace ICLOCS_SingularArcLoad;
  ...
  class ICLOCS_SingularArc_Problem {

    ICLOCS_SingularArc model;
    ...
    ICLOCS_SingularArc_Problem( ICLOCS_SingularArc_Problem const & );
    ICLOCS_SingularArc_Problem const & operator = ( ICLOCS_SingularArc_Problem const & );
  ...
  public:
    ...
    ICLOCS_SingularArc_Problem( integer n_threads, Console const * console )
    : model("ICLOCS_SingularArc",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "ICLOCS_SingularArc::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: ICLOCS_SingularArc_dll_pins.hh
