...
namespace DidoDefine {
  ...
  void
  Dido::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  Dido::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  Dido::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  integer Dido::u_guess_numEqns() const { return 1; }
