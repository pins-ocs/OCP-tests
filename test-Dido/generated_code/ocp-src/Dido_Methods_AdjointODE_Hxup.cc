...
namespace DidoDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Dido::DHxpDxpuv_numRows() const { return 2; }
  integer Dido::DHxpDxpuv_numCols() const { return 5; }
  integer Dido::DHxpDxpuv_nnz()     const { return 1; }

  void
  Dido::DHxpDxpuv_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 1   ; jIndex[0 ] = 2   ;
  }


  void
  Dido::DHxpDxpuv_sparse(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__,
