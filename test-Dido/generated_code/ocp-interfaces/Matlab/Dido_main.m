...
%ocp.setup(Dido_data);
ocp.setup('../../data/Dido_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Dido_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = Dido_Mex('get_raw_solution',obj);
%J     = Dido_Mex('eval_JF',obj,Z,MU,U);
%f     = Dido_Mex('eval_F',obj,Z,MU,U);
