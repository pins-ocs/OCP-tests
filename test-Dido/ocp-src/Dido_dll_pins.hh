...
namespace DidoDefine {
  ...
  class Dido_Problem {
    ...
    Dido_Problem( Dido_Problem const & );
    Dido_Problem const & operator = ( Dido_Problem const & );
  ...
  public:
    ...
    DIDO_API_DLL
    Dido_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("Dido",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "Dido::solver, fatal: unknown error";
      }
      return ok;
    }
