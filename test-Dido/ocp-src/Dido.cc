...
namespace DidoDefine {
  ...
  */
  void
  Dido::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  Dido::setup( GenericContainer const & gc ) {
  ...
  */
  void
  Dido::get_names( GenericContainer & out ) const {
  ...
  */
  void
  Dido::diagnostic( GenericContainer const & gc ) {
  ...
  void
  Dido::save_OCP_info( GenericContainer & gc ) const {
