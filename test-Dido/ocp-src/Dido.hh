...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef DIDO_API_DLL
    #ifdef DIDO_EXPORT
      #define DIDO_API_DLL __declspec(dllexport)
    #elif defined(DIDO_IMPORT)
      #define DIDO_API_DLL __declspec(dllimport)
    #else
      #define DIDO_API_DLL
    #endif
  #endif
...
namespace DidoDefine {
  ...
  class Dido : public Mechatronix::Discretized_Indirect_OCP {
    ...
    Dido( Dido const & );
    Dido const & operator = ( Dido const & );
  ...
  public:
    ...
    DIDO_API_DLL virtual
    ~Dido() MECHATRONIX_OVERRIDE;
