...
main() {
  ...
  try {
    ...
    BikeSteering     model("BikeSteering",n_threads,&console);
    ...
    gc_data["DumpFile"] = "BikeSteering_dump";
    ...
    // Model Parameters
    data_Parameters["Fmax"] = Fmax;
    data_Parameters["Ix"] = 40;
    data_Parameters["g"] = g;
    data_Parameters["h"] = 0.6;
    data_Parameters["m"] = m;
    ...
    data_Parameters["phi_f"] = 0.1745329252;
    ...
    GenericContainer & data_minimumTimeSize = data_Constraints["minimumTimeSize"];
    data_minimumTimeSize["subType"]   = "PENALTY_REGULAR";
    data_minimumTimeSize["epsilon"]   = 0.001;
    data_minimumTimeSize["tolerance"] = 0.001;
    data_minimumTimeSize["active"]    = true;
...
BikeSteering_data.Mesh["segments"][3]["n"] = 10;
    ...
    if ( ok ) {
      ...
      file.open( "data/BikeSteering_OCP_result_NOT_CONVERGED.txt" );
    }
    file.precision(18);
