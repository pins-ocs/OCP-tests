...
%ocp.setup(BikeSteering_data);
ocp.setup('../../data/BikeSteering_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%BikeSteering_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = BikeSteering_Mex('get_raw_solution',obj);
%J     = BikeSteering_Mex('eval_JF',obj,Z,MU,U);
%f     = BikeSteering_Mex('eval_F',obj,Z,MU,U);
