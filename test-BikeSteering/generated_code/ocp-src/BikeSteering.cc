...
namespace BikeSteeringDefine {
  ...
  */
  ...
  void
  BikeSteering::setup_parameters( real_type const Pars[] ) {
  ...
  */
  void
  BikeSteering::info_classes() const {
    int msg_level = 3;

    m_console->message("\nControls\n",msg_level);
    m_console->message( FyControl.info(),msg_level);

    m_console->message("\nConstraints LT\n",msg_level);
    m_console->message( minimumTimeSize.info(),msg_level);
