...
namespace BikeSteeringDefine {
  ...
  BikeSteering::H_eval(
    ...
    real_type result__ = t4 * t1 + t6 + t1 * (ModelPars[iM_h] * L__[iL_lambda2__xo] * (X__[iX_phi] * ModelPars[iM_g] * ModelPars[iM_m] - t2) + L__[iL_lambda1__xo] * X__[iX_omega]);
    return result__;
  }
#else
  real_type
  ...
  integer
  BikeSteering::DmayerDx_numEqns() const
  { return 6; }

  void
  BikeSteering::DmayerDx_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  BikeSteering::DmayerDp_numEqns() const
  { return 0; }

  void
  BikeSteering::DmayerDp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  BikeSteering::DJDx_numEqns() const
  { return 3; }

  void
  BikeSteering::DJDx_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_ptr             result__
    ...
    real_type t5   = FyControl(U__[iU_Fy], -t4, t4);
    result__[ 2   ] = t2 + t5;
    if ( m_debug )
  ...
  integer
  BikeSteering::DJDp_numEqns() const
  { return 0; }

  void
  BikeSteering::DJDp_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  BikeSteering::DJDu_numEqns() const
  { return 1; }

  void
  BikeSteering::DJDu_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  BikeSteering::jump_eval(
    ...
    result__[ 3   ] = -ModelPars[iM_Ix] * (LL__[iL_lambda2__xo] - LR__[iL_lambda2__xo]);
