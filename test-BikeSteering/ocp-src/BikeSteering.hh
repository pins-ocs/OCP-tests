...
#ifndef BIKESTEERING_DOT_HH
#define BIKESTEERING_DOT_HH
...
namespace BikeSteeringDefine {
  ...
  class BikeSteering : public Mechatronix::Discretized_Indirect_OCP {

    // Model Paramaters  - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    real_type ModelPars[9];

    // Controls  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    Mechatronix::PenaltyBarrierU FyControl;

    // Constraints 1D  - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    Mechatronix::PenaltyBarrier1DGreaterThan minimumTimeSize;
  ...
  public:
    ...
    BIKESTEERING_API_DLL virtual
    ~BikeSteering() MECHATRONIX_OVERRIDE;
