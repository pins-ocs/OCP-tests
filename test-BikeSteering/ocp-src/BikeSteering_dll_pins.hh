...
namespace BikeSteeringDefine {
  ...
  public:
    ...
    BikeSteering_Problem( ThreadPool * pTP, Console * pConsole )
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "BikeSteering::solver, fatal: unknown error";
      }
      return ok;
    }
