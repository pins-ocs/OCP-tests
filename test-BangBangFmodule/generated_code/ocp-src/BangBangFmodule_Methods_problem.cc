...
namespace BangBangFmoduleDefine {
  ...
  bool
  BangBangFmodule::penalties_check_cell(
  ...
  BangBangFmodule::H_eval(
    ...
    real_type result__ = t1 + t2 + L__[iL_lambda1__xo] * X__[iX_v] + (t1 - t2) * L__[iL_lambda2__xo];
    if ( m_debug ) {
  ...
  integer BangBangFmodule::DlagrangeDxup_numEqns() const { return 4; }

  void
  BangBangFmodule::DlagrangeDxup_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFmodule::D2lagrangeD2xup_numRows() const { return 4; }
  integer BangBangFmodule::D2lagrangeD2xup_numCols() const { return 4; }
  integer BangBangFmodule::D2lagrangeD2xup_nnz()     const { return 0; }

  void
  BangBangFmodule::D2lagrangeD2xup_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangFmodule::D2lagrangeD2xup_sparse(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer BangBangFmodule::DsegmentLinkDxp_numRows() const { return 0; }
  integer BangBangFmodule::DsegmentLinkDxp_numCols() const { return 0; }
  integer BangBangFmodule::DsegmentLinkDxp_nnz() const { return 0; }
