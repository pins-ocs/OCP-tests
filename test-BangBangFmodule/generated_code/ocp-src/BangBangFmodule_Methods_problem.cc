...
namespace BangBangFmoduleDefine {
  ...
  BangBangFmodule::H_eval(
    ...
    real_type result__ = t1 + t2 + MU__[0] * X__[iX_v] + (t1 - t2) * MU__[1];
    if ( m_debug ) {
  ...
  integer BangBangFmodule::DmayerDxxp_numEqns() const { return 4; }

  void
  BangBangFmodule::DmayerDxxp_eval(
    NodeQX const & LEFT__,
    NodeQX const & RIGHT__,
    P_const_p_type P__,
    real_ptr       result__
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFmodule::D2mayerD2xxp_numRows() const { return 4; }
  integer BangBangFmodule::D2mayerD2xxp_numCols() const { return 4; }
  integer BangBangFmodule::D2mayerD2xxp_nnz()     const { return 0; }

  void
  BangBangFmodule::D2mayerD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangFmodule::D2mayerD2xxp_sparse(
    NodeQX const & LEFT__,
    NodeQX const & RIGHT__,
    P_const_p_type P__,
    real_ptr       result__
  ...
  integer BangBangFmodule::DlagrangeDxpu_numEqns() const { return 4; }

  void
  BangBangFmodule::DlagrangeDxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFmodule::D2lagrangeD2xpu_numRows() const { return 4; }
  integer BangBangFmodule::D2lagrangeD2xpu_numCols() const { return 4; }
  integer BangBangFmodule::D2lagrangeD2xpu_nnz()     const { return 0; }

  void
  BangBangFmodule::D2lagrangeD2xpu_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangFmodule::D2lagrangeD2xpu_sparse(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer BangBangFmodule::segmentLink_numEqns() const { return 0; }
  ...
  integer BangBangFmodule::DsegmentLinkDxxp_numRows() const { return 0; }
  integer BangBangFmodule::DsegmentLinkDxxp_numCols() const { return 0; }
  integer BangBangFmodule::DsegmentLinkDxxp_nnz() const { return 0; }

  void
  BangBangFmodule::DsegmentLinkDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  BangBangFmodule::DsegmentLinkDxxp_sparse(
    NodeQX const & L,
    NodeQX const & R,
    P_const_p_type p,
  ...
  integer BangBangFmodule::jump_numEqns() const { return 4; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFmodule::DjumpDxlxlp_numRows() const { return 4; }
  integer BangBangFmodule::DjumpDxlxlp_numCols() const { return 8; }
  integer BangBangFmodule::DjumpDxlxlp_nnz()     const { return 8; }

  void
  BangBangFmodule::DjumpDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  integer BangBangFmodule::post_numEqns() const { return 5; }
  ...
  integer BangBangFmodule::integrated_post_numEqns() const { return 0; }
...
// EOF: BangBangFmodule_Methods_problem.cc
