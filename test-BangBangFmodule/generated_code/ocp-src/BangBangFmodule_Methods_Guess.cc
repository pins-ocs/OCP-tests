...
namespace BangBangFmoduleDefine {
  ...
  void
  BangBangFmodule::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  BangBangFmodule::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  BangBangFmodule::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  BangBangFmodule::xlambda_check_node(
    integer              ipos,
  ...
  bool
  BangBangFmodule::xlambda_check_cell(
    integer              icell,
  ...
  BangBangFmodule::u_guess_eval(
    ...
    UGUESS__[ iU_Fp ] = ModelPars[iM_FpMax] / 2;
    UGUESS__[ iU_Fm ] = ModelPars[iM_FmMax] / 2;
    if ( m_debug )
  ...
  bool
  BangBangFmodule::u_check_if_admissible(
    NodeType2 const    & NODE__,
    ...
    ok = ok && controlM.check_range(U__[iU_Fm], 0, ModelPars[iM_FmMax]);
    ok = ok && controlP.check_range(U__[iU_Fp], 0, ModelPars[iM_FpMax]);
    return ok;
  }
