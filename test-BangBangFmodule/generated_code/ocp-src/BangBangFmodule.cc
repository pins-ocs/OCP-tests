...
namespace BangBangFmoduleDefine {
  ...
  */
  ...
  void
  BangBangFmodule::setup_parameters( real_type const Pars[] ) {
  ...
  */
  void
  BangBangFmodule::info_classes() const {
    int msg_level = 3;

    m_console->message("\nControls\n",msg_level);
    m_console->message( controlP.info(),msg_level);
    m_console->message( controlM.info(),msg_level);
