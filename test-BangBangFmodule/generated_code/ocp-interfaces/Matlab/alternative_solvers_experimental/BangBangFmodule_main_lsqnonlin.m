...
ocp.setup('../../data/BangBangFmodule_Data'); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,U] = BangBangFmodule_Mex('get_raw_solution',obj);
%J     = BangBangFmodule_Mex('eval_JF',obj,Z,U);
%f     = BangBangFmodule_Mex('eval_F',obj,Z,U);
