%-----------------------------------------------------------------------%
%  file: BangBangFmodule_fsolve_main.m                                  %
%                                                                       %
...
ocp.setup( [DATA_PATH 'BangBangFmodule_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = BangBangFmodule_Mex('get_raw_solution',obj);
%J        = BangBangFmodule_Mex('eval_JF',obj,Z,MU,U);
%f        = BangBangFmodule_Mex('eval_F',obj,Z,MU,U);
