...
#ifndef BANGBANGFMODULE_DOT_HH
#define BANGBANGFMODULE_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef BANGBANGFMODULE_API_DLL
    #ifdef BANGBANGFMODULE_EXPORT
      #define BANGBANGFMODULE_API_DLL __declspec(dllexport)
    #elif defined(BANGBANGFMODULE_IMPORT)
      #define BANGBANGFMODULE_API_DLL __declspec(dllimport)
    #else
      #define BANGBANGFMODULE_API_DLL
    #endif
  #endif
...
namespace BangBangFmoduleDefine {
  ...
  class BangBangFmodule : public Mechatronix::Discretized_Indirect_OCP {

    // Model Paramaters  - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    real_type ModelPars[2];

    // Controls  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    Mechatronix::PenaltyBarrierU controlP;
    Mechatronix::PenaltyBarrierU controlM;
    ...
    BangBangFmodule( BangBangFmodule const & );
    BangBangFmodule const & operator = ( BangBangFmodule const & );
  ...
  public:
    ...
    BANGBANGFMODULE_API_DLL virtual
    ~BangBangFmodule() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    BANGBANGFMODULE_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "BangBangFmodule"; }
...
namespace BangBangFmoduleLoad {
  using BangBangFmoduleDefine::BangBangFmodule;

}

#endif

// EOF: BangBangFmodule.hh
