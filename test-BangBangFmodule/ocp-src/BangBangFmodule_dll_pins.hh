...
namespace BangBangFmoduleDefine {
  ...
  class BangBangFmodule_Problem {

    BangBangFmodule model;
    ...
    BangBangFmodule_Problem( BangBangFmodule_Problem const & );
    BangBangFmodule_Problem const & operator = ( BangBangFmodule_Problem const & );
  ...
  public:
    ...
    BangBangFmodule_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("BangBangFmodule",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "BangBangFmodule::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: BangBangFmodule_dll_pins.hh
