...
namespace BangBangFmoduleDefine {
  ...
  */
  void
  BangBangFmodule::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  BangBangFmodule::setupParameters( GenericContainer const & gc_data ) {
    LW_ASSERT0(
      gc_data.exists("Parameters"),
      "BangBangFmodule::setupParameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  BangBangFmodule::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  BangBangFmodule::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  BangBangFmodule::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  BangBangFmodule::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  BangBangFmodule::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    LW_ASSERT0(
      gc_data.exists("Controls"),
      "BangBangFmodule::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  BangBangFmodule::setupPointers( GenericContainer const & gc_data ) {

    LW_ASSERT0(
      gc_data.exists("Pointers"),
      "BangBangFmodule::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    LW_ASSERT0(
      gc.exists("pMesh"),
      "in BangBangFmodule::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  BangBangFmodule::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;

    pConsole->message("\nControls\n",msg_level);
    mstr.str(""); controlP.info(mstr);
    pConsole->message(mstr.str(),msg_level);
    mstr.str(""); controlM.info(mstr);
    pConsole->message(mstr.str(),msg_level);
  ...
  */
  void
  BangBangFmodule::diagnostic( GenericContainer const & gc ) {
