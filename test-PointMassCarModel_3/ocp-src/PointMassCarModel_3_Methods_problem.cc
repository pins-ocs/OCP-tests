...
namespace PointMassCarModel_3Define {
  ...
  PointMassCarModel_3::H_eval(
    ...
    real_type t31  = X__[iX_s];
    real_type t32  = ALIAS_leftWidth(t31);
    real_type t33  = X__[iX_n];
    real_type t35  = RoadLeftBorder(t32 - t33);
    real_type t36  = L__[iL_lambda3__xo];
    real_type t37  = ALIAS_Kappa(t31);
    real_type t41  = X__[iX_alpha];
    real_type t42  = zeta__dot(t13, t41, t33, t37);
    real_type t44  = ALIAS_rightWidth(t31);
    real_type t46  = RoadRightBorder(t44 + t33);
    real_type t47  = U__[iU_v__Omega];
    real_type t48  = v__OmegaControl(t47, -1, 1);
    real_type t49  = U__[iU_v__fx];
    real_type t50  = v__fxControl(t49, -1, 1);
    real_type t53  = sin(t41);
    real_type t70  = t22 + t30 + t35 + t42 * (-t37 * t36 + L__[iL_lambda1__xo]) + t46 + t48 + t50 + t53 * t13 * L__[iL_lambda2__xo] + t11 * t36 + (-t14 * ModelPars[iM_kD] + t1) * L__[iL_lambda4__xo] + ModelPars[iM_v__Omega__max] * t47 * L__[iL_lambda5__xo] + ModelPars[iM_v__fx__max] * t49 * L__[iL_lambda6__xo] + ModelPars[iM_wT];
    real_type t72  = X__[iX_sqrt_inv_Vseg] * X__[iX_sqrt_inv_Vseg];
    real_type result__ = t72 * t70;
    return result__;
  }
#else
  real_type
  ...
  PointMassCarModel_3::penalties_eval(
    ...
    real_type t4   = ALIAS_rightWidth(t3);
    real_type t5   = X__[iX_n];
    real_type t7   = RoadRightBorder(t4 + t5);
    real_type t8   = X__[iX_V];
    real_type t9   = X__[iX_fx];
    real_type t17  = PowerLimit(1 - ModelPars[iM_m] / ModelPars[iM_Pmax] * t9 * t8);
    real_type t18  = t9 * t9;
    ...
    real_type t28  = X__[iX_Omega] * X__[iX_Omega];
    real_type t29  = t8 * t8;
    real_type t32  = ModelPars[iM_mu__y__max] * ModelPars[iM_mu__y__max];
    real_type t37  = AdherenceEllipse(1 - t25 / t20 * t18 - t25 / t32 * t29 * t28);
    real_type t38  = ALIAS_leftWidth(t3);
    real_type t40  = RoadLeftBorder(t38 - t5);
    real_type result__ = (t7 + t17 + t37 + t40) * t2;
    if ( m_debug ) {
  ...
  integer
  PointMassCarModel_3::DmayerDx_numEqns() const
  { return 14; }

  void
  PointMassCarModel_3::DmayerDx_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  PointMassCarModel_3::DmayerDp_numEqns() const
  { return 0; }

  void
  PointMassCarModel_3::DmayerDp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  PointMassCarModel_3::DJDx_eval(
    ...
    real_type t10  = ALIAS_rightWidth(t3);
    real_type t11  = t10 + t5;
    real_type t12  = ALIAS_RoadRightBorder_D(t11);
    real_type t13  = ALIAS_rightWidth_D(t3);
    result__[ 0   ] = (t13 * t12 + t8 * t7) * t2;
    result__[ 1   ] = -(t7 - t12) * t2;
    result__[ 2   ] = 0;
    real_type t18  = X__[iX_fx];
    real_type t19  = t18 * t18;
    real_type t21  = ModelPars[iM_mu__x__max] * ModelPars[iM_mu__x__max];
    real_type t22  = 1.0 / t21;
    real_type t25  = ModelPars[iM_g] * ModelPars[iM_g];
    real_type t26  = 1.0 / t25;
    real_type t28  = X__[iX_Omega];
    real_type t29  = t28 * t28;
    real_type t30  = X__[iX_V];
    real_type t31  = t30 * t30;
    real_type t34  = ModelPars[iM_mu__y__max] * ModelPars[iM_mu__y__max];
    real_type t35  = 1.0 / t34;
    real_type t38  = -t26 * t35 * t31 * t29 - t26 * t22 * t19 + 1;
    real_type t39  = ALIAS_AdherenceEllipse_D(t38);
    real_type t40  = t39 * t2;
    real_type t47  = ModelPars[iM_m];
    real_type t49  = 1.0 / ModelPars[iM_Pmax];
    real_type t52  = -t49 * t47 * t18 * t30 + 1;
    real_type t53  = ALIAS_PowerLimit_D(t52);
    real_type t54  = t53 * t2;
    result__[ 3   ] = -2 * t26 * t35 * t30 * t29 * t40 - t49 * t47 * t18 * t54;
    result__[ 4   ] = -2 * t26 * t35 * t31 * t28 * t40;
    result__[ 5   ] = -2 * t26 * t22 * t18 * t40 - t49 * t47 * t30 * t54;
    real_type t70  = AdherenceEllipse(t38);
    real_type t71  = RoadLeftBorder(t6);
    real_type t72  = RoadRightBorder(t11);
    real_type t73  = PowerLimit(t52);
    real_type t75  = v__fxControl(U__[iU_v__fx], -1, 1);
    real_type t77  = v__OmegaControl(U__[iU_v__Omega], -1, 1);
    result__[ 6   ] = 2 * (t70 + t71 + t72 + t73 + t75 + t77) * t1;
    if ( m_debug )
