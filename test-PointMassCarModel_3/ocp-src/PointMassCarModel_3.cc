...
namespace PointMassCarModel_3Define {
  ...
  */
  void
  PointMassCarModel_3::updateContinuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
    ...
    UTILS_ASSERT(
      0 <= old_s && old_s < s && s <= 1,
      "PointMassCarModel_3::updateContinuation( phase number={}, old_s={}, s={} ) "
      "must be 0 <= old_s < s <= 1\n",
      phase, old_s, s
    );
    switch ( phase ) {
  ...
  */
  void
  PointMassCarModel_3::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "PointMassCarModel_3::setupParameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  PointMassCarModel_3::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  PointMassCarModel_3::setupClasses( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Constraints"),
      "PointMassCarModel_3::setupClasses: Missing key `Parameters` in data\n"
    );
    GenericContainer const & gc = gc_data("Constraints");
    // Initialize Constraints 1D
    UTILS_ASSERT0(
      gc.exists("AdherenceEllipse"),
      "in PointMassCarModel_3::setupClasses(gc) missing key: ``AdherenceEllipse''\n"
    );
    AdherenceEllipse.setup( gc("AdherenceEllipse") );

    UTILS_ASSERT0(
      gc.exists("RoadLeftBorder"),
      "in PointMassCarModel_3::setupClasses(gc) missing key: ``RoadLeftBorder''\n"
    );
    RoadLeftBorder.setup( gc("RoadLeftBorder") );

    UTILS_ASSERT0(
      gc.exists("RoadRightBorder"),
      "in PointMassCarModel_3::setupClasses(gc) missing key: ``RoadRightBorder''\n"
    );
    RoadRightBorder.setup( gc("RoadRightBorder") );

    UTILS_ASSERT0(
      gc.exists("PowerLimit"),
      "in PointMassCarModel_3::setupClasses(gc) missing key: ``PowerLimit''\n"
    );
  ...
  */
  void
  PointMassCarModel_3::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  PointMassCarModel_3::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  PointMassCarModel_3::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "PointMassCarModel_3::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  PointMassCarModel_3::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "PointMassCarModel_3::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pRoad"),
      "in PointMassCarModel_3::setupPointers(gc) cant find key `pRoad' in gc\n"
    );
  ...
  */
  void
  PointMassCarModel_3::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  PointMassCarModel_3::diagnostic( GenericContainer const & gc ) {
