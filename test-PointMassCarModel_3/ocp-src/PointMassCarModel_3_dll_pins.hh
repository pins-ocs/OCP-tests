/*-----------------------------------------------------------------------*\
 |  file: PointMassCarModel_3_dll_pins.hh                                |
 |                                                                       |
...
namespace PointMassCarModel_3Define {
  ...
  class PointMassCarModel_3_Problem {

    PointMassCarModel_3 model;
    ...
    PointMassCarModel_3_Problem( PointMassCarModel_3_Problem const & );
    PointMassCarModel_3_Problem const & operator = ( PointMassCarModel_3_Problem const & );
  ...
  public:
    ...
    PointMassCarModel_3_Problem( ThreadPool * TP, Console const * console )
    : model("PointMassCarModel_3",TP,console)
    , road( "road" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "PointMassCarModel_3::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: PointMassCarModel_3_dll_pins.hh
