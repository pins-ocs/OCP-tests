...
namespace PointMassCarModel_3Define {
  ...
  public:
    ...
    ~PointMassCarModel_3() MECHATRONIX_OVERRIDE;
    ...
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot      ( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_1  ( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_1_1( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_1_2( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_1_3( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_1_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_2  ( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_2_2( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_2_3( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_2_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_3  ( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_3_3( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_3_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_4  ( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_3_API_DLL real_type zeta__dot_D_4_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
