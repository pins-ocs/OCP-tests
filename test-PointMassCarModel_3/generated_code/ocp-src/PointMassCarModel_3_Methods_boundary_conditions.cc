...
namespace PointMassCarModel_3Define {
  ...
  integer PointMassCarModel_3::boundaryConditions_numEqns() const { return 8; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_3::DboundaryConditionsDxxp_numRows() const { return 8; }
  integer PointMassCarModel_3::DboundaryConditionsDxxp_numCols() const { return 14; }
  integer PointMassCarModel_3::DboundaryConditionsDxxp_nnz()     const { return 13; }

  void
  PointMassCarModel_3::DboundaryConditionsDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  PointMassCarModel_3::DboundaryConditionsDxxp_sparse(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
    ...
    result__[ 12  ] = 1;
    if ( m_debug )
      Mechatronix::check_in_segment2( result__, "DboundaryConditionsDxxp_sparse", 13, i_segment_left, i_segment_right );
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  integer PointMassCarModel_3::adjointBC_numEqns() const { return 14; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_3::DadjointBCDxxp_numRows() const { return 14; }
  integer PointMassCarModel_3::DadjointBCDxxp_numCols() const { return 14; }
  integer PointMassCarModel_3::DadjointBCDxxp_nnz()     const { return 0; }

  void
  PointMassCarModel_3::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  PointMassCarModel_3::DadjointBCDxxp_sparse(
    NodeType const              & LEFT__,
    NodeType const              & RIGHT__,
    P_const_pointer_type          P__,
    OMEGA_full_const_pointer_type OMEGA__,
