...
namespace PointMassCarModel_3Define {
  ...
  integer
  PointMassCarModel_3::DboundaryConditionsDxxp_numRows() const
  { return 8; }

  integer
  PointMassCarModel_3::DboundaryConditionsDxxp_numCols() const
  { return 14; }

  integer
  PointMassCarModel_3::DboundaryConditionsDxxp_nnz() const
  { return 13; }

  void
  PointMassCarModel_3::DboundaryConditionsDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  integer
  PointMassCarModel_3::DadjointBCDxxp_numRows() const
  { return 14; }

  integer
  PointMassCarModel_3::DadjointBCDxxp_numCols() const
  { return 14; }

  integer
  PointMassCarModel_3::DadjointBCDxxp_nnz() const
  { return 0; }

  void
  PointMassCarModel_3::DadjointBCDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  }
