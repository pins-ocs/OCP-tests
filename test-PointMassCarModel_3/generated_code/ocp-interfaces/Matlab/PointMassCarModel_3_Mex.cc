...
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_4);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_1_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_1_4);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_2_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_2_4);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_3_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_3_4);
DO_COMMAND_REMAP_TO_CLASS_METHOD(zeta__dot_D_4_4);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "PointMassCarModel_3_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "PointMassCarModel_3_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
