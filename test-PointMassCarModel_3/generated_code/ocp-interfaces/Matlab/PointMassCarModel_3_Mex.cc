...
public:
...

  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "PointMassCarModel_3_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "PointMassCarModel_3_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
...

  {
    ...
    try {
      ...
      string msg = fmt::format( "PointMassCarModel_3_Mex('eval_F',...) error: {}", exc.what() );
      mexWarnMsgTxt( msg.c_str() );
      ok = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "PointMassCarModel_3_Mex('eval_F',...) unkown error\n" );
      ok = false;
    }
...

  {
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "PointMassCarModel_3_Mex('eval_JF',...) error: {}", exc.what() ).c_str() );
      ok_value = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "PointMassCarModel_3_Mex('eval_JF',...) unkown error\n" );
      ok_value = false;
    }
    int ok = mexCallMATLAB( 1, &arg_out_0, 5, args, "sparse" );
    UTILS_MEX_ASSERT0( ok == 0, CMD "failed the call sparse(...)" );
  ...
  do_zeta__dot(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
  ...
  do_zeta__dot_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_1', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_2', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_3(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_3', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_4(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_4', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_1_1', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_1_2', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_1_3(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_1_3', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_1_4(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_1_4', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_2_2', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_2_3(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_2_3', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_2_4(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_2_4', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_3_3(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_3_3', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_3_4(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_3_4', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
  ...
  do_zeta__dot_D_4_4(
    ...
    #define CMD MODEL_NAME "_Mex('zeta__dot_D_4_4', obj, xo__V, xo__alpha, xo__n, xo__Kappa ): "
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
...
do_zeta__dot(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_3(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_4(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_4( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_1_1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_1_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_1_3(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_1_4(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_1_4( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_2_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_2_3(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_2_4(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_2_4( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_3_3(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_3_3( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_3_4(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_3_4( nlhs, plhs, nrhs, prhs );
}
...
do_zeta__dot_D_4_4(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_zeta__dot_D_4_4( nlhs, plhs, nrhs, prhs );
}
