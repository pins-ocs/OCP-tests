...
public:
  ...
  do_eval_F(
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "PointMassCarModel_3_Mex('eval_F',...) error: {}", exc.what() ).c_str() );
      ok = false;
    } catch ( ... ) {
  ...
  do_zeta__dot(
    ...
    CHECK_IN_OUT( 6, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__V" );
    mwSize N1, M1;
    real_const_ptr arg1 = getMatrixPointer( arg_in_3, N1, M1, CMD " xo__alpha" );
    MEX_CHECK_DIMS(N1,M1,N0,M0);
    mwSize N2, M2;
    real_const_ptr arg2 = getMatrixPointer( arg_in_4, N2, M2, CMD " xo__n" );
    MEX_CHECK_DIMS(N2,M2,N0,M0);
    mwSize N3, M3;
    real_const_ptr arg3 = getMatrixPointer( arg_in_5, N3, M3, CMD " xo__Kappa" );
