%-----------------------------------------------------------------------%
%  file: PointMassCarModel_3_main.m                                     %
%                                                                       %
...
% create object
ocp = PointMassCarModel_3( 'PointMassCarModel_3' );
...
%ocp.setup(PointMassCarModel_3_data);
ocp.setup('../../data/PointMassCarModel_3_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%PointMassCarModel_3_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = PointMassCarModel_3_Mex('get_raw_solution',obj);
%J     = PointMassCarModel_3_Mex('eval_JF',obj,Z,MU,U);
%f     = PointMassCarModel_3_Mex('eval_F',obj,Z,MU,U);
