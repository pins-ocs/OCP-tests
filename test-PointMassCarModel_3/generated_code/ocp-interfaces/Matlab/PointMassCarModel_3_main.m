...
%ocp.setup('../../data/PointMassCarModel_3_Data.lua');
ocp.setup('../../data/PointMassCarModel_3_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = PointMassCarModel_3_Mex('get_raw_solution',obj);
%J     = PointMassCarModel_3_Mex('eval_JF',obj,Z,U);
%f     = PointMassCarModel_3_Mex('eval_F',obj,Z,U);
