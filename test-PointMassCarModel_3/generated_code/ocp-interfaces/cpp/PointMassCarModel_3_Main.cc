...
main() {
  ...
  try {
    PointMassCarModel_3 * m_model = new PointMassCarModel_3("PointMassCarModel_3",n_threads,&console);

    // user defined Object instances (external)
    Road2D           road( "road" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/PointMassCarModel_3_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/PointMassCarModel_3_Data.lua";
    #endif
