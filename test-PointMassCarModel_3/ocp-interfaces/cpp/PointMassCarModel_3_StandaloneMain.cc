...
main() {
  ...
  try {
    ...
    gc_data["DumpFile"] = "PointMassCarModel_3_dump";
    ...
    // PenaltyBarrier1DGreaterThan
    GenericContainer & data_Spos = data_Constraints["Spos"];
    data_Spos["subType"]   = "PENALTY_REGULAR";
    data_Spos["epsilon"]   = p_epsi0;
    data_Spos["tolerance"] = p_tol0;
    data_Spos["active"]    = true;
    // PenaltyBarrier1DGreaterThan
    GenericContainer & data_Tmin = data_Constraints["Tmin"];
    data_Tmin["subType"]   = "PENALTY_REGULAR";
    data_Tmin["epsilon"]   = p_epsi0;
    data_Tmin["tolerance"] = p_tol0;
    data_Tmin["active"]    = true;
    // Constraint2D: none defined

    // User defined classes initialization
    // User defined classes: R O A D
PointMassCarModel_3_data.Road["theta0"] = 0;
PointMassCarModel_3_data.Road["s0"] = 0;
PointMassCarModel_3_data.Road["x0"] = 0;
...
PointMassCarModel_3_data.Road["segments"][9]["gridSize"] = 0.1;
    ...
    std::ofstream file;
    if ( ok ) {
      file.open( "data/PointMassCarModel_3_OCP_result.txt" );
    } else {
      cout << gc_solution("solver_message").get_string() << '\n';
      // dump solution to file
      file.open( "data/PointMassCarModel_3_OCP_not_converged.txt" );
    }
    file.precision(18);
