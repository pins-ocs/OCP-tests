...
#ifndef CRISTIANIMARTINON_DOT_HH
#define CRISTIANIMARTINON_DOT_HH
...
// User Header (end)
  ...
  #ifndef CRISTIANIMARTINON_API_DLL
    #ifdef CRISTIANIMARTINON_EXPORT
      #define CRISTIANIMARTINON_API_DLL __declspec(dllexport)
    #elif defined(CRISTIANIMARTINON_IMPORT)
      #define CRISTIANIMARTINON_API_DLL __declspec(dllimport)
    #else
      #define CRISTIANIMARTINON_API_DLL
    #endif
  #endif
...
namespace CristianiMartinonDefine {
  ...
  class CristianiMartinon : public Mechatronix::Discretized_Indirect_OCP {
    ...
    Mechatronix::PositivePartRegularizedWithErf pos;
    ...
    CristianiMartinon( CristianiMartinon const & );
    CristianiMartinon const & operator = ( CristianiMartinon const & );
  ...
  public:
    ...
    CRISTIANIMARTINON_API_DLL real_type cfun        ( real_type xo__x, real_type xo__y ) const;
    CRISTIANIMARTINON_API_DLL real_type cfun_D_1    ( real_type xo__x, real_type xo__y ) const;
    CRISTIANIMARTINON_API_DLL real_type cfun_D_1_1  ( real_type xo__x, real_type xo__y ) const;
    CRISTIANIMARTINON_API_DLL real_type cfun_D_1_2  ( real_type xo__x, real_type xo__y ) const;
    CRISTIANIMARTINON_API_DLL real_type cfun_D_2    ( real_type xo__x, real_type xo__y ) const;
    CRISTIANIMARTINON_API_DLL real_type cfun_D_2_2  ( real_type xo__x, real_type xo__y ) const;
    CRISTIANIMARTINON_API_DLL real_type yguess      ( real_type xo__zeta ) const;
    CRISTIANIMARTINON_API_DLL real_type yguess_D    ( real_type xo__zeta ) const;
    CRISTIANIMARTINON_API_DLL real_type yguess_DD   ( real_type xo__zeta ) const;
    CRISTIANIMARTINON_API_DLL real_type xguess      ( real_type xo__zeta ) const;
    CRISTIANIMARTINON_API_DLL real_type xguess_D    ( real_type xo__zeta ) const;
    CRISTIANIMARTINON_API_DLL real_type xguess_DD   ( real_type xo__zeta ) const;
...
namespace CristianiMartinonLoad {
  using CristianiMartinonDefine::CristianiMartinon;

}

#endif

// EOF: CristianiMartinon.hh
