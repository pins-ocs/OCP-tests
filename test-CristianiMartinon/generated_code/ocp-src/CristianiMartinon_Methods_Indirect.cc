/*-----------------------------------------------------------------------*\
 |  file: CristianiMartinon_Methods_Guess.cc                             |
 |                                                                       |
...
namespace CristianiMartinonDefine {
  ...
  integer CristianiMartinon::eta_numEqns() const { return 2; }

  void
  CristianiMartinon::eta_eval(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer CristianiMartinon::DetaDxp_numRows() const { return 2; }
  integer CristianiMartinon::DetaDxp_numCols() const { return 3; }
  integer CristianiMartinon::DetaDxp_nnz()     const { return 0; }

  void
  CristianiMartinon::DetaDxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
  ...
  void
  CristianiMartinon::DetaDxp_sparse(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    real_ptr        result__
  ...
  void
  CristianiMartinon::node_LR_to_cell(
    NodeQX const & LEFT,
    NodeQX const & RIGHT,
    NodeQX       & NODE
  ) const {
...
// EOF: CristianiMartinon_Methods_Guess.cc
