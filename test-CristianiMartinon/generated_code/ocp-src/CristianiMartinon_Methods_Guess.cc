...
namespace CristianiMartinonDefine {
  ...
  void
  CristianiMartinon::p_guess_eval( P_p_type P__ ) const {
  ...
  void
  CristianiMartinon::xlambda_guess_eval(
    integer        i_segment,
    Q_const_p_type Q__,
    P_const_p_type P__,
    X_p_type       X__,
  ...
  bool
  CristianiMartinon::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  CristianiMartinon::xlambda_check_node(
    integer         ipos,
  ...
  bool
  CristianiMartinon::penalties_check(
    NodeQX const & NODE__,
    P_const_p_type P__
  ) const {
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    bool ok = true;
    ok = ok && Tpositive.check_range(-P__[iP_T]);
    return ok;
  }
  ...
  integer CristianiMartinon::u_guess_numEqns() const { return 1; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  CristianiMartinon::u_guess_eval(
    NodeQXL const & NODE__,
    P_const_p_type  P__,
  ...
  bool
  CristianiMartinon::u_check_if_admissible(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__
