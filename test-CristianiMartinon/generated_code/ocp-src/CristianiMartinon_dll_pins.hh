/*-----------------------------------------------------------------------*\
 |  file: CristianiMartinon_dll_pins.hh                                  |
 |                                                                       |
...
namespace CristianiMartinonDefine {
  ...
  class CristianiMartinon_Problem {

    CristianiMartinon m_model;
    ...
    CristianiMartinon_Problem( CristianiMartinon_Problem const & );
    CristianiMartinon_Problem const & operator = ( CristianiMartinon_Problem const & );
  ...
  public:
    ...
    CristianiMartinon_Problem(
      Console const  * console,
      ThreadPoolBase * TP
    )
    : m_model("CristianiMartinon",console,TP)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "CristianiMartinon::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: CristianiMartinon_dll_pins.hh
