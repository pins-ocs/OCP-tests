...
"CristianiMartinon_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;
...
DO_COMMAND_REMAP_TO_CLASS_METHOD(cfun);
DO_COMMAND_REMAP_TO_CLASS_METHOD(cfun_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(cfun_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(cfun_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(cfun_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(cfun_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(yguess);
DO_COMMAND_REMAP_TO_CLASS_METHOD(yguess_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(xguess);
DO_COMMAND_REMAP_TO_CLASS_METHOD(xguess_D);
...
static std::unordered_map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"cfun",do_cfun},
  {"cfun_D_1",do_cfun_D_1},
  {"cfun_D_2",do_cfun_D_2},
  {"cfun_D_1_1",do_cfun_D_1_1},
  {"cfun_D_1_2",do_cfun_D_1_2},
  {"cfun_D_2_2",do_cfun_D_2_2},
  {"yguess",do_yguess},
  {"yguess_D",do_yguess_D},
  {"xguess",do_xguess},
  {"xguess_D",do_xguess_D},
  {"new",do_new},
  {"delete",do_delete},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "CristianiMartinon_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "CristianiMartinon_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
