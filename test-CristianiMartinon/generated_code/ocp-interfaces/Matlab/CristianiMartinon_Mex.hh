...
using namespace CristianiMartinonLoad;
using namespace GenericContainerNamespace;
using namespace MechatronixLoad;

#define MODEL_NAME  "CristianiMartinon"
#define MODEL_CLASS CristianiMartinon
...
public:
  ...
  void do_cfun( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_cfun_D_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_cfun_D_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_cfun_D_1_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_cfun_D_1_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_cfun_D_2_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_yguess( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_yguess_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_yguess_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_xguess( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_xguess_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_xguess_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
