...
% create object
ocp = CristianiMartinon( 'CristianiMartinon' );
...
%ocp.setup(CristianiMartinon_data);
ocp.setup('../../data/CristianiMartinon_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%CristianiMartinon_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = CristianiMartinon_Mex('get_raw_solution',obj);
%J     = CristianiMartinon_Mex('eval_JF',obj,Z,MU,U);
%f     = CristianiMartinon_Mex('eval_F',obj,Z,MU,U);
