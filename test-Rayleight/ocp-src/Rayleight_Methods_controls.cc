...
namespace RayleightDefine {
  ...
  integer
  Rayleight::DgDxlp_numRows() const
  { return 1; }

  integer
  Rayleight::DgDxlp_numCols() const
  { return 4; }

  integer
  Rayleight::DgDxlp_nnz() const
  { return 1; }

  void
  Rayleight::DgDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  \*/
  void
  Rayleight::DuDxlp_full_analytic(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
  ...
  void
  Rayleight::DsegmentLinkDxp_sparse(
    NodeType const     & L,
    NodeType const     & R,
    P_const_pointer_type p,
  ...
  integer
  Rayleight::DjumpDxlp_numRows() const
  { return 4; }

  integer
  Rayleight::DjumpDxlp_numCols() const
  { return 8; }

  integer
  Rayleight::DjumpDxlp_nnz() const
  { return 8; }

  void
  Rayleight::DjumpDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
    iIndex[ 0  ] = 0   ; jIndex[ 0  ] = 0   ;
