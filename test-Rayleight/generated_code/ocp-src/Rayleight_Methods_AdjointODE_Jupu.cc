...
namespace RayleightDefine {
  ...
  integer Rayleight::JPxpu_numEqns() const { return 3; }

  void
  Rayleight::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer Rayleight::JUxpu_numEqns() const { return 3; }

  void
  Rayleight::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer Rayleight::LTxpu_numEqns() const { return 3; }

  void
  Rayleight::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
