...
namespace RayleightDefine {
  ...
  class Rayleight_Problem {
    ...
    Rayleight_Problem( Rayleight_Problem const & );
    Rayleight_Problem const & operator = ( Rayleight_Problem const & );
  ...
  public:
    ...
    RAYLEIGHT_API_DLL
    Rayleight_Problem( integer n_threads, Console const * console )
    : model("Rayleight",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "Rayleight::solver, fatal: unknown error";
      }
      return ok;
    }
