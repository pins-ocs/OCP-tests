...
%ocp.setup(Rayleight_data);
ocp.setup('../../data/Rayleight_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Rayleight_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = Rayleight_Mex('get_raw_solution',obj);
%J     = Rayleight_Mex('eval_JF',obj,Z,MU,U);
%f     = Rayleight_Mex('eval_F',obj,Z,MU,U);
