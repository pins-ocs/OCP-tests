...
main() {
  ...
  try {
    ...
    Rayleight        model("Rayleight",n_threads,&console);
...
Rayleight_data.Mesh["s0"] = 0;
Rayleight_data.Mesh["segments"][0]["n"] = 1000;
Rayleight_data.Mesh["segments"][0]["length"] = 2.5;
    ...
    if ( ok ) {
      ...
      file.open( "data/Rayleight_OCP_result_NOT_CONVERGED.txt" );
    }
    file.precision(18);
