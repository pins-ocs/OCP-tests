...
#ifndef FORWARDBACKWARD_DOT_HH
#define FORWARDBACKWARD_DOT_HH
...
// User Header (end)
  ...
  #ifndef FORWARDBACKWARD_API_DLL
    #ifdef FORWARDBACKWARD_EXPORT
      #define FORWARDBACKWARD_API_DLL __declspec(dllexport)
    #elif defined(FORWARDBACKWARD_IMPORT)
      #define FORWARDBACKWARD_API_DLL __declspec(dllimport)
    #else
      #define FORWARDBACKWARD_API_DLL
    #endif
  #endif
...
namespace ForwardBackwardDefine {
  ...
  class ForwardBackward : public Mechatronix::Discretized_Indirect_OCP {

    // Model Paramaters  - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    real_type ModelPars[22];

    // Controls  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

    // Constraints LT  - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    Mechatronix::PenaltyBarrier1DLessThan LimitV_min;
    Mechatronix::PenaltyBarrier1DLessThan LimitV_max;
    Mechatronix::PenaltyBarrier1DLessThan LimitA_min;
    Mechatronix::PenaltyBarrier1DLessThan LimitA_max;
    Mechatronix::PenaltyBarrier1DLessThan LimitE;
  ...
  public:
    ...
    FORWARDBACKWARD_API_DLL real_type LimitV      ( real_type xo___V ) const;
    FORWARDBACKWARD_API_DLL real_type LimitV_D    ( real_type xo___V ) const;
    FORWARDBACKWARD_API_DLL real_type LimitV_DD   ( real_type xo___V ) const;
    FORWARDBACKWARD_API_DLL real_type LimitA      ( real_type xo___V ) const;
    FORWARDBACKWARD_API_DLL real_type LimitA_D    ( real_type xo___V ) const;
    FORWARDBACKWARD_API_DLL real_type LimitA_DD   ( real_type xo___V ) const;
...
namespace ForwardBackwardLoad {
  using ForwardBackwardDefine::ForwardBackward;

}

#endif

// EOF: ForwardBackward.hh
