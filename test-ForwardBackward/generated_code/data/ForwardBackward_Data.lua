...
content = {
  ...
  -- Barrier subtype: BARRIER_1X, BARRIER_LOG, BARRIER_LOG_EXP, BARRIER_LOG0
    ...
    LimitV_minsubType   = "BARRIER_LOG0",
    LimitV_minepsilon   = v_epsi,
    LimitV_mintolerance = v_tol,
    LimitV_minactive    = true

    -- PenaltyBarrier1DLessThan
    LimitV_maxsubType   = "BARRIER_LOG0",
    LimitV_maxepsilon   = v_epsi,
    LimitV_maxtolerance = v_tol,
    LimitV_maxactive    = true

    -- PenaltyBarrier1DLessThan
    LimitA_minsubType   = "BARRIER_LOG0",
    LimitA_minepsilon   = a_epsi,
    LimitA_mintolerance = a_tol,
    LimitA_minactive    = true

    -- PenaltyBarrier1DLessThan
    LimitA_maxsubType   = "BARRIER_LOG0",
    LimitA_maxepsilon   = a_epsi,
    LimitA_maxtolerance = a_tol,
    LimitA_maxactive    = true

    -- PenaltyBarrier1DLessThan
    LimitEsubType   = "BARRIER_LOG0",
    LimitEepsilon   = E_epsi,
    LimitEtolerance = E_tol,
    LimitEactive    = true
  ...
  dofile('../../model/trajectory_data.rb')
