...
#define MODEL_NAME  "ForwardBackward"
#define MODEL_CLASS ForwardBackward
...
public:
  ...
  void do_LimitV( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_LimitV_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_LimitV_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_LimitA( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_LimitA_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_LimitA_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
