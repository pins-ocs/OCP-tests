...
"ForwardBackward_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;
...
DO_COMMAND_REMAP_TO_CLASS_METHOD(LimitV);
DO_COMMAND_REMAP_TO_CLASS_METHOD(LimitV_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(LimitA);
DO_COMMAND_REMAP_TO_CLASS_METHOD(LimitA_D);
...
static std::unordered_map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"LimitV",do_LimitV},
  {"LimitV_D",do_LimitV_D},
  {"LimitA",do_LimitA},
  {"LimitA_D",do_LimitA_D},
  {"new",do_new},
  {"delete",do_delete},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "ForwardBackward_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "ForwardBackward_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
