...
% create object
ocp = ForwardBackward( 'ForwardBackward' );
...
%ocp.setup(ForwardBackward_data);
ocp.setup('../../data/ForwardBackward_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ForwardBackward_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = ForwardBackward_Mex('get_raw_solution',obj);
%J     = ForwardBackward_Mex('eval_JF',obj,Z,MU,U);
%f     = ForwardBackward_Mex('eval_F',obj,Z,MU,U);
