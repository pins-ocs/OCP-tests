...
namespace SingularMarchalDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SingularMarchal::DHxpDxpu_numRows() const { return 2; }
  integer SingularMarchal::DHxpDxpu_numCols() const { return 3; }
  integer SingularMarchal::DHxpDxpu_nnz()     const { return 1; }

  void
  SingularMarchal::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
  }


  void
  SingularMarchal::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
