...
namespace SingularMarchalDefine {
  ...
  integer SingularMarchal::Hxp_numEqns() const { return 2; }

  void
  SingularMarchal::Hxp_eval(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SingularMarchal::DHxpDxpuv_numRows() const { return 2; }
  integer SingularMarchal::DHxpDxpuv_numCols() const { return 5; }
  integer SingularMarchal::DHxpDxpuv_nnz()     const { return 2; }

  void
  SingularMarchal::DHxpDxpuv_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  SingularMarchal::DHxpDxpuv_sparse(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__,
