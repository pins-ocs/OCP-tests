...
namespace SingularMarchalDefine {
  ...
  integer SingularMarchal::fd_ode_numEqns() const { return 2; }

  void
  SingularMarchal::fd_ode_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SingularMarchal::Dfd_odeDxxup_numRows() const { return 2; }
  integer SingularMarchal::Dfd_odeDxxup_numCols() const { return 5; }
  integer SingularMarchal::Dfd_odeDxxup_nnz()     const { return 7; }

  void
  SingularMarchal::Dfd_odeDxxup_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  SingularMarchal::Dfd_odeDxxup_sparse(
    NodeType const &     LEFT__,
    NodeType const &     RIGHT__,
    P_const_pointer_type P__,
    U_const_pointer_type UM__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SingularMarchal::D2fd_odeD2xxup_numRows() const { return 5; }
  integer SingularMarchal::D2fd_odeD2xxup_numCols() const { return 5; }
  integer SingularMarchal::D2fd_odeD2xxup_nnz()     const { return 0; }

  void
  SingularMarchal::D2fd_odeD2xxup_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  SingularMarchal::D2fd_odeD2xxup_sparse(
    NodeType const &     LEFT__,
    NodeType const &     RIGHT__,
    P_const_pointer_type P__,
    U_const_pointer_type UM__,
