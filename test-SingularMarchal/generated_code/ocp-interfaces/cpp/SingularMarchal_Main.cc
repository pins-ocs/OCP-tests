...
main() {
  ...
  try {
    SingularMarchal * m_model = new SingularMarchal("SingularMarchal",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/SingularMarchal_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/SingularMarchal_Data.lua";
    #endif
