...
ocp.setup( [DATA_PATH 'SingularMarchal_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = SingularMarchal_Mex('get_raw_solution',obj);
%J        = SingularMarchal_Mex('eval_JF',obj,Z,MU,U);
%f        = SingularMarchal_Mex('eval_F',obj,Z,MU,U);
