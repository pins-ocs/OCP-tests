...
namespace SingularMarchalDefine {
  ...
  */
  void
  SingularMarchal::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  SingularMarchal::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "SingularMarchal::setupParameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  SingularMarchal::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  SingularMarchal::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  SingularMarchal::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  SingularMarchal::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  SingularMarchal::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "SingularMarchal::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  SingularMarchal::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "SingularMarchal::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in SingularMarchal::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  SingularMarchal::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  SingularMarchal::diagnostic( GenericContainer const & gc ) {
