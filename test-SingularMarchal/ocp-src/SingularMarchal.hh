...
#ifndef SINGULARMARCHAL_DOT_HH
#define SINGULARMARCHAL_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef SINGULARMARCHAL_API_DLL
    #ifdef SINGULARMARCHAL_EXPORT
      #define SINGULARMARCHAL_API_DLL __declspec(dllexport)
    #elif defined(SINGULARMARCHAL_IMPORT)
      #define SINGULARMARCHAL_API_DLL __declspec(dllimport)
    #else
      #define SINGULARMARCHAL_API_DLL
    #endif
  #endif
...
namespace SingularMarchalDefine {
  ...
  class SingularMarchal : public Mechatronix::Discretized_Indirect_OCP {
    ...
    SingularMarchal( SingularMarchal const & );
    SingularMarchal const & operator = ( SingularMarchal const & );
  ...
  public:
    ...
    SINGULARMARCHAL_API_DLL virtual
    ~SingularMarchal() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    SINGULARMARCHAL_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "SingularMarchal"; }
...
namespace SingularMarchalLoad {
  using SingularMarchalDefine::SingularMarchal;

}

#endif

// EOF: SingularMarchal.hh
