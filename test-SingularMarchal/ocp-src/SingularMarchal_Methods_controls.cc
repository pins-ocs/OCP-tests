...
namespace SingularMarchalDefine {
  ...
  SingularMarchal::g_eval(
    ...
    result__[ 0   ] = t7 * (t2 / 2 + ModelPars[iM_epsilon]) + L__[iL_lambda2__xo];
    if ( m_debug )
  ...
  SingularMarchal::u_eval_analytic(
    ...
    U__[ iU_u ] = uControl.solve(-2 / (t3 + 2 * ModelPars[iM_epsilon]) * LM__[1], -1, 1);
    if ( m_debug )
  ...
  SingularMarchal::DuDxlxlp_full_analytic(
    ...
    real_type t2   = XM__[0];
    real_type t3   = t2 * t2;
    real_type t6   = t3 + 2 * ModelPars[iM_epsilon];
    real_type t7   = 1.0 / t6;
    real_type t10  = uControl.solve_rhs(-2 * t7 * t1, -1, 1);
    real_type t12  = t6 * t6;
    real_type tmp_0_0 = 0.20e1 * t2 / t12 * t1 * t10;
    real_type tmp_0_1 = 0.0e0;
    real_type tmp_0_2 = 0.0e0;
    real_type tmp_0_3 = -0.10e1 * t7 * t10;
