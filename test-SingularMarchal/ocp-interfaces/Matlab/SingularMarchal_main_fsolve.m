...
% create object
infolevel  = 4;
ocp = SingularMarchal( 'SingularMarchal', infolevel );
...
%ocp.setup('../../data/SingularMarchal_Data.lua');
ocp.setup('../../data/SingularMarchal_Data.rb');
...
%%clear mex
%x = SingularMarchal_Mex('get_raw_solution',obj);
%J = SingularMarchal_Mex('eval_JF',obj,x);
%f = SingularMarchal_Mex('eval_F',obj,x);
