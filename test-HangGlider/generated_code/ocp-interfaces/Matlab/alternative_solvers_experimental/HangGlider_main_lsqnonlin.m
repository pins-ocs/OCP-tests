...
ocp.setup( [DATA_PATH 'HangGlider_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = HangGlider_Mex('get_raw_solution',obj);
%J        = HangGlider_Mex('eval_JF',obj,Z,MU,U);
%f        = HangGlider_Mex('eval_F',obj,Z,MU,U);
