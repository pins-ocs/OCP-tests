...
public:
  ...
  do_w(
    ...
    real_const_ptr arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    real_const_ptr arg1 = getMatrixPointer( arg_in_3, N1, M1, CMD " xo__y1" );
  ...
  do_v2(
    ...
    real_const_ptr arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    real_const_ptr arg1 = getMatrixPointer( arg_in_3, N1, M1, CMD " xo__x1" );
    MEX_CHECK_DIMS(N1,M1,N0,M0);
    mwSize N2, M2;
    real_const_ptr arg2 = getMatrixPointer( arg_in_4, N2, M2, CMD " xo__y1" );
