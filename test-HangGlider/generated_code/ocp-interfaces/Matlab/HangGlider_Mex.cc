...
using namespace HangGliderLoad;
...
"HangGlider_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "HangGlider"
#define MODEL_CLASS HangGlider
...
public:
  ...
  )
  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "HangGlider_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "HangGlider_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
  ...
  )
  {
    ...
    gc["num_initial_BC"]    = MODEL_CLASS::num_initial_BC();
    gc["num_final_BC"]      = MODEL_CLASS::num_final_BC();
    gc["num_cyclic_BC"]     = MODEL_CLASS::num_cyclic_BC();
    gc["num_initial_OMEGA"] = MODEL_CLASS::num_initial_OMEGA();
    gc["num_final_OMEGA"]   = MODEL_CLASS::num_final_OMEGA();
    gc["num_cyclic_OMEGA"]  = MODEL_CLASS::num_cyclic_OMEGA();
  ...
  )
  {
    ...
    try {
      ...
      string msg = fmt::format( "HangGlider_Mex('eval_F',...) error: {}", exc.what() );
      mexWarnMsgTxt( msg.c_str() );
      ok = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "HangGlider_Mex('eval_F',...) unkown error\n" );
      ok = false;
    }
  ...
  )
  {
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "HangGlider_Mex('eval_JF',...) error: {}", exc.what() ).c_str() );
      ok_value = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "HangGlider_Mex('eval_JF',...) unkown error\n" );
      ok_value = false;
    }
    int ok = mexCallMATLAB( 1, &arg_out_0, 5, args, "sparse" );
    UTILS_MEX_ASSERT0( ok == 0, CMD "failed the call sparse(...)" );
  ...
  do_r(
    ...
    #define CMD MODEL_NAME "_Mex('r', obj, xo__x ): "
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
  ...
  {
    #define CMD MODEL_NAME "_Mex('r_D', obj, xo__x ): "
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
  ...
  do_r_DD(
    ...
    #define CMD MODEL_NAME "_Mex('r_DD', obj, xo__x ): "
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
  ...
  do_u(
    ...
    #define CMD MODEL_NAME "_Mex('u', obj, xo__x ): "
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
  ...
  {
    #define CMD MODEL_NAME "_Mex('u_D', obj, xo__x ): "
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
  ...
  do_u_DD(
    ...
    #define CMD MODEL_NAME "_Mex('u_DD', obj, xo__x ): "
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
  ...
  do_w(
    ...
    #define CMD MODEL_NAME "_Mex('w', obj, xo__x, xo__y1 ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    real_const_ptr arg1 = Utils::mex_matrix_pointer( arg_in_3, N1, M1, CMD " xo__y1" );
    MEX_CHECK_DIMS(N1,M1,N0,M0);

    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->w(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_w_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('w_D_1', obj, xo__x, xo__y1 ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->w_D_1(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_w_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('w_D_2', obj, xo__x, xo__y1 ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->w_D_2(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_w_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('w_D_1_1', obj, xo__x, xo__y1 ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->w_D_1_1(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_w_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('w_D_1_2', obj, xo__x, xo__y1 ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->w_D_1_2(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_w_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('w_D_2_2', obj, xo__x, xo__y1 ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->w_D_2_2(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_v2(
    ...
    #define CMD MODEL_NAME "_Mex('v2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    real_const_ptr arg1 = Utils::mex_matrix_pointer( arg_in_3, N1, M1, CMD " xo__x1" );
    MEX_CHECK_DIMS(N1,M1,N0,M0);
    mwSize N2, M2;
    real_const_ptr arg2 = Utils::mex_matrix_pointer( arg_in_4, N2, M2, CMD " xo__y1" );
    MEX_CHECK_DIMS(N2,M2,N0,M0);

    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v2_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('v2_D_1', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v2_D_1(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v2_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('v2_D_2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v2_D_2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v2_D_3(
    ...
    #define CMD MODEL_NAME "_Mex('v2_D_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v2_D_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v2_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('v2_D_1_1', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v2_D_1_1(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v2_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('v2_D_1_2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v2_D_1_2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v2_D_1_3(
    ...
    #define CMD MODEL_NAME "_Mex('v2_D_1_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v2_D_1_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v2_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('v2_D_2_2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v2_D_2_2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v2_D_2_3(
    ...
    #define CMD MODEL_NAME "_Mex('v2_D_2_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v2_D_2_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v2_D_3_3(
    ...
    #define CMD MODEL_NAME "_Mex('v2_D_3_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v2_D_3_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v(
    ...
    #define CMD MODEL_NAME "_Mex('v', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('v_D_1', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v_D_1(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('v_D_2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v_D_2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v_D_3(
    ...
    #define CMD MODEL_NAME "_Mex('v_D_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v_D_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('v_D_1_1', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v_D_1_1(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('v_D_1_2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v_D_1_2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v_D_1_3(
    ...
    #define CMD MODEL_NAME "_Mex('v_D_1_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v_D_1_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('v_D_2_2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v_D_2_2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v_D_2_3(
    ...
    #define CMD MODEL_NAME "_Mex('v_D_2_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v_D_2_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_v_D_3_3(
    ...
    #define CMD MODEL_NAME "_Mex('v_D_3_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->v_D_3_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Dfun(
    ...
    #define CMD MODEL_NAME "_Mex('Dfun', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Dfun(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Dfun_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('Dfun_D_1', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Dfun_D_1(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Dfun_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('Dfun_D_2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Dfun_D_2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Dfun_D_3(
    ...
    #define CMD MODEL_NAME "_Mex('Dfun_D_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Dfun_D_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Dfun_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('Dfun_D_1_1', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Dfun_D_1_1(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Dfun_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('Dfun_D_1_2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Dfun_D_1_2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Dfun_D_1_3(
    ...
    #define CMD MODEL_NAME "_Mex('Dfun_D_1_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Dfun_D_1_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Dfun_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('Dfun_D_2_2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Dfun_D_2_2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Dfun_D_2_3(
    ...
    #define CMD MODEL_NAME "_Mex('Dfun_D_2_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Dfun_D_2_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Dfun_D_3_3(
    ...
    #define CMD MODEL_NAME "_Mex('Dfun_D_3_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Dfun_D_3_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Lfun(
    ...
    #define CMD MODEL_NAME "_Mex('Lfun', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Lfun(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Lfun_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('Lfun_D_1', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Lfun_D_1(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Lfun_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('Lfun_D_2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Lfun_D_2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Lfun_D_3(
    ...
    #define CMD MODEL_NAME "_Mex('Lfun_D_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Lfun_D_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Lfun_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('Lfun_D_1_1', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Lfun_D_1_1(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Lfun_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('Lfun_D_1_2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Lfun_D_1_2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Lfun_D_1_3(
    ...
    #define CMD MODEL_NAME "_Mex('Lfun_D_1_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Lfun_D_1_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Lfun_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('Lfun_D_2_2', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Lfun_D_2_2(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Lfun_D_2_3(
    ...
    #define CMD MODEL_NAME "_Mex('Lfun_D_2_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Lfun_D_2_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
  ...
  do_Lfun_D_3_3(
    ...
    #define CMD MODEL_NAME "_Mex('Lfun_D_3_3', obj, xo__x, xo__x1, xo__y1 ): "
    CHECK_IN_OUT( 5, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->Lfun_D_3_3(arg0[ii],arg1[ii],arg2[ii]);
    #undef CMD
  }
...
do_r(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('r',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_r( nlhs, plhs, nrhs, prhs );
}
...
do_r_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('r_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_r_D( nlhs, plhs, nrhs, prhs );
}
...
do_r_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('r_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_r_DD( nlhs, plhs, nrhs, prhs );
}
...
do_u_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('u_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_u_D( nlhs, plhs, nrhs, prhs );
}
...
do_u_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('u_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_u_DD( nlhs, plhs, nrhs, prhs );
}
...
do_w(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('w',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_w( nlhs, plhs, nrhs, prhs );
}
...
do_w_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('w_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_w_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_w_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('w_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_w_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_w_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('w_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_w_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_w_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('w_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_w_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_w_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('w_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_w_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_v2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v2( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v2_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v2_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v2_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v2_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v2_D_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v2_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v2_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v2_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v2_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v2_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_1_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v2_D_1_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v2_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v2_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v2_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_2_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v2_D_2_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v2_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_3_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v2_D_3_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v2_D_3_3( nlhs, plhs, nrhs, prhs );
}
...
do_v(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v_D_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_1_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v_D_1_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_2_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v_D_2_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_3_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('v_D_3_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_v_D_3_3( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Dfun',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Dfun( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Dfun_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Dfun_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Dfun_D_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Dfun_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Dfun_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_1_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Dfun_D_1_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Dfun_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_2_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Dfun_D_2_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_3_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Dfun_D_3_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_3_3( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Lfun',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Lfun( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Lfun_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Lfun_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Lfun_D_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Lfun_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Lfun_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_1_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Lfun_D_1_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Lfun_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_2_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Lfun_D_2_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_3_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Lfun_D_3_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_3_3( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"v2_D_2",do_v2_D_2},
  {"v2_D_3",do_v2_D_3},
  {"v2_D_1_1",do_v2_D_1_1},
  {"v2_D_1_2",do_v2_D_1_2},
  {"v2_D_1_3",do_v2_D_1_3},
  {"v2_D_2_2",do_v2_D_2_2},
  {"v2_D_2_3",do_v2_D_2_3},
  {"v2_D_3_3",do_v2_D_3_3},
  {"v",do_v},
  {"v_D_1",do_v_D_1},
  {"v_D_2",do_v_D_2},
  {"v_D_3",do_v_D_3},
  ...
  {"v_D_3_3",do_v_D_3_3},
  {"Dfun",do_Dfun},
  {"Dfun_D_1",do_Dfun_D_1},
  {"Dfun_D_2",do_Dfun_D_2},
  {"Dfun_D_3",do_Dfun_D_3},
  {"Dfun_D_1_1",do_Dfun_D_1_1},
  {"Dfun_D_1_2",do_Dfun_D_1_2},
  {"Dfun_D_1_3",do_Dfun_D_1_3},
  {"Dfun_D_2_2",do_Dfun_D_2_2},
  {"Dfun_D_2_3",do_Dfun_D_2_3},
  {"Dfun_D_3_3",do_Dfun_D_3_3},
  {"Lfun",do_Lfun},
  {"Lfun_D_1",do_Lfun_D_1},
  {"Lfun_D_2",do_Lfun_D_2},
  {"Lfun_D_3",do_Lfun_D_3},
  {"Lfun_D_1_1",do_Lfun_D_1_1},
  {"Lfun_D_1_2",do_Lfun_D_1_2},
  {"Lfun_D_1_3",do_Lfun_D_1_3},
  {"Lfun_D_2_2",do_Lfun_D_2_2},
  {"Lfun_D_2_3",do_Lfun_D_2_3},
  {"Lfun_D_3_3",do_Lfun_D_3_3},
  {"new",do_new},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "HangGlider_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "HangGlider_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
