...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"r",&ProblemStorage::do_r},
  {"r_D",&ProblemStorage::do_r_D},
  {"u",&ProblemStorage::do_u},
  {"u_D",&ProblemStorage::do_u_D},
  {"w",&ProblemStorage::do_w},
  {"w_D_1",&ProblemStorage::do_w_D_1},
  {"w_D_2",&ProblemStorage::do_w_D_2},
  {"w_D_1_1",&ProblemStorage::do_w_D_1_1},
  {"w_D_1_2",&ProblemStorage::do_w_D_1_2},
  {"w_D_2_2",&ProblemStorage::do_w_D_2_2},
  {"v2",&ProblemStorage::do_v2},
  {"v2_D_1",&ProblemStorage::do_v2_D_1},
  {"v2_D_2",&ProblemStorage::do_v2_D_2},
  {"v2_D_3",&ProblemStorage::do_v2_D_3},
  {"v2_D_1_1",&ProblemStorage::do_v2_D_1_1},
  {"v2_D_1_2",&ProblemStorage::do_v2_D_1_2},
  {"v2_D_1_3",&ProblemStorage::do_v2_D_1_3},
  {"v2_D_2_2",&ProblemStorage::do_v2_D_2_2},
  {"v2_D_2_3",&ProblemStorage::do_v2_D_2_3},
  {"v2_D_3_3",&ProblemStorage::do_v2_D_3_3},
  {"v",&ProblemStorage::do_v},
  {"v_D_1",&ProblemStorage::do_v_D_1},
  {"v_D_2",&ProblemStorage::do_v_D_2},
  {"v_D_3",&ProblemStorage::do_v_D_3},
  {"v_D_1_1",&ProblemStorage::do_v_D_1_1},
  {"v_D_1_2",&ProblemStorage::do_v_D_1_2},
  {"v_D_1_3",&ProblemStorage::do_v_D_1_3},
  {"v_D_2_2",&ProblemStorage::do_v_D_2_2},
  {"v_D_2_3",&ProblemStorage::do_v_D_2_3},
  {"v_D_3_3",&ProblemStorage::do_v_D_3_3},
  {"Dfun",&ProblemStorage::do_Dfun},
  {"Dfun_D_1",&ProblemStorage::do_Dfun_D_1},
  {"Dfun_D_2",&ProblemStorage::do_Dfun_D_2},
  {"Dfun_D_3",&ProblemStorage::do_Dfun_D_3},
  {"Dfun_D_1_1",&ProblemStorage::do_Dfun_D_1_1},
  {"Dfun_D_1_2",&ProblemStorage::do_Dfun_D_1_2},
  {"Dfun_D_1_3",&ProblemStorage::do_Dfun_D_1_3},
  {"Dfun_D_2_2",&ProblemStorage::do_Dfun_D_2_2},
  {"Dfun_D_2_3",&ProblemStorage::do_Dfun_D_2_3},
  {"Dfun_D_3_3",&ProblemStorage::do_Dfun_D_3_3},
  {"Lfun",&ProblemStorage::do_Lfun},
  {"Lfun_D_1",&ProblemStorage::do_Lfun_D_1},
  {"Lfun_D_2",&ProblemStorage::do_Lfun_D_2},
  {"Lfun_D_3",&ProblemStorage::do_Lfun_D_3},
  {"Lfun_D_1_1",&ProblemStorage::do_Lfun_D_1_1},
  {"Lfun_D_1_2",&ProblemStorage::do_Lfun_D_1_2},
  {"Lfun_D_1_3",&ProblemStorage::do_Lfun_D_1_3},
  {"Lfun_D_2_2",&ProblemStorage::do_Lfun_D_2_2},
  {"Lfun_D_2_3",&ProblemStorage::do_Lfun_D_2_3},
  {"Lfun_D_3_3",&ProblemStorage::do_Lfun_D_3_3}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "HangGlider_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
