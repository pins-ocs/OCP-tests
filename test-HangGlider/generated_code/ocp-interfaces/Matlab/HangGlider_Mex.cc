...
public:
  ...
  do_eval_F(
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "HangGlider_Mex('eval_F',...) error: {}", exc.what() ).c_str() );
      ok = false;
    } catch ( ... ) {
  ...
  do_w(
    ...
    real_type const * arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    real_type const * arg1 = getMatrixPointer( arg_in_3, N1, M1, CMD " xo__y1" );
  ...
  do_v2(
    ...
    real_type const * arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    real_type const * arg1 = getMatrixPointer( arg_in_3, N1, M1, CMD " xo__x1" );
    MEX_CHECK_DIMS(N1,M1,N0,M0);
    mwSize N2, M2;
    real_type const * arg2 = getMatrixPointer( arg_in_4, N2, M2, CMD " xo__y1" );
...
do_r(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_r( nlhs, plhs, nrhs, prhs );
}
...
do_r_D(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_r_D( nlhs, plhs, nrhs, prhs );
}
...
do_r_DD(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_r_DD( nlhs, plhs, nrhs, prhs );
}
...
do_u_D(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_u_D( nlhs, plhs, nrhs, prhs );
}
...
do_u_DD(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_u_DD( nlhs, plhs, nrhs, prhs );
}
...
do_w(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_w( nlhs, plhs, nrhs, prhs );
}
...
do_w_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_w_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_w_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_w_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_w_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_w_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_w_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_w_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_w_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_w_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_v2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v2( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v2_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v2_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v2_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v2_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v2_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_1_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v2_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v2_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_2_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v2_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_v2_D_3_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v2_D_3_3( nlhs, plhs, nrhs, prhs );
}
...
do_v(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_1_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_2_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_v_D_3_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_v_D_3_3( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Dfun( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_1_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_2_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_Dfun_D_3_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Dfun_D_3_3( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Lfun( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_1_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_2_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_Lfun_D_3_3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Lfun_D_3_3( nlhs, plhs, nrhs, prhs );
}
