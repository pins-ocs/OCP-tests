...
DO_COMMAND_REMAP_TO_CLASS_METHOD(r);
DO_COMMAND_REMAP_TO_CLASS_METHOD(r_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(u);
DO_COMMAND_REMAP_TO_CLASS_METHOD(u_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(w);
DO_COMMAND_REMAP_TO_CLASS_METHOD(w_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(w_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(w_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(w_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(w_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v2_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v2_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v2_D_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v2_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v2_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v2_D_1_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v2_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v2_D_2_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v2_D_3_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v_D_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v_D_1_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v_D_2_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(v_D_3_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Dfun);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Dfun_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Dfun_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Dfun_D_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Dfun_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Dfun_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Dfun_D_1_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Dfun_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Dfun_D_2_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Dfun_D_3_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Lfun);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Lfun_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Lfun_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Lfun_D_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Lfun_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Lfun_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Lfun_D_1_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Lfun_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Lfun_D_2_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Lfun_D_3_3);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "HangGlider_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "HangGlider_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
