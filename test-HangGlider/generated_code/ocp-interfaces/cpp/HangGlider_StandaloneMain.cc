...
main() {
  ...
  try {
    ...
    HangGlider       model("HangGlider",&TP,&console);
    ...
    gc_data["DumpFile"] = "HangGlider_dump";
    ...
    // Model Parameters
    data_Parameters["W"] = W;
    data_Parameters["c0"] = 0.034;
    data_Parameters["c1"] = 0.069662;
    data_Parameters["cL_max"] = cL_max;
    data_Parameters["cL_min"] = cL_min;
    data_Parameters["g"] = 9.80665;
    data_Parameters["m"] = 100;

    // Guess Parameters
    data_Parameters["Tguess"] = 105;

    // Boundary Conditions
    data_Parameters["vx_f"] = 13.2275675;
    data_Parameters["vx_i"] = 13.2275675;
    data_Parameters["vy_f"] = -1.28750052;
    data_Parameters["vy_i"] = -1.28750052;
    data_Parameters["x_i"] = 0;
    data_Parameters["y_f"] = 900;
    data_Parameters["y_i"] = 1000;

    // Post Processing Parameters

    // User Function Parameters
    data_Parameters["S"] = 14;
    data_Parameters["rc"] = 100;
    data_Parameters["rho"] = 1.13;
    data_Parameters["uc"] = 2.5;

    // Continuation Parameters
    data_Parameters["W0"] = W0;
    data_Parameters["W1"] = 0;
    data_Parameters["tol_max"] = tol_max;
    data_Parameters["tol_min"] = 0.0001;
    ...
    data_Tbound["subType"]   = "BARRIER_LOG";
    data_Tbound["epsilon"]   = 0.1;
    data_Tbound["tolerance"] = 0.5;
    data_Tbound["active"]    = true;
...
HangGlider_data.Mesh["segments"][0]["length"] = 1;
    ...
    std::ofstream file;
    if ( ok ) {
      file.open( "data/HangGlider_OCP_result.txt" );
    } else {
      cout << gc_solution("solver_message").get_string() << '\n';
      // dump solution to file
      file.open( "data/HangGlider_OCP_result_NOT_CONVERGED.txt" );
    }
    file.precision(18);
