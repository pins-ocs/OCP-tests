...
namespace HangGliderDefine {
  ...
  class HangGlider_Problem {
    ...
    HangGlider_Problem( HangGlider_Problem const & );
    HangGlider_Problem const & operator = ( HangGlider_Problem const & );
  ...
  public:
    ...
    HANGGLIDER_API_DLL
    HangGlider_Problem( integer n_threads, Console const * console )
    : model("HangGlider",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "HangGlider::solver, fatal: unknown error";
      }
      return ok;
    }
