...
namespace HangGliderDefine {
  ...
  */
  void
  HangGlider::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "HangGlider::setup_parameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  HangGlider::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  HangGlider::setup_classes( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Constraints"),
      "HangGlider::setup_classes: Missing key `Parameters` in data\n"
    );
    GenericContainer const & gc = gc_data("Constraints");
    // Initialize Constraints 1D
    UTILS_ASSERT0(
      gc.exists("Tbound"),
      "in HangGlider::setup_classes(gc) missing key: ``Tbound''\n"
    );
  ...
  */
  void
  HangGlider::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  HangGlider::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  HangGlider::setup_controls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "HangGlider::setup_classes: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  HangGlider::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "HangGlider::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in HangGlider::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  HangGlider::info_model( integer level ) const {
    ...
    m_console->message( cLControl.info(),level);

    // ==================================================================
    m_console->PINS_COLOR_TITLE( fmt::format( "+{:.^71}+\n", "Constraints type LT" ), level);
    m_console->message( Tbound.info(),level);
