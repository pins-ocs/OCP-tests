...
namespace HangGliderDefine {
  ...
  */
  ...
  void
  HangGlider::setup_parameters( real_type const Pars[] ) {
  ...
  */
  void
  HangGlider::info_classes() const {
    int msg_level = 3;

    m_console->message("\nControls\n",msg_level);
    m_console->message( cLControl.info(),msg_level);

    m_console->message("\nConstraints LT\n",msg_level);
    m_console->message( Tbound.info(),msg_level);
