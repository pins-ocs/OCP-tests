...
namespace HangGliderDefine {
  ...
  integer HangGlider::JPxpu_numEqns() const { return 6; }

  void
  HangGlider::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer HangGlider::JUxpu_numEqns() const { return 6; }

  void
  HangGlider::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
    ...
    result__[ 3   ] = 0;
    result__[ 4   ] = 0;
    result__[ 5   ] = ALIAS_cLControl_D_1(U__[iU_cL], ModelPars[iM_cL_min], ModelPars[iM_cL_max]);
    if ( m_debug )
  ...
  integer HangGlider::LTxpu_numEqns() const { return 6; }

  void
  HangGlider::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  HangGlider::D2JUD2xpu_sparse(
    ...
    real_const_ptr X__ = NODE__.x;
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    result__[ 0   ] = ALIAS_cLControl_D_1_1(U__[iU_cL], ModelPars[iM_cL_min], ModelPars[iM_cL_max]);
    if ( m_debug )
