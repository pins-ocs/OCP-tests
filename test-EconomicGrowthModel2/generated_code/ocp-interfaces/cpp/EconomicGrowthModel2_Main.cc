...
main() {
  ...
  try {
    EconomicGrowthModel2 * m_model = new EconomicGrowthModel2("EconomicGrowthModel2",&TP,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/EconomicGrowthModel2_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/EconomicGrowthModel2_Data.lua";
    #endif
    ...
    if ( ok ) {
      ...
      file.open( "data/EconomicGrowthModel2_OCP_result_NOT_CONVERGED.ßtxt" );
    }
    file.precision(18);
