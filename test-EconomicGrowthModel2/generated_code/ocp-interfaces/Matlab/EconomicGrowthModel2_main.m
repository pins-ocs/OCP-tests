...
%ocp.setup('../../data/EconomicGrowthModel2_Data.lua');
ocp.setup('../../data/EconomicGrowthModel2_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = EconomicGrowthModel2_Mex('get_raw_solution',obj);
%J     = EconomicGrowthModel2_Mex('eval_JF',obj,Z,U);
%f     = EconomicGrowthModel2_Mex('eval_F',obj,Z,U);
