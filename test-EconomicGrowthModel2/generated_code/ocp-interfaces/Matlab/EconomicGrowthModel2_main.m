%-----------------------------------------------------------------------%
%  file: EconomicGrowthModel2_main.m                                    %
%                                                                       %
...
% create object
ocp = EconomicGrowthModel2( 'EconomicGrowthModel2' );
...
%ocp.setup(EconomicGrowthModel2_data);
ocp.setup('../../data/EconomicGrowthModel2_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%EconomicGrowthModel2_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = EconomicGrowthModel2_Mex('get_raw_solution',obj);
%J     = EconomicGrowthModel2_Mex('eval_JF',obj,Z,MU,U);
%f     = EconomicGrowthModel2_Mex('eval_F',obj,Z,MU,U);
