...
DO_COMMAND_REMAP_TO_CLASS_METHOD(Q);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Q_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Q_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Q_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Q_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Q_D_2_2);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "EconomicGrowthModel2_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "EconomicGrowthModel2_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
