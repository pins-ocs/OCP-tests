...
namespace EconomicGrowthModel2Define {
  ...
  integer EconomicGrowthModel2::JPxpu_numEqns() const { return 6; }

  void
  EconomicGrowthModel2::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer EconomicGrowthModel2::JUxpu_numEqns() const { return 6; }

  void
  EconomicGrowthModel2::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
    ...
    result__[ 4   ] = uControl(t1, 0, 1);
    real_type t3   = ALIAS_uControl_D_1(t1, 0, 1);
    result__[ 5   ] = t3 * X__[iX_T];
    if ( m_debug )
  ...
  integer EconomicGrowthModel2::LTxpu_numEqns() const { return 6; }

  void
  EconomicGrowthModel2::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
