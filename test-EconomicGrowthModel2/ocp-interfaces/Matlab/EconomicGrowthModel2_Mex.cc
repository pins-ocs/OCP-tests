...
"EconomicGrowthModel2_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "EconomicGrowthModel2"
...
public:
  ...
  do_Q_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('Q_D_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->Q_D_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_Q_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('Q_D_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->Q_D_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_Q_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('Q_D_1_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->Q_D_1_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_Q_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('Q_D_1_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->Q_D_1_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_Q_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('Q_D_2_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->Q_D_2_2(arg0,arg1) );
    #undef CMD
  }
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "EconomicGrowthModel2_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "EconomicGrowthModel2_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
