...
namespace EconomicGrowthModel2Define {
  ...
  class EconomicGrowthModel2_Problem {

    EconomicGrowthModel2 model;
    ...
    EconomicGrowthModel2_Problem( EconomicGrowthModel2_Problem const & );
    EconomicGrowthModel2_Problem const & operator = ( EconomicGrowthModel2_Problem const & );
  ...
  public:
    ...
    EconomicGrowthModel2_Problem( ThreadPool * pTP, Console const * pConsole )
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "EconomicGrowthModel2::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: EconomicGrowthModel2_dll_pins.hh
