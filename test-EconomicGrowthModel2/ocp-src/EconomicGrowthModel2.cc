...
namespace EconomicGrowthModel2Define {
  ...
  */
  void
  EconomicGrowthModel2::updateContinuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
    ...
    UTILS_ASSERT(
      0 <= old_s && old_s < s && s <= 1,
      "EconomicGrowthModel2::updateContinuation( phase number={}, old_s={}, s={} ) "
      "must be 0 <= old_s < s <= 1\n",
      phase, old_s, s
    );
    switch ( phase ) {
  ...
  */
  ...
  void
  EconomicGrowthModel2::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  EconomicGrowthModel2::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  EconomicGrowthModel2::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  EconomicGrowthModel2::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  EconomicGrowthModel2::diagnostic( GenericContainer const & gc ) {
