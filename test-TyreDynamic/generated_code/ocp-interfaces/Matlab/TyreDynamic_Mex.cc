...
"TyreDynamic_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "TyreDynamic"
#define MODEL_CLASS TyreDynamic
...
public:
  ...
  )
  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "TyreDynamic_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "TyreDynamic_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
  ...
  )
  {
    ...
    try {
      ...
      string msg = fmt::format( "TyreDynamic_Mex('eval_F',...) error: {}", exc.what() );
      mexWarnMsgTxt( msg.c_str() );
      ok = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "TyreDynamic_Mex('eval_F',...) unkown error\n" );
      ok = false;
    }
  ...
  )
  {
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "TyreDynamic_Mex('eval_JF',...) error: {}", exc.what() ).c_str() );
      ok_value = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "TyreDynamic_Mex('eval_JF',...) unkown error\n" );
      ok_value = false;
    }
    int ok = mexCallMATLAB( 1, &arg_out_0, 5, args, "sparse" );
    UTILS_MEX_ASSERT0( ok == 0, CMD "failed the call sparse(...)" );
...
do_LongSlipRear(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('LongSlipRear',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_LongSlipRear( nlhs, plhs, nrhs, prhs );
}
...
do_LongSlipRear_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('LongSlipRear_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_LongSlipRear_D( nlhs, plhs, nrhs, prhs );
}
...
do_LongSlipRear_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('LongSlipRear_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_LongSlipRear_DD( nlhs, plhs, nrhs, prhs );
}
...
do_kappa__w(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('kappa__w',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_kappa__w( nlhs, plhs, nrhs, prhs );
}
...
do_kappa__w_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('kappa__w_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_kappa__w_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_kappa__w_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('kappa__w_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_kappa__w_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_kappa__w_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('kappa__w_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_kappa__w_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_kappa__w_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('kappa__w_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_kappa__w_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_kappa__w_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('kappa__w_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_kappa__w_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_F__x(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('F__x',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_F__x( nlhs, plhs, nrhs, prhs );
}
...
do_F__x_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('F__x_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_F__x_D( nlhs, plhs, nrhs, prhs );
}
...
do_F__x_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('F__x_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_F__x_DD( nlhs, plhs, nrhs, prhs );
}
...
do_p__pos(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p__pos',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p__pos( nlhs, plhs, nrhs, prhs );
}
...
do_p__pos_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p__pos_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p__pos_D( nlhs, plhs, nrhs, prhs );
}
...
do_p__pos_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p__pos_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p__pos_DD( nlhs, plhs, nrhs, prhs );
}
...
do_p__neg(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p__neg',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p__neg( nlhs, plhs, nrhs, prhs );
}
...
do_p__neg_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p__neg_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p__neg_D( nlhs, plhs, nrhs, prhs );
}
...
do_p__neg_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p__neg_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p__neg_DD( nlhs, plhs, nrhs, prhs );
}
...
do_b__pos(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('b__pos',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_b__pos( nlhs, plhs, nrhs, prhs );
}
...
do_b__pos_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('b__pos_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_b__pos_D( nlhs, plhs, nrhs, prhs );
}
...
do_b__pos_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('b__pos_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_b__pos_DD( nlhs, plhs, nrhs, prhs );
}
...
do_b__neg(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('b__neg',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_b__neg( nlhs, plhs, nrhs, prhs );
}
...
do_b__neg_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('b__neg_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_b__neg_D( nlhs, plhs, nrhs, prhs );
}
...
do_b__neg_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('b__neg_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_b__neg_DD( nlhs, plhs, nrhs, prhs );
}
...
do_TT__env(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TT__env',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TT__env( nlhs, plhs, nrhs, prhs );
}
...
do_TT__env_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TT__env_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TT__env_D( nlhs, plhs, nrhs, prhs );
}
...
do_TT__env_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TT__env_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TT__env_DD( nlhs, plhs, nrhs, prhs );
}
...
do_BT__env(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('BT__env',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_BT__env( nlhs, plhs, nrhs, prhs );
}
...
do_BT__env_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('BT__env_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_BT__env_D( nlhs, plhs, nrhs, prhs );
}
...
do_BT__env_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('BT__env_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_BT__env_DD( nlhs, plhs, nrhs, prhs );
}
...
do_TT(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TT',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TT( nlhs, plhs, nrhs, prhs );
}
...
do_TT_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TT_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TT_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_TT_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TT_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TT_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_TT_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TT_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TT_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_TT_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TT_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TT_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_TT_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TT_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TT_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_TB(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TB',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TB( nlhs, plhs, nrhs, prhs );
}
...
do_TB_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TB_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TB_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_TB_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TB_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TB_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_TB_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TB_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TB_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_TB_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TB_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TB_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_TB_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('TB_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_TB_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_Fa(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Fa',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Fa( nlhs, plhs, nrhs, prhs );
}
...
do_Fa_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Fa_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Fa_D( nlhs, plhs, nrhs, prhs );
}
...
do_Fa_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Fa_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Fa_DD( nlhs, plhs, nrhs, prhs );
}
...
do_Ma(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Ma',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Ma( nlhs, plhs, nrhs, prhs );
}
...
do_Ma_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Ma_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Ma_D( nlhs, plhs, nrhs, prhs );
}
...
do_Ma_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('Ma_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_Ma_DD( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"LongSlipRear",do_LongSlipRear},
  {"LongSlipRear_D",do_LongSlipRear_D},
  {"LongSlipRear_DD",do_LongSlipRear_DD},
  {"kappa__w",do_kappa__w},
  {"kappa__w_D_1",do_kappa__w_D_1},
  {"kappa__w_D_2",do_kappa__w_D_2},
  {"kappa__w_D_1_1",do_kappa__w_D_1_1},
  {"kappa__w_D_1_2",do_kappa__w_D_1_2},
  {"kappa__w_D_2_2",do_kappa__w_D_2_2},
  {"F__x",do_F__x},
  {"F__x_D",do_F__x_D},
  {"F__x_DD",do_F__x_DD},
  {"p__pos",do_p__pos},
  {"p__pos_D",do_p__pos_D},
  {"p__pos_DD",do_p__pos_DD},
  {"p__neg",do_p__neg},
  {"p__neg_D",do_p__neg_D},
  {"p__neg_DD",do_p__neg_DD},
  {"b__pos",do_b__pos},
  {"b__pos_D",do_b__pos_D},
  {"b__pos_DD",do_b__pos_DD},
  {"b__neg",do_b__neg},
  {"b__neg_D",do_b__neg_D},
  {"b__neg_DD",do_b__neg_DD},
  {"TT__env",do_TT__env},
  {"TT__env_D",do_TT__env_D},
  {"TT__env_DD",do_TT__env_DD},
  {"BT__env",do_BT__env},
  {"BT__env_D",do_BT__env_D},
  {"BT__env_DD",do_BT__env_DD},
  {"TT",do_TT},
  {"TT_D_1",do_TT_D_1},
  {"TT_D_2",do_TT_D_2},
  {"TT_D_1_1",do_TT_D_1_1},
  {"TT_D_1_2",do_TT_D_1_2},
  {"TT_D_2_2",do_TT_D_2_2},
  {"TB",do_TB},
  {"TB_D_1",do_TB_D_1},
  {"TB_D_2",do_TB_D_2},
  {"TB_D_1_1",do_TB_D_1_1},
  {"TB_D_1_2",do_TB_D_1_2},
  {"TB_D_2_2",do_TB_D_2_2},
  {"Fa",do_Fa},
  {"Fa_D",do_Fa_D},
  {"Fa_DD",do_Fa_DD},
  {"Ma",do_Ma},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "TyreDynamic_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "TyreDynamic_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
