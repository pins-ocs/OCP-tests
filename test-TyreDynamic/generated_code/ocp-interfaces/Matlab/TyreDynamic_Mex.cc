...
DO_COMMAND_REMAP_TO_CLASS_METHOD(LongSlipRear);
DO_COMMAND_REMAP_TO_CLASS_METHOD(LongSlipRear_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(kappa__w);
DO_COMMAND_REMAP_TO_CLASS_METHOD(kappa__w_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(kappa__w_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(kappa__w_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(kappa__w_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(kappa__w_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(F__x);
DO_COMMAND_REMAP_TO_CLASS_METHOD(F__x_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p__pos);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p__pos_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p__neg);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p__neg_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(b__pos);
DO_COMMAND_REMAP_TO_CLASS_METHOD(b__pos_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(b__neg);
DO_COMMAND_REMAP_TO_CLASS_METHOD(b__neg_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TT__env);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TT__env_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(BT__env);
DO_COMMAND_REMAP_TO_CLASS_METHOD(BT__env_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TT);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TT_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TT_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TT_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TT_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TT_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TB);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TB_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TB_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TB_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TB_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(TB_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Fa);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Fa_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Ma);
DO_COMMAND_REMAP_TO_CLASS_METHOD(Ma_D);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "TyreDynamic_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "TyreDynamic_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
