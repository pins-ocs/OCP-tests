...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"LongSlipRear",&ProblemStorage::do_LongSlipRear},
  {"LongSlipRear_D",&ProblemStorage::do_LongSlipRear_D},
  {"kappa__w",&ProblemStorage::do_kappa__w},
  {"kappa__w_D_1",&ProblemStorage::do_kappa__w_D_1},
  {"kappa__w_D_2",&ProblemStorage::do_kappa__w_D_2},
  {"kappa__w_D_1_1",&ProblemStorage::do_kappa__w_D_1_1},
  {"kappa__w_D_1_2",&ProblemStorage::do_kappa__w_D_1_2},
  {"kappa__w_D_2_2",&ProblemStorage::do_kappa__w_D_2_2},
  {"F__x",&ProblemStorage::do_F__x},
  {"F__x_D",&ProblemStorage::do_F__x_D},
  {"p__pos",&ProblemStorage::do_p__pos},
  {"p__pos_D",&ProblemStorage::do_p__pos_D},
  {"p__neg",&ProblemStorage::do_p__neg},
  {"p__neg_D",&ProblemStorage::do_p__neg_D},
  {"b__pos",&ProblemStorage::do_b__pos},
  {"b__pos_D",&ProblemStorage::do_b__pos_D},
  {"b__neg",&ProblemStorage::do_b__neg},
  {"b__neg_D",&ProblemStorage::do_b__neg_D},
  {"TT__env",&ProblemStorage::do_TT__env},
  {"TT__env_D",&ProblemStorage::do_TT__env_D},
  {"BT__env",&ProblemStorage::do_BT__env},
  {"BT__env_D",&ProblemStorage::do_BT__env_D},
  {"TT",&ProblemStorage::do_TT},
  {"TT_D_1",&ProblemStorage::do_TT_D_1},
  {"TT_D_2",&ProblemStorage::do_TT_D_2},
  {"TT_D_1_1",&ProblemStorage::do_TT_D_1_1},
  {"TT_D_1_2",&ProblemStorage::do_TT_D_1_2},
  {"TT_D_2_2",&ProblemStorage::do_TT_D_2_2},
  {"TB",&ProblemStorage::do_TB},
  {"TB_D_1",&ProblemStorage::do_TB_D_1},
  {"TB_D_2",&ProblemStorage::do_TB_D_2},
  {"TB_D_1_1",&ProblemStorage::do_TB_D_1_1},
  {"TB_D_1_2",&ProblemStorage::do_TB_D_1_2},
  {"TB_D_2_2",&ProblemStorage::do_TB_D_2_2},
  {"Fa",&ProblemStorage::do_Fa},
  {"Fa_D",&ProblemStorage::do_Fa_D},
  {"Ma",&ProblemStorage::do_Ma},
  {"Ma_D",&ProblemStorage::do_Ma_D}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "TyreDynamic_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
