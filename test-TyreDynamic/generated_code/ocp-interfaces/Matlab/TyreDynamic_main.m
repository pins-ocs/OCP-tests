...
%ocp.setup(TyreDynamic_data);
ocp.setup('../../data/TyreDynamic_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%TyreDynamic_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = TyreDynamic_Mex('get_raw_solution',obj);
%J     = TyreDynamic_Mex('eval_JF',obj,Z,MU,U);
%f     = TyreDynamic_Mex('eval_F',obj,Z,MU,U);
