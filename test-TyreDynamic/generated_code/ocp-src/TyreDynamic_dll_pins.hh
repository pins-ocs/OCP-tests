...
namespace TyreDynamicDefine {
  ...
  class TyreDynamic_Problem {
    ...
    TyreDynamic_Problem( TyreDynamic_Problem const & );
    TyreDynamic_Problem const & operator = ( TyreDynamic_Problem const & );
  ...
  public:
    ...
    : m_model("TyreDynamic",console,TP)
    , m_mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "TyreDynamic::solver, fatal: unknown error";
      }
      return ok;
    }
