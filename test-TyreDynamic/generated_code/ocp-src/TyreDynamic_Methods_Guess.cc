...
namespace TyreDynamicDefine {
  ...
  void
  TyreDynamic::p_guess_eval( P_pointer_type P__ ) const {
  }
  ...
  bool
  TyreDynamic::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  TyreDynamic::xlambda_check_node(
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    Xoptima__check__node__lt(ModelPars[iM_v__adm], X__[iX_v], Xoptima__message_node_check_0);
    return true;
  }
  ...
  bool
  TyreDynamic::xlambda_check_cell(
    integer              icell,
  ...
  TyreDynamic::u_check_if_admissible(
    ...
    b__oControl.check_range(U__[iU_b__o], -1, 1);
    p__oControl.check_range(U__[iU_p__o], -1, 1);
    return ok;
  }
