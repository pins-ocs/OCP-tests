...
% create object
ocp = TwoLinkRobotArm( 'TwoLinkRobotArm' );
...
%ocp.setup(TwoLinkRobotArm_data);
%ocp.setup('../../data/TwoLinkRobotArm_Data.lua');
ocp.setup('../../data/TwoLinkRobotArm_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%TwoLinkRobotArm_Mex('set_tracked',obj,tracked);
...
%[Z,U] = TwoLinkRobotArm_Mex('get_raw_solution',obj);
%J     = TwoLinkRobotArm_Mex('eval_JF',obj,Z,U);
%f     = TwoLinkRobotArm_Mex('eval_F',obj,Z,U);
