...
namespace TwoLinkRobotArmDefine {
  ...
  */
  void
  TwoLinkRobotArm::updateContinuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
    ...
    UTILS_ASSERT(
      0 <= old_s && old_s < s && s <= 1,
      "TwoLinkRobotArm::updateContinuation( phase number={}, old_s={}, s={} ) "
      "must be 0 <= old_s < s <= 1\n",
      phase, old_s, s
    );
    switch ( phase ) {
  ...
  */
  ...
  void
  TwoLinkRobotArm::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  TwoLinkRobotArm::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  TwoLinkRobotArm::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  TwoLinkRobotArm::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  TwoLinkRobotArm::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  TwoLinkRobotArm::diagnostic( GenericContainer const & gc ) {
