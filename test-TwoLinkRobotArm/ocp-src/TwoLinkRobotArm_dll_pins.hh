...
namespace TwoLinkRobotArmDefine {
  ...
  class TwoLinkRobotArm_Problem {

    TwoLinkRobotArm model;
    ...
    TwoLinkRobotArm_Problem( TwoLinkRobotArm_Problem const & );
    TwoLinkRobotArm_Problem const & operator = ( TwoLinkRobotArm_Problem const & );
  ...
  public:
    ...
    TwoLinkRobotArm_Problem( ThreadPool * pTP, Console * pConsole )
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "TwoLinkRobotArm::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: TwoLinkRobotArm_dll_pins.hh
