...
namespace TwoLinkRobotArmDefine {
  ...
  TwoLinkRobotArm::Hx_eval(
    ...
    real_type t15  = t5 * t7;
    result__[ 0   ] = 9.0 / 2.0 * t3 * t15 * t14 - 7 * t5 * t18 * t14 - t24 + t2 * L__[iL_lambda4__xo];
    real_type t27  = X__[iX_x2];
    real_type t26  = t13 * t27;
    result__[ 1   ] = 4 * t5 * t3 * t26 - 9.0 / 2.0 * t18 * t15 * t26 + t24;
    real_type t37  = t8 * t8;
  ...
  TwoLinkRobotArm::DHxDp_sparse(
    ...
    real_type t9   = t11 * t6;
    result__[ 0   ] = 9.0 / 2.0 * t5 * t4 * t9 - 7 * t16 * t9 - t20 + L__[iL_lambda4__xo];
    real_type t22  = X__[iX_x2];
    real_type t21  = t22 * t11;
    result__[ 1   ] = 4 * t4 * t21 - 9.0 / 2.0 * t5 * t16 * t21 + t20;
    real_type t30  = t6 * t6;
  ...
  TwoLinkRobotArm::Hp_eval(
    ...
    result__[ 0   ] = t25 * ((9.0 / 4.0 * t6 * t4 + 2 * t10) * t3 + 4.0 / 3.0 * t14 - 4.0 / 3.0 * t16 - 3.0 / 2.0 * t16 * t4) * L__[iL_lambda1__xo] - t25 * ((7.0 / 2.0 * t6 + 9.0 / 4.0 * t10 * t4) * t3 - 7.0 / 3.0 * t16 + 3.0 / 2.0 * (t14 - t16) * t4) * L__[iL_lambda2__xo] + (t9 - t5) * L__[iL_lambda3__xo] + t5 * L__[iL_lambda4__xo];
    if ( m_debug )
