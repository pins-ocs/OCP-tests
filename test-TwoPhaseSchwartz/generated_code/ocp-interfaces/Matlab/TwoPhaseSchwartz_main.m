...
% create object
ocp = TwoPhaseSchwartz( 'TwoPhaseSchwartz' );
...
%ocp.setup(TwoPhaseSchwartz_data);
%ocp.setup('../../data/TwoPhaseSchwartz_Data.lua');
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%TwoPhaseSchwartz_Mex('set_tracked',obj,tracked);
...
%[Z,U] = TwoPhaseSchwartz_Mex('get_raw_solution',obj);
%J     = TwoPhaseSchwartz_Mex('eval_JF',obj,Z,U);
%f     = TwoPhaseSchwartz_Mex('eval_F',obj,Z,U);
