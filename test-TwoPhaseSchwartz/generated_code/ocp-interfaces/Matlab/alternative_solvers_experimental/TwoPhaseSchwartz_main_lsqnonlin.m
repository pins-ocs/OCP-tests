...
ocp.setup( [DATA_PATH 'TwoPhaseSchwartz_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = TwoPhaseSchwartz_Mex('get_raw_solution',obj);
%J        = TwoPhaseSchwartz_Mex('eval_JF',obj,Z,MU,U);
%f        = TwoPhaseSchwartz_Mex('eval_F',obj,Z,MU,U);
