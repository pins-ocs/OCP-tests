...
namespace TwoPhaseSchwartzDefine {
  ...
  void
  TwoPhaseSchwartz::p_guess_eval( P_p_type P__ ) const {
  }
  ...
  bool
  TwoPhaseSchwartz::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  integer TwoPhaseSchwartz::u_guess_numEqns() const { return 2; }
