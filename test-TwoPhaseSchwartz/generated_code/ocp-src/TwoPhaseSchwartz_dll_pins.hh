/*-----------------------------------------------------------------------*\
 |  file: TwoPhaseSchwartz_dll_pins.hh                                   |
 |                                                                       |
...
namespace TwoPhaseSchwartzDefine {
  ...
  class TwoPhaseSchwartz_Problem {

    TwoPhaseSchwartz model;
    ...
    TwoPhaseSchwartz_Problem( TwoPhaseSchwartz_Problem const & );
    TwoPhaseSchwartz_Problem const & operator = ( TwoPhaseSchwartz_Problem const & );
  ...
  public:
    ...
    TwoPhaseSchwartz_Problem( integer n_threads, Console const * console )
    : model("TwoPhaseSchwartz",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "TwoPhaseSchwartz::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: TwoPhaseSchwartz_dll_pins.hh
