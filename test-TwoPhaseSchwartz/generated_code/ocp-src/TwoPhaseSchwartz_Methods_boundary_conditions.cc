...
namespace TwoPhaseSchwartzDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer TwoPhaseSchwartz::DboundaryConditionsDxxp_numRows() const { return 4; }
  integer TwoPhaseSchwartz::DboundaryConditionsDxxp_numCols() const { return 8; }
  integer TwoPhaseSchwartz::DboundaryConditionsDxxp_nnz()     const { return 6; }

  void
  TwoPhaseSchwartz::DboundaryConditionsDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
