...
namespace TwoPhaseSchwartzDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer TwoPhaseSchwartz::Dfd_odeDxxpu_numRows() const { return 4; }
  integer TwoPhaseSchwartz::Dfd_odeDxxpu_numCols() const { return 10; }
  integer TwoPhaseSchwartz::Dfd_odeDxxpu_nnz()     const { return 18; }

  void
  TwoPhaseSchwartz::Dfd_odeDxxpu_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  TwoPhaseSchwartz::Dfd_odeDxxpu_sparse(
    NodeType const &     LEFT__,
    NodeType const &     RIGHT__,
    P_const_pointer_type P__,
    U_const_pointer_type UM__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer TwoPhaseSchwartz::D2fd_odeD2xxpu_numRows() const { return 10; }
  integer TwoPhaseSchwartz::D2fd_odeD2xxpu_numCols() const { return 10; }
  integer TwoPhaseSchwartz::D2fd_odeD2xxpu_nnz()     const { return 24; }

  void
  TwoPhaseSchwartz::D2fd_odeD2xxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
    iIndex[1 ] = 0   ; jIndex[1 ] = 1   ;
    iIndex[2 ] = 0   ; jIndex[2 ] = 4   ;
    iIndex[3 ] = 0   ; jIndex[3 ] = 5   ;
  ...
  void
  TwoPhaseSchwartz::D2fd_odeD2xxpu_sparse(
    NodeType const &     LEFT__,
    NodeType const &     RIGHT__,
    P_const_pointer_type P__,
    U_const_pointer_type UM__,
    ...
    if ( m_debug )
      Mechatronix::check_in_segment( result__, "D2fd_odeD2xxpu_eval", 24, i_segment );
  }
