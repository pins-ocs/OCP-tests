...
% create object
ocp = SingularLuus03( 'SingularLuus03' );
...
%ocp.setup(SingularLuus03_data);
%ocp.setup('../../data/SingularLuus03_Data.lua');
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%SingularLuus03_Mex('set_tracked',obj,tracked);
...
%[Z,U] = SingularLuus03_Mex('get_raw_solution',obj);
%J     = SingularLuus03_Mex('eval_JF',obj,Z,U);
%f     = SingularLuus03_Mex('eval_F',obj,Z,U);
