...
main() {
  ...
  try {
    SingularLuus03 * m_model = new SingularLuus03("SingularLuus03",&TP,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/SingularLuus03_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/SingularLuus03_Data.lua";
    #endif
    ...
    if ( ok ) {
      ...
      file.open( "data/SingularLuus03_OCP_result_NOT_CONVERGED.ßtxt" );
    }
    file.precision(18);
