...
namespace SingularLuus03Define {
  ...
  integer
  SingularLuus03::DboundaryConditionsDxxp_numRows() const
  { return 3; }

  integer
  SingularLuus03::DboundaryConditionsDxxp_numCols() const
  { return 6; }

  integer
  SingularLuus03::DboundaryConditionsDxxp_nnz() const
  { return 3; }

  void
  SingularLuus03::DboundaryConditionsDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  SingularLuus03::DboundaryConditionsDxxp_sparse(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularLuus03::DadjointBCDxxp_numRows() const
  { return 6; }

  integer
  SingularLuus03::DadjointBCDxxp_numCols() const
  { return 6; }

  integer
  SingularLuus03::DadjointBCDxxp_nnz() const
  { return 0; }

  void
  SingularLuus03::DadjointBCDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  }
  ...
  void
  SingularLuus03::DadjointBCDxxp_sparse(
    NodeType2 const             & LEFT__,
    NodeType2 const             & RIGHT__,
    P_const_pointer_type          P__,
    OMEGA_full_const_pointer_type OMEGA__,
