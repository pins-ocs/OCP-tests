...
namespace SingularLuus03Define {
  ...
  integer
  SingularLuus03::DgDxlxlp_numRows() const
  { return 1; }

  integer
  SingularLuus03::DgDxlxlp_numCols() const
  { return 12; }

  integer
  SingularLuus03::DgDxlxlp_nnz() const
  { return 2; }

  void
  SingularLuus03::DgDxlxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  SingularLuus03::DgDxlxlp_sparse(
    NodeType2 const &    LEFT__,
    NodeType2 const &    RIGHT__,
    U_const_pointer_type UM__,
    P_const_pointer_type P__,
  ...
  SingularLuus03::DuDxlxlp_full_analytic(
    ...
    real_type t2   = uControl.solve_rhs(-LM__[1], -1, 1);
