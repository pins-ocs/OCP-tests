...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef SINGULARLUUS03_API_DLL
    #ifdef SINGULARLUUS03_EXPORT
      #define SINGULARLUUS03_API_DLL __declspec(dllexport)
    #elif defined(SINGULARLUUS03_IMPORT)
      #define SINGULARLUUS03_API_DLL __declspec(dllimport)
    #else
      #define SINGULARLUUS03_API_DLL
    #endif
  #endif
...
namespace SingularLuus03Define {
  ...
  class SingularLuus03 : public Mechatronix::Discretized_Indirect_OCP {
    ...
    SingularLuus03( SingularLuus03 const & );
    SingularLuus03 const & operator = ( SingularLuus03 const & );
  ...
  public:
    ...
    SINGULARLUUS03_API_DLL virtual
    ~SingularLuus03() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    SINGULARLUUS03_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "SingularLuus03"; }
...
namespace SingularLuus03Load {
  using SingularLuus03Define::SingularLuus03;

}

#endif

// EOF: SingularLuus03.hh
