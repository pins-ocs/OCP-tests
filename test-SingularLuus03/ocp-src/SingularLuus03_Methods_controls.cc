...
namespace SingularLuus03Define {
  ...
  integer
  SingularLuus03::g_numEqns() const
  { return 1; }

  void
  SingularLuus03::g_eval(
  ...
  integer
  SingularLuus03::DgDxlp_numRows() const
  { return 1; }

  integer
  SingularLuus03::DgDxlp_numCols() const
  { return 6; }

  integer
  SingularLuus03::DgDxlp_nnz() const
  { return 1; }

  void
  SingularLuus03::DgDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  integer
  SingularLuus03::DgDu_numRows() const
  { return 1; }

  integer
  SingularLuus03::DgDu_numCols() const
  { return 1; }

  integer
  SingularLuus03::DgDu_nnz() const
  { return 1; }

  void
  SingularLuus03::DgDu_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  \*/
  integer
  SingularLuus03::u_numEqns() const
  { return 1; }

  void
  SingularLuus03::u_eval_analytic(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    U_pointer_type       U__
  ) const {
  ...
  \*/
  void
  SingularLuus03::DuDxlp_full_analytic(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
  ...
  bool
  SingularLuus03::DuDxlp_full_numeric(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    MatrixWrapper<real_type> & DuDxlp
    ...
    static integer DgDxlp_I[ 1 ], DgDxlp_J[ 1 ];
