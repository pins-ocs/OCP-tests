/*-----------------------------------------------------------------------*\
 |  file: SingularLuus03_dll_pins.hh                                     |
 |                                                                       |
...
namespace SingularLuus03Define {
  ...
  using namespace SingularLuus03Load;
  ...
  class SingularLuus03_Problem {

    SingularLuus03 model;
    ...
    SingularLuus03_Problem( SingularLuus03_Problem const & );
    SingularLuus03_Problem const & operator = ( SingularLuus03_Problem const & );
  ...
  public:
    ...
    SingularLuus03_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("SingularLuus03",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "SingularLuus03::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: SingularLuus03_dll_pins.hh
