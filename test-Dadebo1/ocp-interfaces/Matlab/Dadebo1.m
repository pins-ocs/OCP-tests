...
classdef Dadebo1 < handle
  ...
  methods
    ...
    function ok = solve( self )
      ...
      ok = Dadebo1_Mex( 'solve', self.objectHandle );
    end
    ...
    function res = x( self, varargin  )
      res = Dadebo1_Mex( 'get_solution', self.objectHandle, 'x', varargin{:} );
    end
    function res = y( self, varargin  )
      res = Dadebo1_Mex( 'get_solution', self.objectHandle, 'y', varargin{:} );
    end
    ...
    function res = lambda1( self, varargin )
      res = Dadebo1_Mex( 'get_solution', self.objectHandle, 'lambda1__xo', varargin{:} );
    end
    function res = lambda2( self, varargin )
      res = Dadebo1_Mex( 'get_solution', self.objectHandle, 'lambda2__xo', varargin{:} );
    end
    ...
    function res = u( self, varargin )
      res = Dadebo1_Mex( 'get_solution', self.objectHandle, 'u', varargin{:} );
    end
