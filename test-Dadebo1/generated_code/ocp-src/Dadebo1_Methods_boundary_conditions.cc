...
namespace Dadebo1Define {
  ...
  integer Dadebo1::boundaryConditions_numEqns() const { return 3; }

  void
  Dadebo1::boundaryConditions_eval(
  ...
  integer Dadebo1::adjointBC_numEqns() const { return 4; }

  void
  Dadebo1::adjointBC_eval(
    NodeType const              & LEFT__,
    NodeType const              & RIGHT__,
    P_const_pointer_type          P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Dadebo1::DadjointBCDxxp_numRows() const { return 4; }
  integer Dadebo1::DadjointBCDxxp_numCols() const { return 4; }
  integer Dadebo1::DadjointBCDxxp_nnz()     const { return 0; }

  void
  Dadebo1::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
