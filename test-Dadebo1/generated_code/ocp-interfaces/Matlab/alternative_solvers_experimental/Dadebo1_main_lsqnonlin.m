...
ocp.setup( [DATA_PATH 'Dadebo1_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = Dadebo1_Mex('get_raw_solution',obj);
%J        = Dadebo1_Mex('eval_JF',obj,Z,MU,U);
%f        = Dadebo1_Mex('eval_F',obj,Z,MU,U);
