...
namespace Dadebo1Define {
  ...
  class Dadebo1_Problem {
    ...
    Dadebo1_Problem( Dadebo1_Problem const & );
    Dadebo1_Problem const & operator = ( Dadebo1_Problem const & );
  ...
  public:
    ...
    DADEBO1_API_DLL
    Dadebo1_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("Dadebo1",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "Dadebo1::solver, fatal: unknown error";
      }
      return ok;
    }
