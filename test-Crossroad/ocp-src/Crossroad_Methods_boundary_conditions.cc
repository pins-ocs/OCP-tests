...
namespace CrossroadDefine {
  ...
  integer
  Crossroad::boundaryConditions_numEqns() const
  { return 6; }
  ...
  Crossroad::boundaryConditions_eval(
    ...
    result__[ 0   ] = XL__[0] - ModelPars[8];
    result__[ 1   ] = XL__[1] - ModelPars[10];
    result__[ 2   ] = XL__[2] - ModelPars[3];
    result__[ 3   ] = XR__[0] - ModelPars[7];
    result__[ 4   ] = XR__[1] - ModelPars[9];
    result__[ 5   ] = XR__[2] - ModelPars[2];
  ...
  integer
  Crossroad::adjointBC_numEqns() const
  { return 8; }
