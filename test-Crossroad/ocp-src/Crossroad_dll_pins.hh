...
namespace CrossroadDefine {
  ...
  class Crossroad_Problem {
    ...
    Crossroad_Problem( Crossroad_Problem const & );
    Crossroad_Problem const & operator = ( Crossroad_Problem const & );
  ...
  public:
    ...
    CROSSROAD_API_DLL
    Crossroad_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("Crossroad",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "Crossroad::solver, fatal: unknown error";
      }
      return ok;
    }
