...
public:
  ...
  do_kappa(
    ...
    #define CMD MODEL_NAME "_Mex('kappa', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->kappa(arg0) );
    #undef CMD
  }
  ...
  do_kappa_D(
    ...
    #define CMD MODEL_NAME "_Mex('kappa_D', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->kappa_D(arg0) );
    #undef CMD
  }
  ...
  do_kappa_DD(
    ...
    #define CMD MODEL_NAME "_Mex('kappa_DD', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->kappa_DD(arg0) );
    #undef CMD
  }
...
do_kappa(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_kappa( nlhs, plhs, nrhs, prhs );
}
...
do_kappa_D(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_kappa_D( nlhs, plhs, nrhs, prhs );
}
...
do_kappa_DD(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_kappa_DD( nlhs, plhs, nrhs, prhs );
}
