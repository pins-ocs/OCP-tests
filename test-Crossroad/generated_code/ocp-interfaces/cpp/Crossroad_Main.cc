...
main() {
  ...
  try {
    Crossroad * m_model = new Crossroad("Crossroad",&TP,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/Crossroad_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/Crossroad_Data.lua";
    #endif
    ...
    if ( ok ) {
      ...
      file.open( "data/Crossroad_OCP_result_NOT_CONVERGED.ßtxt" );
    }
    file.precision(18);
