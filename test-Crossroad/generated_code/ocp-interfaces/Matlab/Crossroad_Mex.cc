...
DO_COMMAND_REMAP_TO_CLASS_METHOD(kappa);
DO_COMMAND_REMAP_TO_CLASS_METHOD(kappa_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(kappa_DD);
DO_COMMAND_REMAP_TO_CLASS_METHOD(VelBound);
DO_COMMAND_REMAP_TO_CLASS_METHOD(VelBound_D);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "Crossroad_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "Crossroad_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
