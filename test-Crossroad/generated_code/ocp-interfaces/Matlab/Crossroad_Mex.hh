...
public:
  ...
  void do_kappa( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_kappa_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_kappa_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_VelBound( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_VelBound_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_VelBound_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
