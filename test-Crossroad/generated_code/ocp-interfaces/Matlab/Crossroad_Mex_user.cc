...
ProblemStorage::do_kappa(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('kappa', obj, xo__s ): "
  CHECK_IN_OUT( 3, 1 );
  mwSize N0, M0;
...
ProblemStorage::do_kappa_D(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('kappa_D', obj, xo__s ): "
  CHECK_IN_OUT( 3, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__s" );
...
ProblemStorage::do_kappa_DD(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('kappa_DD', obj, xo__s ): "
  CHECK_IN_OUT( 3, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__s" );
...
ProblemStorage::do_VelBound(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('VelBound', obj, xo___V ): "
  CHECK_IN_OUT( 3, 1 );
  mwSize N0, M0;
...
ProblemStorage::do_VelBound_D(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('VelBound_D', obj, xo___V ): "
  CHECK_IN_OUT( 3, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo___V" );
...
ProblemStorage::do_VelBound_DD(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('VelBound_DD', obj, xo___V ): "
  CHECK_IN_OUT( 3, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo___V" );
