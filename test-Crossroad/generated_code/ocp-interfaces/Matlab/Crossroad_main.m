...
%ocp.setup(Crossroad_data);
ocp.setup('../../data/Crossroad_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Crossroad_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = Crossroad_Mex('get_raw_solution',obj);
%J     = Crossroad_Mex('eval_JF',obj,Z,MU,U);
%f     = Crossroad_Mex('eval_F',obj,Z,MU,U);
