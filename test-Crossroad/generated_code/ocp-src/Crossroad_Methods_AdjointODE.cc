...
namespace CrossroadDefine {
  ...
  Crossroad::DHxDx_sparse(
    ...
    real_type t2   = t1 * t1;
    real_type t3   = t2 * t2;
    real_type t5   = ModelPars[iM_alat_max] * ModelPars[iM_alat_max];
    real_type t6   = X__[iX_s];
    real_type t7   = kappa(t6);
    real_type t8   = kappa_DD(t6);
    real_type t10  = kappa_D(t6);
    real_type t11  = t10 * t10;
    real_type t14  = X__[iX_a];
    real_type t15  = t14 * t14;
    real_type t17  = ModelPars[iM_along_max] * ModelPars[iM_along_max];
    real_type t18  = 1.0 / t17;
    real_type t20  = t7 * t7;
    real_type t22  = 1.0 / t5;
    real_type t24  = -t22 * t20 * t3 - t18 * t15 + 1;
    real_type t25  = ALIAS_AccBound_D(t24);
    real_type t28  = ALIAS_AccBound_DD(t24);
    real_type t29  = t28 * t20;
    real_type t34  = t5 * t5;
    real_type t35  = 1.0 / t34;
    result__[ 0   ] = 4 * t35 * (-t25 * (t8 * t7 + t11) * t5 / 2 + t3 * t11 * t29) * t3;
    real_type t38  = t2 * t1;
    result__[ 1   ] = 8 * t35 * (-t5 * t25 + t3 * t29) * t38 * t10 * t7;
    real_type t46  = t18 * t14 * t28;
    result__[ 2   ] = 4 * t10 * t22 * t7 * t3 * t46;
    result__[ 3   ] = result__[1];
    real_type t53  = t20 * t20;
    real_type t61  = ALIAS_VelBound_DD(t1);
    result__[ 4   ] = 16 * t35 * t53 * t3 * t2 * t28 - 12 * t22 * t20 * t2 * t25 + t61;
    result__[ 5   ] = 8 * t22 * t20 * t38 * t46;
    result__[ 6   ] = L__[iL_lambda1__xo];
    result__[ 7   ] = result__[2];
    result__[ 8   ] = result__[5];
    real_type t66  = t17 * t17;
    result__[ 9   ] = 4 / t66 * t15 * t28 - 2 * t18 * t25;
