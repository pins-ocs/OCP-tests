...
namespace CrossroadDefine {
  ...
  Crossroad::Hxp_eval(
    ...
    result__[ 1   ] = 4 * t16 * t12 * t8 * t7 * t19 + t35 * t34 - t30 + t33;
    real_type t40  = MU__[1];
    result__[ 2   ] = 2 * t5 * t1 * t19 + t35 * t40;
    real_type t44  = U__[iU_jerk];
    real_type t45  = t44 * t44;
    real_type t47  = ALIAS_Tpositive_D(-t35);
    result__[ 3   ] = t1 * t40 + t7 * t34 + t44 * MU__[2] + t45 * ModelPars[iM_wJ] - t47 + ModelPars[iM_wT];
    if ( m_debug )
