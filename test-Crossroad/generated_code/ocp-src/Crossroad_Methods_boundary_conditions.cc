...
namespace CrossroadDefine {
  ...
  integer Crossroad::fd_BC_numEqns() const { return 8; }

  void
  Crossroad::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Crossroad::Dfd_BCDxlxlp_numRows() const { return 8; }
  integer Crossroad::Dfd_BCDxlxlp_numCols() const { return 16; }
  integer Crossroad::Dfd_BCDxlxlp_nnz()     const { return 8; }

  void
  Crossroad::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
