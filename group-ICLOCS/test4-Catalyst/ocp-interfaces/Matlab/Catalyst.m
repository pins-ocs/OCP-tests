...
classdef Catalyst < handle
  ...
  methods
    ...
    function self = Catalyst( name, infoLevel )
      self.objectHandle = Catalyst_Mex( 'new', name, infoLevel );
    end
    ...
    function guess( self, varargin )
      Catalyst_Mex( 'guess', self.objectHandle, varargin{:} );
    end
    ...
    function sol = pack( self, X, Lambda, Pars, Ommega )
      sol = Catalyst_Mex( 'pack', self.objectHandle, X, Lambda, Pars, Ommega );
    end

    function [X, Lambda, Pars, Ommega] = unpack( self, sol )
      [X, Lambda, Pars, Ommega] = Catalyst_Mex( 'unpack', self.objectHandle, sol );
    end
