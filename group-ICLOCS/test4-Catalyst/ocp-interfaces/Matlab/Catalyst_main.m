...
% create object
infolevel = 4;
ocp = Catalyst( 'Catalyst', infolevel );
...
%ocp.setup(Catalyst_data);
%ocp.setup('../../data/Catalyst_Data.lua');
ocp.setup('../../data/Catalyst_Data.rb');
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Catalyst_Mex('set_tracked',obj,tracked);
...
%%clear mex
%x = Catalyst_Mex('get_raw_solution',obj);
%J = Catalyst_Mex('eval_JF',obj,x);
%f = Catalyst_Mex('eval_F',obj,x);
