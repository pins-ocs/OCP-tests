...
main() {
  ...
  try {
    ICLOCS2_AlyChan * m_model = new ICLOCS2_AlyChan("ICLOCS2_AlyChan",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/ICLOCS2_AlyChan_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/ICLOCS2_AlyChan_Data.lua";
    #endif
