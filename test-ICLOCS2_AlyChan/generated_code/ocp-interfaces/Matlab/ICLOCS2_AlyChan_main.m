...
% create object
ocp = ICLOCS2_AlyChan( 'ICLOCS2_AlyChan' );
...
%ocp.setup(ICLOCS2_AlyChan_data);
ocp.setup('../../data/ICLOCS2_AlyChan_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ICLOCS2_AlyChan_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = ICLOCS2_AlyChan_Mex('get_raw_solution',obj);
%J     = ICLOCS2_AlyChan_Mex('eval_JF',obj,Z,MU,U);
%f     = ICLOCS2_AlyChan_Mex('eval_F',obj,Z,MU,U);
