...
%ocp.setup('../../data/ICLOCS2_AlyChan_Data.lua');
ocp.setup('../../data/ICLOCS2_AlyChan_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = ICLOCS2_AlyChan_Mex('get_raw_solution',obj);
%J     = ICLOCS2_AlyChan_Mex('eval_JF',obj,Z,U);
%f     = ICLOCS2_AlyChan_Mex('eval_F',obj,Z,U);
