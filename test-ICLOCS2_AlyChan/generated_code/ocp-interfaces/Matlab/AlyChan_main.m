...
%ocp.setup(AlyChan_data);
%ocp.setup('../../data/AlyChan_Data.lua');
ocp.setup('../../data/AlyChan_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%AlyChan_Mex('set_tracked',obj,tracked);
...
%[Z,U] = AlyChan_Mex('get_raw_solution',obj);
%J     = AlyChan_Mex('eval_JF',obj,Z,U);
%f     = AlyChan_Mex('eval_F',obj,Z,U);
