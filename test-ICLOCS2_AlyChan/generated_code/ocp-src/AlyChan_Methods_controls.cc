/*-----------------------------------------------------------------------*\
 |  file: AlyChan_Methods_controls.cc                                    |
 |                                                                       |
...
namespace AlyChanDefine {
  ...
  integer
  AlyChan::DgDxlxlp_numRows() const
  { return 1; }

  integer
  AlyChan::DgDxlxlp_numCols() const
  { return 12; }

  integer
  AlyChan::DgDxlxlp_nnz() const
  { return 2; }

  void
  AlyChan::DgDxlxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  integer
  AlyChan::DgDu_numRows() const
  { return 1; }

  integer
  AlyChan::DgDu_numCols() const
  { return 1; }

  integer
  AlyChan::DgDu_nnz() const
  { return 1; }

  void
  AlyChan::DgDu_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  AlyChan::DuDxlxlp_full_analytic(
    NodeType2 const &          LEFT__,
    NodeType2 const &          RIGHT__,
    P_const_pointer_type       P__,
    U_const_pointer_type       UM__,
  ...
  integer
  AlyChan::DmDuu_numRows() const
  { return 1; }

  integer
  AlyChan::DmDuu_numCols() const
  { return 1; }

  integer
  AlyChan::DmDuu_nnz() const
  { return 1; }

  void
  AlyChan::DmDuu_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
...
// EOF: AlyChan_Methods_controls.cc
