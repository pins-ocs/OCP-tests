/*-----------------------------------------------------------------------*\
 |  file: ICLOCS2_AlyChan_dll_pins.hh                                    |
 |                                                                       |
...
namespace ICLOCS2_AlyChanDefine {
  ...
  using namespace ICLOCS2_AlyChanLoad;
  ...
  class ICLOCS2_AlyChan_Problem {

    ICLOCS2_AlyChan model;
    ...
    ICLOCS2_AlyChan_Problem( ICLOCS2_AlyChan_Problem const & );
    ICLOCS2_AlyChan_Problem const & operator = ( ICLOCS2_AlyChan_Problem const & );
  ...
  public:
    ...
    ICLOCS2_AlyChan_Problem( ThreadPool * TP, Console const * console )
    : model("ICLOCS2_AlyChan",TP,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "ICLOCS2_AlyChan::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: ICLOCS2_AlyChan_dll_pins.hh
