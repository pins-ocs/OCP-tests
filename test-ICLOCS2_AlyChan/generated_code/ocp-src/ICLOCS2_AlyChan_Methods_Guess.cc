...
namespace ICLOCS2_AlyChanDefine {
  ...
  void
  ICLOCS2_AlyChan::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  ICLOCS2_AlyChan::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  ICLOCS2_AlyChan::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  ICLOCS2_AlyChan::xlambda_check_node(
    integer              ipos,
  ...
  bool
  ICLOCS2_AlyChan::xlambda_check_cell(
    integer              icell,
  ...
  integer ICLOCS2_AlyChan::u_guess_numEqns() const { return 1; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  ICLOCS2_AlyChan::u_guess_eval(
    NodeType2 const    & LEFT__,
    NodeType2 const    & RIGHT__,
    P_const_pointer_type P__,
  ...
  bool
  ICLOCS2_AlyChan::u_check_if_admissible(
    NodeType2 const    & NODE__,
