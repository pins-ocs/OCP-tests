...
namespace ICLOCS2_AlyChanDefine {
  ...
  */
  ICLOCS2_AlyChan::ICLOCS2_AlyChan(
    string const   & name,
  ...
  */
  void
  ICLOCS2_AlyChan::update_continuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
    ...
    UTILS_ASSERT(
      0 <= old_s && old_s < s && s <= 1,
      "ICLOCS2_AlyChan::update_continuation( phase number={}, old_s={}, s={} ) "
      "must be 0 <= old_s < s <= 1\n",
      phase, old_s, s
    );
    switch ( phase ) {
  ...
  */
  void
  ICLOCS2_AlyChan::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "ICLOCS2_AlyChan::setup_parameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in ICLOCS2_AlyChan::setup not all parameters are set!\n"
    );
  }

  void
  ICLOCS2_AlyChan::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  ICLOCS2_AlyChan::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  ICLOCS2_AlyChan::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  ICLOCS2_AlyChan::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  ICLOCS2_AlyChan::setup_controls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "ICLOCS2_AlyChan::setup_classes: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  ICLOCS2_AlyChan::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "ICLOCS2_AlyChan::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in ICLOCS2_AlyChan::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  ICLOCS2_AlyChan::info_model( integer level ) const {
  ...
  */
  void
  ICLOCS2_AlyChan::setup( GenericContainer const & gc ) {

    m_debug = false;
    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("ICLOCS2_AlyChan::setup, Debug");
  ...
  */
  void
  ICLOCS2_AlyChan::get_names( GenericContainer & out ) const {
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  void
  ICLOCS2_AlyChan::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
