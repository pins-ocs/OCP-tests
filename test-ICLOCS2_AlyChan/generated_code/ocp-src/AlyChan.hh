...
#ifndef ALYCHAN_DOT_HH
#define ALYCHAN_DOT_HH
...
// User Header (end)
  ...
  #ifndef ALYCHAN_API_DLL
    #ifdef ALYCHAN_EXPORT
      #define ALYCHAN_API_DLL __declspec(dllexport)
    #elif defined(ALYCHAN_IMPORT)
      #define ALYCHAN_API_DLL __declspec(dllimport)
    #else
      #define ALYCHAN_API_DLL
    #endif
  #endif
...
namespace AlyChanDefine {
  ...
  class AlyChan : public Mechatronix::Discretized_Indirect_OCP {
    ...
    AlyChan( AlyChan const & );
    AlyChan const & operator = ( AlyChan const & );
...
namespace AlyChanLoad {
  using AlyChanDefine::AlyChan;
