...
namespace AlyChanDefine {
  ...
  void
  AlyChan::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  AlyChan::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  AlyChan::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  integer
  AlyChan::u_guess_numEqns() const
  { return 1; }

  void
  AlyChan::u_guess_eval(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
