...
namespace AlyChanDefine {
  ...
  class AlyChan_Problem {
    ...
    AlyChan_Problem( AlyChan_Problem const & );
    AlyChan_Problem const & operator = ( AlyChan_Problem const & );
  ...
  public:
    ...
    ALYCHAN_API_DLL
    AlyChan_Problem( ThreadPool * TP, Console const * console )
    : model("AlyChan",TP,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "AlyChan::solver, fatal: unknown error";
      }
      return ok;
    }
