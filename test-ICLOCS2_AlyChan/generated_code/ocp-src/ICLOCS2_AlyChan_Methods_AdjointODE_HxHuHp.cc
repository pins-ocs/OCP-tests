...
namespace ICLOCS2_AlyChanDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer ICLOCS2_AlyChan::DHxpDxpu_numRows() const { return 3; }
  integer ICLOCS2_AlyChan::DHxpDxpu_numCols() const { return 4; }
  integer ICLOCS2_AlyChan::DHxpDxpu_nnz()     const { return 2; }

  void
  ICLOCS2_AlyChan::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  ICLOCS2_AlyChan::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
