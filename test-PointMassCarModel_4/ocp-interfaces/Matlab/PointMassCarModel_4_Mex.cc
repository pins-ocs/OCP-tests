/*-----------------------------------------------------------------------*\
 |  file: PointMassCarModel_4_Mex.cc                                     |
 |                                                                       |
...
"PointMassCarModel_4_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "PointMassCarModel_4"
#define MODEL_CLASS PointMassCarModel_4
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "PointMassCarModel_4_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "PointMassCarModel_4_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
