...
namespace PointMassCarModel_4Define {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_4::DbcDxxp_numRows() const { return 8; }
  integer PointMassCarModel_4::DbcDxxp_numCols() const { return 14; }
  integer PointMassCarModel_4::DbcDxxp_nnz()     const { return 13; }

  void
  PointMassCarModel_4::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  PointMassCarModel_4::DbcDxxp_sparse(
    NodeQX const & LEFT__,
    NodeQX const & RIGHT__,
    P_const_p_type P__,
    real_ptr       result__
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_4::D2bcD2xxp_numRows() const { return 14; }
  integer PointMassCarModel_4::D2bcD2xxp_numCols() const { return 14; }
  integer PointMassCarModel_4::D2bcD2xxp_nnz()     const { return 0; }

  void
  PointMassCarModel_4::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
  ...
  integer PointMassCarModel_4::fd_BC_numEqns() const { return 14; }

  void
  PointMassCarModel_4::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_4::Dfd_BCDxlxlp_numRows() const { return 14; }
  integer PointMassCarModel_4::Dfd_BCDxlxlp_numCols() const { return 28; }
  integer PointMassCarModel_4::Dfd_BCDxlxlp_nnz()     const { return 14; }

  void
  PointMassCarModel_4::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  PointMassCarModel_4::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
