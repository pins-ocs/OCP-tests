...
namespace PointMassCarModel_4Define {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_4::Dfd_odeDxxpu_numRows() const { return 7; }
  integer PointMassCarModel_4::Dfd_odeDxxpu_numCols() const { return 16; }
  integer PointMassCarModel_4::Dfd_odeDxxpu_nnz()     const { return 48; }

  void
  PointMassCarModel_4::Dfd_odeDxxpu_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  PointMassCarModel_4::Dfd_odeDxxpu_sparse(
    NodeType const &     LEFT__,
    NodeType const &     RIGHT__,
    P_const_pointer_type P__,
    U_const_pointer_type UM__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_4::D2fd_odeD2xxpu_numRows() const { return 16; }
  integer PointMassCarModel_4::D2fd_odeD2xxpu_numCols() const { return 16; }
  integer PointMassCarModel_4::D2fd_odeD2xxpu_nnz()     const { return 124; }

  void
  PointMassCarModel_4::D2fd_odeD2xxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
    iIndex[1 ] = 0   ; jIndex[1 ] = 1   ;
    iIndex[2 ] = 0   ; jIndex[2 ] = 2   ;
    iIndex[3 ] = 0   ; jIndex[3 ] = 3   ;
  ...
  void
  PointMassCarModel_4::D2fd_odeD2xxpu_sparse(
    NodeType const &     LEFT__,
    NodeType const &     RIGHT__,
    P_const_pointer_type P__,
    U_const_pointer_type UM__,
