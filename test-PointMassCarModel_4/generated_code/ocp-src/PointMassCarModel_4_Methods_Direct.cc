...
namespace PointMassCarModel_4Define {
  ...
  integer PointMassCarModel_4::fd_ode_numEqns() const { return 7; }

  void
  PointMassCarModel_4::fd_ode_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_4::Dfd_odeDxxup_numRows() const { return 7; }
  integer PointMassCarModel_4::Dfd_odeDxxup_numCols() const { return 16; }
  integer PointMassCarModel_4::Dfd_odeDxxup_nnz()     const { return 48; }

  void
  PointMassCarModel_4::Dfd_odeDxxup_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  PointMassCarModel_4::Dfd_odeDxxup_sparse(
    NodeType const &     LEFT__,
    NodeType const &     RIGHT__,
    P_const_pointer_type P__,
    U_const_pointer_type UM__,
    ...
    real_type t12  = 0.5e0 * t10 * t8 * t2;
    result__[ 0   ] = -t12 - __INV_DZETA;
    real_type t13  = zeta__dot_D_3(t3, t4, t5, t7);
    result__[ 1   ] = -0.5e0 * t13 * t2;
    real_type t16  = zeta__dot_D_2(t3, t4, t5, t7);
    result__[ 2   ] = -0.5e0 * t16 * t2;
    real_type t19  = zeta__dot_D_1(t3, t4, t5, t7);
    result__[ 3   ] = -0.5e0 * t19 * t2;
    real_type t22  = zeta__dot(t3, t4, t5, t7);
    result__[ 4   ] = -0.5e0 * t22 * t2;
    ...
    real_type t25  = t3 * t2;
    real_type t26  = cos(t4);
    result__[ 11  ] = -0.5e0 * t26 * t25;
    real_type t29  = sin(t4);
    result__[ 12  ] = -0.5e0 * t29 * t2;
    result__[ 13  ] = -0.5e0 * t29 * t25;
    result__[ 14  ] = __INV_DZETA;
    result__[ 15  ] = result__[11];
    result__[ 16  ] = result__[12];
    result__[ 17  ] = result__[13];
    result__[ 18  ] = 0.5e0 * t2 * (t10 * t8 * t7 + t22 * t10);
    result__[ 19  ] = 0.5e0 * t2 * t13 * t7;
    real_type t43  = 0.5e0 * t2 * t16 * t7;
    result__[ 20  ] = t43 + result__[10];
    result__[ 21  ] = 0.5e0 * t2 * t19 * t7;
    result__[ 22  ] = -0.5e0 * t2;
    result__[ 23  ] = 0.5e0 * t2 * (t22 * t7 - XM__[4]);
    result__[ 24  ] = result__[18];
    result__[ 25  ] = result__[19];
    result__[ 26  ] = t43 + __INV_DZETA;
    result__[ 27  ] = result__[21];
    result__[ 28  ] = result__[22];
    result__[ 29  ] = result__[23];
    real_type t51  = ModelPars[iM_kD];
    real_type t54  = 0.10e1 * t2 * t3 * t51;
    result__[ 30  ] = t54 + result__[10];
    result__[ 31  ] = result__[28];
    real_type t55  = t3 * t3;
    result__[ 32  ] = -0.5e0 * t2 * (-t51 * t55 + XM__[5]);
    result__[ 33  ] = t54 + __INV_DZETA;
    result__[ 34  ] = result__[31];
    result__[ 35  ] = result__[32];
    result__[ 36  ] = result__[10];
    real_type t63  = ModelPars[iM_v__Omega__max];
    result__[ 37  ] = -0.5e0 * t63 * UM__[1] * t2;
    result__[ 38  ] = __INV_DZETA;
    result__[ 39  ] = result__[37];
    result__[ 40  ] = -t63 * t2;
    result__[ 41  ] = result__[36];
    real_type t69  = ModelPars[iM_v__fx__max];
    result__[ 42  ] = -0.5e0 * t69 * UM__[0] * t2;
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_4::D2fd_odeD2xxup_numRows() const { return 16; }
  integer PointMassCarModel_4::D2fd_odeD2xxup_numCols() const { return 16; }
  integer PointMassCarModel_4::D2fd_odeD2xxup_nnz()     const { return 124; }

  void
  PointMassCarModel_4::D2fd_odeD2xxup_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
    iIndex[1 ] = 0   ; jIndex[1 ] = 1   ;
    iIndex[2 ] = 0   ; jIndex[2 ] = 2   ;
    iIndex[3 ] = 0   ; jIndex[3 ] = 3   ;
  ...
  void
  PointMassCarModel_4::D2fd_odeD2xxup_sparse(
    NodeType const &     LEFT__,
    NodeType const &     RIGHT__,
    P_const_pointer_type P__,
    U_const_pointer_type UM__,
    ...
    V__[6] = __INV_DZETA*(XR__[6]-XL__[6]);
    Road2D::SegmentClass const & segment = pRoad->get_segment_by_index(i_segment);
    real_type t6   = exp(XR__[iX_log_inv_Vseg] / 2 + XL__[iX_log_inv_Vseg] / 2);
    real_type t7   = t6 * LM__[0];
    real_type t11  = XR__[iX_V] / 2 + XL__[iX_V] / 2;
    real_type t15  = XR__[iX_alpha] / 2 + XL__[iX_alpha] / 2;
    real_type t19  = XR__[iX_n] / 2 + XL__[iX_n] / 2;
    real_type t23  = XR__[iX_s] / 2 + XL__[iX_s] / 2;
    real_type t24  = ALIAS_Kappa(t23);
    real_type t25  = zeta__dot_D_4_4(t11, t15, t19, t24);
    real_type t26  = ALIAS_Kappa_D(t23);
    real_type t27  = t26 * t26;
    real_type t31  = zeta__dot_D_4(t11, t15, t19, t24);
    real_type t32  = ALIAS_Kappa_DD(t23);
    real_type t36  = LM__[2];
    real_type t37  = zeta__dot(t11, t15, t19, t24);
    real_type t45  = t31 * t24;
    result__[ 0   ] = -t27 * t25 * t7 / 4 - t32 * t31 * t7 / 4 + t6 * (t37 * t32 / 4 + t31 * t27 / 2 + t27 * t25 * t24 / 4 + t32 * t45 / 4) * t36;
    real_type t51  = zeta__dot_D_3_4(t11, t15, t19, t24);
    real_type t52  = t26 * t51;
    real_type t53  = t52 * t7;
    real_type t55  = zeta__dot_D_3(t11, t15, t19, t24);
    result__[ 1   ] = -t53 / 4 + t6 * (t26 * t51 * t24 / 4 + t55 * t26 / 4) * t36;
    real_type t63  = zeta__dot_D_2_4(t11, t15, t19, t24);
    real_type t64  = t26 * t63;
    real_type t65  = t64 * t7;
    real_type t67  = zeta__dot_D_2(t11, t15, t19, t24);
    result__[ 2   ] = -t65 / 4 + t6 * (t26 * t63 * t24 / 4 + t67 * t26 / 4) * t36;
    real_type t75  = zeta__dot_D_1_4(t11, t15, t19, t24);
    real_type t76  = t26 * t75;
    real_type t77  = t76 * t7;
    real_type t79  = zeta__dot_D_1(t11, t15, t19, t24);
    result__[ 3   ] = -t77 / 4 + t6 * (t26 * t75 * t24 / 4 + t79 * t26 / 4) * t36;
    result__[ 4   ] = -t26 * t31 * t7 / 4 + t6 * (t37 * t26 / 2 + t26 * t45 / 2) * t36 / 2;
    ...
    real_type t97  = zeta__dot_D_3_3(t11, t15, t19, t24);
    real_type t99  = t24 * t36;
    result__[ 11  ] = t6 * t97 * t99 / 4 - t97 * t7 / 4;
    real_type t103 = zeta__dot_D_2_3(t11, t15, t19, t24);
    result__[ 12  ] = t6 * t103 * t99 / 4 - t103 * t7 / 4;
    real_type t108 = zeta__dot_D_1_3(t11, t15, t19, t24);
    result__[ 13  ] = t6 * t108 * t99 / 4 - t108 * t7 / 4;
    real_type t114 = t6 * t55;
    result__[ 14  ] = t114 * t99 / 4 - t55 * t7 / 4;
    real_type t117 = t26 * t36;
    result__[ 15  ] = t6 * t52 * t99 / 4 + t114 * t117 / 4 - t53 / 4;
    ...
    real_type t122 = zeta__dot_D_2_2(t11, t15, t19, t24);
    real_type t125 = t6 * LM__[1];
    real_type t126 = sin(t15);
    real_type t128 = t126 * t11 * t125;
    result__[ 22  ] = t6 * t122 * t99 / 4 - t122 * t7 / 4 + t128 / 4;
    real_type t132 = zeta__dot_D_1_2(t11, t15, t19, t24);
    real_type t134 = cos(t15);
    result__[ 23  ] = t6 * t132 * t99 / 4 - t134 * t125 / 4 - t132 * t7 / 4;
    real_type t142 = t6 * t67;
    result__[ 24  ] = -t134 * t11 * t125 / 4 + t142 * t99 / 4 - t67 * t7 / 4;
    result__[ 25  ] = t6 * t64 * t99 / 4 + t142 * t117 / 4 - t65 / 4;
    ...
    real_type t149 = zeta__dot_D_1_1(t11, t15, t19, t24);
    real_type t155 = LM__[3];
    real_type t156 = ModelPars[iM_kD];
    real_type t157 = t156 * t155;
    result__[ 33  ] = -t149 * t7 / 4 + t6 * t149 * t99 / 4 + t6 * t157 / 2;
    real_type t164 = t6 * t79;
    result__[ 34  ] = -t79 * t7 / 4 - t126 * t125 / 4 + t164 * t99 / 4 + t6 * t11 * t157 / 2;
    result__[ 35  ] = t6 * t76 * t99 / 4 + t164 * t117 / 4 - t77 / 4;
    result__[ 36  ] = result__[31];
    result__[ 37  ] = result__[32];
    result__[ 38  ] = result__[33];
    result__[ 39  ] = result__[34];
    result__[ 40  ] = -t6 * t36 / 4;
    result__[ 41  ] = result__[40];
    result__[ 42  ] = -t6 * t155 / 4;
    ...
    real_type t191 = t11 * t11;
    real_type t197 = t6 * LM__[4];
    real_type t199 = ModelPars[iM_v__Omega__max];
    real_type t203 = t6 * LM__[5];
    real_type t205 = ModelPars[iM_v__fx__max];
    result__[ 50  ] = -t37 * t7 / 4 - t128 / 4 + t6 * (-XR__[iX_Omega] / 2 - XL__[iX_Omega] / 2 + t37 * t24) * t36 / 4 - t6 * (XR__[iX_fx] / 2 + XL__[iX_fx] / 2 - t191 * t156) * t155 / 4 - t199 * UM__[1] * t197 / 4 - t205 * UM__[0] * t203 / 4;
    ...
    result__[ 58  ] = -t205 * t203 / 2;
    result__[ 59  ] = -t199 * t197 / 2;
...
// EOF: PointMassCarModel_4_Methods_Guess.cc
