...
namespace PointMassCarModel_4Define {
  ...
  */
  void
  PointMassCarModel_4::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "PointMassCarModel_4::setup_parameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in PointMassCarModel_4::setup not all parameters are set!\n"
    );
  }
  ...
  */
  void
  PointMassCarModel_4::setup_classes( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Constraints"),
      "PointMassCarModel_4::setup_classes: Missing key `Parameters` in data\n"
    );
    GenericContainer const & gc = gc_data("Constraints");
    // Initialize Constraints 1D
    UTILS_ASSERT0(
      gc.exists("AdherenceEllipse"),
      "in PointMassCarModel_4::setup_classes(gc) missing key: ``AdherenceEllipse''\n"
    );
    AdherenceEllipse.setup( gc("AdherenceEllipse") );

    UTILS_ASSERT0(
      gc.exists("RoadLeftBorder"),
      "in PointMassCarModel_4::setup_classes(gc) missing key: ``RoadLeftBorder''\n"
    );
    RoadLeftBorder.setup( gc("RoadLeftBorder") );

    UTILS_ASSERT0(
      gc.exists("RoadRightBorder"),
      "in PointMassCarModel_4::setup_classes(gc) missing key: ``RoadRightBorder''\n"
    );
    RoadRightBorder.setup( gc("RoadRightBorder") );

    UTILS_ASSERT0(
      gc.exists("PowerLimit"),
      "in PointMassCarModel_4::setup_classes(gc) missing key: ``PowerLimit''\n"
    );
  ...
  */
  void
  PointMassCarModel_4::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  PointMassCarModel_4::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  PointMassCarModel_4::setup_controls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "PointMassCarModel_4::setup_classes: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  PointMassCarModel_4::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "PointMassCarModel_4::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pRoad"),
      "in PointMassCarModel_4::setup_pointers(gc) cant find key `pRoad' in gc\n"
    );
  ...
  */
  void
  PointMassCarModel_4::info_model( integer level ) const {
  ...
  */
  void
  PointMassCarModel_4::setup( GenericContainer const & gc ) {

    m_debug = false;
    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("PointMassCarModel_4::setup, Debug");
  ...
  */
  void
  PointMassCarModel_4::get_names( GenericContainer & out ) const {
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  void
  PointMassCarModel_4::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
