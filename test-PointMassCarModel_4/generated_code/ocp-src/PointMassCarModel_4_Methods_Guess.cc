...
namespace PointMassCarModel_4Define {
  ...
  void
  PointMassCarModel_4::p_guess_eval( P_pointer_type P__ ) const {
  }
  ...
  bool
  PointMassCarModel_4::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  PointMassCarModel_4::xlambda_check_cell(
    integer              icell,
  ...
  PointMassCarModel_4::u_guess_eval(
    ...
    UGUESS__[ iU_v__fx    ] = v__OmegaControl.solve(-ModelPars[iM_v__fx__max] * L__[iL_lambda6__xo], -1, 1);
    UGUESS__[ iU_v__Omega ] = v__OmegaControl.solve(-ModelPars[iM_v__Omega__max] * L__[iL_lambda5__xo], -1, 1);
    if ( m_debug )
