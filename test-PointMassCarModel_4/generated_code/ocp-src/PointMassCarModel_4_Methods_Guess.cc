...
namespace PointMassCarModel_4Define {
  ...
  void
  PointMassCarModel_4::p_guess_eval( P_p_type P__ ) const {
  }

  void
  PointMassCarModel_4::xlambda_guess_eval(
    integer        i_segment,
    Q_const_p_type Q__,
    P_const_p_type P__,
    X_p_type       X__,
    ...
    { // open block to avoid temporary clash
      ...
      X__[ iX_log_inv_Vseg ] = log(1.0 / X__[iX_V]);
    }
    { // open block to avoid temporary clash
  ...
  bool
  PointMassCarModel_4::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  PointMassCarModel_4::xlambda_check_node(
    integer         ipos,
  ...
  bool
  PointMassCarModel_4::penalties_check(
    NodeQX const & NODE__,
    P_const_p_type P__
  ) const {
    ...
    ok = ok && RoadLeftBorder.check_range(t22 - t24);
    real_type t26  = ALIAS_rightWidth(t23);
    ok = ok && RoadRightBorder.check_range(-t22 - t26);
  ...
  integer PointMassCarModel_4::u_guess_numEqns() const { return 2; }
  ...
  PointMassCarModel_4::u_guess_eval(
    ...
    UGUESS__[ iU_v__fx    ] = v__OmegaControl.solve(-MU__[5] * ModelPars[iM_v__fx__max], -1, 1);
    UGUESS__[ iU_v__Omega ] = v__OmegaControl.solve(-MU__[4] * ModelPars[iM_v__Omega__max], -1, 1);
    if ( m_debug )
