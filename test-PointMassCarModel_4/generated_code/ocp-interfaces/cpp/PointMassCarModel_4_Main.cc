...
main() {
  ...
  try {
    PointMassCarModel_4 * m_model = new PointMassCarModel_4("PointMassCarModel_4",n_threads,&console);

    // user defined Object instances (external)
    Road2D           road( "road" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/PointMassCarModel_4_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/PointMassCarModel_4_Data.lua";
    #endif
