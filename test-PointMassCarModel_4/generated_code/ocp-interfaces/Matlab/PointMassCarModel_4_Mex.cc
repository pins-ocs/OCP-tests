...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"zeta__dot",&ProblemStorage::do_zeta__dot},
  {"zeta__dot_D_1",&ProblemStorage::do_zeta__dot_D_1},
  {"zeta__dot_D_2",&ProblemStorage::do_zeta__dot_D_2},
  {"zeta__dot_D_3",&ProblemStorage::do_zeta__dot_D_3},
  {"zeta__dot_D_4",&ProblemStorage::do_zeta__dot_D_4},
  {"zeta__dot_D_1_1",&ProblemStorage::do_zeta__dot_D_1_1},
  {"zeta__dot_D_1_2",&ProblemStorage::do_zeta__dot_D_1_2},
  {"zeta__dot_D_1_3",&ProblemStorage::do_zeta__dot_D_1_3},
  {"zeta__dot_D_1_4",&ProblemStorage::do_zeta__dot_D_1_4},
  {"zeta__dot_D_2_2",&ProblemStorage::do_zeta__dot_D_2_2},
  {"zeta__dot_D_2_3",&ProblemStorage::do_zeta__dot_D_2_3},
  {"zeta__dot_D_2_4",&ProblemStorage::do_zeta__dot_D_2_4},
  {"zeta__dot_D_3_3",&ProblemStorage::do_zeta__dot_D_3_3},
  {"zeta__dot_D_3_4",&ProblemStorage::do_zeta__dot_D_3_4},
  {"zeta__dot_D_4_4",&ProblemStorage::do_zeta__dot_D_4_4}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "PointMassCarModel_4_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
