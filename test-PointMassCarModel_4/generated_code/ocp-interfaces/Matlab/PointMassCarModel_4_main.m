%-----------------------------------------------------------------------%
%  file: PointMassCarModel_4_main.m                                     %
%                                                                       %
...
% create object
ocp = PointMassCarModel_4( 'PointMassCarModel_4' );
...
%ocp.setup(PointMassCarModel_4_data);
%ocp.setup('../../data/PointMassCarModel_4_Data.lua');
ocp.setup('../../data/PointMassCarModel_4_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%PointMassCarModel_4_Mex('set_tracked',obj,tracked);
...
%[Z,U] = PointMassCarModel_4_Mex('get_raw_solution',obj);
%J     = PointMassCarModel_4_Mex('eval_JF',obj,Z,U);
%f     = PointMassCarModel_4_Mex('eval_F',obj,Z,U);
