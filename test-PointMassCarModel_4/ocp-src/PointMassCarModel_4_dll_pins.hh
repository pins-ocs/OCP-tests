/*-----------------------------------------------------------------------*\
 |  file: PointMassCarModel_4_dll_pins.hh                                |
 |                                                                       |
...
namespace PointMassCarModel_4Define {
  ...
  public:
    ...
    PointMassCarModel_4_Problem( ThreadPool * TP, Console const * console )
    : model("PointMassCarModel_4",TP,console)
    , road( "road" )
    {
...
// EOF: PointMassCarModel_4_dll_pins.hh
