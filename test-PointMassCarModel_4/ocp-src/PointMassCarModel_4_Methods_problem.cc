...
namespace PointMassCarModel_4Define {
  ...
  real_type
  PointMassCarModel_4::zeta__dot( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = cos(alpha__XO);
    return 1.0 / (-n__XO * Kappa__XO + 1) * t1 * V__XO;
  }

  real_type
  PointMassCarModel_4::zeta__dot_D_1( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = cos(alpha__XO);
    return 1.0 / (-n__XO * Kappa__XO + 1) * t1;
  }

  real_type
  PointMassCarModel_4::zeta__dot_D_1_1( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    return 0;
  }

  real_type
  PointMassCarModel_4::zeta__dot_D_1_2( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = sin(alpha__XO);
    return 1.0 / (n__XO * Kappa__XO - 1) * t1;
  }

  real_type
  PointMassCarModel_4::zeta__dot_D_1_3( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = cos(alpha__XO);
  ...
  real_type
  PointMassCarModel_4::zeta__dot_D_1_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = cos(alpha__XO);
    real_type t5   = pow(n__XO * Kappa__XO - 1, 2);
  ...
  real_type
  PointMassCarModel_4::zeta__dot_D_2( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = sin(alpha__XO);
    return 1.0 / (n__XO * Kappa__XO - 1) * t1 * V__XO;
  }

  real_type
  PointMassCarModel_4::zeta__dot_D_2_2( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = cos(alpha__XO);
    return 1.0 / (n__XO * Kappa__XO - 1) * t1 * V__XO;
  }

  real_type
  PointMassCarModel_4::zeta__dot_D_2_3( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = sin(alpha__XO);
    real_type t5   = pow(n__XO * Kappa__XO - 1, 2);
  ...
  real_type
  PointMassCarModel_4::zeta__dot_D_2_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = sin(alpha__XO);
    real_type t5   = pow(n__XO * Kappa__XO - 1, 2);
  ...
  real_type
  PointMassCarModel_4::zeta__dot_D_3( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = cos(alpha__XO);
    real_type t5   = pow(n__XO * Kappa__XO - 1, 2);
  ...
  real_type
  PointMassCarModel_4::zeta__dot_D_3_3( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = cos(alpha__XO);
  ...
  real_type
  PointMassCarModel_4::zeta__dot_D_3_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = cos(alpha__XO);
  ...
  real_type
  PointMassCarModel_4::zeta__dot_D_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = cos(alpha__XO);
    real_type t5   = pow(n__XO * Kappa__XO - 1, 2);
  ...
  real_type
  PointMassCarModel_4::zeta__dot_D_4_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const {
    real_type t1   = cos(alpha__XO);
  ...
  PointMassCarModel_4::H_eval(
    ...
    return t24 * t2 + t30 * t2 + t34 * t2 + t43 * t2 + t2 * ModelPars[8] + t51 * t2 * L__[0] + t55 * t15 * t2 * L__[1] - t2 * (t51 * t50 - t13) * L__[2] + t2 * (-t16 * ModelPars[4] + t3) * L__[3] + ModelPars[15] * t71 * t2 * L__[4] + ModelPars[16] * t77 * t2 * L__[5] + t81 * t2 + t83 * t2;
  }
  ...
  integer
  PointMassCarModel_4::u_guess_numEqns() const
  { return 2; }

  void
  PointMassCarModel_4::u_guess_eval(
  ...
  bool
  PointMassCarModel_4::u_check_if_admissible(
    NodeType2 const    & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__
  ) const {
