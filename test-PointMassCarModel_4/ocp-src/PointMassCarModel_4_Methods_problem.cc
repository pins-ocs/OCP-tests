...
namespace PointMassCarModel_4Define {
  ...
  PointMassCarModel_4::H_eval(
    ...
    real_type t72  = exp(X__[iX_log_inv_Vseg]);
  ...
  PointMassCarModel_4::penalties_eval(
    ...
    real_type t27  = X__[iX_n];
    real_type t29  = RoadLeftBorder(t26 - t27);
    real_type t30  = ALIAS_rightWidth(t25);
    real_type t32  = RoadRightBorder(t30 + t27);
    real_type t40  = PowerLimit(1 - ModelPars[iM_m] / ModelPars[iM_Pmax] * t3 * t15);
    real_type result__ = (t24 + t29 + t32 + t40) * t2;
    if ( m_debug ) {
  ...
  PointMassCarModel_4::DJDx_eval(
    ...
    real_type t19  = X__[iX_fx];
    real_type t21  = ModelPars[iM_m];
    real_type t22  = ModelPars[iM_Pmax];
    real_type t23  = 1.0 / t22;
    real_type t26  = -t23 * t21 * t19 * t18 + 1;
    real_type t27  = ALIAS_PowerLimit_D(t26);
    real_type t30  = ModelPars[iM_g] * ModelPars[iM_g];
    real_type t33  = ModelPars[iM_mu__y__max] * ModelPars[iM_mu__y__max];
    real_type t37  = t19 * t19;
    real_type t39  = ModelPars[iM_mu__x__max] * ModelPars[iM_mu__x__max];
    real_type t40  = 1.0 / t39;
    real_type t42  = 1.0 / t30;
    real_type t44  = X__[iX_Omega];
    real_type t45  = t44 * t44;
    real_type t46  = t18 * t18;
    real_type t48  = 1.0 / t33;
    real_type t49  = t42 * t48;
    real_type t51  = -t42 * t40 * t37 - t49 * t46 * t45 + 1;
    real_type t52  = ALIAS_AdherenceEllipse_D(t51);
    result__[ 3   ] = -2 * t23 * t49 * (t33 * t21 * t30 * t19 * t27 / 2 + t22 * t45 * t18 * t52) * t2;
    real_type t61  = t52 * t2;
    result__[ 4   ] = -2 * t42 * t48 * t46 * t44 * t61;
    result__[ 5   ] = -t23 * t21 * t18 * t27 * t2 - 2 * t42 * t40 * t19 * t61;
    real_type t75  = AdherenceEllipse(t51);
    real_type t76  = RoadLeftBorder(t6);
    real_type t77  = RoadRightBorder(t11);
    real_type t78  = PowerLimit(t26);
    real_type t80  = v__fxControl(U__[iU_v__fx], -1, 1);
    real_type t82  = v__OmegaControl(U__[iU_v__Omega], -1, 1);
    result__[ 6   ] = (t75 + t76 + t77 + t78 + t80 + t82) * t2;
    if ( m_debug )
