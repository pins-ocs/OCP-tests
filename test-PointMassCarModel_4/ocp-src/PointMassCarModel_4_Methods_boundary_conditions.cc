...
namespace PointMassCarModel_4Define {
  ...
  integer
  PointMassCarModel_4::boundaryConditions_numEqns() const
  { return 8; }
  ...
  integer
  PointMassCarModel_4::DboundaryConditionsDx_numRows() const
  { return 8; }

  integer
  PointMassCarModel_4::DboundaryConditionsDx_numCols() const
  { return 14; }

  integer
  PointMassCarModel_4::DboundaryConditionsDx_nnz() const
  { return 13; }

  void
  PointMassCarModel_4::DboundaryConditionsDx_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  PointMassCarModel_4::DboundaryConditionsDx_sparse(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  PointMassCarModel_4::DboundaryConditionsDp_numRows() const
  { return 8; }

  integer
  PointMassCarModel_4::DboundaryConditionsDp_numCols() const
  { return 0; }

  integer
  PointMassCarModel_4::DboundaryConditionsDp_nnz() const
  { return 0; }

  void
  PointMassCarModel_4::DboundaryConditionsDp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  }
  ...
  void
  PointMassCarModel_4::DboundaryConditionsDp_sparse(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  PointMassCarModel_4::adjointBC_numEqns() const
  { return 14; }
  ...
  integer
  PointMassCarModel_4::DadjointBCDx_numRows() const
  { return 14; }

  integer
  PointMassCarModel_4::DadjointBCDx_numCols() const
  { return 14; }

  integer
  PointMassCarModel_4::DadjointBCDx_nnz() const
  { return 0; }

  void
  PointMassCarModel_4::DadjointBCDx_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  }
  ...
  void
  PointMassCarModel_4::DadjointBCDx_sparse(
    NodeType2 const             & LEFT__,
    NodeType2 const             & RIGHT__,
    P_const_pointer_type          P__,
    OMEGA_full_const_pointer_type OMEGA__,
  ...
  integer
  PointMassCarModel_4::DadjointBCDp_numRows() const
  { return 14; }

  integer
  PointMassCarModel_4::DadjointBCDp_numCols() const
  { return 0; }

  integer
  PointMassCarModel_4::DadjointBCDp_nnz() const
  { return 0; }

  void
  PointMassCarModel_4::DadjointBCDp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  }
  ...
  void
  PointMassCarModel_4::DadjointBCDp_sparse(
    NodeType2 const             & LEFT__,
    NodeType2 const             & RIGHT__,
    P_const_pointer_type          P__,
    OMEGA_full_const_pointer_type OMEGA__,
