...
namespace PointMassCarModel_4Define {
  ...
  */
  void
  PointMassCarModel_4::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "PointMassCarModel_4::setupParameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  PointMassCarModel_4::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  PointMassCarModel_4::setupClasses( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Constraints"),
      "PointMassCarModel_4::setupClasses: Missing key `Parameters` in data\n"
    );
    GenericContainer const & gc = gc_data("Constraints");
    // Initialize Constraints 1D
    UTILS_ASSERT0(
      gc.exists("AdherenceEllipse"),
      "in PointMassCarModel_4::setupClasses(gc) missing key: ``AdherenceEllipse''\n"
    );
    AdherenceEllipse.setup( gc("AdherenceEllipse") );

    UTILS_ASSERT0(
      gc.exists("RoadLeftBorder"),
      "in PointMassCarModel_4::setupClasses(gc) missing key: ``RoadLeftBorder''\n"
    );
    RoadLeftBorder.setup( gc("RoadLeftBorder") );

    UTILS_ASSERT0(
      gc.exists("RoadRightBorder"),
      "in PointMassCarModel_4::setupClasses(gc) missing key: ``RoadRightBorder''\n"
    );
    RoadRightBorder.setup( gc("RoadRightBorder") );

    UTILS_ASSERT0(
      gc.exists("PowerLimit"),
      "in PointMassCarModel_4::setupClasses(gc) missing key: ``PowerLimit''\n"
    );
  ...
  */
  void
  PointMassCarModel_4::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  PointMassCarModel_4::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  PointMassCarModel_4::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "PointMassCarModel_4::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  PointMassCarModel_4::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "PointMassCarModel_4::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pRoad"),
      "in PointMassCarModel_4::setupPointers(gc) cant find key `pRoad' in gc\n"
    );
  ...
  */
  void
  PointMassCarModel_4::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  PointMassCarModel_4::diagnostic( GenericContainer const & gc ) {
