...
#ifndef POINTMASSCARMODEL_4_DOT_HH
#define POINTMASSCARMODEL_4_DOT_HH
...
#include <MechatronixRoad/MechatronixRoad.hh>
  ...
  #ifndef POINTMASSCARMODEL_4_API_DLL
    #ifdef POINTMASSCARMODEL_4_EXPORT
      #define POINTMASSCARMODEL_4_API_DLL __declspec(dllexport)
    #elif defined(POINTMASSCARMODEL_4_IMPORT)
      #define POINTMASSCARMODEL_4_API_DLL __declspec(dllimport)
    #else
      #define POINTMASSCARMODEL_4_API_DLL
    #endif
  #endif
...
namespace PointMassCarModel_4Define {
  ...
  class PointMassCarModel_4 : public Mechatronix::Discretized_Indirect_OCP {
  ...
  public:
    ...
    POINTMASSCARMODEL_4_API_DLL virtual
    ~PointMassCarModel_4() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    POINTMASSCARMODEL_4_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "PointMassCarModel_4"; }
    ...
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot      ( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_1  ( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_1_1( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_1_2( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_1_3( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_1_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_2  ( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_2_2( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_2_3( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_2_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_3  ( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_3_3( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_3_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_4  ( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
    POINTMASSCARMODEL_4_API_DLL real_type zeta__dot_D_4_4( real_type V__XO, real_type alpha__XO, real_type n__XO, real_type Kappa__XO ) const;
...
namespace PointMassCarModel_4Load {
  using PointMassCarModel_4Define::PointMassCarModel_4;

}

#endif

// EOF: PointMassCarModel_4.hh
