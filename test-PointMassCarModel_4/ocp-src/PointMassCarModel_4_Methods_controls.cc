...
namespace PointMassCarModel_4Define {
  ...
  integer
  PointMassCarModel_4::DgDxlp_numRows() const
  { return 2; }

  integer
  PointMassCarModel_4::DgDxlp_numCols() const
  { return 14; }

  integer
  PointMassCarModel_4::DgDxlp_nnz() const
  { return 4; }

  void
  PointMassCarModel_4::DgDxlp_pattern(
    integer_ptr iIndex,
    integer_ptr jIndex
  ) const {
  ...
  void
  PointMassCarModel_4::DgDxlp_sparse(
    NodeType2 const &    NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_ptr             result__
    ...
    Road2D::SegmentClass const & segment = pRoad->get_segment_by_index(i_segment);
    real_type t2   = exp(X__[iX_log_inv_Vseg]);
    real_type t4   = ModelPars[iM_v__fx__max];
    real_type t7   = ALIAS_v__fxControl_D_1(U__[iU_v__fx], -1, 1);
    result__[ 0   ] = (t4 * L__[iL_lambda6__xo] + t7) * t2;
    result__[ 1   ] = t4 * t2;
    real_type t10  = ModelPars[iM_v__Omega__max];
    real_type t13  = ALIAS_v__OmegaControl_D_1(U__[iU_v__Omega], -1, 1);
    result__[ 2   ] = (t10 * L__[iL_lambda5__xo] + t13) * t2;
    result__[ 3   ] = t10 * t2;
    if ( m_debug )
  ...
  PointMassCarModel_4::u_eval_analytic(
    ...
    Road2D::SegmentClass const & segment = pRoad->get_segment_by_index(i_segment);
    real_type t4   = exp(XL__[iX_log_inv_Vseg]);
    real_type t8   = exp(XR__[iX_log_inv_Vseg]);
    real_type t13  = 1.0 / (t4 + t8);
    U__[ iU_v__fx    ] = v__fxControl.solve(-t13 * (t4 * LL__[iL_lambda6__xo] + t8 * LR__[iL_lambda6__xo]) * ModelPars[iM_v__fx__max], -1, 1);
    U__[ iU_v__Omega ] = v__OmegaControl.solve(-t13 * (LL__[iL_lambda5__xo] * t4 + LR__[iL_lambda5__xo] * t8) * ModelPars[iM_v__Omega__max], -1, 1);
    if ( m_debug )
  ...
  PointMassCarModel_4::DuDxlxlp_full_analytic(
    ...
    real_type t2   = LL__[iL_lambda6__xo];
    real_type t4   = exp(XL__[iX_log_inv_Vseg]);
    real_type t6   = LR__[iL_lambda6__xo];
    real_type t8   = exp(XR__[iX_log_inv_Vseg]);
    real_type t12  = t4 + t8;
    real_type t13  = 1.0 / t12;
    real_type t15  = v__fxControl.solve_rhs(-t13 * (t4 * t2 + t8 * t6) * t1, -1, 1);
    real_type t16  = t1 * t15;
    real_type t20  = t12 * t12;
    real_type t21  = 1.0 / t20;
    real_type t23  = t21 * (t2 - t6) * t4 * t8 * t16;
    real_type tmp_0_6 = -t23;
    real_type t24  = ModelPars[iM_v__Omega__max];
    real_type t25  = LL__[iL_lambda5__xo];
    real_type t27  = LR__[iL_lambda5__xo];
    real_type t32  = v__OmegaControl.solve_rhs(-t13 * (t25 * t4 + t27 * t8) * t24, -1, 1);
    real_type t33  = t24 * t32;
    real_type t38  = t21 * (t25 - t27) * t4 * t8 * t33;
    real_type tmp_1_6 = -t38;
    real_type tmp_0_7 = 0;
    real_type tmp_1_7 = 0;
    real_type tmp_0_8 = 0;
    real_type tmp_1_8 = 0;
    ...
    real_type t39  = t13 * t4;
    real_type tmp_1_11 = -t39 * t33;
    real_type tmp_0_12 = -t39 * t16;
    ...
    real_type tmp_0_20 = t23;
    real_type tmp_1_20 = t38;
    ...
    real_type t42  = t13 * t8;
    real_type tmp_1_25 = -t42 * t33;
    real_type tmp_0_26 = -t42 * t16;
  ...
  PointMassCarModel_4::m_eval(
    ...
    real_type t63  = pow(-t60 * t15 * t2 + V__[1], 2);
    real_type t69  = pow(t54 * t53 * t2 - t2 * t13 + V__[2], 2);
    real_type t76  = pow(V__[3] - t2 * (-t16 * ModelPars[iM_kD] + t3), 2);
    real_type t82  = pow(-ModelPars[iM_v__Omega__max] * t48 * t2 + V__[4], 2);
  ...
  PointMassCarModel_4::DmDu_eval(
    ...
    result__[ 0   ] = (2 * t6 * t3 * t2 - 2 * t5 * V__[5] + t12) * t2;
    ...
    result__[ 1   ] = (2 * t17 * t14 * t2 - 2 * t16 * V__[4] + t23) * t2;
    if ( m_debug )
