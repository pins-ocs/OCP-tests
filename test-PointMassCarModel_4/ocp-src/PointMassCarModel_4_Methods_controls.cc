...
namespace PointMassCarModel_4Define {
  ...
  PointMassCarModel_4::g_eval(
    ...
    result__[ 0   ] = ModelPars[iM_v__fx__max] * t2 * LM__[5] + t4 * t2;
    real_type t11  = ALIAS_v__OmegaControl_D_1(UM__[1], -1, 1);
    result__[ 1   ] = ModelPars[iM_v__Omega__max] * t2 * LM__[4] + t11 * t2;
    if ( m_debug )
  ...
  PointMassCarModel_4::DgDxlxlp_sparse(
    ...
    real_type t2   = exp(XM__[6]);
    real_type t4   = ALIAS_v__fxControl_D_1(UM__[0], -1, 1);
    real_type t9   = ModelPars[iM_v__fx__max];
    real_type t7   = t9 * t2;
    result__[ 0   ] = 0.5e0 * t4 * t2 + 0.5e0 * LM__[5] * t7;
    result__[ 1   ] = 0.5e0 * t7;
    result__[ 2   ] = result__[0];
    result__[ 3   ] = result__[1];
    real_type t14  = ALIAS_v__OmegaControl_D_1(UM__[1], -1, 1);
    real_type t19  = ModelPars[iM_v__Omega__max];
    real_type t16  = t19 * t2;
    result__[ 4   ] = 0.5e0 * t14 * t2 + 0.5e0 * LM__[4] * t16;
    result__[ 5   ] = 0.5e0 * t16;
