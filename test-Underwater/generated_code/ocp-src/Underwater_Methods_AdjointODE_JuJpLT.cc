...
namespace UnderwaterDefine {
  ...
  integer Underwater::JPxpu_numEqns() const { return 10; }

  void
  Underwater::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer Underwater::JUxpu_numEqns() const { return 10; }

  void
  Underwater::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
    ...
    real_type t8   = ALIAS_u1Control_D_1(t1, -1, 1);
    result__[ 7   ] = t8 * t7;
    real_type t9   = ALIAS_u2Control_D_1(t3, -1, 1);
    result__[ 8   ] = t9 * t7;
    real_type t10  = ALIAS_u3Control_D_1(t5, -1, 1);
    result__[ 9   ] = t10 * t7;
    if ( m_debug )
  ...
  integer Underwater::LTxpu_numEqns() const { return 10; }

  void
  Underwater::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  Underwater::D2JUD2xpu_sparse(
    ...
    real_type t3   = U__[iU_u3];
    result__[ 2   ] = ALIAS_u3Control_D_1(t3, -1, 1);
    result__[ 3   ] = result__[0];
    real_type t4   = P__[iP_T];
    real_type t5   = ALIAS_u1Control_D_1_1(t1, -1, 1);
    result__[ 4   ] = t5 * t4;
    result__[ 5   ] = result__[1];
    real_type t6   = ALIAS_u2Control_D_1_1(t2, -1, 1);
    result__[ 6   ] = t6 * t4;
    result__[ 7   ] = result__[2];
    real_type t7   = ALIAS_u3Control_D_1_1(t3, -1, 1);
    result__[ 8   ] = t4 * t7;
    if ( m_debug )
