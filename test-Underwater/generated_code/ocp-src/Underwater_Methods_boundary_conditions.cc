...
namespace UnderwaterDefine {
  ...
  integer Underwater::boundaryConditions_numEqns() const { return 10; }

  void
  Underwater::boundaryConditions_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Underwater::DboundaryConditionsDxxp_numRows() const { return 10; }
  integer Underwater::DboundaryConditionsDxxp_numCols() const { return 13; }
  integer Underwater::DboundaryConditionsDxxp_nnz()     const { return 10; }

  void
  Underwater::DboundaryConditionsDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  integer Underwater::adjointBC_numEqns() const { return 13; }

  void
  Underwater::adjointBC_eval(
    NodeType const              & LEFT__,
    NodeType const              & RIGHT__,
    P_const_pointer_type          P__,
    ...
    result__[ 2   ] = OMEGA__[4];
    result__[ 3   ] = OMEGA__[2];
    result__[ 4   ] = OMEGA__[3];
    result__[ 5   ] = 0;
    result__[ 6   ] = OMEGA__[5];
    result__[ 7   ] = OMEGA__[6];
    result__[ 8   ] = OMEGA__[9];
    result__[ 9   ] = OMEGA__[7];
    result__[ 10  ] = OMEGA__[8];
    result__[ 11  ] = 0;
    result__[ 12  ] = 1;
    if ( m_debug )
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Underwater::DadjointBCDxxp_numRows() const { return 13; }
  integer Underwater::DadjointBCDxxp_numCols() const { return 13; }
  integer Underwater::DadjointBCDxxp_nnz()     const { return 0; }

  void
  Underwater::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
