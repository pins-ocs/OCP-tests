...
%ocp.setup(Underwater_data);
ocp.setup('../../data/Underwater_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Underwater_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = Underwater_Mex('get_raw_solution',obj);
%J     = Underwater_Mex('eval_JF',obj,Z,MU,U);
%f     = Underwater_Mex('eval_F',obj,Z,MU,U);
