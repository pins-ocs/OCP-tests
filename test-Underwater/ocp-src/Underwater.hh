...
#ifndef UNDERWATER_DOT_HH
#define UNDERWATER_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
    ...
    #ifdef UNDERWATER_EXPORT
      #define UNDERWATER_API_DLL __declspec(dllexport)
    #elif defined(UNDERWATER_IMPORT)
      #define UNDERWATER_API_DLL __declspec(dllimport)
    #else
      #define UNDERWATER_API_DLL
    #endif
  #endif
...
namespace UnderwaterDefine {
  ...
  public:
    ...
    ~Underwater() MECHATRONIX_OVERRIDE;
...
namespace UnderwaterLoad {
  using UnderwaterDefine::Underwater;
