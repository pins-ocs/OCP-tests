...
namespace UnderwaterDefine {
  ...
  Underwater::DgDxlp_sparse(
    ...
    result__[ 1   ] = t3 * L__[iL_lambda4__xo] + t5;
    real_type t9   = 1.0 / ModelPars[iM_m3];
    result__[ 2   ] = t9 * t1;
    real_type t11  = ALIAS_u2Control_D_1(U__[iU_u2], -1, 1);
    result__[ 3   ] = t9 * L__[iL_lambda5__xo] + t11;
    real_type t15  = 1.0 / ModelPars[iM_inertia];
    result__[ 4   ] = t15 * t1;
    real_type t17  = ALIAS_u3Control_D_1(U__[iU_u3], -1, 1);
    result__[ 5   ] = t15 * L__[iL_lambda6__xo] + t17;
    if ( m_debug )
