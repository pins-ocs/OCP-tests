...
main() {
  ...
  try {
    ...
    Underwater       model("Underwater",&TP,&console);
    ...
    gc_data["DumpFile"] = "Underwater_dump";
    ...
    // Model Parameters
    data_Parameters["inertia"] = 0.12;
    data_Parameters["m1"] = 13.2;
    data_Parameters["m3"] = 25.6;
    ...
    data_Parameters["vx_i"] = 0;
    data_Parameters["vz_f"] = 0;
    data_Parameters["vz_i"] = 0;
    data_Parameters["x_f"] = 2;
    data_Parameters["x_i"] = 0;
    data_Parameters["z_f"] = 1;
    data_Parameters["z_i"] = 1;
    ...
    data_Parameters["epsi_min"] = 1e-07;
...
Underwater_data.Mesh["segments"][0]["length"] = 1;
    ...
    std::ofstream file;
    if ( ok ) {
      file.open( "data/Underwater_OCP_result.txt" );
    } else {
      cout << gc_solution("solver_message").get_string() << '\n';
      // dump solution to file
      file.open( "data/Underwater_OCP_not_converged.txt" );
    }
    file.precision(18);
