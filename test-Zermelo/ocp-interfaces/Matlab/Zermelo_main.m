...
%ocp.setup('../../data/Zermelo_Data.lua');
ocp.setup('../../data/Zermelo_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Zermelo_Mex('set_tracked',obj,tracked);
...
%x = Zermelo_Mex('get_raw_solution',obj);
%J = Zermelo_Mex('eval_JF',obj,x);
%f = Zermelo_Mex('eval_F',obj,x);
