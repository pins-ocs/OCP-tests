...
namespace ZermeloDefine {
  ...
  class Zermelo_Problem {
    ...
    Zermelo_Problem( Zermelo_Problem const & );
    Zermelo_Problem const & operator = ( Zermelo_Problem const & );
  ...
  public:
    ...
    ZERMELO_API_DLL
    Zermelo_Problem( integer n_threads, Console const * console )
    : model("Zermelo",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "Zermelo::solver, fatal: unknown error";
      }
      return ok;
    }
