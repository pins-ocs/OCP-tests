...
namespace ZermeloDefine {
  ...
  void
  Zermelo::p_guess_eval( P_p_type P__ ) const {
  }

  void
  Zermelo::xlambda_guess_eval(
    integer        i_segment,
    Q_const_p_type Q__,
    P_const_p_type P__,
    X_p_type       X__,
  ...
  bool
  Zermelo::p_check( P_const_p_type P__ ) const {
    return true;
  }
