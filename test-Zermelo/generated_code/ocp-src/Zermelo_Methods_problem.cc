...
namespace ZermeloDefine {
  ...
  Zermelo::H_eval(
    ...
    real_type result__ = (X__[iX_vx] + t7) * t2 * L__[iL_lambda1__xo] + (X__[iX_vy] + t13) * t2 * L__[iL_lambda2__xo] + t20 * t18 * t2 * L__[iL_lambda3__xo] + t25 * t18 * t2 * L__[iL_lambda4__xo];
    if ( m_debug ) {
