...
namespace ZermeloDefine {
  ...
  integer Zermelo::fd_BC_numEqns() const { return 10; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Zermelo::Dfd_BCDxlxlp_numRows() const { return 10; }
  integer Zermelo::Dfd_BCDxlxlp_numCols() const { return 20; }
  integer Zermelo::Dfd_BCDxlxlp_nnz()     const { return 10; }

  void
  Zermelo::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
