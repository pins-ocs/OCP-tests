...
ocp.setup( [DATA_PATH 'Zermelo_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = Zermelo_Mex('get_raw_solution',obj);
%J        = Zermelo_Mex('eval_JF',obj,Z,MU,U);
%f        = Zermelo_Mex('eval_F',obj,Z,MU,U);
