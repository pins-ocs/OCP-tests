...
"Zermelo_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "Zermelo"
#define MODEL_CLASS Zermelo
...
public:
  ...
  )
  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "Zermelo_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "Zermelo_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
  ...
  )
  {
    ...
    try {
      ...
      string msg = fmt::format( "Zermelo_Mex('eval_F',...) error: {}", exc.what() );
      mexWarnMsgTxt( msg.c_str() );
      ok = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "Zermelo_Mex('eval_F',...) unkown error\n" );
      ok = false;
    }
  ...
  )
  {
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "Zermelo_Mex('eval_JF',...) error: {}", exc.what() ).c_str() );
      ok_value = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "Zermelo_Mex('eval_JF',...) unkown error\n" );
      ok_value = false;
    }
    int ok = mexCallMATLAB( 1, &arg_out_0, 5, args, "sparse" );
    UTILS_MEX_ASSERT0( ok == 0, CMD "failed the call sparse(...)" );
  ...
  do_velX(
    ...
    #define CMD MODEL_NAME "_Mex('velX', obj, xo__x, xo__y ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    ...
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->velX(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_velX_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('velX_D_1', obj, xo__x, xo__y ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->velX_D_1(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_velX_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('velX_D_2', obj, xo__x, xo__y ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->velX_D_2(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_velX_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('velX_D_1_1', obj, xo__x, xo__y ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->velX_D_1_1(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_velX_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('velX_D_1_2', obj, xo__x, xo__y ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->velX_D_1_2(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_velX_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('velX_D_2_2', obj, xo__x, xo__y ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->velX_D_2_2(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_velY(
    ...
    #define CMD MODEL_NAME "_Mex('velY', obj, xo__x, xo__y ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->velY(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_velY_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('velY_D_1', obj, xo__x, xo__y ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->velY_D_1(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_velY_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('velY_D_2', obj, xo__x, xo__y ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->velY_D_2(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_velY_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('velY_D_1_1', obj, xo__x, xo__y ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->velY_D_1_1(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_velY_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('velY_D_1_2', obj, xo__x, xo__y ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->velY_D_1_2(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_velY_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('velY_D_2_2', obj, xo__x, xo__y ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
    ...
    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->velY_D_2_2(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_arctan2(
    ...
    #define CMD MODEL_NAME "_Mex('arctan2', obj, xo__y, xo__x ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__y" );
    mwSize N1, M1;
    real_const_ptr arg1 = Utils::mex_matrix_pointer( arg_in_3, N1, M1, CMD " xo__x" );
    MEX_CHECK_DIMS(N1,M1,N0,M0);

    real_ptr res = Utils::mex_create_matrix_value( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->arctan2(arg0[ii],arg1[ii]);
    #undef CMD
  }
...
do_velX(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('velX',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_velX( nlhs, plhs, nrhs, prhs );
}
...
do_velX_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('velX_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_velX_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_velX_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('velX_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_velX_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_velX_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('velX_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_velX_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_velX_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('velX_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_velX_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_velX_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('velX_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_velX_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_velY(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('velY',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_velY( nlhs, plhs, nrhs, prhs );
}
...
do_velY_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('velY_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_velY_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_velY_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('velY_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_velY_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_velY_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('velY_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_velY_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_velY_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('velY_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_velY_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_velY_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('velY_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_velY_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_arctan2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('arctan2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_arctan2( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"velX",do_velX},
  {"velX_D_1",do_velX_D_1},
  {"velX_D_2",do_velX_D_2},
  {"velX_D_1_1",do_velX_D_1_1},
  {"velX_D_1_2",do_velX_D_1_2},
  {"velX_D_2_2",do_velX_D_2_2},
  {"velY",do_velY},
  {"velY_D_1",do_velY_D_1},
  {"velY_D_2",do_velY_D_2},
  {"velY_D_1_1",do_velY_D_1_1},
  {"velY_D_1_2",do_velY_D_1_2},
  {"velY_D_2_2",do_velY_D_2_2},
  {"arctan2",do_arctan2},
  {"new",do_new},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "Zermelo_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "Zermelo_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
