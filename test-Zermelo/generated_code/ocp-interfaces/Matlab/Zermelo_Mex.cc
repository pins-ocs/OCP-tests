...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"velX",&ProblemStorage::do_velX},
  {"velX_D_1",&ProblemStorage::do_velX_D_1},
  {"velX_D_2",&ProblemStorage::do_velX_D_2},
  {"velX_D_1_1",&ProblemStorage::do_velX_D_1_1},
  {"velX_D_1_2",&ProblemStorage::do_velX_D_1_2},
  {"velX_D_2_2",&ProblemStorage::do_velX_D_2_2},
  {"velY",&ProblemStorage::do_velY},
  {"velY_D_1",&ProblemStorage::do_velY_D_1},
  {"velY_D_2",&ProblemStorage::do_velY_D_2},
  {"velY_D_1_1",&ProblemStorage::do_velY_D_1_1},
  {"velY_D_1_2",&ProblemStorage::do_velY_D_1_2},
  {"velY_D_2_2",&ProblemStorage::do_velY_D_2_2},
  {"arctan2",&ProblemStorage::do_arctan2}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "Zermelo_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
