...
public:
  ...
  do_eval_F(
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "Zermelo_Mex('eval_F',...) error: {}", exc.what() ).c_str() );
      ok = false;
    } catch ( ... ) {
  ...
  do_arctan2(
    ...
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_type const * arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__y" );
    mwSize N1, M1;
    real_type const * arg1 = getMatrixPointer( arg_in_3, N1, M1, CMD " xo__x" );
    MEX_CHECK_DIMS(N1,M1,N0,M0);
...
do_velX(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_velX( nlhs, plhs, nrhs, prhs );
}
...
do_velX_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_velX_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_velX_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_velX_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_velX_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_velX_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_velX_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_velX_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_velX_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_velX_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_velY(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_velY( nlhs, plhs, nrhs, prhs );
}
...
do_velY_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_velY_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_velY_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_velY_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_velY_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_velY_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_velY_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_velY_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_velY_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_velY_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_arctan2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_arctan2( nlhs, plhs, nrhs, prhs );
}
