...
main() {
  ...
  try {
    Zermelo * m_model = new Zermelo("Zermelo",&TP,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/Zermelo_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/Zermelo_Data.lua";
    #endif
    ...
    if ( ok ) {
      ...
      file.open( "data/Zermelo_OCP_result_NOT_CONVERGED.ßtxt" );
    }
    file.precision(18);
