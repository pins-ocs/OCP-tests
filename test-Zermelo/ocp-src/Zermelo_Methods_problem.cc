...
namespace ZermeloDefine {
  ...
  integer
  Zermelo::DmayerDx_numEqns() const
  { return 10; }

  void
  Zermelo::DmayerDx_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  Zermelo::DmayerDp_numEqns() const
  { return 0; }

  void
  Zermelo::DmayerDp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  Zermelo::DJDx_eval(
    ...
    result__[ 2   ] = 0;
    result__[ 3   ] = 0;
    result__[ 4   ] = ALIAS_Tpositive_D(X__[iX_T]);
    if ( m_debug )
  ...
  integer
  Zermelo::segmentLink_numEqns() const
  { return 0; }
  ...
  integer
  Zermelo::DsegmentLinkDxp_numRows() const
  { return 0; }

  integer
  Zermelo::DsegmentLinkDxp_numCols() const
  { return 0; }

  integer
  Zermelo::DsegmentLinkDxp_nnz() const
  { return 0; }
  ...
  integer
  Zermelo::DjumpDxlp_numRows() const
  { return 10; }

  integer
  Zermelo::DjumpDxlp_numCols() const
  { return 20; }

  integer
  Zermelo::DjumpDxlp_nnz() const
  { return 20; }

  void
  Zermelo::DjumpDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  integer
  Zermelo::integrated_post_numEqns() const
  { return 1; }
