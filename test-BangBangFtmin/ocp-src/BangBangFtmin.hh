...
#ifndef BANGBANGFTMIN_DOT_HH
#define BANGBANGFTMIN_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef BANGBANGFTMIN_API_DLL
    #ifdef BANGBANGFTMIN_EXPORT
      #define BANGBANGFTMIN_API_DLL __declspec(dllexport)
    #elif defined(BANGBANGFTMIN_IMPORT)
      #define BANGBANGFTMIN_API_DLL __declspec(dllimport)
    #else
      #define BANGBANGFTMIN_API_DLL
    #endif
  #endif
...
namespace BangBangFtminDefine {
  ...
  class BangBangFtmin : public Mechatronix::Discretized_Indirect_OCP {
    ...
    BangBangFtmin( BangBangFtmin const & );
    BangBangFtmin const & operator = ( BangBangFtmin const & );
  ...
  public:
    ...
    BANGBANGFTMIN_API_DLL virtual
    ~BangBangFtmin() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    BANGBANGFTMIN_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "BangBangFtmin"; }
...
namespace BangBangFtminLoad {
  using BangBangFtminDefine::BangBangFtmin;

}

#endif

// EOF: BangBangFtmin.hh
