...
namespace BangBangFtminDefine {
  ...
  integer BangBangFtmin::boundaryConditions_numEqns() const { return 4; }

  void
  BangBangFtmin::boundaryConditions_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtmin::DbcDxxp_numRows() const { return 4; }
  integer BangBangFtmin::DbcDxxp_numCols() const { return 5; }
  integer BangBangFtmin::DbcDxxp_nnz()     const { return 4; }

  void
  BangBangFtmin::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtmin::D2bcD2xxp_numRows() const { return 5; }
  integer BangBangFtmin::D2bcD2xxp_numCols() const { return 5; }
  integer BangBangFtmin::D2bcD2xxp_nnz()     const { return 0; }

  void
  BangBangFtmin::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangFtmin::D2bcD2xxp_sparse(
    NodeType const         & LEFT__,
    NodeType const         & RIGHT__,
    P_const_pointer_type     P__,
  ...
  integer BangBangFtmin::adjointBC_numEqns() const { return 5; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtmin::DadjointBCDxxp_numRows() const { return 5; }
  integer BangBangFtmin::DadjointBCDxxp_numCols() const { return 5; }
  integer BangBangFtmin::DadjointBCDxxp_nnz()     const { return 0; }

  void
  BangBangFtmin::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangFtmin::DadjointBCDxxp_sparse(
    NodeType const              & LEFT__,
    NodeType const              & RIGHT__,
    P_const_pointer_type          P__,
    OMEGA_full_const_pointer_type OMEGA__,
...
// EOF: BangBangFtmin_Methods_boundary_conditions.cc
