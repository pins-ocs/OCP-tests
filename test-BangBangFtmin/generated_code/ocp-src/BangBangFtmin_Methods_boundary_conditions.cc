...
namespace BangBangFtminDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtmin::DboundaryConditionsDxxp_numRows() const { return 4; }
  integer BangBangFtmin::DboundaryConditionsDxxp_numCols() const { return 5; }
  integer BangBangFtmin::DboundaryConditionsDxxp_nnz()     const { return 4; }

  void
  BangBangFtmin::DboundaryConditionsDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  BangBangFtmin::DboundaryConditionsDxxp_sparse(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
