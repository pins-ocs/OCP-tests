...
namespace BangBangFtminDefine {
  ...
  integer BangBangFtmin::bc_numEqns() const { return 4; }

  void
  BangBangFtmin::bc_eval(
    NodeQX const & LEFT__,
  ...
  integer BangBangFtmin::fd_BC_numEqns() const { return 4; }

  void
  BangBangFtmin::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtmin::Dfd_BCDxlxlp_numRows() const { return 5; }
  integer BangBangFtmin::Dfd_BCDxlxlp_numCols() const { return 9; }
  integer BangBangFtmin::Dfd_BCDxlxlp_nnz()     const { return 4; }

  void
  BangBangFtmin::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  BangBangFtmin::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
