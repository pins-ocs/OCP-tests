...
namespace BangBangFtminDefine {
  ...
  integer BangBangFtmin::fd_ode_numEqns() const { return 2; }

  void
  BangBangFtmin::fd_ode_eval(
  ...
  integer BangBangFtmin::Dfd_odeDxxup_nnz()     const { return 4; }
  ...
  integer BangBangFtmin::D2fd_odeD2xxup_nnz()     const { return 0; }
