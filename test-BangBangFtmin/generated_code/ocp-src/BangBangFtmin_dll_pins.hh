/*-----------------------------------------------------------------------*\
 |  file: BangBangFtmin_dll_pins.hh                                      |
 |                                                                       |
...
namespace BangBangFtminDefine {
  ...
  using namespace BangBangFtminLoad;
  ...
  class BangBangFtmin_Problem {
    ...
    BangBangFtmin_Problem( BangBangFtmin_Problem const & );
    BangBangFtmin_Problem const & operator = ( BangBangFtmin_Problem const & );
  ...
  public:
    ...
    BangBangFtmin_Problem( integer n_threads, Console const * console )
    : model("BangBangFtmin",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "BangBangFtmin::solver, fatal: unknown error";
      }
      return ok;
    }
