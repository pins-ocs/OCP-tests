...
namespace BangBangFtminDefine {
  ...
  void
  BangBangFtmin::p_guess_eval( P_p_type P__ ) const {
    P__[ iP_T ] = 1;
    if ( m_debug )
  ...
  void
  BangBangFtmin::xlambda_guess_eval(
    integer        i_segment,
    Q_const_p_type Q__,
    P_const_p_type P__,
    X_p_type       X__,
  ...
  bool
  BangBangFtmin::p_check( P_const_p_type P__ ) const {
    /* REMOVED */ Xoptima__check__pars__lt(0, P__[iP_T], Xoptima__message_pars_check_0);
    return true;
  }
  ...
  bool
  BangBangFtmin::xlambda_check_node(
    integer         ipos,
  ...
  bool
  BangBangFtmin::penalties_check_node(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
  ...
  integer BangBangFtmin::u_guess_numEqns() const { return 1; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  BangBangFtmin::u_guess_eval(
    NodeQXL const & NODE__,
    P_const_p_type  P__,
    ...
    UGUESS__[ iU_F ] = Fcontrol.solve(-MU__[1], -1, 1);
    if ( m_debug )
  ...
  bool
  BangBangFtmin::u_check_if_admissible(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__
    ...
    ok = ok && Fcontrol.check_range(U__[iU_F], -1, 1);
    return ok;
  }

}

// EOF: BangBangFtmin_Methods_Guess.cc
