...
namespace BangBangFtminDefine {
  ...
  BangBangFtmin::H_eval(
    ...
    real_type result__ = X__[iX_v] * t2 * MU__[0] + U__[iU_F] * t2 * MU__[1];
    if ( m_debug ) {
  ...
  integer BangBangFtmin::DmayerDxxp_numEqns() const { return 5; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtmin::D2mayerD2xxp_numRows() const { return 5; }
  integer BangBangFtmin::D2mayerD2xxp_numCols() const { return 5; }
  integer BangBangFtmin::D2mayerD2xxp_nnz()     const { return 0; }

  void
  BangBangFtmin::D2mayerD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangFtmin::D2mayerD2xxp_sparse(
    NodeQX const & LEFT__,
    NodeQX const & RIGHT__,
    P_const_p_type P__,
    real_ptr       result__
  ...
  integer BangBangFtmin::DlagrangeDxpu_numEqns() const { return 4; }

  void
  BangBangFtmin::DlagrangeDxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtmin::D2lagrangeD2xpu_numRows() const { return 4; }
  integer BangBangFtmin::D2lagrangeD2xpu_numCols() const { return 4; }
  integer BangBangFtmin::D2lagrangeD2xpu_nnz()     const { return 0; }

  void
  BangBangFtmin::D2lagrangeD2xpu_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangFtmin::D2lagrangeD2xpu_sparse(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer BangBangFtmin::segmentLink_numEqns() const { return 0; }
  ...
  integer BangBangFtmin::DsegmentLinkDxxp_numRows() const { return 0; }
  integer BangBangFtmin::DsegmentLinkDxxp_numCols() const { return 0; }
  integer BangBangFtmin::DsegmentLinkDxxp_nnz() const { return 0; }

  void
  BangBangFtmin::DsegmentLinkDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  BangBangFtmin::DsegmentLinkDxxp_sparse(
    NodeQX const & L,
    NodeQX const & R,
    P_const_p_type p,
  ...
  integer BangBangFtmin::jump_numEqns() const { return 4; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtmin::DjumpDxlxlp_numRows() const { return 4; }
  integer BangBangFtmin::DjumpDxlxlp_numCols() const { return 9; }
  integer BangBangFtmin::DjumpDxlxlp_nnz()     const { return 8; }

  void
  BangBangFtmin::DjumpDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  integer BangBangFtmin::post_numEqns() const { return 2; }
  ...
  integer BangBangFtmin::integrated_post_numEqns() const { return 0; }

  void
  BangBangFtmin::integrated_post_eval(
    NodeQXL const & NODE__,
    P_const_p_type  P__,
    U_const_p_type  U__,
    real_ptr        result__
...
// EOF: BangBangFtmin_Methods_problem.cc
