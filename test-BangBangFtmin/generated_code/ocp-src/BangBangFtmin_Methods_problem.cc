...
namespace BangBangFtminDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtmin::IPOPT_hess_numRows() const { return 4; }
  integer BangBangFtmin::IPOPT_hess_numCols() const { return 4; }
  integer BangBangFtmin::IPOPT_hess_nnz()     const { return 4; }

  void
  BangBangFtmin::IPOPT_hess_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  BangBangFtmin::IPOPT_hess_sparse(
    NodeType2 const    & NODE__,
