...
namespace BangBangFtminDefine {
  ...
  BangBangFtmin::H_eval(
    ...
    real_type result__ = (t6 * L__[iL_lambda2__xo] + L__[iL_lambda1__xo] * X__[iX_v] + t8) * X__[iX_T];
    return result__;
  }
#else
  real_type
  ...
  real_type
  BangBangFtmin::control_penalties_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__
  ) const {
  ...
  integer
  BangBangFtmin::DmayerDx_numEqns() const
  { return 6; }

  void
  BangBangFtmin::DmayerDx_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  BangBangFtmin::DmayerDp_numEqns() const
  { return 0; }

  void
  BangBangFtmin::DmayerDp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  BangBangFtmin::DJDu_numEqns() const
  { return 1; }

  void
  BangBangFtmin::DJDu_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  BangBangFtmin::integrated_post_numEqns() const
  { return 0; }
