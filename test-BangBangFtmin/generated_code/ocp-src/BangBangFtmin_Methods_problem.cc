...
namespace BangBangFtminDefine {
  ...
  bool
  BangBangFtmin::penalties_check_cell(
  ...
  integer BangBangFtmin::DsegmentLinkDxp_numRows() const { return 0; }
  integer BangBangFtmin::DsegmentLinkDxp_numCols() const { return 0; }
  integer BangBangFtmin::DsegmentLinkDxp_nnz() const { return 0; }
