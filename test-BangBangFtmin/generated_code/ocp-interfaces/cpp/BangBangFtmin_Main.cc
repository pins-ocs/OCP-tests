...
main() {
  ...
  try {
    BangBangFtmin * m_model = new BangBangFtmin("BangBangFtmin",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/BangBangFtmin_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/BangBangFtmin_Data.lua";
    #endif
