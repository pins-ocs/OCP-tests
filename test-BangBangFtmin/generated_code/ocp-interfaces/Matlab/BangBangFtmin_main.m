...
% create object
ocp = BangBangFtmin( 'BangBangFtmin' );
...
%ocp.setup(BangBangFtmin_data);
ocp.setup('../../data/BangBangFtmin_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%BangBangFtmin_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = BangBangFtmin_Mex('get_raw_solution',obj);
%J     = BangBangFtmin_Mex('eval_JF',obj,Z,MU,U);
%f     = BangBangFtmin_Mex('eval_F',obj,Z,MU,U);
