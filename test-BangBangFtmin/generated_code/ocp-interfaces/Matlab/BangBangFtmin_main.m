...
%ocp.setup('../../data/BangBangFtmin_Data.lua');
ocp.setup('../../data/BangBangFtmin_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = BangBangFtmin_Mex('get_raw_solution',obj);
%J     = BangBangFtmin_Mex('eval_JF',obj,Z,U);
%f     = BangBangFtmin_Mex('eval_F',obj,Z,U);
