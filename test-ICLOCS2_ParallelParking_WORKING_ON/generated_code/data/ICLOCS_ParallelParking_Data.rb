#-----------------------------------------------------------------------#
#  file: ICLOCS_ParallelParking_Data.rb                                 #
#                                                                       #
...
mechatronix do |data|
  ...
  #data.DumpFile = "ICLOCS_ParallelParking_dump"
  ...
  data.Constraints[:A_bound] = {
    :subType   => "BARRIER_LOG",
    :epsilon   => epsi_slot,
    :tolerance => tol_slot,
    :min       => f_slot(Ax(x(zeta),y(zeta),theta(zeta))),
    :max       => len_cl,
    :active    => true
  }
  # PenaltyBarrier1DInterval
  data.Constraints[:B_bound] = {
    :subType   => "BARRIER_LOG",
    :epsilon   => epsi_slot,
    :tolerance => tol_slot,
    :min       => f_slot(Bx(x(zeta),y(zeta),theta(zeta))),
    :max       => len_cl,
    :active    => true
  }
  # PenaltyBarrier1DInterval
  data.Constraints[:C_bound] = {
    :subType   => "BARRIER_LOG",
    :epsilon   => epsi_slot,
    :tolerance => tol_slot,
    :min       => f_slot(Cx(x(zeta),y(zeta),theta(zeta))),
    :max       => len_cl,
    :active    => true
  }
  # PenaltyBarrier1DInterval
  data.Constraints[:D_bound] = {
    :subType   => "BARRIER_LOG",
    :epsilon   => epsi_slot,
    :tolerance => tol_slot,
    :min       => f_slot(Dx(x(zeta),y(zeta),theta(zeta))),
    :max       => len_cl,
    :active    => true
  }
  # PenaltyBarrier1DGreaterThan
  data.Constraints[:EXTRA1_bound] = {
    :subType   => "BARRIER_LOG",
    :epsilon   => epsi_slot,
    :tolerance => tol_slot,
    :active    => true
