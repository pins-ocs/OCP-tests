--[[
/*-----------------------------------------------------------------------*\
 |  file: ICLOCS_ParallelParking_Data.lua                                |
 |                                                                       |
...
content = {
  ...
  -- DumpFile = "ICLOCS_ParallelParking_dump",
  ...
  -- Barrier subtype: BARRIER_1X, BARRIER_LOG, BARRIER_LOG_EXP, BARRIER_LOG0
    ...
    A_boundsubType   = "BARRIER_LOG",
    A_boundepsilon   = epsi_slot,
    A_boundtolerance = tol_slot,
    A_boundmin       = f_slot(Ax(x(zeta),y(zeta),theta(zeta))),
    A_boundmax       = len_cl,
    A_boundactive    = true

    -- PenaltyBarrier1DInterval
    B_boundsubType   = "BARRIER_LOG",
    B_boundepsilon   = epsi_slot,
    B_boundtolerance = tol_slot,
    B_boundmin       = f_slot(Bx(x(zeta),y(zeta),theta(zeta))),
    B_boundmax       = len_cl,
    B_boundactive    = true

    -- PenaltyBarrier1DInterval
    C_boundsubType   = "BARRIER_LOG",
    C_boundepsilon   = epsi_slot,
    C_boundtolerance = tol_slot,
    C_boundmin       = f_slot(Cx(x(zeta),y(zeta),theta(zeta))),
    C_boundmax       = len_cl,
    C_boundactive    = true

    -- PenaltyBarrier1DInterval
    D_boundsubType   = "BARRIER_LOG",
    D_boundepsilon   = epsi_slot,
    D_boundtolerance = tol_slot,
    D_boundmin       = f_slot(Dx(x(zeta),y(zeta),theta(zeta))),
    D_boundmax       = len_cl,
    D_boundactive    = true

    -- PenaltyBarrier1DGreaterThan
    EXTRA1_boundsubType   = "BARRIER_LOG",
    EXTRA1_boundepsilon   = epsi_slot,
    EXTRA1_boundtolerance = tol_slot,
    EXTRA1_boundactive    = true

    -- PenaltyBarrier1DGreaterThan
    EXTRA2_boundsubType   = "BARRIER_LOG",
    EXTRA2_boundepsilon   = epsi_slot,
    EXTRA2_boundtolerance = tol_slot,
    EXTRA2_boundactive    = true

    -- PenaltyBarrier1DInterval
    vel_boundsubType   = "BARRIER_LOG",
    vel_boundepsilon   = epsi_slot,
    vel_boundtolerance = tol_slot,
    vel_boundmin       = -2,
    vel_boundmax       = 2,
    vel_boundactive    = true

    -- PenaltyBarrier1DInterval
    acc_boundsubType   = "BARRIER_LOG",
    acc_boundepsilon   = epsi_slot,
    acc_boundtolerance = tol_slot,
    acc_boundmin       = -0.75,
    acc_boundmax       = 0.75,
    acc_boundactive    = true

    -- PenaltyBarrier1DInterval
    phi_boundsubType   = "BARRIER_LOG",
    phi_boundepsilon   = epsi_slot,
    phi_boundtolerance = tol_slot,
    phi_boundmin       = -11/60.0*Pi,
    phi_boundmax       = 11/60.0*Pi,
    phi_boundactive    = true
