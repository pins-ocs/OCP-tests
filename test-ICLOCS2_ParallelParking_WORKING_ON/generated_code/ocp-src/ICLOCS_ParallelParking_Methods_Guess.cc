/*-----------------------------------------------------------------------*\
 |  file: ICLOCS_ParallelParking_Methods_Guess.cc                        |
 |                                                                       |
...
namespace ICLOCS_ParallelParkingDefine {
  ...
  void
  ICLOCS_ParallelParking::p_guess_eval( P_pointer_type P__ ) const {
  ...
  void
  ICLOCS_ParallelParking::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  ICLOCS_ParallelParking::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  ICLOCS_ParallelParking::xlambda_check_node(
    integer              ipos,
  ...
  bool
  ICLOCS_ParallelParking::xlambda_check_cell(
    integer              icell,
  ...
  integer
  ICLOCS_ParallelParking::u_guess_numEqns() const
  { return 2; }

  void
  ICLOCS_ParallelParking::u_guess_eval(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
  ...
  bool
  ICLOCS_ParallelParking::u_check_if_admissible(
    NodeType2 const    & NODE__,
    ...
    u1Control.check_range(U__[iU_u1], -t7, t7);
    u2Control.check_range(U__[iU_u2], -0.5e0, 0.5e0);
    return ok;
  }

}

// EOF: ICLOCS_ParallelParking_Methods_Guess.cc
