/*-----------------------------------------------------------------------*\
 |  file: ICLOCS_ParallelParking_dll_pins.hh                             |
 |                                                                       |
...
namespace ICLOCS_ParallelParkingDefine {
  ...
  class ICLOCS_ParallelParking_Problem {

    ICLOCS_ParallelParking model;
    ...
    ICLOCS_ParallelParking_Problem( ICLOCS_ParallelParking_Problem const & );
    ICLOCS_ParallelParking_Problem const & operator = ( ICLOCS_ParallelParking_Problem const & );
  ...
  public:
    ...
    ICLOCS_ParallelParking_Problem( ThreadPool * TP, Console const * console )
    : model("ICLOCS_ParallelParking",TP,console)
    , mesh( "mesh" )
    {
    ...
    ICLOCS_PARALLELPARKING_API_DLL
    ~ICLOCS_ParallelParking_Problem()
    {}
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "ICLOCS_ParallelParking::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: ICLOCS_ParallelParking_dll_pins.hh
