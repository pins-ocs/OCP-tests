...
main() {
  ...
  try {
    ICLOCS_ParallelParking * m_model = new ICLOCS_ParallelParking("ICLOCS_ParallelParking",&TP,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/ICLOCS_ParallelParking_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/ICLOCS_ParallelParking_Data.lua";
    #endif
