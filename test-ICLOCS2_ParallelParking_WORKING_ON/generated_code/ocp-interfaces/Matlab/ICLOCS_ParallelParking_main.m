%-----------------------------------------------------------------------%
%  file: ICLOCS_ParallelParking_main.m                                  %
%                                                                       %
...
% create object
ocp = ICLOCS_ParallelParking( 'ICLOCS_ParallelParking' );
...
%ocp.setup(ICLOCS_ParallelParking_data);
%ocp.setup('../../data/ICLOCS_ParallelParking_Data.lua');
ocp.setup('../../data/ICLOCS_ParallelParking_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ICLOCS_ParallelParking_Mex('set_tracked',obj,tracked);
...
%[Z,U] = ICLOCS_ParallelParking_Mex('get_raw_solution',obj);
%J     = ICLOCS_ParallelParking_Mex('eval_JF',obj,Z,U);
%f     = ICLOCS_ParallelParking_Mex('eval_F',obj,Z,U);
