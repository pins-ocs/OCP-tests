/*-----------------------------------------------------------------------*\
 |  file: SingularCalogeroModified.hh                                    |
 |                                                                       |
...
#ifndef SINGULARCALOGEROMODIFIED_DOT_HH
#define SINGULARCALOGEROMODIFIED_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef SINGULARCALOGEROMODIFIED_API_DLL
    #ifdef SINGULARCALOGEROMODIFIED_EXPORT
      #define SINGULARCALOGEROMODIFIED_API_DLL __declspec(dllexport)
    #elif defined(SINGULARCALOGEROMODIFIED_IMPORT)
      #define SINGULARCALOGEROMODIFIED_API_DLL __declspec(dllimport)
    #else
      #define SINGULARCALOGEROMODIFIED_API_DLL
    #endif
  #endif
...
namespace SingularCalogeroModifiedDefine {
  ...
  class SingularCalogeroModified : public Mechatronix::Discretized_Indirect_OCP {
    ...
    SingularCalogeroModified( SingularCalogeroModified const & );
    SingularCalogeroModified const & operator = ( SingularCalogeroModified const & );
  ...
  public:
    ...
    SINGULARCALOGEROMODIFIED_API_DLL virtual
    ~SingularCalogeroModified() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    SINGULARCALOGEROMODIFIED_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "SingularCalogeroModified"; }
...
namespace SingularCalogeroModifiedLoad {
  using SingularCalogeroModifiedDefine::SingularCalogeroModified;

}

#endif

// EOF: SingularCalogeroModified.hh
