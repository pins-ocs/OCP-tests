/*-----------------------------------------------------------------------*\
 |  file: SingularCalogeroModified_dll_ruby.hh                           |
 |                                                                       |
...
namespace SingularCalogeroModifiedDefine {
  ...
  public:
    ...
    SingularCalogeroModified_Problem( ThreadPool * TP, Console const * console )
    : model("SingularCalogeroModified",TP,console)
    , mesh( "mesh" )
    {
  ...
  */
  ...
  SINGULARCALOGEROMODIFIED_API_DLL
  bool
  SingularCalogeroModified_ocp_guess( char const id[], GenericContainer & gc_guess );
...
// EOF: SingularCalogeroModified_dll_ruby.hh
