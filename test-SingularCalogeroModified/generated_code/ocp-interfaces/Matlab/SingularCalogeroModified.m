...
classdef SingularCalogeroModified < handle
  ...
  methods
    ...
    function [Lambda,Omega] = estimate_multipliers( self, X, U, Pars, method )
      ...
      %
      sol = SingularCalogeroModified_Mex( 'estimate_multipliers', self.objectHandle, X, U, Pars, method );
    end
    ...
    function IPOPT_hess = eval_IPOPT_hess( self, iseg, q, x, lambda, v, u, pars, sigma )
      IPOPT_hess = SingularCalogeroModified_Mex( ...
    ...
    function res = DadjointBCDxxp_pattern( self )
      res = SingularCalogeroModified_Mex('eval_DadjointBCDxxp_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DboundaryConditionsDxxp_pattern( self )
      res = SingularCalogeroModified_Mex('eval_DboundaryConditionsDxxp_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    ...
    function res = IPOPT_hess_pattern( self )
      res = SingularCalogeroModified_Mex('eval_IPOPT_hess_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
