...
% create object
infolevel = 4;
ocp = SingularCalogeroModified( 'SingularCalogeroModified' );
...
ocp.setup( [DATA_PATH 'SingularCalogeroModified_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = SingularCalogeroModified_Mex('get_raw_solution',obj);
%J        = SingularCalogeroModified_Mex('eval_JF',obj,Z,MU,U);
%f        = SingularCalogeroModified_Mex('eval_F',obj,Z,MU,U);
