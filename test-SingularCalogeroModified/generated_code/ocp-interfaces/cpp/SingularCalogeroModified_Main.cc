...
main() {
  ...
  try {
    SingularCalogeroModified * m_model = new SingularCalogeroModified("SingularCalogeroModified",&TP,&console);
    ...
    if ( ok ) {
      ...
      file.open( "data/SingularCalogeroModified_OCP_result_NOT_CONVERGED.ßtxt" );
    }
    file.precision(18);
