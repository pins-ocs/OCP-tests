...
namespace SingularCalogeroModifiedDefine {
  ...
  integer SingularCalogeroModified::bc_numEqns() const { return 2; }

  void
  SingularCalogeroModified::bc_eval(
    NodeQX const & LEFT__,
  ...
  integer SingularCalogeroModified::fd_BC_numEqns() const { return 4; }

  void
  SingularCalogeroModified::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SingularCalogeroModified::Dfd_BCDxlxlp_numRows() const { return 4; }
  integer SingularCalogeroModified::Dfd_BCDxlxlp_numCols() const { return 8; }
  integer SingularCalogeroModified::Dfd_BCDxlxlp_nnz()     const { return 4; }

  void
  SingularCalogeroModified::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  SingularCalogeroModified::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
