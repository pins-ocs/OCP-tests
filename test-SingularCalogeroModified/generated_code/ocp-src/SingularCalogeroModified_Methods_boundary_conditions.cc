...
namespace SingularCalogeroModifiedDefine {
  ...
  integer SingularCalogeroModified::boundaryConditions_numEqns() const { return 2; }
  ...
  integer SingularCalogeroModified::adjointBC_numEqns() const { return 4; }
  ...
  SingularCalogeroModified::adjointBC_eval(
    ...
    result__[ 2   ] = 0;
    result__[ 3   ] = OMEGA__[1];
    if ( m_debug )
      Mechatronix::check_in_segment2( result__, "adjointBC_eval", 4, i_segment_left, i_segment_right );
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SingularCalogeroModified::DadjointBCDxxp_numRows() const { return 4; }
  integer SingularCalogeroModified::DadjointBCDxxp_numCols() const { return 4; }
  integer SingularCalogeroModified::DadjointBCDxxp_nnz()     const { return 0; }

  void
  SingularCalogeroModified::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
