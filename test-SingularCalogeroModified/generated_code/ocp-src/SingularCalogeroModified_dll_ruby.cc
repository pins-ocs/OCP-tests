...
#include "SingularCalogeroModified_dll_ruby.hh"
#include <map>
...
namespace SingularCalogeroModifiedDefine {
  ...
  static map< string, SingularCalogeroModified_Problem * > problems;
  ...
  */
  ...
  SingularCalogeroModified_ocp_guess( char const id[], GenericContainer & gc_data ) {
    ...
    if ( it == problems.end() ) {
      ...
      it->second->guess( gc_data("Guess", "SingularCalogeroModified_ocp_guess missing field `Guess`" ) );
      return true;
    }
  }
  ...
  SingularCalogeroModified_ocp_solve( char const id[],
    ...
    if ( it == problems.end() ) {
      ...
      if ( ok ) {
        ...
        pConsole->error(
          fmt::format("SingularCalogeroModified_ocp_solve, ERROR: {}\n",errmsg)
        );
      }
      return ok;
    }
...
// EOF: SingularCalogeroModified_dll_ruby.cc
