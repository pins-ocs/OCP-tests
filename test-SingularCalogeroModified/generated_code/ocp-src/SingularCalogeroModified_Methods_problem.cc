...
namespace SingularCalogeroModifiedDefine {
  ...
  void
  SingularCalogeroModified::continuation_step_0( real_type s ) {
  ...
  SingularCalogeroModified::H_eval(
    ...
    real_type result__ = MU__[0] * X__[iX_y] + MU__[1] * U__[iU_u] + t7;
    if ( m_debug ) {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SingularCalogeroModified::D2mayerD2xxp_numRows() const { return 4; }
  integer SingularCalogeroModified::D2mayerD2xxp_numCols() const { return 4; }
  integer SingularCalogeroModified::D2mayerD2xxp_nnz()     const { return 0; }

  void
  SingularCalogeroModified::D2mayerD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  SingularCalogeroModified::D2mayerD2xxp_sparse(
    NodeQX const & LEFT__,
    NodeQX const & RIGHT__,
    P_const_p_type P__,
    real_ptr       result__
  ...
  integer SingularCalogeroModified::DlagrangeDxpu_numEqns() const { return 3; }

  void
  SingularCalogeroModified::DlagrangeDxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SingularCalogeroModified::D2lagrangeD2xpu_numRows() const { return 3; }
  integer SingularCalogeroModified::D2lagrangeD2xpu_numCols() const { return 3; }
  integer SingularCalogeroModified::D2lagrangeD2xpu_nnz()     const { return 1; }

  void
  SingularCalogeroModified::D2lagrangeD2xpu_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
  }


  void
  SingularCalogeroModified::D2lagrangeD2xpu_sparse(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer SingularCalogeroModified::DsegmentLinkDxxp_numRows() const { return 0; }
  integer SingularCalogeroModified::DsegmentLinkDxxp_numCols() const { return 0; }
  integer SingularCalogeroModified::DsegmentLinkDxxp_nnz() const { return 0; }

  void
  SingularCalogeroModified::DsegmentLinkDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  SingularCalogeroModified::DsegmentLinkDxxp_sparse(
    NodeQX const & L,
    NodeQX const & R,
    P_const_p_type p,
  ...
  integer SingularCalogeroModified::post_numEqns() const { return 1; }
