#-----------------------------------------------------------------------#
#  file: SingularCalogeroModified_run.rb                                #
#                                                                       #
...
module GenericContainer
  @libGenericContainer = MECHATRONIX_LIB_PATH+"/libSingularCalogeroModified.#{DYLIB_EXT}"
end

module Splines
  @libSplines = MECHATRONIX_LIB_PATH+"/libSingularCalogeroModified.#{DYLIB_EXT}"
end
...
module SingularCalogeroModified
  ...
  LIB_PATH = MECHATRONIX_LIB_PATH+"/libSingularCalogeroModified.#{DYLIB_EXT}"
  ...
  attach_function :OCP_setup,
                  :SingularCalogeroModified_ocp_setup,
                  [ :string, :buffer_in ], :bool

  attach_function :OCP_guess,
                  :SingularCalogeroModified_ocp_guess,
                  [ :string, :buffer_in ], :bool

  attach_function :OCP_solve,
                  :SingularCalogeroModified_ocp_solve,
                  [ :string, :buffer_in, :buffer_out ], :bool

  attach_function :OCP_write_ocp_solution,
                  :SingularCalogeroModified_write_ocp_solution,
                  [ :string, :string ], :void
  ...
  class OCPSolver
    ...
    def solve( convert = true )
      ...
      ok = SingularCalogeroModified.OCP_setup( @id, GenericContainer.GC_mem_ptr(@id) )
      raise RuntimeError, "Failed to do setup: #{out[:Error]}\n" unless ok

      ok = SingularCalogeroModified.OCP_guess( @id, GenericContainer.GC_mem_ptr(@id) )
      raise RuntimeError, "Failed to do guess: #{out[:Error]}\n" unless ok

      ok  = SingularCalogeroModified.OCP_solve( @id,
    ...
    def write_ocp_solution( fname )
      SingularCalogeroModified.OCP_write_ocp_solution( @id, fname )
    end
...
# EOF: SingularCalogeroModified_ffi.rb
