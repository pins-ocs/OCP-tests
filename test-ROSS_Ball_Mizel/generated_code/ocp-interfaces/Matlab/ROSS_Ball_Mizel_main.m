...
% create object
ocp = ROSS_Ball_Mizel( 'ROSS_Ball_Mizel' );
...
%ocp.setup(ROSS_Ball_Mizel_data);
ocp.setup('../../data/ROSS_Ball_Mizel_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ROSS_Ball_Mizel_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = ROSS_Ball_Mizel_Mex('get_raw_solution',obj);
%J     = ROSS_Ball_Mizel_Mex('eval_JF',obj,Z,MU,U);
%f     = ROSS_Ball_Mizel_Mex('eval_F',obj,Z,MU,U);
