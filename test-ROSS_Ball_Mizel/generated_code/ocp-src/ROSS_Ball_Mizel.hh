...
#ifndef ROSS_BALL_MIZEL_DOT_HH
#define ROSS_BALL_MIZEL_DOT_HH
...
// User Header (end)
  ...
  #ifndef ROSS_BALL_MIZEL_API_DLL
    #ifdef ROSS_BALL_MIZEL_EXPORT
      #define ROSS_BALL_MIZEL_API_DLL __declspec(dllexport)
    #elif defined(ROSS_BALL_MIZEL_IMPORT)
      #define ROSS_BALL_MIZEL_API_DLL __declspec(dllimport)
    #else
      #define ROSS_BALL_MIZEL_API_DLL
    #endif
  #endif
...
namespace ROSS_Ball_MizelDefine {
  ...
  class ROSS_Ball_Mizel : public Mechatronix::Discretized_Indirect_OCP {
    ...
    ROSS_Ball_Mizel const & operator = ( ROSS_Ball_Mizel const & );
...
namespace ROSS_Ball_MizelLoad {
  using ROSS_Ball_MizelDefine::ROSS_Ball_Mizel;

}

#endif

// EOF: ROSS_Ball_Mizel.hh
