/*-----------------------------------------------------------------------*\
 |  file: ROSS_Ball_Mizel_Methods_Guess.cc                               |
 |                                                                       |
...
namespace ROSS_Ball_MizelDefine {
  ...
  integer ROSS_Ball_Mizel::eta_numEqns() const { return 1; }

  void
  ROSS_Ball_Mizel::eta_eval(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer ROSS_Ball_Mizel::DetaDxp_numRows() const { return 1; }
  integer ROSS_Ball_Mizel::DetaDxp_numCols() const { return 1; }
  integer ROSS_Ball_Mizel::DetaDxp_nnz()     const { return 0; }

  void
  ROSS_Ball_Mizel::DetaDxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
  ...
  void
  ROSS_Ball_Mizel::DetaDxp_sparse(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    real_ptr        result__
  ...
  void
  ROSS_Ball_Mizel::node_LR_to_cell(
    NodeQX const & LEFT,
    NodeQX const & RIGHT,
    NodeQX       & NODE
  ) const {
...
// EOF: ROSS_Ball_Mizel_Methods_Guess.cc
