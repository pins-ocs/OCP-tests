/*-----------------------------------------------------------------------*\
 |  file: ROSS_Ball_Mizel_dll_pins.hh                                    |
 |                                                                       |
...
namespace ROSS_Ball_MizelDefine {
  ...
  using namespace ROSS_Ball_MizelLoad;
  ...
  class ROSS_Ball_Mizel_Problem {

    ROSS_Ball_Mizel m_model;
    ...
    ROSS_Ball_Mizel_Problem( ROSS_Ball_Mizel_Problem const & );
    ROSS_Ball_Mizel_Problem const & operator = ( ROSS_Ball_Mizel_Problem const & );
  ...
  public:
    ...
    ROSS_Ball_Mizel_Problem(
      Console const  * console,
      ThreadPoolBase * TP
    )
    : m_model("ROSS_Ball_Mizel",console,TP)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "ROSS_Ball_Mizel::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: ROSS_Ball_Mizel_dll_pins.hh
