...
namespace TwoStageCSTRDefine {
  ...
  void
  TwoStageCSTR::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  TwoStageCSTR::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  TwoStageCSTR::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  TwoStageCSTR::xlambda_check_node(
    integer              ipos,
  ...
  bool
  TwoStageCSTR::xlambda_check_cell(
    integer              icell,
  ...
  integer TwoStageCSTR::u_guess_numEqns() const { return 2; }
  ...
  TwoStageCSTR::u_check_if_admissible(
    ...
    ok = ok && u1Control.check_range(U__[iU_u1], -0.5e0, 0.5e0);
    ok = ok && u2Control.check_range(U__[iU_u2], -0.5e0, 0.5e0);
    return ok;
  }
