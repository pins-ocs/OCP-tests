...
namespace TwoStageCSTRDefine {
  ...
  class TwoStageCSTR_Problem {
    ...
    TwoStageCSTR_Problem( TwoStageCSTR_Problem const & );
    TwoStageCSTR_Problem const & operator = ( TwoStageCSTR_Problem const & );
  ...
  public:
    ...
    TwoStageCSTR_Problem( integer n_threads, Console const * console )
    : model("TwoStageCSTR",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "TwoStageCSTR::solver, fatal: unknown error";
      }
      return ok;
    }
