...
public:
...

  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "TwoStageCSTR_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "TwoStageCSTR_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
...

  {
    ...
    try {
      ...
      string msg = fmt::format( "TwoStageCSTR_Mex('eval_F',...) error: {}", exc.what() );
...
do_R1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_R1( nlhs, plhs, nrhs, prhs );
}
...
do_R1_D_1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_R1_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_R1_D_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_R1_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_R1_D_1_1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_R1_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_R1_D_1_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_R1_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_R1_D_2_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_R1_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_R2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_R2( nlhs, plhs, nrhs, prhs );
}
...
do_R2_D_1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_R2_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_R2_D_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_R2_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_R2_D_1_1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_R2_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_R2_D_1_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_R2_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_R2_D_2_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_R2_D_2_2( nlhs, plhs, nrhs, prhs );
}
