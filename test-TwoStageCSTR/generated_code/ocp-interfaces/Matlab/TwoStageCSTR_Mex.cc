...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"R1",&ProblemStorage::do_R1},
  {"R1_D_1",&ProblemStorage::do_R1_D_1},
  {"R1_D_2",&ProblemStorage::do_R1_D_2},
  {"R1_D_1_1",&ProblemStorage::do_R1_D_1_1},
  {"R1_D_1_2",&ProblemStorage::do_R1_D_1_2},
  {"R1_D_2_2",&ProblemStorage::do_R1_D_2_2},
  {"R2",&ProblemStorage::do_R2},
  {"R2_D_1",&ProblemStorage::do_R2_D_1},
  {"R2_D_2",&ProblemStorage::do_R2_D_2},
  {"R2_D_1_1",&ProblemStorage::do_R2_D_1_1},
  {"R2_D_1_2",&ProblemStorage::do_R2_D_1_2},
  {"R2_D_2_2",&ProblemStorage::do_R2_D_2_2}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "TwoStageCSTR_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
