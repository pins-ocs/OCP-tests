...
%ocp.setup(TwoStageCSTR_data);
ocp.setup('../../data/TwoStageCSTR_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%TwoStageCSTR_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = TwoStageCSTR_Mex('get_raw_solution',obj);
%J     = TwoStageCSTR_Mex('eval_JF',obj,Z,MU,U);
%f     = TwoStageCSTR_Mex('eval_F',obj,Z,MU,U);
