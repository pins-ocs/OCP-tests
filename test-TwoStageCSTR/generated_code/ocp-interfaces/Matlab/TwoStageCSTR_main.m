...
%ocp.setup('../../data/TwoStageCSTR_Data.lua');
ocp.setup('../../data/TwoStageCSTR_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = TwoStageCSTR_Mex('get_raw_solution',obj);
%J     = TwoStageCSTR_Mex('eval_JF',obj,Z,U);
%f     = TwoStageCSTR_Mex('eval_F',obj,Z,U);
