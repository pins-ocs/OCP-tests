...
public:
  ...
  void do_R1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_R1_D_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_R1_D_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_R1_D_1_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_R1_D_1_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_R1_D_2_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_R2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_R2_D_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_R2_D_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_R2_D_1_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_R2_D_1_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_R2_D_2_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
