...
#ifndef TWOSTAGECSTR_HH
#define TWOSTAGECSTR_HH
...
namespace TwoStageCSTRDefine {
  ...
  public:
    ...
    ~TwoStageCSTR() MECHATRONIX_OVERRIDE;
    ...
    TWOSTAGECSTR_API_DLL real_type R1      ( real_type x1__XO, real_type x2__XO ) const;
    TWOSTAGECSTR_API_DLL real_type R1_D_1  ( real_type x1__XO, real_type x2__XO ) const;
    TWOSTAGECSTR_API_DLL real_type R1_D_1_1( real_type x1__XO, real_type x2__XO ) const;
    TWOSTAGECSTR_API_DLL real_type R1_D_1_2( real_type x1__XO, real_type x2__XO ) const;
    TWOSTAGECSTR_API_DLL real_type R1_D_2  ( real_type x1__XO, real_type x2__XO ) const;
    TWOSTAGECSTR_API_DLL real_type R1_D_2_2( real_type x1__XO, real_type x2__XO ) const;
    TWOSTAGECSTR_API_DLL real_type R2      ( real_type x3__XO, real_type x4__XO ) const;
    TWOSTAGECSTR_API_DLL real_type R2_D_1  ( real_type x3__XO, real_type x4__XO ) const;
    TWOSTAGECSTR_API_DLL real_type R2_D_1_1( real_type x3__XO, real_type x4__XO ) const;
    TWOSTAGECSTR_API_DLL real_type R2_D_1_2( real_type x3__XO, real_type x4__XO ) const;
    TWOSTAGECSTR_API_DLL real_type R2_D_2  ( real_type x3__XO, real_type x4__XO ) const;
    TWOSTAGECSTR_API_DLL real_type R2_D_2_2( real_type x3__XO, real_type x4__XO ) const;
