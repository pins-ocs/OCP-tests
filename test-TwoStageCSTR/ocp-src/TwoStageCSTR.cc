...
namespace TwoStageCSTRDefine {
  ...
  */
  void
  TwoStageCSTR::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  TwoStageCSTR::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "TwoStageCSTR::setupParameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  TwoStageCSTR::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  TwoStageCSTR::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  TwoStageCSTR::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  TwoStageCSTR::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  TwoStageCSTR::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "TwoStageCSTR::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  TwoStageCSTR::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "TwoStageCSTR::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in TwoStageCSTR::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  TwoStageCSTR::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  TwoStageCSTR::diagnostic( GenericContainer const & gc ) {
