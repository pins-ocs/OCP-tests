...
using namespace TwoStageCSTRLoad;
...
"TwoStageCSTR_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "TwoStageCSTR"
#define MODEL_CLASS TwoStageCSTR
...
public:
  ...
  do_R1_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('R1_D_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->R1_D_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_R1_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('R1_D_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->R1_D_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_R1_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('R1_D_1_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->R1_D_1_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_R1_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('R1_D_1_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->R1_D_1_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_R1_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('R1_D_2_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->R1_D_2_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_R2(
    ...
    #define CMD MODEL_NAME "_Mex('R2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->R2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_R2_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('R2_D_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->R2_D_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_R2_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('R2_D_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->R2_D_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_R2_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('R2_D_1_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->R2_D_1_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_R2_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('R2_D_1_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->R2_D_1_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_R2_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('R2_D_2_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->R2_D_2_2(arg0,arg1) );
    #undef CMD
  }
...
do_R1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('R1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_R1( nlhs, plhs, nrhs, prhs );
}
...
do_R1_D_1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('R1_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_R1_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_R1_D_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('R1_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_R1_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_R1_D_1_1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('R1_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_R1_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_R1_D_1_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('R1_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_R1_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_R1_D_2_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('R1_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_R1_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_R2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('R2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_R2( nlhs, plhs, nrhs, prhs );
}
...
do_R2_D_1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('R2_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_R2_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_R2_D_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('R2_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_R2_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_R2_D_1_1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('R2_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_R2_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_R2_D_1_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('R2_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_R2_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_R2_D_2_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('R2_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_R2_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"R1_D_1",do_R1_D_1},
  {"R1_D_2",do_R1_D_2},
  {"R1_D_1_1",do_R1_D_1_1},
  {"R1_D_1_2",do_R1_D_1_2},
  {"R1_D_2_2",do_R1_D_2_2},
  {"R2",do_R2},
  {"R2_D_1",do_R2_D_1},
  {"R2_D_2",do_R2_D_2},
  {"R2_D_1_1",do_R2_D_1_1},
  {"R2_D_1_2",do_R2_D_1_2},
  {"R2_D_2_2",do_R2_D_2_2},
  {"new",do_new},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "TwoStageCSTR_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "TwoStageCSTR_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
