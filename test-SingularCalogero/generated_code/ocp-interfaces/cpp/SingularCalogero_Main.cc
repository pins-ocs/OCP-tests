...
main() {
  ...
  try {
    SingularCalogero * m_model = new SingularCalogero("SingularCalogero",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/SingularCalogero_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/SingularCalogero_Data.lua";
    #endif
