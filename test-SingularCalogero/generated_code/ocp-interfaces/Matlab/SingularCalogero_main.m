...
% create object
ocp = SingularCalogero( 'SingularCalogero' );
...
%ocp.setup(SingularCalogero_data);
ocp.setup('../../data/SingularCalogero_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%SingularCalogero_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = SingularCalogero_Mex('get_raw_solution',obj);
%J     = SingularCalogero_Mex('eval_JF',obj,Z,MU,U);
%f     = SingularCalogero_Mex('eval_F',obj,Z,MU,U);
