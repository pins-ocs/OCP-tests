...
%ocp.setup('../../data/SingularCalogero_Data.lua');
ocp.setup('../../data/SingularCalogero_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = SingularCalogero_Mex('get_raw_solution',obj);
%J     = SingularCalogero_Mex('eval_JF',obj,Z,U);
%f     = SingularCalogero_Mex('eval_F',obj,Z,U);
