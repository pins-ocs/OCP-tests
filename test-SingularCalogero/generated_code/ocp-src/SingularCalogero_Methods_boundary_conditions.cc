...
namespace SingularCalogeroDefine {
  ...
  integer SingularCalogero::bc_numEqns() const { return 0; }

  void
  SingularCalogero::bc_eval(
    NodeQX const & LEFT__,
  ...
  integer SingularCalogero::fd_BC_numEqns() const { return 2; }

  void
  SingularCalogero::fd_BC_eval(
    ...
    if ( m_debug )
      Mechatronix::check_in_segment2( result__, "fd_BC_eval", 0, i_segment_left, i_segment_right );
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SingularCalogero::Dfd_BCDxlxlp_numRows() const { return 2; }
  integer SingularCalogero::Dfd_BCDxlxlp_numCols() const { return 4; }
  integer SingularCalogero::Dfd_BCDxlxlp_nnz()     const { return 2; }

  void
  SingularCalogero::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  SingularCalogero::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
