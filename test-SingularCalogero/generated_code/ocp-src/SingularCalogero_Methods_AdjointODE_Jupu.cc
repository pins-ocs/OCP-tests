...
namespace SingularCalogeroDefine {
  ...
  integer SingularCalogero::JPxpu_numEqns() const { return 2; }

  void
  SingularCalogero::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer SingularCalogero::JUxpu_numEqns() const { return 2; }

  void
  SingularCalogero::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
    ...
    MeshStd::SegmentClass const & segment = m_pMesh->get_segment_by_index(i_segment);
    result__[ 0   ] = 0;
    result__[ 1   ] = ALIAS_uControl_D_1(U__[iU_u], -1, 1);
    if ( m_debug )
  ...
  integer SingularCalogero::LTxpu_numEqns() const { return 2; }

  void
  SingularCalogero::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
