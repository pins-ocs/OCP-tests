...
namespace SingularCalogeroDefine {
  ...
  void
  SingularCalogero::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  SingularCalogero::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  SingularCalogero::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  SingularCalogero::xlambda_check_node(
    integer              ipos,
  ...
  bool
  SingularCalogero::xlambda_check_cell(
    integer              icell,
  ...
  integer SingularCalogero::u_guess_numEqns() const { return 1; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  SingularCalogero::u_guess_eval(
    NodeType2 const    & LEFT__,
    NodeType2 const    & RIGHT__,
    P_const_pointer_type P__,
    ...
    UGUESS__[ iU_u ] = uControl.solve(-L__[iL_lambda1__xo], -1, 1);
    if ( m_debug )
  ...
  bool
  SingularCalogero::u_check_if_admissible(
    NodeType2 const    & NODE__,
