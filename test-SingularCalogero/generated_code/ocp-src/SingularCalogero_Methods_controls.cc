...
namespace SingularCalogeroDefine {
  ...
  SingularCalogero::g_eval(
    ...
    result__[ 0   ] = L__[iL_lambda1__xo] + t3;
    if ( m_debug )
  ...
  SingularCalogero::u_eval_analytic(
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    U__[ iU_u ] = uControl.solve(-LL__[iL_lambda1__xo] / 2 - LR__[iL_lambda1__xo] / 2, -1, 1);
    if ( m_debug )
  ...
  void
  SingularCalogero::DuDxlxlp_full_analytic(
    NodeType2 const &          LEFT__,
    NodeType2 const &          RIGHT__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    real_type tmp_0_0 = 0;
    real_type t5   = uControl.solve_rhs(-LL__[iL_lambda1__xo] / 2 - LR__[iL_lambda1__xo] / 2, -1, 1);
    real_type tmp_0_1 = -t5 / 2;
    real_type tmp_0_2 = 0;
  ...
  SingularCalogero::m_eval(
    ...
    real_type t5   = pow(V__[0] - t1, 2);
    real_type result__ = t2 + t5;
    if ( m_debug ) {
...
// EOF: SingularCalogero_Methods_controls.cc
