...
namespace SingularCalogeroDefine {
  ...
  integer
  SingularCalogero::DgDxlp_numRows() const
  { return 1; }

  integer
  SingularCalogero::DgDxlp_numCols() const
  { return 2; }

  integer
  SingularCalogero::DgDxlp_nnz() const
  { return 1; }

  void
  SingularCalogero::DgDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  SingularCalogero::DgDxlp_sparse(
    NodeType2 const    & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  \*/
  integer
  SingularCalogero::u_numEqns() const
  { return 1; }

  void
  SingularCalogero::u_eval_analytic(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    U_pointer_type       U__
  ) const {
    ...
    real_type const * L__ = NODE__.lambda;
    MeshStd::SegmentClass const & segment = pMesh->getSegmentByIndex(i_segment);
    U__[ iU_u ] = uControl.solve(-L__[0], -1, 1);
  }
  ...
  \*/
  void
  SingularCalogero::DuDxlp_full_analytic(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    ...
    real_type const * L__ = NODE__.lambda;
    DuDxlp(0, 0) = 0;
    DuDxlp(0, 1) = -uControl.solve_rhs(-L__[0], -1, 1);
  }
  ...
  bool
  SingularCalogero::DuDxlp_full_numeric(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    MatrixWrapper<real_type> & DuDxlp
    ...
    integer info = alglin::gesv( 1, 2, DgDu.get_data(), 1, ipiv, DuDxlp.get_data(), 1 );
    return info == 0;
  }
  ...
  integer
  SingularCalogero::DjumpDxlp_numRows() const
  { return 2; }

  integer
  SingularCalogero::DjumpDxlp_numCols() const
  { return 4; }

  integer
  SingularCalogero::DjumpDxlp_nnz() const
  { return 4; }

  void
  SingularCalogero::DjumpDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
    iIndex[ 0  ] = 0   ; jIndex[ 0  ] = 0   ;
  ...
  void
  SingularCalogero::DjumpDxlp_sparse(
    NodeType2 const    & LEFT__,
    NodeType2 const    & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
    ...
    result__[ 3   ] = 1;
    #ifdef MECHATRONIX_DEBUG
    CHECK_NAN(result__,"DjumpDxlp_sparse",4);
    #endif
  }
