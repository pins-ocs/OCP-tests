...
#ifndef SINGULARCALOGERO_DOT_HH
#define SINGULARCALOGERO_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef SINGULARCALOGERO_API_DLL
    #ifdef SINGULARCALOGERO_EXPORT
      #define SINGULARCALOGERO_API_DLL __declspec(dllexport)
    #elif defined(SINGULARCALOGERO_IMPORT)
      #define SINGULARCALOGERO_API_DLL __declspec(dllimport)
    #else
      #define SINGULARCALOGERO_API_DLL
    #endif
  #endif
...
namespace SingularCalogeroDefine {
  ...
  class SingularCalogero : public Mechatronix::Discretized_Indirect_OCP {
    ...
    SingularCalogero( SingularCalogero const & );
    SingularCalogero const & operator = ( SingularCalogero const & );
  ...
  public:
    ...
    SINGULARCALOGERO_API_DLL virtual
    ~SingularCalogero() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    SINGULARCALOGERO_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "SingularCalogero"; }
...
namespace SingularCalogeroLoad {
  using SingularCalogeroDefine::SingularCalogero;

}

#endif

// EOF: SingularCalogero.hh
