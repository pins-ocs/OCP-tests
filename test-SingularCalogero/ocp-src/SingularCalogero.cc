...
namespace SingularCalogeroDefine {
  ...
  */
  void
  SingularCalogero::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  SingularCalogero::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  SingularCalogero::get_names( GenericContainer & out ) const {
  ...
  */
  void
  SingularCalogero::diagnostic( GenericContainer const & gc ) {
  ...
  void
  SingularCalogero::save_OCP_info( GenericContainer & gc ) const {

  }

}

// EOF: SingularCalogero.cc
