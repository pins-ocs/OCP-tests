...
%ocp.setup(AliChan_data);
%ocp.setup('../../data/AliChan_Data.lua');
ocp.setup('../../data/AliChan_Data.rb');
...
%%clear mex
%x = AliChan_Mex('get_raw_solution',obj);
%J = AliChan_Mex('eval_JF',obj,x);
%f = AliChan_Mex('eval_F',obj,x);
