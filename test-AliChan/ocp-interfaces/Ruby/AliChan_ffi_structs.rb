...
module AliChan
  ...
  class AliChan_solver_params < FFI::Struct
    layout(
      :max_iter,             :index_t,
  ...
  class AliChan_model_params < FFI::Struct
    layout(
  ...
  class AliChan_BC_params < FFI::Struct
    layout(
  ...
  class AliChan_constraints_params < FFI::Struct
    layout(
      # 1D constraints
