...
namespace AliChanDefine {
  ...
  integer
  AliChan::DgDxlp_numRows() const
  { return 1; }

  integer
  AliChan::DgDxlp_numCols() const
  { return 4; }

  integer
  AliChan::DgDxlp_nnz() const
  { return 1; }

  void
  AliChan::DgDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  integer
  AliChan::DgDu_numRows() const
  { return 1; }

  integer
  AliChan::DgDu_numCols() const
  { return 1; }

  integer
  AliChan::DgDu_nnz() const
  { return 1; }

  void
  AliChan::DgDu_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  \*/
  integer
  AliChan::u_numEqns() const
  { return 1; }

  void
  AliChan::u_eval_analytic(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    U_pointer_type       U__
  ) const {
  ...
  integer
  AliChan::segmentLink_numEqns() const
  { return 0; }

  void
  AliChan::segmentLink_eval(
    NodeType const     & L,
    NodeType const     & R,
  ...
  integer
  AliChan::DsegmentLinkDxp_numRows() const
  { return 0; }

  integer
  AliChan::DsegmentLinkDxp_numCols() const
  { return 0; }

  integer
  AliChan::DsegmentLinkDxp_nnz() const
  { return 0; }
  ...
  void
  AliChan::DsegmentLinkDxp_sparse(
    NodeType const     & L,
    NodeType const     & R,
    P_const_pointer_type p,
