...
#ifndef ALICHAN_DOT_HH
#define ALICHAN_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
    ...
    #ifdef ALICHAN_EXPORT
      #define ALICHAN_API_DLL __declspec(dllexport)
    #elif defined(ALICHAN_IMPORT)
      #define ALICHAN_API_DLL __declspec(dllimport)
    #else
      #define ALICHAN_API_DLL
    #endif
  #endif
...
namespace AliChanDefine {
  ...
  class AliChan : public Mechatronix::Discretized_Indirect_OCP {
    ...
    AliChan( AliChan const & );
    AliChan const & operator = ( AliChan const & );
...
namespace AliChanLoad {
  using AliChanDefine::AliChan;
