...
namespace AliChanDefine {
  ...
  real_type
  AliChan::control_penalties_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__
  ) const {
  ...
  integer
  AliChan::integrated_post_numEqns() const
  { return 0; }

  void
  AliChan::integrated_post_eval(
    NodeType2 const    & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
...
// EOF: AliChan_Methods_problem.cc
