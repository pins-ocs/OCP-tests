...
namespace AliChanDefine {
  ...
  class AliChan_Problem {
    ...
    AliChan_Problem( AliChan_Problem const & );
    AliChan_Problem const & operator = ( AliChan_Problem const & );
  ...
  public:
    ...
    ALICHAN_API_DLL
    AliChan_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("AliChan",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "AliChan::solver, fatal: unknown error";
      }
      return ok;
    }
