...
namespace AliChanDefine {
  ...
  void
  AliChan::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  AliChan::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  AliChan::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
