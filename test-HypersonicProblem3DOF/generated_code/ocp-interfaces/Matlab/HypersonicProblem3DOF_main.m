%-----------------------------------------------------------------------%
%  file: HypersonicProblem3DOF_main.m                                   %
%                                                                       %
...
% create object
ocp = HypersonicProblem3DOF( 'HypersonicProblem3DOF' );
...
%ocp.setup(HypersonicProblem3DOF_data);
ocp.setup('../../data/HypersonicProblem3DOF_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%HypersonicProblem3DOF_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = HypersonicProblem3DOF_Mex('get_raw_solution',obj);
%J     = HypersonicProblem3DOF_Mex('eval_JF',obj,Z,MU,U);
%f     = HypersonicProblem3DOF_Mex('eval_F',obj,Z,MU,U);
