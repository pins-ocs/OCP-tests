...
"HypersonicProblem3DOF_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;
...
DO_COMMAND_REMAP_TO_CLASS_METHOD(h_guess_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(theta_guess);
DO_COMMAND_REMAP_TO_CLASS_METHOD(theta_guess_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(phi_guess);
DO_COMMAND_REMAP_TO_CLASS_METHOD(phi_guess_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(V_guess);
DO_COMMAND_REMAP_TO_CLASS_METHOD(V_guess_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(G_guess);
DO_COMMAND_REMAP_TO_CLASS_METHOD(G_guess_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(psi_guess);
DO_COMMAND_REMAP_TO_CLASS_METHOD(psi_guess_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(G_bound);
DO_COMMAND_REMAP_TO_CLASS_METHOD(G_bound_D);
...
static std::unordered_map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"h_guess",do_h_guess},
  {"h_guess_D",do_h_guess_D},
  {"theta_guess",do_theta_guess},
  {"theta_guess_D",do_theta_guess_D},
  {"phi_guess",do_phi_guess},
  {"phi_guess_D",do_phi_guess_D},
  {"V_guess",do_V_guess},
  {"V_guess_D",do_V_guess_D},
  {"G_guess",do_G_guess},
  {"G_guess_D",do_G_guess_D},
  {"psi_guess",do_psi_guess},
  {"psi_guess_D",do_psi_guess_D},
  {"G_bound",do_G_bound},
  {"G_bound_D",do_G_bound_D},
  {"new",do_new},
  {"delete",do_delete},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "HypersonicProblem3DOF_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "HypersonicProblem3DOF_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
