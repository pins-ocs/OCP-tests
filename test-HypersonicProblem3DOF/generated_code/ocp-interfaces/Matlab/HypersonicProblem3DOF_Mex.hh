/*-----------------------------------------------------------------------*\
 |  file: HypersonicProblem3DOF_Mex.cc                                   |
 |                                                                       |
...
#define MODEL_NAME  "HypersonicProblem3DOF"
#define MODEL_CLASS HypersonicProblem3DOF
...
public:
  ...
  void do_h_guess_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_h_guess_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_theta_guess( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_theta_guess_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_theta_guess_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_phi_guess( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_phi_guess_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_phi_guess_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_V_guess( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_V_guess_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_V_guess_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_G_guess( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_G_guess_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_G_guess_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_psi_guess( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_psi_guess_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_psi_guess_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_G_bound( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_G_bound_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_G_bound_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
