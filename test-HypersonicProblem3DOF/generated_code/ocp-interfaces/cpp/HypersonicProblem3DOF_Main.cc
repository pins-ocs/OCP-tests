...
main() {
  ...
  try {
    HypersonicProblem3DOF * m_model = new HypersonicProblem3DOF("HypersonicProblem3DOF",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    string fname = "./data/HypersonicProblem3DOF_Data"; // no .lua or .rb extension
