/*-----------------------------------------------------------------------*\
 |  file: HypersonicProblem3DOF_dll_pins.hh                              |
 |                                                                       |
...
namespace HypersonicProblem3DOFDefine {
  ...
  public:
    ...
    HypersonicProblem3DOF_Problem( integer n_threads, Console const * console )
    : model("HypersonicProblem3DOF",n_threads,console)
    , mesh( "mesh" )
    {
...
// EOF: HypersonicProblem3DOF_dll_pins.hh
