...
namespace HypersonicProblem3DOFDefine {
  ...
  HypersonicProblem3DOF::g_eval(
    ...
    real_type t5   = UM__[0];
    real_type t6   = LM__[3];
    real_type t13  = exp(-XM__[0] / ModelPars[iM_S]);
    real_type t14  = XM__[3];
    real_type t15  = t14 * t14;
    real_type t18  = cos(XM__[4]);
    real_type t19  = ModelPars[iM_ODE];
    real_type t21  = ModelPars[iM_rho0];
    real_type t34  = LM__[4];
    real_type t36  = t13 * t21;
    real_type t39  = ModelPars[iM_CL1] * t14;
    real_type t40  = XM__[6];
    real_type t41  = cos(t40);
    real_type t46  = LM__[5];
    real_type t49  = sin(t40);
    real_type t53  = ModelPars[iM_m];
    result__[ 0   ] = -1.0 / t18 / t53 * (2 * t21 * t19 * t18 * t15 * t13 * t6 * t5 * ModelPars[iM_CD2] * t2 + t21 * t19 * t18 * t15 * t13 * t6 * ModelPars[iM_CD1] * t2 - t18 * t41 * t2 * t39 * t36 * t19 * t34 - t49 * t2 * t39 * t36 * t19 * t46 - 4 * t18 * t53 * t5) * t1 / 2;
    real_type t65  = t1 * LM__[6];
    real_type t70  = ALIAS_u2Control_D_1(UM__[1], -1, 1);
    result__[ 1   ] = ModelPars[iM_sigma_dot_max] * t19 * t65 + t70 * t1;
    real_type t74  = ModelPars[iM_CTRL];
    result__[ 2   ] = t74 * t1 * LM__[0] + 2 * UM__[2] * t1;
    result__[ 3   ] = t74 * t1 * LM__[1] + 2 * UM__[3] * t1;
    result__[ 4   ] = t74 * t1 * LM__[2] + 2 * UM__[4] * t1;
    result__[ 5   ] = t74 * t1 * t6 + 2 * UM__[5] * t1;
    result__[ 6   ] = t74 * t1 * t34 + 2 * UM__[6] * t1;
    result__[ 7   ] = t74 * t1 * t46 + 2 * UM__[7] * t1;
    result__[ 8   ] = 2 * UM__[8] * t1 + t74 * t65;
    if ( m_debug )
  ...
  HypersonicProblem3DOF::DgDxlxlp_sparse(
    ...
    real_type t14  = exp(-t9 * XM__[0]);
    real_type t15  = XM__[3];
    real_type t16  = t15 * t15;
    real_type t17  = t16 * t14;
    real_type t18  = XM__[4];
    ...
    result__[ 0   ] = -0.2500000000e0 * t59 * (t50 * t49 * t48 * t34 * t46 + t43 * t14 * t34 * t33 - t24 * t9 * t6 * t28 - 2 * t24 * t9 * t7 * t4) * t1;
    real_type t62  = t7 * t4;
    ...
    result__[ 1   ] = -0.2500000000e0 * t59 * (-t80 * t37 * t14 * t22 * t46 + 2 * t69 * t19 * t15 * t67 - t19 * t40 * t49 * t74 + 4 * t23 * t48 * t62) * t1;
    real_type t87  = sin(t18);
    real_type t99  = t56 * t5;
    real_type t109 = t69 * t19 * t16;
    real_type t112 = t73 * t46;
    real_type t117 = -t80 * t38 * t112 + t109 * t67 - 4 * t19 * t99 + 2 * t24 * t62 - t43 * t74;
    real_type t119 = t19 * t19;
    result__[ 2   ] = -0.2500000000e0 * t59 * (-2 * t22 * t20 * t87 * t17 * t62 - t69 * t87 * t16 * t67 + t87 * t41 * t38 * t74 + 4 * t87 * t99) * t1 - 0.2500000000e0 * t87 / t119 * t57 * t117 * t1;
    result__[ 3   ] = -0.2500000000e0 * t59 * (t19 * t80 * t38 * t74 - t41 * t38 * t112) * t1;
    result__[ 4   ] = -0.2500000000e0 * t59 * (2 * t109 * t14 * t5 * t4 + t109 * t14 * t28) * t1;
    real_type t144 = t20 * t1;
    result__[ 5   ] = 0.2500000000e0 * t57 * t41 * t38 * t73 * t144;
    result__[ 6   ] = 0.2500000000e0 * t58 * t57 * t50 * t49 * t15 * t73 * t144;
    ...
    result__[ 14  ] = -t58 * t57 * t117 / 2;
    real_type t158 = ModelPars[iM_sigma_dot_max];
    result__[ 15  ] = 0.5e0 * t158 * t144;
    result__[ 16  ] = result__[15];
    real_type t160 = LM__[6];
    real_type t164 = ALIAS_u2Control_D_1(UM__[1], -1, 1);
    result__[ 17  ] = t158 * t20 * t160 + t164;
    real_type t165 = ModelPars[iM_CTRL];
    result__[ 18  ] = 0.5e0 * t165 * t1;
    result__[ 19  ] = result__[18];
    result__[ 20  ] = t165 * LM__[0] + 2 * UM__[2];
    result__[ 21  ] = result__[19];
    result__[ 22  ] = result__[21];
    result__[ 23  ] = t165 * LM__[1] + 2 * UM__[3];
    result__[ 24  ] = result__[22];
    result__[ 25  ] = result__[24];
    result__[ 26  ] = t165 * LM__[2] + 2 * UM__[4];
    result__[ 27  ] = result__[25];
    result__[ 28  ] = result__[27];
    result__[ 29  ] = t165 * t6 + 2 * UM__[5];
    result__[ 30  ] = result__[28];
    result__[ 31  ] = result__[30];
    result__[ 32  ] = t165 * t32 + 2 * UM__[6];
    result__[ 33  ] = result__[31];
    result__[ 34  ] = result__[33];
    result__[ 35  ] = t165 * t45 + 2 * UM__[7];
    result__[ 36  ] = result__[34];
    result__[ 37  ] = result__[36];
    result__[ 38  ] = t165 * t160 + 2 * UM__[8];
    if ( m_debug )
  ...
  HypersonicProblem3DOF::DgDu_sparse(
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    real_type t1   = P__[iP_Tf];
    real_type t10  = exp(-XM__[0] / ModelPars[iM_S]);
    real_type t14  = XM__[3] * XM__[3];
    real_type t16  = cos(XM__[4]);
    real_type t24  = ModelPars[iM_m];
    result__[ 0   ] = -1.0 / t16 / t24 * (2 * ModelPars[iM_ODE] * ModelPars[iM_rho0] * t16 * t14 * t10 * LM__[3] * ModelPars[iM_Aref] * ModelPars[iM_CD2] - 4 * t16 * t24) * t1 / 2;
  ...
  HypersonicProblem3DOF::DmDu_eval(
    ...
    result__[ 0   ] = t34 * t31 * (2 * t23 * t24 + t27) * t21 * t18 * t47 * t46 - t65 * t89 * t88 * t86 * t85 - t97 * t96 * t34 * t31 * t88 * t86 * t116;
    real_type t123 = U__[iU_u2];
    real_type t124 = ALIAS_u2Control_D_1(t123, -1, 1);
    real_type t128 = ModelPars[iM_sigma_dot_max] * t3;
    real_type t135 = t2 * (V__[6] - (t123 * t128 + t40 * U__[iU_c_sigma]) * t2);
    result__[ 1   ] = t124 * t2 - 2 * t128 * t135;
    real_type t139 = t20 * t3;
    result__[ 2   ] = -2 * t40 * t2 * (V__[0] - (t139 * t5 + t40 * U__[iU_c_h]) * t2);
