...
% create object
infolevel  = 4;
ocp = SingularLuus04_FreeTime( 'SingularLuus04_FreeTime', infolevel );
...
%ocp.setup('../../data/SingularLuus04_FreeTime_Data.lua');
...
%%clear mex
%x = SingularLuus04_FreeTime_Mex('get_raw_solution',obj);
%J = SingularLuus04_FreeTime_Mex('eval_JF',obj,x);
%f = SingularLuus04_FreeTime_Mex('eval_F',obj,x);
