...
classdef SingularLuus04_FreeTime < handle
  ...
  methods
    ...
    function u = eval_u( self, varargin )
      ...
      u = SingularLuus04_FreeTime_Mex( 'u', self.objectHandle, varargin{:} );
    end
    % ---------------------------------------------------------------------
