...
#ifndef SINGULARLUUS04_FREETIME_DOT_HH
#define SINGULARLUUS04_FREETIME_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef SINGULARLUUS04_FREETIME_API_DLL
    #ifdef SINGULARLUUS04_FREETIME_EXPORT
      #define SINGULARLUUS04_FREETIME_API_DLL __declspec(dllexport)
    #elif defined(SINGULARLUUS04_FREETIME_IMPORT)
      #define SINGULARLUUS04_FREETIME_API_DLL __declspec(dllimport)
    #else
      #define SINGULARLUUS04_FREETIME_API_DLL
    #endif
  #endif
...
namespace SingularLuus04_FreeTimeDefine {
  ...
  class SingularLuus04_FreeTime : public Mechatronix::Discretized_Indirect_OCP {

    // Model Paramaters  - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    real_type ModelPars[12];
    ...
    SingularLuus04_FreeTime const & operator = ( SingularLuus04_FreeTime const & );
  ...
  public:
    ...
    SINGULARLUUS04_FREETIME_API_DLL virtual
    ~SingularLuus04_FreeTime() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    SINGULARLUUS04_FREETIME_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "SingularLuus04_FreeTime"; }
...
namespace SingularLuus04_FreeTimeLoad {
  using SingularLuus04_FreeTimeDefine::SingularLuus04_FreeTime;

}

#endif

// EOF: SingularLuus04_FreeTime.hh
