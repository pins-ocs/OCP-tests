...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%SingularLuus04_FreeTime_Mex('set_tracked',obj,tracked);
...
%[Z,U] = SingularLuus04_FreeTime_Mex('get_raw_solution',obj);
%J     = SingularLuus04_FreeTime_Mex('eval_JF',obj,Z,U);
%f     = SingularLuus04_FreeTime_Mex('eval_F',obj,Z,U);
