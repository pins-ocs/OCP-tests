...
ocp.setup( [DATA_PATH 'SingularLuus04_FreeTime_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = SingularLuus04_FreeTime_Mex('get_raw_solution',obj);
%J        = SingularLuus04_FreeTime_Mex('eval_JF',obj,Z,MU,U);
%f        = SingularLuus04_FreeTime_Mex('eval_F',obj,Z,MU,U);
