...
main() {
  ...
  try {
    ...
    SingularLuus04_FreeTime model("SingularLuus04_FreeTime",n_threads,&console);
    ...
    gc_data["DumpFile"] = "SingularLuus04_FreeTime_dump";
    ...
    // Model Parameters
    data_Parameters["theta"] = theta;

    // Guess Parameters
    data_Parameters["T_guess"] = 50;

    // Boundary Conditions
    data_Parameters["x_f"] = 0;
    data_Parameters["x_i"] = 1;
    data_Parameters["y_f"] = 0;
    data_Parameters["y_i"] = 0;
    data_Parameters["z_f"] = 0;
    ...
    data_Parameters["theta1"] = 0.01;
    data_Parameters["u_epsi"] = u_epsi;
    data_Parameters["min_u_epsi"] = 0.001;
...
SingularLuus04_FreeTime_data.Mesh["segments"][0]["length"] = 1;
    ...
    std::ofstream file;
    if ( ok ) {
      file.open( "data/SingularLuus04_FreeTime_OCP_result.txt" );
    } else {
      cout << gc_solution("solver_message").get_string() << '\n';
      // dump solution to file
      file.open( "data/SingularLuus04_FreeTime_OCP_result_NOT_CONVERGED.txt" );
    }
    file.precision(18);
