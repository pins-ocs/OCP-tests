...
main() {
  ...
  try {
    SingularLuus04_FreeTime * m_model = new SingularLuus04_FreeTime("SingularLuus04_FreeTime",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/SingularLuus04_FreeTime_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/SingularLuus04_FreeTime_Data.lua";
    #endif
