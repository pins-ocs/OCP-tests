...
namespace SingularLuus04_FreeTimeDefine {
  ...
  void
  SingularLuus04_FreeTime::p_guess_eval( P_p_type P__ ) const {
  }

  void
  SingularLuus04_FreeTime::xlambda_guess_eval(
    integer        i_segment,
    Q_const_p_type Q__,
    P_const_p_type P__,
    X_p_type       X__,
  ...
  bool
  SingularLuus04_FreeTime::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  SingularLuus04_FreeTime::xlambda_check_node(
    integer         ipos,
    ...
    /* REMOVED */ Xoptima__check__node__lt(0, t1, Xoptima__message_node_check_0);
    /* REMOVED */ Xoptima__check__node__lt(t1, 100, Xoptima__message_node_check_1);
    return true;
  }
  ...
  bool
  SingularLuus04_FreeTime::penalties_check_node(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
  ...
  integer SingularLuus04_FreeTime::u_guess_numEqns() const { return 1; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  SingularLuus04_FreeTime::u_guess_eval(
    NodeQXL const & NODE__,
    P_const_p_type  P__,
  ...
  bool
  SingularLuus04_FreeTime::u_check_if_admissible(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__
