/*-----------------------------------------------------------------------*\
 |  file: SingularLuus04_FreeTime_dll_pins.hh                            |
 |                                                                       |
...
namespace SingularLuus04_FreeTimeDefine {
  ...
  using namespace SingularLuus04_FreeTimeLoad;
  ...
  class SingularLuus04_FreeTime_Problem {

    SingularLuus04_FreeTime model;
    ...
    SingularLuus04_FreeTime_Problem( SingularLuus04_FreeTime_Problem const & );
    SingularLuus04_FreeTime_Problem const & operator = ( SingularLuus04_FreeTime_Problem const & );
  ...
  public:
    ...
    SingularLuus04_FreeTime_Problem( integer n_threads, Console const * console )
    : model("SingularLuus04_FreeTime",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    SINGULARLUUS04_FREETIME_API_DLL
    ~SingularLuus04_FreeTime_Problem()
    {}
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "SingularLuus04_FreeTime::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: SingularLuus04_FreeTime_dll_pins.hh
