/*-----------------------------------------------------------------------*\
 |  file: SingularLuus04_FreeTime_dll_ruby.hh                            |
 |                                                                       |
...
namespace SingularLuus04_FreeTimeDefine {
  ...
  */
  ...
  SINGULARLUUS04_FREETIME_API_DLL
  bool
  SingularLuus04_FreeTime_ocp_guess( char const id[], GenericContainer & gc_guess );
...
// EOF: SingularLuus04_FreeTime_dll_ruby.hh
