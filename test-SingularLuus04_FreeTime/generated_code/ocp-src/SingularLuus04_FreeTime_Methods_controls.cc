...
namespace SingularLuus04_FreeTimeDefine {
  ...
  real_type
  SingularLuus04_FreeTime::g_fun_eval(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    ...
    real_type result__ = (ModelPars[iM_theta] * t1 + t3) * t1 + t9 * t1 + X__[iX_y] * t1 * MU__[0] + X__[iX_z] * t1 * MU__[1] + t8 * t1 * MU__[2];
    if ( m_debug ) {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SingularLuus04_FreeTime::DgDxpm_numRows() const { return 1; }
  integer SingularLuus04_FreeTime::DgDxpm_numCols() const { return 8; }
  integer SingularLuus04_FreeTime::DgDxpm_nnz()     const { return 2; }

  void
  SingularLuus04_FreeTime::DgDxpm_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  SingularLuus04_FreeTime::DgDxpm_sparse(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__,
