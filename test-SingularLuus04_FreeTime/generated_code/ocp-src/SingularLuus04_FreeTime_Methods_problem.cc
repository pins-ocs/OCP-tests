...
namespace SingularLuus04_FreeTimeDefine {
  ...
  SingularLuus04_FreeTime::H_eval(
    ...
    real_type t12  = X__[iX_x] * X__[iX_x];
    real_type t15  = uControl(t9, -1, 1);
    real_type result__ = (ModelPars[iM_theta] * t1 + t9 * L__[iL_lambda3__xo] + L__[iL_lambda1__xo] * X__[iX_y] + L__[iL_lambda2__xo] * X__[iX_z] + t12 + t15) * t1;
    return result__;
  }
#else
  real_type
  ...
  integer
  SingularLuus04_FreeTime::DmayerDx_numEqns() const
  { return 8; }

  void
  SingularLuus04_FreeTime::DmayerDx_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  SingularLuus04_FreeTime::DmayerDp_numEqns() const
  { return 0; }

  void
  SingularLuus04_FreeTime::DmayerDp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
