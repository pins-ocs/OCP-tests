...
%ocp.setup(Speyer_data);
%ocp.setup('../../data/Speyer_Data.lua');
ocp.setup('../../data/Speyer_Data.rb');
...
%%clear mex
%x = Speyer_Mex('get_raw_solution',obj);
%J = Speyer_Mex('eval_JF',obj,x);
%f = Speyer_Mex('eval_F',obj,x);
