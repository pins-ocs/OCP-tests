...
classdef Speyer < handle
  ...
  methods
    ...
    function res = x1( self, varargin  )
      res = Speyer_Mex( 'get_solution', self.objectHandle, 'x1', varargin{:} );
    end
    function res = x2( self, varargin  )
      res = Speyer_Mex( 'get_solution', self.objectHandle, 'x2', varargin{:} );
    end
    ...
    function res = lambda1( self, varargin )
      res = Speyer_Mex( 'get_solution', self.objectHandle, 'lambda1__xo', varargin{:} );
    end
    function res = lambda2( self, varargin )
      res = Speyer_Mex( 'get_solution', self.objectHandle, 'lambda2__xo', varargin{:} );
    end
    ...
    function res = u( self, varargin )
      res = Speyer_Mex( 'get_solution', self.objectHandle, 'u', varargin{:} );
    end
    ...
    function [a,c] = get_ac( self, iseg_L, q_L, x_L, lambda_L, ...
      ...
      [a,c] = Speyer_Mex( 'a', self.objectHandle, ...
