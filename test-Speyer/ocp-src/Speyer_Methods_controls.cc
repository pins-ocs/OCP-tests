...
namespace SpeyerDefine {
  ...
  integer
  Speyer::DgDxlp_numRows() const
  { return 1; }

  integer
  Speyer::DgDxlp_numCols() const
  { return 4; }

  integer
  Speyer::DgDxlp_nnz() const
  { return 1; }

  void
  Speyer::DgDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  integer
  Speyer::DgDu_numRows() const
  { return 1; }

  integer
  Speyer::DgDu_numCols() const
  { return 1; }

  integer
  Speyer::DgDu_nnz() const
  { return 1; }
  ...
  \*/
  integer
  Speyer::u_numEqns() const
  { return 1; }

  void
  Speyer::u_eval_analytic(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    U_pointer_type       U__
  ) const {
  ...
  integer
  Speyer::segmentLink_numEqns() const
  { return 0; }

  void
  Speyer::segmentLink_eval(
    NodeType const     & L,
    NodeType const     & R,
  ...
  integer
  Speyer::DsegmentLinkDxp_numRows() const
  { return 0; }

  integer
  Speyer::DsegmentLinkDxp_numCols() const
  { return 0; }

  integer
  Speyer::DsegmentLinkDxp_nnz() const
  { return 0; }

  void
  Speyer::DsegmentLinkDxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
