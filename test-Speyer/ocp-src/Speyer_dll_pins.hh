...
namespace SpeyerDefine {
  ...
  class Speyer_Problem {
    ...
    Speyer_Problem( Speyer_Problem const & );
    Speyer_Problem const & operator = ( Speyer_Problem const & );
  ...
  public:
    ...
    SPEYER_API_DLL
    Speyer_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("Speyer",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "Speyer::solver, fatal: unknown error";
      }
      return ok;
    }
