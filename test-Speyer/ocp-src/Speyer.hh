...
#ifndef SPEYER_DOT_HH
#define SPEYER_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef SPEYER_API_DLL
    #ifdef SPEYER_EXPORT
      #define SPEYER_API_DLL __declspec(dllexport)
    #elif defined(SPEYER_IMPORT)
      #define SPEYER_API_DLL __declspec(dllimport)
    #else
      #define SPEYER_API_DLL
    #endif
  #endif
...
namespace SpeyerDefine {
  ...
  class Speyer : public Mechatronix::Discretized_Indirect_OCP {
    ...
    Speyer( Speyer const & );
    Speyer const & operator = ( Speyer const & );
  ...
  public:
    ...
    SPEYER_API_DLL virtual
    ~Speyer() MECHATRONIX_OVERRIDE;
...
namespace SpeyerLoad {
  using SpeyerDefine::Speyer;
