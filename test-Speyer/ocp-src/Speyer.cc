...
namespace SpeyerDefine {
  ...
  */
  void
  Speyer::updateContinuation( integer phase, real_type s ) {
    UTILS_ASSERT(
      s >= 0 && s <= 1,
      "Speyer::updateContinuation( phase number = {}, s = {}) "
  ...
  */
  void
  Speyer::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "Speyer::setupParameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in Speyer::setup not all parameters are set!\n"
    );
  }

  void
  Speyer::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  Speyer::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  Speyer::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  Speyer::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  Speyer::setupControls( GenericContainer const & gc_data ) {
  ...
  */
  void
  Speyer::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "Speyer::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in Speyer::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  Speyer::setup( GenericContainer const & gc ) {

    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("Speyer::setup, Debug");
  ...
  */
  void
  Speyer::get_names( GenericContainer & out ) const {
  ...
  */
  void
  Speyer::diagnostic( GenericContainer const & gc ) {
  ...
  void
  Speyer::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
