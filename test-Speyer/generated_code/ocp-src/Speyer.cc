...
namespace SpeyerDefine {
  ...
  */
  ...
  Speyer::update_continuation(
    ...
    UTILS_ASSERT(
      0 <= old_s && old_s < s && s <= 1,
      "Speyer::update_continuation( phase number={}, old_s={}, s={} ) "
      "must be 0 <= old_s < s <= 1\n",
      phase, old_s, s
    );
    switch ( phase ) {
  ...
  */
  void
  Speyer::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "Speyer::setup_parameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  Speyer::setup_parameters( real_type const Pars[] ) {
  ...
  */
  void
  Speyer::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  Speyer::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  Speyer::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  Speyer::setup_controls( GenericContainer const & gc_data ) {
  ...
  */
  void
  Speyer::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "Speyer::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in Speyer::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
