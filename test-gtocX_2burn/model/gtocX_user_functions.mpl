...
XPOS := x_position(p(zeta),f(zeta),g(zeta),h(zeta),k(zeta),L(zeta),retrograde):
YPOS := y_position(p(zeta),f(zeta),g(zeta),h(zeta),k(zeta),L(zeta),retrograde):
ZPOS := z_position(p(zeta),f(zeta),g(zeta),h(zeta),k(zeta),L(zeta),retrograde):
XVEL := x_velocity(p(zeta),f(zeta),g(zeta),h(zeta),k(zeta),L(zeta),retrograde):
YVEL := y_velocity(p(zeta),f(zeta),g(zeta),h(zeta),k(zeta),L(zeta),retrograde):
ZVEL := z_velocity(p(zeta),f(zeta),g(zeta),h(zeta),k(zeta),L(zeta),retrograde):
