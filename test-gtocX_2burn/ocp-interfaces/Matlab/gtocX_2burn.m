...
classdef gtocX_2burn < handle
  ...
  methods
    ...
    function ok = solve( self )
      ...
      ok = gtocX_2burn_Mex( 'solve', self.objectHandle );
    end

    function updateContinuation( self, n, s )
      gtocX_2burn_Mex( 'updateContinuation', self.objectHandle, n, s );
    end
    ...
    % STATES
    % -------------------------------------------------------------------------
    function res = p( self, varargin  )
      res = gtocX_2burn_Mex( 'get_solution', self.objectHandle, 'p', varargin{:} );
    end
    function res = f( self, varargin  )
      res = gtocX_2burn_Mex( 'get_solution', self.objectHandle, 'f', varargin{:} );
    end
    function res = g( self, varargin  )
      res = gtocX_2burn_Mex( 'get_solution', self.objectHandle, 'g', varargin{:} );
    end
    function res = h( self, varargin  )
      res = gtocX_2burn_Mex( 'get_solution', self.objectHandle, 'h', varargin{:} );
    end
    function res = k( self, varargin  )
      res = gtocX_2burn_Mex( 'get_solution', self.objectHandle, 'k', varargin{:} );
    end
    function res = L( self, varargin  )
      res = gtocX_2burn_Mex( 'get_solution', self.objectHandle, 'L', varargin{:} );
    end
    ...
    function res = lambda1( self, varargin )
      res = gtocX_2burn_Mex( 'get_solution', self.objectHandle, 'lambda1__xo', varargin{:} );
    end
    function res = lambda2( self, varargin )
      res = gtocX_2burn_Mex( 'get_solution', self.objectHandle, 'lambda2__xo', varargin{:} );
    end
    function res = lambda3( self, varargin )
      res = gtocX_2burn_Mex( 'get_solution', self.objectHandle, 'lambda3__xo', varargin{:} );
    end
    function res = lambda4( self, varargin )
      res = gtocX_2burn_Mex( 'get_solution', self.objectHandle, 'lambda4__xo', varargin{:} );
    end
    function res = lambda5( self, varargin )
      res = gtocX_2burn_Mex( 'get_solution', self.objectHandle, 'lambda5__xo', varargin{:} );
    end
    function res = lambda6( self, varargin )
      res = gtocX_2burn_Mex( 'get_solution', self.objectHandle, 'lambda6__xo', varargin{:} );
    end
