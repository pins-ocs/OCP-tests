...
main() {
  ...
  try {
    gtocX_2burn * m_model = new gtocX_2burn("gtocX_2burn",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/gtocX_2burn_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/gtocX_2burn_Data.lua";
    #endif
    ...
    if ( ok ) {
      ...
      file.open( "data/gtocX_2burn_OCP_result_NOT_CONVERGED.txt" );
    }
    file.precision(18);
