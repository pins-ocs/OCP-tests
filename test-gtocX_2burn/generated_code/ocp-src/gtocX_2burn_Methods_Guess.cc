...
namespace gtocX_2burnDefine {
  ...
  void
  gtocX_2burn::p_guess_eval( P_p_type P__ ) const {
  }
  ...
  // node_check_strings
  #define Xoptima__message_node_check_0 "0 < p(zeta)"

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  bool
  gtocX_2burn::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  integer gtocX_2burn::u_guess_numEqns() const { return 0; }
