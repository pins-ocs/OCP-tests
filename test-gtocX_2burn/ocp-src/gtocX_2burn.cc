...
namespace gtocX_2burnDefine {
  ...
  */
  ...
  void
  gtocX_2burn::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  gtocX_2burn::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  gtocX_2burn::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  gtocX_2burn::setupControls( GenericContainer const & gc_data ) {
