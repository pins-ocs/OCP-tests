...
namespace gtocX_2burnDefine {
  ...
  gtocX_2burn::xPosition_D_2_6( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t38  = 3 * t26;
    return -2 / (t7 + t8 + 1) / (t2 * t1 * (t24 * f__XO - 3 * t26 * f__XO) + t2 * (t10 * (3 * g__XO * t24 - t34) + 3 * t24 - t38) + 3 * t1 * (t26 + 2 * t18 + 1) * f__XO + t10 * (t34 + 3 * g__XO) + t38 + 1) * (2 * t4 * h__XO * t2 + t1 * (t4 * f__XO * h__XO + g__XO * t9 + t10 * t9) - (t18 + 1) * retrograde__XO * h__XO * k__XO) * p__XO;
  }
  ...
  gtocX_2burn::xPosition_D_4_6( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return -2 / t34 / (t21 * (t18 - t19) + t6 * (2 * t9 * g__XO * f__XO + 2 * f__XO) + t19 + 2 * t9 * g__XO + 1) * (retrograde__XO * t4 * f__XO + 2 * g__XO * h__XO * k__XO + 2 * t9 * k__XO * h__XO + t6 * t4 * retrograde__XO) * k__XO * p__XO;
  }
  ...
  gtocX_2burn::xPosition_D_5_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t23  = t1 + t3 + 1;
    real_type t24  = t23 * t23;
    return -4 / t24 / t23 / (t7 * f__XO + t13 * g__XO + 1) * p__XO * (t7 * (t1 - 3 * t3 + 1) * (t1 + 1) + 3 * t13 * retrograde__XO * h__XO * k__XO * (t1 - t3 / 3 + 1));
  }
  ...
  gtocX_2burn::yPosition_D_1_2( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t14  = g__XO * g__XO;
    real_type t16  = t7 * t7;
    return 1.0 / (t1 + t2 + 1) / (t16 * (t13 - t14) + t7 * (2 * t5 * g__XO * f__XO + 2 * f__XO) + t14 + 2 * t5 * g__XO + 1) * t7 * (t5 * (t1 - t2 - 1) * retrograde__XO - 2 * k__XO * h__XO * t7);
  }
  ...
  gtocX_2burn::yPosition_D_2_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return 2 / t31 / (t18 * (t15 - t16) + t1 * (2 * t9 * g__XO * f__XO + 2 * f__XO) + t16 + 2 * t9 * g__XO + 1) * (t1 * (t3 - t4 - 1) * k__XO + 2 * (t4 + 1) * t9 * retrograde__XO * h__XO) * p__XO * t1;
  }
  ...
  gtocX_2burn::yPosition_D_3_6( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t35  = t27 * g__XO;
    real_type t39  = 3 * t27;
    return 2 / (t6 + t7 + 1) / (t2 * t1 * (t25 * f__XO - 3 * t27 * f__XO) + t2 * (t10 * (3 * g__XO * t25 - t35) + 3 * t25 - t39) + 3 * t1 * (2 * t10 * g__XO + t27 + 1) * f__XO + t10 * (t35 + 3 * g__XO) + t39 + 1) * p__XO * (-2 * k__XO * h__XO * t2 + t1 * (-f__XO * h__XO * k__XO + t10 * t8 * retrograde__XO) + t10 * (retrograde__XO * t8 * f__XO + g__XO * h__XO * k__XO) + h__XO * k__XO);
  }
  ...
  gtocX_2burn::yPosition_D_6_6( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t53  = 3 * t21;
    return -2 / (t1 + t2 + 1) / (t11 * t10 * (-3 * t21 * f__XO + t33 * f__XO) + t11 * (t19 * (3 * g__XO * t33 - t49) + 3 * t33 - t53) + 3 * t10 * (2 * t19 * g__XO + t21 + 1) * f__XO + t19 * (t49 + 3 * g__XO) + t53 + 1) * p__XO * (t11 * (-t6 - t8) + t10 * (t19 * (-g__XO * h__XO * k__XO + retrograde__XO * t15 / 2) - 2 * k__XO * h__XO * t21 - retrograde__XO * g__XO * t15 + t27) + t19 * (2 * t27 * f__XO * g__XO + (t33 - 1.0 / 2.0) * t4) - t6 + 2 * t8);
  }
  ...
  gtocX_2burn::zPosition_D_3_6( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return -2 / (t49 + t50 + 1) / (t2 * t1 * (t21 * f__XO - 3 * t23 * f__XO) + t2 * (t10 * (3 * g__XO * t21 - t31) + 3 * t21 - t35) + 3 * t1 * (2 * t10 * g__XO + t23 + 1) * f__XO + t10 * (t31 + 3 * g__XO) + t35 + 1) * p__XO * (retrograde__XO * t10 * g__XO * k__XO + 2 * t10 * h__XO * f__XO - t7 * f__XO * t1 + 2 * h__XO * t10 * t1 - 2 * retrograde__XO * k__XO * t2 + t7);
  }
  ...
  gtocX_2burn::zPosition_D_4_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t21  = t2 + t3 + 1;
    real_type t22  = t21 * t21;
    return 4 / t22 / t21 / (t6 * f__XO + t9 * g__XO + 1) * p__XO * (t6 * (t2 - 3 * t3 + 1) * h__XO * retrograde__XO + 3 * (t2 - t3 / 3 - 1.0 / 3.0) * t9 * k__XO);
  }
  ...
  gtocX_2burn::zPosition_D_5_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t22  = t21 * t21;
    return -4 / t22 / t21 / (t6 * f__XO + t10 * g__XO + 1) * (-3 * t6 * retrograde__XO * k__XO * (t1 - t2 / 3 + 1) + (t1 - 3 * t2 + 1) * t10 * h__XO) * p__XO;
  }
  ...
  gtocX_2burn::xVelocity_D_4_6( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return 2 / t19 * t16 * k__XO * (t7 * (t3 - t4 - 1) * retrograde__XO - 2 * k__XO * h__XO * t9) / t1;
  }
  ...
  gtocX_2burn::xVelocity_D_5_6( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return -2 / t20 * (t10 * (t7 - t8 + 1) * h__XO * retrograde__XO - 2 * (t7 + 1) * t13 * k__XO) * t4 / t1;
  }
  ...
  gtocX_2burn::yVelocity_D_4_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return 12 / t41 / t40 * t39 / t35 * (t7 * (t2 + 1) * (t1 - t2 / 3 - 1.0 / 3.0) * retrograde__XO - t13 * (t1 - 3 * t2 - 3) * k__XO * h__XO / 3 - retrograde__XO * t17 * f__XO / 3 + t2 * k__XO * t21 + t2 * (t1 - 2.0 / 3.0) * t24 - k__XO * (t1 - 3) * t21 / 3 + (t1 - 1.0 / 3.0) * t24);
  }
  ...
  gtocX_2burn::zVelocity_D_1_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return 1.0 / t25 * t23 / t18 / p__XO * (2 * t2 * k__XO * retrograde__XO * h__XO + t9 * (t6 - t7 - 1) + 2 * g__XO * h__XO * k__XO * retrograde__XO + t6 * f__XO - t7 * f__XO - f__XO);
  }
  ...
  gtocX_2burn::zVelocity_D_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return -2 / t24 * t22 / t18 * (2 * t2 * k__XO * retrograde__XO * h__XO + t9 * (t6 - t7 - 1) + 2 * g__XO * h__XO * k__XO * retrograde__XO + t6 * f__XO - t7 * f__XO - f__XO);
  }
  ...
  gtocX_2burn::zVelocity_D_4_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return 4 / t36 / t35 * (t11 * (t6 - 3 * t7 - 3) * h__XO + 3 * t16 * k__XO * (t6 - t7 / 3 - 1.0 / 3.0) * retrograde__XO + t6 * h__XO * f__XO + 3 * k__XO * retrograde__XO * t6 * g__XO + h__XO * (-3 * t7 * f__XO - 3 * f__XO) - (t7 + 1) * retrograde__XO * g__XO * k__XO) * t4 / t1;
  }
  ...
  gtocX_2burn::ray_D_3_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type L__XO ) const {
    ...
    real_type t25  = 3 * t13;
    return 1.0 / (t2 * t1 * (t11 * f__XO - 3 * t13 * f__XO) + t2 * (t4 * (3 * t11 * g__XO - t21) + 3 * t11 - t25) + 3 * t1 * (t13 + 2 * t5 + 1) * f__XO + t4 * (t21 + 3 * g__XO) + t25 + 1) * p__XO * (t2 * f__XO + t1 * (t5 - 1) - 2 * f__XO);
  }
