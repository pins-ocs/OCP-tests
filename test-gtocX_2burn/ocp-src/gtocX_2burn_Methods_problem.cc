...
namespace gtocX_2burnDefine {
  ...
  gtocX_2burn::xPosition_D_2_2( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t31  = 3 * t19;
    return 2 / (t12 * t4 * (t17 * f__XO - 3 * t19 * f__XO) + t12 * (t7 * (3 * g__XO * t17 - t27) + 3 * t17 - t31) + 3 * t4 * (2 * t7 * g__XO + t19 + 1) * f__XO + t7 * (t27 + 3 * g__XO) + t31 + 1) / (t1 + t2 + 1) * p__XO * t12 * (t4 * (t1 - t2 + 1) + 2 * t7 * k__XO * retrograde__XO * h__XO);
  }
  ...
  gtocX_2burn::xPosition_D_2_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t19  = g__XO * g__XO;
    real_type t21  = t1 * t1;
    return 2 / (t21 * (t18 - t19) + t1 * (2 * t7 * g__XO * f__XO + 2 * f__XO) + t19 + 2 * t7 * g__XO + 1) / t15 * p__XO * (t7 * (t3 - t4 - 1) * retrograde__XO - 2 * k__XO * h__XO * t1) * k__XO * t1;
  }
  ...
  gtocX_2burn::xPosition_D_2_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t20  = g__XO * g__XO;
    real_type t22  = t5 * t5;
    return -2 / (t22 * (t19 - t20) + t5 * (2 * t10 * g__XO * f__XO + 2 * f__XO) + t20 + 2 * t10 * g__XO + 1) / t16 * p__XO * t5 * (t5 * (-2 * k__XO * t1 - 2 * k__XO) + t10 * (t1 - t8 + 1) * h__XO * retrograde__XO);
  }
  ...
  gtocX_2burn::xPosition_D_3_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t26  = t7 * t7;
    return 2 / (t5 * (2 * g__XO * t18 + 2 * g__XO) + t26 * (t23 - t24) + 2 * t18 + t24 + 1) / t15 * p__XO * t5 * (t5 * (t1 - t2 - 1) * retrograde__XO - 2 * k__XO * h__XO * t7) * k__XO;
  }
  ...
  gtocX_2burn::xPosition_D_4_6( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t23  = g__XO * g__XO;
    real_type t25  = t5 * t5;
    return -2 / (t25 * (t22 - t23) + t5 * (2 * t8 * g__XO * f__XO + 2 * f__XO) + t23 + 2 * t8 * g__XO + 1) / t19 * p__XO * k__XO * (retrograde__XO * t3 * f__XO + 2 * g__XO * h__XO * k__XO + 2 * t8 * k__XO * h__XO + t5 * t3 * retrograde__XO);
  }
  ...
  gtocX_2burn::xPosition_D_5_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t23  = t1 + t3 + 1;
    real_type t24  = t23 * t23;
    return -4 / t24 / t23 / (t7 * f__XO + t13 * g__XO + 1) * p__XO * (t7 * (t1 - 3 * t3 + 1) * (t1 + 1) + 3 * t13 * k__XO * (t1 - t3 / 3 + 1) * h__XO * retrograde__XO);
  }
  ...
  gtocX_2burn::yPosition_D_2( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t19  = t1 * t1;
    return 1.0 / (t19 * (t16 - t17) + t1 * (2 * t6 * g__XO * f__XO + 2 * f__XO) + t17 + 2 * t6 * g__XO + 1) / (t2 + t3 + 1) * p__XO * (t6 * (t2 - t3 - 1) * retrograde__XO - 2 * k__XO * h__XO * t1) * t1;
  }
  ...
  gtocX_2burn::yPosition_D_2_3( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t32  = 3 * t20;
    return 2 / (t7 * t1 * (t18 * f__XO - 3 * t20 * f__XO) + t7 * (t9 * (3 * g__XO * t18 - t28) + 3 * t18 - t32) + 3 * t1 * (2 * t9 * g__XO + t20 + 1) * f__XO + t9 * (t28 + 3 * g__XO) + t32 + 1) / (t3 + t4 + 1) * (2 * h__XO * k__XO * t9 * t1 + t7 * t6 - t6) * p__XO * t1;
  }
  ...
  gtocX_2burn::yPosition_D_2_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t20  = g__XO * g__XO;
    real_type t22  = t1 * t1;
    return 2 / (t22 * (t19 - t20) + t1 * (2 * t8 * g__XO * f__XO + 2 * f__XO) + t20 + 2 * t8 * g__XO + 1) / t16 * p__XO * (t1 * (t2 - t3 - 1) * k__XO + 2 * (t3 + 1) * t8 * retrograde__XO * h__XO) * t1;
  }
  ...
  gtocX_2burn::yPosition_D_4_6( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t30  = g__XO * g__XO;
    real_type t32  = t2 * t2;
    return -4 / (t32 * (t29 - t30) + t2 * (2 * t10 * g__XO * f__XO + 2 * f__XO) + t30 + 2 * t10 * g__XO + 1) / t27 * p__XO * ((t3 + 1) * t2 * retrograde__XO * h__XO - t10 * (t7 - t3 - 1) * k__XO / 2 + t3 * k__XO * g__XO / 2 + retrograde__XO * t3 * t16 + k__XO * (-t7 / 2 + 1.0 / 2.0) * g__XO + retrograde__XO * t16);
  }
  ...
  gtocX_2burn::zPosition_D_2_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t18  = g__XO * g__XO;
    real_type t20  = t1 * t1;
    return 2 / (t20 * (t17 - t18) + t1 * (2 * t8 * g__XO * f__XO + 2 * f__XO) + t18 + 2 * t8 * g__XO + 1) / t14 * p__XO * (t1 * (t2 - t3 + 1) * retrograde__XO + 2 * t8 * k__XO * h__XO) * t1;
  }
  ...
  gtocX_2burn::zPosition_D_3_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t18  = g__XO * g__XO;
    real_type t20  = t5 * t5;
    return 2 / (t20 * (t17 - t18) + t5 * (2 * t8 * g__XO * f__XO + 2 * f__XO) + t18 + 2 * t8 * g__XO + 1) / t14 * p__XO * t8 * (t5 * (t1 - t2 + 1) * retrograde__XO + 2 * t8 * k__XO * h__XO);
  }
  ...
  gtocX_2burn::zPosition_D_4_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return 4 / t22 / t21 / (t6 * f__XO + t10 * g__XO + 1) * p__XO * (-3 * t6 * (t2 - t3 / 3 - 1.0 / 3.0) * retrograde__XO * k__XO + (t2 - 3 * t3 - 3) * t10 * h__XO);
  }
  ...
  gtocX_2burn::zPosition_D_5_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t22  = t21 * t21;
    return -4 / t22 / t21 / (t6 * f__XO + t10 * g__XO + 1) * p__XO * (-3 * t6 * k__XO * (t1 - t2 / 3 + 1) * retrograde__XO + (t1 - 3 * t2 + 1) * t10 * h__XO);
  }
  ...
  gtocX_2burn::xVelocity( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return -1.0 / (t1 + t2 + 1) / t20 * t18 * (t4 * (t1 - t2 + 1) - 2 * t7 * f__XO * h__XO - 2 * t7 * h__XO * t10 + t1 * g__XO - t2 * g__XO + g__XO);
  }
  ...
  gtocX_2burn::xVelocity_D_2( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t8   = h__XO * h__XO;
    real_type t9   = k__XO * k__XO;
    return 2 / (t8 + t9 + 1) / t5 * t4 * h__XO * k__XO * retrograde__XO;
  }
  ...
  gtocX_2burn::xVelocity_D_2_7( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t7   = h__XO * h__XO;
    real_type t8   = k__XO * k__XO;
    return 2 / (t7 + t8 + 1) / t4 * t3 * h__XO * k__XO;
  }
  ...
  gtocX_2burn::xVelocity_D_4_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t5   = k__XO * k__XO;
    real_type t8   = cos(L__XO);
    real_type t13  = t5 * k__XO;
    real_type t15  = sin(L__XO);
    real_type t18  = f__XO * h__XO;
    real_type t32  = sqrt(ModelPars[0]);
    real_type t34  = t4 + t5 + 1;
    real_type t35  = t34 * t34;
    return 4 / t35 / t34 * k__XO * t32 * (t8 * (t4 - 3 * t5 - 3) * retrograde__XO * h__XO + t15 * (3 * k__XO * t4 - k__XO - t13) - t13 * g__XO - 3 * retrograde__XO * t5 * t18 + k__XO * (3 * t4 * g__XO - g__XO) + (t4 - 3) * retrograde__XO * t18) / t1;
  }
  ...
  gtocX_2burn::xVelocity_D_4_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return -2 / t43 / t42 * t41 * (t11 * (-6 * t5 * t3 + t4 + t8 - 1) * retrograde__XO + 4 * t15 * (t3 - t5 + 1) * k__XO * h__XO + retrograde__XO * t4 * f__XO + 4 * k__XO * t3 * h__XO * g__XO - 6 * retrograde__XO * t5 * t3 * f__XO + h__XO * (-4 * t5 * k__XO * g__XO + 4 * g__XO * k__XO) + retrograde__XO * t8 * f__XO - f__XO * retrograde__XO) / t1;
  }
  ...
  gtocX_2burn::xVelocity_D_4_6( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return 2 / t19 * t16 * (t8 * (t4 - t5 - 1) * retrograde__XO - 2 * t10 * k__XO * h__XO) / t1 * k__XO;
  }
  ...
  gtocX_2burn::yVelocity_D_1_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return 2 / t32 * t30 * (-t8 * (t4 - t5 - 1) * k__XO / 2 + (t5 + 1) * t12 * retrograde__XO * h__XO + t5 * k__XO * g__XO / 2 + retrograde__XO * t5 * t19 + k__XO * (-t4 * g__XO / 2 + g__XO / 2) + retrograde__XO * t19) / t1 / p__XO;
  }
  ...
  gtocX_2burn::yVelocity_D_2_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return 4 / t11 / t6 * t5 * retrograde__XO * k__XO * t1;
  }
  ...
  gtocX_2burn::yVelocity_D_3_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return -2 * h__XO / t10 / t7 * t5 * (t1 - t2 + 1);
  }
  ...
  gtocX_2burn::yVelocity_D_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return -4 / t31 * t29 * (-t7 * (t3 - t4 - 1) * k__XO / 2 + (t4 + 1) * t11 * retrograde__XO * h__XO + t4 * k__XO * g__XO / 2 + retrograde__XO * t4 * t18 + k__XO * (-t3 * g__XO / 2 + g__XO / 2) + retrograde__XO * t18) / t1;
  }
  ...
  gtocX_2burn::yVelocity_D_4_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t35  = sqrt(p__XO);
    real_type t39  = sqrt(ModelPars[0]);
    real_type t40  = t4 + t1 + 1;
    real_type t41  = t40 * t40;
    return 12 / t41 / t40 * t39 / t35 * (t7 * (t4 - t1 / 3 - 1.0 / 3.0) * retrograde__XO * (t1 + 1) - t13 * (t4 - 3 * t1 - 3) * k__XO * h__XO / 3 - retrograde__XO * t17 * f__XO / 3 + t1 * k__XO * t21 + t1 * (t4 - 2.0 / 3.0) * t24 - k__XO * (t4 - 3) * t21 / 3 + (t4 - 1.0 / 3.0) * t24);
  }
  ...
  gtocX_2burn::yVelocity_D_5_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t37  = t5 + t6 + 1;
    real_type t38  = t37 * t37;
    return 4 / t38 / t37 * t35 * (t9 * (t5 - 3 * t6 + 1) * h__XO * retrograde__XO + t17 * (3 * k__XO * t5 - t6 * k__XO + 3 * k__XO) + retrograde__XO * t5 * h__XO * f__XO + 3 * k__XO * t5 * g__XO - 3 * h__XO * (t6 - 1.0 / 3.0) * retrograde__XO * f__XO - (t6 - 3) * k__XO * g__XO) * h__XO / t1;
  }
  ...
  gtocX_2burn::zVelocity_D_3( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t7   = h__XO * h__XO;
    real_type t8   = k__XO * k__XO;
    return 2 / (t7 + t8 + 1) / t4 * t3 * k__XO * retrograde__XO;
  }
  ...
  gtocX_2burn::zVelocity_D_3_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t8   = k__XO * k__XO;
    real_type t10  = pow(t7 + t8 + 1, 2);
    return -4 * h__XO / t10 / t5 * t3 * retrograde__XO * k__XO;
  }
  ...
  gtocX_2burn::zVelocity_D_4_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return 4 / t36 / t35 * t34 * (t8 * (t3 - 3 * t4 - 3) * h__XO + 3 * t13 * k__XO * (t3 - t4 / 3 - 1.0 / 3.0) * retrograde__XO + t3 * h__XO * f__XO + 3 * k__XO * retrograde__XO * t3 * g__XO + h__XO * (-3 * t4 * f__XO - 3 * f__XO) - (t4 + 1) * retrograde__XO * g__XO * k__XO) / t1;
  }
  ...
  gtocX_2burn::zVelocity_D_4_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t36  = t35 * t35;
    return 12 / t36 / t35 * t34 / t30 * (t6 * k__XO * (t1 - t2 / 3 - 1.0 / 3.0) - (t1 - 3 * t2 + 1) * t9 * retrograde__XO * h__XO / 3 - retrograde__XO * t1 * h__XO * g__XO / 3 + k__XO * t1 * f__XO + h__XO * (t2 - 1.0 / 3.0) * g__XO * retrograde__XO - (t2 + 1) * k__XO * f__XO / 3);
  }
  ...
  gtocX_2burn::zVelocity_D_5_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    real_type t35  = t3 + t4 + 1;
    real_type t36  = t35 * t35;
    return -4 / t36 / t35 * t34 * (t8 * (t3 - 3 * t4 + 1) * h__XO + 3 * t13 * k__XO * (t3 - t4 / 3 + 1) * retrograde__XO + t3 * h__XO * f__XO + 3 * k__XO * retrograde__XO * t3 * g__XO + h__XO * (-3 * t4 * f__XO + f__XO) - (t4 - 3) * retrograde__XO * g__XO * k__XO) / t1;
  }
  ...
  gtocX_2burn::zVelocity_D_5_6( real_type p__XO, real_type f__XO, real_type g__XO, real_type h__XO, real_type k__XO, real_type L__XO, real_type retrograde__XO ) const {
    ...
    return 2 / t18 * t16 * (t7 * (t3 - t4 + 1) * retrograde__XO + 2 * t10 * k__XO * h__XO) / t1;
  }
  ...
  gtocX_2burn::ray_D_3_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type L__XO ) const {
    ...
    real_type t25  = 3 * t13;
    return 1.0 / (t2 * t1 * (t11 * f__XO - 3 * t13 * f__XO) + t2 * (t4 * (3 * g__XO * t11 - t21) + 3 * t11 - t25) + 3 * t1 * (t13 + 2 * t5 + 1) * f__XO + t4 * (t21 + 3 * g__XO) + t25 + 1) * (f__XO * t2 + t1 * (t5 - 1) - 2 * f__XO) * p__XO;
  }
  ...
  gtocX_2burn::ray_D_4_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type L__XO ) const {
    ...
    real_type t29  = 3 * t2;
    return -1.0 / (t5 * t4 * (t1 * f__XO - 3 * f__XO * t2) + t5 * (t8 * (3 * t1 * g__XO - t25) + 3 * t1 - t29) + 3 * t4 * (t2 + 2 * t14 + 1) * f__XO + t8 * (t25 + 3 * g__XO) + t29 + 1) * (t5 * (t1 - t2) + t4 * (2 * t8 * g__XO * f__XO - f__XO) - 2 * t1 - t2 - t14) * p__XO;
  }
  ...
  gtocX_2burn::vel_D_2_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type L__XO, real_type muS__XO ) const {
    ...
    real_type t9   = g__XO * g__XO;
    real_type t18  = f__XO * f__XO;
    real_type t19  = 2 * t2 * f__XO + 2 * t5 * g__XO + t18 + t9 + 1;
    real_type t20  = sqrt(t19);
    real_type t23  = sqrt(p__XO);
    return -1.0 / t23 / t20 / t19 * (-g__XO * t3 + t2 * (t5 + g__XO) * f__XO + t9 * t5 + 2 * g__XO + t5) * t1;
  }
  ...
  gtocX_2burn::vel_D_3_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type L__XO, real_type muS__XO ) const {
    ...
    real_type t13  = f__XO * f__XO;
    real_type t14  = g__XO * g__XO;
    real_type t16  = sqrt(2 * t8 * f__XO + 2 * g__XO * t3 + t13 + t14 + 1);
  ...
  gtocX_2burn::vel_D_4_4( real_type p__XO, real_type f__XO, real_type g__XO, real_type L__XO, real_type muS__XO ) const {
    ...
    real_type t2   = cos(L__XO);
    real_type t5   = sin(L__XO);
    real_type t7   = 2 * t5 * g__XO;
    real_type t8   = f__XO * f__XO;
    real_type t9   = g__XO * g__XO;
    real_type t10  = 2 * t2 * f__XO + t7 + t8 + t9 + 1;
    real_type t11  = sqrt(t10);
    real_type t16  = t2 * t2;
    real_type t26  = sqrt(p__XO);
    return -1.0 / t26 * (t16 * (t8 - t9) + t2 * (t8 + t9 + t7 + 1) * f__XO + t5 * (t8 + t9 + 1) * g__XO + t8 + 2 * t9) / t11 / t10 * t1;
  }
  ...
  gtocX_2burn::vel_D_4_5( real_type p__XO, real_type f__XO, real_type g__XO, real_type L__XO, real_type muS__XO ) const {
    ...
    real_type t15  = f__XO * f__XO;
    real_type t16  = g__XO * g__XO;
    real_type t18  = sqrt(2 * t5 * f__XO + 2 * g__XO * t3 + t15 + t16 + 1);
    return 1.0 / t18 / t9 * (-t3 * f__XO + t5 * g__XO) / t1 / 2;
  }
