...
#define MAP_PROBLEM map< string, PointMassCarModel_1_Problem * >
...
namespace PointMassCarModel_1Define {
  ...
  mrb_PointMassCarModel_1_ocp_setup( mrb_state *mrb, mrb_value self ) {
    ...
    if ( !mrb_string_p(id_value) )  {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "PointMassCarModel_1_ocp_setup, missing first parameter or is nota a string (id)\n"
      );
    }
    if ( mrb_nil_p(data_value) )  {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "PointMassCarModel_1_ocp_setup, missing second parameter (data)\n"
      );
    }
    ...
    if ( it == problems.end() ) {
      problems[id] = new PointMassCarModel_1_Problem( pTP, pConsole );
  ...
  POINTMASSCARMODEL_1_API_DLL
  mrb_value
  mrb_PointMassCarModel_1_ocp_guess( mrb_state *mrb, mrb_value self ) {
    ...
    if ( !mrb_string_p(id_value) )  {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "PointMassCarModel_1_ocp_guess, missing first parameter or is not a string (id)\n"
      );
    }
    if ( mrb_nil_p(data_value) )  {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "PointMassCarModel_1_ocp_guess, missing second parameter (data)\n"
      );
    }
    ...
    if ( it == problems.end() ) {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "PointMassCarModel_1_ocp_guess, you must do setup first!\n"
      );
    } else {
      // to C++ parameters
      GenericContainer gc_data;
      ...
      it->second->guess(
        gc_data(
          "Guess",
          "mrb_PointMassCarModel_1_ocp_guess Missing field `Guess`"
        )
      );
    }
  ...
  POINTMASSCARMODEL_1_API_DLL
  mrb_value
  mrb_PointMassCarModel_1_ocp_solve( mrb_state *mrb, mrb_value self ) {
    ...
    if ( !mrb_string_p(id_value) )  {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "PointMassCarModel_1_ocp_solve, missing first parameter or is not a string (id)\n"
      );
    }
    if ( mrb_nil_p(data_value) )  {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "PointMassCarModel_1_ocp_solve, missing second parameter (data)\n"
      );
    }
    ...
    if ( it == problems.end() ) {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "PointMassCarModel_1_ocp_solve, you must do setup first!\n"
      );
    } else {
      // to C++ parameters
      GenericContainer gc_data;
      ...
      if ( !ok )
        pConsole->error( "PointMassCarModel_1_ocp_solve, solution failed!\n" );
  ...
  POINTMASSCARMODEL_1_API_DLL
  mrb_value
  mrb_PointMassCarModel_1_write_ocp_solution( mrb_state *mrb, mrb_value self ) {
    mrb_value a_string;
    ...
    MAP_PROBLEM::const_iterator it = problems.find(id);
    if ( it == problems.end() ) {
      pConsole->error( "PointMassCarModel_1_ocp_write_to_file, no solution found!\n" );
    } else {
  ...
  POINTMASSCARMODEL_1_API_DLL
  mrb_value
  mrb_PointMassCarModel_1_ocp_solution_range( mrb_state *mrb, mrb_value self ) {
  ...
  POINTMASSCARMODEL_1_API_DLL
  mrb_value
  mrb_PointMassCarModel_1_ocp_eval_solution( mrb_state *mrb, mrb_value self ) {
  ...
  POINTMASSCARMODEL_1_API_DLL
  void
  mrb_libPointMassCarModel_1_gem_init(mrb_state* mrb) {
    ...
    mrb_define_const(
      ...
      ocp_class,
      "NAME",
      mrb_str_new_cstr(mrb, "PointMassCarModel_1")
    );
    ...
    mrb_define_method(
      ...
      ocp_class,
      "setup",
      mrb_PointMassCarModel_1_ocp_setup,
      MRB_ARGS_NONE()
    );
    ...
    mrb_define_method(
      ...
      ocp_class,
      "guess",
      mrb_PointMassCarModel_1_ocp_guess,
      MRB_ARGS_NONE()
    );
    ...
    mrb_define_method(
      ...
      ocp_class,
      "solve",
      mrb_PointMassCarModel_1_ocp_solve,
      MRB_ARGS_NONE()
    );
    ...
    mrb_define_method(
      ...
      ocp_class,
      "write_ocp_solution",
      mrb_PointMassCarModel_1_write_ocp_solution,
      MRB_ARGS_REQ(1)
    );
    ...
    mrb_define_method(
      ...
      ocp_class,
      "eval_solution",
      mrb_PointMassCarModel_1_ocp_eval_solution,
      MRB_ARGS_REQ(2)
    );
    ...
    mrb_define_method(
      ...
      ocp_class,
      "solution_range",
      mrb_PointMassCarModel_1_ocp_solution_range,
      MRB_ARGS_REQ(1)
    );
  ...
  POINTMASSCARMODEL_1_API_DLL
  void
  mrb_libPointMassCarModel_1_gem_final(mrb_state* mrb)
  {
  }
}

// EOF: PointMassCarModel_1_dll_pins.cc
