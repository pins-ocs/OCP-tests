...
namespace PointMassCarModel_1Define {
  ...
  integer PointMassCarModel_1::bc_numEqns() const { return 6; }

  void
  PointMassCarModel_1::bc_eval(
    NodeQX const & LEFT__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_1::DbcDxxp_numRows() const { return 6; }
  integer PointMassCarModel_1::DbcDxxp_numCols() const { return 10; }
  integer PointMassCarModel_1::DbcDxxp_nnz()     const { return 11; }

  void
  PointMassCarModel_1::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  PointMassCarModel_1::DbcDxxp_sparse(
    NodeQX const & LEFT__,
    NodeQX const & RIGHT__,
    P_const_p_type P__,
    real_ptr       result__
    ...
    result__[ 10  ] = 1;
    if ( m_debug )
      Mechatronix::check_in_segment2( result__, "DbcDxxp_sparse", 11, i_segment_left, i_segment_right );
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_1::D2bcD2xxp_numRows() const { return 10; }
  integer PointMassCarModel_1::D2bcD2xxp_numCols() const { return 10; }
  integer PointMassCarModel_1::D2bcD2xxp_nnz()     const { return 0; }

  void
  PointMassCarModel_1::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  PointMassCarModel_1::D2bcD2xxp_sparse(
    NodeQX const &          LEFT__,
    NodeQX const &          RIGHT__,
    P_const_p_type          P__,
  ...
  integer PointMassCarModel_1::fd_BC_numEqns() const { return 10; }

  void
  PointMassCarModel_1::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_1::Dfd_BCDxlxlp_numRows() const { return 10; }
  integer PointMassCarModel_1::Dfd_BCDxlxlp_numCols() const { return 20; }
  integer PointMassCarModel_1::Dfd_BCDxlxlp_nnz()     const { return 10; }

  void
  PointMassCarModel_1::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  PointMassCarModel_1::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
