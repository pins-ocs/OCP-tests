...
namespace PointMassCarModel_1Define {
  ...
  void
  PointMassCarModel_1::p_guess_eval( P_p_type P__ ) const {
  }
  ...
  bool
  PointMassCarModel_1::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  PointMassCarModel_1::penalties_check_node(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
  ...
  PointMassCarModel_1::u_guess_eval(
    ...
    UGUESS__[ iU_v__fx    ] = v__OmegaControl.solve(-MU__[4] * ModelPars[iM_v__fx__max], -1, 1);
    UGUESS__[ iU_v__Omega ] = v__OmegaControl.solve(-MU__[3] * ModelPars[iM_v__Omega__max], -1, 1);
    if ( m_debug )
