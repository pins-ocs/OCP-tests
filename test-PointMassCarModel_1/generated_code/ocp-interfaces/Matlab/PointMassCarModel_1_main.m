%-----------------------------------------------------------------------%
%  file: PointMassCarModel_1_main.m                                     %
%                                                                       %
...
% create object
ocp = PointMassCarModel_1( 'PointMassCarModel_1' );
...
%ocp.setup(PointMassCarModel_1_data);
ocp.setup('../../data/PointMassCarModel_1_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%PointMassCarModel_1_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = PointMassCarModel_1_Mex('get_raw_solution',obj);
%J     = PointMassCarModel_1_Mex('eval_JF',obj,Z,MU,U);
%f     = PointMassCarModel_1_Mex('eval_F',obj,Z,MU,U);
