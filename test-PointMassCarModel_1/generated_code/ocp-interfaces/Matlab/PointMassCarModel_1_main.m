...
%ocp.setup('../../data/PointMassCarModel_1_Data.lua');
ocp.setup('../../data/PointMassCarModel_1_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = PointMassCarModel_1_Mex('get_raw_solution',obj);
%J     = PointMassCarModel_1_Mex('eval_JF',obj,Z,U);
%f     = PointMassCarModel_1_Mex('eval_F',obj,Z,U);
