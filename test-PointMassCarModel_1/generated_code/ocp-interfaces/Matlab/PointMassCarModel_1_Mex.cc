...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"inv_zeta__dot",&ProblemStorage::do_inv_zeta__dot},
  {"inv_zeta__dot_D_1",&ProblemStorage::do_inv_zeta__dot_D_1},
  {"inv_zeta__dot_D_2",&ProblemStorage::do_inv_zeta__dot_D_2},
  {"inv_zeta__dot_D_3",&ProblemStorage::do_inv_zeta__dot_D_3},
  {"inv_zeta__dot_D_4",&ProblemStorage::do_inv_zeta__dot_D_4},
  {"inv_zeta__dot_D_1_1",&ProblemStorage::do_inv_zeta__dot_D_1_1},
  {"inv_zeta__dot_D_1_2",&ProblemStorage::do_inv_zeta__dot_D_1_2},
  {"inv_zeta__dot_D_1_3",&ProblemStorage::do_inv_zeta__dot_D_1_3},
  {"inv_zeta__dot_D_1_4",&ProblemStorage::do_inv_zeta__dot_D_1_4},
  {"inv_zeta__dot_D_2_2",&ProblemStorage::do_inv_zeta__dot_D_2_2},
  {"inv_zeta__dot_D_2_3",&ProblemStorage::do_inv_zeta__dot_D_2_3},
  {"inv_zeta__dot_D_2_4",&ProblemStorage::do_inv_zeta__dot_D_2_4},
  {"inv_zeta__dot_D_3_3",&ProblemStorage::do_inv_zeta__dot_D_3_3},
  {"inv_zeta__dot_D_3_4",&ProblemStorage::do_inv_zeta__dot_D_3_4},
  {"inv_zeta__dot_D_4_4",&ProblemStorage::do_inv_zeta__dot_D_4_4}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "PointMassCarModel_1_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
