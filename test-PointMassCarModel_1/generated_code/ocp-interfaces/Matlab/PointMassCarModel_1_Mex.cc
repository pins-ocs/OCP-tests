...
"PointMassCarModel_1_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "PointMassCarModel_1"
#define MODEL_CLASS PointMassCarModel_1
...
public:
...

  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "PointMassCarModel_1_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "PointMassCarModel_1_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
...

  {
    ...
    try {
      ...
      string msg = fmt::format( "PointMassCarModel_1_Mex('eval_F',...) error: {}", exc.what() );
      mexWarnMsgTxt( msg.c_str() );
      ok = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "PointMassCarModel_1_Mex('eval_F',...) unkown error\n" );
      ok = false;
    }
...

  {
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "PointMassCarModel_1_Mex('eval_JF',...) error: {}", exc.what() ).c_str() );
      ok_value = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "PointMassCarModel_1_Mex('eval_JF',...) unkown error\n" );
      ok_value = false;
    }
    int ok = mexCallMATLAB( 1, &arg_out_0, 5, args, "sparse" );
    UTILS_MEX_ASSERT0( ok == 0, CMD "failed the call sparse(...)" );
...
do_inv_zeta__dot(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_4(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_4',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_4( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_1_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_1_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_1_4(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_1_4',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_1_4( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_2_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_2_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_2_4(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_2_4',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_2_4( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_3_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_3_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_3_3( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_3_4(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_3_4',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_3_4( nlhs, plhs, nrhs, prhs );
}
...
do_inv_zeta__dot_D_4_4(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('inv_zeta__dot_D_4_4',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_inv_zeta__dot_D_4_4( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"inv_zeta__dot",do_inv_zeta__dot},
  {"inv_zeta__dot_D_1",do_inv_zeta__dot_D_1},
  {"inv_zeta__dot_D_2",do_inv_zeta__dot_D_2},
  {"inv_zeta__dot_D_3",do_inv_zeta__dot_D_3},
  {"inv_zeta__dot_D_4",do_inv_zeta__dot_D_4},
  {"inv_zeta__dot_D_1_1",do_inv_zeta__dot_D_1_1},
  {"inv_zeta__dot_D_1_2",do_inv_zeta__dot_D_1_2},
  {"inv_zeta__dot_D_1_3",do_inv_zeta__dot_D_1_3},
  {"inv_zeta__dot_D_1_4",do_inv_zeta__dot_D_1_4},
  {"inv_zeta__dot_D_2_2",do_inv_zeta__dot_D_2_2},
  {"inv_zeta__dot_D_2_3",do_inv_zeta__dot_D_2_3},
  {"inv_zeta__dot_D_2_4",do_inv_zeta__dot_D_2_4},
  {"inv_zeta__dot_D_3_3",do_inv_zeta__dot_D_3_3},
  {"inv_zeta__dot_D_3_4",do_inv_zeta__dot_D_3_4},
  {"inv_zeta__dot_D_4_4",do_inv_zeta__dot_D_4_4},
  {"new",do_new},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "PointMassCarModel_1_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "PointMassCarModel_1_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
