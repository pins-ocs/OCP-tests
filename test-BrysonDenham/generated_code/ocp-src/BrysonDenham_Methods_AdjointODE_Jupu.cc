...
namespace BrysonDenhamDefine {
  ...
  integer BrysonDenham::JPxpu_numEqns() const { return 3; }

  void
  BrysonDenham::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer BrysonDenham::JUxpu_numEqns() const { return 3; }

  void
  BrysonDenham::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer BrysonDenham::LTxpu_numEqns() const { return 3; }

  void
  BrysonDenham::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
