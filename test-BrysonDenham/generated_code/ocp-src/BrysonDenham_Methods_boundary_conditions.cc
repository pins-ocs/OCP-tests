...
namespace BrysonDenhamDefine {
  ...
  integer BrysonDenham::bc_numEqns() const { return 4; }

  void
  BrysonDenham::bc_eval(
    NodeQX const & LEFT__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BrysonDenham::DbcDxxp_numRows() const { return 4; }
  integer BrysonDenham::DbcDxxp_numCols() const { return 4; }
  integer BrysonDenham::DbcDxxp_nnz()     const { return 4; }

  void
  BrysonDenham::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BrysonDenham::D2bcD2xxp_numRows() const { return 4; }
  integer BrysonDenham::D2bcD2xxp_numCols() const { return 4; }
  integer BrysonDenham::D2bcD2xxp_nnz()     const { return 0; }

  void
  BrysonDenham::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BrysonDenham::D2bcD2xxp_sparse(
    NodeQX const &          LEFT__,
    NodeQX const &          RIGHT__,
    P_const_p_type          P__,
  ...
  integer BrysonDenham::fd_BC_numEqns() const { return 4; }

  void
  BrysonDenham::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BrysonDenham::Dfd_BCDxlxlp_numRows() const { return 4; }
  integer BrysonDenham::Dfd_BCDxlxlp_numCols() const { return 8; }
  integer BrysonDenham::Dfd_BCDxlxlp_nnz()     const { return 4; }

  void
  BrysonDenham::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  BrysonDenham::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
