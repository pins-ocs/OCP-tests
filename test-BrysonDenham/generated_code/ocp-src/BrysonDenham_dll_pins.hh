...
namespace BrysonDenhamDefine {
  ...
  using namespace BrysonDenhamLoad;
  ...
  class BrysonDenham_Problem {
    ...
    BrysonDenham_Problem( BrysonDenham_Problem const & );
    BrysonDenham_Problem const & operator = ( BrysonDenham_Problem const & );
  ...
  public:
    ...
    BrysonDenham_Problem( integer n_threads, Console const * console )
    : model("BrysonDenham",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "BrysonDenham::solver, fatal: unknown error";
      }
      return ok;
    }
