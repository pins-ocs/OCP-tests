...
namespace BrysonDenhamDefine {
  ...
  void
  BrysonDenham::p_guess_eval( P_p_type P__ ) const {
  }

  void
  BrysonDenham::xlambda_guess_eval(
    integer        i_segment,
    Q_const_p_type Q__,
    P_const_p_type P__,
    X_p_type       X__,
  ...
  bool
  BrysonDenham::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  BrysonDenham::xlambda_check_node(
    integer         ipos,
  ...
  bool
  BrysonDenham::penalties_check_node(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
