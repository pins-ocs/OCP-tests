...
ocp.setup( [DATA_PATH 'BrysonDenham_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = BrysonDenham_Mex('get_raw_solution',obj);
%J        = BrysonDenham_Mex('eval_JF',obj,Z,MU,U);
%f        = BrysonDenham_Mex('eval_F',obj,Z,MU,U);
