...
%ocp.setup('../../data/BrysonDenham_Data.lua');
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%BrysonDenham_Mex('set_tracked',obj,tracked);
...
%[Z,U] = BrysonDenham_Mex('get_raw_solution',obj);
%J     = BrysonDenham_Mex('eval_JF',obj,Z,U);
%f     = BrysonDenham_Mex('eval_F',obj,Z,U);
