/*-----------------------------------------------------------------------*\
 |  file: ICLOCS_TwoLinkRobotArm_dll_pins.hh                             |
 |                                                                       |
...
namespace ICLOCS_TwoLinkRobotArmDefine {
  ...
  class ICLOCS_TwoLinkRobotArm_Problem {

    ICLOCS_TwoLinkRobotArm model;
    ...
    ICLOCS_TwoLinkRobotArm_Problem( ICLOCS_TwoLinkRobotArm_Problem const & );
    ICLOCS_TwoLinkRobotArm_Problem const & operator = ( ICLOCS_TwoLinkRobotArm_Problem const & );
  ...
  public:
    ...
    ICLOCS_TwoLinkRobotArm_Problem( ThreadPool * TP, Console const * console )
    : model("ICLOCS_TwoLinkRobotArm",TP,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "ICLOCS_TwoLinkRobotArm::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: ICLOCS_TwoLinkRobotArm_dll_pins.hh
