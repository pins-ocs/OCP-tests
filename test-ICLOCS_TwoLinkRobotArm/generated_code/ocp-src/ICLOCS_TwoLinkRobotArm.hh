...
#ifndef ICLOCS_TWOLINKROBOTARM_DOT_HH
#define ICLOCS_TWOLINKROBOTARM_DOT_HH
...
// User Header (end)
  ...
  #ifndef ICLOCS_TWOLINKROBOTARM_API_DLL
    #ifdef ICLOCS_TWOLINKROBOTARM_EXPORT
      #define ICLOCS_TWOLINKROBOTARM_API_DLL __declspec(dllexport)
    #elif defined(ICLOCS_TWOLINKROBOTARM_IMPORT)
      #define ICLOCS_TWOLINKROBOTARM_API_DLL __declspec(dllimport)
    #else
      #define ICLOCS_TWOLINKROBOTARM_API_DLL
    #endif
  #endif
...
namespace ICLOCS_TwoLinkRobotArmDefine {
  ...
  class ICLOCS_TwoLinkRobotArm : public Mechatronix::Discretized_Indirect_OCP {
  ...
  public:
    ...
    explicit
    ICLOCS_TwoLinkRobotArm(
      string const   & name,
      integer          n_threads,
      Console const  * console
    );

    ~ICLOCS_TwoLinkRobotArm() override;
...
namespace ICLOCS_TwoLinkRobotArmLoad {
  using ICLOCS_TwoLinkRobotArmDefine::ICLOCS_TwoLinkRobotArm;

}

#endif

// EOF: ICLOCS_TwoLinkRobotArm.hh
