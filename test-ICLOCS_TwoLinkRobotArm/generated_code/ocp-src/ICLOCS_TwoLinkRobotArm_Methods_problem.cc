...
namespace ICLOCS_TwoLinkRobotArmDefine {
  ...
  void
  ICLOCS_TwoLinkRobotArm::continuation_step_2( real_type s ) {
    real_type t2   = 1 - s;
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer ICLOCS_TwoLinkRobotArm::D2mayerD2xxp_numRows() const { return 9; }
  integer ICLOCS_TwoLinkRobotArm::D2mayerD2xxp_numCols() const { return 9; }
  integer ICLOCS_TwoLinkRobotArm::D2mayerD2xxp_nnz()     const { return 1; }

  void
  ICLOCS_TwoLinkRobotArm::D2mayerD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  integer ICLOCS_TwoLinkRobotArm::post_numEqns() const { return 3; }
  ...
  ICLOCS_TwoLinkRobotArm::post_eval(
    ...
    result__[ 2   ] = Q__[iQ_zeta] * P__[iP_T];
    // do not check
