...
namespace ICLOCS_TwoLinkRobotArmDefine {
  ...
  void
  ICLOCS_TwoLinkRobotArm::p_guess_eval( P_p_type P__ ) const {
  ...
  bool
  ICLOCS_TwoLinkRobotArm::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  ICLOCS_TwoLinkRobotArm::penalties_check_node(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
