...
namespace ICLOCS_TwoLinkRobotArmDefine {
  ...
  void
  ICLOCS_TwoLinkRobotArm::p_guess_eval( P_pointer_type P__ ) const {
  ...
  void
  ICLOCS_TwoLinkRobotArm::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  ICLOCS_TwoLinkRobotArm::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  ICLOCS_TwoLinkRobotArm::xlambda_check_node(
    integer              ipos,
  ...
  bool
  ICLOCS_TwoLinkRobotArm::xlambda_check_cell(
    integer              icell,
  ...
  bool
  ICLOCS_TwoLinkRobotArm::u_check_if_admissible(
    NodeType2 const    & NODE__,
