...
namespace ICLOCS_TwoLinkRobotArmDefine {
  ...
  integer
  ICLOCS_TwoLinkRobotArm::boundaryConditions_numEqns() const
  { return 8; }
  ...
  integer
  ICLOCS_TwoLinkRobotArm::DboundaryConditionsDxxp_numRows() const
  { return 8; }

  integer
  ICLOCS_TwoLinkRobotArm::DboundaryConditionsDxxp_numCols() const
  { return 9; }

  integer
  ICLOCS_TwoLinkRobotArm::DboundaryConditionsDxxp_nnz() const
  { return 8; }

  void
  ICLOCS_TwoLinkRobotArm::DboundaryConditionsDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  ICLOCS_TwoLinkRobotArm::DboundaryConditionsDxxp_sparse(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  ICLOCS_TwoLinkRobotArm::adjointBC_numEqns() const
  { return 9; }
  ...
  integer
  ICLOCS_TwoLinkRobotArm::DadjointBCDxxp_numRows() const
  { return 9; }

  integer
  ICLOCS_TwoLinkRobotArm::DadjointBCDxxp_numCols() const
  { return 9; }

  integer
  ICLOCS_TwoLinkRobotArm::DadjointBCDxxp_nnz() const
  { return 1; }

  void
  ICLOCS_TwoLinkRobotArm::DadjointBCDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
