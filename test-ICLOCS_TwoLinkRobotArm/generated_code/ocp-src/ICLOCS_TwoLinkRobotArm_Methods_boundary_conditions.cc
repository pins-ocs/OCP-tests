...
namespace ICLOCS_TwoLinkRobotArmDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer ICLOCS_TwoLinkRobotArm::DboundaryConditionsDxxp_numRows() const { return 8; }
  integer ICLOCS_TwoLinkRobotArm::DboundaryConditionsDxxp_numCols() const { return 9; }
  integer ICLOCS_TwoLinkRobotArm::DboundaryConditionsDxxp_nnz()     const { return 8; }

  void
  ICLOCS_TwoLinkRobotArm::DboundaryConditionsDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
