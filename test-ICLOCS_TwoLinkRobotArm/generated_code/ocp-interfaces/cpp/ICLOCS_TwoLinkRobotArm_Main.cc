...
main() {
  ...
  try {
    ICLOCS_TwoLinkRobotArm * m_model = new ICLOCS_TwoLinkRobotArm("ICLOCS_TwoLinkRobotArm",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/ICLOCS_TwoLinkRobotArm_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/ICLOCS_TwoLinkRobotArm_Data.lua";
    #endif
