...
%ocp.setup(ICLOCS_TwoLinkRobotArm_data);
%ocp.setup('../../data/ICLOCS_TwoLinkRobotArm_Data.lua');
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ICLOCS_TwoLinkRobotArm_Mex('set_tracked',obj,tracked);
...
%[Z,U] = ICLOCS_TwoLinkRobotArm_Mex('get_raw_solution',obj);
%J     = ICLOCS_TwoLinkRobotArm_Mex('eval_JF',obj,Z,U);
%f     = ICLOCS_TwoLinkRobotArm_Mex('eval_F',obj,Z,U);
