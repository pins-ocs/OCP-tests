...
namespace HangingChainDefine {
  ...
  integer
  HangingChain::DboundaryConditionsDx_numCols() const
  { return 4; }

  integer
  HangingChain::DboundaryConditionsDx_nnz() const
  { return 3; }

  void
  HangingChain::DboundaryConditionsDx_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  HangingChain::DboundaryConditionsDx_sparse(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  HangingChain::DboundaryConditionsDp_numCols() const
  { return 0; }

  integer
  HangingChain::DboundaryConditionsDp_nnz() const
  { return 0; }

  void
  HangingChain::DboundaryConditionsDp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  }
  ...
  void
  HangingChain::DboundaryConditionsDp_sparse(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  HangingChain::DadjointBCDx_numCols() const
  { return 4; }

  integer
  HangingChain::DadjointBCDx_nnz() const
  { return 1; }

  void
  HangingChain::DadjointBCDx_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  HangingChain::DadjointBCDx_sparse(
    NodeType2 const             & LEFT__,
    NodeType2 const             & RIGHT__,
    P_const_pointer_type          P__,
    OMEGA_full_const_pointer_type OMEGA__,
  ...
  integer
  HangingChain::DadjointBCDp_numCols() const
  { return 0; }

  integer
  HangingChain::DadjointBCDp_nnz() const
  { return 0; }

  void
  HangingChain::DadjointBCDp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  }
  ...
  void
  HangingChain::DadjointBCDp_sparse(
    NodeType2 const             & LEFT__,
    NodeType2 const             & RIGHT__,
    P_const_pointer_type          P__,
    OMEGA_full_const_pointer_type OMEGA__,
