...
%ocp.setup(HangingChain_data);
ocp.setup('../../data/HangingChain_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%HangingChain_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = HangingChain_Mex('get_raw_solution',obj);
%J     = HangingChain_Mex('eval_JF',obj,Z,MU,U);
%f     = HangingChain_Mex('eval_F',obj,Z,MU,U);
