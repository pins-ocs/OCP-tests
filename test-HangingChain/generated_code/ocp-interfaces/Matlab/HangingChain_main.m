...
%ocp.setup('../../data/HangingChain_Data.lua');
ocp.setup('../../data/HangingChain_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = HangingChain_Mex('get_raw_solution',obj);
%J     = HangingChain_Mex('eval_JF',obj,Z,U);
%f     = HangingChain_Mex('eval_F',obj,Z,U);
