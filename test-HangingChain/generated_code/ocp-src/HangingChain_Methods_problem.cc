...
namespace HangingChainDefine {
  ...
  integer HangingChain::DsegmentLinkDxxp_numRows() const { return 0; }
  integer HangingChain::DsegmentLinkDxxp_numCols() const { return 0; }
  integer HangingChain::DsegmentLinkDxxp_nnz() const { return 0; }

  void
  HangingChain::DsegmentLinkDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  HangingChain::DsegmentLinkDxxp_sparse(
    NodeQX const & L,
    NodeQX const & R,
    P_const_p_type p,
