...
namespace HangingChainDefine {
  ...
  integer HangingChain::fd_ode_numEqns() const { return 2; }

  void
  HangingChain::fd_ode_eval(
  ...
  integer HangingChain::Dfd_odeDxxup_nnz()     const { return 4; }
  ...
  integer HangingChain::D2fd_odeD2xxup_nnz()     const { return 0; }
