...
namespace HangingChainDefine {
  ...
  integer HangingChain::JPxpu_numEqns() const { return 3; }

  void
  HangingChain::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer HangingChain::JUxpu_numEqns() const { return 3; }

  void
  HangingChain::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer HangingChain::LTxpu_numEqns() const { return 3; }

  void
  HangingChain::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
