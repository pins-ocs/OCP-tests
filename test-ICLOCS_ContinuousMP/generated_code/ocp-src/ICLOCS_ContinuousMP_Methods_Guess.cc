...
namespace ICLOCS_ContinuousMPDefine {
  ...
  bool
  ICLOCS_ContinuousMP::penalties_check(
    NodeQX const & NODE__,
    P_const_p_type P__
  ) const {
    ...
    ok = ok && u1Limitation_min.check_range(-10 - t1);
    ok = ok && u1Limitation_max.check_range(t1 - 10);
    real_type t4   = P__[iP_u2];
    ok = ok && u2Limitation_min.check_range(-10 - t4);
    ok = ok && u2Limitation_max.check_range(t4 - 10);
    real_type t7   = P__[iP_u3];
    ok = ok && u3Limitation_min.check_range(-10 - t7);
    ok = ok && u3Limitation_max.check_range(t7 - 10);
    real_type t10  = P__[iP_u4];
    ok = ok && u4Limitation_min.check_range(-10 - t10);
    ok = ok && u4Limitation_max.check_range(t10 - 10);
    real_type t13  = P__[iP_u5];
    ok = ok && u5Limitation_min.check_range(-10 - t13);
    ok = ok && u5Limitation_max.check_range(t13 - 10);
    real_type t16  = P__[iP_u6];
    ok = ok && u6Limitation_min.check_range(-10 - t16);
    ok = ok && u6Limitation_max.check_range(t16 - 10);
    real_type t19  = P__[iP_u7];
    ok = ok && u7Limitation_min.check_range(-10 - t19);
    ok = ok && u7Limitation_max.check_range(t19 - 10);
    real_type t22  = P__[iP_u8];
    ok = ok && u8Limitation_min.check_range(-10 - t22);
    ok = ok && u8Limitation_max.check_range(t22 - 10);
    real_type t25  = P__[iP_u9];
    ok = ok && u9Limitation_min.check_range(-10 - t25);
    ok = ok && u9Limitation_max.check_range(t25 - 10);
    real_type t28  = P__[iP_u10];
    ok = ok && u10Limitation_min.check_range(-10 - t28);
    ok = ok && u10Limitation_max.check_range(t28 - 10);
    real_type t31  = P__[iP_u11];
    ok = ok && u11Limitation_min.check_range(-10 - t31);
    ok = ok && u11Limitation_max.check_range(t31 - 10);
    real_type t34  = P__[iP_u12];
    ok = ok && u12Limitation_min.check_range(-10 - t34);
    ok = ok && u12Limitation_max.check_range(t34 - 10);
    real_type t37  = P__[iP_u13];
    ok = ok && u13Limitation_min.check_range(-10 - t37);
    ok = ok && u13Limitation_max.check_range(t37 - 10);
    real_type t40  = P__[iP_u14];
    ok = ok && u14Limitation_min.check_range(-10 - t40);
    ok = ok && u14Limitation_max.check_range(t40 - 10);
    real_type t43  = P__[iP_u15];
    ok = ok && u15Limitation_min.check_range(-10 - t43);
    ok = ok && u15Limitation_max.check_range(t43 - 10);
    real_type t46  = P__[iP_u16];
    ok = ok && u16Limitation_min.check_range(-10 - t46);
    ok = ok && u16Limitation_max.check_range(t46 - 10);
    real_type t49  = P__[iP_u17];
    ok = ok && u17Limitation_min.check_range(-10 - t49);
    ok = ok && u17Limitation_max.check_range(t49 - 10);
    real_type t52  = P__[iP_u18];
    ok = ok && u18Limitation_min.check_range(-10 - t52);
    ok = ok && u18Limitation_max.check_range(t52 - 10);
    real_type t55  = P__[iP_u19];
    ok = ok && u19Limitation_min.check_range(-10 - t55);
    ok = ok && u19Limitation_max.check_range(t55 - 10);
    real_type t58  = P__[iP_u20];
    ok = ok && u20Limitation_min.check_range(-10 - t58);
    ok = ok && u20Limitation_max.check_range(t58 - 10);
    real_type t61  = ModelPars[iM_xy_bound];
    real_type t62  = X__[iX_xx1];
    ok = ok && xx1Limitation_min.check_range(-t61 - t62);
    ok = ok && xx1Limitation_max.check_range(t62 - t61);
    real_type t65  = X__[iX_yy1];
    ok = ok && yy1Limitation_min.check_range(-t61 - t65);
    ok = ok && yy1Limitation_max.check_range(t65 - t61);
    real_type t68  = X__[iX_xx2];
    ok = ok && xx2Limitation_min.check_range(-t61 - t68);
    ok = ok && xx2Limitation_max.check_range(t68 - t61);
    real_type t71  = X__[iX_yy2];
    ok = ok && yy2Limitation_min.check_range(-t61 - t71);
    ok = ok && yy2Limitation_max.check_range(t71 - t61);
    real_type t74  = X__[iX_xx3];
    ok = ok && xx3Limitation_min.check_range(-t61 - t74);
    ok = ok && xx3Limitation_max.check_range(t74 - t61);
    real_type t77  = X__[iX_yy3];
    ok = ok && yy3Limitation_min.check_range(-t61 - t77);
    ok = ok && yy3Limitation_max.check_range(t77 - t61);
    real_type t80  = X__[iX_xx4];
    ok = ok && xx4Limitation_min.check_range(-t61 - t80);
    ok = ok && xx4Limitation_max.check_range(t80 - t61);
    real_type t83  = X__[iX_yy4];
    ok = ok && yy4Limitation_min.check_range(-t61 - t83);
    ok = ok && yy4Limitation_max.check_range(t83 - t61);
    real_type t86  = X__[iX_xx5];
    ok = ok && xx5Limitation_min.check_range(-t61 - t86);
    ok = ok && xx5Limitation_max.check_range(t86 - t61);
    real_type t89  = X__[iX_yy5];
    ok = ok && yy5Limitation_min.check_range(-t61 - t89);
    ok = ok && yy5Limitation_max.check_range(t89 - t61);
    real_type t92  = X__[iX_xx6];
    ok = ok && xx6Limitation_min.check_range(-t61 - t92);
    ok = ok && xx6Limitation_max.check_range(t92 - t61);
    real_type t95  = X__[iX_yy6];
    ok = ok && yy6Limitation_min.check_range(-t61 - t95);
    ok = ok && yy6Limitation_max.check_range(t95 - t61);
    real_type t98  = X__[iX_xx7];
    ok = ok && xx7Limitation_min.check_range(-t61 - t98);
    ok = ok && xx7Limitation_max.check_range(t98 - t61);
    real_type t101 = X__[iX_yy7];
    ok = ok && yy7Limitation_min.check_range(-t61 - t101);
    ok = ok && yy7Limitation_max.check_range(t101 - t61);
    real_type t104 = X__[iX_xx8];
    ok = ok && xx8Limitation_min.check_range(-t61 - t104);
    ok = ok && xx8Limitation_max.check_range(t104 - t61);
    real_type t107 = X__[iX_yy8];
    ok = ok && yy8Limitation_min.check_range(-t61 - t107);
    ok = ok && yy8Limitation_max.check_range(t107 - t61);
    real_type t110 = X__[iX_xx9];
    ok = ok && xx9Limitation_min.check_range(-t61 - t110);
    ok = ok && xx9Limitation_max.check_range(t110 - t61);
    real_type t113 = X__[iX_yy9];
    ok = ok && yy9Limitation_min.check_range(-t61 - t113);
    ok = ok && yy9Limitation_max.check_range(t113 - t61);
    real_type t116 = X__[iX_xx10];
    ok = ok && xx10Limitation_min.check_range(-t61 - t116);
    ok = ok && xx10Limitation_max.check_range(t116 - t61);
    real_type t119 = X__[iX_yy10];
    ok = ok && yy10Limitation_min.check_range(-t61 - t119);
    ok = ok && yy10Limitation_max.check_range(t119 - t61);
    real_type t122 = X__[iX_xx11];
    ok = ok && xx11Limitation_min.check_range(-t61 - t122);
    ok = ok && xx11Limitation_max.check_range(t122 - t61);
    real_type t125 = X__[iX_yy11];
    ok = ok && yy11Limitation_min.check_range(-t61 - t125);
    ok = ok && yy11Limitation_max.check_range(t125 - t61);
    real_type t128 = X__[iX_xx12];
    ok = ok && xx12Limitation_min.check_range(-t61 - t128);
    ok = ok && xx12Limitation_max.check_range(t128 - t61);
    real_type t131 = X__[iX_yy12];
    ok = ok && yy12Limitation_min.check_range(-t61 - t131);
    ok = ok && yy12Limitation_max.check_range(t131 - t61);
    real_type t134 = X__[iX_xx13];
    ok = ok && xx13Limitation_min.check_range(-t61 - t134);
    ok = ok && xx13Limitation_max.check_range(t134 - t61);
    real_type t137 = X__[iX_yy13];
    ok = ok && yy13Limitation_min.check_range(-t61 - t137);
    ok = ok && yy13Limitation_max.check_range(t137 - t61);
    real_type t140 = X__[iX_xx14];
    ok = ok && xx14Limitation_min.check_range(-t61 - t140);
    ok = ok && xx14Limitation_max.check_range(t140 - t61);
    real_type t143 = X__[iX_yy14];
    ok = ok && yy14Limitation_min.check_range(-t61 - t143);
    ok = ok && yy14Limitation_max.check_range(t143 - t61);
    real_type t146 = X__[iX_xx15];
    ok = ok && xx15Limitation_min.check_range(-t61 - t146);
    ok = ok && xx15Limitation_max.check_range(t146 - t61);
    real_type t149 = X__[iX_yy15];
    ok = ok && yy15Limitation_min.check_range(-t61 - t149);
    ok = ok && yy15Limitation_max.check_range(t149 - t61);
    real_type t152 = X__[iX_xx16];
    ok = ok && xx16Limitation_min.check_range(-t61 - t152);
    ok = ok && xx16Limitation_max.check_range(t152 - t61);
    real_type t155 = X__[iX_yy16];
    ok = ok && yy16Limitation_min.check_range(-t61 - t155);
    ok = ok && yy16Limitation_max.check_range(t155 - t61);
    real_type t158 = X__[iX_xx17];
    ok = ok && xx17Limitation_min.check_range(-t61 - t158);
    ok = ok && xx17Limitation_max.check_range(t158 - t61);
    real_type t161 = X__[iX_yy17];
    ok = ok && yy17Limitation_min.check_range(-t61 - t161);
    ok = ok && yy17Limitation_max.check_range(t161 - t61);
    real_type t164 = X__[iX_xx18];
    ok = ok && xx18Limitation_min.check_range(-t61 - t164);
    ok = ok && xx18Limitation_max.check_range(t164 - t61);
    real_type t167 = X__[iX_yy18];
    ok = ok && yy18Limitation_min.check_range(-t61 - t167);
    ok = ok && yy18Limitation_max.check_range(t167 - t61);
    real_type t170 = X__[iX_xx19];
    ok = ok && xx19Limitation_min.check_range(-t61 - t170);
    ok = ok && xx19Limitation_max.check_range(t170 - t61);
    real_type t173 = X__[iX_yy19];
    ok = ok && yy19Limitation_min.check_range(-t61 - t173);
    ok = ok && yy19Limitation_max.check_range(t173 - t61);
    real_type t176 = X__[iX_xx20];
    ok = ok && xx20Limitation_min.check_range(-t61 - t176);
    ok = ok && xx20Limitation_max.check_range(t176 - t61);
    real_type t179 = X__[iX_yy20];
    ok = ok && yy20Limitation_min.check_range(-t61 - t179);
    ok = ok && yy20Limitation_max.check_range(t179 - t61);
    return ok;
  }
