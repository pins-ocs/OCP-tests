/*-----------------------------------------------------------------------*\
 |  file: ICLOCS_ContinuousMP_dll_ruby.hh                                |
 |                                                                       |
...
namespace ICLOCS_ContinuousMPDefine {
  ...
  class ICLOCS_ContinuousMP_Problem {

    ICLOCS_ContinuousMP model;

    // user defined Object instances (external)
    MeshStd    mesh;

    // block copy constructor
    ICLOCS_ContinuousMP_Problem( ICLOCS_ContinuousMP_Problem const & );
    ICLOCS_ContinuousMP_Problem const & operator = ( ICLOCS_ContinuousMP_Problem const & );
  ...
  public:
    ...
    ICLOCS_ContinuousMP_Problem( integer n_threads, Console const * console )
    : model("ICLOCS_ContinuousMP",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "ICLOCS_ContinuousMP::solver, fatal: unknown error";
        ok    = false;
      }
      return ok;
    }
  ...
  */
  ...
  ICLOCS_CONTINUOUSMP_API_DLL
  bool
  ICLOCS_ContinuousMP_ocp_guess( char const id[], GenericContainer & gc_guess );
...
// EOF: ICLOCS_ContinuousMP_dll_ruby.hh
