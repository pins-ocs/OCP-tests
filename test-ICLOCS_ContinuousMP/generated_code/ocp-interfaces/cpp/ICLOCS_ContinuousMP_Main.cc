...
main() {
  ...
  try {
    ICLOCS_ContinuousMP * m_model = new ICLOCS_ContinuousMP("ICLOCS_ContinuousMP",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/ICLOCS_ContinuousMP_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/ICLOCS_ContinuousMP_Data.lua";
    #endif
