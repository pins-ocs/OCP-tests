%-----------------------------------------------------------------------%
%  file: ICLOCS_ContinuousMP_main.m                                     %
%                                                                       %
...
% create object
ocp = ICLOCS_ContinuousMP( 'ICLOCS_ContinuousMP' );
...
%ocp.setup(ICLOCS_ContinuousMP_data);
ocp.setup('../../data/ICLOCS_ContinuousMP_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ICLOCS_ContinuousMP_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = ICLOCS_ContinuousMP_Mex('get_raw_solution',obj);
%J     = ICLOCS_ContinuousMP_Mex('eval_JF',obj,Z,MU,U);
%f     = ICLOCS_ContinuousMP_Mex('eval_F',obj,Z,MU,U);
