...
%ocp.setup('../../data/ICLOCS_ContinuousMP_Data.lua');
ocp.setup('../../data/ICLOCS_ContinuousMP_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = ICLOCS_ContinuousMP_Mex('get_raw_solution',obj);
%J     = ICLOCS_ContinuousMP_Mex('eval_JF',obj,Z,U);
%f     = ICLOCS_ContinuousMP_Mex('eval_F',obj,Z,U);
