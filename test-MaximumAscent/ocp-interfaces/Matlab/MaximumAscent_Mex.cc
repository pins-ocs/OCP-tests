...
"MaximumAscent_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "MaximumAscent"
#define MODEL_CLASS MaximumAscent
...
public:
  ...
  do_eta(
    ...
    #define CMD MODEL_NAME "_Mex('eta', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->eta(arg0) );
    #undef CMD
  }
  ...
  do_eta_D(
    ...
    #define CMD MODEL_NAME "_Mex('eta_D', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->eta_D(arg0) );
    #undef CMD
  }
  void
  do_eta_DD(
    ...
    #define CMD MODEL_NAME "_Mex('eta_DD', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->eta_DD(arg0) );
    #undef CMD
  }
  ...
  do_Tbar(
    ...
    #define CMD MODEL_NAME "_Mex('Tbar', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->Tbar(arg0) );
    #undef CMD
  }
  ...
  do_Tbar_D(
    ...
    #define CMD MODEL_NAME "_Mex('Tbar_D', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->Tbar_D(arg0) );
    #undef CMD
  }
  void
  do_Tbar_DD(
    ...
    #define CMD MODEL_NAME "_Mex('Tbar_DD', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->Tbar_DD(arg0) );
    #undef CMD
  }
  ...
  do_tf(
    ...
    #define CMD MODEL_NAME "_Mex('tf', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->tf(arg0) );
    #undef CMD
  }
  ...
  do_tf_D(
    ...
    #define CMD MODEL_NAME "_Mex('tf_D', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->tf_D(arg0) );
    #undef CMD
  }
  void
  do_tf_DD(
    ...
    #define CMD MODEL_NAME "_Mex('tf_DD', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->tf_DD(arg0) );
    #undef CMD
  }
...
do_eta_D(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('eta_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_eta_D( nlhs, plhs, nrhs, prhs );
}
...
do_eta_DD(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('eta_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_eta_DD( nlhs, plhs, nrhs, prhs );
}
...
do_Tbar(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('Tbar',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Tbar( nlhs, plhs, nrhs, prhs );
}
...
do_Tbar_D(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('Tbar_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Tbar_D( nlhs, plhs, nrhs, prhs );
}
...
do_Tbar_DD(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('Tbar_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Tbar_DD( nlhs, plhs, nrhs, prhs );
}
...
do_tf(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('tf',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_tf( nlhs, plhs, nrhs, prhs );
}
...
do_tf_D(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('tf_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_tf_D( nlhs, plhs, nrhs, prhs );
}
...
do_tf_DD(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('tf_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_tf_DD( nlhs, plhs, nrhs, prhs );
}
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "MaximumAscent_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "MaximumAscent_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
