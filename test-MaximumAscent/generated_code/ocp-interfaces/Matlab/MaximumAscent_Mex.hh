...
public:
  ...
  void do_eta( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_eta_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_eta_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_Tbar( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_Tbar_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_Tbar_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_tf( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_tf_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_tf_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
