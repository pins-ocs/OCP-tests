...
% create object
ocp = MaximumAscent( 'MaximumAscent' );
...
%ocp.setup(MaximumAscent_data);
%ocp.setup('../../data/MaximumAscent_Data.lua');
ocp.setup('../../data/MaximumAscent_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%MaximumAscent_Mex('set_tracked',obj,tracked);
...
%[Z,U] = MaximumAscent_Mex('get_raw_solution',obj);
%J     = MaximumAscent_Mex('eval_JF',obj,Z,U);
%f     = MaximumAscent_Mex('eval_F',obj,Z,U);
