...
namespace MaximumAscentDefine {
  ...
  */
  void
  MaximumAscent::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "MaximumAscent::setup_parameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  MaximumAscent::setup_parameters( real_type const Pars[] ) {
  ...
  */
  void
  MaximumAscent::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  MaximumAscent::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  MaximumAscent::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  MaximumAscent::setup_controls( GenericContainer const & gc_data ) {
  ...
  */
  void
  MaximumAscent::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "MaximumAscent::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in MaximumAscent::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  MaximumAscent::info_classes() const {
    int msg_level = 3;
