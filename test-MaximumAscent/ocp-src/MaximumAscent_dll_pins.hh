...
namespace MaximumAscentDefine {
  ...
  class MaximumAscent_Problem {
    ...
    MaximumAscent_Problem( MaximumAscent_Problem const & );
    MaximumAscent_Problem const & operator = ( MaximumAscent_Problem const & );
  ...
  public:
    ...
    MaximumAscent_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("MaximumAscent",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "MaximumAscent::solver, fatal: unknown error";
      }
      return ok;
    }
