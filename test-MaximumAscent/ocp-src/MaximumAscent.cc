...
namespace MaximumAscentDefine {
  ...
  */
  void
  MaximumAscent::updateContinuation( integer phase, real_type s ) {
    UTILS_ASSERT(
      s >= 0 && s <= 1,
      "MaximumAscent::updateContinuation( phase number = {}, s = {}) "
  ...
  */
  void
  MaximumAscent::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "MaximumAscent::setupParameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in MaximumAscent::setup not all parameters are set!\n"
    );
  }

  void
  MaximumAscent::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  MaximumAscent::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  MaximumAscent::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  MaximumAscent::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  MaximumAscent::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "MaximumAscent::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in MaximumAscent::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  MaximumAscent::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  MaximumAscent::setup( GenericContainer const & gc ) {

    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("MaximumAscent::setup, Debug");
  ...
  */
  void
  MaximumAscent::get_names( GenericContainer & out ) const {
  ...
  */
  void
  MaximumAscent::diagnostic( GenericContainer const & gc ) {
  ...
  void
  MaximumAscent::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
