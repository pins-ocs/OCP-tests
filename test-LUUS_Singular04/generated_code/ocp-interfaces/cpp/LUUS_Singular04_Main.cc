...
main() {
  ...
  try {
    LUUS_Singular04 * m_model = new LUUS_Singular04("LUUS_Singular04",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/LUUS_Singular04_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/LUUS_Singular04_Data.lua";
    #endif
