...
%ocp.setup('../../data/LUUS_Singular04_Data.lua');
ocp.setup('../../data/LUUS_Singular04_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = LUUS_Singular04_Mex('get_raw_solution',obj);
%J     = LUUS_Singular04_Mex('eval_JF',obj,Z,U);
%f     = LUUS_Singular04_Mex('eval_F',obj,Z,U);
