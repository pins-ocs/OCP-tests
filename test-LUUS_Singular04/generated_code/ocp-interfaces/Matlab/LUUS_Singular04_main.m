...
% create object
ocp = LUUS_Singular04( 'LUUS_Singular04' );
...
%ocp.setup(LUUS_Singular04_data);
ocp.setup('../../data/LUUS_Singular04_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%LUUS_Singular04_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = LUUS_Singular04_Mex('get_raw_solution',obj);
%J     = LUUS_Singular04_Mex('eval_JF',obj,Z,MU,U);
%f     = LUUS_Singular04_Mex('eval_F',obj,Z,MU,U);
