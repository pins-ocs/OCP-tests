...
namespace LUUS_Singular04Define {
  ...
  integer LUUS_Singular04::boundaryConditions_numEqns() const { return 3; }
  ...
  integer LUUS_Singular04::adjointBC_numEqns() const { return 6; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer LUUS_Singular04::DadjointBCDxxp_numRows() const { return 6; }
  integer LUUS_Singular04::DadjointBCDxxp_numCols() const { return 6; }
  integer LUUS_Singular04::DadjointBCDxxp_nnz()     const { return 0; }

  void
  LUUS_Singular04::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
