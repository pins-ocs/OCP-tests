...
namespace LUUS_Singular04Define {
  ...
  integer LUUS_Singular04::fd_BC_numEqns() const { return 6; }

  void
  LUUS_Singular04::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer LUUS_Singular04::Dfd_BCDxlxlp_numRows() const { return 6; }
  integer LUUS_Singular04::Dfd_BCDxlxlp_numCols() const { return 12; }
  integer LUUS_Singular04::Dfd_BCDxlxlp_nnz()     const { return 6; }

  void
  LUUS_Singular04::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  LUUS_Singular04::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
