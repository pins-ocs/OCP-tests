...
namespace LUUS_Singular04Define {
  ...
  integer
  LUUS_Singular04::boundaryConditions_numEqns() const
  { return 3; }

  void
  LUUS_Singular04::boundaryConditions_eval(
  ...
  integer
  LUUS_Singular04::DboundaryConditionsDxxp_numRows() const
  { return 3; }

  integer
  LUUS_Singular04::DboundaryConditionsDxxp_numCols() const
  { return 6; }

  integer
  LUUS_Singular04::DboundaryConditionsDxxp_nnz() const
  { return 3; }

  void
  LUUS_Singular04::DboundaryConditionsDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  integer
  LUUS_Singular04::adjointBC_numEqns() const
  { return 6; }

  void
  LUUS_Singular04::adjointBC_eval(
  ...
  integer
  LUUS_Singular04::DadjointBCDxxp_numRows() const
  { return 6; }

  integer
  LUUS_Singular04::DadjointBCDxxp_numCols() const
  { return 6; }

  integer
  LUUS_Singular04::DadjointBCDxxp_nnz() const
  { return 0; }

  void
  LUUS_Singular04::DadjointBCDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  }
  ...
  void
  LUUS_Singular04::DadjointBCDxxp_sparse(
    NodeType2 const             & LEFT__,
    NodeType2 const             & RIGHT__,
    P_const_pointer_type          P__,
    OMEGA_full_const_pointer_type OMEGA__,
