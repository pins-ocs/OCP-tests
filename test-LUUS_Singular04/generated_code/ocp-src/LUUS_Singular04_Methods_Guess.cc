...
namespace LUUS_Singular04Define {
  ...
  void
  LUUS_Singular04::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  LUUS_Singular04::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  LUUS_Singular04::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  LUUS_Singular04::xlambda_check_node(
    integer              ipos,
  ...
  bool
  LUUS_Singular04::xlambda_check_cell(
    integer              icell,
  ...
  integer LUUS_Singular04::u_guess_numEqns() const { return 1; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  LUUS_Singular04::u_guess_eval(
    NodeType2 const    & LEFT__,
    NodeType2 const    & RIGHT__,
    P_const_pointer_type P__,
    ...
    UGUESS__[ iU_u ] = uControl.solve(-2 / (t3 + t5 + 2 * t7) * L__[iL_lambda3__xo], -1, 1);
    if ( m_debug )
  ...
  bool
  LUUS_Singular04::u_check_if_admissible(
    NodeType2 const    & NODE__,
...
// EOF: LUUS_Singular04_Methods_Guess.cc
