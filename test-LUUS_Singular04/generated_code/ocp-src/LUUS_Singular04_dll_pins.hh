/*-----------------------------------------------------------------------*\
 |  file: LUUS_Singular04_dll_pins.hh                                    |
 |                                                                       |
...
namespace LUUS_Singular04Define {
  ...
  using namespace LUUS_Singular04Load;
  ...
  class LUUS_Singular04_Problem {

    LUUS_Singular04 model;
    ...
    LUUS_Singular04_Problem const & operator = ( LUUS_Singular04_Problem const & );
  ...
  public:
    ...
    LUUS_Singular04_Problem( integer n_threads, Console const * console )
    : model("LUUS_Singular04",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "LUUS_Singular04::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: LUUS_Singular04_dll_pins.hh
