...
#ifndef LUUS_SINGULAR04_DOT_HH
#define LUUS_SINGULAR04_DOT_HH
...
// User Header (end)
  ...
  #ifndef LUUS_SINGULAR04_API_DLL
    #ifdef LUUS_SINGULAR04_EXPORT
      #define LUUS_SINGULAR04_API_DLL __declspec(dllexport)
    #elif defined(LUUS_SINGULAR04_IMPORT)
      #define LUUS_SINGULAR04_API_DLL __declspec(dllimport)
    #else
      #define LUUS_SINGULAR04_API_DLL
    #endif
  #endif
...
namespace LUUS_Singular04Define {
  ...
  class LUUS_Singular04 : public Mechatronix::Discretized_Indirect_OCP {
    ...
    LUUS_Singular04( LUUS_Singular04 const & );
    LUUS_Singular04 const & operator = ( LUUS_Singular04 const & );
...
namespace LUUS_Singular04Load {
  using LUUS_Singular04Define::LUUS_Singular04;

}

#endif

// EOF: LUUS_Singular04.hh
