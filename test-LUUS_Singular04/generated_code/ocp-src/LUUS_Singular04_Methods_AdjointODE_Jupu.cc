...
namespace LUUS_Singular04Define {
  ...
  integer LUUS_Singular04::JPxpu_numEqns() const { return 4; }

  void
  LUUS_Singular04::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer LUUS_Singular04::JUxpu_numEqns() const { return 4; }

  void
  LUUS_Singular04::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer LUUS_Singular04::LTxpu_numEqns() const { return 4; }

  void
  LUUS_Singular04::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
