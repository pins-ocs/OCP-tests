...
namespace BrachiostocronaDefine {
  ...
  */
  Brachiostocrona::Brachiostocrona(
    string  const & name,
    ThreadPool    * _TP,
  ...
  */
  void
  Brachiostocrona::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  Brachiostocrona::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "Brachiostocrona::setupParameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in Brachiostocrona::setup not all parameters are set!\n"
    );
  }

  void
  Brachiostocrona::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  Brachiostocrona::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  Brachiostocrona::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  Brachiostocrona::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  Brachiostocrona::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "Brachiostocrona::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  Brachiostocrona::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "Brachiostocrona::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in Brachiostocrona::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  Brachiostocrona::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  Brachiostocrona::setup( GenericContainer const & gc ) {

    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("Brachiostocrona::setup, Debug");
  ...
  */
  void
  Brachiostocrona::get_names( GenericContainer & out ) const {
  ...
  */
  void
  Brachiostocrona::diagnostic( GenericContainer const & gc ) {
  ...
  void
  Brachiostocrona::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
