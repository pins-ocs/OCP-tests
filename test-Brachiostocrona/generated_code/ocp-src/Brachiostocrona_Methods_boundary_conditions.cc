...
namespace BrachiostocronaDefine {
  ...
  integer Brachiostocrona::boundaryConditions_numEqns() const { return 5; }

  void
  Brachiostocrona::boundaryConditions_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Brachiostocrona::DboundaryConditionsDxxp_numRows() const { return 5; }
  integer Brachiostocrona::DboundaryConditionsDxxp_numCols() const { return 9; }
  integer Brachiostocrona::DboundaryConditionsDxxp_nnz()     const { return 5; }

  void
  Brachiostocrona::DboundaryConditionsDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  integer Brachiostocrona::adjointBC_numEqns() const { return 9; }

  void
  Brachiostocrona::adjointBC_eval(
    NodeType const              & LEFT__,
    NodeType const              & RIGHT__,
    P_const_pointer_type          P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Brachiostocrona::DadjointBCDxxp_numRows() const { return 9; }
  integer Brachiostocrona::DadjointBCDxxp_numCols() const { return 9; }
  integer Brachiostocrona::DadjointBCDxxp_nnz()     const { return 0; }

  void
  Brachiostocrona::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
