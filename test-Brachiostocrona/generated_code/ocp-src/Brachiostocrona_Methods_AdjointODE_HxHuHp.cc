...
namespace BrachiostocronaDefine {
  ...
  Brachiostocrona::DHxpDxpu_sparse(
    ...
    result__[ 9   ] = t11 * t24 * t26 * t8 - t11 * t14 * t19 - t15 * t19 * t9;
    result__[ 10  ] = -t11 * t19 * t7 + t13 * t15 * t19 - t15 * t24 * t26;
  ...
  Brachiostocrona::Hu_eval(
    ...
    real_type t14  = exp(-t12 * t5);
    result__[ 1   ] = 2 * (ModelPars[iM_slope_low] * X__[iX_x] + t5 - X__[iX_y] + ModelPars[iM_y0_low]) * ModelPars[iM_w_ARG] - t14 * t12 - 1.0 / t5 * t11;
    if ( m_debug )
