...
namespace BrachiostocronaDefine {
  ...
  void
  Brachiostocrona::p_guess_eval( P_p_type P__ ) const {
  ...
  void
  Brachiostocrona::xlambda_guess_eval(
    integer        i_segment,
    Q_const_p_type Q__,
    P_const_p_type P__,
    X_p_type       X__,
  ...
  bool
  Brachiostocrona::p_check( P_const_p_type P__ ) const {
  ...
  bool
  Brachiostocrona::xlambda_check_node(
    integer         ipos,
  ...
  Brachiostocrona::u_guess_eval(
    ...
    UGUESS__[ iU_vtheta ] = vthetaControl.solve(-MU__[3] / P__[iP_T], -10, 10);
    if ( m_debug )
  ...
  bool
  Brachiostocrona::u_check_if_admissible(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__
