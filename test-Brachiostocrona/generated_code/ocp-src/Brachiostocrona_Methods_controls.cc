...
namespace BrachiostocronaDefine {
  ...
  Brachiostocrona::u_eval_analytic(
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    U__[ iU_vtheta ] = vthetaControl.solve((-LL__[iL_lambda4__xo] - LR__[iL_lambda4__xo]) / P__[iP_T] / 2, -10, 10);
    if ( m_debug )
  ...
  Brachiostocrona::DuDxlxlp_full_analytic(
    ...
    real_type tmp_0_5 = 0;
    real_type tmp_0_6 = 0;
    real_type t3   = -LL__[iL_lambda4__xo] - LR__[iL_lambda4__xo];
    real_type t4   = P__[iP_T];
    real_type t5   = 1.0 / t4;
    real_type t8   = vthetaControl.solve_rhs(t5 * t3 / 2, -10, 10);
    real_type tmp_0_7 = -t5 * t8 / 2;
    real_type tmp_0_8 = 0;
    real_type tmp_0_9 = 0;
    ...
    real_type t13  = t4 * t4;
    real_type tmp_0_16 = -1.0 / t13 * t3 * t8 / 2;
