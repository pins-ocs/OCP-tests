...
namespace BrachiostocronaDefine {
  ...
  void
  Brachiostocrona::continuation_step_1( real_type s ) {
  ...
  Brachiostocrona::H_eval(
    ...
    real_type result__ = t11 * t4 * t2 * MU__[1] - t11 * ModelPars[iM_g] * t2 * MU__[2] + t6 * t4 * t2 * MU__[0] + MU__[3] * U__[iU_vtheta];
    if ( m_debug ) {
  ...
  integer Brachiostocrona::post_numEqns() const { return 3; }
