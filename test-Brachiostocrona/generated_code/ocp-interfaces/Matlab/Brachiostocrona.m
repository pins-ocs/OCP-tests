...
classdef Brachiostocrona < handle
  ...
  methods
    ...
    function res = post_processing_ARG( self )
      %
      % Return the solution for the post processing variable: ARG
      %
      res = Brachiostocrona_Mex( 'get_solution', self.objectHandle, 'ARG' );
    end
