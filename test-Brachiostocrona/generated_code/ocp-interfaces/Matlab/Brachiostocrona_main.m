...
% create object
ocp = Brachiostocrona( 'Brachiostocrona' );
...
%ocp.setup(Brachiostocrona_data);
ocp.setup('../../data/Brachiostocrona_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Brachiostocrona_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = Brachiostocrona_Mex('get_raw_solution',obj);
%J     = Brachiostocrona_Mex('eval_JF',obj,Z,MU,U);
%f     = Brachiostocrona_Mex('eval_F',obj,Z,MU,U);
