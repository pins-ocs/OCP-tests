...
public:
  ...
  do_fun(
    ...
    #define CMD MODEL_NAME "_Mex('fun', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->fun(arg0) );
    #undef CMD
  }
  ...
  do_fun_D(
    ...
    #define CMD MODEL_NAME "_Mex('fun_D', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->fun_D(arg0) );
    #undef CMD
  }
  void
  do_fun_DD(
    ...
    #define CMD MODEL_NAME "_Mex('fun_DD', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->fun_DD(arg0) );
    #undef CMD
  }
