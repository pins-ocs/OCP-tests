...
namespace BangBangFclipDefine {
  ...
  integer BangBangFclip::bc_numEqns() const { return 5; }

  void
  BangBangFclip::bc_eval(
    NodeQX const & LEFT__,
  ...
  integer BangBangFclip::fd_BC_numEqns() const { return 6; }

  void
  BangBangFclip::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFclip::Dfd_BCDxlxlp_numRows() const { return 6; }
  integer BangBangFclip::Dfd_BCDxlxlp_numCols() const { return 12; }
  integer BangBangFclip::Dfd_BCDxlxlp_nnz()     const { return 6; }

  void
  BangBangFclip::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  BangBangFclip::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
