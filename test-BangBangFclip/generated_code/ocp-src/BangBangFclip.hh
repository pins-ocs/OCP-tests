...
#ifndef BANGBANGFCLIP_DOT_HH
#define BANGBANGFCLIP_DOT_HH
...
// User Header (end)
  ...
  #ifndef BANGBANGFCLIP_API_DLL
    #ifdef BANGBANGFCLIP_EXPORT
      #define BANGBANGFCLIP_API_DLL __declspec(dllexport)
    #elif defined(BANGBANGFCLIP_IMPORT)
      #define BANGBANGFCLIP_API_DLL __declspec(dllimport)
    #else
...
namespace BangBangFclipDefine {
  ...
  class BangBangFclip : public Mechatronix::Discretized_Indirect_OCP {
    ...
    BangBangFclip( BangBangFclip const & );
    BangBangFclip const & operator = ( BangBangFclip const & );
...
namespace BangBangFclipLoad {
  using BangBangFclipDefine::BangBangFclip;

}

#endif

// EOF: BangBangFclip.hh
