...
namespace BangBangFclipDefine {
  ...
  BangBangFclip::u_eval_analytic(
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    real_type t5   = ModelPars[iM_vFmax];
    U__[ iU_vF ] = controlForce.solve(-LL__[iL_lambda3__xo] / 2 - LR__[iL_lambda3__xo] / 2, -t5, t5);
    if ( m_debug )
  ...
  BangBangFclip::DuDxlxlp_full_analytic(
    ...
    real_type tmp_0_4 = 0;
    real_type t5   = ModelPars[iM_vFmax];
    real_type t6   = controlForce.solve_rhs(-LL__[iL_lambda3__xo] / 2 - LR__[iL_lambda3__xo] / 2, -t5, t5);
    real_type tmp_0_5 = -t6 / 2;
    real_type tmp_0_6 = 0;
    real_type tmp_0_7 = 0;
    real_type tmp_0_8 = 0;
    real_type tmp_0_9 = 0;
