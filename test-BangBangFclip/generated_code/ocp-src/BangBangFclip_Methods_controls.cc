...
namespace BangBangFclipDefine {
  ...
  BangBangFclip::g_fun_eval(
    ...
    real_type t8   = clip(XM__[2], ModelPars[iM_minClip], ModelPars[iM_maxClip]);
  ...
  BangBangFclip::DgDu_sparse(
    ...
    result__[ 0   ] = ALIAS_controlForce_D_1_1(UM__[0], -t2, t2);
    if ( m_debug )
  ...
  void
  BangBangFclip::DuDxlxlp_full_analytic(
    NodeType2 const &          LEFT__,
    NodeType2 const &          RIGHT__,
    P_const_pointer_type       P__,
    U_const_pointer_type       UM__,
    ...
    real_type t2   = ModelPars[iM_vFmax];
    real_type t3   = controlForce.solve_rhs(-LM__[2], -t2, t2);
