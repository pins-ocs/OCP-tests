...
main() {
  ...
  try {
    BangBangFclip * m_model = new BangBangFclip("BangBangFclip",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/BangBangFclip_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/BangBangFclip_Data.lua";
    #endif
