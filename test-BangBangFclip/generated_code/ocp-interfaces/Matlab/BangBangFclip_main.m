...
% create object
ocp = BangBangFclip( 'BangBangFclip' );
...
%ocp.setup(BangBangFclip_data);
ocp.setup('../../data/BangBangFclip_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%BangBangFclip_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = BangBangFclip_Mex('get_raw_solution',obj);
%J     = BangBangFclip_Mex('eval_JF',obj,Z,MU,U);
%f     = BangBangFclip_Mex('eval_F',obj,Z,MU,U);
