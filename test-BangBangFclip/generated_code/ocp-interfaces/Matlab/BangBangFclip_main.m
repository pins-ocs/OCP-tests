...
%ocp.setup('../../data/BangBangFclip_Data.lua');
ocp.setup('../../data/BangBangFclip_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = BangBangFclip_Mex('get_raw_solution',obj);
%J     = BangBangFclip_Mex('eval_JF',obj,Z,U);
%f     = BangBangFclip_Mex('eval_F',obj,Z,U);
