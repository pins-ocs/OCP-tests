...
namespace gtocX_2burn_parsDefine {
  ...
  gtocX_2burn_pars::Hx_eval(
    ...
    real_type t12  = 1 - ModelPars[iM_w_guess];
    ...
    real_type t26  = t25 * L__[iL_lambda1__xo];
    ...
    real_type t43  = t25 * L__[iL_lambda2__xo];
  ...
  gtocX_2burn_pars::DHxDx_sparse(
    ...
    real_type t10  = t3 * t3;
    real_type t13  = 2 * ModelPars[iM_w_guess];
    real_type t17  = ModelPars[iM_time_f] - ModelPars[iM_time_i];
    real_type t18  = t17 * L__[iL_lambda1__xo];
    ...
    real_type t42  = t17 * L__[iL_lambda2__xo];
  ...
  gtocX_2burn_pars::DHxDp_sparse(
    ...
    real_type t8   = 1.0 / t7;
    real_type t9   = ModelPars[iM_muS];
    real_type t10  = sqrt(t9);
    real_type t11  = 1.0 / t10;
    real_type t12  = t11 * t8;
    real_type t13  = t12 * t5;
    real_type t14  = ModelPars[iM_w_nonlin];
    real_type t15  = X__[iX_f];
    real_type t16  = X__[iX_g];
    real_type t17  = X__[iX_L];
    ...
    real_type t41  = t4 * L__[iL_lambda2__xo];
  ...
  gtocX_2burn_pars::Hp_eval(
    ...
    result__[ 0   ] = 2 * t5 * (t3 * t5 - 1) * t2 + t15 * t35 * t29 * t28 / 2 + t15 * t44 * t29 * t38 - t43 * t35 * t45 * t28 / 2 - t43 * t44 * t45 * t38 - 3.0 / 2.0 * t59 * t14 * L__[iL_lambda3__xo] / t60 * t17 * t20;
