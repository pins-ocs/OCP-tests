...
namespace gtocX_2burn_parsDefine {
  ...
  */
  void
  gtocX_2burn_pars::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "gtocX_2burn_pars::setupParameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  gtocX_2burn_pars::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  gtocX_2burn_pars::setupClasses( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Constraints"),
      "gtocX_2burn_pars::setupClasses: Missing key `Parameters` in data\n"
    );
    GenericContainer const & gc = gc_data("Constraints");
    // Initialize Constraints 1D
    UTILS_ASSERT0(
      gc.exists("ray_positive"),
      "in gtocX_2burn_pars::setupClasses(gc) missing key: ``ray_positive''\n"
    );
  ...
  */
  void
  gtocX_2burn_pars::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  gtocX_2burn_pars::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  gtocX_2burn_pars::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "gtocX_2burn_pars::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in gtocX_2burn_pars::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  gtocX_2burn_pars::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
