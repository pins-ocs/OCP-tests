...
namespace gtocX_2burn_parsDefine {
  ...
  gtocX_2burn_pars::DadjointBCDx_sparse(
    ...
    real_type t48  = XR__[iX_f];
    real_type t49  = XR__[iX_g];
    real_type t50  = XR__[iX_L];
    ...
    result__[ 26  ] = t137 * t1 + t139 * t11 + t141 * t14;
    ...
    result__[ 30  ] = t161 * t1 + t163 * t11 + t165 * t14;
    ...
    result__[ 31  ] = t167 * t1 + t169 * t11 + t171 * t14;
    ...
    result__[ 32  ] = t173 * t1 + t175 * t11 + t177 * t14;
    ...
    if ( m_debug )
      Mechatronix::check_in_segment2( result__, "DadjointBCDxp_sparse", 36, i_segment_left, i_segment_right );
  }
  ...
  gtocX_2burn_pars::DadjointBCDp_sparse(
    ...
    real_type t66  = XR__[iX_f];
    real_type t67  = XR__[iX_g];
    real_type t68  = XR__[iX_L];
    ...
    result__[ 19  ] = t137 * t1 + t139 * t11 + t141 * t14 + t143 * t65 + t145 * t71 + t147 * t74;
    ...
    result__[ 22  ] = t161 * t1 + t163 * t11 + t165 * t14 + t167 * t65 + t169 * t71 + t171 * t74;
    ...
    result__[ 23  ] = t173 * t1 + t175 * t11 + t177 * t14 + t179 * t65 + t181 * t71 + t183 * t74;
    ...
    if ( m_debug )
      Mechatronix::check_in_segment2( result__, "DadjointBCDxp_sparse", 27, i_segment_left, i_segment_right );
  }
