...
XPOS := xPosition(p(zeta),f(zeta),g(zeta),h(zeta),k(zeta),L(zeta),retrograde):
YPOS := yPosition(p(zeta),f(zeta),g(zeta),h(zeta),k(zeta),L(zeta),retrograde):
ZPOS := zPosition(p(zeta),f(zeta),g(zeta),h(zeta),k(zeta),L(zeta),retrograde):
XVEL := xVelocity(p(zeta),f(zeta),g(zeta),h(zeta),k(zeta),L(zeta),retrograde):
YVEL := yVelocity(p(zeta),f(zeta),g(zeta),h(zeta),k(zeta),L(zeta),retrograde):
ZVEL := zVelocity(p(zeta),f(zeta),g(zeta),h(zeta),k(zeta),L(zeta),retrograde):
