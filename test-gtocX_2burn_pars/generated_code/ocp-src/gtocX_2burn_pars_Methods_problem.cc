...
namespace gtocX_2burn_parsDefine {
  ...
  void
  gtocX_2burn_pars::continuation_step_2( real_type s ) {
  ...
  gtocX_2burn_pars::H_eval(
    ...
    real_type t66  = pow(t50 * t20 + t57 * t9 + 1, 2);
    real_type result__ = (t8 + t19 + t23 + t27 + t31 + t35) * (1 - ModelPars[iM_w_guess]) + t50 * t49 * t47 * t41 * t39 * MU__[0] - t57 * t49 * t47 * t41 * t39 * MU__[1] + t44 / t41 / t3 * t66 * t39 * MU__[2];
    if ( m_debug ) {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer gtocX_2burn_pars::D2mayerD2xxp_numRows() const { return 9; }
  integer gtocX_2burn_pars::D2mayerD2xxp_numCols() const { return 9; }
  integer gtocX_2burn_pars::D2mayerD2xxp_nnz()     const { return 0; }

  void
  gtocX_2burn_pars::D2mayerD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  gtocX_2burn_pars::D2mayerD2xxp_sparse(
    NodeQX const & LEFT__,
    NodeQX const & RIGHT__,
    P_const_p_type P__,
    real_ptr       result__
  ...
  integer gtocX_2burn_pars::DlagrangeDxpu_numEqns() const { return 6; }

  void
  gtocX_2burn_pars::DlagrangeDxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer gtocX_2burn_pars::D2lagrangeD2xpu_numRows() const { return 6; }
  integer gtocX_2burn_pars::D2lagrangeD2xpu_numCols() const { return 6; }
  integer gtocX_2burn_pars::D2lagrangeD2xpu_nnz()     const { return 6; }

  void
  gtocX_2burn_pars::D2lagrangeD2xpu_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  gtocX_2burn_pars::D2lagrangeD2xpu_sparse(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer gtocX_2burn_pars::DsegmentLinkDxxp_numRows() const { return 0; }
  integer gtocX_2burn_pars::DsegmentLinkDxxp_numCols() const { return 0; }
  integer gtocX_2burn_pars::DsegmentLinkDxxp_nnz() const { return 0; }

  void
  gtocX_2burn_pars::DsegmentLinkDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  gtocX_2burn_pars::DsegmentLinkDxxp_sparse(
    NodeQX const & L,
    NodeQX const & R,
    P_const_p_type p,
  ...
  integer gtocX_2burn_pars::post_numEqns() const { return 21; }
  ...
  gtocX_2burn_pars::post_eval(
    ...
    real_type t16  = P__[iP_h];
    real_type t17  = P__[iP_k];
