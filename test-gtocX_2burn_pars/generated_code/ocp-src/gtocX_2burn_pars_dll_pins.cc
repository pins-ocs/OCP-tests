...
#include "gtocX_2burn_pars_dll_pins.hh"
#include <map>
...
#define MAP_PROBLEM map< string, gtocX_2burn_pars_Problem * >
...
namespace gtocX_2burn_parsDefine {
  ...
  mrb_value
  mrb_gtocX_2burn_pars_ocp_setup( mrb_state *mrb, mrb_value self ) {
    ...
    if ( !mrb_string_p(id_value) )  {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "gtocX_2burn_pars_ocp_setup, missing first parameter or is nota a string (id)\n"
      );
    }
    if ( mrb_nil_p(data_value) )  {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "gtocX_2burn_pars_ocp_setup, missing second parameter (data)\n"
      );
    }
    ...
    if ( it == problems.end() ) {
      problems[id] = new gtocX_2burn_pars_Problem( n_threads, pConsole );
  ...
  GTOCX_2BURN_PARS_API_DLL
  mrb_value
  mrb_gtocX_2burn_pars_ocp_guess( mrb_state *mrb, mrb_value self ) {
    ...
    if ( !mrb_string_p(id_value) )  {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "gtocX_2burn_pars_ocp_guess, missing first parameter or is not a string (id)\n"
      );
    }
    if ( mrb_nil_p(data_value) )  {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "gtocX_2burn_pars_ocp_guess, missing second parameter (data)\n"
      );
    }
    ...
    if ( it == problems.end() ) {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "gtocX_2burn_pars_ocp_guess, you must do setup first!\n"
      );
    } else {
      // to C++ parameters
      GenericContainer gc_data;
      Mechatronix::mrb_to_GC( mrb, data_value, gc_data, "mrb_to_GC:" );
      it->second->guess( gc_data( "Guess", "mrb_gtocX_2burn_pars_ocp_guess" ) );
    }
  ...
  GTOCX_2BURN_PARS_API_DLL
  mrb_value
  mrb_gtocX_2burn_pars_ocp_solve( mrb_state *mrb, mrb_value self ) {
    ...
    if ( !mrb_string_p(id_value) )  {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "gtocX_2burn_pars_ocp_solve, missing first parameter or is not a string (id)\n"
      );
    }
    if ( mrb_nil_p(data_value) )  {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "gtocX_2burn_pars_ocp_solve, missing second parameter (data)\n"
      );
    }
    ...
    if ( it == problems.end() ) {
      mrb_raise(
        mrb,
        E_OCP_ERROR,
        "gtocX_2burn_pars_ocp_solve, you must do setup first!\n"
      );
    } else {
      // to C++ parameters
      GenericContainer gc_data;
      ...
      if ( !ok )
        pConsole->error( "gtocX_2burn_pars_ocp_solve, solution failed!\n" );
  ...
  GTOCX_2BURN_PARS_API_DLL
  mrb_value
  mrb_gtocX_2burn_pars_write_ocp_solution( mrb_state *mrb, mrb_value self ) {
    mrb_value a_string;
  ...
  GTOCX_2BURN_PARS_API_DLL
  mrb_value
  mrb_gtocX_2burn_pars_ocp_solution_range( mrb_state *mrb, mrb_value self ) {
  ...
  GTOCX_2BURN_PARS_API_DLL
  mrb_value
  mrb_gtocX_2burn_pars_ocp_eval_solution( mrb_state *mrb, mrb_value self ) {
  ...
  GTOCX_2BURN_PARS_API_DLL
  void
  mrb_libgtocX_2burn_pars_gem_init(mrb_state* mrb) {
    ...
    mrb_define_const(
      ...
      ocp_class,
      "NAME",
      mrb_str_new_cstr(mrb, "gtocX_2burn_pars")
    );
    ...
    mrb_define_method(
      ...
      ocp_class,
      "setup",
      mrb_gtocX_2burn_pars_ocp_setup,
      MRB_ARGS_NONE()
    );
    ...
    mrb_define_method(
      ...
      ocp_class,
      "guess",
      mrb_gtocX_2burn_pars_ocp_guess,
      MRB_ARGS_NONE()
    );
    ...
    mrb_define_method(
      ...
      ocp_class,
      "solve",
      mrb_gtocX_2burn_pars_ocp_solve,
      MRB_ARGS_NONE()
    );
    ...
    mrb_define_method(
      ...
      ocp_class,
      "write_ocp_solution",
      mrb_gtocX_2burn_pars_write_ocp_solution,
      MRB_ARGS_REQ(1)
    );
    ...
    mrb_define_method(
      ...
      ocp_class,
      "eval_solution",
      mrb_gtocX_2burn_pars_ocp_eval_solution,
      MRB_ARGS_REQ(2)
    );
    ...
    mrb_define_method(
      ...
      ocp_class,
      "solution_range",
      mrb_gtocX_2burn_pars_ocp_solution_range,
      MRB_ARGS_REQ(1)
    );
  ...
  GTOCX_2BURN_PARS_API_DLL
  void
  mrb_libgtocX_2burn_pars_gem_final(mrb_state* mrb)
  {
  }
}

// EOF: gtocX_2burn_pars_dll_pins.cc
