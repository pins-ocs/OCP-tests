/*-----------------------------------------------------------------------*\
 |  file: gtocX_2burn_pars_dll_pins.hh                                   |
 |                                                                       |
...
namespace gtocX_2burn_parsDefine {
  ...
  class gtocX_2burn_pars_Problem {

    gtocX_2burn_pars model;
    ...
    gtocX_2burn_pars_Problem( gtocX_2burn_pars_Problem const & );
    gtocX_2burn_pars_Problem const & operator = ( gtocX_2burn_pars_Problem const & );
  ...
  public:
    ...
    gtocX_2burn_pars_Problem( integer n_threads, Console const * console )
    : model("gtocX_2burn_pars",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "gtocX_2burn_pars::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: gtocX_2burn_pars_dll_pins.hh
