...
namespace gtocX_2burn_parsDefine {
  ...
  gtocX_2burn_pars::x_velocity( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -1.0 / (t1 + t2 + 1) * t22 / t18 * (t4 * (t1 - t2 + 1) - 2 * t7 * xo__k * xo__retrograde * xo__h - 2 * xo__f * xo__h * xo__k * xo__retrograde + t1 * xo__g - t2 * xo__g + xo__g);
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = 1.0 / (t1 + t2 + 1) * t23 / t18 / xo__p * (t4 * (t1 - t2 + 1) - 2 * t7 * xo__k * xo__retrograde * xo__h - 2 * xo__f * xo__h * xo__k * xo__retrograde + t1 * xo__g - t2 * xo__g + xo__g) / 2;
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_1( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -3.0 / 4.0 / (t1 + t2 + 1) * t24 / t19 / t18 * (t4 * (t1 - t2 + 1) - 2 * t7 * xo__k * xo__retrograde * xo__h - 2 * xo__f * xo__h * xo__k * xo__retrograde + t1 * xo__g - t2 * xo__g + xo__g);
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_4( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = 1.0 / t19 * t16 * t13 * (-2 * xo__f * xo__k * xo__retrograde + 2 * t1 * xo__h - 2 * t4 * t3 + 2 * xo__g * xo__h) / 2 - xo__h / t37 * t16 * t13 * (t1 * (t17 - t18 + 1) - 2 * t4 * xo__k * xo__retrograde * xo__h - 2 * t3 * xo__f * xo__h + t17 * xo__g - t18 * xo__g + xo__g);
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_5( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = 1.0 / t19 * t16 * t13 * (-2 * t1 * xo__k - 2 * t4 * t3 - 2 * xo__retrograde * t6 - 2 * xo__g * xo__k) / 2 - xo__k / t36 * t16 * t13 * (t1 * (t17 - t18 + 1) - 2 * t4 * xo__k * t3 - 2 * xo__k * xo__retrograde * t6 + t17 * xo__g - t18 * xo__g + xo__g);
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_7( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t14  = xo__h * xo__h;
    real_type t15  = xo__k * xo__k;
    real_type result__ = 1.0 / (t14 + t15 + 1) * t13 / t8 / xo__p * (-2 * t2 * xo__k * xo__h - 2 * xo__f * xo__h * xo__k) / 2;
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_7( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t13  = xo__h * xo__h;
    real_type t14  = xo__k * xo__k;
    real_type result__ = -1.0 / (t13 + t14 + 1) * t12 / t8 * (-2 * t2 * xo__k * xo__h - 2 * xo__f * xo__h * xo__k);
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::y_velocity_D_1_4( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t35  = t18 * t18;
    real_type result__ = 1.0 / t18 * t15 * t12 * (t2 * xo__h * xo__retrograde + xo__f * xo__h * xo__retrograde + t4 * xo__k + xo__g * xo__k) - 2 * xo__h / t35 * t15 * t12 * (t2 * t22 * xo__retrograde / 2 + t4 * xo__k * xo__h + xo__retrograde * t22 * xo__f / 2 + xo__g * xo__h * xo__k);
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::y_velocity_D_1_5( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t22  = t16 - t17 - 1;
    real_type t34  = t18 * t18;
    real_type result__ = 1.0 / t18 * t15 * t12 * (-t2 * xo__k * xo__retrograde - xo__f * xo__k * xo__retrograde + t4 * xo__h + t8) - 2 * xo__k / t34 * t15 * t12 * (t2 * t22 * xo__retrograde / 2 + t4 * xo__k * xo__h + xo__retrograde * t22 * xo__f / 2 + xo__k * t8);
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
