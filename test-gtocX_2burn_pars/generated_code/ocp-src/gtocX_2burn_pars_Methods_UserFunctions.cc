...
namespace gtocX_2burn_parsDefine {
  ...
  gtocX_2burn_pars::x_position_D_6( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t18  = 1.0 / (t1 + t2 + 1);
    real_type t27  = t15 * t15;
    real_type result__ = t18 / t15 * xo__p * (2 * t6 * t7 * xo__k - t3 * t4) - (-t4 * xo__f + t7 * xo__g) * t18 / t27 * xo__p * (2 * t4 * t6 * xo__k + t3 * t7);
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::y_velocity_D_1_4( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = 1.0 / t17 * (t10 * xo__k + t7 * t8 + t7 * xo__f + xo__g * xo__k) * t6 - 2 * xo__h / t33 * (t8 * t21 * xo__retrograde / 2 + t10 * xo__k * xo__h + xo__retrograde * t21 * xo__f / 2 + xo__g * xo__h * xo__k) * t6;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::y_velocity_D_1_5( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = 1.0 / t17 * (t10 * xo__h - t7 * t8 - t7 * xo__f + t13) * t6 - 2 * xo__k / t32 * (t8 * t21 * xo__retrograde / 2 + t10 * xo__k * xo__h + xo__retrograde * t21 * xo__f / 2 + xo__k * t13) * t6;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::y_velocity_D_4_5( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -2 / t10 * (t6 + xo__g) * t5 + 4 * xo__k * t23 * (t15 * t16 + t15 * xo__f + t6 * xo__k + xo__g * xo__k) * t5 + 4 * xo__h * t23 * (-t16 * t28 - t28 * xo__f + t6 * xo__h + t32) * t5 - 16 * xo__k * xo__h / t22 / t10 * (t16 * t38 * xo__retrograde / 2 + t6 * xo__k * xo__h + xo__retrograde * t38 * xo__f / 2 + xo__k * t32) * t5;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::y_velocity_D_4_7( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -2 / t12 * (t6 * xo__h + xo__h * xo__f) * t5 + 4 * xo__h / t22 * (t6 * t17 / 2 + t17 * xo__f / 2) * t5;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::y_velocity_D_5_5( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -2 / t12 * (-t6 * xo__retrograde - xo__retrograde * xo__f) * t5 + 8 * xo__k * t25 * (-t6 * t17 - t17 * xo__f + t19 * xo__h + t22) * t5 - 16 * t11 / t24 / t12 * t40 * t5 + 4 * t25 * t40 * t5;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::y_velocity_D_5_7( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t17  = t10 - t11 - 1;
    real_type t22  = t12 * t12;
    real_type result__ = -2 / t12 * (-t6 * xo__k - xo__k * xo__f) * t5 + 4 * xo__k / t22 * (t6 * t17 / 2 + t17 * xo__f / 2) * t5;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
