...
namespace gtocX_2burn_parsDefine {
  ...
  gtocX_2burn_pars::x_position_D_4_6( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = t16 * t12 * xo__p * (-2 * t1 * xo__h + 2 * t3 * t4) - t29 * t16 * t25 * xo__p * (2 * t1 * t3 + 2 * t4 * xo__h) - 2 * xo__h * t41 * t12 * xo__p * (2 * t34 * t4 * xo__k - t1 * t32) + 2 * t29 * xo__h * t41 * t25 * xo__p * (2 * t1 * xo__k * t34 + t32 * t4);
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -1.0 / (t3 + t4 + 1) / t21 * (t6 * (t3 - t4 + 1) - 2 * t9 * xo__k * xo__retrograde * xo__h - 2 * xo__f * xo__h * xo__k * xo__retrograde + t3 * xo__g - t4 * xo__g + xo__g) * t2;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t9   = cos(xo__L);
    real_type t21  = sqrt(xo__p);
    real_type result__ = 1.0 / (t3 + t4 + 1) / t21 / xo__p * (t6 * (t3 - t4 + 1) - 2 * t9 * xo__k * xo__retrograde * xo__h - 2 * xo__f * xo__h * xo__k * xo__retrograde + t3 * xo__g - t4 * xo__g + xo__g) * t2 / 2;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_1( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -3.0 / 4.0 / (t3 + t4 + 1) / t22 / t21 * (t6 * (t3 - t4 + 1) - 2 * t9 * xo__k * xo__retrograde * xo__h - 2 * xo__f * xo__h * xo__k * xo__retrograde + t3 * xo__g - t4 * xo__g + xo__g) * t2;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_4( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = 1.0 / t19 * t16 * (-2 * xo__f * xo__k * xo__retrograde + 2 * t3 * xo__h - 2 * t6 * t5 + 2 * xo__g * xo__h) * t2 / 2 - xo__h / t37 * t16 * (t3 * (t17 - t18 + 1) - 2 * t6 * xo__k * xo__retrograde * xo__h - 2 * t5 * xo__f * xo__h + t17 * xo__g - t18 * xo__g + xo__g) * t2;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_5( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = 1.0 / t19 * t16 * (-2 * t3 * xo__k - 2 * t6 * t5 - 2 * xo__retrograde * t8 - 2 * xo__g * xo__k) * t2 / 2 - xo__k / t36 * t16 * (t3 * (t17 - t18 + 1) - 2 * t6 * xo__k * t5 - 2 * xo__k * xo__retrograde * t8 + t17 * xo__g - t18 * xo__g + xo__g) * t2;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_7( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t14  = xo__h * xo__h;
    real_type t15  = xo__k * xo__k;
    real_type result__ = 1.0 / (t14 + t15 + 1) / t11 / xo__p * (-2 * t4 * xo__k * xo__h - 2 * xo__f * xo__h * xo__k) * t2 / 2;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_5( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -1.0 / t18 * t15 * (-2 * t3 * xo__k - 2 * t6 * t5 - 2 * xo__retrograde * t8 - 2 * xo__g * xo__k) * t2 + 2 * xo__k / t34 * t15 * (t3 * (t16 - t17 + 1) - 2 * t6 * xo__k * t5 - 2 * xo__k * xo__retrograde * t8 + t16 * xo__g - t17 * xo__g + xo__g) * t2;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_7( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t13  = xo__h * xo__h;
    real_type t14  = xo__k * xo__k;
    real_type result__ = -1.0 / (t13 + t14 + 1) / t11 * (-2 * t4 * xo__k * xo__h - 2 * xo__f * xo__h * xo__k) * t2;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
