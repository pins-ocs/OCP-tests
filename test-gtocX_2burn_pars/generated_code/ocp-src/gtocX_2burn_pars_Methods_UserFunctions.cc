...
namespace gtocX_2burn_parsDefine {
  ...
  gtocX_2burn_pars::x_velocity( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -1.0 / (t1 + t2 + 1) / t21 * t19 * (t4 * (t1 - t2 + 1) - 2 * xo__h * xo__k * xo__retrograde * xo__f - 2 * t11 * xo__k * xo__retrograde * xo__h + t1 * xo__g - t2 * xo__g + xo__g);
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t19  = sqrt(ModelPars[iM_muS]);
    real_type t21  = sqrt(xo__p);
    real_type result__ = 1.0 / (t1 + t2 + 1) / t21 / xo__p * t19 * (t4 * (t1 - t2 + 1) - 2 * xo__h * xo__k * xo__retrograde * xo__f - 2 * t11 * xo__k * xo__retrograde * xo__h + t1 * xo__g - t2 * xo__g + xo__g) / 2;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_1( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -3.0 / 4.0 / (t1 + t2 + 1) / t22 / t21 * t19 * (t4 * (t1 - t2 + 1) - 2 * xo__h * xo__k * xo__retrograde * xo__f - 2 * t11 * xo__k * xo__retrograde * xo__h + t1 * xo__g - t2 * xo__g + xo__g);
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_4( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = 1.0 / t18 * t15 * t11 * (2 * t1 * xo__h - 2 * t5 * t3 - 2 * xo__f * t3 + 2 * xo__g * xo__h) / 2 - xo__h / t37 * t15 * t11 * (t1 * (t16 - t17 + 1) - 2 * xo__h * xo__k * xo__retrograde * xo__f - 2 * t5 * xo__k * xo__retrograde * xo__h + t16 * xo__g - t17 * xo__g + xo__g);
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_5( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = 1.0 / t18 * t15 * t11 * (-2 * t1 * xo__k - 2 * t5 * t3 - 2 * xo__f * t3 - 2 * xo__g * xo__k) / 2 - xo__k / t36 * t15 * t11 * (t1 * (t16 - t17 + 1) - 2 * xo__h * xo__k * xo__retrograde * xo__f - 2 * t5 * xo__k * t3 + t16 * xo__g - t17 * xo__g + xo__g);
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_7( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t13  = xo__h * xo__h;
    real_type t14  = xo__k * xo__k;
    real_type result__ = 1.0 / (t13 + t14 + 1) / t10 / xo__p * t8 * (-2 * t3 * t1 - 2 * xo__f * t1) / 2;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_5_5( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -1.0 / t11 * t8 * t5 * (-2 * t1 - 2 * xo__g) + 4 * xo__k * t26 * t5 * (-2 * t1 * xo__k - 2 * t16 * t18 - 2 * t16 * xo__f - 2 * xo__g * xo__k) - 8 * t10 / t24 / t11 * t8 * t42 + 2 * t26 * t42;
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_7( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t12  = xo__h * xo__h;
    real_type t13  = xo__k * xo__k;
    real_type result__ = -1.0 / (t12 + t13 + 1) / t10 * t8 * (-2 * t3 * t1 - 2 * xo__f * t1);
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
