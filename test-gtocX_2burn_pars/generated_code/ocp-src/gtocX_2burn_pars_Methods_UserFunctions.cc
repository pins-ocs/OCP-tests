...
namespace gtocX_2burn_parsDefine {
  ...
  gtocX_2burn_pars::x_position_D_4_6( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = t16 * t12 * xo__p * (-2 * t1 * xo__h + 2 * t3 * t4) - t29 * t16 * t25 * xo__p * (2 * t1 * t3 + 2 * t4 * xo__h) - 2 * xo__h * t41 * t12 * xo__p * (2 * t34 * t4 * xo__k - t1 * t32) + 2 * t29 * xo__h * t41 * t25 * xo__p * (2 * t1 * xo__k * t34 + t4 * t32);
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::x_position_D_5_6( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = t16 * t12 * xo__p * (2 * t3 * t4 + 2 * t2) - t29 * t16 * t25 * xo__p * (2 * t1 * t3 - 2 * t19) - 2 * xo__k * t39 * t12 * xo__p * (-t1 * t32 + 2 * t19 * t3) + 2 * t29 * xo__k * t39 * t25 * xo__p * (2 * t2 * t3 + t4 * t32);
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_4( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -1.0 / t18 * t15 * t12 * (-2 * xo__f * xo__k * xo__retrograde + 2 * t1 * xo__h - 2 * t3 * t4 + 2 * xo__g * xo__h) + 2 * xo__h / t35 * t15 * t12 * (t1 * (t16 - t17 + 1) - 2 * t4 * xo__k * xo__retrograde * xo__h - 2 * t3 * xo__f * xo__h + t16 * xo__g - t17 * xo__g + xo__g);
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_5( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = -1.0 / t18 * t15 * t12 * (-2 * t1 * xo__k - 2 * t3 * t4 - 2 * xo__retrograde * t6 - 2 * xo__g * xo__k) + 2 * xo__k / t34 * t15 * t12 * (t1 * (t16 - t17 + 1) - 2 * t4 * xo__k * t3 - 2 * xo__k * xo__retrograde * t6 + t16 * xo__g - t17 * xo__g + xo__g);
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::y_velocity_D_2_4( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t9   = t7 + t8 + 1;
    real_type t15  = t9 * t9;
    real_type result__ = -2 / t9 * t6 * xo__h * xo__retrograde + 2 * xo__h / t15 * xo__retrograde * (t7 - t8 - 1) * t6;
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
  ...
  gtocX_2burn_pars::y_velocity_D_2_5( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t9   = t7 + t8 + 1;
    real_type t15  = t9 * t9;
    real_type result__ = 2 / t9 * t6 * xo__k * xo__retrograde + 2 * xo__k / t15 * xo__retrograde * (t7 - t8 - 1) * t6;
    if ( m_debug ) {
      UTILS_ASSERT(
        Utils::is_finite(result__),
