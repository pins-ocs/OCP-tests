...
namespace gtocX_2burn_parsDefine {
  ...
  gtocX_2burn_pars::x_velocity_D_1_4( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = 1.0 / t19 * t16 * t12 * (-2 * xo__f * xo__k * xo__retrograde + 2 * t1 * xo__h - 2 * t3 * t4 + 2 * xo__g * xo__h) / 2 - xo__h / t37 * t16 * t12 * (t1 * (t17 - t18 + 1) - 2 * t4 * xo__k * xo__retrograde * xo__h - 2 * t3 * xo__f * xo__h + t17 * xo__g - t18 * xo__g + xo__g);
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_1_5( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type result__ = 1.0 / t19 * t16 * t12 * (-2 * t1 * xo__k - 2 * t3 * t4 - 2 * xo__retrograde * t6 - 2 * xo__g * xo__k) / 2 - xo__k / t36 * t16 * t12 * (t1 * (t17 - t18 + 1) - 2 * t4 * xo__k * t3 - 2 * xo__k * xo__retrograde * t6 + t17 * xo__g - t18 * xo__g + xo__g);
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
  ...
  gtocX_2burn_pars::x_velocity_D_7( real_type xo__p, real_type xo__f, real_type xo__g, real_type xo__h, real_type xo__k, real_type xo__L, real_type xo__retrograde ) const {
    ...
    real_type t13  = xo__h * xo__h;
    real_type t14  = xo__k * xo__k;
    real_type result__ = -1.0 / (t13 + t14 + 1) / t11 * t9 * (-2 * t2 * xo__h * xo__k - 2 * xo__f * xo__h * xo__k);
    if ( m_debug ) {
      UTILS_ASSERT(
        isRegular(result__),
