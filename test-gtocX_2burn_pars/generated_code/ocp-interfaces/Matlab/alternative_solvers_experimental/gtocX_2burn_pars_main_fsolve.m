...
ocp.setup( [DATA_PATH 'gtocX_2burn_pars_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = gtocX_2burn_pars_Mex('get_raw_solution',obj);
%J        = gtocX_2burn_pars_Mex('eval_JF',obj,Z,MU,U);
%f        = gtocX_2burn_pars_Mex('eval_F',obj,Z,MU,U);
