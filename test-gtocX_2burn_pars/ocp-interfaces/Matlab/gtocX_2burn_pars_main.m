...
%ocp.setup('../../data/gtocX_2burn_pars_Data.lua');
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%gtocX_2burn_pars_Mex('set_tracked',obj,tracked);
...
%x = gtocX_2burn_pars_Mex('get_raw_solution',obj);
%J = gtocX_2burn_pars_Mex('eval_JF',obj,x);
%f = gtocX_2burn_pars_Mex('eval_F',obj,x);
