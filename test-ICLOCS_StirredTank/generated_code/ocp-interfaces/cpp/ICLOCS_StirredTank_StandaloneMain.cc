...
main() {
  ...
  try {
    ...
    data_Parameters["w_time"] = w_time;
    data_Parameters["x1_f"] = 0.2632;
    data_Parameters["x2_f"] = 0.6519;
    ...
    data_Parameters["epsi_ctrl1"] = 0.001;
    data_Parameters["tol_ctrl0"] = tol_ctrl0;
    data_Parameters["tol_ctrl1"] = 0.001;
    data_Parameters["w_time_max"] = w_time_max;
    data_Parameters["w_time_min"] = 0.01;
...
ICLOCS_StirredTank_data.Mesh["segments"][0]["n"] = 400;
    ...
    if ( ok ) {
      ...
      file.open( "data/ICLOCS_StirredTank_OCP_result_NOT_CONVERGED.txt" );
    }
    file.precision(18);
