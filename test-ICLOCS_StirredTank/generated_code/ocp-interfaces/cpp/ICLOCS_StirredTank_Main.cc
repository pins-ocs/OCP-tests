...
main() {
  ...
  try {
    ICLOCS_StirredTank * m_model = new ICLOCS_StirredTank("ICLOCS_StirredTank",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/ICLOCS_StirredTank_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/ICLOCS_StirredTank_Data.lua";
    #endif
