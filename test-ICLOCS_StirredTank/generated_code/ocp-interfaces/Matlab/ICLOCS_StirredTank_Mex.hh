...
public:
  ...
  void do_x1bound( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_x1bound_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_x1bound_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_x2bound( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_x2bound_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_x2bound_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
