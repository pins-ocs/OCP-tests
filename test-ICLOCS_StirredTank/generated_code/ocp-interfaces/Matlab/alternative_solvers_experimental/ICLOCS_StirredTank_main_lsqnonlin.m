...
%ocp.setup(ICLOCS_StirredTank_data);
ocp.setup( [DATA_PATH 'ICLOCS_StirredTank_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = ICLOCS_StirredTank_Mex('get_raw_solution',obj);
%J        = ICLOCS_StirredTank_Mex('eval_JF',obj,Z,MU,U);
%f        = ICLOCS_StirredTank_Mex('eval_F',obj,Z,MU,U);
