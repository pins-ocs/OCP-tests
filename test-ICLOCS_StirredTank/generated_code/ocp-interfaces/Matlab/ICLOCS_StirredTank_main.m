...
%ocp.setup('../../data/ICLOCS_StirredTank_Data.lua');
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ICLOCS_StirredTank_Mex('set_tracked',obj,tracked);
...
%[Z,U] = ICLOCS_StirredTank_Mex('get_raw_solution',obj);
%J     = ICLOCS_StirredTank_Mex('eval_JF',obj,Z,U);
%f     = ICLOCS_StirredTank_Mex('eval_F',obj,Z,U);
