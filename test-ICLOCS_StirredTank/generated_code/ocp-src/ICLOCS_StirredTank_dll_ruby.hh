/*-----------------------------------------------------------------------*\
 |  file: ICLOCS_StirredTank_dll_ruby.hh                                 |
 |                                                                       |
...
namespace ICLOCS_StirredTankDefine {
  ...
  public:
    ...
    ICLOCS_StirredTank_Problem( integer n_threads, Console const * console )
    : model("ICLOCS_StirredTank",n_threads,console)
    , mesh( "mesh" )
    {
  ...
  */
  ...
  ICLOCS_STIRREDTANK_API_DLL
  bool
  ICLOCS_StirredTank_ocp_guess( char const id[], GenericContainer & gc_guess );
...
// EOF: ICLOCS_StirredTank_dll_ruby.hh
