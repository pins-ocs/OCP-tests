...
namespace ICLOCS_StirredTankDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer ICLOCS_StirredTank::DboundaryConditionsDxxp_numRows() const { return 4; }
  integer ICLOCS_StirredTank::DboundaryConditionsDxxp_numCols() const { return 5; }
  integer ICLOCS_StirredTank::DboundaryConditionsDxxp_nnz()     const { return 4; }

  void
  ICLOCS_StirredTank::DboundaryConditionsDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
