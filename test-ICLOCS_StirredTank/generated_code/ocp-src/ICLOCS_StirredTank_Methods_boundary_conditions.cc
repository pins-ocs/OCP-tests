...
namespace ICLOCS_StirredTankDefine {
  ...
  integer ICLOCS_StirredTank::boundaryConditions_numEqns() const { return 4; }
  ...
  integer ICLOCS_StirredTank::adjointBC_numEqns() const { return 5; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer ICLOCS_StirredTank::DadjointBCDxxp_numRows() const { return 5; }
  integer ICLOCS_StirredTank::DadjointBCDxxp_numCols() const { return 5; }
  integer ICLOCS_StirredTank::DadjointBCDxxp_nnz()     const { return 0; }

  void
  ICLOCS_StirredTank::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
