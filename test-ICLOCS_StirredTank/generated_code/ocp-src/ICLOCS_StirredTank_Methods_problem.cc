...
namespace ICLOCS_StirredTankDefine {
  ...
  ICLOCS_StirredTank::H_eval(
    ...
    real_type t10  = log(t1);
    real_type t14  = pow(t5 - ModelPars[iM_x1_f], 2);
    real_type t17  = pow(t7 - ModelPars[iM_x2_f], 2);
    real_type t18  = U__[iU_u];
    real_type t21  = pow(t18 - ModelPars[iM_u_f], 2);
    real_type t28  = 1.0 / ModelPars[iM_theta];
    real_type t35  = exp(-1.0 / t7 * ModelPars[iM_En]);
    real_type t36  = t35 * t5 * ModelPars[iM_k];
    real_type result__ = t4 + t6 + t8 + (t10 * ModelPars[iM_w_time] + t14 + t17 + t21) * t1 + (t28 * (1 - t5) - t36) * t1 * L__[iL_lambda1__xo] + (t28 * (ModelPars[iM_Tf] - t7) + t36 - (t7 - ModelPars[iM_Tc]) * t18 * ModelPars[iM_a]) * t1 * L__[iL_lambda2__xo];
    if ( m_debug ) {
  ...
  real_type
  ICLOCS_StirredTank::penalties_eval(
    ...
    real_const_ptr X__ = NODE__.x;
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    real_type t4   = tfbound(P__[iP_TimeSize] - ModelPars[iM_T_min]);
    real_type t6   = x1bound(X__[iX_x1]);
    real_type t8   = x2bound(X__[iX_x2]);
    real_type result__ = t4 + t6 + t8;
    if ( m_debug ) {
  ...
  real_type
  ICLOCS_StirredTank::control_penalties_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__
  ) const {
  ...
  integer
  ICLOCS_StirredTank::DJDp_numEqns() const
  { return 1; }

  void
  ICLOCS_StirredTank::DJDp_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
    ...
    real_const_ptr X__ = NODE__.x;
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    result__[ 0   ] = ALIAS_tfbound_D(P__[iP_TimeSize] - ModelPars[iM_T_min]);
    if ( m_debug )
  ...
  integer
  ICLOCS_StirredTank::DJDu_numEqns() const
  { return 1; }

  void
  ICLOCS_StirredTank::DJDu_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  ICLOCS_StirredTank::segmentLink_numEqns() const
  { return 0; }
  ...
  integer
  ICLOCS_StirredTank::DsegmentLinkDxp_numRows() const
  { return 0; }

  integer
  ICLOCS_StirredTank::DsegmentLinkDxp_numCols() const
  { return 0; }

  integer
  ICLOCS_StirredTank::DsegmentLinkDxp_nnz() const
  { return 0; }
  ...
  integer
  ICLOCS_StirredTank::jump_numEqns() const
  { return 4; }
  ...
  integer
  ICLOCS_StirredTank::DjumpDxlxlp_numRows() const
  { return 4; }

  integer
  ICLOCS_StirredTank::DjumpDxlxlp_numCols() const
  { return 9; }

  integer
  ICLOCS_StirredTank::DjumpDxlxlp_nnz() const
  { return 8; }
  ...
  integer
  ICLOCS_StirredTank::post_numEqns() const
  { return 1; }
  ...
  integer
  ICLOCS_StirredTank::integrated_post_numEqns() const
  { return 0; }
