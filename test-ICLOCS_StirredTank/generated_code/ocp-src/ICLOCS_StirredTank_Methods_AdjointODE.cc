...
namespace ICLOCS_StirredTankDefine {
  ...
  ICLOCS_StirredTank::Hx_eval(
    ...
    result__[ 1   ] = t20 - t13 * t24 * t9 * t1 * t8 * t5 + (t13 * t24 * t9 * t1 * t8 - ModelPars[iM_a] * U__[iU_u] - t7) * t18;
    if ( m_debug )
  ...
  ICLOCS_StirredTank::DHxDx_sparse(
    ...
    real_type t24  = 1.0 / t9 / t8;
    real_type t29  = t7 * t7;
    real_type t31  = t9 * t9;
    real_type t32  = 1.0 / t31;
    real_type t36  = t1 * t5;
    result__[ 3   ] = t21 + 2 * t14 * t24 * t7 * t1 * t6 - t14 * t32 * t29 * t1 * t6 + (-2 * t14 * t24 * t7 * t36 + t14 * t32 * t29 * t36) * t18;
    if ( m_debug )
  ...
  ICLOCS_StirredTank::DHxDp_sparse(
    ...
    result__[ 0   ] = (-t9 * t4 - t3) * t1 + t9 * t4 * t13;
    real_type t17  = X__[iX_x1];
    real_type t19  = t6 * t6;
    real_type t22  = t9 / t19 * t5;
    result__[ 1   ] = -t22 * t17 * t4 * t1 + (t22 * t17 * t4 - ModelPars[iM_a] * U__[iU_u] - t3) * t13;
    if ( m_debug )
