...
#ifndef ICLOCS_STIRREDTANK_DOT_HH
#define ICLOCS_STIRREDTANK_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef ICLOCS_STIRREDTANK_API_DLL
    #ifdef ICLOCS_STIRREDTANK_EXPORT
      #define ICLOCS_STIRREDTANK_API_DLL __declspec(dllexport)
    #elif defined(ICLOCS_STIRREDTANK_IMPORT)
      #define ICLOCS_STIRREDTANK_API_DLL __declspec(dllimport)
    #else
      #define ICLOCS_STIRREDTANK_API_DLL
    #endif
  #endif
...
namespace ICLOCS_StirredTankDefine {
  ...
  class ICLOCS_StirredTank : public Mechatronix::Discretized_Indirect_OCP {
    ...
    // Constraints 1D  - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    Mechatronix::PenaltyBarrier1DInterval tfbound;
    ...
    ICLOCS_StirredTank( ICLOCS_StirredTank const & );
    ICLOCS_StirredTank const & operator = ( ICLOCS_StirredTank const & );
...
namespace ICLOCS_StirredTankLoad {
  using ICLOCS_StirredTankDefine::ICLOCS_StirredTank;

}

#endif

// EOF: ICLOCS_StirredTank.hh
