...
namespace SlidingModeDefine {
  ...
  integer SlidingMode::bc_numEqns() const { return 3; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SlidingMode::DbcDxxp_numRows() const { return 3; }
  integer SlidingMode::DbcDxxp_numCols() const { return 4; }
  integer SlidingMode::DbcDxxp_nnz()     const { return 3; }

  void
  SlidingMode::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SlidingMode::D2bcD2xxp_numRows() const { return 4; }
  integer SlidingMode::D2bcD2xxp_numCols() const { return 4; }
  integer SlidingMode::D2bcD2xxp_nnz()     const { return 0; }

  void
  SlidingMode::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  SlidingMode::D2bcD2xxp_sparse(
    NodeQX const &          LEFT__,
    NodeQX const &          RIGHT__,
    P_const_p_type          P__,
  ...
  integer SlidingMode::fd_BC_numEqns() const { return 4; }

  void
  SlidingMode::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SlidingMode::Dfd_BCDxlxlp_numRows() const { return 4; }
  integer SlidingMode::Dfd_BCDxlxlp_numCols() const { return 8; }
  integer SlidingMode::Dfd_BCDxlxlp_nnz()     const { return 4; }

  void
  SlidingMode::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  SlidingMode::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
