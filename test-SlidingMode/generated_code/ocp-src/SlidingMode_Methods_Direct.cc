...
namespace SlidingModeDefine {
  ...
  integer SlidingMode::fd_ode_numEqns() const { return 2; }

  void
  SlidingMode::fd_ode_eval(
  ...
  integer SlidingMode::Dfd_odeDxxup_nnz()     const { return 4; }
  ...
  integer SlidingMode::D2fd_odeD2xxup_nnz()     const { return 0; }
