...
namespace SlidingModeDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SlidingMode::D2lagrangeD2xup_numRows() const { return 3; }
  integer SlidingMode::D2lagrangeD2xup_numCols() const { return 3; }
  integer SlidingMode::D2lagrangeD2xup_nnz()     const { return 0; }

  void
  SlidingMode::D2lagrangeD2xup_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  SlidingMode::D2lagrangeD2xup_sparse(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
