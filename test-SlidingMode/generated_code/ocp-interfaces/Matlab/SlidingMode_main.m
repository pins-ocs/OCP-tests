...
%ocp.setup(SlidingMode_data);
ocp.setup('../../data/SlidingMode_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%SlidingMode_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = SlidingMode_Mex('get_raw_solution',obj);
%J     = SlidingMode_Mex('eval_JF',obj,Z,MU,U);
%f     = SlidingMode_Mex('eval_F',obj,Z,MU,U);
