...
#ifndef SLIDINGMODE_DOT_HH
#define SLIDINGMODE_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef SLIDINGMODE_API_DLL
    #ifdef SLIDINGMODE_EXPORT
      #define SLIDINGMODE_API_DLL __declspec(dllexport)
    #elif defined(SLIDINGMODE_IMPORT)
      #define SLIDINGMODE_API_DLL __declspec(dllimport)
    #else
      #define SLIDINGMODE_API_DLL
    #endif
  #endif
...
namespace SlidingModeDefine {
  ...
  class SlidingMode : public Mechatronix::Discretized_Indirect_OCP {
    ...
    SlidingMode const & operator = ( SlidingMode const & );
  ...
  public:
    ...
    SLIDINGMODE_API_DLL virtual
    ~SlidingMode() MECHATRONIX_OVERRIDE;
...
namespace SlidingModeLoad {
  using SlidingModeDefine::SlidingMode;
