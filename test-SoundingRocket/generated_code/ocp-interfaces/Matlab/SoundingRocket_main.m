...
% create object
ocp = SoundingRocket( 'SoundingRocket' );
...
%ocp.setup(SoundingRocket_data);
ocp.setup('../../data/SoundingRocket_Data');  % automatically try extension .rb and .lua
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%SoundingRocket_Mex('set_tracked',obj,tracked);
