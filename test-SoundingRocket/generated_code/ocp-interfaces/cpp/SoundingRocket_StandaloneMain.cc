...
main() {
  ...
  try {
    ...
    gc_data["DumpFile"] = "SoundingRocket_dump";
    ...
    data_Parameters["W"] = W;
    data_Parameters["g"] = g;
    data_Parameters["kappa"] = 0.002;
    data_Parameters["Tf_guess"] = 20;

    // Guess Parameters

    // Boundary Conditions
    data_Parameters["x3_f"] = x3_f;
    ...
    data_Parameters["epsi1"] = 1e-06;
    data_Parameters["tol0"] = tol0;
    data_Parameters["tol1"] = 1e-06;
...
SoundingRocket_data.Mesh["s0"] = 0;
SoundingRocket_data.Mesh["segments"][0]["length"] = 1;
SoundingRocket_data.Mesh["segments"][0]["n"] = 100;
    ...
    std::ofstream file;
    if ( ok ) {
      file.open( "data/SoundingRocket_OCP_result.txt" );
    } else {
      cout << gc_solution("solver_message").get_string() << '\n';
      // dump solution to file
      file.open( "data/SoundingRocket_OCP_result_NOT_CONVERGED.txt" );
    }
    file.precision(18);
