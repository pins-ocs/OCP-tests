...
namespace SoundingRocketDefine {
  ...
  using namespace SoundingRocketLoad;
  ...
  class SoundingRocket_Problem {

    SoundingRocket m_model;
    ...
    SoundingRocket_Problem( SoundingRocket_Problem const & );
    SoundingRocket_Problem const & operator = ( SoundingRocket_Problem const & );
  ...
  public:
    ...
    : m_model("SoundingRocket",console,TP)
    , m_mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "SoundingRocket::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: SoundingRocket_dll_pins.hh
