...
#ifndef SOUNDINGROCKET_DOT_HH
#define SOUNDINGROCKET_DOT_HH
...
// User Header (end)
  ...
  #ifndef SOUNDINGROCKET_API_DLL
    #ifdef SOUNDINGROCKET_EXPORT
      #define SOUNDINGROCKET_API_DLL __declspec(dllexport)
    #elif defined(SOUNDINGROCKET_IMPORT)
      #define SOUNDINGROCKET_API_DLL __declspec(dllimport)
    #else
      #define SOUNDINGROCKET_API_DLL
    #endif
  #endif
...
namespace SoundingRocketDefine {
  ...
  class SoundingRocket : public Mechatronix::Discretized_Indirect_OCP {
    ...
    SoundingRocket( SoundingRocket const & );
    SoundingRocket const & operator = ( SoundingRocket const & );
...
namespace SoundingRocketLoad {
  using SoundingRocketDefine::SoundingRocket;

}

#endif

// EOF: SoundingRocket.hh
