...
namespace SoundingRocketDefine {
  ...
  void
  SoundingRocket::p_guess_eval( P_pointer_type P__ ) const {
  ...
  void
  SoundingRocket::xlambda_guess_eval(
    integer              i_segment,
    ...
    X__[ iX_x1 ] = Q__[iQ_zeta] * ModelPars[iM_Tf_guess];
    X__[ iX_x2 ] = 0;
    X__[ iX_x3 ] = X__[iX_x1];
  ...
  // pars_check_strings
  #define Xoptima__message_pars_check_0 "0 < Tf"

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  bool
  SoundingRocket::p_check( P_const_pointer_type P__ ) const {
    /* REMOVED */ Xoptima__check__pars__lt(0, P__[iP_Tf], Xoptima__message_pars_check_0);
    return true;
  }
  ...
  bool
  SoundingRocket::xlambda_check_node(
    integer              ipos,
  ...
  bool
  SoundingRocket::xlambda_check_cell(
    integer              icell,
  ...
  integer SoundingRocket::u_guess_numEqns() const { return 1; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  SoundingRocket::u_guess_eval(
    NodeType2 const    & LEFT__,
    NodeType2 const    & RIGHT__,
    P_const_pointer_type P__,
    ...
    UGUESS__[ iU_u ] = ModelPars[iM_B] / 2;
    if ( m_debug )
  ...
  bool
  SoundingRocket::u_check_if_admissible(
    NodeType2 const    & NODE__,
