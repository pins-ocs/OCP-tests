...
namespace Brachiostocrona2Define {
  ...
  integer Brachiostocrona2::boundaryConditions_numEqns() const { return 5; }
  ...
  integer Brachiostocrona2::adjointBC_numEqns() const { return 7; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Brachiostocrona2::DadjointBCDxxp_numRows() const { return 7; }
  integer Brachiostocrona2::DadjointBCDxxp_numCols() const { return 7; }
  integer Brachiostocrona2::DadjointBCDxxp_nnz()     const { return 0; }

  void
  Brachiostocrona2::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
