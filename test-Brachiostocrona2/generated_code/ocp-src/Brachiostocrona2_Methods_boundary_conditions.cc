...
namespace Brachiostocrona2Define {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Brachiostocrona2::DboundaryConditionsDxxp_numRows() const { return 5; }
  integer Brachiostocrona2::DboundaryConditionsDxxp_numCols() const { return 7; }
  integer Brachiostocrona2::DboundaryConditionsDxxp_nnz()     const { return 5; }

  void
  Brachiostocrona2::DboundaryConditionsDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
