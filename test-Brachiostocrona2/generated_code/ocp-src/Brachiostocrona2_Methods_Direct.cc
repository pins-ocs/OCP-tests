...
namespace Brachiostocrona2Define {
  ...
  integer Brachiostocrona2::Dfd_odeDxxup_nnz()     const { return 6; }
  ...
  Brachiostocrona2::Dfd_odeDxxup_sparse(
    ...
    real_type t2   = __INV_DZETA * ModelPars[iM_mass];
    result__[ 4   ] = -t2;
    result__[ 5   ] = t2;
    if ( m_debug )
  ...
  integer Brachiostocrona2::D2fd_odeD2xxup_nnz()     const { return 0; }
