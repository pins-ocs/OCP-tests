...
namespace Brachiostocrona2Define {
  ...
  */
  void
  Brachiostocrona2::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "Brachiostocrona2::setup_parameters: Missing key `Parameters` in data\n"
    );
  ...
  */
  void
  Brachiostocrona2::setup_classes( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Constraints"),
      "Brachiostocrona2::setup_classes: Missing key `Parameters` in data\n"
    );
    GenericContainer const & gc = gc_data("Constraints");
    // Initialize Constraints 1D
    UTILS_ASSERT0(
      gc.exists("TimePositive"),
      "in Brachiostocrona2::setup_classes(gc) missing key: ``TimePositive''\n"
    );
  ...
  */
  void
  Brachiostocrona2::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  Brachiostocrona2::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  Brachiostocrona2::setup_controls( GenericContainer const & gc_data ) {
  ...
  */
  void
  Brachiostocrona2::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "Brachiostocrona2::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in Brachiostocrona2::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  Brachiostocrona2::info_model( integer level ) const {
    ...
    m_console->message( TimePositive.info(),level);
