...
#ifndef BRACHIOSTOCRONA2_DOT_HH
#define BRACHIOSTOCRONA2_DOT_HH
...
// User Header (end)
  ...
  #ifndef BRACHIOSTOCRONA2_API_DLL
    #ifdef BRACHIOSTOCRONA2_EXPORT
      #define BRACHIOSTOCRONA2_API_DLL __declspec(dllexport)
    #elif defined(BRACHIOSTOCRONA2_IMPORT)
      #define BRACHIOSTOCRONA2_API_DLL __declspec(dllimport)
    #else
...
namespace Brachiostocrona2Define {
  ...
  class Brachiostocrona2 : public Mechatronix::Discretized_Indirect_OCP {
    ...
    Brachiostocrona2( Brachiostocrona2 const & );
...
namespace Brachiostocrona2Load {
  using Brachiostocrona2Define::Brachiostocrona2;

}

#endif

// EOF: Brachiostocrona2.hh
