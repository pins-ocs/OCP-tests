...
namespace Brachiostocrona2Define {
  ...
  integer Brachiostocrona2::JPxpu_numEqns() const { return 5; }

  void
  Brachiostocrona2::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer Brachiostocrona2::JUxpu_numEqns() const { return 5; }

  void
  Brachiostocrona2::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer Brachiostocrona2::LTxpu_numEqns() const { return 5; }

  void
  Brachiostocrona2::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
