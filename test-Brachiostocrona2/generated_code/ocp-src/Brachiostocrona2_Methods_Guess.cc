...
namespace Brachiostocrona2Define {
  ...
  void
  Brachiostocrona2::p_guess_eval( P_p_type P__ ) const {
  ...
  void
  Brachiostocrona2::xlambda_guess_eval(
    integer        i_segment,
    Q_const_p_type Q__,
    P_const_p_type P__,
    X_p_type       X__,
  ...
  bool
  Brachiostocrona2::p_check( P_const_p_type P__ ) const {
  ...
  bool
  Brachiostocrona2::xlambda_check_node(
    integer         ipos,
  ...
  bool
  Brachiostocrona2::penalties_check_node(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
  ...
  integer Brachiostocrona2::u_guess_numEqns() const { return 1; }
