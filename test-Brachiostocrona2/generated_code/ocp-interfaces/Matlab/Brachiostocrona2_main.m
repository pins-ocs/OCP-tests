...
% create object
ocp = Brachiostocrona2( 'Brachiostocrona2' );
...
ocp.setup('../../data/Brachiostocrona2_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Brachiostocrona2_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = Brachiostocrona2_Mex('get_raw_solution',obj);
%J     = Brachiostocrona2_Mex('eval_JF',obj,Z,MU,U);
%f     = Brachiostocrona2_Mex('eval_F',obj,Z,MU,U);
