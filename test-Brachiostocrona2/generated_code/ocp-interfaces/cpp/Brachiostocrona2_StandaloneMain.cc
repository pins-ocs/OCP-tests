...
main() {
  ...
  try {
    ...
    Brachiostocrona2 model("Brachiostocrona2",n_threads,&console);
    ...
    gc_data["DumpFile"] = "Brachiostocrona2_dump";
    ...
    data_TimePositive["subType"]   = "PENALTY_REGULAR";
    data_TimePositive["epsilon"]   = 0.1;
