...
using namespace Brachiostocrona2Load;
...
"Brachiostocrona2_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "Brachiostocrona2"
#define MODEL_CLASS Brachiostocrona2
...
public:
  ...
  do_arctan2_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('arctan2_D_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->arctan2_D_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_arctan2_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('arctan2_D_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->arctan2_D_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_theta_sol(
    ...
    #define CMD MODEL_NAME "_Mex('theta_sol', obj, ... args ... ): "
    CHECK_IN( 6 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->theta_sol(arg0,arg1,arg2,arg3) );
    #undef CMD
  }
  ...
  do_theta_sol_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('theta_sol_D_1', obj, ... args ... ): "
    CHECK_IN( 6 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->theta_sol_D_1(arg0,arg1,arg2,arg3) );
    #undef CMD
  }
  ...
  do_theta_sol_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('theta_sol_D_2', obj, ... args ... ): "
    CHECK_IN( 6 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->theta_sol_D_2(arg0,arg1,arg2,arg3) );
    #undef CMD
  }
  ...
  do_theta_sol_D_3(
    ...
    #define CMD MODEL_NAME "_Mex('theta_sol_D_3', obj, ... args ... ): "
    CHECK_IN( 6 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->theta_sol_D_3(arg0,arg1,arg2,arg3) );
    #undef CMD
  }
  ...
  do_theta_sol_D_4(
    ...
    #define CMD MODEL_NAME "_Mex('theta_sol_D_4', obj, ... args ... ): "
    CHECK_IN( 6 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->theta_sol_D_4(arg0,arg1,arg2,arg3) );
    #undef CMD
  }
...
do_arctan2_D_1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('arctan2_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_arctan2_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_arctan2_D_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('arctan2_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_arctan2_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_theta_sol(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('theta_sol',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_theta_sol( nlhs, plhs, nrhs, prhs );
}
...
do_theta_sol_D_1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('theta_sol_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_theta_sol_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_theta_sol_D_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('theta_sol_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_theta_sol_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_theta_sol_D_3(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('theta_sol_D_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_theta_sol_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_theta_sol_D_4(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('theta_sol_D_4',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_theta_sol_D_4( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"arctan2",do_arctan2},
  {"arctan2_D_1",do_arctan2_D_1},
  {"arctan2_D_2",do_arctan2_D_2},
  {"theta_sol",do_theta_sol},
  {"theta_sol_D_1",do_theta_sol_D_1},
  {"theta_sol_D_2",do_theta_sol_D_2},
  {"theta_sol_D_3",do_theta_sol_D_3},
  {"theta_sol_D_4",do_theta_sol_D_4},
  {"new",do_new},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "Brachiostocrona2_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "Brachiostocrona2_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
