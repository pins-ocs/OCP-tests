...
% create object
ocp = WorstCaseScenario( 'WorstCaseScenario' );
...
%ocp.setup(WorstCaseScenario_data);
%ocp.setup('../../data/WorstCaseScenario_Data.lua');
ocp.setup('../../data/WorstCaseScenario_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%WorstCaseScenario_Mex('set_tracked',obj,tracked);
...
%[Z,U] = WorstCaseScenario_Mex('get_raw_solution',obj);
%J     = WorstCaseScenario_Mex('eval_JF',obj,Z,U);
%f     = WorstCaseScenario_Mex('eval_F',obj,Z,U);
