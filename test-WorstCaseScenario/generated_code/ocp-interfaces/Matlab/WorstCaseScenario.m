...
classdef WorstCaseScenario < handle
  ...
  methods
    ...
    function IPOPT_hess = eval_IPOPT_hess( self, iseg, q, x, lambda, v, u, pars, sigma )
      IPOPT_hess = WorstCaseScenario_Mex( ...
    ...
    function res = DboundaryConditionsDxxp_pattern( self )
      res = WorstCaseScenario_Mex('eval_DboundaryConditionsDxxp_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    ...
    function res = IPOPT_hess_pattern( self )
      res = WorstCaseScenario_Mex('eval_IPOPT_hess_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
