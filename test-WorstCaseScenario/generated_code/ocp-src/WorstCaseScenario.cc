...
namespace WorstCaseScenarioDefine {
  ...
  */
  void
  WorstCaseScenario::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "WorstCaseScenario::setup_parameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  WorstCaseScenario::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  WorstCaseScenario::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  WorstCaseScenario::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  WorstCaseScenario::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  WorstCaseScenario::setup_controls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "WorstCaseScenario::setup_classes: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  WorstCaseScenario::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "WorstCaseScenario::setup_pointers: Missing key `Pointers` in data\n"
    );
  ...
  */
  void
  WorstCaseScenario::info_model( integer level ) const {
