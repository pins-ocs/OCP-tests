...
namespace WorstCaseScenarioDefine {
  ...
  integer WorstCaseScenario::JPxpu_numEqns() const { return 2; }

  void
  WorstCaseScenario::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer WorstCaseScenario::JUxpu_numEqns() const { return 2; }

  void
  WorstCaseScenario::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    result__[ 0   ] = 0;
    result__[ 1   ] = ALIAS_uControl_D_1(U__[iU_u], 0, 1);
    if ( m_debug )
  ...
  integer WorstCaseScenario::LTxpu_numEqns() const { return 2; }

  void
  WorstCaseScenario::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
