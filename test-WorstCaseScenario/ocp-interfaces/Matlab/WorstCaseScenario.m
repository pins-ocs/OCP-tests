...
classdef WorstCaseScenario < handle
  ...
  methods
    ...
    function ok = solve( self )
      ...
      ok = WorstCaseScenario_Mex( 'solve', self.objectHandle );
    end
    ...
    function res = x( self, varargin  )
      res = WorstCaseScenario_Mex( 'get_solution', self.objectHandle, 'x', varargin{:} );
    end
    ...
    function res = lambda1( self, varargin )
      res = WorstCaseScenario_Mex( 'get_solution', self.objectHandle, 'lambda1__xo', varargin{:} );
    end
    ...
    function res = u( self, varargin )
      res = WorstCaseScenario_Mex( 'get_solution', self.objectHandle, 'u', varargin{:} );
    end
