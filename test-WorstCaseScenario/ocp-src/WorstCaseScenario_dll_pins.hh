/*-----------------------------------------------------------------------*\
 |  file: WorstCaseScenario_dll_pins.hh                                  |
 |                                                                       |
...
namespace WorstCaseScenarioDefine {
  ...
  class WorstCaseScenario_Problem {

    WorstCaseScenario model;
    ...
    WorstCaseScenario_Problem( WorstCaseScenario_Problem const & );
    WorstCaseScenario_Problem const & operator = ( WorstCaseScenario_Problem const & );
  ...
  public:
    ...
    WorstCaseScenario_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("WorstCaseScenario",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "WorstCaseScenario::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: WorstCaseScenario_dll_pins.hh
