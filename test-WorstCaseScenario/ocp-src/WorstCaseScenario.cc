...
namespace WorstCaseScenarioDefine {
  ...
  */
  void
  WorstCaseScenario::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  WorstCaseScenario::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "WorstCaseScenario::setupParameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in WorstCaseScenario::setup not all parameters are set!\n"
    );
  }

  void
  WorstCaseScenario::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  WorstCaseScenario::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  WorstCaseScenario::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  WorstCaseScenario::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  WorstCaseScenario::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "WorstCaseScenario::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  WorstCaseScenario::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "WorstCaseScenario::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in WorstCaseScenario::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  WorstCaseScenario::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  WorstCaseScenario::setup( GenericContainer const & gc ) {

    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("WorstCaseScenario::setup, Debug");
  ...
  */
  void
  WorstCaseScenario::get_names( GenericContainer & out ) const {
  ...
  */
  void
  WorstCaseScenario::diagnostic( GenericContainer const & gc ) {
  ...
  void
  WorstCaseScenario::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
