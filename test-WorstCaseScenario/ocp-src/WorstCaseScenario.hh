...
#ifndef WORSTCASESCENARIO_DOT_HH
#define WORSTCASESCENARIO_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
    ...
    #ifdef WORSTCASESCENARIO_EXPORT
      #define WORSTCASESCENARIO_API_DLL __declspec(dllexport)
    #elif defined(WORSTCASESCENARIO_IMPORT)
      #define WORSTCASESCENARIO_API_DLL __declspec(dllimport)
    #else
      #define WORSTCASESCENARIO_API_DLL
    #endif
  #endif
...
namespace WorstCaseScenarioDefine {
  ...
  class WorstCaseScenario : public Mechatronix::Discretized_Indirect_OCP {
    ...
    WorstCaseScenario( WorstCaseScenario const & );
    WorstCaseScenario const & operator = ( WorstCaseScenario const & );
  ...
  public:
    ...
    ~WorstCaseScenario() MECHATRONIX_OVERRIDE;
...
namespace WorstCaseScenarioLoad {
  using WorstCaseScenarioDefine::WorstCaseScenario;

}

#endif

// EOF: WorstCaseScenario.hh
