...
namespace Hager_2000Define {
  ...
  integer Hager_2000::JPxpu_numEqns() const { return 2; }

  void
  Hager_2000::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer Hager_2000::JUxpu_numEqns() const { return 2; }

  void
  Hager_2000::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer Hager_2000::LTxpu_numEqns() const { return 2; }

  void
  Hager_2000::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
