...
#ifndef HAGER_2000_DOT_HH
#define HAGER_2000_DOT_HH
...
// User Header (end)
  ...
  #ifndef HAGER_2000_API_DLL
    #ifdef HAGER_2000_EXPORT
      #define HAGER_2000_API_DLL __declspec(dllexport)
    #elif defined(HAGER_2000_IMPORT)
      #define HAGER_2000_API_DLL __declspec(dllimport)
    #else
      #define HAGER_2000_API_DLL
    #endif
  #endif
...
namespace Hager_2000Define {
  ...
  class Hager_2000 : public Mechatronix::Discretized_Indirect_OCP {
    ...
    Hager_2000( Hager_2000 const & );
    Hager_2000 const & operator = ( Hager_2000 const & );
  ...
  public:
    ...
    HAGER_2000_API_DLL real_type x_exact      ( real_type xo__t ) const;
    HAGER_2000_API_DLL real_type x_exact_D    ( real_type xo__t ) const;
    HAGER_2000_API_DLL real_type x_exact_DD   ( real_type xo__t ) const;
    HAGER_2000_API_DLL real_type u_exact      ( real_type xo__t ) const;
    HAGER_2000_API_DLL real_type u_exact_D    ( real_type xo__t ) const;
    HAGER_2000_API_DLL real_type u_exact_DD   ( real_type xo__t ) const;
...
namespace Hager_2000Load {
  using Hager_2000Define::Hager_2000;
