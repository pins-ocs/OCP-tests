...
namespace Hager_2000Define {
  ...
  public:
    ...
    HAGER_2000_API_DLL
    Hager_2000_Problem( ThreadPool * TP, Console const * console )
    : model("Hager_2000",TP,console)
    , mesh( "mesh" )
    {
  ...
  */
  ...
  HAGER_2000_API_DLL
  bool
  Hager_2000_ocp_guess( char const id[], GenericContainer & gc_guess );
