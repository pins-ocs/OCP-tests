...
namespace Hager_2000Define {
  ...
  void
  Hager_2000::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  Hager_2000::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  Hager_2000::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  integer
  Hager_2000::u_guess_numEqns() const
  { return 1; }
  ...
  bool
  Hager_2000::u_check_if_admissible(
    NodeType2 const    & NODE__,
