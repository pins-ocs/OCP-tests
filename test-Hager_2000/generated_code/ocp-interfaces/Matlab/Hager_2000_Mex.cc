...
public:
  ...
  do_eval_F(
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "Hager_2000_Mex('eval_F',...) error: {}", exc.what() ).c_str() );
      ok = false;
    } catch ( ... ) {
...
do_x_exact(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_x_exact( nlhs, plhs, nrhs, prhs );
}
...
do_x_exact_D(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_x_exact_D( nlhs, plhs, nrhs, prhs );
}
...
do_x_exact_DD(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_x_exact_DD( nlhs, plhs, nrhs, prhs );
}
...
do_u_exact(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_u_exact( nlhs, plhs, nrhs, prhs );
}
...
do_u_exact_D(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_u_exact_D( nlhs, plhs, nrhs, prhs );
}
...
do_u_exact_DD(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_u_exact_DD( nlhs, plhs, nrhs, prhs );
}
