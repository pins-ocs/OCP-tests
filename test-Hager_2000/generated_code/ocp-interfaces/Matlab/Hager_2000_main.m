...
%ocp.setup(Hager_2000_data);
ocp.setup('../../data/Hager_2000_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Hager_2000_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = Hager_2000_Mex('get_raw_solution',obj);
%J     = Hager_2000_Mex('eval_JF',obj,Z,MU,U);
%f     = Hager_2000_Mex('eval_F',obj,Z,MU,U);
