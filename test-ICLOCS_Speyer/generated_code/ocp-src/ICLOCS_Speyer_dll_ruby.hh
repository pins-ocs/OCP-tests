...
namespace ICLOCS_SpeyerDefine {
  ...
  public:
    ...
    ICLOCS_Speyer_Problem( integer n_threads, Console const * console )
    : model("ICLOCS_Speyer",n_threads,console)
    , mesh( "mesh" )
    {
  ...
  */
  ...
  ICLOCS_SPEYER_API_DLL
  bool
  ICLOCS_Speyer_ocp_guess( char const id[], GenericContainer & gc_guess );
