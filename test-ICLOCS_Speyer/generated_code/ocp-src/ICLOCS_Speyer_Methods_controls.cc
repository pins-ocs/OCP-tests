...
namespace ICLOCS_SpeyerDefine {
  ...
  void
  ICLOCS_Speyer::DuDxlxlp_full_analytic(
    NodeType2 const &          LEFT__,
    NodeType2 const &          RIGHT__,
    P_const_pointer_type       P__,
    U_const_pointer_type       UM__,
...
// EOF: ICLOCS_Speyer_Methods_controls.cc
