...
namespace ICLOCS_SpeyerDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer ICLOCS_Speyer::DgDxpm_numRows() const { return 1; }
  integer ICLOCS_Speyer::DgDxpm_numCols() const { return 4; }
  integer ICLOCS_Speyer::DgDxpm_nnz()     const { return 1; }

  void
  ICLOCS_Speyer::DgDxpm_pattern( integer iIndex[], integer jIndex[] ) const {
