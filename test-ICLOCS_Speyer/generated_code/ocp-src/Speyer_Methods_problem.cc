...
namespace SpeyerDefine {
  ...
  void
  Speyer::continuation_step_0( real_type s ) {
  ...
  integer
  Speyer::DmayerDxxp_numEqns() const
  { return 4; }

  void
  Speyer::DmayerDxxp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  Speyer::DlagrangeDxup_numEqns() const
  { return 3; }

  void
  Speyer::DlagrangeDxup_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  Speyer::integrated_post_numEqns() const
  { return 0; }

  void
  Speyer::integrated_post_eval(
    NodeType2 const    & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
