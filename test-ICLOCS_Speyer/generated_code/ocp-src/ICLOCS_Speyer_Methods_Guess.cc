...
namespace ICLOCS_SpeyerDefine {
  ...
  void
  ICLOCS_Speyer::p_guess_eval( P_p_type P__ ) const {
  }
  ...
  bool
  ICLOCS_Speyer::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  ICLOCS_Speyer::penalties_check_node(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
  ...
  ICLOCS_Speyer::u_guess_eval(
    ...
    UGUESS__[ iU_u ] = -MU__[1] / ModelPars[iM_b];
    if ( m_debug )
