...
namespace ICLOCS_SpeyerDefine {
  ...
  void
  ICLOCS_Speyer::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  ICLOCS_Speyer::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  ICLOCS_Speyer::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  ICLOCS_Speyer::xlambda_check_node(
    integer              ipos,
  ...
  bool
  ICLOCS_Speyer::xlambda_check_cell(
    integer              icell,
  ...
  integer ICLOCS_Speyer::u_guess_numEqns() const { return 1; }

  void
  ICLOCS_Speyer::u_guess_eval(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    ...
    UGUESS__[ iU_u ] = -L__[iL_lambda2__xo] / ModelPars[iM_b];
    if ( m_debug )
  ...
  bool
  ICLOCS_Speyer::u_check_if_admissible(
    NodeType2 const    & NODE__,
