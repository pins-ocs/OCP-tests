...
namespace ICLOCS_SpeyerDefine {
  ...
  integer ICLOCS_Speyer::JPxpu_numEqns() const { return 3; }

  void
  ICLOCS_Speyer::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer ICLOCS_Speyer::JUxpu_numEqns() const { return 3; }

  void
  ICLOCS_Speyer::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer ICLOCS_Speyer::LTxpu_numEqns() const { return 3; }

  void
  ICLOCS_Speyer::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
