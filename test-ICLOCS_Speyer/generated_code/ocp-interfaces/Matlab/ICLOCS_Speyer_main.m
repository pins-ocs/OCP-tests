...
% create object
ocp = ICLOCS_Speyer( 'ICLOCS_Speyer' );
...
%ocp.setup(ICLOCS_Speyer_data);
%ocp.setup('../../data/ICLOCS_Speyer_Data.lua');
ocp.setup('../../data/ICLOCS_Speyer_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ICLOCS_Speyer_Mex('set_tracked',obj,tracked);
...
%[Z,U] = ICLOCS_Speyer_Mex('get_raw_solution',obj);
%J     = ICLOCS_Speyer_Mex('eval_JF',obj,Z,U);
%f     = ICLOCS_Speyer_Mex('eval_F',obj,Z,U);
