/*-----------------------------------------------------------------------*\
 |  file: BangBangFtminP_Methods_controls.cc                             |
 |                                                                       |
...
namespace BangBangFtminPDefine {
  ...
  BangBangFtminP::g_eval(
    ...
    result__[ 0   ] = (t3 + L__[iL_lambda2__xo]) * P__[iP_T];
    if ( m_debug )
  ...
  BangBangFtminP::DgDxlp_sparse(
    ...
    result__[ 0   ] = P__[iP_T];
    real_type t3   = ALIAS_Fcontrol_D_1(U__[iU_F], -1, 1);
    result__[ 1   ] = L__[iL_lambda2__xo] + t3;
    if ( m_debug )
  ...
  BangBangFtminP::u_eval_analytic(
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    U__[ iU_F ] = Fcontrol.solve(-LL__[iL_lambda2__xo] / 2 - LR__[iL_lambda2__xo] / 2, -1, 1);
    if ( m_debug )
  ...
  void
  BangBangFtminP::DuDxlxlp_full_analytic(
    NodeType2 const &          LEFT__,
    NodeType2 const &          RIGHT__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    ...
    real_type tmp_0_1 = 0;
    real_type tmp_0_2 = 0;
    real_type t5   = Fcontrol.solve_rhs(-LL__[iL_lambda2__xo] / 2 - LR__[iL_lambda2__xo] / 2, -1, 1);
    real_type tmp_0_3 = -t5 / 2;
    real_type tmp_0_4 = 0;
    real_type tmp_0_5 = 0;
    real_type tmp_0_6 = 0;
  ...
  integer
  BangBangFtminP::DmDu_numEqns() const
  { return 1; }

  void
  BangBangFtminP::DmDu_eval(
    NodeType const &     NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
  ...
  integer
  BangBangFtminP::DmDuu_numRows() const
  { return 1; }

  integer
  BangBangFtminP::DmDuu_numCols() const
  { return 1; }

  integer
  BangBangFtminP::DmDuu_nnz() const
  { return 1; }

  void
  BangBangFtminP::DmDuu_pattern(
    integer_ptr iIndex,
    integer_ptr jIndex
  ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
...
// EOF: BangBangFtminP_Methods_controls.cc
