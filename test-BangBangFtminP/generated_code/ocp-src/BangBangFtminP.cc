...
namespace BangBangFtminPDefine {
  ...
  */
  void
  BangBangFtminP::update_continuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
  ...
  */
  void
  BangBangFtminP::setup_parameters( GenericContainer const & gc_data ) {
  }

  void
  BangBangFtminP::setup_parameters( real_type const Pars[] ) {
  }
  ...
  */
  void
  BangBangFtminP::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  BangBangFtminP::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  BangBangFtminP::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  BangBangFtminP::setup_controls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "BangBangFtminP::setup_classes: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  BangBangFtminP::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "BangBangFtminP::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in BangBangFtminP::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  BangBangFtminP::info_classes() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  ...
  BangBangFtminP::setup( GenericContainer const & gc ) {
    ...
    m_debug = false;
    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("BangBangFtminP::setup, Debug");
