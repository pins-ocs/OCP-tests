...
% create object
ocp = BangBangFtminP( 'BangBangFtminP' );
...
%ocp.setup(BangBangFtminP_data);
%ocp.setup('../../data/BangBangFtminP_Data.lua');
ocp.setup('../../data/BangBangFtminP_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%BangBangFtminP_Mex('set_tracked',obj,tracked);
...
%[Z,U] = BangBangFtminP_Mex('get_raw_solution',obj);
%J     = BangBangFtminP_Mex('eval_JF',obj,Z,U);
%f     = BangBangFtminP_Mex('eval_F',obj,Z,U);
