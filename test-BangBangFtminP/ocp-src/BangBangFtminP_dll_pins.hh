/*-----------------------------------------------------------------------*\
 |  file: BangBangFtminP_dll_pins.hh                                     |
 |                                                                       |
...
namespace BangBangFtminPDefine {
  ...
  class BangBangFtminP_Problem {

    BangBangFtminP model;
    ...
    BangBangFtminP_Problem( BangBangFtminP_Problem const & );
    BangBangFtminP_Problem const & operator = ( BangBangFtminP_Problem const & );
  ...
  public:
    ...
    BangBangFtminP_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("BangBangFtminP",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "BangBangFtminP::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: BangBangFtminP_dll_pins.hh
