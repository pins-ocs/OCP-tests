...
#ifndef BANGBANGFTMINP_DOT_HH
#define BANGBANGFTMINP_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef BANGBANGFTMINP_API_DLL
    #ifdef BANGBANGFTMINP_EXPORT
      #define BANGBANGFTMINP_API_DLL __declspec(dllexport)
    #elif defined(BANGBANGFTMINP_IMPORT)
      #define BANGBANGFTMINP_API_DLL __declspec(dllimport)
    #else
      #define BANGBANGFTMINP_API_DLL
    #endif
  #endif
...
namespace BangBangFtminPDefine {
  ...
  class BangBangFtminP : public Mechatronix::Discretized_Indirect_OCP {
    ...
    BangBangFtminP( BangBangFtminP const & );
    BangBangFtminP const & operator = ( BangBangFtminP const & );
  ...
  public:
    ...
    BANGBANGFTMINP_API_DLL virtual
    ~BangBangFtminP() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    BANGBANGFTMINP_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "BangBangFtminP"; }
...
namespace BangBangFtminPLoad {
  using BangBangFtminPDefine::BangBangFtminP;

}

#endif

// EOF: BangBangFtminP.hh
