...
namespace BangBangFtminPDefine {
  ...
  void
  BangBangFtminP::p_guess_eval( P_pointer_type P__ ) const {
    P__[ iP_T ] = 1;
  }

  void
  BangBangFtminP::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  BangBangFtminP::p_check( P_const_pointer_type P__ ) const {
    bool ok = true;
  ...
  bool
  BangBangFtminP::xlambda_check_node(
    integer              ipos,
  ...
  bool
  BangBangFtminP::xlambda_check_cell(
    integer              icell,
    NodeType2 const    & NODE__,
    P_const_pointer_type P__
  ) const {
