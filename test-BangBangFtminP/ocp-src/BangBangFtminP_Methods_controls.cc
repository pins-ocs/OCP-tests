...
namespace BangBangFtminPDefine {
  ...
  integer
  BangBangFtminP::g_numEqns() const
  { return 1; }

  void
  BangBangFtminP::g_eval(
  ...
  integer
  BangBangFtminP::DgDxlp_numRows() const
  { return 1; }

  integer
  BangBangFtminP::DgDxlp_numCols() const
  { return 5; }

  integer
  BangBangFtminP::DgDxlp_nnz() const
  { return 2; }

  void
  BangBangFtminP::DgDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  integer
  BangBangFtminP::DgDu_numRows() const
  { return 1; }

  integer
  BangBangFtminP::DgDu_numCols() const
  { return 1; }

  integer
  BangBangFtminP::DgDu_nnz() const
  { return 1; }

  void
  BangBangFtminP::DgDu_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  \*/
  integer
  BangBangFtminP::u_numEqns() const
  { return 1; }

  void
  BangBangFtminP::u_eval_analytic(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    U_pointer_type       U__
  ) const {
  ...
  \*/
  void
  BangBangFtminP::DuDxlp_full_analytic(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    ...
    DuDxlp(0, 1) = 0;
    DuDxlp(0, 2) = 0;
    DuDxlp(0, 3) = -Fcontrol.solve_rhs(-L__[1], -1, 1);
    DuDxlp(0, 4) = 0;
  }
  ...
  bool
  BangBangFtminP::DuDxlp_full_numeric(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    MatrixWrapper<real_type> & DuDxlp
    ...
    integer info = alglin::gesv( 1, 5, DgDu.get_data(), 1, ipiv, DuDxlp.get_data(), 1 );
    return info == 0;
  }
