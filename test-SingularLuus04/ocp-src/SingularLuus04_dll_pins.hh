/*-----------------------------------------------------------------------*\
 |  file: SingularLuus04_dll_pins.hh                                     |
 |                                                                       |
...
namespace SingularLuus04Define {
  ...
  class SingularLuus04_Problem {

    SingularLuus04 model;
    ...
    SingularLuus04_Problem( SingularLuus04_Problem const & );
    SingularLuus04_Problem const & operator = ( SingularLuus04_Problem const & );
  ...
  public:
    ...
    SingularLuus04_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("SingularLuus04",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "SingularLuus04::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: SingularLuus04_dll_pins.hh
