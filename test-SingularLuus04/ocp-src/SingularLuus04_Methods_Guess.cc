...
namespace SingularLuus04Define {
  ...
  void
  SingularLuus04::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  SingularLuus04::xlambda_guess_eval(
    integer              i_segment,
    ...
    X__[ iX_x ] = ModelPars[1];
    X__[ iX_y ] = ModelPars[2];
    X__[ iX_z ] = ModelPars[3];
  ...
  bool
  SingularLuus04::p_check( P_const_pointer_type P__ ) const {
    bool ok = true;
  ...
  bool
  SingularLuus04::xlambda_check_node(
    integer              ipos,
  ...
  bool
  SingularLuus04::xlambda_check_cell(
    integer              icell,
    NodeType2 const    & NODE__,
    P_const_pointer_type P__
  ) const {
