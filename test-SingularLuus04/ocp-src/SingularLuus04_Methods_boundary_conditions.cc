...
namespace SingularLuus04Define {
  ...
  integer
  SingularLuus04::DboundaryConditionsDx_numCols() const
  { return 6; }

  integer
  SingularLuus04::DboundaryConditionsDx_nnz() const
  { return 3; }

  void
  SingularLuus04::DboundaryConditionsDx_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  SingularLuus04::DboundaryConditionsDx_sparse(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularLuus04::DboundaryConditionsDp_numCols() const
  { return 0; }

  integer
  SingularLuus04::DboundaryConditionsDp_nnz() const
  { return 0; }

  void
  SingularLuus04::DboundaryConditionsDp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  SingularLuus04::DboundaryConditionsDp_sparse(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularLuus04::DadjointBCDx_numCols() const
  { return 6; }

  integer
  SingularLuus04::DadjointBCDx_nnz() const
  { return 0; }

  void
  SingularLuus04::DadjointBCDx_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  SingularLuus04::DadjointBCDx_sparse(
    NodeType2 const             & LEFT__,
    NodeType2 const             & RIGHT__,
    P_const_pointer_type          P__,
    OMEGA_full_const_pointer_type OMEGA__,
  ...
  integer
  SingularLuus04::DadjointBCDp_numCols() const
  { return 0; }

  integer
  SingularLuus04::DadjointBCDp_nnz() const
  { return 0; }

  void
  SingularLuus04::DadjointBCDp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  SingularLuus04::DadjointBCDp_sparse(
    NodeType2 const             & LEFT__,
    NodeType2 const             & RIGHT__,
    P_const_pointer_type          P__,
    OMEGA_full_const_pointer_type OMEGA__,
