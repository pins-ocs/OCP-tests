...
main() {
  ...
  try {
    SingularLuus04 * m_model = new SingularLuus04("SingularLuus04",&TP,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/SingularLuus04_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/SingularLuus04_Data.lua";
    #endif
    ...
    if ( ok ) {
      ...
      file.open( "data/SingularLuus04_OCP_result_NOT_CONVERGED.ßtxt" );
    }
    file.precision(18);
