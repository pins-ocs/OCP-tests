...
% create object
ocp = SingularLuus04( 'SingularLuus04' );
...
%ocp.setup(SingularLuus04_data);
%ocp.setup('../../data/SingularLuus04_Data.lua');
ocp.setup('../../data/SingularLuus04_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%SingularLuus04_Mex('set_tracked',obj,tracked);
...
%[Z,U] = SingularLuus04_Mex('get_raw_solution',obj);
%J     = SingularLuus04_Mex('eval_JF',obj,Z,U);
%f     = SingularLuus04_Mex('eval_F',obj,Z,U);
