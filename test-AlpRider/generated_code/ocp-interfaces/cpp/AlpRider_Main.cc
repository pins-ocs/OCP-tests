...
main() {
  ...
  try {
    AlpRider * m_model = new AlpRider("AlpRider",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/AlpRider_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/AlpRider_Data.lua";
    #endif
    ...
    if ( ok ) {
      ...
      file.open( "data/AlpRider_OCP_result_NOT_CONVERGED.txt" );
    }
    file.precision(18);
