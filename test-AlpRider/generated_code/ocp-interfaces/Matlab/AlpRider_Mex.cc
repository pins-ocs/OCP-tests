...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"p_base",&ProblemStorage::do_p_base},
  {"p_base_D_1",&ProblemStorage::do_p_base_D_1},
  {"p_base_D_2",&ProblemStorage::do_p_base_D_2},
  {"p_base_D_3",&ProblemStorage::do_p_base_D_3},
  {"p_base_D_1_1",&ProblemStorage::do_p_base_D_1_1},
  {"p_base_D_1_2",&ProblemStorage::do_p_base_D_1_2},
  {"p_base_D_1_3",&ProblemStorage::do_p_base_D_1_3},
  {"p_base_D_2_2",&ProblemStorage::do_p_base_D_2_2},
  {"p_base_D_2_3",&ProblemStorage::do_p_base_D_2_3},
  {"p_base_D_3_3",&ProblemStorage::do_p_base_D_3_3},
  {"q_lower",&ProblemStorage::do_q_lower},
  {"q_lower_D",&ProblemStorage::do_q_lower_D}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "AlpRider_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
