...
public:
  ...
  )
  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "AlpRider_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "AlpRider_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
  ...
  )
  {
    ...
    try {
      ...
      string msg = fmt::format( "AlpRider_Mex('eval_F',...) error: {}", exc.what() );
...
do_p_base(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p_base',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p_base( nlhs, plhs, nrhs, prhs );
}
...
do_p_base_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p_base_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p_base_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_p_base_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p_base_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p_base_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_p_base_D_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p_base_D_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p_base_D_3( nlhs, plhs, nrhs, prhs );
}
...
do_p_base_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p_base_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p_base_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_p_base_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p_base_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p_base_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_p_base_D_1_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p_base_D_1_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p_base_D_1_3( nlhs, plhs, nrhs, prhs );
}
...
do_p_base_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p_base_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p_base_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_p_base_D_2_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p_base_D_2_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p_base_D_2_3( nlhs, plhs, nrhs, prhs );
}
...
do_p_base_D_3_3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('p_base_D_3_3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_p_base_D_3_3( nlhs, plhs, nrhs, prhs );
}
...
do_q_lower(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('q_lower',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_q_lower( nlhs, plhs, nrhs, prhs );
}
...
do_q_lower_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('q_lower_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_q_lower_D( nlhs, plhs, nrhs, prhs );
}
...
do_q_lower_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('q_lower_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_q_lower_DD( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"p_base",do_p_base},
  {"p_base_D_1",do_p_base_D_1},
  {"p_base_D_2",do_p_base_D_2},
  {"p_base_D_3",do_p_base_D_3},
  {"p_base_D_1_1",do_p_base_D_1_1},
  {"p_base_D_1_2",do_p_base_D_1_2},
  {"p_base_D_1_3",do_p_base_D_1_3},
  {"p_base_D_2_2",do_p_base_D_2_2},
  {"p_base_D_2_3",do_p_base_D_2_3},
  {"p_base_D_3_3",do_p_base_D_3_3},
  {"q_lower",do_q_lower},
  {"q_lower_D",do_q_lower_D},
  {"q_lower_DD",do_q_lower_DD},
  {"new",do_new},
