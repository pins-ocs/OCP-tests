...
DO_COMMAND_REMAP_TO_CLASS_METHOD(p_base);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p_base_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p_base_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p_base_D_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p_base_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p_base_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p_base_D_1_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p_base_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p_base_D_2_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(p_base_D_3_3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(q_lower);
DO_COMMAND_REMAP_TO_CLASS_METHOD(q_lower_D);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "AlpRider_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "AlpRider_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
