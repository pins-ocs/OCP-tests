...
ocp.setup('../../data/AlpRider_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%AlpRider_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = AlpRider_Mex('get_raw_solution',obj);
%J     = AlpRider_Mex('eval_JF',obj,Z,MU,U);
%f     = AlpRider_Mex('eval_F',obj,Z,MU,U);
