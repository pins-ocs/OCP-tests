...
public:
  ...
  void do_p_base( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_p_base_D_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_p_base_D_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_p_base_D_3( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_p_base_D_1_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_p_base_D_1_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_p_base_D_1_3( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_p_base_D_2_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_p_base_D_2_3( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_p_base_D_3_3( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_q_lower( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_q_lower_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_q_lower_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
