...
namespace AlpRiderDefine {
  ...
  class AlpRider_Problem {
    ...
    AlpRider_Problem( AlpRider_Problem const & );
    AlpRider_Problem const & operator = ( AlpRider_Problem const & );
  ...
  public:
    ...
    ALPRIDER_API_DLL
    AlpRider_Problem( ThreadPool * pTP, Console const * pConsole )
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "AlpRider::solver, fatal: unknown error";
      }
      return ok;
    }
