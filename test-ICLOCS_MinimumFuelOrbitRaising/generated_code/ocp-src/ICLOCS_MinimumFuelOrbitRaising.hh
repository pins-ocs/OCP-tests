...
#ifndef ICLOCS_MINIMUMFUELORBITRAISING_DOT_HH
#define ICLOCS_MINIMUMFUELORBITRAISING_DOT_HH
...
// User Header (end)
  ...
  #ifndef ICLOCS_MINIMUMFUELORBITRAISING_API_DLL
    #ifdef ICLOCS_MINIMUMFUELORBITRAISING_EXPORT
      #define ICLOCS_MINIMUMFUELORBITRAISING_API_DLL __declspec(dllexport)
    #elif defined(ICLOCS_MINIMUMFUELORBITRAISING_IMPORT)
      #define ICLOCS_MINIMUMFUELORBITRAISING_API_DLL __declspec(dllimport)
    #else
      #define ICLOCS_MINIMUMFUELORBITRAISING_API_DLL
    #endif
  #endif
...
namespace ICLOCS_MinimumFuelOrbitRaisingDefine {
  ...
  public:
    ...
    explicit
    ICLOCS_MinimumFuelOrbitRaising(
      string const   & name,
      integer          n_threads,
      Console const  * console
    );

    ~ICLOCS_MinimumFuelOrbitRaising() override;
    ...
    { return "ICLOCS_MinimumFuelOrbitRaising"; }
...
namespace ICLOCS_MinimumFuelOrbitRaisingLoad {
  using ICLOCS_MinimumFuelOrbitRaisingDefine::ICLOCS_MinimumFuelOrbitRaising;

}

#endif

// EOF: ICLOCS_MinimumFuelOrbitRaising.hh
