...
namespace ICLOCS_MinimumFuelOrbitRaisingDefine {
  ...
  void
  ICLOCS_MinimumFuelOrbitRaising::continuation_step_1( real_type s ) {
  ...
  integer ICLOCS_MinimumFuelOrbitRaising::DsegmentLinkDxxp_numRows() const { return 0; }
  integer ICLOCS_MinimumFuelOrbitRaising::DsegmentLinkDxxp_numCols() const { return 0; }
  integer ICLOCS_MinimumFuelOrbitRaising::DsegmentLinkDxxp_nnz() const { return 0; }

  void
  ICLOCS_MinimumFuelOrbitRaising::DsegmentLinkDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  ICLOCS_MinimumFuelOrbitRaising::DsegmentLinkDxxp_sparse(
    NodeQX const & L,
    NodeQX const & R,
    P_const_p_type p,
