/*-----------------------------------------------------------------------*\
 |  file: ICLOCS_MinimumFuelOrbitRaising_dll_ruby.hh                     |
 |                                                                       |
...
namespace ICLOCS_MinimumFuelOrbitRaisingDefine {
  ...
  */
  ...
  ICLOCS_MINIMUMFUELORBITRAISING_API_DLL
  bool
  ICLOCS_MinimumFuelOrbitRaising_ocp_guess( char const id[], GenericContainer & gc_guess );
...
// EOF: ICLOCS_MinimumFuelOrbitRaising_dll_ruby.hh
