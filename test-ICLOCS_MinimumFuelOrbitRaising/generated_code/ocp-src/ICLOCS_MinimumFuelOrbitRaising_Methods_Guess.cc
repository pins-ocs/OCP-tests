...
namespace ICLOCS_MinimumFuelOrbitRaisingDefine {
  ...
  void
  ICLOCS_MinimumFuelOrbitRaising::p_guess_eval( P_p_type P__ ) const {
  }
  ...
  bool
  ICLOCS_MinimumFuelOrbitRaising::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  ICLOCS_MinimumFuelOrbitRaising::penalties_check_node(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
  ...
  ICLOCS_MinimumFuelOrbitRaising::u_check_if_admissible(
    ...
    /* REMOVED */ Xoptima__check__u__le(-t1, t2, Xoptima__message_u_check_0);
    /* REMOVED */ Xoptima__check__u__le(t2, t1, Xoptima__message_u_check_1);
    return ok;
  }
