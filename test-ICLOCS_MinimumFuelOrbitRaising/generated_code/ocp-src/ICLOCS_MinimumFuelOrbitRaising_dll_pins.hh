/*-----------------------------------------------------------------------*\
 |  file: ICLOCS_MinimumFuelOrbitRaising_dll_pins.hh                     |
 |                                                                       |
...
namespace ICLOCS_MinimumFuelOrbitRaisingDefine {
  ...
  using namespace ICLOCS_MinimumFuelOrbitRaisingLoad;
  ...
  class ICLOCS_MinimumFuelOrbitRaising_Problem {

    ICLOCS_MinimumFuelOrbitRaising model;
    ...
    ICLOCS_MinimumFuelOrbitRaising_Problem( ICLOCS_MinimumFuelOrbitRaising_Problem const & );
    ICLOCS_MinimumFuelOrbitRaising_Problem const & operator = ( ICLOCS_MinimumFuelOrbitRaising_Problem const & );
  ...
  public:
    ...
    ICLOCS_MinimumFuelOrbitRaising_Problem( integer n_threads, Console const * console )
    : model("ICLOCS_MinimumFuelOrbitRaising",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    ICLOCS_MINIMUMFUELORBITRAISING_API_DLL
    ~ICLOCS_MinimumFuelOrbitRaising_Problem()
    {}
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "ICLOCS_MinimumFuelOrbitRaising::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: ICLOCS_MinimumFuelOrbitRaising_dll_pins.hh
