...
do_mass(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_mass( nlhs, plhs, nrhs, prhs );
}
...
do_mass_D(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_mass_D( nlhs, plhs, nrhs, prhs );
}
...
do_mass_DD(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_mass_DD( nlhs, plhs, nrhs, prhs );
}
