...
%ocp.setup(ICLOCS_MinimumFuelOrbitRaising_data);
%ocp.setup('../../data/ICLOCS_MinimumFuelOrbitRaising_Data.lua');
ocp.setup('../../data/ICLOCS_MinimumFuelOrbitRaising_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ICLOCS_MinimumFuelOrbitRaising_Mex('set_tracked',obj,tracked);
...
%[Z,U] = ICLOCS_MinimumFuelOrbitRaising_Mex('get_raw_solution',obj);
%J     = ICLOCS_MinimumFuelOrbitRaising_Mex('eval_JF',obj,Z,U);
%f     = ICLOCS_MinimumFuelOrbitRaising_Mex('eval_F',obj,Z,U);
