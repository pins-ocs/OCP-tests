...
ocp.setup( [DATA_PATH 'ICLOCS_MinimumFuelOrbitRaising_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = ICLOCS_MinimumFuelOrbitRaising_Mex('get_raw_solution',obj);
%J        = ICLOCS_MinimumFuelOrbitRaising_Mex('eval_JF',obj,Z,MU,U);
%f        = ICLOCS_MinimumFuelOrbitRaising_Mex('eval_F',obj,Z,MU,U);
