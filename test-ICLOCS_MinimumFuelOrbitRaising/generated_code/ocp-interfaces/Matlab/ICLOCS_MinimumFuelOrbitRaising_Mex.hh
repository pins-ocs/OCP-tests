...
public:
  ...
  void do_mass( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_mass_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_mass_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
