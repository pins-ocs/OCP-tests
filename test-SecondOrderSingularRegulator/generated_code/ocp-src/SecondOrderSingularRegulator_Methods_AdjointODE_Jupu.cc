...
namespace SecondOrderSingularRegulatorDefine {
  ...
  integer SecondOrderSingularRegulator::JPxpu_numEqns() const { return 3; }

  void
  SecondOrderSingularRegulator::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer SecondOrderSingularRegulator::JUxpu_numEqns() const { return 3; }

  void
  SecondOrderSingularRegulator::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer SecondOrderSingularRegulator::LTxpu_numEqns() const { return 3; }

  void
  SecondOrderSingularRegulator::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
