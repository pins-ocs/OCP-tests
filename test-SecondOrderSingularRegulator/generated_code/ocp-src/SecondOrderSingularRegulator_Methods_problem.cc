...
namespace SecondOrderSingularRegulatorDefine {
  ...
  real_type
  SecondOrderSingularRegulator::H_eval(
  ...
  real_type
  SecondOrderSingularRegulator::lagrange_target(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
  ...
  real_type
  SecondOrderSingularRegulator::mayer_target(
    NodeQX const & LEFT__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SecondOrderSingularRegulator::D2mayerD2xxp_numRows() const { return 4; }
  integer SecondOrderSingularRegulator::D2mayerD2xxp_numCols() const { return 4; }
  integer SecondOrderSingularRegulator::D2mayerD2xxp_nnz()     const { return 0; }

  void
  SecondOrderSingularRegulator::D2mayerD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  SecondOrderSingularRegulator::D2mayerD2xxp_sparse(
    NodeQX const & LEFT__,
    NodeQX const & RIGHT__,
    P_const_p_type P__,
    real_ptr       result__
  ...
  integer SecondOrderSingularRegulator::DlagrangeDxpu_numEqns() const { return 3; }

  void
  SecondOrderSingularRegulator::DlagrangeDxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SecondOrderSingularRegulator::D2lagrangeD2xpu_numRows() const { return 3; }
  integer SecondOrderSingularRegulator::D2lagrangeD2xpu_numCols() const { return 3; }
  integer SecondOrderSingularRegulator::D2lagrangeD2xpu_nnz()     const { return 2; }

  void
  SecondOrderSingularRegulator::D2lagrangeD2xpu_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  SecondOrderSingularRegulator::D2lagrangeD2xpu_sparse(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer
  SecondOrderSingularRegulator::q_numEqns() const
  { return 1; }

  void
  SecondOrderSingularRegulator::q_eval(
    integer   i_segment,
    real_type s,
    Q_p_type  result__
  ) const {
  ...
  integer SecondOrderSingularRegulator::DsegmentLinkDxxp_numRows() const { return 0; }
  integer SecondOrderSingularRegulator::DsegmentLinkDxxp_numCols() const { return 0; }
  integer SecondOrderSingularRegulator::DsegmentLinkDxxp_nnz() const { return 0; }

  void
  SecondOrderSingularRegulator::DsegmentLinkDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  SecondOrderSingularRegulator::DsegmentLinkDxxp_sparse(
    NodeQX const & L,
    NodeQX const & R,
    P_const_p_type p,
  ...
  void
  SecondOrderSingularRegulator::DjumpDxlxlp_sparse(
    NodeQXL const & LEFT__,
    NodeQXL const & RIGHT__,
    P_const_p_type  P__,
    real_ptr        result__
  ...
  integer SecondOrderSingularRegulator::post_numEqns() const { return 1; }
...
// EOF: SecondOrderSingularRegulator_Methods_problem.cc
