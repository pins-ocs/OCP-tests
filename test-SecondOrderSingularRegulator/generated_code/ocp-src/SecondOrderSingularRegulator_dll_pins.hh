/*-----------------------------------------------------------------------*\
 |  file: SecondOrderSingularRegulator_dll_pins.hh                       |
 |                                                                       |
...
namespace SecondOrderSingularRegulatorDefine {
  ...
  class SecondOrderSingularRegulator_Problem {

    SecondOrderSingularRegulator model;
    ...
    SecondOrderSingularRegulator_Problem( SecondOrderSingularRegulator_Problem const & );
    SecondOrderSingularRegulator_Problem const & operator = ( SecondOrderSingularRegulator_Problem const & );
  ...
  public:
    ...
    SecondOrderSingularRegulator_Problem( integer n_threads, Console const * console )
    : model("SecondOrderSingularRegulator",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    SECONDORDERSINGULARREGULATOR_API_DLL
    ~SecondOrderSingularRegulator_Problem()
    {}
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "SecondOrderSingularRegulator::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: SecondOrderSingularRegulator_dll_pins.hh
