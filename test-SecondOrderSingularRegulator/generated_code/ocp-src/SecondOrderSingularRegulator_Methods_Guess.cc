...
namespace SecondOrderSingularRegulatorDefine {
  ...
  void
  SecondOrderSingularRegulator::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  SecondOrderSingularRegulator::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  SecondOrderSingularRegulator::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  SecondOrderSingularRegulator::xlambda_check_node(
    integer              ipos,
  ...
  bool
  SecondOrderSingularRegulator::xlambda_check_cell(
    integer              icell,
  ...
  integer SecondOrderSingularRegulator::u_guess_numEqns() const { return 1; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  SecondOrderSingularRegulator::u_guess_eval(
    NodeType2 const    & LEFT__,
    NodeType2 const    & RIGHT__,
    P_const_pointer_type P__,
    ...
    UGUESS__[ iU_u ] = uControl.solve(-L__[iL_lambda2__xo], -1, 1);
    if ( m_debug )
  ...
  bool
  SecondOrderSingularRegulator::u_check_if_admissible(
    NodeType2 const    & NODE__,
