...
namespace SecondOrderSingularRegulatorDefine {
  ...
  void
  SecondOrderSingularRegulator::p_guess_eval( P_p_type P__ ) const {
  }
  ...
  bool
  SecondOrderSingularRegulator::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  SecondOrderSingularRegulator::penalties_check_node(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
  ...
  SecondOrderSingularRegulator::u_guess_eval(
    ...
    UGUESS__[ iU_u ] = uControl.solve(-MU__[1], -1, 1);
    if ( m_debug )
