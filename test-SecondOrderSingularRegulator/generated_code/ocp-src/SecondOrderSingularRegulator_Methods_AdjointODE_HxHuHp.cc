...
namespace SecondOrderSingularRegulatorDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SecondOrderSingularRegulator::DHxpDxpu_numRows() const { return 2; }
  integer SecondOrderSingularRegulator::DHxpDxpu_numCols() const { return 3; }
  integer SecondOrderSingularRegulator::DHxpDxpu_nnz()     const { return 2; }

  void
  SecondOrderSingularRegulator::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  SecondOrderSingularRegulator::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
