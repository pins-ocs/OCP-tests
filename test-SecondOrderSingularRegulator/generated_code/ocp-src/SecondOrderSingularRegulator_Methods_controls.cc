...
namespace SecondOrderSingularRegulatorDefine {
  ...
  real_type
  SecondOrderSingularRegulator::g_fun_eval(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    ...
    real_type result__ = t1 * MU__[0] + t5 * MU__[1] + t2 + t4 + t6;
    if ( m_debug ) {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SecondOrderSingularRegulator::DgDxpm_numRows() const { return 1; }
  integer SecondOrderSingularRegulator::DgDxpm_numCols() const { return 4; }
  integer SecondOrderSingularRegulator::DgDxpm_nnz()     const { return 1; }

  void
  SecondOrderSingularRegulator::DgDxpm_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  SecondOrderSingularRegulator::DgDxpm_sparse(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__,
