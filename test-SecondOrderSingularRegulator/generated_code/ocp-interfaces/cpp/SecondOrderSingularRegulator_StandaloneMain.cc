...
main() {
  ...
  try {
    ...
    SecondOrderSingularRegulator model("SecondOrderSingularRegulator",n_threads,&console);
    ...
    gc_data["DumpFile"] = "SecondOrderSingularRegulator_dump";
