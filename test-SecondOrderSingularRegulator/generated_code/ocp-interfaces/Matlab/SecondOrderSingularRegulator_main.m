%-----------------------------------------------------------------------%
%  file: SecondOrderSingularRegulator_main.m                            %
%                                                                       %
...
% create object
ocp = SecondOrderSingularRegulator( 'SecondOrderSingularRegulator' );
...
%ocp.setup(SecondOrderSingularRegulator_data);
%ocp.setup('../../data/SecondOrderSingularRegulator_Data.lua');
ocp.setup('../../data/SecondOrderSingularRegulator_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%SecondOrderSingularRegulator_Mex('set_tracked',obj,tracked);
...
%[Z,U] = SecondOrderSingularRegulator_Mex('get_raw_solution',obj);
%J     = SecondOrderSingularRegulator_Mex('eval_JF',obj,Z,U);
%f     = SecondOrderSingularRegulator_Mex('eval_F',obj,Z,U);
