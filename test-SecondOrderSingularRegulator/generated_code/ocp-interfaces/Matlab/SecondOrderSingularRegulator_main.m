...
ocp.setup('../../data/SecondOrderSingularRegulator_Data');  % automatically try extension .rb and .lua
...
%[Z,MU,U] = SecondOrderSingularRegulator_Mex('get_raw_solution',obj);
%J     = SecondOrderSingularRegulator_Mex('eval_JF',obj,Z,MU,U);
%f     = SecondOrderSingularRegulator_Mex('eval_F',obj,Z,MU,U);
