...
%x = SecondOrderSingularRegulator_Mex('get_raw_solution',obj);
%J = SecondOrderSingularRegulator_Mex('eval_JF',obj,x);
%f = SecondOrderSingularRegulator_Mex('eval_F',obj,x);
