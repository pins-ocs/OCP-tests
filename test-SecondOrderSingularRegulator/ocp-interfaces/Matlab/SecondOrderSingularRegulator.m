...
classdef SecondOrderSingularRegulator < handle
  ...
  methods
    ...
    function res = y1( self, varargin  )
      res = SecondOrderSingularRegulator_Mex( 'get_solution', self.objectHandle, 'y1', varargin{:} );
    end
    function res = y2( self, varargin  )
      res = SecondOrderSingularRegulator_Mex( 'get_solution', self.objectHandle, 'y2', varargin{:} );
    end
    ...
    function res = lambda1( self, varargin )
      res = SecondOrderSingularRegulator_Mex( 'get_solution', self.objectHandle, 'lambda1__xo', varargin{:} );
    end
    function res = lambda2( self, varargin )
      res = SecondOrderSingularRegulator_Mex( 'get_solution', self.objectHandle, 'lambda2__xo', varargin{:} );
    end
    ...
    function res = u( self, varargin )
      res = SecondOrderSingularRegulator_Mex( 'get_solution', self.objectHandle, 'u', varargin{:} );
    end
    ...
    function [a,c] = get_ac( self, iseg_L, q_L, x_L, lambda_L, ...
      ...
      [a,c] = SecondOrderSingularRegulator_Mex( 'a', self.objectHandle, ...
