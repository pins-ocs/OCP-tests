...
classdef SecondOrderSingularRegulator < handle
  ...
  methods
    ...
    function u = eval_u( self, varargin )
      ...
      u = SecondOrderSingularRegulator_Mex( 'u', self.objectHandle, varargin{:} );
    end
    % ---------------------------------------------------------------------
    function u = eval_DuDxlp( self, varargin )
      ...
      %
      u = SecondOrderSingularRegulator_Mex( 'DuDxlp', self.objectHandle, varargin{:} );
    end
    % ---------------------------------------------------------------------
    function rhs = eval_rhs_ode( self, iseg, q, x, u, pars )
      % compute rhs of the ODE `A(q,x,pars) x' = rhs( q, x, u, pars )`
      rhs = SecondOrderSingularRegulator_Mex(...
