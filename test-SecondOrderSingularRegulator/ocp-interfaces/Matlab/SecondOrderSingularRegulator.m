...
classdef SecondOrderSingularRegulator < handle
  ...
  methods
    ...
    function N_thread( self, nt )
      ...
      % Set information level.
      %
      SecondOrderSingularRegulator_Mex( 'N_thread', self.objectHandle, nt );
    end
    ...
    function F = eval_F( self, x )
      ...
      %
      F = SecondOrderSingularRegulator_Mex( 'eval_F', self.objectHandle, x );
    end
    % ---------------------------------------------------------------------
    function JF = eval_JF( self, x )
      ...
      %
      JF = SecondOrderSingularRegulator_Mex( 'eval_JF', self.objectHandle, x );
    end
    % ---------------------------------------------------------------------
    ...
    function x = get_raw_solution( self )
      ...
      %
      x = SecondOrderSingularRegulator_Mex( 'get_raw_solution', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function set_raw_solution( self, x )
      ...
      %
      SecondOrderSingularRegulator_Mex( 'set_raw_solution', self.objectHandle, x );
    end
    % ---------------------------------------------------------------------
    function ok = check_raw_solution( self, x )
      ...
      %
      ok = SecondOrderSingularRegulator_Mex( 'check_raw_solution', self.objectHandle, x );
    end
    % ---------------------------------------------------------------------
    function check_jacobian( self, x, epsi )
      ...
      %
      SecondOrderSingularRegulator_Mex( 'check_jacobian', self.objectHandle, x, epsi );
    end
    % ---------------------------------------------------------------------
    % ---------------------------------------------------------------------
    ...
    function [Ja,Jc] = eval_DacDxlp( self, iseg_L, q_L, x_L, lambda_L, ...
      ...
      % given left and right states.
      %
      [Ja,Jc] = SecondOrderSingularRegulator_Mex( 'DacDxlp', self.objectHandle, ...
        iseg_L, q_L, x_L, lambda_L, iseg_R, q_R, x_R, lambda_R, pars, U ...
      );
    end
    % ---------------------------------------------------------------------
    ...
    function [Jh,Jc] = eval_DhcDxlop( self, iseg_L, q_L, x_L, lambda_L, ...
      ...
      % given left and right states.
      %
      [Jh,Jc] = SecondOrderSingularRegulator_Mex( 'DhcDxlop', self.objectHandle, ...
        iseg_L,  q_L, x_L, lambda_L, iseg_R, q_R, x_R, lambda_R, pars ...
      );
    end
    % ---------------------------------------------------------------------
