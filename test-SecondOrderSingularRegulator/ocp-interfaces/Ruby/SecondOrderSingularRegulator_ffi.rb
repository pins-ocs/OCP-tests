#-----------------------------------------------------------------------#
#  file: SecondOrderSingularRegulator_run.rb                            #
#                                                                       #
...
module GenericContainer
  @libGenericContainer = MECHATRONIX_LIB_PATH+"/libSecondOrderSingularRegulator.#{DYLIB_EXT}"
end

module Splines
  @libSplines = MECHATRONIX_LIB_PATH+"/libSecondOrderSingularRegulator.#{DYLIB_EXT}"
end
...
module SecondOrderSingularRegulator
  ...
  LIB_PATH = MECHATRONIX_LIB_PATH+"/libSecondOrderSingularRegulator.#{DYLIB_EXT}"
  ...
  attach_function :OCP_setup,
                  :SecondOrderSingularRegulator_ocp_setup,
                  [ :string, :buffer_in ], :bool

  attach_function :OCP_guess,
                  :SecondOrderSingularRegulator_ocp_guess,
                  [ :string, :buffer_in ], :bool

  attach_function :OCP_solve,
                  :SecondOrderSingularRegulator_ocp_solve,
                  [ :string, :buffer_in, :buffer_out ], :bool

  attach_function :OCP_write_ocp_solution,
                  :SecondOrderSingularRegulator_write_ocp_solution,
                  [ :string, :string ], :void
  ...
  class OCPSolver
    ...
    def solve( convert = true )
      ...
      ok = SecondOrderSingularRegulator.OCP_setup( @id, GenericContainer.GC_mem_ptr(@id) )
      raise RuntimeError, "Failed to do setup: #{out[:Error]}\n" unless ok

      ok = SecondOrderSingularRegulator.OCP_guess( @id, GenericContainer.GC_mem_ptr(@id) )
      raise RuntimeError, "Failed to do guess: #{out[:Error]}\n" unless ok

      ok  = SecondOrderSingularRegulator.OCP_solve( @id,
    ...
    def write_ocp_solution( fname )
      SecondOrderSingularRegulator.OCP_write_ocp_solution( @id, fname )
    end
...
# EOF: SecondOrderSingularRegulator_ffi.rb
