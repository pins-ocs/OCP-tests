/*-----------------------------------------------------------------------*\
 |  file: SecondOrderSingularRegulator.hh                                |
 |                                                                       |
...
#ifndef SECONDORDERSINGULARREGULATOR_DOT_HH
#define SECONDORDERSINGULARREGULATOR_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef SECONDORDERSINGULARREGULATOR_API_DLL
    #ifdef SECONDORDERSINGULARREGULATOR_EXPORT
      #define SECONDORDERSINGULARREGULATOR_API_DLL __declspec(dllexport)
    #elif defined(SECONDORDERSINGULARREGULATOR_IMPORT)
      #define SECONDORDERSINGULARREGULATOR_API_DLL __declspec(dllimport)
    #else
      #define SECONDORDERSINGULARREGULATOR_API_DLL
    #endif
  #endif
...
namespace SecondOrderSingularRegulatorDefine {
  ...
  class SecondOrderSingularRegulator : public Mechatronix::Discretized_Indirect_OCP {
    ...
    SecondOrderSingularRegulator( SecondOrderSingularRegulator const & );
    SecondOrderSingularRegulator const & operator = ( SecondOrderSingularRegulator const & );
  ...
  public:
    ...
    explicit
    SecondOrderSingularRegulator(
      string  const & name,
      ThreadPool    * TP,
      Console const * console
    );

    SECONDORDERSINGULARREGULATOR_API_DLL virtual
    ~SecondOrderSingularRegulator() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    SECONDORDERSINGULARREGULATOR_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "SecondOrderSingularRegulator"; }
...
namespace SecondOrderSingularRegulatorLoad {
  using SecondOrderSingularRegulatorDefine::SecondOrderSingularRegulator;

}

#endif

// EOF: SecondOrderSingularRegulator.hh
