...
namespace SecondOrderSingularRegulatorDefine {
  ...
  integer
  SecondOrderSingularRegulator::DmayerDx_numEqns() const
  { return 4; }

  void
  SecondOrderSingularRegulator::DmayerDx_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SecondOrderSingularRegulator::DmayerDp_numEqns() const
  { return 0; }

  void
  SecondOrderSingularRegulator::DmayerDp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
