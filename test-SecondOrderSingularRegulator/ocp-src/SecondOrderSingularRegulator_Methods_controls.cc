...
namespace SecondOrderSingularRegulatorDefine {
  ...
  integer
  SecondOrderSingularRegulator::DgDxlp_numRows() const
  { return 1; }

  integer
  SecondOrderSingularRegulator::DgDxlp_numCols() const
  { return 4; }

  integer
  SecondOrderSingularRegulator::DgDxlp_nnz() const
  { return 1; }

  void
  SecondOrderSingularRegulator::DgDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  SecondOrderSingularRegulator::DgDxlp_sparse(
    NodeType2 const    & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  void
  SecondOrderSingularRegulator::DgDu_sparse(
    NodeType2 const    & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  \*/
  integer
  SecondOrderSingularRegulator::u_numEqns() const
  { return 1; }

  void
  SecondOrderSingularRegulator::u_eval_analytic(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    U_pointer_type       U__
  ) const {
  ...
  \*/
  void
  SecondOrderSingularRegulator::DuDxlp_full_analytic(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    ...
    DuDxlp(0, 1) = 0;
    DuDxlp(0, 2) = 0;
    DuDxlp(0, 3) = -uControl.solve_rhs(-L__[1], -1, 1);
  }
  ...
  bool
  SecondOrderSingularRegulator::DuDxlp_full_numeric(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    MatrixWrapper<real_type> & DuDxlp
  ...
  integer
  SecondOrderSingularRegulator::DjumpDxlp_numRows() const
  { return 4; }

  integer
  SecondOrderSingularRegulator::DjumpDxlp_numCols() const
  { return 8; }

  integer
  SecondOrderSingularRegulator::DjumpDxlp_nnz() const
  { return 8; }

  void
  SecondOrderSingularRegulator::DjumpDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
  ...
  void
  SecondOrderSingularRegulator::DjumpDxlp_sparse(
    NodeType2 const    & LEFT__,
    NodeType2 const    & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
