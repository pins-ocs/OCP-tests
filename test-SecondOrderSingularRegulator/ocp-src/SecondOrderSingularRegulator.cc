...
namespace SecondOrderSingularRegulatorDefine {
  ...
  */
  void
  SecondOrderSingularRegulator::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  SecondOrderSingularRegulator::setupParameters( GenericContainer const & gc_data ) {
  }

  void
  SecondOrderSingularRegulator::setupParameters( real_type const Pars[] ) {
  }
  ...
  */
  void
  SecondOrderSingularRegulator::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  SecondOrderSingularRegulator::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  SecondOrderSingularRegulator::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  SecondOrderSingularRegulator::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "SecondOrderSingularRegulator::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  SecondOrderSingularRegulator::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "SecondOrderSingularRegulator::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in SecondOrderSingularRegulator::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  SecondOrderSingularRegulator::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  SecondOrderSingularRegulator::diagnostic( GenericContainer const & gc ) {
