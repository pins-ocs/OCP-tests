...
public:
  ...
  do_eval_F(
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "LUUS_DrugDisplacement_Mex('eval_F',...) error: {}", exc.what() ).c_str() );
      ok = false;
    } catch ( ... ) {
  ...
  do_g2(
    ...
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__x1" );
    mwSize N1, M1;
    real_const_ptr arg1 = getMatrixPointer( arg_in_3, N1, M1, CMD " xo__x2" );
...
do_g2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g2( nlhs, plhs, nrhs, prhs );
}
...
do_g2_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g2_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_g2_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g2_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_g2_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g2_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_g2_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g2_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_g2_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g2_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_g3(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g3( nlhs, plhs, nrhs, prhs );
}
...
do_g3_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g3_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_g3_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g3_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_g3_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g3_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_g3_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g3_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_g3_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g3_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_g4(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g4( nlhs, plhs, nrhs, prhs );
}
...
do_g4_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g4_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_g4_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g4_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_g4_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g4_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_g4_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g4_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_g4_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g4_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_g1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g1( nlhs, plhs, nrhs, prhs );
}
...
do_g1_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g1_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_g1_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g1_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_g1_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g1_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_g1_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g1_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_g1_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_g1_D_2_2( nlhs, plhs, nrhs, prhs );
}
