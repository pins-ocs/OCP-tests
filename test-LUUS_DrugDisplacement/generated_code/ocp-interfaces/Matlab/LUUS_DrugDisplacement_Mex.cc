...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"g2",&ProblemStorage::do_g2},
  {"g2_D_1",&ProblemStorage::do_g2_D_1},
  {"g2_D_2",&ProblemStorage::do_g2_D_2},
  {"g2_D_1_1",&ProblemStorage::do_g2_D_1_1},
  {"g2_D_1_2",&ProblemStorage::do_g2_D_1_2},
  {"g2_D_2_2",&ProblemStorage::do_g2_D_2_2},
  {"g3",&ProblemStorage::do_g3},
  {"g3_D_1",&ProblemStorage::do_g3_D_1},
  {"g3_D_2",&ProblemStorage::do_g3_D_2},
  {"g3_D_1_1",&ProblemStorage::do_g3_D_1_1},
  {"g3_D_1_2",&ProblemStorage::do_g3_D_1_2},
  {"g3_D_2_2",&ProblemStorage::do_g3_D_2_2},
  {"g4",&ProblemStorage::do_g4},
  {"g4_D_1",&ProblemStorage::do_g4_D_1},
  {"g4_D_2",&ProblemStorage::do_g4_D_2},
  {"g4_D_1_1",&ProblemStorage::do_g4_D_1_1},
  {"g4_D_1_2",&ProblemStorage::do_g4_D_1_2},
  {"g4_D_2_2",&ProblemStorage::do_g4_D_2_2},
  {"g1",&ProblemStorage::do_g1},
  {"g1_D_1",&ProblemStorage::do_g1_D_1},
  {"g1_D_2",&ProblemStorage::do_g1_D_2},
  {"g1_D_1_1",&ProblemStorage::do_g1_D_1_1},
  {"g1_D_1_2",&ProblemStorage::do_g1_D_1_2},
  {"g1_D_2_2",&ProblemStorage::do_g1_D_2_2}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "LUUS_DrugDisplacement_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
