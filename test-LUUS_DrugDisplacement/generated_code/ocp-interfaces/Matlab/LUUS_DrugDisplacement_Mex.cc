...
DO_COMMAND_REMAP_TO_CLASS_METHOD(g2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g2_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g2_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g2_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g2_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g2_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g3);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g3_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g3_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g3_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g3_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g3_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g4);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g4_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g4_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g4_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g4_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g4_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g1_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g1_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g1_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g1_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(g1_D_2_2);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "LUUS_DrugDisplacement_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "LUUS_DrugDisplacement_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
