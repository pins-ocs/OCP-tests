...
"LUUS_DrugDisplacement_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;
...
public:
  ...
  )
  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "LUUS_DrugDisplacement_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "LUUS_DrugDisplacement_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
  ...
  )
  {
    ...
    try {
      ...
      string msg = fmt::format( "LUUS_DrugDisplacement_Mex('eval_F',...) error: {}", exc.what() );
      mexWarnMsgTxt( msg.c_str() );
      ok = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "LUUS_DrugDisplacement_Mex('eval_F',...) unkown error\n" );
      ok = false;
    }
  ...
  )
  {
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "LUUS_DrugDisplacement_Mex('eval_JF',...) error: {}", exc.what() ).c_str() );
      ok_value = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "LUUS_DrugDisplacement_Mex('eval_JF',...) unkown error\n" );
      ok_value = false;
    }
    int ok = mexCallMATLAB( 1, &arg_out_0, 5, args, "sparse" );
    UTILS_MEX_ASSERT0( ok == 0, CMD "failed the call sparse(...)" );
...
do_g2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g2( nlhs, plhs, nrhs, prhs );
}
...
do_g2_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g2_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g2_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_g2_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g2_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g2_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_g2_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g2_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g2_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_g2_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g2_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g2_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_g2_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g2_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g2_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_g3(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g3',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g3( nlhs, plhs, nrhs, prhs );
}
...
do_g3_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g3_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g3_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_g3_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g3_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g3_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_g3_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g3_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g3_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_g3_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g3_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g3_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_g3_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g3_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g3_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_g4(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g4',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g4( nlhs, plhs, nrhs, prhs );
}
...
do_g4_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g4_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g4_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_g4_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g4_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g4_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_g4_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g4_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g4_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_g4_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g4_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g4_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_g4_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g4_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g4_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_g1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g1( nlhs, plhs, nrhs, prhs );
}
...
do_g1_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g1_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g1_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_g1_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g1_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g1_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_g1_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g1_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g1_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_g1_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g1_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g1_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_g1_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('g1_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_g1_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"g2_D_1",do_g2_D_1},
  {"g2_D_2",do_g2_D_2},
  {"g2_D_1_1",do_g2_D_1_1},
  {"g2_D_1_2",do_g2_D_1_2},
  {"g2_D_2_2",do_g2_D_2_2},
  {"g3",do_g3},
  {"g3_D_1",do_g3_D_1},
  {"g3_D_2",do_g3_D_2},
  {"g3_D_1_1",do_g3_D_1_1},
  {"g3_D_1_2",do_g3_D_1_2},
  {"g3_D_2_2",do_g3_D_2_2},
  {"g4",do_g4},
  {"g4_D_1",do_g4_D_1},
  {"g4_D_2",do_g4_D_2},
  {"g4_D_1_1",do_g4_D_1_1},
  {"g4_D_1_2",do_g4_D_1_2},
  {"g4_D_2_2",do_g4_D_2_2},
  {"g1",do_g1},
  {"g1_D_1",do_g1_D_1},
  {"g1_D_2",do_g1_D_2},
  {"g1_D_1_1",do_g1_D_1_1},
  {"g1_D_1_2",do_g1_D_1_2},
  {"g1_D_2_2",do_g1_D_2_2},
  {"new",do_new},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "LUUS_DrugDisplacement_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "LUUS_DrugDisplacement_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
