...
ProblemStorage::do_g2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
...
ProblemStorage::do_g2_D_1(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g2_D_1', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g2_D_2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g2_D_2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g2_D_1_1(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g2_D_1_1', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g2_D_1_2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g2_D_1_2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g2_D_2_2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g2_D_2_2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g3(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g3', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g3_D_1(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g3_D_1', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g3_D_2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g3_D_2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g3_D_1_1(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g3_D_1_1', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g3_D_1_2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g3_D_1_2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g3_D_2_2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g3_D_2_2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g4(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g4', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g4_D_1(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g4_D_1', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g4_D_2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g4_D_2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g4_D_1_1(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g4_D_1_1', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g4_D_1_2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g4_D_1_2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g4_D_2_2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g4_D_2_2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g1(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g1', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g1_D_1(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g1_D_1', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g1_D_2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g1_D_2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g1_D_1_1(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g1_D_1_1', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g1_D_1_2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g1_D_1_2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
...
ProblemStorage::do_g1_D_2_2(
  ...
  #define CMD "res = " MODEL_NAME "_Mex('g1_D_2_2', obj, xo__x1, xo__x2 ): "
  CHECK_IN_OUT( 4, 1 );
  mwSize N0, M0;
  real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x1" );
  mwSize N1, M1;
