%-----------------------------------------------------------------------%
%  file: LUUS_DrugDisplacement_fsolve_main.m                            %
%                                                                       %
...
ocp.setup( [DATA_PATH 'LUUS_DrugDisplacement_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = LUUS_DrugDisplacement_Mex('get_raw_solution',obj);
%J        = LUUS_DrugDisplacement_Mex('eval_JF',obj,Z,MU,U);
%f        = LUUS_DrugDisplacement_Mex('eval_F',obj,Z,MU,U);
