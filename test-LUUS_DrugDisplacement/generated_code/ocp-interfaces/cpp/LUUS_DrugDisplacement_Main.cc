...
main() {
  ...
  try {
    LUUS_DrugDisplacement * m_model = new LUUS_DrugDisplacement("LUUS_DrugDisplacement",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/LUUS_DrugDisplacement_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/LUUS_DrugDisplacement_Data.lua";
    #endif
