...
#ifndef LUUS_DRUGDISPLACEMENT_DOT_HH
#define LUUS_DRUGDISPLACEMENT_DOT_HH
...
// User Header (end)
  ...
  #ifndef LUUS_DRUGDISPLACEMENT_API_DLL
    #ifdef LUUS_DRUGDISPLACEMENT_EXPORT
      #define LUUS_DRUGDISPLACEMENT_API_DLL __declspec(dllexport)
    #elif defined(LUUS_DRUGDISPLACEMENT_IMPORT)
      #define LUUS_DRUGDISPLACEMENT_API_DLL __declspec(dllimport)
    #else
      #define LUUS_DRUGDISPLACEMENT_API_DLL
    #endif
  #endif
...
namespace LUUS_DrugDisplacementDefine {
  ...
  class LUUS_DrugDisplacement : public Mechatronix::Discretized_Indirect_OCP {
    ...
    LUUS_DrugDisplacement( LUUS_DrugDisplacement const & );
    LUUS_DrugDisplacement const & operator = ( LUUS_DrugDisplacement const & );
  ...
  public:
    ...
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g2      ( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g2_D_1  ( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g2_D_1_1( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g2_D_1_2( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g2_D_2  ( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g2_D_2_2( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g3      ( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g3_D_1  ( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g3_D_1_1( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g3_D_1_2( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g3_D_2  ( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g3_D_2_2( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g4      ( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g4_D_1  ( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g4_D_1_1( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g4_D_1_2( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g4_D_2  ( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g4_D_2_2( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g1      ( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g1_D_1  ( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g1_D_1_1( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g1_D_1_2( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g1_D_2  ( real_type xo__x1, real_type xo__x2 ) const;
    LUUS_DRUGDISPLACEMENT_API_DLL real_type g1_D_2_2( real_type xo__x1, real_type xo__x2 ) const;
...
namespace LUUS_DrugDisplacementLoad {
  using LUUS_DrugDisplacementDefine::LUUS_DrugDisplacement;

}

#endif

// EOF: LUUS_DrugDisplacement.hh
