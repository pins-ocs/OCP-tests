...
namespace LUUS_DrugDisplacementDefine {
  ...
  void
  LUUS_DrugDisplacement::continuation_step_0( real_type s ) {
    real_type t2   = 1 - s;
  ...
  real_type
  LUUS_DrugDisplacement::penalties_eval(
  ...
  real_type
  LUUS_DrugDisplacement::control_penalties_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__
  ) const {
  ...
  integer
  LUUS_DrugDisplacement::DmayerDxxp_numEqns() const
  { return 5; }
  ...
  integer
  LUUS_DrugDisplacement::DlagrangeDxup_numEqns() const
  { return 4; }

  void
  LUUS_DrugDisplacement::DlagrangeDxup_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  LUUS_DrugDisplacement::DJDx_numEqns() const
  { return 2; }

  void
  LUUS_DrugDisplacement::DJDx_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  LUUS_DrugDisplacement::DJDp_numEqns() const
  { return 1; }

  void
  LUUS_DrugDisplacement::DJDp_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  LUUS_DrugDisplacement::DJDu_numEqns() const
  { return 1; }

  void
  LUUS_DrugDisplacement::DJDu_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  LUUS_DrugDisplacement::q_numEqns() const
  { return 1; }
  ...
  integer
  LUUS_DrugDisplacement::segmentLink_numEqns() const
  { return 0; }
  ...
  integer
  LUUS_DrugDisplacement::DsegmentLinkDxp_numRows() const
  { return 0; }

  integer
  LUUS_DrugDisplacement::DsegmentLinkDxp_numCols() const
  { return 0; }

  integer
  LUUS_DrugDisplacement::DsegmentLinkDxp_nnz() const
  { return 0; }
  ...
  integer
  LUUS_DrugDisplacement::jump_numEqns() const
  { return 4; }
  ...
  integer
  LUUS_DrugDisplacement::DjumpDxlxlp_numRows() const
  { return 4; }

  integer
  LUUS_DrugDisplacement::DjumpDxlxlp_numCols() const
  { return 9; }

  integer
  LUUS_DrugDisplacement::DjumpDxlxlp_nnz() const
  { return 8; }

  void
  LUUS_DrugDisplacement::DjumpDxlxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  integer
  LUUS_DrugDisplacement::post_numEqns() const
  { return 1; }
  ...
  integer
  LUUS_DrugDisplacement::integrated_post_numEqns() const
  { return 0; }
...
// EOF: LUUS_DrugDisplacement_Methods_problem.cc
