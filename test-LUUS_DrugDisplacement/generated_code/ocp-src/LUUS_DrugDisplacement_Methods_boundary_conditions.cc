...
namespace LUUS_DrugDisplacementDefine {
  ...
  integer LUUS_DrugDisplacement::bc_numEqns() const { return 4; }

  void
  LUUS_DrugDisplacement::bc_eval(
    NodeQX const & LEFT__,
  ...
  integer LUUS_DrugDisplacement::fd_BC_numEqns() const { return 4; }

  void
  LUUS_DrugDisplacement::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer LUUS_DrugDisplacement::Dfd_BCDxlxlp_numRows() const { return 5; }
  integer LUUS_DrugDisplacement::Dfd_BCDxlxlp_numCols() const { return 9; }
  integer LUUS_DrugDisplacement::Dfd_BCDxlxlp_nnz()     const { return 4; }

  void
  LUUS_DrugDisplacement::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  LUUS_DrugDisplacement::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
