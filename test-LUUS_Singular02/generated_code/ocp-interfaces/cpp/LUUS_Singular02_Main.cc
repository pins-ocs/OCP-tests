...
main() {
  ...
  try {
    LUUS_Singular02 * m_model = new LUUS_Singular02("LUUS_Singular02",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/LUUS_Singular02_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/LUUS_Singular02_Data.lua";
    #endif
