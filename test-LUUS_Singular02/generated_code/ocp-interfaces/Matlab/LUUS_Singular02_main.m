...
% create object
ocp = LUUS_Singular02( 'LUUS_Singular02' );
...
%ocp.setup(LUUS_Singular02_data);
ocp.setup('../../data/LUUS_Singular02_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%LUUS_Singular02_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = LUUS_Singular02_Mex('get_raw_solution',obj);
%J     = LUUS_Singular02_Mex('eval_JF',obj,Z,MU,U);
%f     = LUUS_Singular02_Mex('eval_F',obj,Z,MU,U);
