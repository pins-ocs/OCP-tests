...
%ocp.setup('../../data/LUUS_Singular02_Data.lua');
ocp.setup('../../data/LUUS_Singular02_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = LUUS_Singular02_Mex('get_raw_solution',obj);
%J     = LUUS_Singular02_Mex('eval_JF',obj,Z,U);
%f     = LUUS_Singular02_Mex('eval_F',obj,Z,U);
