...
#ifndef LUUS_SINGULAR02_DOT_HH
#define LUUS_SINGULAR02_DOT_HH
...
// User Header (end)
  ...
  #ifndef LUUS_SINGULAR02_API_DLL
    #ifdef LUUS_SINGULAR02_EXPORT
      #define LUUS_SINGULAR02_API_DLL __declspec(dllexport)
    #elif defined(LUUS_SINGULAR02_IMPORT)
      #define LUUS_SINGULAR02_API_DLL __declspec(dllimport)
    #else
      #define LUUS_SINGULAR02_API_DLL
    #endif
  #endif
...
namespace LUUS_Singular02Define {
  ...
  class LUUS_Singular02 : public Mechatronix::Discretized_Indirect_OCP {
    ...
    LUUS_Singular02( LUUS_Singular02 const & );
    LUUS_Singular02 const & operator = ( LUUS_Singular02 const & );
...
namespace LUUS_Singular02Load {
  using LUUS_Singular02Define::LUUS_Singular02;

}

#endif

// EOF: LUUS_Singular02.hh
