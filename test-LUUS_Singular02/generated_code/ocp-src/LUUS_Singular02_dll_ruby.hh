/*-----------------------------------------------------------------------*\
 |  file: LUUS_Singular02_dll_ruby.hh                                    |
 |                                                                       |
...
namespace LUUS_Singular02Define {
  ...
  public:
    ...
    LUUS_Singular02_Problem( integer n_threads, Console const * console )
    : model("LUUS_Singular02",n_threads,console)
    , mesh( "mesh" )
    {
  ...
  */
  ...
  LUUS_SINGULAR02_API_DLL
  bool
  LUUS_Singular02_ocp_guess( char const id[], GenericContainer & gc_guess );
...
// EOF: LUUS_Singular02_dll_ruby.hh
