...
namespace LUUS_Singular02Define {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer LUUS_Singular02::DHxpDxpu_numRows() const { return 2; }
  integer LUUS_Singular02::DHxpDxpu_numCols() const { return 3; }
  integer LUUS_Singular02::DHxpDxpu_nnz()     const { return 1; }

  void
  LUUS_Singular02::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
  }


  void
  LUUS_Singular02::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
