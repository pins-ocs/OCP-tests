...
namespace LUUS_Singular02Define {
  ...
  integer LUUS_Singular02::Hxp_numEqns() const { return 2; }

  void
  LUUS_Singular02::Hxp_eval(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer LUUS_Singular02::DHxpDxpuv_numRows() const { return 2; }
  integer LUUS_Singular02::DHxpDxpuv_numCols() const { return 5; }
  integer LUUS_Singular02::DHxpDxpuv_nnz()     const { return 2; }

  void
  LUUS_Singular02::DHxpDxpuv_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  LUUS_Singular02::DHxpDxpuv_sparse(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__,
