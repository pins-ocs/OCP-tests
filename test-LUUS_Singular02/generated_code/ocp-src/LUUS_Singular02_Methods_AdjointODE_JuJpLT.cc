...
namespace LUUS_Singular02Define {
  ...
  integer LUUS_Singular02::JP_numEqns() const { return 0; }
  ...
  integer LUUS_Singular02::LT_numEqns() const { return 0; }
  ...
  integer LUUS_Singular02::JU_numEqns() const { return 1; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer LUUS_Singular02::DJPDxpu_numRows() const { return 0; }
  integer LUUS_Singular02::DJPDxpu_numCols() const { return 3; }
  integer LUUS_Singular02::DJPDxpu_nnz()     const { return 0; }

  void
  LUUS_Singular02::DJPDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  LUUS_Singular02::DJPDxpu_sparse(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer LUUS_Singular02::DLTDxpu_numRows() const { return 0; }
  integer LUUS_Singular02::DLTDxpu_numCols() const { return 3; }
  integer LUUS_Singular02::DLTDxpu_nnz()     const { return 0; }

  void
  LUUS_Singular02::DLTDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  LUUS_Singular02::DLTDxpu_sparse(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer LUUS_Singular02::DJUDxpu_numRows() const { return 1; }
  integer LUUS_Singular02::DJUDxpu_numCols() const { return 3; }
  integer LUUS_Singular02::DJUDxpu_nnz()     const { return 2; }

  void
  LUUS_Singular02::DJUDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  LUUS_Singular02::DJUDxpu_sparse(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
