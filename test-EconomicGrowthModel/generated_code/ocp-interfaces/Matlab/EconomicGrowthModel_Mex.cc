...
DO_COMMAND_REMAP_TO_CLASS_METHOD(x1L);
DO_COMMAND_REMAP_TO_CLASS_METHOD(x1L_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(x2L);
DO_COMMAND_REMAP_TO_CLASS_METHOD(x2L_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(l1L);
DO_COMMAND_REMAP_TO_CLASS_METHOD(l1L_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(l2L);
DO_COMMAND_REMAP_TO_CLASS_METHOD(l2L_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(x1R);
DO_COMMAND_REMAP_TO_CLASS_METHOD(x1R_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(x2R);
DO_COMMAND_REMAP_TO_CLASS_METHOD(x2R_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(l1R);
DO_COMMAND_REMAP_TO_CLASS_METHOD(l1R_D);
DO_COMMAND_REMAP_TO_CLASS_METHOD(l2R);
DO_COMMAND_REMAP_TO_CLASS_METHOD(l2R_D);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "EconomicGrowthModel_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "EconomicGrowthModel_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
