...
"EconomicGrowthModel_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "EconomicGrowthModel"
#define MODEL_CLASS EconomicGrowthModel
...
public:
  ...
  )
  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "EconomicGrowthModel_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "EconomicGrowthModel_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
  ...
  )
  {
    ...
    try {
      ...
      string msg = fmt::format( "EconomicGrowthModel_Mex('eval_F',...) error: {}", exc.what() );
...
do_x1L(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_x1L( nlhs, plhs, nrhs, prhs );
}
...
do_x1L_D(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_x1L_D( nlhs, plhs, nrhs, prhs );
}
...
do_x1L_DD(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_x1L_DD( nlhs, plhs, nrhs, prhs );
}
...
do_x2L(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_x2L( nlhs, plhs, nrhs, prhs );
}
...
do_x2L_D(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_x2L_D( nlhs, plhs, nrhs, prhs );
}
...
do_x2L_DD(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_x2L_DD( nlhs, plhs, nrhs, prhs );
}
...
do_l1L(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_l1L( nlhs, plhs, nrhs, prhs );
}
...
do_l1L_D(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_l1L_D( nlhs, plhs, nrhs, prhs );
}
...
do_l1L_DD(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_l1L_DD( nlhs, plhs, nrhs, prhs );
}
...
do_l2L(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_l2L( nlhs, plhs, nrhs, prhs );
}
...
do_l2L_D(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_l2L_D( nlhs, plhs, nrhs, prhs );
}
...
do_l2L_DD(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_l2L_DD( nlhs, plhs, nrhs, prhs );
}
...
do_x1R(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_x1R( nlhs, plhs, nrhs, prhs );
}
...
do_x1R_D(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_x1R_D( nlhs, plhs, nrhs, prhs );
}
...
do_x1R_DD(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_x1R_DD( nlhs, plhs, nrhs, prhs );
}
...
do_x2R(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_x2R( nlhs, plhs, nrhs, prhs );
}
...
do_x2R_D(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_x2R_D( nlhs, plhs, nrhs, prhs );
}
...
do_x2R_DD(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_x2R_DD( nlhs, plhs, nrhs, prhs );
}
...
do_l1R(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_l1R( nlhs, plhs, nrhs, prhs );
}
...
do_l1R_D(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_l1R_D( nlhs, plhs, nrhs, prhs );
}
...
do_l1R_DD(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_l1R_DD( nlhs, plhs, nrhs, prhs );
}
...
do_l2R(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_l2R( nlhs, plhs, nrhs, prhs );
}
...
do_l2R_D(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_l2R_D( nlhs, plhs, nrhs, prhs );
}
...
do_l2R_DD(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_l2R_DD( nlhs, plhs, nrhs, prhs );
}
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "EconomicGrowthModel_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "EconomicGrowthModel_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
