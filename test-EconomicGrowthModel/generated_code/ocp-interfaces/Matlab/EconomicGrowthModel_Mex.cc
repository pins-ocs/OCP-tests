...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"Q",&ProblemStorage::do_Q},
  {"Q_D_1",&ProblemStorage::do_Q_D_1},
  {"Q_D_2",&ProblemStorage::do_Q_D_2},
  {"Q_D_1_1",&ProblemStorage::do_Q_D_1_1},
  {"Q_D_1_2",&ProblemStorage::do_Q_D_1_2},
  {"Q_D_2_2",&ProblemStorage::do_Q_D_2_2},
  {"x1L",&ProblemStorage::do_x1L},
  {"x1L_D",&ProblemStorage::do_x1L_D},
  {"x2L",&ProblemStorage::do_x2L},
  {"x2L_D",&ProblemStorage::do_x2L_D},
  {"l1L",&ProblemStorage::do_l1L},
  {"l1L_D",&ProblemStorage::do_l1L_D},
  {"l2L",&ProblemStorage::do_l2L},
  {"l2L_D",&ProblemStorage::do_l2L_D},
  {"x1R",&ProblemStorage::do_x1R},
  {"x1R_D",&ProblemStorage::do_x1R_D},
  {"x2R",&ProblemStorage::do_x2R},
  {"x2R_D",&ProblemStorage::do_x2R_D},
  {"l1R",&ProblemStorage::do_l1R},
  {"l1R_D",&ProblemStorage::do_l1R_D},
  {"l2R",&ProblemStorage::do_l2R},
  {"l2R_D",&ProblemStorage::do_l2R_D}
};
...
mexFunction(
  ...
  try {
    ...
    if ( it != cmd_to_fun2.end() ) {
      ...
      UTILS_MEX_ASSERT(
        nrhs >= 2,
        "EconomicGrowthModel_Mex('{}',obj,...): Expected at least 2 argument(s), nrhs = {}\n",
        cmd, nrhs
      );
