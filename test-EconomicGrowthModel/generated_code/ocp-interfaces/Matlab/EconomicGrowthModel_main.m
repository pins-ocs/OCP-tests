%-----------------------------------------------------------------------%
%  file: EconomicGrowthModel_main.m                                     %
%                                                                       %
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%EconomicGrowthModel_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = EconomicGrowthModel_Mex('get_raw_solution',obj);
%J     = EconomicGrowthModel_Mex('eval_JF',obj,Z,MU,U);
%f     = EconomicGrowthModel_Mex('eval_F',obj,Z,MU,U);
