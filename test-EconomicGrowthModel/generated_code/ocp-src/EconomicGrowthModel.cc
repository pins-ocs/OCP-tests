...
namespace EconomicGrowthModelDefine {
  ...
  */
  void
  EconomicGrowthModel::update_continuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
  ...
  */
  void
  EconomicGrowthModel::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "EconomicGrowthModel::setup_parameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  EconomicGrowthModel::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  EconomicGrowthModel::setup_classes( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Constraints"),
      "EconomicGrowthModel::setup_classes: Missing key `Parameters` in data\n"
    );
    GenericContainer const & gc = gc_data("Constraints");
    // Initialize Constraints 1D
    UTILS_ASSERT0(
      gc.exists("Tpositive"),
      "in EconomicGrowthModel::setup_classes(gc) missing key: ``Tpositive''\n"
    );
  ...
  */
  void
  EconomicGrowthModel::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  EconomicGrowthModel::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  EconomicGrowthModel::setup_controls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "EconomicGrowthModel::setup_classes: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  EconomicGrowthModel::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "EconomicGrowthModel::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in EconomicGrowthModel::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  EconomicGrowthModel::info_model( integer level ) const {
