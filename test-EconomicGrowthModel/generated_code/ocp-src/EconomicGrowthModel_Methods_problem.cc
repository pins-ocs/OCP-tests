...
namespace EconomicGrowthModelDefine {
  ...
  EconomicGrowthModel::H_eval(
    ...
    real_type result__ = t3 * t1 + t14 * t1 * (L__[iL_lambda2__xo] * (1 - t2) + t2 * L__[iL_lambda1__xo]) + t16;
    return result__;
  }
#else
  real_type
  ...
  real_type
  EconomicGrowthModel::penalties_eval(
  ...
  real_type
  EconomicGrowthModel::control_penalties_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__
  ) const {
  ...
  integer
  EconomicGrowthModel::DmayerDx_numEqns() const
  { return 6; }

  void
  EconomicGrowthModel::DmayerDx_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  EconomicGrowthModel::DmayerDp_numEqns() const
  { return 0; }

  void
  EconomicGrowthModel::DmayerDp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  EconomicGrowthModel::DJDx_numEqns() const
  { return 3; }

  void
  EconomicGrowthModel::DJDx_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_ptr             result__
    ...
    real_type t4   = uControl(U__[iU_u], 0, 1);
    result__[ 2   ] = t2 + t4;
    if ( m_debug )
  ...
  integer
  EconomicGrowthModel::DJDp_numEqns() const
  { return 0; }

  void
  EconomicGrowthModel::DJDp_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  EconomicGrowthModel::DJDu_numEqns() const
  { return 1; }

  void
  EconomicGrowthModel::DJDu_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  EconomicGrowthModel::integrated_post_numEqns() const
  { return 0; }
