...
namespace EconomicGrowthModelDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer EconomicGrowthModel::IPOPT_hess_numRows() const { return 4; }
  integer EconomicGrowthModel::IPOPT_hess_numCols() const { return 4; }
  integer EconomicGrowthModel::IPOPT_hess_nnz()     const { return 14; }

  void
  EconomicGrowthModel::IPOPT_hess_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  EconomicGrowthModel::IPOPT_hess_sparse(
    NodeType2 const    & NODE__,
  ...
  integer EconomicGrowthModel::post_numEqns() const { return 5; }
