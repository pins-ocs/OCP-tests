...
namespace EconomicGrowthModelDefine {
  ...
  real_type
  EconomicGrowthModel::Q( real_type x__XO, real_type y__XO ) const {
    return x__XO * y__XO;
  }

  real_type
  EconomicGrowthModel::Q_D_1( real_type x__XO, real_type y__XO ) const {
    return y__XO;
  }

  real_type
  EconomicGrowthModel::Q_D_1_1( real_type x__XO, real_type y__XO ) const {
    return 0;
  }

  real_type
  EconomicGrowthModel::Q_D_1_2( real_type x__XO, real_type y__XO ) const {
    return 1;
  }

  real_type
  EconomicGrowthModel::Q_D_2( real_type x__XO, real_type y__XO ) const {
    return x__XO;
  }

  real_type
  EconomicGrowthModel::Q_D_2_2( real_type x__XO, real_type y__XO ) const {
    return 0;
  }
...
// EOF: EconomicGrowthModel_Methods1.cc
