...
namespace EconomicGrowthModelDefine {
  ...
  */
  EconomicGrowthModel::EconomicGrowthModel(
    string  const & name,
    ThreadPool    * _TP,
  ...
  */
  void
  EconomicGrowthModel::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  EconomicGrowthModel::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "EconomicGrowthModel::setupParameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in EconomicGrowthModel::setup not all parameters are set!\n"
    );
  }

  void
  EconomicGrowthModel::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  EconomicGrowthModel::setupClasses( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Constraints"),
      "EconomicGrowthModel::setupClasses: Missing key `Parameters` in data\n"
    );
    GenericContainer const & gc = gc_data("Constraints");
    // Initialize Constraints 1D
    UTILS_ASSERT0(
      gc.exists("Tpositive"),
      "in EconomicGrowthModel::setupClasses(gc) missing key: ``Tpositive''\n"
    );
  ...
  */
  void
  EconomicGrowthModel::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  EconomicGrowthModel::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  EconomicGrowthModel::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "EconomicGrowthModel::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  EconomicGrowthModel::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "EconomicGrowthModel::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in EconomicGrowthModel::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  EconomicGrowthModel::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  EconomicGrowthModel::setup( GenericContainer const & gc ) {

    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("EconomicGrowthModel::setup, Debug");
  ...
  */
  void
  EconomicGrowthModel::get_names( GenericContainer & out ) const {
  ...
  */
  void
  EconomicGrowthModel::diagnostic( GenericContainer const & gc ) {
  ...
  void
  EconomicGrowthModel::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
