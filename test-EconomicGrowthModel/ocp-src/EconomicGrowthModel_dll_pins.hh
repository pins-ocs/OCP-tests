/*-----------------------------------------------------------------------*\
 |  file: EconomicGrowthModel_dll_pins.hh                                |
 |                                                                       |
...
namespace EconomicGrowthModelDefine {
  ...
  public:
    ...
    EconomicGrowthModel_Problem( ThreadPool * TP, Console const * console )
    : model("EconomicGrowthModel",TP,console)
    , mesh( "mesh" )
    {
...
// EOF: EconomicGrowthModel_dll_pins.hh
