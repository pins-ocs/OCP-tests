...
unless ocp.ocp_solution[:Error] then
  if ocp.ocp_solution[:converged] then
    ...
    puts "Lagrange       = #{ocp.ocp_solution[:lagrange]}"
    puts "Mayer          = #{ocp.ocp_solution[:mayer]}"
    puts "Lagrange+Mayer = #{ocp.ocp_solution[:mayer]+ocp.ocp_solution[:lagrange]}"
  else
