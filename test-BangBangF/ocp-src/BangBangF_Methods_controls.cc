...
namespace BangBangFDefine {
  ...
  integer
  BangBangF::DgDxlp_numRows() const
  { return 1; }

  integer
  BangBangF::DgDxlp_numCols() const
  { return 4; }

  integer
  BangBangF::DgDxlp_nnz() const
  { return 1; }

  void
  BangBangF::DgDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  BangBangF::DgDu_sparse(
    ...
    real_type const * L__ = NODE__.lambda;
    MeshStd::SegmentClass const & segment = pMesh->getSegmentByIndex(i_segment);
    result__[ 0   ] = ALIAS_FControl_D_1_1(U__[0], -1, 1);
    if ( m_debug )
  ...
  \*/
  integer
  BangBangF::u_numEqns() const
  { return 1; }

  void
  BangBangF::u_eval_analytic(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    U_pointer_type       U__
  ) const {
  ...
  \*/
  void
  BangBangF::DuDxlp_full_analytic(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
  ...
  integer
  BangBangF::DjumpDxlp_numRows() const
  { return 4; }

  integer
  BangBangF::DjumpDxlp_numCols() const
  { return 8; }

  integer
  BangBangF::DjumpDxlp_nnz() const
  { return 8; }

  void
  BangBangF::DjumpDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
    iIndex[ 0  ] = 0   ; jIndex[ 0  ] = 0   ;
