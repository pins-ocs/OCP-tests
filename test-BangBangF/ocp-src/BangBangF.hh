...
#ifndef BANGBANGF_DOT_HH
#define BANGBANGF_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef BANGBANGF_API_DLL
    #ifdef BANGBANGF_EXPORT
      #define BANGBANGF_API_DLL __declspec(dllexport)
    #elif defined(BANGBANGF_IMPORT)
      #define BANGBANGF_API_DLL __declspec(dllimport)
    #else
      #define BANGBANGF_API_DLL
    #endif
  #endif
...
namespace BangBangFDefine {
  ...
  class BangBangF : public Mechatronix::Discretized_Indirect_OCP {
    ...
    BangBangF( BangBangF const & );
    BangBangF const & operator = ( BangBangF const & );
  ...
  public:
    ...
    BANGBANGF_API_DLL virtual
    ~BangBangF() MECHATRONIX_OVERRIDE;
...
namespace BangBangFLoad {
  using BangBangFDefine::BangBangF;
