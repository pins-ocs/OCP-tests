...
namespace BangBangFDefine {
  ...
  void
  BangBangF::p_guess_eval( P_p_type P__ ) const {
  }

  void
  BangBangF::xlambda_guess_eval(
    integer        i_segment,
    Q_const_p_type Q__,
    P_const_p_type P__,
    X_p_type       X__,
  ...
  bool
  BangBangF::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  BangBangF::penalties_check(
    ...
    ok = ok && C1_constr.check_range(t2);
    return ok;
  }
  ...
  integer BangBangF::u_guess_numEqns() const { return 1; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  BangBangF::u_guess_eval(
    NodeQXL const & NODE__,
    P_const_p_type  P__,
  ...
  bool
  BangBangF::u_check_if_admissible(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__
