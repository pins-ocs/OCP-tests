...
namespace BangBangFDefine {
  ...
  integer BangBangF::JPxpu_numEqns() const { return 3; }

  void
  BangBangF::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer BangBangF::JUxpu_numEqns() const { return 3; }

  void
  BangBangF::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
    ...
    result__[ 0   ] = 0;
    result__[ 1   ] = 0;
    result__[ 2   ] = ALIAS_FControl_D_1(U__[iU_F], -1, 1);
    if ( m_debug )
  ...
  integer BangBangF::LTxpu_numEqns() const { return 3; }

  void
  BangBangF::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
