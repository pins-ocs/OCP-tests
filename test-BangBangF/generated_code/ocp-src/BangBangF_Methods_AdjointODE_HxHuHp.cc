...
namespace BangBangFDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangF::DHxpDxpu_numRows() const { return 2; }
  integer BangBangF::DHxpDxpu_numCols() const { return 3; }
  integer BangBangF::DHxpDxpu_nnz()     const { return 0; }

  void
  BangBangF::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangF::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
