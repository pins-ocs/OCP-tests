...
namespace BangBangFDefine {
  ...
  class BangBangF_Problem {
    ...
    BangBangF_Problem( BangBangF_Problem const & );
    BangBangF_Problem const & operator = ( BangBangF_Problem const & );
  ...
  public:
    ...
    BANGBANGF_API_DLL
    BangBangF_Problem( integer n_threads, Console const * console )
    : model("BangBangF",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "BangBangF::solver, fatal: unknown error";
      }
      return ok;
    }
