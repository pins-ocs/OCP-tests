...
namespace BangBangFDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangF::D2mayerD2xxp_numRows() const { return 4; }
  integer BangBangF::D2mayerD2xxp_numCols() const { return 4; }
  integer BangBangF::D2mayerD2xxp_nnz()     const { return 0; }

  void
  BangBangF::D2mayerD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangF::D2mayerD2xxp_sparse(
    NodeQX const & LEFT__,
    NodeQX const & RIGHT__,
    P_const_p_type P__,
    real_ptr       result__
  ...
  integer BangBangF::DlagrangeDxpu_numEqns() const { return 3; }

  void
  BangBangF::DlagrangeDxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangF::D2lagrangeD2xpu_numRows() const { return 3; }
  integer BangBangF::D2lagrangeD2xpu_numCols() const { return 3; }
  integer BangBangF::D2lagrangeD2xpu_nnz()     const { return 0; }

  void
  BangBangF::D2lagrangeD2xpu_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangF::D2lagrangeD2xpu_sparse(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer BangBangF::DsegmentLinkDxxp_numRows() const { return 0; }
  integer BangBangF::DsegmentLinkDxxp_numCols() const { return 0; }
  integer BangBangF::DsegmentLinkDxxp_nnz() const { return 0; }

  void
  BangBangF::DsegmentLinkDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  BangBangF::DsegmentLinkDxxp_sparse(
    NodeQX const & L,
    NodeQX const & R,
    P_const_p_type p,
  ...
  integer BangBangF::post_numEqns() const { return 3; }
