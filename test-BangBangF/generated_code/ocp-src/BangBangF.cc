...
namespace BangBangFDefine {
  ...
  */
  ...
  void
  BangBangF::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  BangBangF::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  BangBangF::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  BangBangF::setup_controls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "BangBangF::setup_classes: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  BangBangF::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "BangBangF::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in BangBangF::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  BangBangF::info_model( integer level ) const {
    ...
    m_console->message( C1_constr.info(),level);
