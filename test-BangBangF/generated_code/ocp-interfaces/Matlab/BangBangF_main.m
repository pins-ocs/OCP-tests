...
%ocp.setup(BangBangF_data);
ocp.setup('../../data/BangBangF_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%BangBangF_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = BangBangF_Mex('get_raw_solution',obj);
%J     = BangBangF_Mex('eval_JF',obj,Z,MU,U);
%f     = BangBangF_Mex('eval_F',obj,Z,MU,U);
