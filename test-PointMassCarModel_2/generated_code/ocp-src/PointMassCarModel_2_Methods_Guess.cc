...
namespace PointMassCarModel_2Define {
  ...
  void
  PointMassCarModel_2::p_guess_eval( P_p_type P__ ) const {
  }
  ...
  bool
  PointMassCarModel_2::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  PointMassCarModel_2::u_guess_eval(
    ...
    UGUESS__[ iU_v__fx    ] = v__OmegaControl.solve(-t8 * ModelPars[iM_v__fx__max] * MU__[3], -1, 1);
    UGUESS__[ iU_v__Omega ] = v__OmegaControl.solve(-t8 * ModelPars[iM_v__Omega__max] * MU__[4], -1, 1);
    if ( m_debug )
