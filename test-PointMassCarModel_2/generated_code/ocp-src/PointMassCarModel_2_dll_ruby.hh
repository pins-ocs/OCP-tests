...
namespace PointMassCarModel_2Define {
  ...
  public:
    ...
    : m_model("PointMassCarModel_2",console,TP)
    , m_road( "road" )
    {
  ...
  */
  ...
  POINTMASSCARMODEL_2_API_DLL
  bool
  PointMassCarModel_2_ocp_guess( char const id[], GenericContainer & gc_guess );
...
// EOF: PointMassCarModel_2_dll_ruby.hh
