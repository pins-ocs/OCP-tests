...
namespace PointMassCarModel_2Define {
  ...
  void
  PointMassCarModel_2::continuation_step_2( real_type s ) {
  ...
  PointMassCarModel_2::H_eval(
    ...
    real_type t20  = t2 * t2;
    real_type result__ = 1.0 / t6 * ModelPars[iM_wT] + t11 * t2 * MU__[0] + (-t6 * t5 + X__[iX_Omega]) * MU__[1] + (-t20 * ModelPars[iM_kD] + X__[iX_fx]) * MU__[2] + MU__[3] * U__[iU_v__fx] * ModelPars[iM_v__fx__max] + MU__[4] * U__[iU_v__Omega] * ModelPars[iM_v__Omega__max];
    if ( m_debug ) {
  ...
  integer PointMassCarModel_2::DlagrangeDxpu_numEqns() const { return 7; }

  void
  PointMassCarModel_2::DlagrangeDxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_2::D2lagrangeD2xpu_numRows() const { return 7; }
  integer PointMassCarModel_2::D2lagrangeD2xpu_numCols() const { return 7; }
  integer PointMassCarModel_2::D2lagrangeD2xpu_nnz()     const { return 9; }

  void
  PointMassCarModel_2::D2lagrangeD2xpu_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  PointMassCarModel_2::D2lagrangeD2xpu_sparse(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer PointMassCarModel_2::DsegmentLinkDxxp_numRows() const { return 0; }
  integer PointMassCarModel_2::DsegmentLinkDxxp_numCols() const { return 0; }
  integer PointMassCarModel_2::DsegmentLinkDxxp_nnz() const { return 0; }

  void
  PointMassCarModel_2::DsegmentLinkDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  PointMassCarModel_2::DsegmentLinkDxxp_sparse(
    NodeQX const & L,
    NodeQX const & R,
    P_const_p_type p,
  ...
  integer PointMassCarModel_2::DjumpDxlxlp_nnz()     const { return 20; }
