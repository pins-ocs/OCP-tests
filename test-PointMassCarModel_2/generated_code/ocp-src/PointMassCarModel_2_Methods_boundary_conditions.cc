...
namespace PointMassCarModel_2Define {
  ...
  integer PointMassCarModel_2::bc_numEqns() const { return 6; }

  void
  PointMassCarModel_2::bc_eval(
    NodeQX const & LEFT__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_2::DbcDxxp_numRows() const { return 6; }
  integer PointMassCarModel_2::DbcDxxp_numCols() const { return 10; }
  integer PointMassCarModel_2::DbcDxxp_nnz()     const { return 11; }

  void
  PointMassCarModel_2::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  PointMassCarModel_2::DbcDxxp_sparse(
    NodeQX const & LEFT__,
    NodeQX const & RIGHT__,
    P_const_p_type P__,
    real_ptr       result__
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_2::D2bcD2xxp_numRows() const { return 10; }
  integer PointMassCarModel_2::D2bcD2xxp_numCols() const { return 10; }
  integer PointMassCarModel_2::D2bcD2xxp_nnz()     const { return 0; }

  void
  PointMassCarModel_2::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  PointMassCarModel_2::D2bcD2xxp_sparse(
    NodeQX const &          LEFT__,
    NodeQX const &          RIGHT__,
    P_const_p_type          P__,
  ...
  integer PointMassCarModel_2::fd_BC_numEqns() const { return 10; }

  void
  PointMassCarModel_2::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer PointMassCarModel_2::Dfd_BCDxlxlp_numRows() const { return 10; }
  integer PointMassCarModel_2::Dfd_BCDxlxlp_numCols() const { return 20; }
  integer PointMassCarModel_2::Dfd_BCDxlxlp_nnz()     const { return 10; }

  void
  PointMassCarModel_2::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  PointMassCarModel_2::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
