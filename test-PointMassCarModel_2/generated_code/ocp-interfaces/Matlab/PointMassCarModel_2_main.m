%-----------------------------------------------------------------------%
%  file: PointMassCarModel_2_main.m                                     %
%                                                                       %
...
%ocp.setup(PointMassCarModel_2_data);
%ocp.setup('../../data/PointMassCarModel_2_Data.lua');
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%PointMassCarModel_2_Mex('set_tracked',obj,tracked);
...
%[Z,U] = PointMassCarModel_2_Mex('get_raw_solution',obj);
%J     = PointMassCarModel_2_Mex('eval_JF',obj,Z,U);
%f     = PointMassCarModel_2_Mex('eval_F',obj,Z,U);
