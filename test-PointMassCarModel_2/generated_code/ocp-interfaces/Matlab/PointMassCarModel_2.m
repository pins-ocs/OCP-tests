...
classdef PointMassCarModel_2 < handle
  ...
  methods
    % ---------------------------------------------------------------------
    function self = PointMassCarModel_2( name )
      %% Allocate the C++ class instance
      self.objectHandle = PointMassCarModel_2_Mex( 'new', name );
    end
    % ---------------------------------------------------------------------
    function delete( self )
      %% Destroy the C++ class instance
      PointMassCarModel_2_Mex( 'delete', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function help( ~ )
      %% print help for the class usage
      PointMassCarModel_2_Mex('help');
    end
    ...
    function data = read( self, fname )
      ...
      %
      data = PointMassCarModel_2_Mex( 'read', self.objectHandle, fname );
    end
    % ---------------------------------------------------------------------
    function setup( self, fname_or_struct )
      ...
      %
      PointMassCarModel_2_Mex( 'setup', self.objectHandle, fname_or_struct );
      res = PointMassCarModel_2_Mex( 'dims', self.objectHandle );
    ...
    function res = get_dim_Q( self )
      PointMassCarModel_2_Mex( 'dim_Q', self.objectHandle );
      res = PointMassCarModel_2_Mex( 'dim_Q', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = get_dim_X( self )
      PointMassCarModel_2_Mex( 'dim_X', self.objectHandle );
      res = PointMassCarModel_2_Mex( 'dim_X', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = get_dim_Pars( self )
      PointMassCarModel_2_Mex( 'dim_Pars', self.objectHandle );
      res = PointMassCarModel_2_Mex( 'dim_Pars', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = get_dim_BC( self )
      PointMassCarModel_2_Mex( 'dim_BC', self.objectHandle );
      res = PointMassCarModel_2_Mex( 'dim_BC', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = get_dim_Post( self )
      PointMassCarModel_2_Mex( 'dim_Post', self.objectHandle );
      res = PointMassCarModel_2_Mex( 'dim_Post', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = get_dim_Ipost( self )
      PointMassCarModel_2_Mex( 'dim_Ipost', self.objectHandle );
      res = PointMassCarModel_2_Mex( 'dim_Ipost', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = get_num_active_BC( self )
      PointMassCarModel_2_Mex( 'num_active_BC', self.objectHandle );
      res = PointMassCarModel_2_Mex( 'num_active_BC', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = get_num_nodes( self )
      PointMassCarModel_2_Mex( 'num_nodes', self.objectHandle );
      res = PointMassCarModel_2_Mex( 'num_nodes', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = get_num_equations( self )
      PointMassCarModel_2_Mex( 'num_equations', self.objectHandle );
      res = PointMassCarModel_2_Mex( 'num_equations', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = get_num_segments( self )
      PointMassCarModel_2_Mex( 'num_segments', self.objectHandle );
      res = PointMassCarModel_2_Mex( 'num_segments', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = get_dim_full_bc( self )
      PointMassCarModel_2_Mex( 'dim_full_bc', self.objectHandle );
      res = PointMassCarModel_2_Mex( 'dim_full_bc', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = get_dim_ineq( self )
      PointMassCarModel_2_Mex( 'dim_ineq', self.objectHandle );
      res = PointMassCarModel_2_Mex( 'dim_ineq', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function n = names( self )
      ...
      %
      n = PointMassCarModel_2_Mex( 'names', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    ...
    function res = get_ocp_data( self )
      ...
      % res.Pointers
      %
      res = PointMassCarModel_2_Mex( 'get_ocp_data', self.objectHandle );
    end
    ...
    % ---------------------------------------------------------------------
    function info( self )
      PointMassCarModel_2_Mex( 'info', self.objectHandle );
    end
    ...
    function set_info_level( self, infoLvl )
      ...
      %
      PointMassCarModel_2_Mex( 'set_info_level', self.objectHandle, infoLvl );
    end
    %
    % DEPRECATED
    %
    ...
    function set_max_threads( self, nt )
      ...
      %
      PointMassCarModel_2_Mex( 'set_max_threads', self.objectHandle, nt );
    end
    ...
    function remesh( self, new_mesh )
      ...
      %
      PointMassCarModel_2_Mex( 'remesh', self.objectHandle, new_mesh );
    end
    ...
    function set_guess( self, varargin )
      ...
      %
      PointMassCarModel_2_Mex( 'set_guess', self.objectHandle, varargin{:} );
    end
    %
    % ---------------------------------------------------------------------
    %
    function guess = get_guess( self )
      ...
      %
      guess = PointMassCarModel_2_Mex( 'get_guess', self.objectHandle );
    end
    %
    % ---------------------------------------------------------------------
    %
    function guess = get_solution_as_guess( self )
      ...
      %
      guess = PointMassCarModel_2_Mex( 'get_solution_as_guess', self.objectHandle );
    end
    ...
    function ok = solve( self, varargin )
      ...
      %
      ok = PointMassCarModel_2_Mex( 'solve', self.objectHandle, varargin{:} );
    end
    %
    % ---------------------------------------------------------------------
    %
    function update_continuation( self, n, old_s, s )
      ...
      % the continuation.
      %
      PointMassCarModel_2_Mex( 'update_continuation', self.objectHandle, n, old_s, s );
    end
    ...
    function sol = solution( self, varargin )
      ...
      %
      %
      sol = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, varargin{:} );
    end
    % ---------------------------------------------------------------------
    function sol = solution_by_group( self )
      ...
      sol = PointMassCarModel_2_Mex( 'get_solution2', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function sol = solution_by_group_and_names( self )
      ...
      % res.data.control_penalties
      %
      sol = PointMassCarModel_2_Mex( 'get_solution3', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function sol = pack( self, X, Lambda, Pars, Omega )
      ...
      %
      sol = PointMassCarModel_2_Mex( 'pack', self.objectHandle, X, Lambda, Pars, Omega );
    end
    % ---------------------------------------------------------------------
    function [X, Lambda, Pars, Omega ] = unpack( self, sol )
      ...
      %
      [X, Lambda, Pars, Omega] = PointMassCarModel_2_Mex( 'unpack', self.objectHandle, sol );
    end
    % ---------------------------------------------------------------------
    function sol = pack_for_direct( self, X, U, Pars )
      ...
      %
      sol = PointMassCarModel_2_Mex( 'pack_for_direct', self.objectHandle, X, U, Pars );
    end
    % ---------------------------------------------------------------------
    function [X, U, Pars] = unpack_for_direct( self, sol )
      ...
      %
      [X, U, Pars] = PointMassCarModel_2_Mex( 'unpack_for_direct', self.objectHandle, sol );
    end
    % ---------------------------------------------------------------------
    function [Lambda,Omega] = estimate_multipliers( self, X, U, Pars, method )
      ...
      %
      [Lambda,Omega] = PointMassCarModel_2_Mex( 'estimate_multipliers', self.objectHandle, X, U, Pars, method );
    end
    ...
    function res = zeta( self )
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'zeta' );
    end
    ...
    function res = n( self )
      ...
      %
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'n' );
    end
    function res = alpha( self )
      %
      % Return the solution for the state: alpha
      %
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'alpha' );
    end
    function res = V( self )
      %
      % Return the solution for the state: V
      %
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'V' );
    end
    function res = Omega( self )
      %
      % Return the solution for the state: Omega
      %
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'Omega' );
    end
    function res = fx( self )
      %
      % Return the solution for the state: fx
      %
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'fx' );
    end
    ...
    function res = lambda1( self )
      ...
      %
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'lambda1__xo' );
    end
    function res = lambda2( self )
      %
      % Return the solution for the multiplier: lambda2
      %
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'lambda2__xo' );
    end
    function res = lambda3( self )
      %
      % Return the solution for the multiplier: lambda3
      %
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'lambda3__xo' );
    end
    function res = lambda4( self )
      %
      % Return the solution for the multiplier: lambda4
      %
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'lambda4__xo' );
    end
    function res = lambda5( self )
      %
      % Return the solution for the multiplier: lambda5
      %
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'lambda5__xo' );
    end
    ...
    function res = v__fx( self )
      ...
      %
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'v__fx' );
    end
    function res = v__Omega( self )
      %
      % Return the solution for the control: v__Omega
      %
      res = PointMassCarModel_2_Mex( 'get_solution', self.objectHandle, 'v__Omega' );
    end
    ...
    function U = init_U( self, Z, do_minimization )
      ...
      % Initialize `u`
      %
      U = PointMassCarModel_2_Mex( 'init_U', self.objectHandle, Z, do_minimization );
    end
    % ---------------------------------------------------------------------
    function U = eval_U( self, Z, u_guess )
      ...
      %
      U = PointMassCarModel_2_Mex( 'eval_U', self.objectHandle, Z, u_guess );
    end
    % ---------------------------------------------------------------------
    function [F,ok] = eval_F( self, Z, U )
      ...
      % Vector Z can be built as Z = pack( X, Lambda, Pars, Omega );
      %
      [F,ok] = PointMassCarModel_2_Mex( 'eval_F', self.objectHandle, Z, U );
    end
    % ---------------------------------------------------------------------
    function [JF,ok] = eval_JF( self, Z, U )
      ...
      % Vector Z can be built as Z = pack( X, Lambda, Pars, Omega );
      %
      [JF,ok] = PointMassCarModel_2_Mex( 'eval_JF', self.objectHandle, Z, U );
    end
    % ---------------------------------------------------------------------
    function JF = eval_JF_pattern( self )
      ...
      %
      JF = PointMassCarModel_2_Mex( 'eval_JF_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function [Z,U] = get_raw_solution( self )
      ...
      %
      [Z,U] = PointMassCarModel_2_Mex( 'get_raw_solution', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function set_raw_solution( self, Z, U )
      ...
      % Vector Z can be built as Z = pack( X, Lambda, Pars, Omega );
      %
      PointMassCarModel_2_Mex( 'set_raw_solution', self.objectHandle, Z, U );
    end
    % ---------------------------------------------------------------------
    function ok = check_raw_solution( self, Z )
      ...
      % admissible regions.
      %
      ok = PointMassCarModel_2_Mex( 'check_raw_solution', self.objectHandle, Z );
    end
    % ---------------------------------------------------------------------
    function check_jacobian( self, Z, U, epsi )
      ...
      %
      PointMassCarModel_2_Mex( 'check_jacobian', self.objectHandle, Z, U, epsi );
    end
    % ---------------------------------------------------------------------
    % ---------------------------------------------------------------------
    ...
    function [ac] = eval_ac( self, iseg_L, t_L, x_L, lambda_L, ...
      ...
      ac = PointMassCarModel_2_Mex( 'ac', self.objectHandle, ...
    ...
    function [ DacDxlxlp, DacDu ] = ...
      ...
      %
      [q_L,q_R] = self.eval_q_LR( iseg_L, t_L, iseg_R, t_R );
      [DacDxlxlp, DacDu] = PointMassCarModel_2_Mex( ...
    ...
    function [h,c] = eval_hc( self, iseg_L, t_L, x_L, lambda_L, ...
      ...
      %
      [q_L,q_R] = self.eval_q_LR( iseg_L, t_L, iseg_R, t_R );
      [h,c] = PointMassCarModel_2_Mex( 'hc', self.objectHandle, ...
    ...
    function [Jh,Jc] = eval_DhcDxlxlop( self, iseg_L, t_L, x_L, lambda_L, ...
      ...
      %
      [q_L,q_R] = self.eval_q_LR( iseg_L, t_L, iseg_R, t_R );
      [Jh,Jc] = PointMassCarModel_2_Mex( 'DhcDxlxlop', self.objectHandle, ...
        iseg_L,  q_L, x_L, lambda_L, iseg_R, q_R, x_R, lambda_R, pars ...
      );
    end
    % ---------------------------------------------------------------------
    ...
    function u = eval_u( self, iseg_L, t_L, x_L, lambda_L, ...
      ...
      if iseg_L == iseg_R
        [q_L,q_R] = self.eval_q_LR( iseg_L, t_L, iseg_R, t_R );
        u = PointMassCarModel_2_Mex( 'u', self.objectHandle, ...
          iseg_L, q_L, x_L, lambda_L, iseg_R, q_R, x_R, lambda_R, pars ...
        );
      else
    ...
    function DuDxlxlp = eval_DuDxlxlp( self, iseg_L, t_L, x_L, lambda_L, ...
      ...
      if iseg_L == iseg_R
        [q_L,q_R] = self.eval_q_LR( iseg_L, t_L, iseg_R, t_R );
        DuDxlxlp = PointMassCarModel_2_Mex( 'DuDxlxlp', self.objectHandle, ...
          iseg_L, q_L, x_L, lambda_L, iseg_R, q_R, x_R, lambda_R, pars ...
        );
      else
    ...
    function rhs = eval_rhs_ode( self, iseg, q, x, u, pars )
      ...
      %
      rhs = PointMassCarModel_2_Mex( 'rhs_ode', self.objectHandle, ...
        iseg, q, x, u, pars ...
      );
    end
    % ---------------------------------------------------------------------
    ...
    function A = eval_A( self, iseg, q, x, pars )
      ...
      % respect to `pars`.
      %
      A = PointMassCarModel_2_Mex( 'A', self.objectHandle, iseg, q, x, pars );
    end
    % ---------------------------------------------------------------------
    ...
    function nu = eval_nu( self, iseg, q, x, V, pars )
      ...
      %
      nu = PointMassCarModel_2_Mex( 'nu', self.objectHandle, iseg, q, x, V, pars );
    end
    % ---------------------------------------------------------------------
    function J = eval_DnuDxp( self, iseg, q, x, V, pars )
      ...
      % respect to `x` and `pars`.
      %
      J = PointMassCarModel_2_Mex( 'DnuDxp', self.objectHandle, iseg, q, x, V, pars );
    end
    % ---------------------------------------------------------------------
    function bc = eval_bc( self, iseg_L, t_L, x_L, iseg_R, t_R, x_R, pars )
      [q_L,q_R] = self.eval_q_LR( iseg_L, t_L, iseg_R, t_R );
      bc = PointMassCarModel_2_Mex( ...
    ...
    function fd_ode = eval_fd_ode( self, iseg_L, t_L, x_L, ...
      ...
      if iseg_L == iseg_R
        [q_L,q_R] = self.eval_q_LR( iseg_L, t_L, iseg_R, t_R );
        fd_ode = PointMassCarModel_2_Mex( ...
    ...
    function Dfd_odeDxxpu = eval_Dfd_odeDxxpu( self, iseg_L, t_L, x_L, ...
      ...
      if iseg_L == iseg_R
        [q_L,q_R] = self.eval_q_LR( iseg_L, t_L, iseg_R, t_R );
        Dfd_odeDxxpu = PointMassCarModel_2_Mex( ...
    ...
    function D2fd_odeD2xxpu = eval_D2fd_odeD2xxpu( self, iseg_L, t_L, x_L, ...
      ...
      if iseg_L == iseg_R
        [q_L,q_R] = self.eval_q_LR( iseg_L, t_L, iseg_R, t_R );
        D2fd_odeD2xxpu = PointMassCarModel_2_Mex( ...
    ...
    function DmayerDxxp = eval_DmayerDxxp( self, iseg_L, t_L, x_L, ...
                                                 ...
                                                 pars )
      [q_L,q_R] = self.eval_q_LR( iseg_L, t_L, iseg_R, t_R );
      DmayerDxxp = PointMassCarModel_2_Mex( ...
    ...
    function D2mayerD2xxp = eval_D2mayerD2xxp( self, iseg_L, t_L, x_L, ...
                                                     ...
                                                     pars )
      [q_L,q_R] = self.eval_q_LR( iseg_L, t_L, iseg_R, t_R );
      D2mayerD2xxp = PointMassCarModel_2_Mex( ...
    ...
    function J = eval_penalties( self, iseg, q, x, u, pars )
      ...
      %
      J = PointMassCarModel_2_Mex( 'JP', self.objectHandle, iseg, q, x, u, pars );
    end
    % ---------------------------------------------------------------------
    % ---------------------------------------------------------------------
    % ---------------------------------------------------------------------
    ...
    function target = eval_q( self, i_segment, s )
      target = PointMassCarModel_2_Mex( 'mesh_functions', self.objectHandle, i_segment, s );
    end
    % ---------------------------------------------------------------------
    function nodes = get_nodes( self )
      nodes = PointMassCarModel_2_Mex( 'nodes', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function node_to_segment = get_node_to_segment( self )
      node_to_segment = PointMassCarModel_2_Mex( 'node_to_segment', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    ...
    function res = A_pattern( self )
      res = PointMassCarModel_2_Mex('A_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DbcDxxp_pattern( self )
      res = PointMassCarModel_2_Mex('DbcDxxp_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = D2bcD2xxp_pattern( self )
      res = PointMassCarModel_2_Mex('D2bcD2xxp_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = Drhs_odeDxpu_pattern( self )
      res = PointMassCarModel_2_Mex('Drhs_odeDxpu_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DsegmentLinkDxp_pattern( self )
      res = PointMassCarModel_2_Mex('DsegmentLinkDxp_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DjumpDxlxlp_pattern( self )
      res = PointMassCarModel_2_Mex('DjumpDxlxlp_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DHxpDxpu_pattern( self )
      res = PointMassCarModel_2_Mex('DHxpDxpu_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DJPDxpu_pattern( self )
      res = PointMassCarModel_2_Mex('DJPDxpu_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DLTDxpu_pattern( self )
      res = PointMassCarModel_2_Mex('DLTDxpu_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DJUDxpu_pattern( self )
      res = PointMassCarModel_2_Mex('DJUDxpu_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = D2JPD2xpu_pattern( self )
      res = PointMassCarModel_2_Mex('D2JPD2xpu_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = D2LTD2xpu_pattern( self )
      res = PointMassCarModel_2_Mex('D2LTD2xpu_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = D2JUD2xpu_pattern( self )
      res = PointMassCarModel_2_Mex('D2JUD2xpu_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DLTargsDxpu_pattern( self )
      res = PointMassCarModel_2_Mex('DLTargsDxpu_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = D2LTargsD2xpu_pattern( self )
      res = PointMassCarModel_2_Mex('D2LTargsD2xpu_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DnuDxp_pattern( self )
      res = PointMassCarModel_2_Mex('DnuDxp_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DetaDxp_pattern( self )
      res = PointMassCarModel_2_Mex('DetaDxp_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DgDxlxlp_pattern( self )
      res = PointMassCarModel_2_Mex('DgDxlxlp_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DgDu_pattern( self )
      res = PointMassCarModel_2_Mex('DgDu_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = DmDuu_pattern( self )
      res = PointMassCarModel_2_Mex('DmDuu_pattern', self.objectHandle );
    end
    ...
    function res = zeta__dot( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_1( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_1', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_2( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_2', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_3( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_3', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_4( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_4', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_1_1( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_1_1', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_1_2( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_1_2', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_1_3( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_1_3', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_1_4( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_1_4', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_2_2( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_2_2', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_2_3( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_2_3', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_2_4( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_2_4', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_3_3( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_3_3', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_3_4( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_3_4', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_4_4( self, xo__V, xo__alpha, xo__n, xo__Kappa )
      res = PointMassCarModel_2_Mex('zeta__dot_D_4_4', self.objectHandle, xo__V, xo__alpha, xo__n, xo__Kappa );
    end
    % ---------------------------------------------------------------------
    % PLOT SOLUTION
    % ---------------------------------------------------------------------
