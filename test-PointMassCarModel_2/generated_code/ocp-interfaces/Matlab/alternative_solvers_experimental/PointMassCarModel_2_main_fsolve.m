...
ocp.setup( [DATA_PATH 'PointMassCarModel_2_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = PointMassCarModel_2_Mex('get_raw_solution',obj);
%J        = PointMassCarModel_2_Mex('eval_JF',obj,Z,MU,U);
%f        = PointMassCarModel_2_Mex('eval_F',obj,Z,MU,U);
