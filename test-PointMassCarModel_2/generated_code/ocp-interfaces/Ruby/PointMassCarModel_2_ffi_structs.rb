...
module PointMassCarModel_2
  ...
  class PointMassCarModel_2_solver_params < FFI::Struct
    layout(
      :max_iter,             :index_t,
  ...
  class PointMassCarModel_2_model_params < FFI::Struct
    layout(
  ...
  class PointMassCarModel_2_BC_params < FFI::Struct
    layout(
  ...
  attach_function :setup_model, # ruby name
                  :PointMassCarModel_2_setup_model, # C name
                  [:pointer ,:pointer ,:pointer ],
                  :void

  attach_function :setup_solver, # ruby name
                  :PointMassCarModel_2_setup_solver, # C name
                  [:pointer ],
                  :void

  attach_function :write_solution_to_file, # ruby name
                  :PointMassCarModel_2_write_solution_to_file, # C name
                  [:string],
                  :void

  attach_function :printout_enabled?, # ruby name
                  :PointMassCarModel_2_printout_is_enabled, # C name
                  [],
                  :int

  attach_function :enable_printout, # ruby name
                  :PointMassCarModel_2_enable_printout, # C name
                  [],
                  :void

  attach_function :disable_printout, # ruby name
                  :PointMassCarModel_2_disable_printout, # C name
                  [],
                  :void

  attach_function :reset_multiplier, # ruby name
                  :PointMassCarModel_2_reset_multiplier, # C name
                  [],
                  :void

  attach_function :reset_BC_multiplier, # ruby name
                  :PointMassCarModel_2_reset_BC_multiplier, # C name
                  [],
                  :void

  attach_function :set_internal_guess, # ruby name
                  :PointMassCarModel_2_set_internal_guess, # C name
                  [],
                  :void

end

# EOF: PointMassCarModel_2_ffi_stucts.rb
