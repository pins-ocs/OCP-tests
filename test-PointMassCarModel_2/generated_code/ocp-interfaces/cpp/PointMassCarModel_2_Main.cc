...
main() {
  ...
  try {
    PointMassCarModel_2 * m_model = new PointMassCarModel_2("PointMassCarModel_2",n_threads,&console);

    // user defined Object instances (external)
    Road2D           road( "road" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/PointMassCarModel_2_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/PointMassCarModel_2_Data.lua";
    #endif
