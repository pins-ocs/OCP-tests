/*-----------------------------------------------------------------------*\
 |  file: PointMassCarModel_2_Mex.cc                                     |
 |                                                                       |
...
"PointMassCarModel_2_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "PointMassCarModel_2"
#define MODEL_CLASS PointMassCarModel_2
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "PointMassCarModel_2_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "PointMassCarModel_2_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
