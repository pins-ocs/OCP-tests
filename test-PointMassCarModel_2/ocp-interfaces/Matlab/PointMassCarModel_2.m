...
classdef PointMassCarModel_2 < handle
  ...
  methods
    ...
    function res = zeta__dot( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_1( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_1', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_2( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_2', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_3( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_3', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_4( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_4', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_1_1( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_1_1', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_1_2( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_1_2', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_1_3( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_1_3', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_1_4( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_1_4', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_2_2( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_2_2', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_2_3( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_2_3', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_2_4( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_2_4', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_3_3( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_3_3', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_3_4( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_3_4', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    function res = zeta__dot_D_4_4( self, V__XO, alpha__XO, n__XO, Kappa__XO )
      res = PointMassCarModel_2_Mex('zeta__dot_D_4_4', self.objectHandle, V__XO, alpha__XO, n__XO, Kappa__XO );
    end
    % ---------------------------------------------------------------------
    % PLOT SOLUTION
    % ---------------------------------------------------------------------
