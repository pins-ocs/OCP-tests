...
namespace SingularArcDefine {
  ...
  integer
  SingularArc::DgDxlp_numRows() const
  { return 1; }

  integer
  SingularArc::DgDxlp_numCols() const
  { return 7; }

  integer
  SingularArc::DgDxlp_nnz() const
  { return 2; }

  void
  SingularArc::DgDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  integer
  SingularArc::DgDu_numRows() const
  { return 1; }

  integer
  SingularArc::DgDu_numCols() const
  { return 1; }

  integer
  SingularArc::DgDu_nnz() const
  { return 1; }

  void
  SingularArc::DgDu_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  \*/
  integer
  SingularArc::u_numEqns() const
  { return 1; }

  void
  SingularArc::u_eval_analytic(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    U_pointer_type       U__
  ) const {
  ...
  \*/
  void
  SingularArc::DuDxlp_full_analytic(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
  ...
  bool
  SingularArc::DuDxlp_full_numeric(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    MatrixWrapper<real_type> & DuDxlp
  ...
  integer
  SingularArc::segmentLink_numEqns() const
  { return 0; }

  void
  SingularArc::segmentLink_eval(
    NodeType const     & L,
    NodeType const     & R,
  ...
  integer
  SingularArc::DsegmentLinkDxp_numRows() const
  { return 0; }

  integer
  SingularArc::DsegmentLinkDxp_numCols() const
  { return 0; }

  integer
  SingularArc::DsegmentLinkDxp_nnz() const
  { return 0; }

  void
  SingularArc::DsegmentLinkDxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
    LW_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  SingularArc::DsegmentLinkDxp_sparse(
    NodeType const     & L,
    NodeType const     & R,
    P_const_pointer_type p,
  ...
  integer
  SingularArc::jump_numEqns() const
  { return 6; }

  void
  SingularArc::jump_eval(
    NodeType2 const    & LEFT__,
    NodeType2 const    & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
