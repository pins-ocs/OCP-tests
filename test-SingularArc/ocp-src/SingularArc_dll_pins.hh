...
namespace SingularArcDefine {
  ...
  using namespace SingularArcLoad;
  ...
  class SingularArc_Problem {
    ...
    SingularArc_Problem( SingularArc_Problem const & );
    SingularArc_Problem const & operator = ( SingularArc_Problem const & );
  ...
  public:
    ...
    SINGULARARC_API_DLL
    SingularArc_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("SingularArc",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "SingularArc::solver, fatal: unknown error";
      }
      return ok;
    }
