...
namespace SingularArcDefine {
  ...
  integer
  SingularArc::boundaryConditions_numEqns() const
  { return 5; }

  void
  SingularArc::boundaryConditions_eval(
  ...
  integer
  SingularArc::adjointBC_numEqns() const
  { return 7; }

  void
  SingularArc::adjointBC_eval(
