...
#ifndef SINGULARARC_DOT_HH
#define SINGULARARC_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef SINGULARARC_API_DLL
    #ifdef SINGULARARC_EXPORT
      #define SINGULARARC_API_DLL __declspec(dllexport)
    #elif defined(SINGULARARC_IMPORT)
      #define SINGULARARC_API_DLL __declspec(dllimport)
    #else
      #define SINGULARARC_API_DLL
    #endif
  #endif
...
namespace SingularArcDefine {
  ...
  class SingularArc : public Mechatronix::Discretized_Indirect_OCP {
    ...
    SingularArc( SingularArc const & );
    SingularArc const & operator = ( SingularArc const & );
  ...
  public:
    ...
    SINGULARARC_API_DLL virtual
    ~SingularArc() MECHATRONIX_OVERRIDE;
...
namespace SingularArcLoad {
  using SingularArcDefine::SingularArc;
