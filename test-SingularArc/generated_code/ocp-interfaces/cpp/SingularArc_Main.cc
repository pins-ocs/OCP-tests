...
main() {
  ...
  try {
    SingularArc * m_model = new SingularArc("SingularArc",&TP,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/SingularArc_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/SingularArc_Data.lua";
    #endif
    ...
    if ( ok ) {
      ...
      file.open( "data/SingularArc_OCP_result_NOT_CONVERGED.ßtxt" );
    }
    file.precision(18);
