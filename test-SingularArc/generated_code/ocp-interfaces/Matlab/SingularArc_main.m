...
%ocp.setup(SingularArc_data);
%ocp.setup('../../data/SingularArc_Data.lua');
ocp.setup('../../data/SingularArc_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%SingularArc_Mex('set_tracked',obj,tracked);
...
%[Z,U] = SingularArc_Mex('get_raw_solution',obj);
%J     = SingularArc_Mex('eval_JF',obj,Z,U);
%f     = SingularArc_Mex('eval_F',obj,Z,U);
