...
namespace SingularArcDefine {
  ...
  void
  SingularArc::continuation_step_0( real_type s ) {
    real_type t2   = 1 - s;
  ...
  integer
  SingularArc::DmayerDxxp_numEqns() const
  { return 7; }

  void
  SingularArc::DmayerDxxp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularArc::DlagrangeDxup_numEqns() const
  { return 5; }

  void
  SingularArc::DlagrangeDxup_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularArc::DJDx_numEqns() const
  { return 3; }

  void
  SingularArc::DJDx_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularArc::DJDp_numEqns() const
  { return 1; }

  void
  SingularArc::DJDp_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  SingularArc::DJDu_numEqns() const
  { return 1; }

  void
  SingularArc::DJDu_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
...
// EOF: SingularArc_Methods_problem.cc
