...
"GoddardRocket_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "GoddardRocket"
#define MODEL_CLASS GoddardRocket
...
public:
  ...
  do_DD_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('DD_D_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->DD_D_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_DD_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('DD_D_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->DD_D_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_DD_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('DD_D_1_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->DD_D_1_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_DD_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('DD_D_1_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->DD_D_1_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_DD_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('DD_D_2_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->DD_D_2_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_gg(
    ...
    #define CMD MODEL_NAME "_Mex('gg', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->gg(arg0) );
    #undef CMD
  }
  ...
  do_gg_D(
    ...
    #define CMD MODEL_NAME "_Mex('gg_D', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->gg_D(arg0) );
    #undef CMD
  }
  void
  do_gg_DD(
    ...
    #define CMD MODEL_NAME "_Mex('gg_DD', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->gg_DD(arg0) );
    #undef CMD
  }
  ...
  do_explog(
    ...
    #define CMD MODEL_NAME "_Mex('explog', obj, ... args ... ): "
    CHECK_IN( 5 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->explog(arg0,arg1,arg2) );
    #undef CMD
  }
  ...
  do_explog_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('explog_D_1', obj, ... args ... ): "
    CHECK_IN( 5 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->explog_D_1(arg0,arg1,arg2) );
    #undef CMD
  }
  ...
  do_explog_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('explog_D_2', obj, ... args ... ): "
    CHECK_IN( 5 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->explog_D_2(arg0,arg1,arg2) );
    #undef CMD
  }
  ...
  do_explog_D_3(
    ...
    #define CMD MODEL_NAME "_Mex('explog_D_3', obj, ... args ... ): "
    CHECK_IN( 5 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->explog_D_3(arg0,arg1,arg2) );
    #undef CMD
  }
  ...
  do_explog_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('explog_D_1_1', obj, ... args ... ): "
    CHECK_IN( 5 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->explog_D_1_1(arg0,arg1,arg2) );
    #undef CMD
  }
  ...
  do_explog_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('explog_D_1_2', obj, ... args ... ): "
    CHECK_IN( 5 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->explog_D_1_2(arg0,arg1,arg2) );
    #undef CMD
  }
  ...
  do_explog_D_1_3(
    ...
    #define CMD MODEL_NAME "_Mex('explog_D_1_3', obj, ... args ... ): "
    CHECK_IN( 5 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->explog_D_1_3(arg0,arg1,arg2) );
    #undef CMD
  }
  ...
  do_explog_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('explog_D_2_2', obj, ... args ... ): "
    CHECK_IN( 5 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->explog_D_2_2(arg0,arg1,arg2) );
    #undef CMD
  }
  ...
  do_explog_D_2_3(
    ...
    #define CMD MODEL_NAME "_Mex('explog_D_2_3', obj, ... args ... ): "
    CHECK_IN( 5 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->explog_D_2_3(arg0,arg1,arg2) );
    #undef CMD
  }
  ...
  do_explog_D_3_3(
    ...
    #define CMD MODEL_NAME "_Mex('explog_D_3_3', obj, ... args ... ): "
    CHECK_IN( 5 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );
    ...
    setScalarValue( arg_out_0, this->explog_D_3_3(arg0,arg1,arg2) );
    #undef CMD
  }
...
do_DD(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_DD( nlhs, plhs, nrhs, prhs );
}
...
do_DD_D_1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('DD_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_DD_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_DD_D_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('DD_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_DD_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_DD_D_1_1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('DD_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_DD_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_DD_D_1_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('DD_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_DD_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_DD_D_2_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('DD_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_DD_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_gg(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('gg',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_gg( nlhs, plhs, nrhs, prhs );
}
...
do_gg_D(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('gg_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_gg_D( nlhs, plhs, nrhs, prhs );
}
...
do_gg_DD(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('gg_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_gg_DD( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"DD_D_1",do_DD_D_1},
  {"DD_D_2",do_DD_D_2},
  {"DD_D_1_1",do_DD_D_1_1},
  {"DD_D_1_2",do_DD_D_1_2},
  {"DD_D_2_2",do_DD_D_2_2},
  {"gg",do_gg},
  {"gg_D",do_gg_D},
  {"gg_DD",do_gg_DD},
  {"explog",do_explog},
  {"explog_D_1",do_explog_D_1},
  {"explog_D_2",do_explog_D_2},
  {"explog_D_3",do_explog_D_3},
  {"explog_D_1_1",do_explog_D_1_1},
  {"explog_D_1_2",do_explog_D_1_2},
  {"explog_D_1_3",do_explog_D_1_3},
  {"explog_D_2_2",do_explog_D_2_2},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "GoddardRocket_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "GoddardRocket_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
