...
public:
  ...
  )
  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "GoddardRocket_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "GoddardRocket_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
  ...
  )
  {
    ...
    try {
      ...
      string msg = fmt::format( "GoddardRocket_Mex('eval_F',...) error: {}", exc.what() );
...
do_DD(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_DD( nlhs, plhs, nrhs, prhs );
}
...
do_DD_D_1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_DD_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_DD_D_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_DD_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_DD_D_1_1(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_DD_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_DD_D_1_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_DD_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_DD_D_2_2(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_DD_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_gg(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_gg( nlhs, plhs, nrhs, prhs );
}
...
do_gg_D(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_gg_D( nlhs, plhs, nrhs, prhs );
}
...
do_gg_DD(
  ...
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_gg_DD( nlhs, plhs, nrhs, prhs );
}
