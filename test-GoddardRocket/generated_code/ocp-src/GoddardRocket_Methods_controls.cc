...
namespace GoddardRocketDefine {
  ...
  GoddardRocket::u_eval_analytic(
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    real_type t3   = XR__[iX_m];
    real_type t6   = XL__[iX_m];
    real_type t9   = ModelPars[iM_c];
    U__[ iU_T ] = TControl.solve(-1.0 / t3 / t9 / t6 * (t9 * (t3 * LL__[iL_lambda2__xo] + t6 * LR__[iL_lambda2__xo]) - (LL__[iL_lambda3__xo] + LR__[iL_lambda3__xo]) * t3 * t6) * P__[iP_TimeSize] / 2, 0, ModelPars[iM_Tmax]);
    if ( m_debug )
  ...
  GoddardRocket::DuDxlxlp_full_analytic(
    ...
    real_type t6   = XL__[iX_m];
    real_type t9   = ModelPars[iM_c];
    real_type t14  = LL__[iL_lambda3__xo] + LR__[iL_lambda3__xo];
    real_type t18  = 1.0 / t6;
    real_type t19  = 1.0 / t9;
    real_type t21  = 1.0 / t3;
    real_type t22  = t21 * t19 * t18;
    real_type t26  = TControl.solve_rhs(-t22 * (t9 * (t6 * t5 + t4) - t14 * t3 * t6) * t1 / 2, 0, ModelPars[iM_Tmax]);
    real_type t27  = t1 * t26;
    real_type t28  = t6 * t6;
    real_type tmp_0_2 = 1.0 / t28 * t2 * t27 / 2;
    real_type tmp_0_3 = 0;
    ...
    real_type tmp_0_7 = 0;
    real_type t35  = t3 * t3;
    real_type tmp_0_8 = 1.0 / t35 * t5 * t27 / 2;
    real_type tmp_0_9 = 0;
    real_type tmp_0_10 = -t21 * t27 / 2;
    real_type tmp_0_11 = tmp_0_5;
    real_type tmp_0_12 = -t22 * (t6 * (-t3 * t14 + t5 * t9) + t9 * t4) * t26 / 2;
