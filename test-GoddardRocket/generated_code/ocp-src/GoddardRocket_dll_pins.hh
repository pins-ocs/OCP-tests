/*-----------------------------------------------------------------------*\
 |  file: GoddardRocket_dll_pins.hh                                      |
 |                                                                       |
...
namespace GoddardRocketDefine {
  ...
  class GoddardRocket_Problem {
    ...
    GoddardRocket_Problem( GoddardRocket_Problem const & );
    GoddardRocket_Problem const & operator = ( GoddardRocket_Problem const & );
  ...
  public:
    ...
    GoddardRocket_Problem( integer n_threads, Console const * console )
    : model("GoddardRocket",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "GoddardRocket::solver, fatal: unknown error";
      }
      return ok;
    }
