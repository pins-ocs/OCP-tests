...
namespace GoddardRocketDefine {
  ...
  integer GoddardRocket::bc_numEqns() const { return 4; }

  void
  GoddardRocket::bc_eval(
    NodeQX const & LEFT__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer GoddardRocket::DbcDxxp_numRows() const { return 4; }
  integer GoddardRocket::DbcDxxp_numCols() const { return 7; }
  integer GoddardRocket::DbcDxxp_nnz()     const { return 4; }

  void
  GoddardRocket::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer GoddardRocket::D2bcD2xxp_numRows() const { return 7; }
  integer GoddardRocket::D2bcD2xxp_numCols() const { return 7; }
  integer GoddardRocket::D2bcD2xxp_nnz()     const { return 0; }

  void
  GoddardRocket::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  GoddardRocket::D2bcD2xxp_sparse(
    NodeQX const &          LEFT__,
    NodeQX const &          RIGHT__,
    P_const_p_type          P__,
  ...
  integer GoddardRocket::fd_BC_numEqns() const { return 6; }

  void
  GoddardRocket::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer GoddardRocket::Dfd_BCDxlxlp_numRows() const { return 7; }
  integer GoddardRocket::Dfd_BCDxlxlp_numCols() const { return 13; }
  integer GoddardRocket::Dfd_BCDxlxlp_nnz()     const { return 6; }

  void
  GoddardRocket::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  GoddardRocket::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
