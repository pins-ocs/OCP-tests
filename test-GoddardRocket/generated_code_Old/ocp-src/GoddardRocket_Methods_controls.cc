...
namespace GoddardRocketDefine {
  ...
  GoddardRocket::DgDxlp_sparse(
    ...
    result__[ 2   ] = -t10 * t2;
    result__[ 3   ] = t1 * t8 - t10 * L__[iL_lambda3__xo];
    if ( m_debug )
  ...
  GoddardRocket::u_eval_analytic(
    ...
    real_type t5   = XL__[iX_m];
    real_type t8   = ModelPars[iM_c];
    U__[ iU_T ] = TControl.solve(-1.0 / t2 / t8 / t5 * P__[iP_TimeSize] * (t8 * (t2 * LL__[iL_lambda2__xo] + t5 * LR__[iL_lambda2__xo]) - (LL__[iL_lambda3__xo] + LR__[iL_lambda3__xo]) * t2 * t5) / 2, 0, ModelPars[iM_Tmax]);
    if ( m_debug )
  ...
  GoddardRocket::DuDxlxlp_full_analytic(
    ...
    real_type t5   = XL__[iX_m];
    real_type t8   = ModelPars[iM_c];
    real_type t13  = LL__[iL_lambda3__xo] + LR__[iL_lambda3__xo];
    real_type t16  = P__[iP_TimeSize];
    real_type t18  = 1.0 / t5;
    real_type t19  = 1.0 / t8;
    real_type t21  = 1.0 / t2;
    real_type t22  = t21 * t19 * t18;
    real_type t26  = TControl.solve_rhs(-t22 * t16 * (t8 * (t5 * t4 + t3) - t13 * t2 * t5) / 2, 0, ModelPars[iM_Tmax]);
    real_type t27  = t16 * t26;
    real_type t28  = t5 * t5;
    real_type tmp_0_2 = 1.0 / t28 * t1 * t27 / 2;
    real_type tmp_0_3 = 0;
    real_type tmp_0_4 = -t18 * t27 / 2;
    real_type tmp_0_5 = t19 * t27 / 2;
    real_type tmp_0_6 = 0;
    real_type tmp_0_7 = 0;
    real_type t35  = t2 * t2;
    real_type tmp_0_8 = 1.0 / t35 * t4 * t27 / 2;
    real_type tmp_0_9 = 0;
    real_type tmp_0_10 = -t21 * t27 / 2;
    real_type tmp_0_11 = tmp_0_5;
    real_type tmp_0_12 = -t22 * (t5 * (-t2 * t13 + t4 * t8) + t8 * t3) * t26 / 2;
