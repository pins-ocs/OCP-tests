...
namespace MultipleDubinsDefine {
  ...
  MultipleDubins::Hx_eval(
    ...
    real_type t5   = sin(t4);
    real_type t9   = cos(t4);
    result__[ 2   ] = -t5 * t2 * L__[0] + t9 * t2 * L__[1];
    result__[ 3   ] = 0;
    result__[ 4   ] = 0;
    real_type t12  = P__[1];
    real_type t14  = X__[5];
    ...
    result__[ 5   ] = -t15 * t12 * L__[3] + t19 * t12 * L__[4];
    result__[ 6   ] = 0;
    result__[ 7   ] = 0;
    real_type t22  = P__[2];
    real_type t24  = X__[8];
    ...
    result__[ 8   ] = -t25 * t22 * L__[6] + t29 * t22 * L__[7];
    if ( m_debug )
  ...
  MultipleDubins::DHxDx_sparse(
    ...
    real_type t5   = cos(t4);
    real_type t9   = sin(t4);
    result__[ 0   ] = -t5 * t2 * L__[0] - t9 * t2 * L__[1];
    real_type t12  = P__[1];
    real_type t14  = X__[5];
    real_type t15  = cos(t14);
    real_type t19  = sin(t14);
    result__[ 1   ] = -t15 * t12 * L__[3] - t19 * t12 * L__[4];
    real_type t22  = P__[2];
    real_type t24  = X__[8];
    real_type t25  = cos(t24);
    real_type t29  = sin(t24);
    result__[ 2   ] = -t25 * t22 * L__[6] - t29 * t22 * L__[7];
    if ( m_debug )
  ...
  MultipleDubins::DHxDp_sparse(
    ...
    real_type t3   = sin(t2);
    real_type t6   = cos(t2);
    result__[ 0   ] = -t3 * L__[0] + t6 * L__[1];
    real_type t9   = X__[5];
    real_type t10  = sin(t9);
    real_type t13  = cos(t9);
    result__[ 1   ] = -t10 * L__[3] + t13 * L__[4];
    real_type t16  = X__[8];
    real_type t17  = sin(t16);
    real_type t20  = cos(t16);
    result__[ 2   ] = -t17 * L__[6] + t20 * L__[7];
    if ( m_debug )
  ...
  MultipleDubins::Hp_eval(
    ...
    real_type t12  = L__[2];
    real_type t13  = P__[3];
    result__[ 0   ] = 2 * t2 * t1 + t10 * L__[1] + t13 * t12 + t7 * L__[0] + 1;
    real_type t15  = P__[1];
    real_type t19  = X__[5];
    ...
    real_type t25  = L__[5];
    real_type t26  = P__[4];
    result__[ 1   ] = 2 * t15 * t1 + t20 * L__[3] + t23 * L__[4] + t26 * t25 + 1;
    real_type t28  = P__[2];
    real_type t32  = X__[8];
    ...
    real_type t38  = L__[8];
    real_type t39  = P__[5];
    result__[ 2   ] = 2 * t28 * t1 + t33 * L__[6] + t36 * L__[7] + t39 * t38 + 1;
    real_type t42  = ModelPars[6];
