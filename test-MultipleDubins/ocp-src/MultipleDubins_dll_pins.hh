...
namespace MultipleDubinsDefine {
  ...
  class MultipleDubins_Problem {

    MultipleDubins model;
    ...
    MultipleDubins_Problem( MultipleDubins_Problem const & );
    MultipleDubins_Problem const & operator = ( MultipleDubins_Problem const & );
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "MultipleDubins::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: MultipleDubins_dll_pins.hh
