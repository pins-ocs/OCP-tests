/*-----------------------------------------------------------------------*\
 |  file: MultipleDubins_dll_ruby.hh                                     |
 |                                                                       |
...
namespace MultipleDubinsDefine {
  ...
  public:
    ...
    MultipleDubins_Problem( ThreadPool * pTP, Console * pConsole )
  ...
  */
  ...
  MULTIPLEDUBINS_API_DLL
  bool
  MultipleDubins_ocp_guess( char const id[], GenericContainer & gc_guess );
...
// EOF: MultipleDubins_dll_ruby.hh
