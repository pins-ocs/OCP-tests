...
% create object
ocp = MultipleDubins( 'MultipleDubins' );
...
%ocp.setup(MultipleDubins_data);
%ocp.setup('../../data/MultipleDubins_Data.lua');
ocp.setup('../../data/MultipleDubins_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%MultipleDubins_Mex('set_tracked',obj,tracked);
...
%[Z,U] = MultipleDubins_Mex('get_raw_solution',obj);
%J     = MultipleDubins_Mex('eval_JF',obj,Z,U);
%f     = MultipleDubins_Mex('eval_F',obj,Z,U);
