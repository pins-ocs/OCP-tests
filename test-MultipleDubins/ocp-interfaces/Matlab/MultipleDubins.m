...
classdef MultipleDubins < handle
  ...
  methods
    % ---------------------------------------------------------------------
    function self = MultipleDubins( name )
      %% Allocate the C++ class instance
      self.objectHandle = MultipleDubins_Mex( 'new', name );
    end
    % ---------------------------------------------------------------------
    function delete( self )
      %% Destroy the C++ class instance
      MultipleDubins_Mex( 'delete', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function help( self )
      %% print help for the class usage
      MultipleDubins_Mex('help');
    end
    ...
    function data = read( self, fname )
      ...
      %
      data = MultipleDubins_Mex( 'read', self.objectHandle, fname );
    end
    % ---------------------------------------------------------------------
    function setup( self, fname_or_struct )
      ...
      %
      MultipleDubins_Mex( 'setup', self.objectHandle, fname_or_struct );
    end
    % ---------------------------------------------------------------------
    function n = names( self )
      ...
      %
      n = MultipleDubins_Mex( 'names', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = dims( self )
      ...
      %
      res = MultipleDubins_Mex( 'dims', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function res = get_ocp_data( self )
      ...
      % res.Pointers
      %
      res = MultipleDubins_Mex( 'get_ocp_data', self.objectHandle );
    end
    ...
    function infoLevel( self, infoLvl )
      ...
      %
      MultipleDubins_Mex( 'infoLevel', self.objectHandle, infoLvl );
    end
    ...
    function set_max_threads( self, nt )
      ...
      %
      MultipleDubins_Mex( 'set_max_threads', self.objectHandle, nt );
    end
    ...
    function remesh( self, new_mesh )
      ...
      %
      MultipleDubins_Mex( 'remesh', self.objectHandle, new_mesh );
    end
    ...
    function set_guess( self, varargin )
      ...
      %
      MultipleDubins_Mex( 'set_guess', self.objectHandle, varargin{:} );
    end
    function guess = get_guess( self )
      %
      % Return a structure with the stored guess.
      %
      guess = MultipleDubins_Mex( 'get_guess', self.objectHandle );
    end
    function guess = get_solution_as_guess( self )
      %
      % Return a structure with the solution formatted as a guess.
      %
      guess = MultipleDubins_Mex( 'get_solution_as_guess', self.objectHandle );
    end
    ...
    function ok = solve( self, varargin )
      ...
      %
      ok = MultipleDubins_Mex( 'solve', self.objectHandle, varargin{:} );
    end
    % ---------------------------------------------------------------------
    ...
    function sol = solution( self, varargin )
      ...
      %
      %
      sol = MultipleDubins_Mex( 'get_solution', self.objectHandle, varargin{:} );
    end
    % ---------------------------------------------------------------------
    function sol = solution_by_group( self )
      ...
      sol = MultipleDubins_Mex( 'get_solution2', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function sol = solution_by_group_and_names( self )
      ...
      % res.data.control_penalties
      %
      sol = MultipleDubins_Mex( 'get_solution3', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function sol = pack( self, X, Lambda, Pars, Omega )
      ...
      %
      sol = MultipleDubins_Mex( 'pack', self.objectHandle, X, Lambda, Pars, Omega );
    end
    % ---------------------------------------------------------------------
    function [X, Lambda, Pars, Omega ] = unpack( self, sol )
      ...
      %
      [X, Lambda, Pars, Omega] = MultipleDubins_Mex( 'unpack', self.objectHandle, sol );
    end
    ...
    function res = zeta( self )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'zeta' );
    end
    ...
    function res = x1( self )
      ...
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'x1' );
    end
    function res = y1( self )
      %
      % Return the solution for the state: y1
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'y1' );
    end
    function res = theta1( self )
      %
      % Return the solution for the state: theta1
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'theta1' );
    end
    function res = x2( self )
      %
      % Return the solution for the state: x2
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'x2' );
    end
    function res = y2( self )
      %
      % Return the solution for the state: y2
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'y2' );
    end
    function res = theta2( self )
      %
      % Return the solution for the state: theta2
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'theta2' );
    end
    function res = x3( self )
      %
      % Return the solution for the state: x3
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'x3' );
    end
    function res = y3( self )
      %
      % Return the solution for the state: y3
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'y3' );
    end
    function res = theta3( self )
      %
      % Return the solution for the state: theta3
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'theta3' );
    end
    ...
    function res = lambda1( self )
      ...
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda1__xo' );
    end
    function res = lambda2( self )
      %
      % Return the solution for the multiplier: lambda2
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda2__xo' );
    end
    function res = lambda3( self )
      %
      % Return the solution for the multiplier: lambda3
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda3__xo' );
    end
    function res = lambda4( self )
      %
      % Return the solution for the multiplier: lambda4
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda4__xo' );
    end
    function res = lambda5( self )
      %
      % Return the solution for the multiplier: lambda5
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda5__xo' );
    end
    function res = lambda6( self )
      %
      % Return the solution for the multiplier: lambda6
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda6__xo' );
    end
    function res = lambda7( self )
      %
      % Return the solution for the multiplier: lambda7
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda7__xo' );
    end
    function res = lambda8( self )
      %
      % Return the solution for the multiplier: lambda8
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda8__xo' );
    end
    function res = lambda9( self )
      %
      % Return the solution for the multiplier: lambda9
      %
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda9__xo' );
    end
    ...
    function U = init_U( self, x, do_minimization )
      ...
      % Initialize `u`
      %
      U = MultipleDubins_Mex( 'init_U', self.objectHandle, x, do_minimization );
    end
    % ---------------------------------------------------------------------
    function U = eval_U( self, x, u_guess )
      ...
      % Compute `u`
      %
      U = MultipleDubins_Mex( 'eval_U', self.objectHandle, x, u_guess );
    end
    % ---------------------------------------------------------------------
    function F = eval_F( self, x, u )
      ...
      %
      F = MultipleDubins_Mex( 'eval_F', self.objectHandle, x, u );
    end
    % ---------------------------------------------------------------------
    function JF = eval_JF( self, x, u )
      ...
      %
      JF = MultipleDubins_Mex( 'eval_JF', self.objectHandle, x, u );
    end
    % ---------------------------------------------------------------------
    function JF = eval_JF_pattern( self )
      ...
      %
      JF = MultipleDubins_Mex( 'eval_JF_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function [z,u] = get_raw_solution( self )
      ...
      %
      [z,u] = MultipleDubins_Mex( 'get_raw_solution', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function set_raw_solution( self, z, u )
      ...
      %
      MultipleDubins_Mex( 'set_raw_solution', self.objectHandle, z, u );
    end
    % ---------------------------------------------------------------------
    function ok = check_raw_solution( self, z )
      ...
      % admissible regions.
      %
      ok = MultipleDubins_Mex( 'check_raw_solution', self.objectHandle, z );
    end
    % ---------------------------------------------------------------------
    function check_jacobian( self, z, u, epsi )
      ...
      %
      MultipleDubins_Mex( 'check_jacobian', self.objectHandle, z, u, epsi );
    end
    % ---------------------------------------------------------------------
    % ---------------------------------------------------------------------
    ...
    function [a,c] = eval_ac( self, iseg_L, q_L, x_L, lambda_L, ...
      ...
      % <<FD1.jpg>>
      %
      [a,c] = MultipleDubins_Mex( 'ac', self.objectHandle, ...
    ...
    function [Ja,Jc] = eval_DacDxlxlp( self, iseg_L, q_L, x_L, lambda_L, ...
      ...
      % <<FD2.jpg>>
      %
      [Ja,Jc] = MultipleDubins_Mex( 'DacDxlxlp', self.objectHandle, ...
        iseg_L, q_L, x_L, lambda_L, iseg_R, q_R, x_R, lambda_R, pars, U ...
      );
    end
    % ---------------------------------------------------------------------
    function [h,c] = eval_hc( self, iseg_L, q_L, x_L, lambda_L, ...
      ...
      % <<FD3.jpg>>
      %
      [h,c] = MultipleDubins_Mex( 'hc', self.objectHandle, ...
    ...
    function [Jh,Jc] = eval_DhcDxlxlop( self, iseg_L, q_L, x_L, lambda_L, ...
      ...
      % <<FD4.jpg>>
      %
      [Jh,Jc] = MultipleDubins_Mex( 'DhcDxlxlop', self.objectHandle, ...
        iseg_L,  q_L, x_L, lambda_L, iseg_R, q_R, x_R, lambda_R, pars ...
      );
    end
    % ---------------------------------------------------------------------
    ...
    function u = eval_u( self, iseg_L, q_L, x_L, lambda_L, ...
      ...
      %
      u = MultipleDubins_Mex( 'u', self.objectHandle, ...
        iseg_L, q_L, x_L, lambda_L, iseg_R, q_R, x_R, lambda_R, pars ...
      );
    end
    % ---------------------------------------------------------------------
    function DuDxlxlp = eval_DuDxlxlp( self, iseg_L, q_L, x_L, lambda_L, ...
      ...
      %
      DuDxlxlp = MultipleDubins_Mex( 'DuDxlxlp', self.objectHandle, ...
        iseg_L, q_L, x_L, lambda_L, iseg_R, q_R, x_R, lambda_R, pars ...
      );
    end
    % ---------------------------------------------------------------------
    function rhs = eval_rhs_ode( self, iseg, q, x, u, pars )
      ...
      %
      rhs = MultipleDubins_Mex( 'rhs_ode', self.objectHandle, ...
        iseg, q, x, u, pars ...
      );
    end
    % ---------------------------------------------------------------------
    ...
    function A = eval_A( self, iseg, q, x, pars )
      ...
      % respect to `pars`.
      %
      A = MultipleDubins_Mex( 'A', self.objectHandle, iseg, q, x, pars );
    end
    % ---------------------------------------------------------------------
    ...
    function nu = eval_nu( self, iseg, q, x, V, pars )
      ...
      %
      nu = MultipleDubins_Mex( 'nu', self.objectHandle, iseg, q, x, V, pars );
    end
    % ---------------------------------------------------------------------
    function J = eval_DnuDx( self, iseg, q, x, V, pars )
      ...
      % respect to `x`.
      %
      J = MultipleDubins_Mex( 'DnuDx', self.objectHandle, iseg, q, x, V, pars );
    end
    % ---------------------------------------------------------------------
    function J = eval_DnuDp( self, iseg, q, x, V, pars )
      ...
      % respect to `x`.
      %
      J = MultipleDubins_Mex( 'DnuDp', self.objectHandle, iseg, q, x, V, pars );
    end
    % ---------------------------------------------------------------------
    ...
    function target = eval_q( self, i_segment, s )
      target = MultipleDubins_Mex( 'q', self.objectHandle, i_segment, s );
    end
    % ---------------------------------------------------------------------
    function nodes = get_nodes( self )
      nodes = MultipleDubins_Mex( 'nodes', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    function node_to_segment = get_node_to_segment( self )
      node_to_segment = MultipleDubins_Mex( 'node_to_segment', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    % PLOT SOLUTION
    % ---------------------------------------------------------------------
    function plot_states( self )
      plot(...
        ...
        self.zeta(), self.x2(), ...
        self.zeta(), self.y2(), ...
        self.zeta(), self.theta2(), ...
        self.zeta(), self.x3(), ...
        self.zeta(), self.y3(), ...
        self.zeta(), self.theta3(), ...
        'Linewidth', 2 ...
      );
      title('states');
      legend( 'x1', 'y1', 'th\eta1', 'x2', 'y2', 'th\eta2', 'x3', 'y3', 'th\eta3' );
    end
    % ---------------------------------------------------------------------
    function plot_multipliers( self )
      ...
      title('multipliers');
      legend( '\lambda1', '\lambda2', '\lambda3', '\lambda4', '\lambda5', '\lambda6', '\lambda7', '\lambda8', '\lambda9' );
    end
    % ---------------------------------------------------------------------
