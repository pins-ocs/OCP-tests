...
classdef MultipleDubins < handle
  ...
  methods
    ...
    function updateContinuation( self, n, s )
      ...
      MultipleDubins_Mex( 'updateContinuation', self.objectHandle, n, s );
    end
    ...
    function u = eval_u( self, varargin )
      ...
      u = MultipleDubins_Mex( 'u', self.objectHandle, varargin{:} );
    end
    % -------------------------------------------------------------------------
