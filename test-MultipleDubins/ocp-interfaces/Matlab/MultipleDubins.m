...
classdef MultipleDubins < handle
  ...
  methods
    ...
    function res = x1( self, varargin  )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'x1', varargin{:} );
    end
    function res = y1( self, varargin  )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'y1', varargin{:} );
    end
    function res = theta1( self, varargin  )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'theta1', varargin{:} );
    end
    function res = x2( self, varargin  )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'x2', varargin{:} );
    end
    function res = y2( self, varargin  )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'y2', varargin{:} );
    end
    function res = theta2( self, varargin  )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'theta2', varargin{:} );
    end
    function res = x3( self, varargin  )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'x3', varargin{:} );
    end
    function res = y3( self, varargin  )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'y3', varargin{:} );
    end
    function res = theta3( self, varargin  )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'theta3', varargin{:} );
    end
    ...
    function res = lambda1( self, varargin )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda1__xo', varargin{:} );
    end
    function res = lambda2( self, varargin )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda2__xo', varargin{:} );
    end
    function res = lambda3( self, varargin )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda3__xo', varargin{:} );
    end
    function res = lambda4( self, varargin )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda4__xo', varargin{:} );
    end
    function res = lambda5( self, varargin )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda5__xo', varargin{:} );
    end
    function res = lambda6( self, varargin )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda6__xo', varargin{:} );
    end
    function res = lambda7( self, varargin )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda7__xo', varargin{:} );
    end
    function res = lambda8( self, varargin )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda8__xo', varargin{:} );
    end
    function res = lambda9( self, varargin )
      res = MultipleDubins_Mex( 'get_solution', self.objectHandle, 'lambda9__xo', varargin{:} );
    end
    ...
    function [a,c] = get_ac( self, iseg_L, q_L, x_L, lambda_L, ...
      ...
      [a,c] = MultipleDubins_Mex( 'a', self.objectHandle, ...
