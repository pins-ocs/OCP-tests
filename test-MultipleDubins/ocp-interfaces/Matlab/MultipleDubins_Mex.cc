...
#define MODEL_NAME  "MultipleDubins"
#define MODEL_CLASS MultipleDubins
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "MultipleDubins_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "MultipleDubins_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
