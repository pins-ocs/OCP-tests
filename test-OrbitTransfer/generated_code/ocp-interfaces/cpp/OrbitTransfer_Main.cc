...
main() {
  ...
  try {
    OrbitTransfer * m_model = new OrbitTransfer("OrbitTransfer",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/OrbitTransfer_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/OrbitTransfer_Data.lua";
    #endif
