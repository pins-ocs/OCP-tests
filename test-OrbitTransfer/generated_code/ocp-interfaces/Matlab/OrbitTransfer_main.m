...
% create object
ocp = OrbitTransfer( 'OrbitTransfer' );
...
%ocp.setup(OrbitTransfer_data);
%ocp.setup('../../data/OrbitTransfer_Data.lua');
ocp.setup('../../data/OrbitTransfer_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%OrbitTransfer_Mex('set_tracked',obj,tracked);
...
%[Z,U] = OrbitTransfer_Mex('get_raw_solution',obj);
%J     = OrbitTransfer_Mex('eval_JF',obj,Z,U);
%f     = OrbitTransfer_Mex('eval_F',obj,Z,U);
