...
namespace OrbitTransferDefine {
  ...
  */
  void
  OrbitTransfer::update_continuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
  ...
  */
  void
  OrbitTransfer::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "OrbitTransfer::setup_parameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  OrbitTransfer::setup_parameters( real_type const Pars[] ) {
  ...
  */
  void
  OrbitTransfer::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  OrbitTransfer::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  OrbitTransfer::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  OrbitTransfer::setup_controls( GenericContainer const & gc_data ) {
  ...
  */
  void
  OrbitTransfer::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "OrbitTransfer::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in OrbitTransfer::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  OrbitTransfer::info_classes() const {
    int msg_level = 3;
    ostringstream mstr;
