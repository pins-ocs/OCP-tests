...
namespace OrbitTransferDefine {
  ...
  integer OrbitTransfer::DlagrangeDxpu_numEqns() const { return 6; }

  void
  OrbitTransfer::DlagrangeDxpu_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer OrbitTransfer::D2lagrangeD2xpu_numRows() const { return 6; }
  integer OrbitTransfer::D2lagrangeD2xpu_numCols() const { return 6; }
  integer OrbitTransfer::D2lagrangeD2xpu_nnz()     const { return 0; }

  void
  OrbitTransfer::D2lagrangeD2xpu_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  OrbitTransfer::D2lagrangeD2xpu_sparse(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
