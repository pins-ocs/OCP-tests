...
namespace OrbitTransferDefine {
  ...
  OrbitTransfer::xlambda_guess_eval(
    ...
    X__[ iX_m     ] = ModelPars[1];
    real_type t2   = ModelPars[6];
    real_type t4   = ModelPars[4];
    X__[ iX_alpha ] = Q__[0] / t4 * t2 * ModelPars[5];
    X__[ iX_r     ] = t4;
    X__[ iX_u     ] = 0;
    X__[ iX_v     ] = t2;
  ...
  integer
  OrbitTransfer::u_guess_numEqns() const
  { return 1; }
  ...
  OrbitTransfer::u_guess_eval(
    ...
    UGUESS__[ iU_theta ] = atan2(-L__[1], -L__[2]);
    if ( m_debug )
