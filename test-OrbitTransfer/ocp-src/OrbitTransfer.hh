...
#ifndef ORBITTRANSFER_DOT_HH
#define ORBITTRANSFER_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
    ...
    #ifdef ORBITTRANSFER_EXPORT
      #define ORBITTRANSFER_API_DLL __declspec(dllexport)
    #elif defined(ORBITTRANSFER_IMPORT)
      #define ORBITTRANSFER_API_DLL __declspec(dllimport)
    #else
      #define ORBITTRANSFER_API_DLL
    #endif
  #endif
...
namespace OrbitTransferDefine {
  ...
  class OrbitTransfer : public Mechatronix::Discretized_Indirect_OCP {
    ...
    OrbitTransfer( OrbitTransfer const & );
    OrbitTransfer const & operator = ( OrbitTransfer const & );
  ...
  public:
    ...
    ~OrbitTransfer() MECHATRONIX_OVERRIDE;
...
namespace OrbitTransferLoad {
  using OrbitTransferDefine::OrbitTransfer;

}

#endif

// EOF: OrbitTransfer.hh
