/*-----------------------------------------------------------------------*\
 |  file: OrbitTransfer_dll_pins.hh                                      |
 |                                                                       |
...
namespace OrbitTransferDefine {
  ...
  using namespace OrbitTransferLoad;
  ...
  class OrbitTransfer_Problem {
    ...
    OrbitTransfer_Problem( OrbitTransfer_Problem const & );
    OrbitTransfer_Problem const & operator = ( OrbitTransfer_Problem const & );
  ...
  public:
    ...
    OrbitTransfer_Problem( ThreadPool * pTP, Console const * pConsole )
    : model("OrbitTransfer",pTP,pConsole)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "OrbitTransfer::solver, fatal: unknown error";
      }
      return ok;
    }
