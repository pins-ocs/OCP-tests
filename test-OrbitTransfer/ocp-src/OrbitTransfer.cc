...
namespace OrbitTransferDefine {
  ...
  */
  void
  OrbitTransfer::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  OrbitTransfer::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "OrbitTransfer::setupParameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in OrbitTransfer::setup not all parameters are set!\n"
    );
  }

  void
  OrbitTransfer::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  OrbitTransfer::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  OrbitTransfer::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  OrbitTransfer::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  OrbitTransfer::setupControls( GenericContainer const & gc_data ) {
  ...
  */
  void
  OrbitTransfer::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "OrbitTransfer::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in OrbitTransfer::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  OrbitTransfer::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  OrbitTransfer::setup( GenericContainer const & gc ) {

    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("OrbitTransfer::setup, Debug");
  ...
  */
  void
  OrbitTransfer::get_names( GenericContainer & out ) const {
  ...
  */
  void
  OrbitTransfer::diagnostic( GenericContainer const & gc ) {
  ...
  void
  OrbitTransfer::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
