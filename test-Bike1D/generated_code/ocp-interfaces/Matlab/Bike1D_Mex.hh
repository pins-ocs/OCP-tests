...
public:
  ...
  void do_Tmax_normalized( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_Tmax_normalized_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_Tmax_normalized_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
