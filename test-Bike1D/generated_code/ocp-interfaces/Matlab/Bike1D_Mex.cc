...
public:
  ...
  do_eval_F(
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "Bike1D_Mex('eval_F',...) error: {}", exc.what() ).c_str() );
      ok = false;
    } catch ( ... ) {
...
do_Tmax_normalized(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Tmax_normalized( nlhs, plhs, nrhs, prhs );
}
...
do_Tmax_normalized_D(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Tmax_normalized_D( nlhs, plhs, nrhs, prhs );
}
...
do_Tmax_normalized_DD(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_Tmax_normalized_DD( nlhs, plhs, nrhs, prhs );
}
