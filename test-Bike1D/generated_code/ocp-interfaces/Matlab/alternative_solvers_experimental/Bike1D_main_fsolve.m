...
ocp.setup( [DATA_PATH 'Bike1D_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = Bike1D_Mex('get_raw_solution',obj);
%J        = Bike1D_Mex('eval_JF',obj,Z,MU,U);
%f        = Bike1D_Mex('eval_F',obj,Z,MU,U);
