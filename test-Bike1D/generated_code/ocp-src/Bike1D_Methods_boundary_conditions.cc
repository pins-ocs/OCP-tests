...
namespace Bike1DDefine {
  ...
  integer Bike1D::bc_numEqns() const { return 2; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Bike1D::DbcDxxp_numRows() const { return 2; }
  integer Bike1D::DbcDxxp_numCols() const { return 2; }
  integer Bike1D::DbcDxxp_nnz()     const { return 2; }

  void
  Bike1D::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Bike1D::D2bcD2xxp_numRows() const { return 2; }
  integer Bike1D::D2bcD2xxp_numCols() const { return 2; }
  integer Bike1D::D2bcD2xxp_nnz()     const { return 0; }

  void
  Bike1D::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
