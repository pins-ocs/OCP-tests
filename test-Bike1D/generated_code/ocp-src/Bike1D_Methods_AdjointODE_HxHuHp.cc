...
namespace Bike1DDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Bike1D::DHxpDxpu_numRows() const { return 1; }
  integer Bike1D::DHxpDxpu_numCols() const { return 3; }
  integer Bike1D::DHxpDxpu_nnz()     const { return 1; }

  void
  Bike1D::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
  }


  void
  Bike1D::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
