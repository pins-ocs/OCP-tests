...
public:
  ...
  do_Tmax_normalized(
    ...
    #define CMD MODEL_NAME "_Mex('Tmax_normalized', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->Tmax_normalized(arg0) );
    #undef CMD
  }
  ...
  do_Tmax_normalized_D(
    ...
    #define CMD MODEL_NAME "_Mex('Tmax_normalized_D', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->Tmax_normalized_D(arg0) );
    #undef CMD
  }
  void
  do_Tmax_normalized_DD(
    ...
    #define CMD MODEL_NAME "_Mex('Tmax_normalized_DD', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->Tmax_normalized_DD(arg0) );
    #undef CMD
  }
