%-----------------------------------------------------------------------%
%  file: LUUS_Singular03_fsolve_main.m                                  %
%                                                                       %
...
ocp.setup( [DATA_PATH 'LUUS_Singular03_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = LUUS_Singular03_Mex('get_raw_solution',obj);
%J        = LUUS_Singular03_Mex('eval_JF',obj,Z,MU,U);
%f        = LUUS_Singular03_Mex('eval_F',obj,Z,MU,U);
