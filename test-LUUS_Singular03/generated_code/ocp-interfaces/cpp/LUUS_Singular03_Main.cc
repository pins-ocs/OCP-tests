...
main() {
  ...
  try {
    LUUS_Singular03 * m_model = new LUUS_Singular03("LUUS_Singular03",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/LUUS_Singular03_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/LUUS_Singular03_Data.lua";
    #endif
