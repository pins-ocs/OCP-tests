...
namespace LUUS_Singular03Define {
  ...
  void
  LUUS_Singular03::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  LUUS_Singular03::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  LUUS_Singular03::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  LUUS_Singular03::xlambda_check_node(
    integer              ipos,
  ...
  bool
  LUUS_Singular03::xlambda_check_cell(
    integer              icell,
  ...
  integer LUUS_Singular03::u_guess_numEqns() const { return 1; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  LUUS_Singular03::u_guess_eval(
    NodeType2 const    & LEFT__,
    NodeType2 const    & RIGHT__,
    P_const_pointer_type P__,
    ...
    UGUESS__[ iU_u ] = uControl.solve(-2 / (t3 + t5 + t7 + t9 + 2 * t11) * L__[iL_lambda2__xo], -1, 1);
    if ( m_debug )
  ...
  bool
  LUUS_Singular03::u_check_if_admissible(
    NodeType2 const    & NODE__,
