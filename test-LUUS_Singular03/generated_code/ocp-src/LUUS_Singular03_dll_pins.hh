/*-----------------------------------------------------------------------*\
 |  file: LUUS_Singular03_dll_pins.hh                                    |
 |                                                                       |
...
namespace LUUS_Singular03Define {
  ...
  using namespace LUUS_Singular03Load;
  ...
  class LUUS_Singular03_Problem {

    LUUS_Singular03 model;
    ...
    LUUS_Singular03_Problem( LUUS_Singular03_Problem const & );
    LUUS_Singular03_Problem const & operator = ( LUUS_Singular03_Problem const & );
  ...
  public:
    ...
    LUUS_Singular03_Problem( integer n_threads, Console const * console )
    : model("LUUS_Singular03",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "LUUS_Singular03::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: LUUS_Singular03_dll_pins.hh
