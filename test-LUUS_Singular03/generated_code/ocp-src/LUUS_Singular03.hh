...
#ifndef LUUS_SINGULAR03_DOT_HH
#define LUUS_SINGULAR03_DOT_HH
...
// User Header (end)
  ...
  #ifndef LUUS_SINGULAR03_API_DLL
    #ifdef LUUS_SINGULAR03_EXPORT
      #define LUUS_SINGULAR03_API_DLL __declspec(dllexport)
    #elif defined(LUUS_SINGULAR03_IMPORT)
      #define LUUS_SINGULAR03_API_DLL __declspec(dllimport)
    #else
      #define LUUS_SINGULAR03_API_DLL
    #endif
  #endif
...
namespace LUUS_Singular03Define {
  ...
  class LUUS_Singular03 : public Mechatronix::Discretized_Indirect_OCP {
    ...
    LUUS_Singular03( LUUS_Singular03 const & );
    LUUS_Singular03 const & operator = ( LUUS_Singular03 const & );
...
namespace LUUS_Singular03Load {
  using LUUS_Singular03Define::LUUS_Singular03;

}

#endif

// EOF: LUUS_Singular03.hh
