...
namespace CatalystDefine {
  ...
  Catalyst::H_eval(
    ...
    real_type result__ = t2 + t1 * (t7 * (t3 - 9 * t4) - t3 * t9 + 10 * t4 * t9) - t4 * t7;
    return result__;
  }
#else
  real_type
  ...
  integer
  Catalyst::DmayerDx_numEqns() const
  { return 4; }

  void
  Catalyst::DmayerDx_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  Catalyst::DmayerDp_numEqns() const
  { return 0; }

  void
  Catalyst::DmayerDp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
...
// EOF: Catalyst_Methods_problem.cc
