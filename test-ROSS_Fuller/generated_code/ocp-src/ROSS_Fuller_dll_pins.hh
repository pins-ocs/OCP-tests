...
namespace ROSS_FullerDefine {
  ...
  using namespace ROSS_FullerLoad;
  ...
  class ROSS_Fuller_Problem {
    ...
    ROSS_Fuller_Problem( ROSS_Fuller_Problem const & );
    ROSS_Fuller_Problem const & operator = ( ROSS_Fuller_Problem const & );
  ...
  public:
    ...
    : m_model("ROSS_Fuller",console,TP)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "ROSS_Fuller::solver, fatal: unknown error";
      }
      return ok;
    }
