/*-----------------------------------------------------------------------*\
 |  file: ROSS_Fuller_Methods_Guess.cc                                   |
 |                                                                       |
...
namespace ROSS_FullerDefine {
  ...
  integer ROSS_Fuller::eta_numEqns() const { return 2; }

  void
  ROSS_Fuller::eta_eval(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer ROSS_Fuller::DetaDxp_numRows() const { return 2; }
  integer ROSS_Fuller::DetaDxp_numCols() const { return 2; }
  integer ROSS_Fuller::DetaDxp_nnz()     const { return 0; }

  void
  ROSS_Fuller::DetaDxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
...
// EOF: ROSS_Fuller_Methods_Guess.cc
