...
namespace ROSS_FullerDefine {
  ...
  void
  ROSS_Fuller::p_guess_eval( P_p_type P__ ) const {
  }

  void
  ROSS_Fuller::xlambda_guess_eval(
    integer        i_segment,
    Q_const_p_type Q__,
    P_const_p_type P__,
    X_p_type       X__,
  ...
  bool
  ROSS_Fuller::p_check( P_const_p_type P__ ) const {
    return true;
  }
  ...
  bool
  ROSS_Fuller::xlambda_check_node(
    integer         ipos,
  ...
  bool
  ROSS_Fuller::penalties_check_node(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__
  ) const {
  ...
  integer ROSS_Fuller::u_guess_numEqns() const { return 1; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  ROSS_Fuller::u_guess_eval(
    NodeQXL const & NODE__,
    P_const_p_type  P__,
  ...
  bool
  ROSS_Fuller::u_check_if_admissible(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__
    ...
    ok = ok && uControl.check_range(U__[iU_u], -t2, t2);
    return ok;
  }
