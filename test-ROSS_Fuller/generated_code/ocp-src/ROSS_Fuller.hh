...
#ifndef ROSS_FULLER_DOT_HH
#define ROSS_FULLER_DOT_HH
...
// User Header (end)
  ...
  #ifndef ROSS_FULLER_API_DLL
    #ifdef ROSS_FULLER_EXPORT
      #define ROSS_FULLER_API_DLL __declspec(dllexport)
    #elif defined(ROSS_FULLER_IMPORT)
      #define ROSS_FULLER_API_DLL __declspec(dllimport)
    #else
      #define ROSS_FULLER_API_DLL
    #endif
  #endif
...
namespace ROSS_FullerDefine {
  ...
  class ROSS_Fuller : public Mechatronix::Discretized_Indirect_OCP {
    ...
    ROSS_Fuller const & operator = ( ROSS_Fuller const & );
...
namespace ROSS_FullerLoad {
  using ROSS_FullerDefine::ROSS_Fuller;
