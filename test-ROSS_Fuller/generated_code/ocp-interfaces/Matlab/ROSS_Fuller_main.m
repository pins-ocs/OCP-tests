...
%ocp.setup(ROSS_Fuller_data);
ocp.setup('../../data/ROSS_Fuller_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ROSS_Fuller_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = ROSS_Fuller_Mex('get_raw_solution',obj);
%J     = ROSS_Fuller_Mex('eval_JF',obj,Z,MU,U);
%f     = ROSS_Fuller_Mex('eval_F',obj,Z,MU,U);
