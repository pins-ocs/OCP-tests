...
namespace FlowInAchannelDefine {
  ...
  */
  void
  FlowInAchannel::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  FlowInAchannel::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "FlowInAchannel::setupParameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  FlowInAchannel::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  FlowInAchannel::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  FlowInAchannel::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  FlowInAchannel::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  FlowInAchannel::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "FlowInAchannel::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in FlowInAchannel::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  FlowInAchannel::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  FlowInAchannel::diagnostic( GenericContainer const & gc ) {
