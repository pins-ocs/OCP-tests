...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%FlowInAchannel_Mex('set_tracked',obj,tracked);
...
%[Z,U] = FlowInAchannel_Mex('get_raw_solution',obj);
%J     = FlowInAchannel_Mex('eval_JF',obj,Z,U);
%f     = FlowInAchannel_Mex('eval_F',obj,Z,U);
