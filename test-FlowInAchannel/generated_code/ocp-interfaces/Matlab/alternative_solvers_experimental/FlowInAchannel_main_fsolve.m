...
ocp.setup( [DATA_PATH 'FlowInAchannel_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = FlowInAchannel_Mex('get_raw_solution',obj);
%J        = FlowInAchannel_Mex('eval_JF',obj,Z,MU,U);
%f        = FlowInAchannel_Mex('eval_F',obj,Z,MU,U);
