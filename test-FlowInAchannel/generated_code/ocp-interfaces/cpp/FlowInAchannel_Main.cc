...
main() {
  ...
  try {
    FlowInAchannel * m_model = new FlowInAchannel("FlowInAchannel",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/FlowInAchannel_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/FlowInAchannel_Data.lua";
    #endif
