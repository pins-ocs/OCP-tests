...
namespace FlowInAchannelDefine {
  ...
  integer FlowInAchannel::JPxpu_numEqns() const { return 4; }

  void
  FlowInAchannel::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer FlowInAchannel::JUxpu_numEqns() const { return 4; }

  void
  FlowInAchannel::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer FlowInAchannel::LTxpu_numEqns() const { return 4; }

  void
  FlowInAchannel::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
