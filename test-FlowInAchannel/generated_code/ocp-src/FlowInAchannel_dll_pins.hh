/*-----------------------------------------------------------------------*\
 |  file: FlowInAchannel_dll_pins.hh                                     |
 |                                                                       |
...
namespace FlowInAchannelDefine {
  ...
  using namespace FlowInAchannelLoad;
  ...
  class FlowInAchannel_Problem {

    FlowInAchannel model;
    ...
    FlowInAchannel_Problem( FlowInAchannel_Problem const & );
    FlowInAchannel_Problem const & operator = ( FlowInAchannel_Problem const & );
  ...
  public:
    ...
    FlowInAchannel_Problem( integer n_threads, Console const * console )
    : model("FlowInAchannel",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "FlowInAchannel::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: FlowInAchannel_dll_pins.hh
