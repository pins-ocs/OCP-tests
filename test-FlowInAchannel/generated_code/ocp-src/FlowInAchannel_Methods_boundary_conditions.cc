...
namespace FlowInAchannelDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer FlowInAchannel::DbcDxxp_numRows() const { return 4; }
  integer FlowInAchannel::DbcDxxp_numCols() const { return 8; }
  integer FlowInAchannel::DbcDxxp_nnz()     const { return 4; }

  void
  FlowInAchannel::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer FlowInAchannel::D2bcD2xxp_numRows() const { return 8; }
  integer FlowInAchannel::D2bcD2xxp_numCols() const { return 8; }
  integer FlowInAchannel::D2bcD2xxp_nnz()     const { return 0; }

  void
  FlowInAchannel::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
  ...
  integer FlowInAchannel::fd_BC_numEqns() const { return 8; }

  void
  FlowInAchannel::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer FlowInAchannel::Dfd_BCDxlxlp_numRows() const { return 8; }
  integer FlowInAchannel::Dfd_BCDxlxlp_numCols() const { return 16; }
  integer FlowInAchannel::Dfd_BCDxlxlp_nnz()     const { return 8; }

  void
  FlowInAchannel::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  FlowInAchannel::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
