...
namespace FlowInAchannelDefine {
  ...
  FlowInAchannel::H_eval(
    ...
    real_type t3   = X__[iX_u3];
    real_type t5   = X__[iX_u1];
    real_type t6   = X__[iX_u2];
    real_type result__ = -ModelPars[iM_R] * (t3 * X__[iX_u] - t6 * t5) * L__[iL_lambda4__xo] + t5 * L__[iL_lambda1__xo] + t6 * L__[iL_lambda2__xo] + t3 * L__[iL_lambda3__xo];
    return result__;
  }
#else
  real_type
  ...
  integer
  FlowInAchannel::DmayerDx_numEqns() const
  { return 8; }

  void
  FlowInAchannel::DmayerDx_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
  ...
  integer
  FlowInAchannel::DmayerDp_numEqns() const
  { return 0; }

  void
  FlowInAchannel::DmayerDp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_ptr             result__
