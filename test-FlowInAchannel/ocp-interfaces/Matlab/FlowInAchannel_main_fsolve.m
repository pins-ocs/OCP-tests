%-----------------------------------------------------------------------%
%  file: FlowInAchannel_fsolve_main.m                                   %
%                                                                       %
...
% create object
infolevel  = 4;
ocp = FlowInAchannel( 'FlowInAchannel', infolevel );
...
%ocp.setup(FlowInAchannel_data);
%ocp.setup('../../data/FlowInAchannel_Data.lua');
ocp.setup('../../data/FlowInAchannel_Data.rb');
...
%%clear mex
%x = FlowInAchannel_Mex('get_raw_solution',obj);
%J = FlowInAchannel_Mex('eval_JF',obj,x);
%f = FlowInAchannel_Mex('eval_F',obj,x);
