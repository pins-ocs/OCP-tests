...
ocp.setup('../../data/SingularConstrainedCalogero_Data');  % automatically try extension .rb and .lua
...
%[Z,MU,U] = SingularConstrainedCalogero_Mex('get_raw_solution',obj);
%J     = SingularConstrainedCalogero_Mex('eval_JF',obj,Z,MU,U);
%f     = SingularConstrainedCalogero_Mex('eval_F',obj,Z,MU,U);
