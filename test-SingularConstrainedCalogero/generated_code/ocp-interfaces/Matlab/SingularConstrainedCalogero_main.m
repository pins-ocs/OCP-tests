%-----------------------------------------------------------------------%
%  file: SingularConstrainedCalogero_main.m                             %
%                                                                       %
...
% create object
ocp = SingularConstrainedCalogero( 'SingularConstrainedCalogero' );
...
%ocp.setup(SingularConstrainedCalogero_data);
%ocp.setup('../../data/SingularConstrainedCalogero_Data.lua');
ocp.setup('../../data/SingularConstrainedCalogero_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%SingularConstrainedCalogero_Mex('set_tracked',obj,tracked);
...
%[Z,U] = SingularConstrainedCalogero_Mex('get_raw_solution',obj);
%J     = SingularConstrainedCalogero_Mex('eval_JF',obj,Z,U);
%f     = SingularConstrainedCalogero_Mex('eval_F',obj,Z,U);
