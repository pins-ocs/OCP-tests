...
main() {
  ...
  try {
    SingularConstrainedCalogero * m_model = new SingularConstrainedCalogero("SingularConstrainedCalogero",&TP,&console);
    ...
    if ( ok ) {
      ...
      file.open( "data/SingularConstrainedCalogero_OCP_result_NOT_CONVERGED.ßtxt" );
    }
    file.precision(18);
