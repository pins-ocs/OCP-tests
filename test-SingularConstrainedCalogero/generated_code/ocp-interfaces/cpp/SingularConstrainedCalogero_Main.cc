...
main() {
  ...
  try {
    SingularConstrainedCalogero * m_model = new SingularConstrainedCalogero("SingularConstrainedCalogero",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/SingularConstrainedCalogero_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/SingularConstrainedCalogero_Data.lua";
    #endif
