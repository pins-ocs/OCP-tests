/*-----------------------------------------------------------------------*\
 |  file: SingularConstrainedCalogero_dll_ruby.hh                        |
 |                                                                       |
...
namespace SingularConstrainedCalogeroDefine {
  ...
  */
  ...
  SINGULARCONSTRAINEDCALOGERO_API_DLL
  bool
  SingularConstrainedCalogero_ocp_guess( char const id[], GenericContainer & gc_guess );
...
// EOF: SingularConstrainedCalogero_dll_ruby.hh
