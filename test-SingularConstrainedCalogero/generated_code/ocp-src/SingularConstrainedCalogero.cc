...
namespace SingularConstrainedCalogeroDefine {
  ...
  */
  void
  SingularConstrainedCalogero::update_continuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
  ...
  */
  ...
  void
  SingularConstrainedCalogero::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  SingularConstrainedCalogero::info_model( integer level ) const {
    ...
    m_console->message( uMaxBound.info(),level);
