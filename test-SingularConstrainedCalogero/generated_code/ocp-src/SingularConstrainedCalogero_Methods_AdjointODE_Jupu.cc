...
namespace SingularConstrainedCalogeroDefine {
  ...
  integer SingularConstrainedCalogero::JPxpu_numEqns() const { return 2; }

  void
  SingularConstrainedCalogero::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer SingularConstrainedCalogero::JUxpu_numEqns() const { return 2; }

  void
  SingularConstrainedCalogero::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer SingularConstrainedCalogero::LTxpu_numEqns() const { return 2; }

  void
  SingularConstrainedCalogero::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
