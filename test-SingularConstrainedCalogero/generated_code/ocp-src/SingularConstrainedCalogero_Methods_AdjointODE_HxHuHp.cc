...
namespace SingularConstrainedCalogeroDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SingularConstrainedCalogero::DHxpDxpu_numRows() const { return 1; }
  integer SingularConstrainedCalogero::DHxpDxpu_numCols() const { return 2; }
  integer SingularConstrainedCalogero::DHxpDxpu_nnz()     const { return 0; }

  void
  SingularConstrainedCalogero::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  SingularConstrainedCalogero::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
