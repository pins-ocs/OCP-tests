...
namespace SingularConstrainedCalogeroDefine {
  ...
  integer SingularConstrainedCalogero::Hxp_numEqns() const { return 1; }

  void
  SingularConstrainedCalogero::Hxp_eval(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer SingularConstrainedCalogero::DHxpDxpuv_numRows() const { return 1; }
  integer SingularConstrainedCalogero::DHxpDxpuv_numCols() const { return 3; }
  integer SingularConstrainedCalogero::DHxpDxpuv_nnz()     const { return 2; }

  void
  SingularConstrainedCalogero::DHxpDxpuv_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  SingularConstrainedCalogero::DHxpDxpuv_sparse(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__,
