...
namespace SingularConstrainedCalogeroDefine {
  ...
  void
  SingularConstrainedCalogero::continuation_step_1( real_type s ) {
    real_type t2   = 1 - s;
  ...
  SingularConstrainedCalogero::H_eval(
    ...
    real_type result__ = (Q__[iQ_zeta] - 4) * t1 + t1 * MU__[0];
    if ( m_debug ) {
  ...
  integer SingularConstrainedCalogero::DsegmentLinkDxxp_numRows() const { return 0; }
  integer SingularConstrainedCalogero::DsegmentLinkDxxp_numCols() const { return 0; }
  integer SingularConstrainedCalogero::DsegmentLinkDxxp_nnz() const { return 0; }

  void
  SingularConstrainedCalogero::DsegmentLinkDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  SingularConstrainedCalogero::DsegmentLinkDxxp_sparse(
    NodeQX const & L,
    NodeQX const & R,
    P_const_p_type p,
