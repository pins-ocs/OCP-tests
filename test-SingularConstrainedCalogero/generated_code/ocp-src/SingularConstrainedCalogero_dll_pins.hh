/*-----------------------------------------------------------------------*\
 |  file: SingularConstrainedCalogero_dll_pins.hh                        |
 |                                                                       |
...
namespace SingularConstrainedCalogeroDefine {
  ...
  using namespace SingularConstrainedCalogeroLoad;
  ...
  class SingularConstrainedCalogero_Problem {

    SingularConstrainedCalogero model;
    ...
    SingularConstrainedCalogero_Problem( SingularConstrainedCalogero_Problem const & );
    SingularConstrainedCalogero_Problem const & operator = ( SingularConstrainedCalogero_Problem const & );
  ...
  public:
    ...
    SingularConstrainedCalogero_Problem( integer n_threads, Console const * console )
    : model("SingularConstrainedCalogero",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    SINGULARCONSTRAINEDCALOGERO_API_DLL
    ~SingularConstrainedCalogero_Problem()
    {}
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "SingularConstrainedCalogero::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: SingularConstrainedCalogero_dll_pins.hh
