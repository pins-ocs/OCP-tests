/*-----------------------------------------------------------------------*\
 |  file: SingularConstrainedCalogero.hh                                 |
 |                                                                       |
...
#ifndef SINGULARCONSTRAINEDCALOGERO_DOT_HH
#define SINGULARCONSTRAINEDCALOGERO_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef SINGULARCONSTRAINEDCALOGERO_API_DLL
    #ifdef SINGULARCONSTRAINEDCALOGERO_EXPORT
      #define SINGULARCONSTRAINEDCALOGERO_API_DLL __declspec(dllexport)
    #elif defined(SINGULARCONSTRAINEDCALOGERO_IMPORT)
      #define SINGULARCONSTRAINEDCALOGERO_API_DLL __declspec(dllimport)
    #else
      #define SINGULARCONSTRAINEDCALOGERO_API_DLL
    #endif
  #endif
...
namespace SingularConstrainedCalogeroDefine {
  ...
  class SingularConstrainedCalogero : public Mechatronix::Discretized_Indirect_OCP {
    ...
    // Constraints 1D  - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    Mechatronix::PenaltyBarrier1DGreaterThan uMaxBound;
    ...
    SingularConstrainedCalogero( SingularConstrainedCalogero const & );
    SingularConstrainedCalogero const & operator = ( SingularConstrainedCalogero const & );
  ...
  public:
    ...
    SINGULARCONSTRAINEDCALOGERO_API_DLL virtual
    ~SingularConstrainedCalogero() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    SINGULARCONSTRAINEDCALOGERO_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "SingularConstrainedCalogero"; }
...
namespace SingularConstrainedCalogeroLoad {
  using SingularConstrainedCalogeroDefine::SingularConstrainedCalogero;

}

#endif

// EOF: SingularConstrainedCalogero.hh
