...
#define MODEL_NAME  "SingularConstrainedCalogero"
#define MODEL_CLASS SingularConstrainedCalogero
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "SingularConstrainedCalogero_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "SingularConstrainedCalogero_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
