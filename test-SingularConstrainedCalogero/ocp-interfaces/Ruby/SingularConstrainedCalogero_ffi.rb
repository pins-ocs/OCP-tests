#-----------------------------------------------------------------------#
#  file: SingularConstrainedCalogero_run.rb                             #
#                                                                       #
...
module GenericContainer
  @libGenericContainer = MECHATRONIX_LIB_PATH+"/libSingularConstrainedCalogero.#{DYLIB_EXT}"
end

module Splines
  @libSplines = MECHATRONIX_LIB_PATH+"/libSingularConstrainedCalogero.#{DYLIB_EXT}"
end
...
module SingularConstrainedCalogero
  ...
  LIB_PATH = MECHATRONIX_LIB_PATH+"/libSingularConstrainedCalogero.#{DYLIB_EXT}"
  ...
  attach_function :OCP_setup,
                  :SingularConstrainedCalogero_ocp_setup,
                  [ :string, :buffer_in ], :bool

  attach_function :OCP_guess,
                  :SingularConstrainedCalogero_ocp_guess,
                  [ :string, :buffer_in ], :bool

  attach_function :OCP_solve,
                  :SingularConstrainedCalogero_ocp_solve,
                  [ :string, :buffer_in, :buffer_out ], :bool

  attach_function :OCP_write_ocp_solution,
                  :SingularConstrainedCalogero_write_ocp_solution,
                  [ :string, :string ], :void
  ...
  class OCPSolver
    ...
    def solve( convert = true )
      ...
      ok = SingularConstrainedCalogero.OCP_setup( @id, GenericContainer.GC_mem_ptr(@id) )
      raise RuntimeError, "Failed to do setup: #{out[:Error]}\n" unless ok

      ok = SingularConstrainedCalogero.OCP_guess( @id, GenericContainer.GC_mem_ptr(@id) )
      raise RuntimeError, "Failed to do guess: #{out[:Error]}\n" unless ok

      ok  = SingularConstrainedCalogero.OCP_solve( @id,
    ...
    def write_ocp_solution( fname )
      SingularConstrainedCalogero.OCP_write_ocp_solution( @id, fname )
    end
...
# EOF: SingularConstrainedCalogero_ffi.rb
