--[[
/*-----------------------------------------------------------------------*\
 |  file: ICLOCS2_BatchFermentor_Data.lua                                |
 |                                                                       |
...
WX0          = 1
WX           = WX0
state_tol    = state_tol0
Tf           = 126
u_epsilon0   = 0.1
u_epsilon    = u_epsilon0
u_tolerance0 = 0.1
state_epsi0  = 0.1
state_epsi   = state_epsi0
...
content = {
  ...
  -- DumpFile = "ICLOCS2_BatchFermentor_dump",
  ...
  Parameters = {
    ...
    WX0         = WX0,
    WX1         = 0.01,
    state_epsi0 = state_epsi0,
    state_epsi1 = 0.001,
    state_tol0  = state_tol0,
    state_tol1  = 0.001,
  ...
  -- Barrier subtype: BARRIER_1X, BARRIER_LOG, BARRIER_LOG_EXP, BARRIER_LOG0
    ...
    x_LimitsubType   = "PENALTY_REGULAR",
    x_Limitepsilon   = state_epsi,
    x_Limittolerance = state_tol,
    x_Limitactive    = true

    -- PenaltyBarrier1DGreaterThan
    p_LimitsubType   = "PENALTY_REGULAR",
    p_Limitepsilon   = state_epsi,
    p_Limittolerance = state_tol,
    p_Limitactive    = true

    -- PenaltyBarrier1DGreaterThan
    s_LimitsubType   = "PENALTY_REGULAR",
    s_Limitepsilon   = state_epsi,
    s_Limittolerance = state_tol,
    s_Limitactive    = true

    -- PenaltyBarrier1DGreaterThan
    v_LimitsubType   = "PENALTY_REGULAR",
    v_Limitepsilon   = state_epsi,
    v_Limittolerance = state_tol,
    v_Limitactive    = true
