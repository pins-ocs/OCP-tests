/*-----------------------------------------------------------------------*\
 |  file: ICLOCS2_BatchFermentor_dll_pins.hh                             |
 |                                                                       |
...
namespace ICLOCS2_BatchFermentorDefine {
  ...
  class ICLOCS2_BatchFermentor_Problem {

    ICLOCS2_BatchFermentor      model;
    ...
    ICLOCS2_BatchFermentor_Problem( ICLOCS2_BatchFermentor_Problem const & );
    ICLOCS2_BatchFermentor_Problem const & operator = ( ICLOCS2_BatchFermentor_Problem const & );
  ...
  public:
    ...
    ICLOCS2_BatchFermentor_Problem( integer n_threads, Console const * console )
    : model("ICLOCS2_BatchFermentor",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    ICLOCS2_BATCHFERMENTOR_API_DLL
    ~ICLOCS2_BatchFermentor_Problem()
    {}
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "ICLOCS2_BatchFermentor::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: ICLOCS2_BatchFermentor_dll_pins.hh
