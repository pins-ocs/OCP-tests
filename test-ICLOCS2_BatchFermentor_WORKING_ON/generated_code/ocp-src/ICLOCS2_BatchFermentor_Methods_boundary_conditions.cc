/*-----------------------------------------------------------------------*\
 |  file: ICLOCS2_BatchFermentor_Methods_boundary_conditions.cc          |
 |                                                                       |
...
namespace ICLOCS2_BatchFermentorDefine {
  ...
  integer
  ICLOCS2_BatchFermentor::boundaryConditions_numEqns() const
  { return 4; }

  void
  ICLOCS2_BatchFermentor::boundaryConditions_eval(
    ...
    result__[ 1   ] = XL__[iX_p] - ModelPars[iM_p_i];
    result__[ 2   ] = XL__[iX_s] - ModelPars[iM_s_i];
  ...
  integer
  ICLOCS2_BatchFermentor::DboundaryConditionsDxxp_numRows() const
  { return 4; }

  integer
  ICLOCS2_BatchFermentor::DboundaryConditionsDxxp_numCols() const
  { return 8; }

  integer
  ICLOCS2_BatchFermentor::DboundaryConditionsDxxp_nnz() const
  { return 4; }

  void
  ICLOCS2_BatchFermentor::DboundaryConditionsDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  ICLOCS2_BatchFermentor::DboundaryConditionsDxxp_sparse(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  ICLOCS2_BatchFermentor::adjointBC_numEqns() const
  { return 8; }

  void
  ICLOCS2_BatchFermentor::adjointBC_eval(
    ...
    result__[ 5   ] = -XR__[iX_v] - LR__[iL_lambda2__xo];
    result__[ 6   ] = -LR__[iL_lambda3__xo];
    result__[ 7   ] = -XR__[iX_p] - LR__[iL_lambda4__xo];
    if ( m_debug )
  ...
  integer
  ICLOCS2_BatchFermentor::DadjointBCDxxp_numRows() const
  { return 8; }

  integer
  ICLOCS2_BatchFermentor::DadjointBCDxxp_numCols() const
  { return 8; }

  integer
  ICLOCS2_BatchFermentor::DadjointBCDxxp_nnz() const
  { return 2; }

  void
  ICLOCS2_BatchFermentor::DadjointBCDxxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  void
  ICLOCS2_BatchFermentor::DadjointBCDxxp_sparse(
    NodeType2 const             & LEFT__,
    NodeType2 const             & RIGHT__,
    P_const_pointer_type          P__,
    OMEGA_full_const_pointer_type OMEGA__,
...
// EOF: ICLOCS2_BatchFermentor_Methods_boundary_conditions.cc
