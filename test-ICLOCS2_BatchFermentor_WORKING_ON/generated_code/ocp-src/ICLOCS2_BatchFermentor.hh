...
namespace ICLOCS2_BatchFermentorDefine {
  ...
  class ICLOCS2_BatchFermentor : public Mechatronix::Discretized_Indirect_OCP {
    ...
    // Model Paramaters  - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    real_type ModelPars[31];

    // Controls  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    Mechatronix::PenaltyBarrierU uControl;

    // Constraints 1D  - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    Mechatronix::PenaltyBarrier1DGreaterThan x_Limit;
    Mechatronix::PenaltyBarrier1DGreaterThan p_Limit;
    Mechatronix::PenaltyBarrier1DGreaterThan s_Limit;
    Mechatronix::PenaltyBarrier1DGreaterThan v_Limit;
