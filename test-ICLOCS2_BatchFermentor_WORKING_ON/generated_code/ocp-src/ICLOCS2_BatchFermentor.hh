/*-----------------------------------------------------------------------*\
 |  file: ICLOCS2_BatchFermentor.hh                                      |
 |                                                                       |
...
#ifndef ICLOCS2_BATCHFERMENTOR_DOT_HH
#define ICLOCS2_BATCHFERMENTOR_DOT_HH
...
// User Header (end)
  ...
  #ifndef ICLOCS2_BATCHFERMENTOR_API_DLL
    #ifdef ICLOCS2_BATCHFERMENTOR_EXPORT
      #define ICLOCS2_BATCHFERMENTOR_API_DLL __declspec(dllexport)
    #elif defined(ICLOCS2_BATCHFERMENTOR_IMPORT)
      #define ICLOCS2_BATCHFERMENTOR_API_DLL __declspec(dllimport)
    #else
      #define ICLOCS2_BATCHFERMENTOR_API_DLL
    #endif
  #endif
...
namespace ICLOCS2_BatchFermentorDefine {
  ...
  class ICLOCS2_BatchFermentor : public Mechatronix::Discretized_Indirect_OCP {

    // Model Paramaters  - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    real_type ModelPars[33];
    ...
    ICLOCS2_BatchFermentor( ICLOCS2_BatchFermentor const & );
    ICLOCS2_BatchFermentor const & operator = ( ICLOCS2_BatchFermentor const & );
  ...
  public:
    ...
    explicit
    ICLOCS2_BatchFermentor(
      string const   & name,
      integer          n_threads,
      Console const  * console
    );

    ~ICLOCS2_BatchFermentor() override;
    ...
    ICLOCS2_BATCHFERMENTOR_API_DLL real_type U        ( real_type xo__w ) const;
    ICLOCS2_BATCHFERMENTOR_API_DLL real_type U_D      ( real_type xo__w ) const;
    ICLOCS2_BATCHFERMENTOR_API_DLL real_type U_DD     ( real_type xo__w ) const;
    ICLOCS2_BATCHFERMENTOR_API_DLL real_type mu       ( real_type xo__s, real_type xo__x ) const;
    ICLOCS2_BATCHFERMENTOR_API_DLL real_type mu_D_1   ( real_type xo__s, real_type xo__x ) const;
    ICLOCS2_BATCHFERMENTOR_API_DLL real_type mu_D_1_1 ( real_type xo__s, real_type xo__x ) const;
    ICLOCS2_BATCHFERMENTOR_API_DLL real_type mu_D_1_2 ( real_type xo__s, real_type xo__x ) const;
    ICLOCS2_BATCHFERMENTOR_API_DLL real_type mu_D_2   ( real_type xo__s, real_type xo__x ) const;
    ICLOCS2_BATCHFERMENTOR_API_DLL real_type mu_D_2_2 ( real_type xo__s, real_type xo__x ) const;
    ICLOCS2_BATCHFERMENTOR_API_DLL real_type rho      ( real_type xo__s ) const;
    ICLOCS2_BATCHFERMENTOR_API_DLL real_type rho_D    ( real_type xo__s ) const;
    ICLOCS2_BATCHFERMENTOR_API_DLL real_type rho_DD   ( real_type xo__s ) const;
...
namespace ICLOCS2_BatchFermentorLoad {
  using ICLOCS2_BatchFermentorDefine::ICLOCS2_BatchFermentor;

}

#endif

// EOF: ICLOCS2_BatchFermentor.hh
