/*-----------------------------------------------------------------------*\
 |  file: ICLOCS2_BatchFermentor.cc                                      |
 |                                                                       |
...
namespace ICLOCS2_BatchFermentorDefine {
  ...
  */
  ICLOCS2_BatchFermentor::ICLOCS2_BatchFermentor(
    string const &  name,
    ThreadPool *    TP,
  ...
  */
  void
  ICLOCS2_BatchFermentor::update_continuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
    ...
    UTILS_ASSERT(
      0 <= old_s && old_s < s && s <= 1,
      "ICLOCS2_BatchFermentor::update_continuation( phase number={}, old_s={}, s={} ) "
      "must be 0 <= old_s < s <= 1\n",
      phase, old_s, s
    );
    switch ( phase ) {
  ...
  */
  void
  ICLOCS2_BatchFermentor::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "ICLOCS2_BatchFermentor::setup_parameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in ICLOCS2_BatchFermentor::setup not all parameters are set!\n"
    );
  }

  void
  ICLOCS2_BatchFermentor::setup_parameters( real_type const Pars[] ) {
  ...
  */
  void
  ICLOCS2_BatchFermentor::setup_classes( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Constraints"),
      "ICLOCS2_BatchFermentor::setup_classes: Missing key `Parameters` in data\n"
    );
    GenericContainer const & gc = gc_data("Constraints");
    // Initialize Constraints 1D
    UTILS_ASSERT0(
      gc.exists("x_Limit"),
      "in ICLOCS2_BatchFermentor::setup_classes(gc) missing key: ``x_Limit''\n"
    );
    x_Limit.setup( gc("x_Limit") );

    UTILS_ASSERT0(
      gc.exists("p_Limit"),
      "in ICLOCS2_BatchFermentor::setup_classes(gc) missing key: ``p_Limit''\n"
    );
    p_Limit.setup( gc("p_Limit") );

    UTILS_ASSERT0(
      gc.exists("s_Limit"),
      "in ICLOCS2_BatchFermentor::setup_classes(gc) missing key: ``s_Limit''\n"
    );
    s_Limit.setup( gc("s_Limit") );

    UTILS_ASSERT0(
      gc.exists("v_Limit"),
      "in ICLOCS2_BatchFermentor::setup_classes(gc) missing key: ``v_Limit''\n"
    );
    v_Limit.setup( gc("v_Limit") );
  ...
  */
  void
  ICLOCS2_BatchFermentor::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  ICLOCS2_BatchFermentor::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  ICLOCS2_BatchFermentor::setup_controls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "ICLOCS2_BatchFermentor::setup_classes: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  ICLOCS2_BatchFermentor::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "ICLOCS2_BatchFermentor::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in ICLOCS2_BatchFermentor::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  ICLOCS2_BatchFermentor::info_classes() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  ICLOCS2_BatchFermentor::setup( GenericContainer const & gc ) {

    m_debug = false;
    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("ICLOCS2_BatchFermentor::setup, Debug");
  ...
  */
  void
  ICLOCS2_BatchFermentor::get_names( GenericContainer & out ) const {
  ...
  void
  ICLOCS2_BatchFermentor::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
