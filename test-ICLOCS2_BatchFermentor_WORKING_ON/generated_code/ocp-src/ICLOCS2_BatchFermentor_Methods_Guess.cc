...
namespace ICLOCS2_BatchFermentorDefine {
  ...
  void
  ICLOCS2_BatchFermentor::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  ICLOCS2_BatchFermentor::xlambda_guess_eval(
    integer              i_segment,
    ...
    real_type t5   = 1.0 / ModelPars[iM_Tf] * Q__[iQ_zeta];
    X__[ iX_x ] = t1 + (ModelPars[iM_x_f] - t1) * t5;
    real_type t9   = ModelPars[iM_p_i];
    X__[ iX_p ] = t9 + (ModelPars[iM_p_f] - t9) * t5;
    real_type t13  = ModelPars[iM_s_i];
    X__[ iX_s ] = t13 + (ModelPars[iM_s_f] - t13) * t5;
    real_type t17  = ModelPars[iM_v_i];
    X__[ iX_v ] = t17 + (ModelPars[iM_v_f] - t17) * t5;
  ...
  bool
  ICLOCS2_BatchFermentor::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  ICLOCS2_BatchFermentor::xlambda_check_node(
    integer              ipos,
  ...
  bool
  ICLOCS2_BatchFermentor::xlambda_check_cell(
    integer              icell,
  ...
  integer ICLOCS2_BatchFermentor::u_guess_numEqns() const { return 5; }

  void
  ICLOCS2_BatchFermentor::u_guess_eval(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    std::fill_n( UGUESS__.pointer(), 5, 0 );
    UGUESS__[ iU_c_x ] = ModelPars[iM_x_max] / 2;
    UGUESS__[ iU_c_p ] = ModelPars[iM_p_max] / 2;
    UGUESS__[ iU_c_s ] = ModelPars[iM_s_max] / 2;
    UGUESS__[ iU_c_v ] = ModelPars[iM_v_max] / 2;
    UGUESS__[ iU_w   ] = 0;
    if ( m_debug )
      Mechatronix::check_in_segment( UGUESS__.pointer(), "u_guess_eval", 5, i_segment );
  }
  ...
  bool
  ICLOCS2_BatchFermentor::u_check_if_admissible(
    NodeType2 const    & NODE__,
