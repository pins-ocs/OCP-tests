/*-----------------------------------------------------------------------*\
 |  file: ICLOCS2_BatchFermentor_Mex.cc                                  |
 |                                                                       |
...
"ICLOCS2_BatchFermentor_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "ICLOCS2_BatchFermentor"
#define MODEL_CLASS ICLOCS2_BatchFermentor
...
public:
  ...
  do_eval_F(
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "ICLOCS2_BatchFermentor_Mex('eval_F',...) error: {}", exc.what() ).c_str() );
      ok = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "ICLOCS2_BatchFermentor_Mex('eval_F',...) unkown error\n" );
      ok = false;
    }
  ...
  do_eval_JF(
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "ICLOCS2_BatchFermentor_Mex('eval_JF',...) error: {}", exc.what() ).c_str() );
      ok_value = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "ICLOCS2_BatchFermentor_Mex('eval_JF',...) unkown error\n" );
      ok_value = false;
    }
    int ok = mexCallMATLAB( 1, &arg_out_0, 5, args, "sparse" );
    MEX_ASSERT( ok == 0, CMD "failed the call sparse(...)" );
  ...
  do_mu(
    ...
    #define CMD MODEL_NAME "_Mex('mu', obj, xo__s, xo__x ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    ...
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->mu(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_mu_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('mu_D_1', obj, xo__s, xo__x ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__s" );
    mwSize N1, M1;
    ...
    real_ptr res = createMatrixValue( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->mu_D_1(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_mu_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('mu_D_2', obj, xo__s, xo__x ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__s" );
    mwSize N1, M1;
    ...
    real_ptr res = createMatrixValue( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->mu_D_2(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_mu_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('mu_D_1_1', obj, xo__s, xo__x ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__s" );
    mwSize N1, M1;
    ...
    real_ptr res = createMatrixValue( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->mu_D_1_1(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_mu_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('mu_D_1_2', obj, xo__s, xo__x ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__s" );
    mwSize N1, M1;
    ...
    real_ptr res = createMatrixValue( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->mu_D_1_2(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_mu_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('mu_D_2_2', obj, xo__s, xo__x ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__s" );
    mwSize N1, M1;
    ...
    real_ptr res = createMatrixValue( arg_out_0, N0, M0 );
    for ( mwSize ii = 0; ii < N0*M0; ++ii )
      res[ii] = this->mu_D_2_2(arg0[ii],arg1[ii]);
    #undef CMD
  }
  ...
  do_rho(
    ...
    #define CMD MODEL_NAME "_Mex('rho', obj, xo__s ): "
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__s" );
  ...
  do_rho_D(
    ...
    #define CMD MODEL_NAME "_Mex('rho_D', obj, xo__s ): "
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__s" );
  ...
  do_rho_DD(
    ...
    #define CMD MODEL_NAME "_Mex('rho_DD', obj, xo__s ): "
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = getMatrixPointer( arg_in_2, N0, M0, CMD " xo__s" );
...
do_mu(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('mu',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_mu( nlhs, plhs, nrhs, prhs );
}
...
do_mu_D_1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('mu_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_mu_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_mu_D_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('mu_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_mu_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_mu_D_1_1(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('mu_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_mu_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_mu_D_1_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('mu_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_mu_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_mu_D_2_2(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('mu_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_mu_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_rho(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('rho',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_rho( nlhs, plhs, nrhs, prhs );
}
...
do_rho_D(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('rho_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_rho_D( nlhs, plhs, nrhs, prhs );
}
...
do_rho_DD(
  ...
  MEX_ASSERT2(
    nrhs >= 2,
    MODEL_NAME "_Mex('rho_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_rho_DD( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"mu_D_1",do_mu_D_1},
  {"mu_D_2",do_mu_D_2},
  {"mu_D_1_1",do_mu_D_1_1},
  {"mu_D_1_2",do_mu_D_1_2},
  {"mu_D_2_2",do_mu_D_2_2},
  {"rho",do_rho},
  {"rho_D",do_rho_D},
  {"rho_DD",do_rho_DD},
  {"new",do_new},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "ICLOCS2_BatchFermentor_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "ICLOCS2_BatchFermentor_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
