%-----------------------------------------------------------------------%
%  file: ICLOCS2_BatchFermentor_main.m                                  %
%                                                                       %
...
% create object
ocp = ICLOCS2_BatchFermentor( 'ICLOCS2_BatchFermentor' );
...
%ocp.setup(ICLOCS2_BatchFermentor_data);
%ocp.setup('../../data/ICLOCS2_BatchFermentor_Data.lua');
ocp.setup('../../data/ICLOCS2_BatchFermentor_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ICLOCS2_BatchFermentor_Mex('set_tracked',obj,tracked);
...
%[Z,U] = ICLOCS2_BatchFermentor_Mex('get_raw_solution',obj);
%J     = ICLOCS2_BatchFermentor_Mex('eval_JF',obj,Z,U);
%f     = ICLOCS2_BatchFermentor_Mex('eval_F',obj,Z,U);
