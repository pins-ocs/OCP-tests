...
public:
  ...
  void do_mu( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_mu_D_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_mu_D_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_mu_D_1_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_mu_D_1_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_mu_D_2_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_rho( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_rho_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_rho_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
