...
main() {
  ...
  try {
    ICLOCS2_BatchFermentor * m_model = new ICLOCS2_BatchFermentor("ICLOCS2_BatchFermentor",&TP,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/ICLOCS2_BatchFermentor_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/ICLOCS2_BatchFermentor_Data.lua";
    #endif
