...
main() {
  ...
  try {
    ICLOCS2_BatchFermentor * m_model = new ICLOCS2_BatchFermentor("ICLOCS2_BatchFermentor",n_threads,&console);

    // user defined Object instances (external)
    MeshStd                     mesh( "mesh" );

    string fname = "./data/ICLOCS2_BatchFermentor_Data"; // no .lua or .rb extension
