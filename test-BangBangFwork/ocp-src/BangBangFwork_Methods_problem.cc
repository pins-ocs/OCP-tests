...
namespace BangBangFworkDefine {
  ...
  integer
  BangBangFwork::DmayerDx_numEqns() const
  { return 4; }

  void
  BangBangFwork::DmayerDx_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  BangBangFwork::DmayerDp_numEqns() const
  { return 0; }

  void
  BangBangFwork::DmayerDp_eval(
    NodeType const     & LEFT__,
    NodeType const     & RIGHT__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  BangBangFwork::DJDx_numEqns() const
  { return 2; }

  void
  BangBangFwork::DJDx_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  BangBangFwork::DJDp_numEqns() const
  { return 0; }

  void
  BangBangFwork::DJDp_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer
  BangBangFwork::DJDu_numEqns() const
  { return 1; }

  void
  BangBangFwork::DJDu_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
