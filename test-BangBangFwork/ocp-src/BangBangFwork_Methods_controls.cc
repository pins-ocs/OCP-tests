...
namespace BangBangFworkDefine {
  ...
  integer
  BangBangFwork::DgDxlp_numRows() const
  { return 1; }

  integer
  BangBangFwork::DgDxlp_numCols() const
  { return 4; }

  integer
  BangBangFwork::DgDxlp_nnz() const
  { return 1; }

  void
  BangBangFwork::DgDxlp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
  ...
  \*/
  integer
  BangBangFwork::u_numEqns() const
  { return 1; }

  void
  BangBangFwork::u_eval_analytic(
    NodeType2 const    & NODE__,
    P_const_pointer_type P__,
    U_pointer_type       U__
  ) const {
  ...
  \*/
  void
  BangBangFwork::DuDxlp_full_analytic(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
  ...
  bool
  BangBangFwork::DuDxlp_full_numeric(
    NodeType2 const          & NODE__,
    P_const_pointer_type       P__,
    U_const_pointer_type       U__,
    MatrixWrapper<real_type> & DuDxlp
  ...
  integer
  BangBangFwork::segmentLink_numEqns() const
  { return 0; }
  ...
  integer
  BangBangFwork::DsegmentLinkDxp_numRows() const
  { return 0; }

  integer
  BangBangFwork::DsegmentLinkDxp_numCols() const
  { return 0; }

  integer
  BangBangFwork::DsegmentLinkDxp_nnz() const
  { return 0; }

  void
  BangBangFwork::DsegmentLinkDxp_pattern(
    integer iIndex[],
    integer jIndex[]
  ) const {
   UTILS_ERROR0("NON IMPLEMENTATA\n");
  ...
  void
  BangBangFwork::DsegmentLinkDxp_sparse(
    NodeType const     & L,
    NodeType const     & R,
    P_const_pointer_type p,
  ...
  integer
  BangBangFwork::jump_numEqns() const
  { return 4; }
