...
#ifndef BANGBANGFWORK_DOT_HH
#define BANGBANGFWORK_DOT_HH
...
#include <MechatronixCore/MechatronixCore.hh>
  ...
  #ifndef BANGBANGFWORK_API_DLL
    #ifdef BANGBANGFWORK_EXPORT
      #define BANGBANGFWORK_API_DLL __declspec(dllexport)
    #elif defined(BANGBANGFWORK_IMPORT)
      #define BANGBANGFWORK_API_DLL __declspec(dllimport)
    #else
      #define BANGBANGFWORK_API_DLL
    #endif
  #endif
...
namespace BangBangFworkDefine {
  ...
  class BangBangFwork : public Mechatronix::Discretized_Indirect_OCP {
    ...
    BangBangFwork( BangBangFwork const & );
    BangBangFwork const & operator = ( BangBangFwork const & );
  ...
  public:
    ...
    BANGBANGFWORK_API_DLL virtual
    ~BangBangFwork() MECHATRONIX_OVERRIDE;

    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    BANGBANGFWORK_API_DLL virtual
    char const * model_name() const MECHATRONIX_OVERRIDE
    { return "BangBangFwork"; }
    ...
    BANGBANGFWORK_API_DLL real_type fMax      ( real_type zeta__XO ) const;
    BANGBANGFWORK_API_DLL real_type fMax_D    ( real_type zeta__XO ) const;
    BANGBANGFWORK_API_DLL real_type fMax_DD   ( real_type zeta__XO ) const;
...
namespace BangBangFworkLoad {
  using BangBangFworkDefine::BangBangFwork;

}

#endif

// EOF: BangBangFwork.hh
