...
namespace BangBangFworkDefine {
  ...
  */
  void
  BangBangFwork::updateContinuation( integer phase, real_type s ) {
  }
  ...
  */
  void
  BangBangFwork::setupParameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "BangBangFwork::setupParameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in BangBangFwork::setup not all parameters are set!\n"
    );
  }

  void
  BangBangFwork::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  BangBangFwork::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  BangBangFwork::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  BangBangFwork::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  BangBangFwork::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "BangBangFwork::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  BangBangFwork::setupPointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "BangBangFwork::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in BangBangFwork::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  BangBangFwork::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  BangBangFwork::setup( GenericContainer const & gc ) {

    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("BangBangFwork::setup, Debug");
  ...
  */
  void
  BangBangFwork::get_names( GenericContainer & out ) const {
  ...
  */
  void
  BangBangFwork::diagnostic( GenericContainer const & gc ) {
  ...
  void
  BangBangFwork::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
