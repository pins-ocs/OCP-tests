...
public:
  ...
  do_fMax(
    ...
    #define CMD MODEL_NAME "_Mex('fMax', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->fMax(arg0) );
    #undef CMD
  }
  ...
  do_fMax_D(
    ...
    #define CMD MODEL_NAME "_Mex('fMax_D', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->fMax_D(arg0) );
    #undef CMD
  }
  void
  do_fMax_DD(
    ...
    #define CMD MODEL_NAME "_Mex('fMax_DD', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->fMax_DD(arg0) );
    #undef CMD
  }
