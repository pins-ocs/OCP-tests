...
%ocp.setup('../../data/BangBangFwork_Data.lua');
ocp.setup('../../data/BangBangFwork_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%BangBangFwork_Mex('set_tracked',obj,tracked);
...
%x = BangBangFwork_Mex('get_raw_solution',obj);
%J = BangBangFwork_Mex('eval_JF',obj,x);
%f = BangBangFwork_Mex('eval_F',obj,x);
