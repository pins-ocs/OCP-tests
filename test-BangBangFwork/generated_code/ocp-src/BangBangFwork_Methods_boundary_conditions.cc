...
namespace BangBangFworkDefine {
  ...
  integer BangBangFwork::bc_numEqns() const { return 3; }

  void
  BangBangFwork::bc_eval(
    NodeQX const & LEFT__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFwork::DbcDxxp_numRows() const { return 3; }
  integer BangBangFwork::DbcDxxp_numCols() const { return 4; }
  integer BangBangFwork::DbcDxxp_nnz()     const { return 3; }

  void
  BangBangFwork::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFwork::D2bcD2xxp_numRows() const { return 4; }
  integer BangBangFwork::D2bcD2xxp_numCols() const { return 4; }
  integer BangBangFwork::D2bcD2xxp_nnz()     const { return 0; }

  void
  BangBangFwork::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangFwork::D2bcD2xxp_sparse(
    NodeQX const &          LEFT__,
    NodeQX const &          RIGHT__,
    P_const_p_type          P__,
  ...
  integer BangBangFwork::fd_BC_numEqns() const { return 4; }

  void
  BangBangFwork::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFwork::Dfd_BCDxlxlp_numRows() const { return 4; }
  integer BangBangFwork::Dfd_BCDxlxlp_numCols() const { return 8; }
  integer BangBangFwork::Dfd_BCDxlxlp_nnz()     const { return 4; }

  void
  BangBangFwork::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  BangBangFwork::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
