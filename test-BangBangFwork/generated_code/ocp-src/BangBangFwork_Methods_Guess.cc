...
namespace BangBangFworkDefine {
  ...
  void
  BangBangFwork::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  BangBangFwork::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  BangBangFwork::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  BangBangFwork::xlambda_check_node(
    integer              ipos,
  ...
  bool
  BangBangFwork::xlambda_check_cell(
    integer              icell,
  ...
  integer BangBangFwork::u_guess_numEqns() const { return 1; }
  ...
  BangBangFwork::u_guess_eval(
    ...
    UGUESS__[ iU_F ] = Fcontrol.solve(-L__[iL_lambda2__xo], -t3, t3);
    if ( m_debug )
  ...
  BangBangFwork::u_check_if_admissible(
    ...
    real_type t3   = fMax(Q__[iQ_zeta]);
    ok = ok && Fcontrol.check_range(U__[iU_F], -t3, t3);
    return ok;
  }
