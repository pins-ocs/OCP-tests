...
namespace BangBangFworkDefine {
  ...
  */
  void
  BangBangFwork::update_continuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
  ...
  */
  void
  BangBangFwork::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "BangBangFwork::setup_parameters: Missing key `Parameters` in data\n"
    );
  ...
  */
  void
  BangBangFwork::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  BangBangFwork::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  BangBangFwork::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  BangBangFwork::setup_controls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "BangBangFwork::setup_classes: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  BangBangFwork::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "BangBangFwork::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in BangBangFwork::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  BangBangFwork::info_model( integer level ) const {
    ...
    m_console->message( Fcontrol.info(),level);
