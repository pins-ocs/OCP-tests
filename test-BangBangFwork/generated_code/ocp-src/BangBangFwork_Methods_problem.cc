...
namespace BangBangFworkDefine {
  ...
  bool
  BangBangFwork::penalties_check_cell(
  ...
  integer BangBangFwork::DlagrangeDxup_numEqns() const { return 3; }

  void
  BangBangFwork::DlagrangeDxup_eval(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFwork::D2lagrangeD2xup_numRows() const { return 3; }
  integer BangBangFwork::D2lagrangeD2xup_numCols() const { return 3; }
  integer BangBangFwork::D2lagrangeD2xup_nnz()     const { return 0; }

  void
  BangBangFwork::D2lagrangeD2xup_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangFwork::D2lagrangeD2xup_sparse(
    NodeType const     & NODE__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
    real_type            result__[]
  ...
  integer BangBangFwork::DsegmentLinkDxp_numRows() const { return 0; }
  integer BangBangFwork::DsegmentLinkDxp_numCols() const { return 0; }
  integer BangBangFwork::DsegmentLinkDxp_nnz() const { return 0; }
