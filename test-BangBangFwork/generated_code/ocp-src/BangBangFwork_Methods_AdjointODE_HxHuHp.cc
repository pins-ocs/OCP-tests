...
namespace BangBangFworkDefine {
  ...
  integer BangBangFwork::Hxp_numEqns() const { return 2; }

  void
  BangBangFwork::Hxp_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFwork::DHxpDxpu_numRows() const { return 2; }
  integer BangBangFwork::DHxpDxpu_numCols() const { return 3; }
  integer BangBangFwork::DHxpDxpu_nnz()     const { return 0; }

  void
  BangBangFwork::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangFwork::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
