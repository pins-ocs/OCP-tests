/*-----------------------------------------------------------------------*\
 |  file: BangBangFwork_dll_pins.hh                                      |
 |                                                                       |
...
namespace BangBangFworkDefine {
  ...
  class BangBangFwork_Problem {
    ...
    BangBangFwork_Problem( BangBangFwork_Problem const & );
    BangBangFwork_Problem const & operator = ( BangBangFwork_Problem const & );
  ...
  public:
    ...
    BangBangFwork_Problem( integer n_threads, Console const * console )
    : model("BangBangFwork",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "BangBangFwork::solver, fatal: unknown error";
      }
      return ok;
    }
