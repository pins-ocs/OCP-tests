...
namespace BangBangFworkDefine {
  ...
  BangBangFwork::u_eval_analytic(
    ...
    MeshStd::SegmentClass const & segment = pMesh->get_segment_by_index(i_segment);
    real_type t6   = fMax(Q__[iQ_zeta]);
    U__[ iU_F ] = Fcontrol.solve(-LL__[iL_lambda2__xo] / 2 - LR__[iL_lambda2__xo] / 2, -t6, t6);
    if ( m_debug )
  ...
  BangBangFwork::DuDxlxlp_full_analytic(
    ...
    real_type tmp_0_2 = 0;
    real_type t6   = fMax(Q__[iQ_zeta]);
    real_type t7   = Fcontrol.solve_rhs(-LL__[iL_lambda2__xo] / 2 - LR__[iL_lambda2__xo] / 2, -t6, t6);
