...
public:
  ...
  void do_fMax( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_fMax_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_fMax_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
