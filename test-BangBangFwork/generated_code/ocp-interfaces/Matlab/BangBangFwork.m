...
classdef BangBangFwork < handle
  ...
  methods
    ...
    function res = DboundaryConditionsDxxp_pattern( self )
      res = BangBangFwork_Mex('eval_DboundaryConditionsDxxp_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
    ...
    function res = IPOPT_hess_pattern( self )
      res = BangBangFwork_Mex('eval_IPOPT_hess_pattern', self.objectHandle );
    end
    % ---------------------------------------------------------------------
