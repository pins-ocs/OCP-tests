...
ocp.setup( [DATA_PATH 'BangBangFwork_Data'] ); % automatically try extension .rb and .lua
...
%%clear mex
%[Z,MU,U] = BangBangFwork_Mex('get_raw_solution',obj);
%J        = BangBangFwork_Mex('eval_JF',obj,Z,MU,U);
%f        = BangBangFwork_Mex('eval_F',obj,Z,MU,U);
