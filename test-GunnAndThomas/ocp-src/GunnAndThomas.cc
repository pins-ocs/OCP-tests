...
namespace GunnAndThomasDefine {
  ...
  */
  void
  GunnAndThomas::setupParameters( GenericContainer const & gc_data ) {
    LW_ASSERT0(
      gc_data.exists("Parameters"),
      "GunnAndThomas::setupParameters: Missing key `Parameters` in data\n"
    );
  ...
  void
  GunnAndThomas::setupParameters( real_type const Pars[] ) {
  ...
  */
  void
  GunnAndThomas::setupClasses( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  GunnAndThomas::setupUserClasses( GenericContainer const & gc ) {
  }
  ...
  */
  void
  GunnAndThomas::setupUserMappedFunctions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  GunnAndThomas::setupControls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    LW_ASSERT0(
      gc_data.exists("Controls"),
      "GunnAndThomas::setupClasses: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  GunnAndThomas::setupPointers( GenericContainer const & gc_data ) {

    LW_ASSERT0(
      gc_data.exists("Pointers"),
      "GunnAndThomas::setupPointers: Missing key `Pointers` in data\n"
    );
    ...
    LW_ASSERT0(
      gc.exists("pMesh"),
      "in GunnAndThomas::setupPointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  GunnAndThomas::infoClasses() const {
    int msg_level = 3;
    ostringstream mstr;
  ...
  */
  void
  GunnAndThomas::diagnostic( GenericContainer const & gc ) {
