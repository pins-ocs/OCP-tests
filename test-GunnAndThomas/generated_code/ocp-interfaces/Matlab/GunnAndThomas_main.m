...
% create object
ocp = GunnAndThomas( 'GunnAndThomas' );
...
%ocp.setup(GunnAndThomas_data);
ocp.setup('../../data/GunnAndThomas_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%GunnAndThomas_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = GunnAndThomas_Mex('get_raw_solution',obj);
%J     = GunnAndThomas_Mex('eval_JF',obj,Z,MU,U);
%f     = GunnAndThomas_Mex('eval_F',obj,Z,MU,U);
