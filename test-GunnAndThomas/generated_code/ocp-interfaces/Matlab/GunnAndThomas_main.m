...
%ocp.setup('../../data/GunnAndThomas_Data.lua');
ocp.setup('../../data/GunnAndThomas_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = GunnAndThomas_Mex('get_raw_solution',obj);
%J     = GunnAndThomas_Mex('eval_JF',obj,Z,U);
%f     = GunnAndThomas_Mex('eval_F',obj,Z,U);
