...
namespace GunnAndThomasDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer GunnAndThomas::DgDxpm_numRows() const { return 1; }
  integer GunnAndThomas::DgDxpm_numCols() const { return 4; }
  integer GunnAndThomas::DgDxpm_nnz()     const { return 4; }

  void
  GunnAndThomas::DgDxpm_pattern( integer iIndex[], integer jIndex[] ) const {
