...
namespace GunnAndThomasDefine {
  ...
  integer GunnAndThomas::bc_numEqns() const { return 2; }

  void
  GunnAndThomas::bc_eval(
    NodeQX const & LEFT__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer GunnAndThomas::DbcDxxp_numRows() const { return 2; }
  integer GunnAndThomas::DbcDxxp_numCols() const { return 4; }
  integer GunnAndThomas::DbcDxxp_nnz()     const { return 2; }

  void
  GunnAndThomas::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer GunnAndThomas::D2bcD2xxp_numRows() const { return 4; }
  integer GunnAndThomas::D2bcD2xxp_numCols() const { return 4; }
  integer GunnAndThomas::D2bcD2xxp_nnz()     const { return 0; }

  void
  GunnAndThomas::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  GunnAndThomas::D2bcD2xxp_sparse(
    NodeQX const &          LEFT__,
    NodeQX const &          RIGHT__,
    P_const_p_type          P__,
  ...
  integer GunnAndThomas::fd_BC_numEqns() const { return 4; }

  void
  GunnAndThomas::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer GunnAndThomas::Dfd_BCDxlxlp_numRows() const { return 4; }
  integer GunnAndThomas::Dfd_BCDxlxlp_numCols() const { return 8; }
  integer GunnAndThomas::Dfd_BCDxlxlp_nnz()     const { return 4; }

  void
  GunnAndThomas::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  GunnAndThomas::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
