...
namespace GunnAndThomasDefine {
  ...
  void
  GunnAndThomas::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  GunnAndThomas::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  GunnAndThomas::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  bool
  GunnAndThomas::xlambda_check_node(
    integer              ipos,
  ...
  bool
  GunnAndThomas::xlambda_check_cell(
    integer              icell,
  ...
  integer GunnAndThomas::u_guess_numEqns() const { return 1; }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  void
  GunnAndThomas::u_guess_eval(
    NodeType2 const    & LEFT__,
    NodeType2 const    & RIGHT__,
    P_const_pointer_type P__,
  ...
  bool
  GunnAndThomas::u_check_if_admissible(
    NodeType2 const    & NODE__,
