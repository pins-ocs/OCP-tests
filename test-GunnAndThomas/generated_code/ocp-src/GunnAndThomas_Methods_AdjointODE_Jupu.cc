...
namespace GunnAndThomasDefine {
  ...
  integer GunnAndThomas::JPxpu_numEqns() const { return 3; }

  void
  GunnAndThomas::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer GunnAndThomas::JUxpu_numEqns() const { return 3; }

  void
  GunnAndThomas::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer GunnAndThomas::LTxpu_numEqns() const { return 3; }

  void
  GunnAndThomas::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
