...
namespace GunnAndThomasDefine {
  ...
  using namespace GunnAndThomasLoad;
  ...
  class GunnAndThomas_Problem {
    ...
    GunnAndThomas_Problem( GunnAndThomas_Problem const & );
    GunnAndThomas_Problem const & operator = ( GunnAndThomas_Problem const & );
  ...
  public:
    ...
    GunnAndThomas_Problem( integer n_threads, Console const * console )
    : model("GunnAndThomas",n_threads,console)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "GunnAndThomas::solver, fatal: unknown error";
      }
      return ok;
    }
