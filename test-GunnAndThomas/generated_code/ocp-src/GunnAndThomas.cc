...
namespace GunnAndThomasDefine {
  ...
  */
  void
  GunnAndThomas::update_continuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
  ...
  */
  void
  GunnAndThomas::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "GunnAndThomas::setup_parameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in GunnAndThomas::setup not all parameters are set!\n"
    );
  }

  void
  GunnAndThomas::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  GunnAndThomas::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  GunnAndThomas::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  GunnAndThomas::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  GunnAndThomas::setup_controls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "GunnAndThomas::setup_classes: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  GunnAndThomas::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "GunnAndThomas::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in GunnAndThomas::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  GunnAndThomas::info_model( integer level ) const {
  ...
  */
  void
  GunnAndThomas::get_names( GenericContainer & out ) const {
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  void
  GunnAndThomas::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
