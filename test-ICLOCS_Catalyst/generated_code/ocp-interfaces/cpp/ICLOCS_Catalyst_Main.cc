...
main() {
  ...
  try {
    ICLOCS_Catalyst * m_model = new ICLOCS_Catalyst("ICLOCS_Catalyst",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/ICLOCS_Catalyst_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/ICLOCS_Catalyst_Data.lua";
    #endif
