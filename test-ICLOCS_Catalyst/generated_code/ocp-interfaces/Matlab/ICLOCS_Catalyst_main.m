...
%ocp.setup('../../data/ICLOCS_Catalyst_Data.lua');
ocp.setup('../../data/ICLOCS_Catalyst_Data.rb');
ocp.infoLevel(4);
...
%[Z,U] = ICLOCS_Catalyst_Mex('get_raw_solution',obj);
%J     = ICLOCS_Catalyst_Mex('eval_JF',obj,Z,U);
%f     = ICLOCS_Catalyst_Mex('eval_F',obj,Z,U);
