...
% create object
ocp = ICLOCS_Catalyst( 'ICLOCS_Catalyst' );
...
%ocp.setup(ICLOCS_Catalyst_data);
ocp.setup('../../data/ICLOCS_Catalyst_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%ICLOCS_Catalyst_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = ICLOCS_Catalyst_Mex('get_raw_solution',obj);
%J     = ICLOCS_Catalyst_Mex('eval_JF',obj,Z,MU,U);
%f     = ICLOCS_Catalyst_Mex('eval_F',obj,Z,MU,U);
