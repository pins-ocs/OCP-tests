...
namespace ICLOCS_CatalystDefine {
  ...
  */
  ICLOCS_Catalyst::ICLOCS_Catalyst(
    string const   & name,
  ...
  */
  void
  ICLOCS_Catalyst::update_continuation(
    integer   phase,
    real_type old_s,
    real_type s
  ) {
  ...
  */
  void
  ICLOCS_Catalyst::setup_parameters( GenericContainer const & gc_data ) {
    UTILS_ASSERT0(
      gc_data.exists("Parameters"),
      "ICLOCS_Catalyst::setup_parameters: Missing key `Parameters` in data\n"
    );
    ...
    UTILS_ASSERT0(
      allfound, "in ICLOCS_Catalyst::setup not all parameters are set!\n"
    );
  }

  void
  ICLOCS_Catalyst::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  ICLOCS_Catalyst::setup_classes( GenericContainer const & gc_data ) {
  }
  ...
  */
  void
  ICLOCS_Catalyst::setup_user_classes( GenericContainer const & gc ) {
  }
  ...
  */
  void
  ICLOCS_Catalyst::setup_user_mapped_functions( GenericContainer const & gc_data ) {
  }
  /* --------------------------------------------------------------------------
  //            _                ____            _             _
  ...
  */
  void
  ICLOCS_Catalyst::setup_controls( GenericContainer const & gc_data ) {
    // initialize Control penalties
    UTILS_ASSERT0(
      gc_data.exists("Controls"),
      "ICLOCS_Catalyst::setup_classes: Missing key `Controls` in data\n"
    );
  ...
  */
  void
  ICLOCS_Catalyst::setup_pointers( GenericContainer const & gc_data ) {

    UTILS_ASSERT0(
      gc_data.exists("Pointers"),
      "ICLOCS_Catalyst::setup_pointers: Missing key `Pointers` in data\n"
    );
    ...
    UTILS_ASSERT0(
      gc.exists("pMesh"),
      "in ICLOCS_Catalyst::setup_pointers(gc) cant find key `pMesh' in gc\n"
    );
  ...
  */
  void
  ICLOCS_Catalyst::info_model( integer level ) const {
  ...
  */
  void
  ICLOCS_Catalyst::setup( GenericContainer const & gc ) {

    m_debug = false;
    if ( gc.exists("Debug") )
      m_debug = gc("Debug").get_bool("ICLOCS_Catalyst::setup, Debug");
  ...
  */
  void
  ICLOCS_Catalyst::get_names( GenericContainer & out ) const {
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  void
  ICLOCS_Catalyst::save_OCP_info( GenericContainer & gc ) const {
    for ( integer i = 0; i < numModelPars; ++i )
