...
namespace CatalystDefine {
  ...
  integer Catalyst::boundaryConditions_numEqns() const { return 2; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Catalyst::DboundaryConditionsDxxp_numRows() const { return 2; }
  integer Catalyst::DboundaryConditionsDxxp_numCols() const { return 4; }
  integer Catalyst::DboundaryConditionsDxxp_nnz()     const { return 2; }

  void
  Catalyst::DboundaryConditionsDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  integer Catalyst::adjointBC_numEqns() const { return 4; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Catalyst::DadjointBCDxxp_numRows() const { return 4; }
  integer Catalyst::DadjointBCDxxp_numCols() const { return 4; }
  integer Catalyst::DadjointBCDxxp_nnz()     const { return 0; }

  void
  Catalyst::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
