...
namespace ICLOCS_CatalystDefine {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer ICLOCS_Catalyst::DHxpDxpu_numRows() const { return 2; }
  integer ICLOCS_Catalyst::DHxpDxpu_numCols() const { return 3; }
  integer ICLOCS_Catalyst::DHxpDxpu_nnz()     const { return 2; }

  void
  ICLOCS_Catalyst::DHxpDxpu_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  ICLOCS_Catalyst::DHxpDxpu_sparse(
    NodeType2 const    & NODE__,
    V_const_pointer_type V__,
    U_const_pointer_type U__,
    P_const_pointer_type P__,
