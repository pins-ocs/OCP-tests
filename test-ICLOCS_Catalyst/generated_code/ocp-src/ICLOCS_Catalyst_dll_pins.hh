/*-----------------------------------------------------------------------*\
 |  file: ICLOCS_Catalyst_dll_pins.hh                                    |
 |                                                                       |
...
namespace ICLOCS_CatalystDefine {
  ...
  using namespace ICLOCS_CatalystLoad;
  ...
  class ICLOCS_Catalyst_Problem {

    ICLOCS_Catalyst m_model;
    ...
    ICLOCS_Catalyst_Problem( ICLOCS_Catalyst_Problem const & );
    ICLOCS_Catalyst_Problem const & operator = ( ICLOCS_Catalyst_Problem const & );
  ...
  public:
    ...
    : m_model("ICLOCS_Catalyst",console,TP)
    , mesh( "mesh" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "ICLOCS_Catalyst::solver, fatal: unknown error";
      }
      return ok;
    }
...
// EOF: ICLOCS_Catalyst_dll_pins.hh
