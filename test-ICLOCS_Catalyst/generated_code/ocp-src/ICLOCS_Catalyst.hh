...
#ifndef ICLOCS_CATALYST_DOT_HH
#define ICLOCS_CATALYST_DOT_HH
...
// User Header (end)
  ...
  #ifndef ICLOCS_CATALYST_API_DLL
    #ifdef ICLOCS_CATALYST_EXPORT
      #define ICLOCS_CATALYST_API_DLL __declspec(dllexport)
    #elif defined(ICLOCS_CATALYST_IMPORT)
      #define ICLOCS_CATALYST_API_DLL __declspec(dllimport)
    #else
      #define ICLOCS_CATALYST_API_DLL
    #endif
  #endif
...
namespace ICLOCS_CatalystDefine {
  ...
  class ICLOCS_Catalyst : public Mechatronix::Discretized_Indirect_OCP {
    ...
    ICLOCS_Catalyst( ICLOCS_Catalyst const & );
    ICLOCS_Catalyst const & operator = ( ICLOCS_Catalyst const & );
...
namespace ICLOCS_CatalystLoad {
  using ICLOCS_CatalystDefine::ICLOCS_Catalyst;

}

#endif

// EOF: ICLOCS_Catalyst.hh
