...
namespace CatalystDefine {
  ...
  public:
    ...
    CATALYST_API_DLL
    Catalyst_Problem( integer n_threads, Console const * console )
    : model("Catalyst",n_threads,console)
    , mesh( "mesh" )
    {
  ...
  */
  ...
  CATALYST_API_DLL
  bool
  Catalyst_ocp_guess( char const id[], GenericContainer & gc_guess );
