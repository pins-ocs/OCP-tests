/*-----------------------------------------------------------------------*\
 |  file: Catalyst_Methods_Guess.cc                                      |
 |                                                                       |
...
namespace CatalystDefine {
  ...
  void
  Catalyst::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  Catalyst::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  Catalyst::p_check( P_const_pointer_type P__ ) const {
    return true;
  }
  ...
  integer Catalyst::u_guess_numEqns() const { return 1; }
