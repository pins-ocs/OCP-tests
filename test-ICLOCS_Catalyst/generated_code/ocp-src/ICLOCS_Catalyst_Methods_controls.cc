...
namespace ICLOCS_CatalystDefine {
  ...
  integer ICLOCS_Catalyst::g_numEqns() const { return 1; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer ICLOCS_Catalyst::DgDu_numRows() const { return 1; }
  integer ICLOCS_Catalyst::DgDu_numCols() const { return 1; }
  integer ICLOCS_Catalyst::DgDu_nnz()     const { return 1; }

  void
  ICLOCS_Catalyst::DgDu_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
  }
  ...
  void
  ICLOCS_Catalyst::DuDxlxlp_full_analytic(
    NodeType2 const &          LEFT__,
    NodeType2 const &          RIGHT__,
    P_const_pointer_type       P__,
    U_const_pointer_type       UM__,
...
// EOF: ICLOCS_Catalyst_Methods_controls.cc
