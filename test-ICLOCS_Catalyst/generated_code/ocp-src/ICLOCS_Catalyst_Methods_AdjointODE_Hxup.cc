...
namespace ICLOCS_CatalystDefine {
  ...
  integer ICLOCS_Catalyst::Hxp_numEqns() const { return 2; }

  void
  ICLOCS_Catalyst::Hxp_eval(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer ICLOCS_Catalyst::DHxpDxpuv_numRows() const { return 2; }
  integer ICLOCS_Catalyst::DHxpDxpuv_numCols() const { return 5; }
  integer ICLOCS_Catalyst::DHxpDxpuv_nnz()     const { return 2; }

  void
  ICLOCS_Catalyst::DHxpDxpuv_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  ICLOCS_Catalyst::DHxpDxpuv_sparse(
    NodeQX const &  NODE__,
    P_const_p_type  P__,
    MU_const_p_type MU__,
    U_const_p_type  U__,
