...
namespace CatalystDefine {
  ...
  integer Catalyst::g_numEqns() const { return 1; }
  ...
  Catalyst::g_eval(
    ...
    result__[ 0   ] = (10 * t2 - t4) * LM__[0] + (t4 - 9 * t2) * LM__[1] + t12;
    if ( m_debug )
      Mechatronix::check_in_segment( result__, "g_eval", 1, i_segment );
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Catalyst::DgDxlxlp_numRows() const { return 1; }
  integer Catalyst::DgDxlxlp_numCols() const { return 8; }
  integer Catalyst::DgDxlxlp_nnz()     const { return 8; }

  void
  Catalyst::DgDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Catalyst::DgDu_numRows() const { return 1; }
  integer Catalyst::DgDu_numCols() const { return 1; }
  integer Catalyst::DgDu_nnz()     const { return 1; }

  void
  Catalyst::DgDu_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
  }
  ...
  integer Catalyst::DmDu_numEqns() const { return 1; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Catalyst::DmDuu_numRows() const { return 1; }
  integer Catalyst::DmDuu_numCols() const { return 1; }
  integer Catalyst::DmDuu_nnz()     const { return 1; }

  void
  Catalyst::DmDuu_pattern( integer iIndex[], integer jIndex[] ) const {
    iIndex[0 ] = 0   ; jIndex[0 ] = 0   ;
  }
