...
namespace ICLOCS_CatalystDefine {
  ...
  integer ICLOCS_Catalyst::JPxpu_numEqns() const { return 3; }

  void
  ICLOCS_Catalyst::JPxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
  ...
  integer ICLOCS_Catalyst::JUxpu_numEqns() const { return 3; }

  void
  ICLOCS_Catalyst::JUxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
    ...
    result__[ 0   ] = 0;
    result__[ 1   ] = 0;
    result__[ 2   ] = ALIAS_uControl_D_1(U__[iU_u], 0, 1);
    if ( m_debug )
  ...
  integer ICLOCS_Catalyst::LTxpu_numEqns() const { return 3; }

  void
  ICLOCS_Catalyst::LTxpu_eval(
    NodeQX const & NODE__,
    P_const_p_type P__,
    U_const_p_type U__,
    real_ptr       result__
