...
namespace TrainDefine {
  ...
  */
  ...
  void
  Train::setup_parameters( real_const_ptr Pars ) {
  ...
  */
  void
  Train::info_model( integer level ) const {
    ...
    m_console->message( uaControl.info(),level);
    m_console->message( ubControl.info(),level);
