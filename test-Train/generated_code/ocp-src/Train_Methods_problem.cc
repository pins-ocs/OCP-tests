...
namespace TrainDefine {
  ...
  Train::H_eval(
    ...
    real_type t10  = acc(X__[iX_x], t9);
    real_type result__ = t3 + t6 + t10 * t7 + t7 * (t1 - t4) + t9 * L__[iL_lambda1__xo] + t9 * t1;
    return result__;
  }
#else
  real_type
  ...
  integer
  Train::segmentLink_numEqns() const
  { return 0; }
  ...
  integer
  Train::DsegmentLinkDxp_numRows() const
  { return 0; }

  integer
  Train::DsegmentLinkDxp_numCols() const
  { return 0; }

  integer
  Train::DsegmentLinkDxp_nnz() const
  { return 0; }
  ...
  integer
  Train::integrated_post_numEqns() const
  { return 0; }
