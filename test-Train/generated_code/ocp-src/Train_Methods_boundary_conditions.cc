...
namespace TrainDefine {
  ...
  integer Train::bc_numEqns() const { return 4; }
  ...
  integer Train::fd_BC_numEqns() const { return 4; }
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer Train::Dfd_BCDxlxlp_numRows() const { return 4; }
  integer Train::Dfd_BCDxlxlp_numCols() const { return 8; }
  integer Train::Dfd_BCDxlxlp_nnz()     const { return 4; }

  void
  Train::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
