...
main() {
  ...
  try {
    Train * m_model = new Train("Train",n_threads,&console);

    // user defined Object instances (external)
    MeshStd          mesh( "mesh" );

    #ifdef MECHATRONIX_USE_RUBY
    string fname = "./data/Train_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/Train_Data.lua";
    #endif
    ...
    if ( ok ) {
      ...
      file.open( "data/Train_OCP_result_NOT_CONVERGED.txt" );
    }
    file.precision(18);
