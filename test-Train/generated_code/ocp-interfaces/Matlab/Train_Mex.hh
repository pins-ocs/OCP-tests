...
public:
  ...
  void do_acc( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_acc_D_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_acc_D_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_acc_D_1_1( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_acc_D_1_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_acc_D_2_2( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_h( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_h_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_h_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
