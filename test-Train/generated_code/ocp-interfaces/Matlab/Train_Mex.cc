...
"Train_Mex('command', arguments ):\n"
"%===========================================================================%\n"
;

#define MODEL_NAME  "Train"
#define MODEL_CLASS Train
...
public:
  ...
  )
  {
    ...
    try {
      ...
      mexErrMsgTxt(
        fmt::format(
          "Train_Mex('set_guess',...), error: {}",
          exc.what()
        ).c_str()
      );
    }
    catch (...) {
      mexErrMsgTxt( "Train_Mex('set_guess',...), Unknown error\n" );
    }
    #undef CMD
  }
  ...
  )
  {
    ...
    try {
      ...
      string msg = fmt::format( "Train_Mex('eval_F',...) error: {}", exc.what() );
      mexWarnMsgTxt( msg.c_str() );
      ok = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "Train_Mex('eval_F',...) unkown error\n" );
      ok = false;
    }
  ...
  )
  {
    ...
    try {
      ...
      mexWarnMsgTxt( fmt::format( "Train_Mex('eval_JF',...) error: {}", exc.what() ).c_str() );
      ok_value = false;
    } catch ( ... ) {
      mexWarnMsgTxt( "Train_Mex('eval_JF',...) unkown error\n" );
      ok_value = false;
    }
    int ok = mexCallMATLAB( 1, &arg_out_0, 5, args, "sparse" );
    UTILS_MEX_ASSERT0( ok == 0, CMD "failed the call sparse(...)" );
  ...
  do_acc(
    ...
    #define CMD MODEL_NAME "_Mex('acc', obj, xo__x, xo__v ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
  ...
  do_acc_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('acc_D_1', obj, xo__x, xo__v ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
  ...
  do_acc_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('acc_D_2', obj, xo__x, xo__v ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
  ...
  do_acc_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('acc_D_1_1', obj, xo__x, xo__v ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
  ...
  do_acc_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('acc_D_1_2', obj, xo__x, xo__v ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
  ...
  do_acc_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('acc_D_2_2', obj, xo__x, xo__v ): "
    CHECK_IN_OUT( 4, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
    mwSize N1, M1;
  ...
  do_h(
    ...
    #define CMD MODEL_NAME "_Mex('h', obj, xo__x ): "
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
  ...
  {
    #define CMD MODEL_NAME "_Mex('h_D', obj, xo__x ): "
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
  ...
  do_h_DD(
    ...
    #define CMD MODEL_NAME "_Mex('h_DD', obj, xo__x ): "
    CHECK_IN_OUT( 3, 1 );
    mwSize N0, M0;
    real_const_ptr arg0 = Utils::mex_matrix_pointer( arg_in_2, N0, M0, CMD " xo__x" );
...
do_acc(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('acc',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_acc( nlhs, plhs, nrhs, prhs );
}
...
do_acc_D_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('acc_D_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_acc_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_acc_D_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('acc_D_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_acc_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_acc_D_1_1(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('acc_D_1_1',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_acc_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_acc_D_1_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('acc_D_1_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_acc_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_acc_D_2_2(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('acc_D_2_2',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_acc_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_h(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('h',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_h( nlhs, plhs, nrhs, prhs );
}
...
do_h_D(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('h_D',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_h_D( nlhs, plhs, nrhs, prhs );
}
...
do_h_DD(
  ...
  UTILS_MEX_ASSERT(
    nrhs >= 2,
    MODEL_NAME "_Mex('h_DD',...): Expected at least {} argument(s), nrhs = {}\n", nrhs
  );
  Utils::mex_convert_mx_to_ptr<ProblemStorage>(arg_in_1)->do_h_DD( nlhs, plhs, nrhs, prhs );
}
...
static std::map<std::string,DO_CMD> cmd_to_fun = {
  ...
  {"acc_D_1",do_acc_D_1},
  {"acc_D_2",do_acc_D_2},
  {"acc_D_1_1",do_acc_D_1_1},
  {"acc_D_1_2",do_acc_D_1_2},
  {"acc_D_2_2",do_acc_D_2_2},
  {"h",do_h},
  {"h_D",do_h_D},
  {"h_DD",do_h_DD},
  {"new",do_new},
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt( fmt::format( "Train_Mex, unknown command: {}", exc.what() ).c_str() );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt( fmt::format( "Train_Mex, error: {}", exc.what() ).c_str() );
  }
  catch (...) {
