...
DO_COMMAND_REMAP_TO_CLASS_METHOD(acc);
DO_COMMAND_REMAP_TO_CLASS_METHOD(acc_D_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(acc_D_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(acc_D_1_1);
DO_COMMAND_REMAP_TO_CLASS_METHOD(acc_D_1_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(acc_D_2_2);
DO_COMMAND_REMAP_TO_CLASS_METHOD(h);
DO_COMMAND_REMAP_TO_CLASS_METHOD(h_D);
...
mexFunction(
  ...
  try {
    ...
    mexErrMsgTxt(
      fmt::format( "Train_Mex, unknown command: {}",
      exc.what() ).c_str()
    );
  }
  catch ( std::exception const & exc ) {
    mexErrMsgTxt(
      fmt::format( "Train_Mex, error: {}",
      exc.what() ).c_str()
    );
  }
  catch (...) {
