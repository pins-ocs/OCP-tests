...
ocp.setup('../../data/Train_Data');  % automatically try extension .rb and .lua
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Train_Mex('set_tracked',obj,tracked);
...
%[Z,MU,U] = Train_Mex('get_raw_solution',obj);
%J     = Train_Mex('eval_JF',obj,Z,MU,U);
%f     = Train_Mex('eval_F',obj,Z,MU,U);
