...
public:
  ...
  do_acc_D_1(
    ...
    #define CMD MODEL_NAME "_Mex('acc_D_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->acc_D_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_acc_D_2(
    ...
    #define CMD MODEL_NAME "_Mex('acc_D_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->acc_D_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_acc_D_1_1(
    ...
    #define CMD MODEL_NAME "_Mex('acc_D_1_1', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->acc_D_1_1(arg0,arg1) );
    #undef CMD
  }
  ...
  do_acc_D_1_2(
    ...
    #define CMD MODEL_NAME "_Mex('acc_D_1_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->acc_D_1_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_acc_D_2_2(
    ...
    #define CMD MODEL_NAME "_Mex('acc_D_2_2', obj, ... args ... ): "
    CHECK_IN( 4 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );
    real_type arg1 = getScalarValue( arg_in_1, CMD " arg1" );

    setScalarValue( arg_out_0, this->acc_D_2_2(arg0,arg1) );
    #undef CMD
  }
  ...
  do_h(
    ...
    #define CMD MODEL_NAME "_Mex('h', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->h(arg0) );
    #undef CMD
  }
  ...
  do_h_D(
    ...
    #define CMD MODEL_NAME "_Mex('h_D', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->h_D(arg0) );
    #undef CMD
  }
  void
  do_h_DD(
    ...
    #define CMD MODEL_NAME "_Mex('h_DD', obj, ... args ... ): "
    CHECK_IN( 3 );
    CHECK_OUT( 1 );
    real_type arg0 = getScalarValue( arg_in_0, CMD " arg0" );

    setScalarValue( arg_out_0, this->h_DD(arg0) );
    #undef CMD
  }
...
do_acc(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_acc( nlhs, plhs, nrhs, prhs );
}
...
do_acc_D_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_acc_D_1( nlhs, plhs, nrhs, prhs );
}
...
do_acc_D_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_acc_D_2( nlhs, plhs, nrhs, prhs );
}
...
do_acc_D_1_1(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_acc_D_1_1( nlhs, plhs, nrhs, prhs );
}
...
do_acc_D_1_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_acc_D_1_2( nlhs, plhs, nrhs, prhs );
}
...
do_acc_D_2_2(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_acc_D_2_2( nlhs, plhs, nrhs, prhs );
}
...
do_h(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_h( nlhs, plhs, nrhs, prhs );
}
...
do_h_D(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_h_D( nlhs, plhs, nrhs, prhs );
}
...
do_h_DD(
  ...
  convertMat2Ptr<ProblemStorage>(arg_in_1)->do_h_DD( nlhs, plhs, nrhs, prhs );
}
