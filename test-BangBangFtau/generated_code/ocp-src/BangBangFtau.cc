...
namespace BangBangFtauDefine {
  ...
  */
  void
  BangBangFtau::info_model( integer level ) const {
    ...
    m_console->message( vsTpositive.info(),level);
    m_console->message( vsBpositive.info(),level);
    m_console->message( vsTmax.info(),level);
    m_console->message( vsTBInterval_min.info(),level);
    m_console->message( vsTBInterval_max.info(),level);
