...
namespace BangBangFtauDefine {
  ...
  integer BangBangFtau::bc_numEqns() const { return 5; }

  void
  BangBangFtau::bc_eval(
    NodeQX const & LEFT__,
  ...
  integer BangBangFtau::fd_BC_numEqns() const { return 8; }

  void
  BangBangFtau::fd_BC_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtau::Dfd_BCDxlxlp_numRows() const { return 8; }
  integer BangBangFtau::Dfd_BCDxlxlp_numCols() const { return 16; }
  integer BangBangFtau::Dfd_BCDxlxlp_nnz()     const { return 8; }

  void
  BangBangFtau::Dfd_BCDxlxlp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  void
  BangBangFtau::Dfd_BCDxlxlp_sparse(
    NodeQXL const &         LEFT__,
    NodeQXL const &         RIGHT__,
    P_const_p_type          P__,
    OMEGA_full_const_p_type OMEGA__,
