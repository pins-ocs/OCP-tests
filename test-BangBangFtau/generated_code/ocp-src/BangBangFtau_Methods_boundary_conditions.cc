...
namespace BangBangFtauDefine {
  ...
  integer BangBangFtau::boundaryConditions_numEqns() const { return 5; }

  void
  BangBangFtau::boundaryConditions_eval(
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtau::DbcDxxp_numRows() const { return 5; }
  integer BangBangFtau::DbcDxxp_numCols() const { return 8; }
  integer BangBangFtau::DbcDxxp_nnz()     const { return 5; }

  void
  BangBangFtau::DbcDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtau::D2bcD2xxp_numRows() const { return 8; }
  integer BangBangFtau::D2bcD2xxp_numCols() const { return 8; }
  integer BangBangFtau::D2bcD2xxp_nnz()     const { return 0; }

  void
  BangBangFtau::D2bcD2xxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }


  void
  BangBangFtau::D2bcD2xxp_sparse(
    NodeType const         & LEFT__,
    NodeType const         & RIGHT__,
    P_const_pointer_type     P__,
  ...
  integer BangBangFtau::adjointBC_numEqns() const { return 8; }

  void
  BangBangFtau::adjointBC_eval(
    NodeType const              & LEFT__,
    NodeType const              & RIGHT__,
    P_const_pointer_type          P__,
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  integer BangBangFtau::DadjointBCDxxp_numRows() const { return 8; }
  integer BangBangFtau::DadjointBCDxxp_numCols() const { return 8; }
  integer BangBangFtau::DadjointBCDxxp_nnz()     const { return 0; }

  void
  BangBangFtau::DadjointBCDxxp_pattern( integer iIndex[], integer jIndex[] ) const {
    // EMPTY!
  }
