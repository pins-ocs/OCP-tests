...
namespace BangBangFtauDefine {
  ...
  public:
    ...
    BangBangFtau_Problem( integer n_threads, Console const * console )
    : model("BangBangFtau",n_threads,console)
    , mesh( "mesh" )
    {
