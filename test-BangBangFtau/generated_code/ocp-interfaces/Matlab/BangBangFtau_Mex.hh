...
public:
  ...
  void do_vsTBInterval( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_vsTBInterval_D( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
  void do_vsTBInterval_DD( int nlhs, mxArray *plhs[], int nrhs, mxArray const *prhs[] );
