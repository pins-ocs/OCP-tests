...
ocp.setup('../../data/BangBangFtau_Data');  % automatically try extension .rb and .lua
ocp.infoLevel(4);
...
%[Z,U] = BangBangFtau_Mex('get_raw_solution',obj);
%J     = BangBangFtau_Mex('eval_JF',obj,Z,U);
%f     = BangBangFtau_Mex('eval_F',obj,Z,U);
